...
this.id=a.getImageID(this.oid,this.display.id);this.status.load="loading";$(this.png.image).on("load",function(){g.mkOffScreenCanvas();g.mkRawDataFromPNG();"zscale"===g.params.scaleclipping&&g.zscale(!0);g.mkSection();e=j(g,h);e.length&&g.mkSection.apply(g,e);g.displayImage("all",h);k.call(g,d);a.DEBUG&&a.log("JS9 image: %s dims(%d,%d) min/max(%d,%d)",g.file,g.raw.width,g.raw.height,g.raw.dmin,g.raw.dmax)}).on("error",function(){a.waiting(!1);g.status.load="error";a.error("could not load image: "+
g.id)});this.png.image.src=c;break;default:a.log("unknown specification type for Load: "+typeof c)}};a.Image.prototype.getImageData=function(a){var b=null;if(a)if("array"===a)b=Array.prototype.slice.call(this.raw.data);else if("base64"===a){var b="",d=new Uint8Array(this.raw.data.buffer),e=d.byteLength;for(a=0;a<e;a++)b+=String.fromCharCode(d[a]);b=window.btoa(b)}else a&&"false"!==a&&(b=this.raw.data);return{id:this.id,file:this.file,fits:this.fitsFile||"",source:this.source,imtab:this.imtab,width:this.raw.width,
...
0;d<f;d++)c=d/f,b=10*c,c=Math.floor(Math.log(b+Math.sqrt(b*b+1))/3*e),c>=e&&(c=e-1),this.psColors[d]=this.colorCells[c];break;case "sinh":for(d=0;d<f;d++)c=d/f,b=3*c,c=Math.floor((Math.exp(b)-Math.exp(-b))/2/10*e),c>=e&&(c=e-1),this.psColors[d]=this.colorCells[c];break;default:a.log("unknown scale '"+this.params.scale+"'")}return this};a.Image.prototype.mkRGBImage=function(){var c,b,d,e,f,g,h,j,k,m,p,r,l,n,q,s,t,v,u,w,y=null,x=null,A=null,B=!1;if(!this.rgb)return this;if(a.globalOpts.rgb.active&&
(this===a.globalOpts.rgb.rim||this===a.globalOpts.rgb.gim||this===a.globalOpts.rgb.bim))B=!0,a.globalOpts.rgb.rim&&(y=a.globalOpts.rgb.rim),a.globalOpts.rgb.gim&&(x=a.globalOpts.rgb.gim),a.globalOpts.rgb.bim&&(A=a.globalOpts.rgb.bim);h=this.display.context;c=this.rgb;b=c.sect;if(this.MakeRGBImage&&"function"===typeof this.MakeRGBImage&&this.MakeRGBImage()||this.MakePrimaryImage&&"function"===typeof this.MakePrimaryImage&&this.MakePrimaryImage())return this;if(this.rgbFile){f=b.width/b.zoom;g=b.height/
b.zoom;d=b.x0;e=this.offscreen.canvas.height-1-(b.y0+g);e=this.offscreen.context.getImageData(d,e,f,g);if(1===b.zoom)c.img=e;else{c.img=h.createImageData(b.width,b.height);c=c.img;for(m=j=0;j<e.height;j++,m++){s=j*e.width;r=m*b.zoom;for(k=h=0;h<e.width;h++,k++){d=4*(s+h);p=k*b.zoom;for(l=0;l<b.zoom;l++){n=Math.floor(r+l);t=n*b.width;for(n=0;n<b.zoom;n++)q=Math.floor(p+n),q=4*(t+q),c.data[q]=e.data[d],c.data[q+1]=e.data[d+1],c.data[q+2]=e.data[d+2],c.data[q+3]=e.data[d+3]}}}}return this}if(!c.img||
c.img.width!==b.width||c.img.height!==b.height)c.img=h.createImageData(b.width,b.height);c=c.img;if(!this.psColors)return this;v=void 0!==this.params.opacity?255*this.params.opacity:void 0!==this.params.alpha?this.params.alpha:255;this.maskData&&(this.params.maskInvert?void 0!==this.params.opacity&&void 0!==this.params.maskOpacity?(e=255*this.params.opacity,f=255*this.params.maskOpacity):void 0!==this.params.alpha1&&void 0!==this.params.alpha2?(e=this.params.alpha2,f=this.params.alpha1):(e=0,f=255):
void 0!==this.params.opacity&&void 0!==this.params.maskOpacity?(e=255*this.params.maskOpacity,f=255*this.params.opacity):void 0!==this.params.alpha1&&void 0!==this.params.alpha2?(e=this.params.alpha1,f=this.params.alpha2):(e=255,f=0));j=b.y1-1;for(m=0;j>=b.y0;j--,m++){s=j*this.raw.width;r=m*b.zoom;h=b.x0;for(k=0;h<b.x1;h++,k++){if(B){if(g=y?y.colorData[s+h]:0,u=x?x.colorData[s+h]:0,w=A?A.colorData[s+h]:0,void 0===g||void 0===u||void 0===w)return a.globalOpts.rgb.active=!1,a.error("RGB images are incompatible. Turning off RGB mode.",
"",!1),a.Image.prototype.mkRGBImage.call(this),this}else d=this.colorData[s+h];this.maskData&&(v=0<this.maskData[s+h]?e:f);p=k*b.zoom;for(l=0;l<b.zoom;l++){n=Math.floor(r+l);t=n*b.width;for(n=0;n<b.zoom;n++)q=Math.floor(p+n),q=4*(t+q),B?(c.data[q]=y?y.psColors[g][0]:0,c.data[q+1]=x?x.psColors[u][1]:0,c.data[q+2]=A?A.psColors[w][2]:0):(c.data[q]=this.psColors[d][0],c.data[q+1]=this.psColors[d][1],c.data[q+2]=this.psColors[d][2]),c.data[q+3]=v}}}return this};a.Image.prototype.blendImage=function(c,
b,d){var e=/normal|multiply|screen|overlay|darken|lighten|color-dodge|color-burn|hard-light|soft-light|difference|exclusion|hue|saturation|color|luminosity|clear|copy|source-over|destination-over|source-in|destination-in|source-out|destination-out|source-atop|destination-atop|xor|lighter/i;if(0===arguments.length)return this.blend;if(!0===c||!1===c)return this.blend.active=c,this.display.blendMode&&this.displayImage(),this;if(a.notNull(c)||a.notNull(b))a.notNull(c)&&(e.test(c)||a.error("invalid composite/blend operation: "+
c),this.blend.mode=c),a.notNull(b)&&(this.blend.opacity=b),a.notNull(d)&&(this.blend.active=d),this.display.blendMode&&this.blend.active&&this.displayImage();return this};a.noff=0;a.Image.prototype.putImage=function(c){var b,d,e=this.rgb;b=this.display;var f=b.context,g=function(c,b){var d,e;c.offscreenRGB||(e=document.createElement("canvas"),d=e.getContext("2d"),e.width=b.width,e.height=b.height,a.ANTIALIAS||(d.imageSmoothingEnabled=!1,d.mozImageSmoothingEnabled=!1,d.webkitImageSmoothingEnabled=
!1),d.putImageData(b,0,0),c.offscreenRGB={canvas:e,context:d});return c.offscreenRGB.canvas};c=c||{};this.ix=Math.floor((b.canvas.width-e.img.width)/2);this.iy=Math.floor((b.canvas.height-e.img.height)/2);"reproject"===this.rawDataLayer()&&(c.wcsim&&(b=c.wcsim.logicalToDisplayPos({x:c.wcsim.raw.header.CRPIX1,y:c.wcsim.raw.header.CRPIX2}),d=this.logicalToDisplayPos({x:this.raw.header.CRPIX1,y:this.raw.header.CRPIX2}),this.wcsix=b.x-d.x,this.wcsiy=b.y-d.y),this.wcsix&&(this.ix+=this.wcsix*this.rgb.sect.zoom),
this.wcsiy&&(this.iy+=this.wcsiy*this.rgb.sect.zoom));a.notNull(c.opacity)||a.notNull(c.blend)?(f.save(),void 0!==c.opacity&&(f.globalAlpha=c.opacity),void 0!==c.blend&&(f.globalCompositeOperation=c.blend),f.drawImage(g(this,e.img),this.ix,this.iy),f.restore()):f.putImageData(e.img,this.ix,this.iy)};a.Image.prototype.displayImage=function(c,b){var d,e,f,g;g=0;var h=[],j={};if(!1===c)return this.displayMode=!1,this;!0===c&&(this.displayMode=!0,c="all");if(!this.displayMode)return this;"object"===typeof c&&
(b=c,c=null);c?"all"===c?(c="colors,scaled,rgb,display,plugins",j.notify=!0):"rgbonly"===c?(c="rgb,nodisplay",j.notify=!0):"display"===c&&(j.notify=!0):c="rgb";c.split(",").forEach(function(a){a=a.trim();j[a]=!0;switch(a){case "colors":j.scaled=!0;j.rgb=!0;break;case "scaled":j.rgb=!0}});j.display=!0;j.plugins=!0;this.rgbFile&&(c.colors=!1,c.scaled=!1);b=b||{};if(this.display.blendMode)for(d=0;d<a.images.length;d++)e=a.images[d],e.display===this.display&&e.blend.active&&(h.push(e),g++);j.colors&&
...
for(c=0;c<g.length;c++)j[c]=g.charCodeAt(c);if(0<(new Int8Array((new Int16Array([1])).buffer))[0]){f=g.length;e=Math.abs(this.raw.bitpix)/8;m=new Uint8Array(k);for(c=0;c<m.byteLength;c+=e){b=c+e-1;for(d=0;d<e;b--,d++)j[f++]=m[b]}}else j.set(new Uint8Array(k),g.length);f=g.length+k.byteLength;for(c=0;c<h;c++)j[f++]=0;return j};a.Image.prototype.getPan=function(){return{x:(this.rgb.sect.x0+this.rgb.sect.x1)/2+1,y:(this.rgb.sect.y0+this.rgb.sect.y1)/2+1}};a.Image.prototype.setPan=function(c,b){var d,
...
switch(b){case "physical":this.lcs.physical&&(d=this.lcs.physical.forward);break;case "detector":this.lcs.detector&&(d=this.lcs.detector.forward);break;case "amplifier":this.lcs.amplifier&&(d=this.lcs.amplifier.forward)}d&&(e.x=a.x*d[0][0]+a.y*d[1][0]+d[2][0],e.y=a.x*d[0][1]+a.y*d[1][1]+d[2][1]);return e};a.Image.prototype.displayToImagePos=function(a){var b=this.rgb,d=this.rgb.sect,e={};1>=d.zoom?(e.x=(a.x-this.ix)/d.zoom+d.x0+1,e.y=(b.img.height-1-(a.y-this.iy))/d.zoom+d.y0+1):(e.x=(a.x-this.ix)/
d.zoom+d.x0+1-0.5,e.y=(b.img.height-1-(a.y-this.iy))/d.zoom+d.y0+1-0.5);return e};a.Image.prototype.imageToDisplayPos=function(a){var b=this.rgb,d=this.rgb.sect,e={};1>=d.zoom?(e.x=(a.x-1-d.x0)*d.zoom+this.ix,e.y=(d.y0-(a.y-1))*d.zoom+(b.img.height-1)+this.iy):(e.x=(a.x-1+0.5-d.x0)*d.zoom+this.ix,e.y=(d.y0-(a.y-1+0.5))*d.zoom+(b.img.height-1)+this.iy);return e};a.Image.prototype.logicalToDisplayPos=function(a){return this.imageToDisplayPos(this.logicalToImagePos(a))};a.Image.prototype.displayToLogicalPos=
...
this.display.newShapeLayer(c,a.Regions.opts);g=a.InstallDir(f.url);$.ajax({url:g,cache:!1,dataType:"json",success:p,error:l});break;case "text":g=a.InstallDir(f.url),$.ajax({url:g,cache:!1,dataType:"text",success:r,error:l})}}};a.Image.prototype.saveFITS=function(c){var b;window.hasOwnProperty("saveAs")?(c=c||"js9.fits",b=this.toArray(),b=new Blob([b],{type:"application/octet-binary"}),saveAs(b,c)):a.error("no saveAs function available to save FITS file");return c};a.Image.prototype.saveIMG=function(c,
...
return c};a.Image.prototype.savePNG=function(a){this.saveIMG(a||"js9.png","image/png")};a.Image.prototype.saveJPEG=function(a,b){this.saveIMG(a||"js9.jpeg","image/jpeg",b)};a.Image.prototype.updateValpos=function(c,b){var d,e,f,g,h;d=null;e=function(a,c){return a.toFixed(c||3)};f=function(a,c){var b="",d="";0>a&&(a=Math.abs(a),d="-");for(b+=a;b.length<c;)b="0"+b;return d+b};if(this.params.valpos){void 0===b&&(b=!0);if(this.valpos)return b&&this.displayMessage("info",this.valpos),this.valpos;g={x:c.x,
...
b=b||{};b.bitpix=-64===this.raw.bitpix?-64:-32;b.oraw="current0";b.alwaysCopy=!0;b.rawid="gaussBlur";b.sigma=c;this.rawDataLayer(b,function(b,e){var f;switch(e.bitpix){case -32:f=new Float32Array(e.data);break;case -64:f=new Float64Array(e.data);break;default:a.error("invalid temp bitpix for gaussBlur: "+e.bitpix)}gaussBlur(f,e.data,e.width,e.height,c);return!0})};a.Image.prototype.shiftData=function(c,b,d){(void 0===c||void 0===b)&&a.error("missing translation value(s) for shiftData");d=d||{};d.rawid=
"shift";d.x=c;d.y=b;this.rawDataLayer(d,function(a,c,b){var d,j,k,m,p=a.data.BYTES_PER_ELEMENT;void 0===c.xoff&&(c.xoff=0);void 0===c.yoff&&(c.yoff=0);c.xoff+=b.x;c.yoff+=b.y;if(!b.fill||"clear"===b.fill)if("function"===typeof c.data.fill)c.data.fill(0);else for(b=0;b<c.data.length;b++)c.data[b]=0;for(b=0;b<a.height;b++)if(k=b+c.yoff,!(0>k||k>=a.height)){d=0;j=d+c.xoff;m=a.width;0>j&&(d-=j,m+=j,j=0);j+m>a.width&&(m-=j+m-a.width);if(0>=m)return!1;d=(b*a.width+d)*p;d=new Uint8Array(a.data.buffer,d,
m*p);j=(k*a.width+j)*p;m=new Uint8Array(c.data.buffer,j,m*p);m.set(d)}return!0})};a.Image.prototype.reprojectData=function(c,b){var d=this,e={},f,g,h,j,k,m,p,r,l=/NAXIS|NAXIS[1-4]|AMDX|AMDY|CD[1-2]_[1-2]|CDELT[1-4]|CNPIX[1-4]|CO1_[1-9][0-9]|CO2_[1-9][0-9]|CROTA[1-4]|CRPIX[1-4]|CRVAL[1-4]|CTYPE[1-4]|CUNIT[1-4]|DATE|DATE_OBS|DC-FLAG|DEC|DETSEC|DETSIZE|EPOCH|EQUINOX|EQUINOX[a-z]|IMAGEH|IMAGEW|LATPOLE|LONGPOLE|MJD-OBS|PC00[1-4]00[1-4]|PC[1-4]_[1-4]|PIXSCALE|PIXSCAL[1-2]|PLTDECH|PLTDECM|PLTDECS|PLTDECSN|PLTRAH|PLTRAM|PLTRAS|PPO|PROJP[1-9]|PROJR0|PV[1-3]_[1-3]|PV[1-4]_[1-4]|RA|RADECSYS|SECPIX|SECPIX|SECPIX[1-2]|UT|UTMID|VELOCITY|VSOURCE|WCSAXES|WCSDEP|WCSDIM|WCSNAME|XPIXSIZE|YPIXSIZE|ZSOURCE|LTM|LTV/,
...
"fits")):(e=this.toArray(),j=this.id.replace(/\.png$/,"_png"+a.uniqueID()+".fits"),a.vfile(j,e),k="reprojected_"+j);window.setTimeout(function(){var d,e,g,h;try{d=k.lastIndexOf("."),0<=d&&(e=k.substring(0,d)+"_area"+k.substring(d)),h=b.cmdswitches||"",p=a.reproject(j,k,f,h),a.vunlink(e),a.vunlink(f),0>p.search(/\[struct stat="OK"/)&&((g=p.match(/msg="([^"]*)"/))&&g[1]?a.error(g[1]+" (from mProjectPP)"):a.error(p))}catch(l){a.vunlink(e),a.vunlink(f),p?a.error(p):a.error("WCS reproject failed",l)}m=
$.extend(!0,{},b||{},a.fits.options);m.rawid=m.rawid||"reproject";m.wcsim=c;try{a.fits.handleFITSFile(k,m,n)}catch(r){a.error("can't process reprojected FITS file",r)}},a.SPINOUT)}};a.Colormap=function(c,b,d,e){this.name=c;switch(arguments.length-1){case 1:this.type="lut";this.colors=b;break;case 3:this.type="sao";this.vertices=[];this.vertices[0]=b;this.vertices[1]=d;this.vertices[2]=e;break;default:a.error("colormap requires name and 1 or 3 array arg")}a.colormaps.push(this);1<a.DEBUG&&a.log("JS9 colormap:  %s",
...
h=0,n=b()[0].image,q={zoomtitle:{name:"Zoom Factors:",disabled:!0}};for(c=a.imageOpts.zooms;1<=c;c--)d=Math.pow(2,-c),e=Math.pow(2,c),f=sprintf("zoom%s",d),e=sprintf("zoom 1/%s",e),q[f]={name:e},n&&n.rgb.sect.zoom===d&&(q[f].icon="sun");for(c=0;c<=a.imageOpts.zooms;c++)d=Math.pow(2,c),f=sprintf("zoom%s",d),e=sprintf("zoom %s",d),q[f]={name:e},n&&n.rgb.sect.zoom===d&&(q[f].icon="sun");q["sep"+h++]="------";q.zoomiotitle={name:"Zoom In/Out:",disabled:!0};q.zoomIn={name:"zoom in"};q.zoomOut={name:"zoom out"};
...
$("#colorMenu"+g.id).contextMenu()});$.contextMenu({selector:"#colorMenu"+g.id,zIndex:a.MENUZINDEX,events:{hide:c},build:function(){var c,d,e,f=0,h={},n=b()[0],q=function(a,c){c.contrast&&!isNaN(c.contrast)&&(a.params.contrast=parseFloat(c.contrast));c.bias&&!isNaN(c.bias)&&(a.params.bias=parseFloat(c.bias));isNaN(c.opacity)||(a.params.opacity=""!==c.opacity?parseFloat(c.opacity):1);a.displayImage("colors")},s=function(a){var c=$.contextMenu.getInputValues(a.data),b=g.display.image;switch(a.which||
a.keyCode){case 9:case 13:q(b,c);a.data.edited=!1;break;default:a.data.edited=!0}};h.cmaptitle={name:"Colormaps:",disabled:!0};for(c=0;c<a.colormaps.length;c++)e=d=a.colormaps[c].name,h[d]={name:e},n.image&&n.image.cmapObj.name===d&&(h[d].icon="sun");h["sep"+f++]="------";h.contrast={events:{keyup:s},name:"contrast value:",type:"text"};h.bias={events:{keyup:s},name:"bias value:",type:"text"};h.opacity={events:{keyup:s},name:"opacity value:",type:"text"};h["sep"+f++]="------";h.reset={name:"reset contrast/bias"};
h["sep"+f++]="------";h.invert={name:"invert colormap"};n.image&&n.image.params.invert&&(h.invert.icon="sun");h["sep"+f++]="------";h.rgb={name:"RGB mode"};a.globalOpts.rgb.active&&(h.rgb.icon="sun");return{callback:function(a){b().forEach(function(c){(c=c.image)&&c.setColormap(a)})},events:{show:function(c){var b=g.display.image,d={};b&&(d.contrast=String(b.params.contrast),d.bias=String(b.params.bias),d.opacity=String(b.params.opacity),d.sigma=String(b.params.sigma));$.contextMenu.setInputValues(c,
d);a.jupyterFocus(".context-menu-item")},hide:function(a){var c=g.display.image;c&&a.edited&&(delete a.edited,a=$.contextMenu.getInputValues(a),q(c,a))}},items:h}}});$("#regionMenu"+g.id).on("mousedown",function(a){a.preventDefault();$("#regionMenu"+g.id).contextMenu()});$.contextMenu({selector:"#regionMenu"+g.id,zIndex:a.MENUZINDEX,events:{hide:c},build:function(){var c=b()[0].image,d={regiontitle:{name:"Regions:",disabled:!0},annulus:{name:"annulus"},box:{name:"box"},circle:{name:"circle"},ellipse:{name:"ellipse"},
line:{name:"line"},point:{name:"point"},polygon:{name:"polygon"},text:{name:"text"},sep2:"------",loadRegions:{name:"load regions"},saveRegions:{name:"save regions"},listRegions:{name:"list regions"},deleteRegions:{name:"delete regions"},listonchange:{name:"list on change"},xeqonchange:{name:"xeq on change"}};c&&c.params.listonchange&&(d.listonchange.icon="sun");c&&c.params.xeqonchange&&(d.xeqonchange.icon="sun");return{callback:function(c){b().forEach(function(b){var d=b.image;if(d)switch(c){case "deleteRegions":d.removeShapes("regions",
"all");d.clearMessage("regions");break;case "loadRegions":a.OpenRegionsMenu({display:b});break;case "saveRegions":d.saveRegions("all",!0);break;case "listRegions":d.listRegions("all",2);break;case "xeqonchange":d.params.xeqonchange=!d.params.xeqonchange;break;case "listonchange":d.params.listonchange=!d.params.listonchange;break;default:d.addShapes("regions",c,{ireg:!0})}})},items:d}}});$("#wcsMenu"+g.id).on("mousedown",function(a){a.preventDefault();$("#wcsMenu"+g.id).contextMenu()});$.contextMenu({selector:"#wcsMenu"+
g.id,zIndex:a.MENUZINDEX,events:{hide:c},build:function(){var c,d,e,f=0,g=0,h={},q=b()[0],s=q.image;h.wcssystitle={name:"WCS Systems:",disabled:!0};for(c=0;c<a.wcssyss.length;c++)e=d=a.wcssyss[c],h[d]={name:e},q.image&&q.image.params.wcssys===d&&(h[d].icon="sun");h["sep"+f++]="------";h.wcsutitle={name:"WCS Units:",disabled:!0};for(c=0;c<a.wcsunitss.length;c++)e=d=a.wcsunitss[c],h[d]={name:e},q.image&&q.image.params.wcsunits===d&&(h[d].icon="sun");h["sep"+f++]="------";h.reproject={name:"reproject",
items:{reprojtitle:{name:"wcs from:",disabled:!0}}};for(c=0;c<a.images.length;c++)s!==a.images[c]&&a.images[c].wcs&&(d="reproject_"+a.images[c].id,h.reproject.items[d]={name:a.images[c].id},g++);g||(h.reproject.items.notasks={name:"[none]",disabled:!0,events:{keyup:function(){}}});return{callback:function(c){b().forEach(function(b){var d;d=RegExp(c);if(b=b.image)c.match(/^reproject_/)?(d=c.replace(/^reproject_/,""),b.reprojectData(d)):0<=a.wcssyss.join("@").search(d)?b.setWCSSys(c):0<=a.wcsunitss.join("@").search(d)?
b.setWCSUnits(c):a.error("unknown wcs sys/units: "+c)})},items:h}}});$("#analysisMenu"+g.id).on("mousedown",function(a){a.preventDefault();$("#analysisMenu"+g.id).contextMenu()});$.contextMenu({selector:"#analysisMenu"+g.id,zIndex:a.MENUZINDEX,events:{hide:c},build:function(){var c,d,e,f,h,n=0,q=0,s={};h=b()[0];var t=h.image,v="",u=function(a,c){c.sigma||(c.sigma="none");"none"===c.sigma?(a.params.sigma=c.sigma,a.rawDataLayer("gaussBlur","remove")):(a.params.sigma=parseFloat(c.sigma),a.gaussBlurData(a.params.sigma))},
...
function(c,b,d){var e,f,g,h,j,k,m,p,r,l=[],n={};if((j=this.getShapeLayer(c))&&j.show){k=j.canvas;"main"===this.display.layers[c].dtype?(m=this.rgb.sect.zoom,p=this.binning.bin||1):p=m=1;if("string"===typeof b)e=this.parseRegions(b),b="string"===typeof e?[{shape:e}]:e;else if(!$.isArray(b))if("object"===typeof b)b=[b];else return;if("string"===typeof d)try{g=JSON.parse(d)}catch(q){return a.error("can't parse shape opts: "+d,q),null}else g=d;k.size()||(d=this.display.layers[c],"regions"===c&&d.opts.canvas.zindex++,
...
g)})}return this};a.Fabric.updateShapes=function(c,b,d,e){var f=this;this.selectShapes(c,b,function(b,h){a.Fabric._updateShape.call(f,c,b,h,d,e)});return this};a.Fabric._updateShape=function(c,b,d,e,f){var g,h,j,k,m,p,r,l={},n=this.layers[c],q=function(a){return a.toFixed(1)};d=d||{};f=f||{};p=this.display;j="main"===this.display.layers[c].dtype?this.rgb.sect.zoom:1;l.mode=e||"update";l.id=b.params.id;l.shape=b.params.shape;l.layer=c;l.color=b.stroke;l.tags=b.params.tags;e=b.getCenterPoint();d.group&&
(r=d.group.getCenterPoint(),e={x:e.x+r.x,y:e.y+r.y});r=this.displayToImagePos(e);l.x=r.x;l.y=r.y;l.imsys="image";l.lcs=this.imageToLogicalPos(r);"image"===this.params.wcssys?(k=l.x,m=l.y):(k=l.lcs.x,m=l.lcs.y,l.imsys=l.lcs.sys);l.angle=-b.angle;d.group&&(l.angle-=d.group.angle);for(;0>l.angle;)l.angle+=360;for(;360<l.angle;)l.angle-=360;e=1*(b.scaleX/j);j=1*(b.scaleY/j);d.group&&(e*=d.group.scaleX,j*=d.group.scaleY);switch(l.shape){case "annulus":l.shape="annulus";l.radii=[];l.imstr="annulus("+q(k)+
", "+q(m)+", ";h="annulus "+l.x+" "+l.y+" ";j=b.getObjects();k=j.length;for(d=0;d<k;d++)m=j[d].radius*e,l.imstr+=q(m),h+=l.x+" "+l.y+" "+(l.x+m)+" "+l.y+" ",l.imstr=d===k-1?l.imstr+")":l.imstr+", ",l.radii.push(m);break;case "box":l.shape="box";l.width=b.width*e;l.height=b.height*j;l.imstr="box("+q(k)+", "+q(m)+", "+q(l.width)+", "+q(l.height)+", "+l.angle.toFixed(4)+")";h="box "+l.x+" "+l.y+" "+l.x+" "+l.y+" "+(l.x+l.width)+" "+l.y+" "+l.x+" "+l.y+" "+l.x+" "+(l.y+l.height)+" "+l.angle*Math.PI/180;
break;case "circle":l.radius=b.radius*e;l.imstr="circle("+q(k)+", "+q(m)+", "+q(l.radius)+")";h="circle "+l.x+" "+l.y+" "+l.x+" "+l.y+" "+(l.x+l.radius)+" "+l.y;break;case "ellipse":l.r1=b.width*e/2;l.r2=b.height*j/2;l.imstr="ellipse("+q(k)+", "+q(m)+", "+q(l.r1)+", "+q(l.r2)+", "+l.angle.toFixed(4)+")";h="ellipse "+l.x+" "+l.y+" "+l.x+" "+l.y+" "+(l.x+l.r1)+" "+l.y+" "+l.x+" "+l.y+" "+l.x+" "+(l.y+l.r2)+" "+l.angle*Math.PI/180;break;case "point":l.width=b.width*e;l.height=b.height*j;l.imstr="point("+
q(k)+", "+q(m)+")";h="point "+l.x+" "+l.y;break;case "line":case "polygon":l.imstr=l.shape+"(";h=l.shape+" ";l.pts=[];for(d=0;d<b.points.length;d++)0<d&&(l.imstr+=", ",h+=" "),m={x:l.x+b.points[d].x*e,y:l.y-b.points[d].y*j},m=a.rotatePoint(m,l.angle,{x:l.x,y:l.y}),"image"===this.params.wcssys?l.imstr+=q(m.x)+", "+q(m.y):(k=this.imageToLogicalPos(m),l.imstr+=q(k.x)+", "+q(k.y)),h+=m.x+" "+m.y,l.pts.push(m);l.imstr+=")";break;case "text":l.imstr="text("+q(k)+", "+q(m)+', "'+b.text+'")',l.text=b.text,
h="text "+l.x+" "+l.y+' "'+b.text+'"'}if(this.wcs&&0<this.wcs){if("regions"===c&&!1!==f.dowcsstr||"regions"!==c&&!0===f.dowcsstr)l.wcsstr=a.reg2wcs(this.wcs,h).replace(/;$/,"");h=a.pix2wcs(this.wcs,r.x,r.y).trim().split(/\s+/);l.ra=h[0];l.dec=h[1];l.wcssys=h[2]}l.data=b.params.data;b.set("pub",l);b.params.winid&&($(b.params.winid).is(":visible")?a.Regions.initConfigForm.call(this,b):b.params.winid=null);if(f.nocb)return l;if("regions"===c&&this.params.xeqonchange&&n.show&&this.onregionschange)try{this.params.xeqonchange=
!1,a.xeqByName(this.onregionschange,window,this,l)}catch(s){a.log("error in xeqonchange: %s [%s]\n%s",this.id,s.message,a.strace(s))}finally{this.params.xeqonchange=!0}if(this.params.xeqonchange&&n.show&&n.opts.onchange)try{this.params.xeqonchange=!1,a.xeqByName(n.opts.onchange,window,this,l)}catch(t){a.log("error in onchange: %s [%s]\n%s",this.id,t.message,a.strace(t))}finally{this.params.xeqonchange=!0}f="on"+c+"change";for(g in p.pluginInstances)if(p.pluginInstances.hasOwnProperty(g)&&(c=p.pluginInstances[g],
b=c.plugin.opts,c.isActive(f)))try{b[f].call(c,this,l)}catch(v){c.errLog(f,v)}return l};a.Fabric.removeShapes=function(c,b){var d=this,e,f;if(e=this.getShapeLayer(c))return f=e.canvas,this.selectShapes(c,b,function(b,e){a.Fabric._updateShape.call(d,c,b,e,"remove");e&&e.group&&e.group.remove(b);b.params&&b.params.winid&&b.params.winid.close();f.remove(b)}),f.getActiveGroup()&&f.discardActiveGroup(),f.renderAll(),this};a.Fabric.getShapes=function(a,b){var d=[];this.selectShapes(a,b,function(a){d.push(a.pub||
{})});return d};a.Fabric.changeShapes=function(c,b,d){var e,f,g,h,j,k,m,p,r,l,n,q,s=this;if((j=this.getShapeLayer(c))&&d)return k=j.canvas,"main"===this.display.layers[c].dtype?(n=this.rgb.sect.zoom,q=this.binning.bin||1):q=n=1,m=k.getActiveObject(),this.selectShapes(c,b,function(b,v){h=$.extend(!0,{},b.params,d);g=a.Fabric._parseShapeOptions.call(this,c,h,b);if(g.remove){if(!0===g.remove||"true"===g.remove)g.remove="all";if(!1!==g.remove&&"false"!==g.remove){this.removeShapes(c,g.remove||"all");
return}}switch(b.params.shape){case "text":g.opts.stroke&&(g.opts.fill=g.opts.stroke),g.opts.strokeWidth=0}b.set(g.opts);b.params=$.extend(!1,{},b.params,g.params);switch(b.params.shape){case "annulus":if(d.radii&&d.radii.length){r=b.get("stroke");b.forEachObject(function(a){b.remove(a);k.remove(a)});p=b.params.radii.length;for(e=l=0;e<p;e++)f=new fabric.Circle({radius:b.params.radii[e],stroke:r}),l=Math.max(l,b.params.radii[e]),b.add(f);b.scaleX=n/q;b.scaleY=n/q;b.width=2*l;b.height=2*l;m===b&&k.setActiveObject(b)}break;
case "box":d.width&&(b.scaleX=n/q);d.height&&(b.scaleY=n/q);break;case "circle":d.radius&&(b.scaleX=n/q,b.scaleY=n/q);break;case "ellipse":d.r1&&(b.rx=d.r1,b.scaleX=n/q,b.width=2*b.rx);d.r2&&(b.ry=d.r2,b.scaleY=n/q,b.height=2*b.ry);break;case "line":case "polygon":d.points&&d.points.length&&(b.scaleX=n/q,b.scaleY=n/q),m===b&&(a.Fabric.removePolygonAnchors(j.dlayer,b),a.Fabric.addPolygonAnchors(j.dlayer,b)),a.resetPolygonCenter(b)}b.rescaleBorder();b.setCoords();a.Fabric._updateShape.call(s,c,b,v,
"update")}),(void 0===d.redraw||d.redraw)&&k.renderAll(),this};a.Fabric.refreshShapes=function(c){var b,d,e,f,g,h,j,k,m,p=!1,r=this;if(m=this.getShapeLayer(c))return"main"===this.display.layers[c].dtype&&(p=!0),p?(e=this.binning.bin,f=this.rgb.sect.zoom,g=this.binning.obin/this.rgb.sect.ozoom*f/e,h=this.binning.obin/this.rgb.sect.ozoom*f/e):(e=1,h=g=f=this.rgb.sect.zoom),e=m.canvas,e.getActiveGroup()&&e.discardActiveGroup(),d=e.getActiveObject(),this.selectShapes(c,"all",function(c){b=r.logicalToDisplayPos(c.pub.lcs);
c.setLeft(b.x);c.setTop(b.y);switch(c.params.shape){case "point":case "text":break;default:j=g,k=h,p&&(j*=c.scaleX,k*=c.scaleY),c.scaleX=j,c.scaleY=k,c.rescaleBorder()}c.setCoords();switch(c.type){case "polyline":case "polygon":d===c&&(a.Fabric.removePolygonAnchors(m.dlayer,c),a.Fabric.addPolygonAnchors(m.dlayer,c))}}),p&&(this.binning.obin=this.binning.bin,this.rgb.sect.ozoom=this.rgb.sect.zoom),e&&e.renderAll(),this};a.Fabric.addPolygonPoint=function(c,b,d){var e,f,g,h,j,k,m,p,r,l={},n,q,s,t,v,
u=Number.MAX_VALUE;if(b&&b.points){l=a.eventToDisplayPos(d);d=b.getCenterPoint().x;g=b.getCenterPoint().y;d=(l.x-d)/b.get("scaleX");n=(l.y-g)/b.get("scaleY");for(g=-b.get("angle")*Math.PI/180;g>2*Math.PI;)g-=2*Math.PI;l=Math.cos(g)*d-Math.sin(g)*n;n=Math.sin(g)*d+Math.cos(g)*n;d=b.points;for(g=0;g<d.length;g++)f=d[g],h=d[(g+1)%d.length],j=f.x<h.x?f.x:h.x,k=f.y<h.y?f.y:h.y,m=f.x>h.x?f.x:h.x,p=f.y>h.y?f.y:h.y,e=f.x-h.x,f=f.y-h.y,r=Math.sqrt(e*e+f*f),0!==r&&(e/=r,f/=r),r=l-h.x,v=n-h.y,r=r*e+v*f,e=h.x+
e*r,h=h.y+f*r,e<j?e=j:e>m&&(e=m),h<k?h=k:h>p&&(h=p),j=(e-l)*(e-l)+(h-n)*(h-n),j<u&&(u=j,q=e,s=h,t=g===d.length?0:g);c=this.getShapeLayer(c);a.Fabric.removePolygonAnchors(c.dlayer,b);d.splice(t+1,0,{x:q,y:s});c.canvas.setActiveObject(b)}};a.Fabric.removePolygonPoint=function(c,b){var d,e,f,g;b&&b.polyparams&&(e=b.polyparams.polygon,f=e.points,g=b.polyparams.point,d=this.getShapeLayer(c),a.Fabric.removePolygonAnchors(d.dlayer,e),f.splice(g,1),a.resetPolygonCenter(e),d.canvas.setActiveObject(e))};a.Fabric.addPolygonAnchors=
function(c,b){var d,e,f={},g=c.canvas,h=function(){var b=this.polyparams.polygon,d=this.polyparams.point,e=b.get("points"),h=c.display.image;b.angle?f=a.rotatePoint({x:this.left,y:this.top},-b.angle,{x:b.left,y:b.top}):(f.x=this.left,f.y=this.top);e[d].x=(f.x-b.left)/b.scaleX;e[d].y=(f.y-b.top)/b.scaleY;a.resetPolygonCenter(b);a.Fabric._updateShape.call(h,b.params.layerName,b,null,"update");h&&(h.params.listonchange||b.params.listonchange)&&h.listRegions(b,2);g.renderAll()},j=function(c){var b,d=
{};for(b=0;b<c.params.anchors.length;b++)d.x=c.left+c.points[b].x*c.scaleX,d.y=c.top+c.points[b].y*c.scaleY,c.angle&&(d=a.rotatePoint(d,c.angle,{x:c.left,y:c.top})),c.params.anchors[b].set({left:d.x,top:d.y,angle:c.angle}),c.params.anchors[b].setCoords();c._calcDimensions(!0);g.renderAll()};if(!b.params.anchors){b.params.anchors=[];for(d=0;d<b.points.length;d++)f.x=b.left+b.points[d].x*b.scaleX,f.y=b.top+b.points[d].y*b.scaleY,b.angle&&(f=a.rotatePoint(f,b.angle,b.getCenterPoint())),e=new fabric.Rect({left:f.x,
top:f.y,hasControls:!1,hasRotatingPoint:!1,hasBorders:!1,selectable:!0,fill:b.get("stroke"),hoverCursor:"pointer",width:a.Fabric.opts.cornerSize,height:a.Fabric.opts.cornerSize,padding:2}),e.on("moving",h),e.polyparams={},e.polyparams.polygon=b,e.polyparams.point=d,b.params.anchors[d]=e,g.add(e);b.on("moving",function(){j(b)});b.on("rotating",function(){j(b)});b.on("scaling",function(){j(b)});b.setCoords()}};a.Fabric.removePolygonAnchors=function(a,b){var d,e=a.canvas;if(b.params&&b.params.anchors){for(d=
0;d<b.params.anchors.length;d++)e.remove(b.params.anchors[d]);delete b.params.anchors}};a.resetPolygonCenter=function(c){var b,d,e,f={};c._calcDimensions();d=(c.minX+c.width/2)*c.scaleX;b=(c.minY+c.height/2)*c.scaleY;c.angle?f=a.rotatePoint({x:c.left+d,y:c.top+b},c.angle,{x:c.left,y:c.top}):(f.x=c.left+d,f.y=c.top+b);if(5<=fabric.version.split(".")[1]){d/=c.scaleX;e=b/c.scaleY;for(b=0;b<c.points.length;b++)c.points[b].x-=d,c.points[b].y-=e}c.left=f.x;c.top=f.y;c.setCoords()};a.Fabric.print=function(){var c,
b,d;b=sprintf("width=%s,height=%s,menubar=1,toolbar=1,status=0,scrollbars=1,resizable=1",this.display.canvasjq.attr("width"),this.display.canvasjq.attr("height"));d=this.display.canvas.toDataURL("image/png");if(b=window.open(null,this.id,b)){b.document.open();b.document.write("<html><body style='padding: 0px; margin: 0px' onload='window.print(); return false'>");b.document.write("<div style='position: absolute'>");b.document.write("<img src='");b.document.write(d);b.document.write("' />");b.document.write("</div>");
for(c in this.layers)this.layers.hasOwnProperty(c)&&("main"===this.layers[c].dlayer.dtype&&this.layers[c].show)&&(b.document.write("<div style='position: absolute'>"),b.document.write(this.layers[c].dlayer.canvas.toSVG()),b.document.write("</div>"));b.document.write("</body></html>");b.document.close()}else a.log("warning: could not create print window (check your pop-up blockers)")};a.Fabric.initGraphics=function(){var c;a.Display.prototype.newShapeLayer=a.Fabric.newShapeLayer;a.Image.prototype.addShapes=
a.Fabric.addShapes;a.Image.prototype.selectShapes=a.Fabric.selectShapes;a.Image.prototype.updateShapes=a.Fabric.updateShapes;a.Image.prototype.updateShape=a.Fabric._updateShape;a.Image.prototype.getShapes=a.Fabric.getShapes;a.Image.prototype.changeShapes=a.Fabric.changeShapes;a.Image.prototype.removeShapes=a.Fabric.removeShapes;a.Image.prototype.refreshShapes=a.Fabric.refreshShapes;a.Image.prototype.getShapeLayer=a.Fabric.getShapeLayer;a.Image.prototype.showShapeLayer=a.Fabric.showShapeLayer;a.Image.prototype.displayShapeLayers=
a.Fabric.displayShapeLayers;a.Image.prototype.print=a.Fabric.print;for(c in a.Fabric.opts)a.Fabric.opts.hasOwnProperty(c)&&(fabric.Object.prototype[c]=a.Fabric.opts[c])};a.Fabric.initGraphics();a.Regions={};a.Regions.CLASS="JS9";a.Regions.NAME="Regions";a.Regions.opts={canvas:{zindex:a.SHAPEZINDEX+2},panzoom:!0,tags:"source,include",strokeWidth:2,iradius:0,oradius:30,nannuli:10,width:60,height:60,radius:30,r1:30,r2:20,ptshape:"box",ptsize:2,linepoints:[{x:-30,y:30},{x:30,y:-30}],polypoints:[{x:-30,
y:30},{x:30,y:30},{x:0,y:-30}],fontFamily:"Helvetica",fontSize:14,fontStyle:"normal",fontWeight:300,textAlign:"left",angle:0,aradius1:4,aradius2:8,configURL:"./params/regionsconfig.html",tagcolors:{include_source:"#00FF00",exclude_source:"#FF0000",include_background:"#FFD700",exclude_background:"#FF8C00",source:"#00FF00",background:"#FFD700",defcolor:"#00FF00"},onmousedown:function(c,b,d,e){var f;!a.specialKey(d)&&e.params&&(b=(new Date).getTime(),e.params.lasttime&&b-e.params.lasttime<a.DBLCLICK&&
(f=!0),e.params.lasttime=b);f?e.params.winid||($("#dhtmlwindowholder").arrive("#regionsConfigForm",{onceOnly:!0},function(){e.pub&&a.Regions.initConfigForm.call(c,e)}),e.params.winid=a.allinone?c.displayAnalysis("params",a.allinone.regionsConfigHTML,"Region Configuration"):c.displayAnalysis("params",a.InstallDir(a.Regions.opts.configURL),"Region Configuration")):a.specialKey(d)&&("polygon"===e.type||"polyline"===e.type?(a.Fabric.addPolygonPoint.call(c,e.params.layerName,e,d),a.Fabric._updateShape.call(c,
e.params.layerName,e,null,"update")):e.polyparams&&e.polyparams.polygon&&(f=e.polyparams.polygon,a.Fabric.removePolygonPoint.call(c,f.params.layerName,e,d),a.Fabric._updateShape.call(c,f.params.layerName,f,null,"update")))},onmouseup:function(){var a,b=[];this.getActiveObject()&&b.push(this.getActiveObject());this.getActiveGroup()&&(b=this.getActiveGroup().getObjects());for(a=0;a<b.length;a++)b[a].polyparams&&this.setActiveObject(b[a].polyparams.polygon)},onchange:null};a.Regions.init=function(c){var b;
a.Image.prototype.parseRegions=a.Regions.parseRegions;a.Image.prototype.saveRegions=a.Regions.saveRegions;a.Image.prototype.listRegions=a.Regions.listRegions;b=this.display.newShapeLayer(c||"regions",a.Regions.opts);b.canvas.on("mouse:up",function(){var a,c,f=[];if(b.display.image){c=b.display.image;this.getActiveObject()&&f.push(this.getActiveObject());this.getActiveGroup()&&(f=this.getActiveGroup().getObjects());for(a=0;a<f.length;a++)if(f[a].params){c.params.listonchange?c.listRegions("all",2):
f[a].params.listonchange&&c.listRegions("selected",2);break}}});return this};a.Regions.onchange=function(c,b){if(a.Regions.opts.onchange&&"function"===typeof a.Regions.opts.onchange)try{a.Regions.opts.onchange(c,b)}catch(d){}};a.Regions.initConfigForm=function(a){var b,d,e=a.params.winid,f="#"+$(e).attr("id")+" #regionsConfigForm ";$(f+"."+a.pub.shape).each(function(){$(this).removeClass("nodisplay")});$(f+".val").each(function(){d="";b=$(this).attr("name");switch(b){case "pts":a.pub.pts?a.pub.pts.forEach(function(a){d&&
(d+=", ");d+=sprintf("%s, %s",a.x,a.y)}):a.pub.imstr&&(d=a.pub.imstr.replace(/^.*\(/,"").replace(/\)$/,""));break;default:void 0!==a.pub[b]&&(d=a.pub[b])}$(this).val(d)});a.pub.wcsstr&&$(f+".wcs").removeClass("nodisplay");void 0===a.params.listonchange&&(a.params.listonchange=!1);a.params.listonchange?$(f+"[name='listonchange']").attr("checked","checked"):$(f+"[name='listonchange']").removeAttr("checked");void 0===a.params.fixinplace&&(a.params.fixinplace=!1);a.params.fixinplace?$(f+"[name='fixinplace']").attr("checked",
"checked"):$(f+"[name='fixinplace']").removeAttr("checked");switch(a.pub.shape){case "box":case "ellipse":case "line":case "polygon":case "text":$(f+".angle").removeClass("nodisplay")}$(f).data("im",this);$(f).data("shape",a);$(f).data("winid",e)};a.Regions.processConfigForm=function(c,b,d){var e,f,g,h=d.length,j={},k=function(a,c,b){return"remove"===c||void 0!==a.pub[c]&&String(a.pub[c])!==b||void 0!==a.params[c]&&String(a.params[c])!==b?!0:!1},m=function(a){return"true"===a?!0:"false"===a?!1:""===
a||isNaN(a)?a:parseFloat(a)};for(e=0;e<h;e++)switch(f=d[e].name,g=d[e].value,f){case "x":k(c,f,g)&&(j[f]=m(g),void 0===j.y&&(j.y=c.pub.y));break;case "y":k(c,f,g)&&(j[f]=m(g),void 0===j.x&&(j.x=c.pub.x));break;default:k(c,f,g)&&(j[f]=m(g))}this.changeShapes(c.pub.layer,c,j);a.Regions.initConfigForm.call(this,c,b)};a.Regions.listRegions=function(a,b){var d,e,f,g,h,j,k="",m="none",p=!1,r=[];void 0===b&&(b=2);r=this.getShapes("regions",a);f=r.length;if(b)for(d=0;d<f;d++)if(e=r[d],"source,include"!==
e.tags.join(",")){p=!0;break}for(d=0;d<f;d++)e=r[d],h=e.tags.join(","),j=0<=h.indexOf("exclude")?"-":"",p&&(g=" # "+h),e.wcsstr&&"image"!==this.params.wcssys&&"physical"!==this.params.wcssys?("wcs"!==m&&("none"!==m&&(k+="; "),k+=this.params.wcssys,m="wcs"),k+="; "+j+e.wcsstr):e.imstr&&(m!==e.imsys&&("none"!==m&&(k+="; "),k+=e.imsys,m=e.imsys),k+="; "+j+e.imstr),p&&(k+=g);1<b&&this.displayMessage("regions",k);return k};a.Regions.parseRegions=function(c){var b=[],d,e,f,g,h,j,k,m,p,r,l,n,q=/(annulus)|(box)|(circle)|(ellipse)|(line)|(polygon)|(point)|(text)/,
s=/(fk4)|(fk5)|(icrs)|(galactic)|(ecliptic)|(image)|(physical)/,t=/\(\s*([^)]+?)\s*\)/,v=/(\{[^}]*\})/,u=/\s*,\s*/,w=function(c){c=a.saostrtod(c);var b=String.fromCharCode(a.saodtype());switch(b){case '"':c/=3600;break;case "'":c/=60;break;case "r":c*=180/Math.PI}return{dval:c,dtype:b}},y=function(c,b){var d,e;e=w(c);d=w(b);if(":"===e.dtype||":"===d.dtype)p=!0;m||p?(":"===e.dtype&&("galactic"!==k&&"ecliptic"!==k)&&(e.dval*=15),d=a.wcs2pix(this.wcs,e.dval,d.dval).split(/ +/),e=parseFloat(d[0])-1,d=
parseFloat(d[1])-1):"physical"===k?(d=this.logicalToImagePos({x:e.dval,y:d.dval}),e=d.x,d=d.y):(e=e.dval,d=d.dval);return[e,d]},x=function(a,c){var b=w(a);if((m||p)&&b.dtype&&"."!==b.dtype)b.dval=Math.abs(b.dval/l["cdelt"+c]);return b.dval};c=c.trim();if(!c.match(/(\(|\{|#|;|\n)/))return c;try{l=JSON.parse(a.wcsinfo(this.wcs))}catch(z){l={cdelt1:1,cdelt2:1,crot:0,imflip:0}}j=this.getWCSSys();k="physical";this.setWCSSys(k);m="image"!==k&&"physical"!==k;f=c.split(/\n|;/);for(c=0;c<f.length;c++)if("#"!==
f[c].trim().substr(0,1)){p=!1;g=f[c];h=void 0;d={opts:{},args:[],isregion:0};d.cmd=0<=g.indexOf("(")?g.split("(")[0].trim().toLowerCase():0<=g.indexOf("{")?g.split("{")[0].trim().toLowerCase():0<=g.indexOf("#")?g.split("#")[0].trim().toLowerCase():g.trim().toLowerCase();d.cmd&&(d.isregion=0<=d.cmd.search(q));d.comment=g.split("#")[1];d.comment&&(d.comment=d.comment.trim().toLowerCase());if((h=v.exec(g))&&h[1])try{d.opts=JSON.parse(h[1].trim())}catch(B){d.opts={}}if((h=t.exec(g))&&h[1])d.args=h[1].split(u);
d.isregion&&0===d.cmd.indexOf("-")&&(d.cmd=d.cmd.slice(1),d.comment=d.comment?d.comment+",exclude":"exclude");h=d;n=h.args.length;if(h.isregion){g=$.extend(!0,{},h.opts);g.shape=h.cmd;2<=n&&(r=y.call(this,h.args[0],h.args[1]),g.x=r[0],g.y=r[1]);switch(h.cmd){case "annulus":g.radii=[];for(d=2;d<n;d++)g.radii.push(x.call(this,h.args[d],1));break;case "box":3<=n&&(g.width=x.call(this,h.args[2],1));4<=n&&(g.height=x.call(this,h.args[3],2));5<=n&&(g.angle=w(h.args[4]).dval);break;case "circle":3<=n&&(g.radius=
x.call(this,h.args[2],1));break;case "ellipse":3<=n&&(g.r1=x.call(this,h.args[2],1));4<=n&&(g.r2=x.call(this,h.args[3],2));5<=n&&(g.angle=w(h.args[4]).dval);break;case "line":case "polygon":g.pts=[];for(e=d=0;d<n;d+=2,e++)r=y.call(this,h.args[d],h.args[d+1]),g.pts[e]={x:r[0],y:r[1]};delete g.x;delete g.y;break;case "text":3<=n&&(d=g,e=h.args[2].replace(/^['"]/,"").replace(/['"]$/,""),d.text=e)}h.comment&&(g.tags=h.comment);b.push(g)}else h.cmd.match(s)?(this.setWCSSys(h.cmd),k=this.getWCSSys(),m=
"image"!==k&&"physical"!==k):("remove"===h.cmd||"delete"===h.cmd)&&b.push({remove:!0})}this.setWCSSys(j);return b};a.Regions.saveRegions=function(c){var b=sprintf("# Region file format: JS9 version 1.0");c=this.listRegions(c,1);b=sprintf("%s\n%s\n",b,c.replace(/; */g,"\n"));b=new Blob([b],{type:"text/plain;charset=utf-8"});window.hasOwnProperty("saveAs")?saveAs(b,"js9.reg"):a.error("no saveAs function available to save region file");return c};a.Regions.keyDownCB=function(a,b,d,e){var f,g;b={evt:d};
var h=d.which||d.keyCode;e=e||"regions";g=a.display.layers[e].canvas;switch(h){case 8:case 46:d.preventDefault();f="removeRegion";break;case 37:d.preventDefault();f="editRegion";b.dx=-1;break;case 38:d.preventDefault();f="editRegion";b.dy=1;break;case 39:d.preventDefault();f="editRegion";b.dx=1;break;case 40:d.preventDefault();f="editRegion";b.dy=-1;break;case 68:f="downRegion";break;case 85:f="upRegion"}switch(f){case "removeRegion":a.removeShapes(e,"selected");a.clearMessage(e);g.fire("mouse:up");
break;case "editRegion":a.changeShapes(e,"selected",b);g.fire("mouse:up");break;case "downRegion":a.selectShapes(e,"selected",function(a){g.sendToBack(a)});break;case "upRegion":a.selectShapes(e,"selected",function(a){g.bringToFront(a)})}};a.Magnifier={};a.Magnifier.CLASS="JS9";a.Magnifier.NAME="Magnifier";a.Magnifier.opts={originX:"left",originY:"top",hasControls:!1,hasRotatingPoint:!1,hasBorders:!1,selectable:!1,zoom:4,canvas:{selection:!1},tagcolors:{defcolor:"#00FF00"}};a.Magnifier.HTML="<span><button type='button' class='JS9Button' onClick='JS9.bcall(this, \"zoomMagnifier\", \"x2\"); return false'>x2</button><button type='button' class='JS9Button' onClick='JS9.bcall(this, \"zoomMagnifier\", \"/2\"); return false'>/2</button><button type='button' class='JS9Button' onClick='JS9.bcall(this, \"zoomMagnifier\", \""+
...
b.panner.ix)*b.panner.xblock/b.panner.zoom+b.panner.x0;h=(d.canvas.height-(h.y+b.panner.iy))*b.panner.yblock/b.panner.zoom+b.panner.y0;try{b.display.pluginInstances.JS9Panner.status="inactive",b.setPan(c,h)}catch(j){a.log("couldn't pan image",j)}finally{b.display.pluginInstances.JS9Panner.status="active"}}});this.display.image&&a.Panner.display(this.display.image)};a.Panner.create=function(a){var b,d,e,f,g,h,j,k,m,p,r,l,n;if(a&&a.raw&&a.display.pluginInstances.JS9Panner){a.panner||(a.panner={});a.panner.zoom||
(a.panner.zoom=1);b=a.display.pluginInstances.JS9Panner;d=a.panner;e=a.rgb.sect;l=Math.min(a.raw.width,b.width);n=Math.min(a.raw.height,b.height);d.xblock=a.raw.width/l;d.yblock=a.raw.height/n;d.xblock>d.yblock?(n=Math.floor(n/d.xblock*d.yblock+0.5),d.yblock=d.xblock):d.yblock>d.xblock&&(l=Math.floor(l/d.yblock*d.xblock+0.5),d.xblock=d.yblock);b=a.display.context.createImageData(l,n);1===d.zoom?(g=d.xblock,h=d.yblock,e=f=0):(g=d.xblock/d.zoom,h=d.yblock/d.zoom,f=Math.max(0,(e.x0+e.x1-l*g)/2),e=Math.max(0,
(e.y0+e.y1-n*h)/2));d.x0=f;d.y0=e;d.img=b;d.ix=0;d.iy=0;if(a.rgbFile){for(j=0;j<n;j++){m=Math.floor(e+j*h)*a.offscreen.img.width;p=j*l;for(d=0;d<l;d++)k=Math.floor(f+d*g),k=4*(k+m),r=4*(p+d),b.data[r]=a.offscreen.img.data[k],b.data[r+1]=a.offscreen.img.data[k+1],b.data[r+2]=a.offscreen.img.data[k+2],b.data[r+3]=255}return a}for(j=0;j<n;j++){m=Math.floor(e+(n-j-1)*h)*a.raw.width;p=j*l;for(d=0;d<l;d++)k=Math.floor(f+d*g),k=a.colorData[k+m],r=4*(p+d),a.psColors[k]&&(b.data[r]=a.psColors[k][0],b.data[r+
1]=a.psColors[k][1],b.data[r+2]=a.psColors[k][2],b.data[r+3]=255)}return a}};a.Panner.display=function(c){var b,d,e,f,g,h,j;if(c&&(c.display.pluginInstances.JS9Panner&&"active"===c.display.pluginInstances.JS9Panner.status)&&(a.Panner.create(c),d=c.panner,b=c.display.pluginInstances.JS9Panner,e=c.rgb.sect,d.img))return d.img.width<b.canvas.width&&(d.ix=Math.floor((b.canvas.width-d.img.width)/2)),d.img.height<b.canvas.height&&(d.iy=Math.floor((b.canvas.height-d.img.height)/2)),b.context.clear(),b.context.putImageData(d.img,
...
else{g.blendMode&&(g.blendMode=0);if(!a.specialKey(c))for(b in g.pluginInstances)if(g.pluginInstances.hasOwnProperty(b)&&(d=g.pluginInstances[b],e=d.plugin.opts,d.isActive("onmousedown")&&(!h.rclick||e.mousedownRegions)))try{e.onmousedown.call(d,h,f,c.originalEvent||c)}catch(j){d.errLog("onmousedown",j)}h.evstate=c.button;c.originalEvent&&(c.originalEvent.touches&&c.originalEvent.touches.length)&&(h.evstate=c.originalEvent.touches.length-2);$("body").on("mousemove",g,function(b){return a.mouseMoveCB(b)});
$("body").on("mouseup",g,function(b){return a.mouseUpCB(b)})}};a.mouseUpCB=function(c){var b,d,e,f,g=c.data,h=g.image;if(h){b=a.eventToDisplayPos(c);g.inResize(b)||c.preventDefault();2<a.DEBUG&&a.log("m-up: %d %d %s",b.x,b.y,h.rclick);d=h.displayToImagePos(b);h.rclick?h.dnpos&&Math.abs(h.dnpos.x-b.x)<a.NOMOVE&&Math.abs(h.dnpos.y-b.y)<a.NOMOVE?h.updateShapes("regions","selected","select"):h.updateShapes("regions","selected","update"):a.specialKey(c)&&(h.dnpos&&Math.abs(h.dnpos.x-b.x)<a.NOMOVE&&Math.abs(h.dnpos.y-
b.y)<a.NOMOVE)&&h.setPan(d.x,d.y);0===g.blendMode&&(g.blendMode=!0,h.displayImage("rgb"));if(!a.specialKey(c))for(e in g.pluginInstances)if(g.pluginInstances.hasOwnProperty(e)&&(b=g.pluginInstances[e],f=b.plugin.opts,b.isActive("onmouseup")&&(!h.rclick||f.mouseupRegions)))try{f.onmouseup.call(b,h,d,c.originalEvent||c)}catch(j){b.errLog("onmouseup",j)}h.rclick=0;h.evstate=-1;g.resizing&&(g.resizing=0,a.bugs.webkit_resize&&(c=parseInt(g.divjq.css("width"),10),d=parseInt(g.divjq.css("height"),10),c<
g.owidth&&g.divjq.css("width",g.owidth+a.RESIZEFUDGE),d<g.oheight&&g.divjq.css("height",g.oheight+a.RESIZEFUDGE)));$("body").off("mouseup");$("body").off("mousemove")}};a.mouseMoveCB=function(c){var b,d,e,f,g=c.data,h=g.image;if(h&&!g.resizing){b=a.eventToDisplayPos(c);g.inResize(b)||c.preventDefault();3<a.DEBUG&&a.log("m-move: %d %d %s",b.x,b.y,h.rclick);d=h.displayToImagePos(b);h.valpos=null;if(h.rclick&&(h.rclick=2,(f=h.display.layers.regions.params.sel)&&(h.params.listonchange||f.params.listonchange)))h.updateShape("regions",
f,null,"update",!0),h.listRegions("selected",2);switch(h.evstate){case -1:if(0<d.x&&(0<d.y&&d.x<h.raw.width&&d.y<h.raw.height)&&!a.specialKey(c))for(e in a.globalOpts.internalValPos&&(h.valpos=h.updateValpos(d)),g.pluginInstances)if(g.pluginInstances.hasOwnProperty(e)&&(b=g.pluginInstances[e],f=b.plugin.opts,b.isActive("onmousemove")&&(!h.rclick||f.mousemoveRegions)))try{f.onmousemove.call(b,h,d,c.originalEvent||c)}catch(j){b.errLog("onmousemove",j)}break;case 0:case 1:if(!a.globalOpts.internalContrastBias)break;
if(h.rclick||a.specialKey(c))break;if(h.rgbFile)break;if(h.dnpos&&Math.abs(h.dnpos.x-b.x)<a.NOMOVE&&Math.abs(h.dnpos.y-b.y)<a.NOMOVE)break;d.x=Math.floor(b.x+0.5);d.y=Math.floor(b.y+0.5);if(0>d.x||0>d.y||d.x>=g.canvas.width||d.y>=g.canvas.height)break;h.params.bias=d.x/g.canvas.width;h.params.contrast=10*(d.y/g.canvas.height);a.bugs.firefox_linux?window.setTimeout(function(){h.displayImage("scaled")},0):h.displayImage("scaled")}}};a.mouseOverCB=function(c){var b,d,e,f,g=c.data,h=g.image;b=$(document).scrollLeft();
e=$(document).scrollTop();c.preventDefault();if(h&&(h.display.displayConjq.focus(),window.scrollTo(b,e),!a.specialKey(c)))for(d in b=a.eventToDisplayPos(c),b=h.displayToImagePos(b),g.pluginInstances)if(g.pluginInstances.hasOwnProperty(d)&&(e=g.pluginInstances[d],f=e.plugin.opts,e.isActive("onmouseover")&&(!h.rclick||f.mouseoverRegions)))try{f.onmouseover.call(e,h,b,c.originalEvent||c)}catch(j){e.errLog("onmouseover",j)}};a.mouseOutCB=function(c){var b,d,e,f,g=c.data,h=g.image;c.preventDefault();if(h&&
...
e.isActive("onkeydown")))try{f.onkeydown.call(e,h,b,c.originalEvent||c)}catch(j){e.errLog("onkeydown",j)}h.layer&&h.layers[h.layer].opts.usekeyboard&&a.Regions.keyDownCB(h,b,c,h.layer)};a.dragenter=function(a,b){b.stopPropagation();b.preventDefault()};a.dragover=function(a,b){b.stopPropagation();b.preventDefault()};a.dragexit=function(a,b){b.stopPropagation();b.preventDefault()};a.dragdrop=function(c,b,d){var e=b.target.files||b.dataTransfer.files,f=$.extend(!0,{},a.fits.options);b.stopPropagation();
b.preventDefault();void 0===f.display&&(f.display=c);void 0===f.extlist&&(f.extlist=a.globalOpts.extlist);a.onFileList(e,f,d)};a.consoleKeyDownCB=function(c){var b=c.data,d=c.which||c.keyCode;if(!a.specialKey(c)){c=b.consoleConjq.find(".JS9CmdIn:last");c.focus();if(b.hist.length&&(38===d||40===d)){b.hist[b.histpos]?b.hist[b.histpos]=c.val():b.histtemp=c.val();switch(d){case 38:b.histpos--;0>b.histpos&&(b.histpos=0);break;case 40:b.histpos++;b.histpos>b.hist.length&&(b.histpos=b.hist.length);break;
...
window.addEventListener("message",function(b){var c;b=b.data;if("string"===typeof b)try{c=JSON.parse(b)}catch(d){a.error("can't parse msg: "+b,d)}else"object"===typeof b?c=b:a.error("invalid msg from postMessage");(b=a.msgHandler(c))&&parent.postMessage({cmd:c.cmd,res:b},"*")},!1);a.DEBUG=a.DEBUG||a.globalOpts.debug||0;window.hasOwnProperty("Astroem")&&(a.vmalloc=Astroem.vmalloc,a.vfree=Astroem.vfree,a.vheap=Astroem.vheap,a.vmemcpy=Astroem.vmemcpy,a.vfile=Astroem.vfile,a.vunlink=Astroem.vunlink,a.arrfile=
Astroem.arrfile,a.initwcs=Astroem.initwcs,a.wcsinfo=Astroem.wcsinfo,a.wcssys=Astroem.wcssys,a.wcsunits=Astroem.wcsunits,a.pix2wcs=Astroem.pix2wcs,a.wcs2pix=Astroem.wcs2pix,a.reg2wcs=Astroem.reg2wcs,a.saostrtod=Astroem.saostrtod,a.saodtype=Astroem.saodtype,a.zscale=Astroem.zscale,a.reproject=Astroem.reproject);window.hasOwnProperty("Fitsy")?(a.fitsLibrary("fitsy"),a.fits=Fitsy):window.hasOwnProperty("Astroem")&&(a.fitsLibrary("cfitsio"),a.fits=Astroem);$("div.JS9").each(function(){a.checkNew(new a.Display($(this)))});
