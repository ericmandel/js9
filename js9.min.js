...
FK5:"sexagesimal",ICRS:"sexagesimal",galactic:"degrees",ecliptic:"degrees",linear:"degrees",physical:"pixels",image:"pixels"},wcsSetUpdatesDef:!0,regionTemplates:".reg",sessionTemplates:".ses,.js9ses",colormapTemplates:".cmap",catalogTemplates:".cat,.tab",localTemplates:".fits,.fts",controlsMatchRegion:!1,internalColorPicker:!0,newWindowWidth:530,newWindowHeight:625,debug:0};a.favorites={scales:["linear","log","histeq"],colormaps:["cool","heat","viridis","magma"],regions:["annulus","box","circle",
"ellipse"],wcs:["FK5","ICRS","galactic:Galactic","physical","image"]};a.desktopOpts={currentPath:!0,sessionPath:!0};a.imageOpts={inherit:!1,contrast:1,bias:.5,invert:!1,exp:1E3,colormap:"grey",scale:"linear",scaleclipping:"dataminmax",scalemin:Number.NaN,scalemax:Number.NaN,flip:"none",rot90:0,rotate:0,zscalecontrast:.25,zscalesamples:600,zscaleline:120,wcssys:"native",lcs:"physical",valpos:!0,sigma:"none",opacity:1,alpha:255,nancolor:"#000000",nocolor:{red:0,green:0,blue:0,alpha:0},zoom:1,zooms:6,
...
"width=660px,height=470px,resize=1,scrolling=1");window.hasOwnProperty("Jupyter")&&(a.globalOpts.useWasm=!1);if(window.isElectron){"Chrome"===a.BROWSER[0]&&66<=parseFloat(a.BROWSER[1])&&(a.globalOpts.allowFileWasm=!0);if(!window.electronVersion||5>parseInt(window.electronVersion,10))a.globalOpts.internalColorPicker=!1;a.hasNode="object"===typeof process&&"function"===typeof require;a.hasNode&&(a.localMount=require("os").hostname()||"localAccess");window.multiElectron&&(a.globalOpts.localStorage=!1);
window&&"function"===typeof window.eval&&(window.eval=function(){throw Error("For security reasons, Desktop JS9 does not support window.eval()");})}a.Image=function(c,b,d){var e=this,f=null,h=0,g=0,k=function(b){b=b||{};a.isNull(b.scaleclipping)?"zscale"===e.params.scaleclipping?e.zscale(!0):"zmax"===e.params.scaleclipping&&e.zscale("zmax"):"zscale"===b.scaleclipping?e.zscale(!0):"zmax"===b.scaleclipping&&e.zscale("zmax");a.notNull(b.scalemin)&&(e.params.scalemin=b.scalemin);a.notNull(b.scalemax)&&
...
this.xeqPlugins("image","onrawdata");return this}};a.Image.prototype.mkRawDataFromPNG=function(){var c,b,d;var e=b=0;var f=[];var h=new ArrayBuffer(8);var g=new Uint8Array(h),k=new DataView(h);if(!this.offscreen.img)return this;this.raws.push({from:"png"});this.raw=this.raws[this.raws.length-1];this.raw.id=a.RAWID0;var l=this.offscreen.img.data;for(c=h=0;h<l.length&&0!==l[h];h++)if(255!==l[h]&&(f[c]=String.fromCharCode(l[h]),c++),15===c&&'{"js9Protocol":'!==f.join("")){var m=!0;break}if(15>c||m)this.mkRawDataFromIMG(this.offscreen.img);
else{c=f.join("");2<a.DEBUG&&a.log("jsonHeader: %s",c);try{var n=JSON.parse(c)}catch(q){a.error("can't read FITS header from PNG file: "+c,q)}if(1===n.js9Protocol)this.raw.header=n,this.raw.endian=this.raw.header.js9Endian,this.raw.protocol=this.raw.header.js9Protocol;else for(this.raw.endian=n.js9Endian,this.raw.protocol=n.js9Protocol,this.raw.cardstr=n.cardstr,this.raw.ncard=n.ncard,this.raw.header={},n=this.raw.ncard,c=0;c<n;c++)m=this.raw.cardstr.slice(80*c,80*(c+1)),m=a.cardpars(m),void 0!==
...
e=0;e<f;e++)h=this.raw.cardstr.slice(80*e,80*(e+1)),h=a.cardpars(h),void 0!==h&&("HISTORY"===h[0]?this.raw.header[h[0]+"__"+g++]=h[1]:"COMMENT"===h[0]?this.raw.header[h[0]+"__"+k++]=h[1]:this.raw.header[h[0]]=h[1]);else this.raw.header={},this.raw.header.SIMPLE=!0,this.raw.header.NAXIS=2,this.raw.header.NAXIS1=this.raw.width,this.raw.header.NAXIS2=this.raw.height,this.raw.header.BITPIX=this.raw.bitpix;e=this.raw.header;m||this.parentFile||this.parent||void 0===e.LTV1&&void 0===e.LTV2&&void 0===e.LTM1_1&&
void 0===e.LTM2_2||(this.parent={},this.parent.raw={header:$.extend(!0,{},e)},this.parent.lcs={},a.Image.prototype.initLCS.call(this.parent,this.parent.raw.header));if("image"===l.imtab&&void 0!==l.x1&&1!==l.x1||void 0!==l.y1&&1!==l.y1||void 0===l.bin||1!==l.bin)g=a.defNull(l.x1,1),k=a.defNull(l.y1,1),f=l.bin||1,0>f&&(f=1/Math.abs(f)),a.notNull(e.NAXIS1)&&(e.NAXIS1/=f),a.notNull(e.NAXIS2)&&(e.NAXIS2/=f),a.notNull(e.CRPIX1)&&(e.CRPIX1=(e.CRPIX1+1-g-.5)/f+.5),a.notNull(e.CRPIX2)&&(e.CRPIX2=(e.CRPIX2+
1-k-.5)/f+.5),a.notNull(e.CDELT1)&&(e.CDELT1*=f),a.notNull(e.CDELT2)&&(e.CDELT2*=f),a.notNull(e.CD1_1)&&(e.CD1_1*=f),a.notNull(e.CD1_2)&&(e.CD1_2*=f),a.notNull(e.CD2_1)&&(e.CD2_1*=f),a.notNull(e.CD2_2)&&(e.CD2_2*=f),e.LTM1_1=a.defNull(e.LTM1_1,1),e.LTM1_1/=f,e.LTM2_1=e.LTM2_1||0,e.LTM2_1/=f,e.LTM1_2=e.LTM1_2||0,e.LTM1_2/=f,e.LTM2_2=a.defNull(e.LTM2_2,1),e.LTM2_2/=f,e.LTV1=e.LTV1||0,e.LTV1=(e.LTV1-g)/f+.5,e.LTV2=e.LTV2||0,e.LTV2=(e.LTV2-k)/f+.5;b.lcsUseRota2&&(e.LCSROTA2=!0);b.file&&b.file!==this.file?
...
if(f.nocb)return g;if(!b.params.parent&&!e.match(l)){if(this.params.xeqonchange&&k.show&&k.opts.onchange)try{this.params.xeqonchange=!1,a.xeqByName(k.opts.onchange,window,this,g)}catch(z){a.log("error in onchange: %s [%s]\n%s",this.id,z.message,a.strace(z))}finally{this.params.xeqonchange=!0}this.xeqPlugins("shape","on"+c+"change",g)}if("regions"===c&&a.globalOpts.regionsToClipboard){switch(e){case "add":case "select":case "update":d=g.parent||g.id;break;default:d=null}if(a.notNull(d)){try{var B=
this.listRegions(d,{mode:1,includedcoords:!0})}catch(z){B=null}B&&(a.clipboard=B)}}return g};a.Fabric.removeShapes=function(c,b,d){var e=this,f,h={mode:1,includedcoords:!0},g=[];if(f=this.getShapeLayer(c)){var k=f.canvas;d=d||{};"regions"===c&&a.globalOpts.unremoveReg&&(this.regstack.push(this.listRegions(b,h,c)),this.regstack.length>a.globalOpts.unremoveReg&&(this.regstack=this.regstack.slice(0,a.globalOpts.unremoveReg)));this.selectShapes(c,b,function(b,f){if(!(!1===b.params.removable&&!d.overrideRemovable||
b.params.sticky&&!1===d.sticky)){a.Fabric._updateShape.call(e,c,b,f,"remove");b.params.winid&&(b.params.winid.close(),b.params.winid=null);if(b.params.parent){var h=b.params.parent.obj;for(f=h.params.children.length-1;0<=f;f--)if(b===h.params.children[f].obj){h.params.children.splice(f,1);break}}for(f=0;f<b.params.children.length;f++)h=b.params.children[f].obj,g.push(h);g.push(b)}});for(b=0;b<g.length;b++)k.remove(g[b]);1===fabric.major_version?k.getActiveGroup()&&k.discardActiveGroup():k.discardActiveObject();
k.renderAll();!k.getObjects().length&&a.globalOpts.resetEmptyShapeId&&(f.nshape=0);return this}};a.Fabric.getShapes=function(c,b,d){var e={},f=[];d=d||{};if("string"===typeof d)try{d=JSON.parse(d)}catch(k){a.error("can't parse getShapes opts: "+d,k)}if("regions"===c&&("text"===d.format||"csv"===d.format)){d.mode=d.mode||1;b=this.listRegions(b,d);if("csv"===d.format){var h=b.split(";");c=0;for(b="";c<h.length;c++)if(h[c])if(h[c].toLowerCase().match(a.WCSEXP))d.includewcs&&(b+=h[c].trim()+"\n");else{var g=
h[c].replace(/\(/,",").replace(/\).*/,"").trim();b+=g+"\n"}}return b}this.selectShapes(c,b,function(a){e=a.pub||{};d.includeObj&&(e.obj=a);f.push(e)});return f};a.Fabric.changeShapes=function(c,b,d){var e=this,f,h,g,k,l,m,n,p,q,r,v,u=[],t=[];if((l=this.getShapeLayer(c))&&d){if("string"===typeof d)try{d=JSON.parse(d)}catch(x){a.error("can't parse shape opts: "+d,x)}if(this.display.image!==this)this.delayedShapes=this.delayedShapes||[],this.delayedShapes.push({layer:c,shape:b,mode:"change",opts:d});
else{var w=l.canvas;var y=w.getActiveObject();this.selectShapes(c,b,function(b,B){p="main"!==e.display.layers[c].dtype||b.params.preservedcoords?1:e.rgb.sect.zoom;d.radii&&(b.params.radii=[]);d.tags&&(b.params.tags=[]);k=$.extend(!0,{},b.params,d);g=a.Fabric._parseShapeOptions.call(e,c,k,b);if(g.remove){if(!0===g.remove||"true"===g.remove)g.remove="all";if(!1!==g.remove&&"false"!==g.remove){e.removeShapes(c,g.remove||"all");return}}if(g.opts.send)switch(g.opts.send){case "front":w.sendToFront(y);
w.discardActiveObject();break;case "back":w.sendToBack(y),w.discardActiveObject()}q=a.Fabric._exportShapeOptions.call(e,d).filter(function(a){return!b.params.exports.hasOwnProperty(a)});g.params.exports=b.params.exports.concat(q);g.opts.stroke&&(g.opts.color=g.opts.stroke,g.opts.stroke=a.colorToHex(g.opts.stroke));switch(b.params.shape){case "text":g.opts.stroke&&(g.opts.fill=g.opts.stroke);g.opts.strokeWidth=0;break;case "line":case "polygon":g.opts.points&&g.opts.points.length&&(b.angle=0)}b.set(g.opts);
b.params=$.extend(!1,{},b.params,g.params);d.strokeWidth&&(b.params.sw1=d.strokeWidth);switch(b.params.shape){case "annulus":if(d.radii&&d.radii.length){b.forEachObject(function(b){u.push(b)});m=u.length;for(f=0;f<m;f++)b.remove(u[f]),w.remove(u[f]);m=b.params.radii.length;n=0;r=$.extend(!0,{},d);r.stroke=r.stroke||b.get("stroke");for(f=0;f<m;f++)r.radius=b.params.radii[f],h=new fabric.Circle(r),n=Math.max(n,b.params.radii[f]),b.add(h);b.scaleX=p;b.scaleY=p;b.width=2*n;b.height=2*n;y===b&&w.setActiveObject(b)}break;
case "box":d.width&&(b.scaleX=p);d.height&&(b.scaleY=p);break;case "circle":d.radius&&(b.scaleX=p,b.scaleY=p);break;case "cross":r=$.extend(!0,{},d);r.stroke=r.stroke||b.get("stroke");r.width&&(b.scaleX=p,t[0]=[{x:-r.width/2,y:0},{x:r.width/2,y:0}],delete r.width);r.height&&(b.scaleY=p,t[1]=[{x:0,y:-r.height/2},{x:0,y:r.height/2}],delete r.height);r.angle&&delete r.angle;b.forEachObject(function(b,a){v=$.extend(!0,{},r);t[a]&&(v.points=t[a]);b.set(v)});break;case "ellipse":d.r1&&(b.rx=b.params.r1,
b.scaleX=p,b.width=2*b.rx);d.r2&&(b.ry=b.params.r2,b.scaleY=p,b.height=2*b.ry);break;case "line":case "polygon":if(d.points&&d.points.length||d.pts&&d.pts.length)b.scaleX=p,b.scaleY=p;y===b&&(a.Fabric.removePolygonAnchors(l.dlayer,b),a.Fabric.addPolygonAnchors(l.dlayer,b));a.resetPolygonCenter(b);break;case "text":d.text&&(b.params.text=d.text)}b.rescaleBorder();a.Fabric.updateChildren(l.dlayer,b,"moving");a.Fabric.updateChildren(l.dlayer,b,"scaling");a.Fabric.updateChildren(l.dlayer,b,"rotating");
a.Fabric.updateChildren(l.dlayer,b,"deltas");b.setCoords();a.Fabric._handleChildText.call(e,c,b,d);a.Fabric._updateShape.call(e,c,b,B,"update");if(d.onchangeshapes&&b.pub)try{a.xeqByName(d.onchangeshapes,e,e,b.pub)}catch(z){a.error("in onchangeshapes callback",z,!1)}});(void 0===d.redraw||d.redraw)&&w.renderAll();return this}}};a.Fabric.refreshShapes=function(c){var b;if(c){var d=this.getWCSSys();if("image"===d){var e=a.globalOpts.xeqPlugins;a.globalOpts.xeqPlugins=!1;this.raw.wcs&&0<this.raw.wcs?
this.setWCSSys("native",!1):this.setWCSSys("physical",!1)}if(b=this.listRegions("all",{mode:1,sticky:!1,savewcsconfig:!0,saveid:!0},c))this.removeShapes(c,"all",{overrideRemovable:!0,sticky:!1}),this.addShapes(c,b,{restoreid:!0});"image"===d&&(this.setWCSSys(d,!1),this.updateShapes(c,"all","refresh"),a.globalOpts.xeqPlugins=e);return this}};a.Fabric.copyShapes=function(c,b,d){var e,f=[];if("object"===typeof b)f.push(b);else if("all"===b)for(b=0;b<a.images.length;b++)this!==a.images[b]&&f.push(a.images[b]);
else(b=a.lookupImage(b))&&f.push(b);if(f.length){d||(e=this.listRegions("selected",{mode:1,includedcoords:a.globalOpts.regCopyDCoords},c));e||(e=this.listRegions(d,{mode:1,includedcoords:a.globalOpts.regCopyDCoords},c));for(b=0;b<f.length;b++)d=this.display.layers[c]?this.display.layers[c].opts:a.Regions.opts,f[b].display.newShapeLayer(c,d),f[b].addShapes(c,e);return this}};a.Fabric.addPolygonPoint=function(c,b,d){var e=Number.MAX_VALUE;if(b&&b.points){d=a.eventToDisplayPos(d);var f=b.getCenterPoint().x;
var h=b.getCenterPoint().y;f=(d.x-f)/b.get("scaleX");var g=(d.y-h)/b.get("scaleY");for(h=-b.get("angle")*Math.PI/180;h>2*Math.PI;)h-=2*Math.PI;d=Math.cos(h)*f-Math.sin(h)*g;g=Math.sin(h)*f+Math.cos(h)*g;f=b.points;for(h=0;h<f.length;h++){var k=f[h];var l=f[(h+1)%f.length];var m=k.x<l.x?k.x:l.x;var n=k.y<l.y?k.y:l.y;var p=k.x>l.x?k.x:l.x;var q=k.y>l.y?k.y:l.y;var r=k.x-l.x;k=k.y-l.y;var v=Math.sqrt(r*r+k*k);0!==v&&(r/=v,k/=v);v=d-l.x;var u=g-l.y;v=v*r+u*k;r=l.x+r*v;l=l.y+k*v;r<m?r=m:r>p&&(r=p);l<n?
l=n:l>q&&(l=q);m=(r-d)*(r-d)+(l-g)*(l-g);if(m<e){e=m;var t=r;var w=l;var y=h===f.length?0:h}}c=this.getShapeLayer(c);a.Fabric.removePolygonAnchors(c.dlayer,b);f.splice(y+1,0,{x:t,y:w});if(1===fabric.major_version)c.canvas.setActiveObject(b);else{switch(b.type){case "polyline":case "polygon":a.Fabric.addPolygonAnchors(c.dlayer,b),c.dlayer.canvas.renderAll()}b.polyparams?c.dlayer.params.sel=b.polyparams.polygon:b.params&&(c.dlayer.params.sel=b)}}};a.Fabric.removePolygonPoint=function(c,b){if(b&&b.polyparams){var d=
b.polyparams.polygon;var e=d.points;if(!("polygon"===d.type&&3>=e.length||"polyline"===d.type&&2>=e.length)){var f=b.polyparams.point;delete b.polyparams.point;c=this.getShapeLayer(c);a.Fabric.removePolygonAnchors(c.dlayer,d);e.splice(f,1);a.resetPolygonCenter(d);c.canvas.setActiveObject(d)}}};a.Fabric.addPolygonAnchors=function(c,b){var d,e={},f=c.canvas,h=function(b){b=b.target;var d=b.polyparams.polygon,g=b.polyparams.point,h=d.get("points"),k=c.display.image;void 0!==g&&!1!==d.params.changeable&&
(d.angle?e=a.rotatePoint({x:b.left,y:b.top},-d.angle,{x:d.left,y:d.top}):(e.x=b.left,e.y=b.top),h[g].x=(e.x-d.left)/d.scaleX,h[g].y=(e.y-d.top)/d.scaleY,a.resetPolygonCenter(d),a.Fabric._updateShape.call(k,d.params.layerName,d,null,"update"),k&&(k.params.listonchange||d.params.listonchange)&&k.listRegions(d,{mode:2}),f.renderAll())},g=function(b){var c,d={};for(c=0;c<b.params.anchors.length;c++)d.x=b.left+b.points[c].x*b.scaleX,d.y=b.top+b.points[c].y*b.scaleY,b.angle&&(d=a.rotatePoint(d,b.angle,
{x:b.left,y:b.top})),b.params.anchors[c].set({left:d.x,top:d.y,angle:b.angle}),b.params.anchors[c].setCoords();b._calcDimensions(!0);f.renderAll()};if(!b.params.anchors&&!1!==b.params.changeable){b.params.anchors=[];for(d=0;d<b.points.length;d++){e.x=b.left+b.points[d].x*b.scaleX;e.y=b.top+b.points[d].y*b.scaleY;b.angle&&(e=a.rotatePoint(e,b.angle,b.getCenterPoint()));var k=new fabric.Rect({left:e.x,top:e.y,hasControls:!1,hasRotatingPoint:!1,hasBorders:!1,selectable:!0,fill:b.get("stroke"),hoverCursor:"pointer",
width:a.Fabric.opts.cornerSize+2,height:a.Fabric.opts.cornerSize+2,padding:2});k.on("moving",h);k.polyparams={};k.polyparams.polygon=b;k.polyparams.point=d;b.params.anchors[d]=k;f.add(k)}b.on("moving",function(){g(b)});b.on("rotating",function(){g(b)});b.on("scaling",function(){g(b)});b.setCoords()}};a.Fabric.removePolygonAnchors=function(a,b){var c=a.canvas;if(b&&b.params&&b.params.anchors&&!1!==b.params.changeable){for(a=0;a<b.params.anchors.length;a++)c.remove(b.params.anchors[a]);delete b.params.anchors}};
a.Fabric.updateChildren=function(c,b,d){var e,f;if("regions"===c.layerName)if("objects"===d){var h={};c.canvas.getObjects().forEach(function(b){b.params&&(b.params.parent||b.params.children.length)&&(h[b.params.id]=b)});c.canvas.getObjects().forEach(function(b){if(b.params)for(b.params.parent&&(b.params.parent.obj=h[b.params.parent.id]),e=0;e<b.params.children.length;e++)b.params.children[e].obj=h[b.params.children[e].id]})}else if(b&&b.params)if("deltas"===d){if(b.params.parent){var g=b.params.parent;
g.dleft=g.obj.left-b.left;g.dtop=g.obj.top-b.top;g.moved=!0}}else for(e=0;e<b.params.children.length;e++){var k=b.params.children[e].obj;g=k.params.parent;switch(d){case "moving":k.left=b.left-g.dleft;k.top=b.top-g.dtop;break;case "rotating":for(f=b.angle;0>f;)f+=360;for(;360<=f;)f-=360;var l=f-g.lastangle;var m=a.rotatePoint({x:k.left,y:k.top},l,{x:b.left,y:b.top});k.left=m.x;k.top=m.y;g.dleft=b.left-k.left;g.dtop=b.top-k.top;for(k.angle+=l;0>k.angle;)k.angle+=360;for(;360<=k.angle;)k.angle-=360;
g.lastangle=f;break;case "scaling":g.dleft*=b.scaleX/g.lastscalex,g.dtop=b.scaleY/g.lastscaley*(g.dtop-g.textheight)+g.textheight,g.lastscalex=b.scaleX,g.lastscaley=b.scaleY,g.moved=!0,k.left=b.left-g.dleft,k.top=b.top-g.dtop}k.setCoords();c.display.image&&c.display.image.updateShapes(c.layerName,k,"updatechild")}};a.resetPolygonCenter=function(c){var b={};if(1===fabric.major_version){c._calcDimensions();var d=(c.minX+c.width/2)*c.scaleX;var e=(c.minY+c.height/2)*c.scaleY}else e=c._calcDimensions(),
...
d,e,f=0,h=sprintf("width=%s,height=%s,menubar=1,toolbar=1,status=0,scrollbars=1,resizable=1",this.display.canvasjq.attr("width"),this.display.canvasjq.attr("height"));c=c||{};if("string"===typeof c)try{c=JSON.parse(c)}catch(m){a.error("can't parse print opts: "+c,m)}var g=this.display.canvas.toDataURL("image/png");var k="<html><body style='padding: 0px; margin: 0px' onload='window.print(); return false'>";var l=sprintf("<div style='position:absolute; left:%spx; top:%spx'>",0,f);k+=l+"<img src='"+
g+"'></div>";for(b in this.layers)this.layers.hasOwnProperty(b)&&(g=this.layers[b],"main"===g.dlayer.dtype&&g.show&&(k+=""+l+g.dlayer.canvas.toSVG()+"</div>"));(void 0===c.colorbar||c.colorbar)&&(c=this.display.pluginInstances.JS9Colorbar)&&c.isActive()&&(f+=2,g=c.colorbarjq[0].toDataURL("image/png"),f+=this.display.height,l=sprintf("<div style='position:absolute; left:%spx; top:%spx'>",0,f),k+=l+"<img src='"+g+"'></div>",c.textjq&&c.textjq[0]&&(g=c.textjq[0].toDataURL("image/png"),f+=c.colorbarjq.height()+
1,l=sprintf("<div style='position:absolute; left:%spx; top:%spx'>",0,f),k+=l+"<img style='width:"+this.display.width+"px;'src='"+g+"'></div>"));k+="</body></html>";window.isElectron&&(e="data:text/html,<html><body><script>window.addEventListener('message', (ev) => {document.documentElement.innerHTML=ev.data; window.setTimeout(() => {window.print()}, 250);},false)\x3c/script><p>waiting for image ...</body></html>");(d=window.open(e,this.id,h))?d.document?(d.document.open(),d.document.write(k),d.document.close()):
...
a.Image.prototype.displayShapeLayers=a.Fabric.displayShapeLayers;a.Image.prototype.toggleShapeLayers=a.Fabric.toggleShapeLayers;a.Image.prototype.print=a.Fabric.print;for(c in a.Fabric.opts)a.Fabric.opts.hasOwnProperty(c)&&(fabric.Object.prototype[c]=a.Fabric.opts[c])};a.Fabric.initGraphics();a.MouseTouch={};a.MouseTouch.CLASS="JS9";a.MouseTouch.NAME="MouseTouch";a.MouseTouch.WIDTH=512;a.MouseTouch.HEIGHT=220;a.MouseTouch.BASE=a.MouseTouch.CLASS+a.MouseTouch.NAME;a.MouseTouch.mouseText=[];a.MouseTouch.mouseText[0]=
"Move mouse, no buttons pressed:";a.MouseTouch.mouseText[1]="Move mouse, primary button pressed:";a.MouseTouch.mouseText[2]="Move mouse, secondary button pressed:";a.MouseTouch.touchText=[];a.MouseTouch.touchText[0]="Touch move, with one finger:";a.MouseTouch.touchText[1]="Touch move, with two fingers:";a.MouseTouch.touchText[2]="Touch move, with three fingers:";a.MouseTouch.textHTML="<div style='float: left'>%s</div>";a.MouseTouch.actionHTML="<div style='float: left'><b>%s</b></div>";a.MouseTouch.actionid=
function(a,b){return(a+"_"+b).replace(/[^A-Za-z0-9_]/g,"_")};a.MouseTouch.addText=function(c,b){b=sprintf(a.MouseTouch.textHTML,b);return $("<div>").addClass(a.MouseTouch.BASE+"Text").html(b).appendTo(c)};a.MouseTouch.addAction=function(c,b,d){b=a.MouseTouch.actionid(b,d);d=sprintf(a.MouseTouch.actionHTML,d);return $("<div>").addClass(a.MouseTouch.BASE+"Action").attr("id",b).html(d).appendTo(c)};a.MouseTouch.isPinch=function(c,b){var d,e,f=a.globalOpts.pinchWait,h=a.globalOpts.pinchThresh;if(!c)return-1;
b=c.display;if(!b.mousetouchZoom||2!==c.pos.touches.length)return-1;switch(b.ispinch){case -1:case 1:return b.ispinch}c=Math.sqrt((c.pos.touches[0].x-c.pos.touches[1].x)*(c.pos.touches[0].x-c.pos.touches[1].x)+(c.pos.touches[0].y-c.pos.touches[1].y)*(c.pos.touches[0].y-c.pos.touches[1].y));b.dist0||(b.dist0=c);b.deltas.push(Math.floor(c-b.dist0));if(b.deltas.length>=f){c=1;for(e=d=0;c<f;c++)b.deltas[c]>b.deltas[c-1]?d++:b.deltas[c]<b.deltas[c-1]&&e++;b.ispinch=d>=h||e>=h?1:-1;b.lastzoom=0;return b.ispinch}return 0};
a.MouseTouch.Actions={};a.MouseTouch.Actions["display value/position"]=function(c,b,d){!a.specialKey(d)&&a.globalOpts.internalValPos&&c&&b&&0<b.x&&0<b.y&&b.x<=c.raw.width&&b.y<=c.raw.height&&(c.valpos=c.updateValpos(b,!0))};a.MouseTouch.Actions["change contrast/bias"]=function(c,b,d){var e=c.display;a.globalOpts.internalContrastBias&&c&&b&&"static"!==c.cmapObj.type&&!(c.pos0&&c.pos&&Math.abs(c.pos0.x-c.pos.x)<a.NOMOVE&&Math.abs(c.pos0.y-c.pos.y)<a.NOMOVE||c.clickInRegion||a.specialKey(d)||c.rgbFile)&&
...
{mode:2}):c[a].params.listonchange&&f.listRegions("selected",{mode:2});break}}});return this};a.Regions.displayConfigForm=function(c,b){var d=this,e=0,f=a.Regions.opts.title;if(this&&(b=b||{},c||this.getShapes("regions").length)){b.type=b.type||"config";switch(b.type){case "save":var h=a.allinone?a.allinone.regionsSaveHTML:a.InstallDir(a.Regions.opts.saveURL);f="Save regions";var g=a.lightOpts[a.LIGHTWIN].regWin1;break;default:h=a.allinone?a.allinone.regionsConfigHTML:a.InstallDir(a.Regions.opts.configURL),
c||(b.multi=!0)}if(b.multi&&($("form[class='regionsConfigForm']").each(function(a,c){a=$(c).data("multi");var f=$(c).data("winid");c=$(c).data("im");a&&f&&c===d&&(b.winid=f,c.initRegionsForm(null,b),e++)}),f=f.replace(/regions?/,"selected regions"),e))return;$(a.lightOpts[a.LIGHTWIN].topid).arrive(".regionsConfigForm",{onceOnly:!0},function(){b.firsttime=!0;d.updateShapes("regions",c,"wcsconfig");d.initRegionsForm(c,b)});b.winid=this.displayAnalysis("regions",h,{title:f,winformat:g});c&&(c.params.winid=
b.winid)}};a.Regions.initConfigForm=function(c,b){var d=this,e,f,h,g,k,l,m,n=!1,p=this.raw.wcsinfo||{cdelt1:1,cdelt2:1};var q={type:"multi",pub:{shape:"multi",wcsconfig:{}},params:{}};var r=function(b){if(void 0!==b)return"number"===typeof b&&0!==b%1&&(b=Math.round(1E4*(b+1E-5))/1E4),String(b)},v=function(b){return(b||"").replace(/\n/g,"\\n")};if(c&&c.pub&&c.pub.wcsconfig&&c.pub.wcsconfig.wcssys)var u=c.pub.wcsconfig.wcssys;else u=this.params.wcssys,c=q;b=b||{};if(c.params.winid)var t=c.params.winid;
else b.winid&&(t=b.winid);if(t){var w="#"+$(t).attr("id")+" .regionsConfigForm ";if($(w).length){n=$(w).data("multi")?!0:b.multi;$(w+"."+c.pub.shape).each(function(b,a){$(a).removeClass("nodisplay")});$(w+".val").each(function(b,m){h="";f=$(m).attr("name");switch(f){case "x":case "y":c.pub.lcs&&void 0!==c.pub.lcs[f]?h=r(c.pub.lcs[f]):void 0!==c.pub[f]&&(h=r(c.pub[f]));break;case "radii":c.pub.radii&&(h=a.notWCS(u)||!c.pub.wcsconfig.wcsstr?c.pub.imstr.replace(/^annulus\(/,"").replace(/\)$/,"").split(",").slice(2).join(","):
c.pub.wcsconfig.wcsstr.replace(/^annulus\(/,"").replace(/\)$/,"").split(",").slice(2).join(","));break;case "pts":c.pub.pts?c.pub.pts.forEach(function(b){h&&(h+=", ");h+=b.x.toFixed(2)+", "+b.y.toFixed(2)}):c.pub.imstr&&(h=c.pub.imstr.replace(/^.*\(/,"").replace(/\)$/,""));break;case "linelength":if(c.pub.pts&&2===c.pub.pts.length){k=c.pub.pts[0];l=c.pub.pts[1];h=r(Math.sqrt((l.x-k.x)*(l.x-k.x)+(l.y-k.y)*(l.y-k.y)));switch(u){case "image":case "physical":break;default:h*=Math.abs(p.cdelt1),h*=Math.abs(p.cdelt2)}h=
r(h);d.tmp.linelength=h}break;case "lineangle":if(c.pub.pts&&2===c.pub.pts.length){k=c.pub.pts[0];l=c.pub.pts[1];for(h=180*Math.atan2(l.y-k.y,l.x-k.x)/Math.PI;0>h;)h+=360;h=r(h);d.tmp.lineangle=h}break;case "fontFamily":c.getFontFamily&&(h=c.getFontFamily());break;case "fontSize":c.getFontSize&&(h=c.getFontSize());break;case "fontStyle":c.getFontStyle&&(h=c.getFontStyle());break;case "fontWeight":c.getFontWeight&&(h=c.getFontWeight());break;case "strokeWidth":c.params.sw1&&(h=c.params.sw1);break;
case "strokeDashes":c.strokeDashArray&&(h=c.strokeDashArray.join(" "),h.match(/NaN/)&&(h=""));break;case "regstr":h=a.notWCS(u)||!c.pub.wcsconfig.wcsstr?c.pub.imsys+";"+c.pub.imstr:c.pub.wcsconfig.wcssys+";"+c.pub.wcsconfig.wcsstr;break;case "xpos":switch(u){case "image":c.pub.preservedcoords&&void 0!==c.pub.dx?h=sprintf("d%.1f",c.pub.dx):void 0!==c.pub.x&&(h=sprintf("%.1f",c.pub.x));break;case "physical":c.pub.lcs?h=sprintf("%.1f",c.pub.lcs.x):void 0!==c.pub.x&&(h=sprintf("%.1f",c.pub.x));break;
default:void 0!==c.pub.wcsconfig.ra?h=sprintf("%.6f",c.pub.wcsconfig.ra):void 0!==c.pub.x&&(h=sprintf("%.1f",c.pub.x))}break;case "ypos":switch(u){case "image":c.pub.preservedcoords&&void 0!==c.pub.dy?h=sprintf("d%.1f",c.pub.dy):void 0!==c.pub.y&&(h=sprintf("%.1f",c.pub.y));break;case "physical":c.pub.lcs?h=sprintf("%.1f",c.pub.lcs.y):void 0!==c.pub.y&&(h=sprintf("%.1f",c.pub.y));break;default:void 0!==c.pub.wcsconfig.dec?h=sprintf("%.6f",c.pub.wcsconfig.dec):void 0!==c.pub.y&&(h=sprintf("%.1f",c.pub.y))}break;
case "radius":case "oradius":case "length":case "width":case "r1":switch(u){case "image":void 0!==c.pub[f]&&(h=r(c.pub[f]));break;case "physical":c.pub.lcs&&void 0!==c.pub.lcs[f]&&(h=r(c.pub.lcs[f]));break;default:void 0!==c.pub.wcsconfig.wcssizestr?h=r(c.pub.wcsconfig.wcssizestr[0]):void 0!==c.pub[f]&&(h=r(c.pub[f]))}break;case "height":case "r2":switch(u){case "image":void 0!==c.pub[f]&&(h=r(c.pub[f]));break;case "physical":c.pub.lcs&&void 0!==c.pub.lcs[f]&&(h=r(c.pub.lcs[f]));break;default:void 0!==
c.pub.wcsconfig.wcssizestr?h=r(c.pub.wcsconfig.wcssizestr[1]):void 0!==c.pub[f]&&(h=r(c.pub[f]))}break;case "wcssys":case "savewcs":y=$(w).find("[name='"+f+"']");if(!y.find("option").length)for(e=0;e<a.wcssyss.length;e++)y.append("<option>"+a.wcssyss[e]+"</option>");g="savewcs"===f?a.globalOpts.regSaveWCS||u:u;y.find("option").each(function(b,a){g===a.value&&(h=a.value)});break;case "wcsunits":c.pub.wcsunits&&(h=c.pub.wcsunits);break;case "childtext":c.params.children&&0<c.params.children.length&&
(h=v(c.params.children[0].obj.text));break;case "text":void 0!==c.pub[f]&&(h=v(r(c.pub[f])));break;case "id":n?h="selected":void 0!==c.pub.id&&(h=String(c.pub.id),$(m).css("width",h.length+"ch"));break;case "tags":void 0!==c.pub[f]&&(h=r(c.pub[f]));break;case "savefile":h=$(w).data("savefile")||d.tmp.saveregionsFile||"js9.reg";window.isElectron&&window.currentDir&&!h.match(/.*\//)&&(h=window.currentDir+"/"+h);break;default:void 0!==c.pub[f]&&(h=r(c.pub[f]))}$(m).val(h)});(n||!this.raw.wcs||0>this.raw.wcs)&&
...
q=y.find(".rwcsbuttoncontainer");if(q.length&&!q.find(".rwcsbutton").length){for(e=0;e<a.favorites.wcs.length;e++){var x=a.favorites.wcs[e];var B="string"===typeof x?x.split(":"):x;x=B[0];B=B[1]||x;if("save"===b.type){var z="rsavecol_R"+(e+2);var A="rsaveradio"}else z="rconfigcol_R"+(e+2),A="rconfigradio";q.append("<span class='rconfigcol_R rwcsbutton "+z+"'>\n                                <input type='radio'\n                                       id='rwcsbutton_"+x+"'\n                                       name='rwcsbutton'\n                                       class='rwcsradio "+
A+"}'\n                                       value='"+x+"'\n                                       data-tooltip='save using "+x+' wcs\'\n                                       onclick=\'\n                                           $(this).closest("form")\n                                           .find("[name=savewcs]")\n                                           .val("'+x+'")\n                                           .trigger("change");\'>\n                                <label for=\'rwcsbutton_'+
x+"'>"+B+"</label>\n                                </span>")}$(w).find(".rwcsbuttons").find("[value='"+u+"']").prop("checked",!0)}}void 0===c.params.listonchange&&(c.params.listonchange=!1);c.params.listonchange?$(w+"[name='listonchange']").prop("checked",!0):$(w+"[name='listonchange']").prop("checked",!1);void 0===c.params.changeable&&void 0!==c.params.fixinplace&&(c.params.changeable=!c.params.fixinplace);void 0===c.params.changeable&&(c.params.changeable=!0);c.params.changeable?$(w+"[name='changeable']").prop("checked",
!0):$(w+"[name='changeable']").prop("checked",!1);c.params.sticky?$(w+"[name='sticky']").prop("checked",!0):$(w+"[name='sticky']").prop("checked",!1);$(w+"[id='includejson']").prop("checked",a.globalOpts.regIncludeJSON);$(w+"[id='includecomments']").prop("checked",a.globalOpts.regIncludeComments);$(w+"[id='savedcoords']").prop("checked",a.globalOpts.regSaveDCoords);$(w+"[id='includewcs']").prop("checked",a.globalOpts.csvIncludeWCS);$(w).find("input[name='saveformat']").prop("checked",!1);$(w).find("input[value='"+
a.globalOpts.regSaveFormat+"']").prop("checked",!0);$(w).find("input[name='rwcsbutton']").prop("checked",!1);$(w).find("input[value='"+(a.globalOpts.regSaveWCS||u)+"']").prop("checked",!0);x="save"===b.type?"save"+a.globalOpts.regSaveWhich1:"save"+a.globalOpts.regSaveWhich2;$(w+"[id='"+x+"']").prop("checked",!0);"save"===b.type&&$(w).find("input[name='savefile']").trigger("change");if(n)$(w).find(".regid").hide(),$(w).find(".edit").hide(),$(w).find(".childtext").hide(),$(w).find(".multi").removeClass("nodisplay"),
!1===b.setmode?$(w).find("[name='multitext']").val(""):(x=this.listRegions("selected",{mode:1,includejson:!1,includecomments:!1}).replace(/ *; */g,"\n"),$(w).find("[name='multitext']").val(x));else switch($(w).find("input:text[readonly]").css("border-color","A5A5A5").css("background","#E9E9E9"),c.pub.shape){case "box":case "cross":case "ellipse":$(w+".angle").removeClass("nodisplay");break;case "text":$(w+".textangle").removeClass("nodisplay");break;case "line":c.pub.pts&&2===c.pub.pts.length?($(w+
".linelength").removeClass("nodisplay"),$(w+".lineangle").removeClass("nodisplay")):($(w+".linelength").addClass("nodisplay"),$(w+".lineangle").addClass("nodisplay"))}$(w+".xtrareg").addClass("nodisplay");$(w+".xtracsv").addClass("nodisplay");$(w+".xtrasvg").addClass("nodisplay");$(w+".xtra"+a.globalOpts.regSaveFormat).removeClass("nodisplay");$(w).data("im",this);$(w).data("shape",c);$(w).data("winid",t);$(w).data("multi",n);a.BROWSER[3]?(t="touchstart",q="touchend"):(t="mouseover",q="mouseout");
if("save"===b.type)$(w).on(t,function(){$(w).find("input[name='savefile']").focus()});$(w).data("tooltipInit")||($(w).data("tooltipInit",!0),$(".rconfigcol_R, .rsavecol_R").on(t,function(b){var c=b.currentTarget;b=$(c).find("input, textarea, span").data("tooltip");c=$(c).closest(a.lightOpts[a.LIGHTWIN].top).find(a.lightOpts[a.LIGHTWIN].dragBar);b&&c.length&&(m=$(c)[0].childNodes[0].nodeValue.replace(/:.*/,""),$(c)[0].childNodes[0].nodeValue=m+": "+b)}),$(".rconfigcol_R, .rsavecol_R").on(q,function(b){b=
$(b.currentTarget).closest(a.lightOpts[a.LIGHTWIN].top).find(a.lightOpts[a.LIGHTWIN].dragBar);b.length&&(m=$(b)[0].childNodes[0].nodeValue.replace(/:.*/,""),$(b)[0].childNodes[0].nodeValue=m)}))}}};a.Regions.processConfigForm=function(c,b,d){var e=1;var f={type:"multi",pub:{shape:"multi"},params:{}};var h=d.length,g={},k=this.raw.wcsinfo||{cdelt1:1,cdelt2:1},l=function(b){if(void 0!==b)return"number"===typeof b&&0!==b%1&&(b=Math.round(1E4*(b+1E-5))/1E4),String(b)},m=function(b,a){return v?!0:void 0===
b?!1:l(b)!==l(a)},n=function(b,c,d){if("remove"===c)return"selected"===d;if("childtext"===c)return b.params.children&&0<b.params.children.length?!1:""!==d;if("strokeDashes"===c)return b.strokeDashArray?JSON.stringify(b.strokeDashArray)!==JSON.stringify(d):""!==d;if("tags"!==c&&""===d)return!1;if("misc"===c&&""!==d)return!0;if("angle"===c)return b.angle!==-parseFloat(d);if("ix"===c)return b.pub.preservedcoords&&"d"===d.charAt(0).toLowerCase()?m(b.pub.dx,a.saostrtod(d.substring(1))):m(b.pub.x,a.saostrtod(d));
if("iy"===c)return b.pub.preservedcoords&&"d"===d.charAt(0).toLowerCase()?m(b.pub.dy,a.saostrtod(d.substring(1))):m(b.pub.y,a.saostrtod(d));if("px"===c&&b.pub.lcs)return m(b.pub.lcs.x,a.saostrtod(d));if("py"===c&&b.pub.lcs)return m(b.pub.lcs.y,a.saostrtod(d));if("ra"===c)return b.pub.wcsconfig.wcsposstr?m(a.saostrtod(b.pub.wcsconfig.wcsposstr[0]),a.saostrtod(d)):b.pub.wcsposstr?m(a.saostrtod(b.pub.wcsposstr[0]),a.saostrtod(d)):!1;if("dec"===c){if(b.pub.wcsconfig.wcsposstr)return m(a.saostrtod(b.pub.wcsconfig.wcsposstr[1]),
a.saostrtod(d));if(b.pub.wcsposstr)return m(a.saostrtod(b.pub.wcsposstr[1]),a.saostrtod(d))}return"sticky"===c?m(b.pub.sticky||!1,d):b.pub.lcs&&void 0!==b.pub.lcs[c]?m(b.pub.lcs[c],d)?!0:!1:m(b.pub[c],d)||m(b.params[c],d)||m(b[c],d)?!0:!1},p=function(b){return"true"===b?!0:"false"===b?!1:a.isNumber(b)?parseFloat(b):b},q=function(b){var a=String.fromCharCode(13,10);return(b||"").replace(/\\n/g,a)};this.lcs&&this.lcs.physical&&(e=Math.sqrt(Math.pow(this.lcs.physical.forward[0][0],2)+Math.pow(this.lcs.physical.forward[0][1],
2)));if(b&&b.pub&&b.pub.wcsconfig&&b.pub.wcsconfig.wcssys)var r=b.pub.wcsconfig.wcssys;else r=this.params.wcssys,b=f;var v=$(c).data("multi");f=b.pub.layer||"regions";for(c=0;c<h;c++){var u=d[c].name;var t=d[c].value;if("xpos"===u||"ypos"===u)switch(r){case "image":u="i"+u.charAt(0);break;case "physical":u="p"+u.charAt(0);break;default:u=this.raw.wcs&&0<this.raw.wcs?"xpos"===u?"ra":"dec":"xpos"===u?"ix":"iy"}switch(u){case "text":"text"===b.type&&n(b,u,t)&&(g[u]=q(p(t)));break;case "strokeDashes":t=
t.trim().split(/\s+/);n(b,u,t)&&(g.strokeDashArray=0===t.length?[]:t.map(function(b){return parseInt(b,10)}));break;case "childtext":"text"!==b.type&&n(b,u,t)&&(g.text=q(p(t)));break;case "ix":n(b,u,t)&&(b.pub.preservedcoords&&"d"===t.charAt(0).toLowerCase()?(g.dx=p(t.substring(1)),void 0===g.dy&&void 0!==b.pub.dy&&(g.dy=b.pub.dy)):(g.x=p(t),void 0===g.y&&void 0!==b.pub.y&&(g.y=b.pub.y)));break;case "iy":n(b,u,t)&&(b.pub.preservedcoords&&"d"===t.charAt(0).toLowerCase()?(g.dy=p(t.substring(1)),void 0===
g.dx&&void 0!==b.pub.dx&&(g.dx=b.pub.dx)):(g.y=p(t),void 0===g.x&&void 0!==b.pub.x&&(g.x=b.pub.x)));break;case "px":n(b,u,t)&&(g.px=p(t),void 0===g.py&&b.pub.lcs&&(g.py=b.pub.lcs.y));break;case "py":n(b,u,t)&&(g.py=p(t),void 0===g.px&&b.pub.lcs&&(g.px=b.pub.lcs.x));break;case "ra":n(b,u,t)&&(g.ra=t,void 0===g.dec&&(b.pub.wcsconfig.wcsposstr?g.dec=b.pub.wcsconfig.wcsposstr[1]:b.pub.wcsposstr&&(g.dec=b.pub.wcsposstr[1])));break;case "dec":n(b,u,t)&&(g.dec=t,void 0===g.ra&&(b.pub.wcsconfig.wcsposstr?
g.ra=b.pub.wcsconfig.wcsposstr[0]:b.pub.wcsposstr&&(g.ra=b.pub.wcsposstr[0])),void 0===g.wcssys&&(g.wcssys=r));break;case "wcssys":break;case "radius":case "length":case "width":case "r1":switch(r){case "image":n(b,u,t)&&(g[u]=p(t));break;case "physical":n(b,u,t)&&(g[u]=p(t)*e);break;default:t=a.strtoscaled(t),t="."===t.dtype&&"galactic"!==r&&"ecliptic"!==r?t.dval:Math.abs(t.dval/k.cdelt1),u=u.replace("wcs",""),n(b,u,t)&&(g[u]=p(t))}break;case "height":case "r2":switch(r){case "image":n(b,u,t)&&(g[u]=
p(t));break;case "physical":n(b,u,t)&&(g[u]=p(t)*e);break;default:t=a.strtoscaled(t),t="."===t.dtype&&"galactic"!==r&&"ecliptic"!==r?t.dval:Math.abs(t.dval/k.cdelt2),u=u.replace("wcs",""),n(b,u,t)&&(g[u]=p(t))}break;case "radii":n(b,u,t)&&(g[u]=t);break;case "linelength":if(b.pub.pts&&2===b.pub.pts.length&&a.isNumber(t)&&t!==this.tmp.linelength){t=parseFloat(t);switch(r){case "image":case "physical":break;default:void 0!==k.cdelt1?t/=Math.abs(k.cdelt1):void 0!==k.cdelt2&&(t/=Math.abs(k.cdelt2))}if(g.pts){u=
g.pts[0];var w=g.pts[1]}else u=b.pub.pts[0],w=b.pub.pts[1];if(0<=$.inArray("line",a.Regions.opts.noCenteredScaling)){var y=Math.sqrt((u.x-w.x)*(u.x-w.x)+(u.y-w.y)*(u.y-w.y));var x=u.x-t*(u.x-w.x)/y;t=u.y-t*(u.y-w.y)/y;g.pts=[u,{x:x,y:t}]}else x={x:(u.x+w.x)/2,y:(u.y+w.y)/2},y=parseFloat(this.tmp.lineangle)||0,u.x=x.x-t/2,u.y=x.y,w.x=x.x+t/2,w.y=x.y,g.pts=[a.rotatePoint(u,y,x),a.rotatePoint(w,y,x)]}break;case "lineangle":b.pub.pts&&2===b.pub.pts.length&&a.isNumber(t)&&t!==this.tmp.lineangle&&(y=parseFloat(t)-
parseFloat(this.tmp.lineangle)||0,g.pts?(u=g.pts[0],w=g.pts[1]):(u=b.pub.pts[0],w=b.pub.pts[1]),0<=$.inArray("line",a.Regions.opts.noCenteredScaling)?g.pts=[u,a.rotatePoint(w,y,u)]:(x={x:(u.x+w.x)/2,y:(u.y+w.y)/2},g.pts=[a.rotatePoint(u,y,x),a.rotatePoint(w,y,x)]));break;case "remove":n(b,u,t)&&(v?g[u]="selected":void 0!==b.pub.id&&(g[u]=b.pub.id));break;case "misc":if(t.trim())try{var B=JSON.parse(t);$.extend(g,B)}catch(z){a.error("invalid json: "+t)}break;default:n(b,u,t)&&(g[u]=p(t))}}v?this.changeShapes(f,
"selected",g):this.changeShapes(f,b,g);this.initRegionsForm(b,{multi:v})};a.Regions.pasteFromClipboard=function(c){var b,d=0,e=0;if(this){(b=a.CopyFromClipboard().trim())||a.error(a.CLIPBOARDERROR);if(b.match(/(annulus|box|circle|cross|ellipse|line|polygon|point|text) *\(/)){var f=a.globalOpts.regionsToClipboard;a.globalOpts.regionsToClipboard=!1;var h=this.addShapes("regions",b,{rtn:"objs"});if(c){var g=h.length;for(c=0;c<g;c++)d+=h[c].pub.x,e+=h[c].pub.y;d/=g;e/=g;for(c=0;c<g;c++){var k=h[c].pub.x-
d+this.ipos.x;var l=h[c].pub.y-e+this.ipos.y;this.changeShapes("regions",h[c].pub.id,{x:k,y:l})}}a.globalOpts.regionsToClipboard=f}else a.error(a.CLIPBOARDERROR2);return b}};a.Regions.listRegions=function(c,b,d){var e=this,f,h,g,k,l="";var m="none";var n=!1,p=[];var q={};var r=[],v=[],u=function(c,d){var f,g={},h=c.params,k=h.children,l=h.exports;for(f=0;f<l.length;f++){var m=l[f];if(("text"!==m||"text"===c.type)&&"textOpts"!==m){if("strokeDashArray"===m&&c.strokeDashArray){var n=c.strokeDashArray.join("");
if(""===n||n.match(/NaN/))continue}"id"===m&&b.file||"wcsconfig"===m&&b.file||"data"===m&&"object"===typeof h.data&&!1===h.data.doexport&&b.file||("strokeWidth"===m&&h.sw1?g[m]=h.sw1:void 0!==c[m]?g[m]=c[m]:void 0!==h[m]?g[m]=h[m]:d&&void 0!==d[m]&&(g[m]=d[m]))}}if(0<k.length&&k[0].obj.text){n=k[0].obj;g.text=n.text;g.textOpts=u(n);if(c.angle!==n.angle){if(g.textOpts.angle=-n.angle,"circle"===c.params.shape||"annulus"===c.params.shape)n.params.hasTextOpts=!0}else 0===n.angle||"circle"!==c.params.shape&&
"annulus"!==c.params.shape||(g.textOpts.angle=-n.angle,n.params.hasTextOpts=!0);if(n.params.parent.moved||n.params.hasTextOpts)n.pub.ra&&n.pub.dec?(y&&x&&y!==x?(n=e.wcs2wcs(y,x,n.pub.ra,n.pub.dec),n=n.trim().split(/\s+/),d=a.saostrtod(n[0]),a.isHMS(x)&&(d*=15),n=a.saostrtod(n[1])):(d=n.pub.ra,n=n.pub.dec),g.textOpts.ra=d,g.textOpts.dec=n):n.pub.lcs?(g.textOpts.px=n.pub.lcs.x,g.textOpts.py=n.pub.lcs.y):(g.textOpts.x=n.pub.x,g.textOpts.y=n.pub.y);g.textOpts.color===c.stroke&&delete g.textOpts.color;
g.textOpts.text&&delete g.textOpts.text;Object.keys(g.textOpts).length||delete g.textOpts}return g};b=b||{};if("string"===typeof b)try{b=JSON.parse(b)}catch(E){a.error("can't parse listRegions opts: "+b,E)}var t=b.mode;a.isNull(t)&&(t=3);a.isNull(d)&&(d="regions");if(b.wcssys||b.wcsunits){var w=a.globalOpts.xeqPlugins;a.globalOpts.xeqPlugins=!1;if(b.wcssys){var y=this.getWCSSys();this.setWCSSys(b.wcssys,!1);var x=this.getWCSSys()}if(b.wcsunits){var B=this.getWCSUnits();this.setWCSUnits(b.wcsunits,
!1)}this.updateShapes(d,c,"export")}a.isNull(b.includedcoords)&&(b.includedcoords=a.globalOpts.regListDCoords);p=this.getShapes(d,c,{includeObj:!0});var z=p.length;if(t)for(f=0;f<z;f++){var A=p[f];if((h=A.tags.join(","))&&"source,include"!==h&&"include,source"!==h){n=!0;break}}for(C in a.Regions.opts.tagcolors)a.Regions.opts.tagcolors.hasOwnProperty(C)&&v.push(a.Regions.opts.tagcolors[C]);for(f=0;f<z;f++)if(A=p[f],q=A.obj,r=[],!A.sticky||!1!==b.sticky)if(!A.preservedcoords||b.includedcoords)if($.isArray(q.params.preservedcoords)){for(h=
0;h<q.params.preservedcoords.length;h++){var C=q.params.preservedcoords[h];switch(C){case "pts":0>$.inArray("dx",r)&&r.push("dx");0>$.inArray("dy",r)&&r.push("dy");0>$.inArray("points",r)&&r.push("points");break;default:r.push(C)}}"none"!==m&&(l+="; ");"image"!==m&&(l+="image",l+="; ");l+=A.shape+"({";for(k=h=0;h<r.length;h++)if(C=r[h],"shape"!==C&&"sticky"!==C&&"wcsconfig"!==C){"pts"===C&&(C="dx",q.params.preservedcoords.push("dy"),q.params.preservedcoords.push("points"));if("preservedcoords"===
C)m=!0;else if(a.notNull(A[C]))m=A[C];else if(a.notNull(q[C]))m=q[C];else switch(C){case "dx":m=q.left;break;case "dy":m=q.top;break;case "color":m=q.stroke;break;default:m=null}if(m)switch(0<k++&&(l+=","),l+='"'+C+'":',typeof m){case "string":l+='"'+m+'"';break;case "object":try{l+=JSON.stringify(m)}catch(E){a.error("can't parse: "+m,E)}break;default:l+=""+m}}l+="})";m="image"}else h=A.tags.join(","),C=h.includes("exclude")?"-":"",q=u(q,A),b.saveid&&(q.id=A.id),b.savewcsconfig&&A.wcsconfig&&0<Object.keys(A.wcsconfig).length&&
(q.wcsconfig=$.extend(!0,{},A.wcsconfig)),A.color&&!v.includes(A.color)&&(q.color=A.color),n&&(g=" # "+h),A.wcsstr&&a.isWCS(this.params.wcssys)?("wcs"!==m&&("none"!==m&&(l+="; "),l=A.wcssys?l+A.wcssys:l+this.params.wcssys,m="wcs"),l+="; "+C+A.wcsstr):A.imstr&&(m!==A.imsys&&("none"!==m&&(l+="; "),l+=A.imsys,m=A.imsys),l+="; "+C+A.imstr),!1!==b.includejson&&1===t%2&&0<Object.keys(q).length&&("line"===A.shape&&(l=l.replace(/ *{[^{}]*}$/,"")),l+=" "+JSON.stringify(q)),g&&(l+=g);!1===b.includecomments&&
(l=l.replace(/ *#[^;]*/g,""));if(y||B)y&&this.setWCSSys(y,!1),B&&this.setWCSUnits(B,!1),this.updateShapes(d,c,"export"),a.globalOpts.xeqPlugins=w;1<t&&this.display.displayMessage("regions",l);return l};a.Regions.copyRegions=function(a,b){return this.copyShapes("regions",a,b)};a.Regions.parseRegions=function(c,b){var d=this,e,f,h=[],g=/^-?(annulus|box|circle|cross|ellipse|line|polygon|point|text)$/,k=/^(fk4|fk5|icrs|galactic|ecliptic|image|physical|linear)$/,l=/^(image|physical)$/,m=/[dr:]/,n=/\(\s*([^)]+?)\s*\)/,
p=/(\{.*\})/,q=/\s*,\s*/,r=/#(?![a-zA-Z0-9]{6}['"])/,v=function(b){return"0"===b||"false"===b.toLowerCase()?!1:!0},u=function(b){for(var a,c,d,e={},f=/([a-zA-Z][a-zA-Z0-9_]*)\s*=\s*(\d+(\s*\d+)*|[^ '"{]+|['"{][^'"}]*['"}])/g,g={color:function(b){return{color:b}},dash:function(b){if(b)return{strokeDashArray:[3,1]}},dashlist:function(b){if(b){var a=b.split(" ");for(b=0;b<a.length;b++)a[b]=parseFloat(a[b]);return{strokeDashArray:a}}},delete:function(b){return{removable:v(b)}},edit:function(b){return{selectable:v(b)}},
...
b.includes("{")?d.cmd=b.split("{")[0].trim().toLowerCase():b.includes("#")?d.cmd=b.split("#")[0].trim().toLowerCase():d.cmd=b.trim().toLowerCase();d.cmd&&(d.isregion=0<=d.cmd.search(g));var e=b.trim().split(r);if((c=p.exec(e[0]))&&c[0])try{d.opts=JSON.parse(c[0].trim())}catch(M){a.error("can't parse opts: "+c[0],M)}d.comment=e[1];if(d.comment){var f=u(d.comment.trim());void 0!==f._comment&&(d.comment=f._comment,delete f._comment)}f&&(d.opts=$.extend({},f,d.opts));(c=n.exec(b))&&c[0].match(p)?d.args=
[]:c&&c[1]&&(d.args=c[1].split(q));d.isregion&&d.cmd.startsWith("-")&&(d.cmd=d.cmd.slice(1),d.comment?d.comment.match(/exclude/)||(d.comment+=",exclude"):d.comment="exclude");return d},w=function(b,c){var e={};if("d"===b.charAt(0).toLowerCase()&&"d"===c.charAt(0).toLowerCase())return e.dx=parseFloat(b.substring(1)),e.dy=parseFloat(c.substring(1)),e;b=a.strtoscaled(b);c=a.strtoscaled(c);!b.dtype.match(m)&&!c.dtype.match(m)||z||x.match(l)||(C=!0,B=x);if(z||C)return a.isHMS(B,b.dtype)&&(b.dval*=15),
"r"===b.dtype&&(b.dval=180*b.dval/Math.PI),"r"===c.dtype&&(c.dval=180*c.dval/Math.PI),c=a.wcs2pix(d.raw.wcs,b.dval,c.dval).split(/ +/),e.x=parseFloat(c[0]),e.y=parseFloat(c[1]),e;if("physical"===B)return c=d.logicalToImagePos({x:b.dval,y:c.dval}),e.x=c.x,e.y=c.y,e;e.x=b.dval;e.y=c.dval;return e},y=function(b,c){b=a.strtoscaled(b);var e=d.raw.wcsinfo||{cdelt1:1,cdelt2:1};!b.dtype.match(m)||z||x.match(l)||(C=!0,B=x);z||C?("r"===b.dtype&&(b.dval=180*b.dval/Math.PI),b.dval=Math.abs(b.dval/e["cdelt"+c])):
"physical"===B&&d.lcs&&d.lcs.physical&&(c=Math.sqrt(Math.pow(d.lcs.physical.forward[0][0],2)+Math.pow(d.lcs.physical.forward[0][1],2)),b.dval=Math.abs(b.dval*c));return b.dval};c=c.trim();if(!c.match(/(\(|\{|#|;|\n)/))return c;var x=this.getWCSSys();b=this.getWCSUnits();var B="physical";var z=a.isWCS(B);var A=c.split(/\n|;/);for(c=0;c<A.length;c++)if("#"!==A[c].trim().substr(0,1)){var C=!1;var E=t(A[c]);var D=E.args.length;if(E.isregion){var F=$.extend(!0,{},E.opts);F.shape=E.cmd;F.wcsconfig=F.wcsconfig||
{wcssys:B};2<=D&&"line"!==F.shape&&"polygon"!==F.shape&&$.extend(F,w(E.args[0],E.args[1]));F.textOpts&&void 0!==F.textOpts.ra&&void 0!==F.textOpts.dec&&(F.textOpts._wcssys=B);switch(E.cmd){case "annulus":if(0<D)for(F.radii=[],e=2;e<D;e++)F.radii.push(y(E.args[e],1));break;case "box":case "cross":3<=D&&(F.width=y(E.args[2],1));4<=D&&(F.height=y(E.args[3],2));5<=D&&(F.angle=a.strtoscaled(E.args[4]).dval);break;case "circle":3<=D&&(F.radius=y(E.args[2],1));break;case "ellipse":3<=D&&(F.r1=y(E.args[2],
1));4<=D&&(F.r2=y(E.args[3],2));5<=D&&(F.angle=a.strtoscaled(E.args[4]).dval);break;case "line":case "polygon":if(0<D)for(F.pts=[],f=e=0;e<D;e+=2,f++){var G=w(E.args[e],E.args[e+1]);a.notNull(G.dx)&&a.notNull(G.dy)?F.pts[f]={dx:G.dx,dy:G.dy}:F.pts[f]={x:G.x,y:G.y}}break;case "text":3<=D&&(F.text=E.args[2].replace(/^['"]/,"").replace(/["']$/,"")),4<=D&&(F.angle=a.strtoscaled(E.args[3]).dval)}E.comment&&(F.tags=E.comment);h.push(F)}else E.cmd.match(k)?(e=a.globalOpts.xeqPlugins,a.globalOpts.xeqPlugins=
!1,this.setWCSSys(E.cmd,!1),a.globalOpts.xeqPlugins=e,B=this.getWCSSys(),z=a.isWCS(B)):"remove"!==E.cmd&&"delete"!==E.cmd||h.push({remove:!0})}e=a.globalOpts.xeqPlugins;a.globalOpts.xeqPlugins=!1;this.setWCSSys(x,!1);this.setWCSUnits(b);a.globalOpts.xeqPlugins=e;return h};a.Regions.saveRegions=function(c,b,d){var e,f,h;c&&(f=c.match(/\.([^.]*)$/))&&f[1]&&f[1].match(/^(reg|svg|csv)$/)&&(e=f[1]);if("object"===typeof d){var g=d;d=null}else if(d&&"string"===typeof d){try{g=JSON.parse(d)}catch(p){g=null}g&&
(d=null)}g&&(a.notNull(g.layer)&&(d=g.layer),a.notNull(g.type)&&(e=g.type),a.notNull(g.format)&&(e=g.format));g=g||{};d=d||"regions";e=e||"reg";this.layers[d]||a.error("can't find layer for saveRegions: "+d);c||(c=d&&"regions"!==d?"js9_"+d+"."+e:"js9."+e);switch(e){case "svg":try{a.globalOpts.svgBorder&&(h=this.addShapes(d,"box",{left:this.rgb.img.width/2,top:this.rgb.img.height/2,width:this.rgb.img.width,height:this.rgb.img.height,color:"black",strokeWidth:1,tags:"SVGBorder"}));var k=this.layers[d].dlayer.canvas.toSVG();
a.globalOpts.svgBorder&&this.removeShapes(d,h)}catch(p){a.error("can't convert layer to SVG: "+d)}break;case "csv":try{g.mode=1;g.file=c;a.isNull(g.includewcs)&&(g.includewcs=a.globalOpts.csvIncludeWCS);a.isNull(g.savedcoords)&&(g.includedcoords=a.globalOpts.regSaveDCoords);var l=this.listRegions(b,g,d);f=l.split(";");var m=0;for(k="";m<f.length;m++)if(f[m])if(f[m].toLowerCase().match(a.WCSEXP))g.includewcs&&(k+=f[m].trim()+"\n");else{var n=f[m].replace(/\(/,",").replace(/\).*/,"").trim();k+=n+"\n"}}catch(p){a.error("can't convert layer to region: "+
d)}break;default:try{g.mode=1,g.file=c,a.isNull(g.includejson)&&(g.includejson=a.globalOpts.regIncludeJSON),a.isNull(g.includecomments)&&(g.includecomments=a.globalOpts.regIncludeComments),a.isNull(g.savedcoords)&&(g.includedcoords=a.globalOpts.regSaveDCoords),l=this.listRegions(b,g,d).replace(/; */g,"\n"),k=!1!==g.includecomments?"# Region file format: JS9 version 1.0\n"+l+"\n":l+"\n"}catch(p){a.error("can't convert layer to region: "+d)}}b=new Blob([k],{type:"text/plain;charset=utf-8"});window.hasOwnProperty("saveAs")?
a.saveAs(b,c):a.error("no saveAs() available to save region file");return this.tmp.saveregionsFile=c};a.Regions.unremoveRegions=function(){var a=this.regstack.pop();return a?this.addShapes("regions",a):null};a.Regions.changeRegionTags=function(a,b,d){var c;a=a||"all";b=b||[];d=d||[];$.isArray(b)||(b=b.split(",").map(function(b){return b.trim()}));$.isArray(d)||(d=d.split(",").map(function(b){return b.trim()}));var f=this.getShapes("regions",a);for(a=0;a<f.length;a++){var h=f[a].tags;var g=[];for(c=
0;c<b.length;c++)0>$.inArray(b[c],h)&&g.push(b[c]);for(c=0;c<h.length;c++)0>$.inArray(h[c],d)&&g.push(h[c]);this.changeShapes("regions",f[a].id,{tags:g})}};a.Regions.toggleRegionTags=function(a,b,d){var c;var f=this.getShapes("regions",a||"all");for(a=0;a<f.length;a++){var h=f[a].tags;var g="";for(c=0;c<h.length;c++)if(h[c]===b){g=h[c]=d;break}else if(h[c]===d){g=h[c]=b;break}g&&this.changeShapes("regions",f[a].id,{tags:h})}};a.Plot={};a.Plot.CLASS="JS9";a.Plot.NAME="Plot";a.Plot.opts={annotate:!1,
annotateColor:"#FF0000",color:"blue",zoomStack:{enabled:!0},selection:{mode:"xy"},series:{clickable:!0,hoverable:!0,lines:{show:!0},points:{show:!1}},legend:{backgroundColor:null,backgroundOpacity:0},xaxis:{autorange:!0},yaxis:{autorange:!0},title:"Plot Configuration",configURL:"./params/plotconfig.html"};a.Plot.logfunc=function(a){return 0===a?0:Math.log(a)};a.Plot.expfunc=function(a){return 0===a?0:Math.exp(a)};a.Plot.rescale=function(c,b,d,e,f,h,g){switch(a.globalOpts.plotLibrary){case "flot":switch(e){case "x":var k=
b.getAxes().xaxis;break;case "y":k=b.getAxes().yaxis}switch(f){case "linear":k.options.transform=null;k.options.inverseTransform=null;d.curscale[e]=f;break;case "log":k.options.transform=a.Plot.logfunc,k.options.inverseTransform=a.Plot.expfunc,d.curscale[e]=f}a.isNumber(h)?k.options.min=Number.parseFloat(h):""==h&&(k.options.min=null);a.isNumber(g)?k.options.max=Number.parseFloat(g):""==g&&(k.options.max=null);b.setupGrid();b.draw();break;case "plotly":switch(e){case "x":var l={xaxis:{type:f,autorange:!0}};
d.curscale[e]=f;break;case "y":l={yaxis:{type:f,autorange:!0}},d.curscale[e]=f}Plotly.restyle(c.attr("id"),l)}};a.Plot.annotate=function(c,b,d){var e;var f=[];var h=d.data,g=d.annotations.color||a.Plot.opts.annotateColor,k=function(b,a){if(!b.text)return null;var c=b.x||0;if("%Y"===b.y.toUpperCase())for(b=1;b<a.length-1;b++){if(a[b][0]>c){var d=Math.max(a[b-1][1],a[b][1],a[b+1][1]);break}}else d=b.y;return{x:c,y:d}};switch(a.globalOpts.plotLibrary){case "flot":var l=-25;c.find(".plotAnnotation").remove();
for(e=0;e<d.annotations.data.length;e++){var m=d.annotations.data[e];var n=k(m,h);f=b.pointOffset({x:n.x,y:n.y});0>f.left||f.left>c.width()||(m=sprintf("<div class='plotAnnotation' style='position: absolute; left: %spx; top:%spx; color: %s; font-size: small'>%s</div>",f.left,f.top+l,g,"&darr;"+m.text),c.append(m))}break;case "plotly":l=-30;for(e=0;e<d.annotations.data.length;e++)if(m=d.annotations.data[e],n=k(m,h))c={x:n.x,y:n.y,xref:"x",yref:"y",text:m.text,arrowcolor:g,font:{color:g},showarrow:!0,
arrowhead:2,ax:0,ay:l},f.push(c);return f}};a.Plot.initConfigForm=function(c,b){var d,e;var f=c.winid;var h="#"+$(f).attr("id")+" #plotConfigForm ";var g=function(b){if(void 0!==b)return"number"===typeof b&&0!==b%1&&(b=Math.round(100*(b+.001))/100),String(b)};c&&b&&"flot"===a.globalOpts.plotLibrary&&($(h+".val").each(function(f,h){d="";e=$(h).attr("name");switch(e){case "xscale":a.notNull(b.curscale.x)&&(d=g(b.curscale.x));break;case "xmin":a.notNull(c.getAxes().xaxis.options.min)&&(d=g(c.getAxes().xaxis.options.min));
break;case "xmax":a.notNull(c.getAxes().xaxis.options.max)&&(d=g(c.getAxes().xaxis.options.max));break;case "yscale":a.notNull(b.curscale.y)&&(d=g(b.curscale.y));break;case "ymin":a.notNull(c.getAxes().yaxis.options.min)&&(d=g(c.getAxes().yaxis.options.min));break;case "ymax":a.notNull(c.getAxes().yaxis.options.max)&&(d=g(c.getAxes().yaxis.options.max))}$(h).val(d)}),$(h).data("im",this),$(h).data("plot",c),$(h).data("pobj",b),$(h).data("winid",f),$(h).data("tooltipInit")||($(h).data("tooltipInit",
!0),a.BROWSER[3]?(f="touchstart",h="touchend"):(f="mouseover",h="mouseout"),$(".plotcol_P").on(f,function(b){var c=b.currentTarget;b=$(c).find("input").data("tooltip");c=$(c).closest(a.lightOpts[a.LIGHTWIN].top).find(a.lightOpts[a.LIGHTWIN].dragBar);b&&c.length&&(b=a.Plot.opts.title+": "+b,$(c)[0].childNodes[0].nodeValue=b)}),$(".plotcol_P").on(h,function(b){b=$(b.currentTarget).closest(a.lightOpts[a.LIGHTWIN].top).find(a.lightOpts[a.LIGHTWIN].dragBar);b.length&&($(b)[0].childNodes[0].nodeValue=a.Plot.opts.title)})))};
a.Plot.processConfigForm=function(c,b,d,e){var f=e.length;switch(a.globalOpts.plotLibrary){case "plotly":return}for(c=0;c<f;c++){var h=e[c].name;var g=e[c].value;switch(h){case "xscale":""===g&&(g="linear");a.Plot.rescale(null,b,d,"x",g);break;case "xmin":a.Plot.rescale(null,b,d,"x",null,g,null);break;case "xmax":a.Plot.rescale(null,b,d,"x",null,null,g);break;case "yscale":""===g&&(g="linear");a.Plot.rescale(null,b,d,"y",g);break;case "ymin":a.Plot.rescale(null,b,d,"y",null,g,null);break;case "ymax":a.Plot.rescale(null,
b,d,"y",null,null,g)}}a.Plot.initConfigForm.call(this,b,d)};a.plotOpts=a.Plot.opts;a.Catalogs={};a.Catalogs.CLASS="JS9";a.Catalogs.NAME="Catalogs";a.Catalogs.opts={hasControls:!1,hasRotatingPoint:!1,hasBorders:!1,lockMovementX:!0,lockMovementY:!0,lockRotation:!0,lockScalingX:!0,lockScalingY:!0,lockUniScaling:!0,selectable:!1,canvas:{selection:!1},updateWCS:!1,panzoom:!0,shape:"circle",strokeWidth:2,width:10,height:10,radius:5,eradius:{x:5,y:3},angle:0,tagcolors:{defcolor:"#00FF00"},sortOverlapping:!1};
...
d=/iPad|iPhone|iPod/.test(navigator.platform)?!0:d.shiftKey;if(c.tmp.arrowCrosshair||d&&c&&!c.tmp.shiftKey&&c.crosshair&&c.params.crosshair){if(c.tmp.arrowCrosshair&&!c.params.crosshair){var f=a.Crosshair.opts.arrowSize/c.rgb.sect.zoom;d=b.x-f;var h=b.x+f;var g=b.y-f;var k=b.y+f}else d=0,h=c.raw.width,g=0,k=c.raw.height;h={pts:[{x:d,y:b.y},{x:h,y:b.y}],redraw:!1};c.changeShapes(e,c.crosshair.h,h);d={pts:[{x:b.x,y:g},{x:b.x,y:k}],redraw:!0};c.changeShapes(e,c.crosshair.v,d);c.crosshair.visible=!0;
if(a.globalOpts.wcsCrosshair&&c&&c.raw.wcs&&0<c.raw.wcs){g=a.pix2wcs(c.raw.wcs,b.x,b.y).trim().split(/\s+/);var l=a.saostrtod(g[0]);a.isHMS(c.params.wcssys)&&(l*=15);var m=a.saostrtod(g[1]);for(b=0;b<a.displays.length;b++)if((f=a.displays[b].image)&&f!==c&&f.crosshair&&f.params.crosshair&&0<f.raw.wcs){h=f.raw.width;k=f.raw.height;try{var n=a.wcs2pix(f.raw.wcs,l,m)}catch(p){n=null}n&&(g=n.trim().split(/\s+/),d=parseFloat(g[0]),g=parseFloat(g[1]),0<d&&d<h&&0<g&&g<k&&(h={pts:[{x:0,y:g},{x:h,y:g}],redraw:!1},
f.changeShapes(e,f.crosshair.h,h),d={pts:[{x:d,y:0},{x:d,y:k}],redraw:!0},f.changeShapes(e,f.crosshair.v,d),f.crosshair.visible=!0))}}}};a.Crosshair.hide=function(c,b,d){b=a.Crosshair.LAYERNAME;d=a.Crosshair.opts.hiddenPts;if(c&&c.crosshair&&c.crosshair.visible||c.tmp.arrowCrosshairVisible)c.changeShapes(b,c.crosshair.h,d),c.changeShapes(b,c.crosshair.v,d),c.crosshair.visible=!1,delete c.tmp.arrowCrosshairVisible};a.Crosshair.create=function(c){var b=a.Crosshair.opts.hiddenPts,d=a.Crosshair.LAYERNAME;
...
":",c.sexaPrec);var h=b.split(":");if(c.last[d])for(b="",e=0;e<h.length;e++)if(b&&(b+=":"),f||h[e]!==c.last[d][e])b+=h[e],f=!0;c.last[d]=$.extend({},h);break;default:b=b.toFixed(c.degPrec)}b=b.replace(/0+$/,"");c=b.indexOf(".");0>c?b+=".0":c===b.length-1&&(b+="0");return b=b.replace(/:\.0/,":0.0")};a.Grid.display=function(c,b){var d,e,f,h;var g=this.display;var k=this.raw;var l=[{ra:0,dec:0},{ra:0,dec:0},{ra:0,dec:0},{ra:0,dec:0}];if(a.isNull(c))switch(this.tmp.gridStatus){case "inactive":case void 0:return!1;
...
g.width)),Math.max(1,Math.floor(k.height/g.height))];b=[{x:0,y:0},{x:k.width-1,y:k.height-1}]}else{m=c.reduceDims?k.width<k.height?[k.width/k.height,1]:k.height<k.width?[1,k.height/k.width]:[1,1]:[1,1];b=[];var n={x:this.ix+c.margin,y:this.iy-c.margin};var p=this.displayToImagePos(n);b[0]={x:p.x,y:p.y};n={x:g.width-1-this.ix-c.margin,y:g.height-1-this.iy-c.margin};p=this.displayToImagePos(n);b[1]={x:p.x,y:p.y}}var q=a.pix2wcs(k.wcs,b[0].x,b[0].y).trim().split(/\s+/);l[0].ra=a.saostrtod(q[0]);l[0].dec=
a.saostrtod(q[1]);q=a.pix2wcs(k.wcs,b[0].x,b[1].y).trim().split(/\s+/);l[1].ra=a.saostrtod(q[0]);l[1].dec=a.saostrtod(q[1]);q=a.pix2wcs(k.wcs,b[1].x,b[0].y).trim().split(/\s+/);l[2].ra=a.saostrtod(q[0]);l[2].dec=a.saostrtod(q[1]);q=a.pix2wcs(k.wcs,b[1].x,b[1].y).trim().split(/\s+/);l[3].ra=a.saostrtod(q[0]);l[3].dec=a.saostrtod(q[1]);g=l[0].ra;p=l[0].dec;b=l[0].ra;var r=l[0].dec;for(q=1;4>q;q++)g=Math.min(g,l[q].ra),p=Math.min(p,l[q].dec),b=Math.max(b,l[q].ra),r=Math.max(r,l[q].dec);q=a.Grid.limits.call(this,
c,g,b,c.raLines*m[0]);g=q.lo;b=q.hi;l=q.inc;q=a.Grid.limits.call(this,c,p,r,c.decLines*m[1]);p=q.lo;r=q.hi;var v=q.inc;a.wcsunits(this.raw.wcs,c.wcsunits);var u=Math.abs(this.raw.wcsinfo.cdelt1);var t=u*a.Grid.opts.stride;var w=b-t;var y=Math.abs(this.raw.wcsinfo.cdelt2);var x=y*a.Grid.opts.stride;var B=r-x;q="image;";for(f=g;f<=b;f+=l){var z="line(";var A=y;n=e=0;for(h=p;h<=r;h+=A)(d=a.wcs2pix(k.wcs,f,h).trim().split(/ +/))&&d.length&&(m=parseFloat(d[0]),d=parseFloat(d[1]),m>=-c.margin&&m<=k.width+
c.margin&&d>=-c.margin&&d<=k.height+c.margin?(z+=String(m+1+","+d+1+", "),n++,0===e?(e=1,h<B&&(A=x)):1===e&&h>B&&(e=2,A=y)):1===e&&(e=2,h-=A,A=y));1<n&&(q+=z.replace(/,\s+$/,") "),q+=' {"color": "'+c.lineColor+'"};')}for(h=p;h<=r;h+=v){z="line(";A=u;n=e=0;for(f=g;f<=b;f+=A)(d=a.wcs2pix(k.wcs,f,h).trim().split(/ +/))&&d.length&&(m=parseFloat(d[0]),d=parseFloat(d[1]),m>=-c.margin&&m<=k.width+c.margin&&d>=-c.margin&&d<=k.height+c.margin?(z+=String(m+1+","+d+1+", "),n++,0===e?(e=1,f<w&&(A=t)):1===e&&
f>w&&(e=2,A=u)):1===e&&(e=2,f-=A,A=u));1<n&&(q+=z.replace(/,\s+$/,") "),q+=' {"color": "'+c.lineColor+'"};')}e=c.labelDecOffx/this.rgb.sect.zoom;A=c.labelDecOffy/this.rgb.sect.zoom;u=0;f=t=g;for(z=0;f<=b;f+=l){for(h=p;h<=r;h+=v)(d=a.wcs2pix(k.wcs,f,h).trim().split(/ +/))&&d.length&&(m=parseFloat(d[0]),d=parseFloat(d[1]),n=this.imageToDisplayPos({x:m,y:d}),n.x>this.ix+c.labelMargin&&n.x<this.rgb.img.width+this.ix-c.labelMargin&&n.y>this.iy+c.labelMargin&&n.y<this.rgb.img.height+this.iy-c.labelMargin&&
...
d.length&&(m=parseFloat(d[0]),d=parseFloat(d[1]),n=this.imageToDisplayPos({x:m,y:d}),n.x>this.ix+c.labelMargin&&n.x<this.rgb.img.width+this.ix-c.labelMargin&&n.y>this.iy+c.labelMargin&&n.y<this.rgb.img.height+this.iy-c.labelMargin&&(u>=c.raSkip?(q+=sprintf('text(%s,%s,%s,%s) {"color":"%s", "fontFamily":"%s", "fontSize":%s, "fontStyle":"%s", "fontWeight":"%s", "originX":"left", "originY":"top"};',m+e,d+A,a.Grid.getLabel.call(this,c,f,"ra"),c.raAngle,c.labelColor,c.labelFontFamily,c.labelFontSize,c.labelFontStyle,
...
b++}return!1}});a.getRawCopy=function(a,b){var c=$.extend(!0,{},a);c.bitpix=b||a.bitpix;switch(c.bitpix){case 8:c.data=new Uint8Array(a.data);break;case 16:c.data=new Int16Array(a.data);break;case -16:c.data=new Uint16Array(a.data);break;case 32:c.data=new Int32Array(a.data);break;case -32:c.data=new Float32Array(a.data);break;case -64:c.data=new Float64Array(a.data)}return c};a.getRawLine=function(c,b,d,e){switch(c.bitpix){case 8:var f=new Uint8Array(c.data.buffer,b,c.width);var h=new Uint8Array(d.data.buffer,
e,c.width);break;case 16:case -16:f=new Uint16Array(c.data.buffer,b,c.width);h=new Uint16Array(d.data.buffer,e,c.width);break;case 32:f=new Uint32Array(c.data.buffer,b,c.width);h=new Uint32Array(d.data.buffer,e,c.width);break;case -32:f=new Float32Array(c.data.buffer,b,c.width);h=new Float32Array(d.data.buffer,e,c.width);break;case -64:f=new Float64Array(c.data.buffer,b,c.width);h=new Float64Array(d.data.buffer,e,c.width);break;default:a.error("unknown bitpix value for flip: "+c.bitpix)}return[f,
h]};a.memcpy=function(a,b,d,e,f){a=new Uint8Array(a,b,f);d=new Uint8Array(d,e,f);a.set(d)};a.jupyterFocus=function(a,b){window.hasOwnProperty("Jupyter")&&(a=a instanceof jQuery?a:$(a),a.find(b||"input, textarea").each(function(b,a){Jupyter.keyboard_manager.register_events($(a))}))};a.getImageID=function(c,b,d){var e,f=0,h=1,g=a.images.length,k=/.*<([0-9][0-9]*)>$/,l=/<[0-9][0-9]*>/;c=c.replace(l,"");for(e=0;e<g;e++){var m=a.images[e];m.display.id===b&&m!==d&&c===m.id0.replace(l,"")&&(m.id&&0<=m.id.search(k)&&
(m=m.id.replace(k,"$1"),h=Math.max(h,parseInt(m,10))),f++)}return f?c+"<"+String(h+1)+">":c};a.uniqueID=function(){var a=1;return function(){return a++}}();a.waiting=function(c,b){switch(c){case !0:if(window.hasOwnProperty("Spinner")&&"spinner"===a.globalOpts.waitType){if(b)if("object"===typeof b)var d=b.divjq[0];else"string"===typeof b&&(c=a.lookupDisplay(b))&&(d=c.divjq[0]);d||(d=$("body").get(0));a.spinner||(a.spinner={},c={color:a.globalOpts.spinColor,opacity:a.globalOpts.spinOpacity},a.spinner.spinner=
...
typeof c&&(l=c);if(l&&"object"===typeof l&&l.hasOwnProperty("display")&&1===Object.keys(l).length){k.pop();break a}}l={display:f}}else l=null}switch(e){case "RunAnalysis":b&&(1===d.length&&d.push(null),d.push(b))}l&&d.push(l);try{var m=a.publics[e].apply(a.publics,$jscomp.arrayFromIterable(d))}catch(n){m="ERROR: "+n.message}if(b){a.globalOpts.alerts=h;if(m instanceof a.Display||m instanceof a.Image)m=m.id;switch(e){case "NewShapeLayer":m&&m.layerName&&(m=m.layerName);break;case "RunAnalysis":m.match(/^ERROR:/)||
(b=null)}b&&b(m)}return m}if(e&&"#"!==e){l=a.lookupCommand(e);k=a.lookupDisplay(f);if(l&&k)switch(l.getDisplayInfo(k),c.args?d=$.extend(!0,[],c.args):c.paramlist&&(d=c.paramlist.split(/ +/)),l.getWhich(d)){case "get":try{m=l.get(d)||""}catch(n){m="ERROR: "+n.message}break;case "set":try{m=l.set(d)||g}catch(n){m="ERROR: "+n.message}break;default:m="ERROR: unknown cmd type for '"+e+"'"}else l||(m="ERROR: unknown cmd '"+e+"'"),k||(m="ERROR: unknown display ("+f+")");if(b){a.globalOpts.alerts=h;if(m instanceof
a.Display||m instanceof a.Image)m=m.id;b(m)}return m}b&&b("");b&&(a.globalOpts.alerts=h)};a.lightWin=function(c,b,d,e,f){f=f||"";switch(a.LIGHTWIN){case "dhtml":f.match(/(left|top|center)=/)||(f&&(f+=","),f+=""+a.globalOpts.lightWinPos);var h=dhtmlwindow.open(c,b,d,e,f);/iPad|iPhone|iPod/.test(navigator.platform)&&$("#"+c+" "+a.lightOpts[a.LIGHTWIN].drag).css("-webkit-overflow-scrolling","touch").css("overflow-y","scroll");$("#"+c+" "+a.lightOpts[a.LIGHTWIN].dragBar).on("dblclick",function(){h.close()}).on("touchend",
function(b){var c=(new Date).getTime(),d=$(b.currentTarget).data("lasttime");d&&c-d>a.DBLCLICK0&&c-d<a.DBLCLICK&&h.close();$(b.currentTarget).data("lasttime",c)});$("#"+c+" "+a.lightOpts[a.LIGHTWIN].dragBar).on("touchend",function(){dhtmlwindow.distancex||dhtmlwindow.distancey?0<a.lightOpts.nclick&&(a.lightOpts.nclick=0):2<=a.lightOpts.nclick?(alert("trouble closing this window? double-tap the window handle"),a.lightOpts.nclick=-1):0<=a.lightOpts.nclick&&a.lightOpts.nclick++})}return h};a.checkNew=
...
b,d){var c="";if(void 0===a)return c;-2>b?(b="%."+String(2+d)+"e",c=sprintf(b,a)):0>b?c=a.toFixed(Math.abs(b)+3+d):2>b?(b="%."+String(b+d)+"f",c=sprintf(b,a)):5>b?c=a.toFixed(0+d):(b="%."+String(2+d)+"e",c=sprintf(b,a));return c};a.centerPolygon=function(a){var b;if(a&&a.length){var c=a.length;for(b=0;b<c;b++){if(void 0===e||a[b].x<e)var e=a[b].x;if(void 0===f||a[b].x>f)var f=a[b].x;if(void 0===h||a[b].y<h)var h=a[b].y;if(void 0===g||a[b].y>g)var g=a[b].y}return{x:(e+f)/2,y:(h+g)/2}}};a.centroidPolygon=
function(a,b){var c=0,e=0,f=0,h=0,g=0,k=[];if(a&&a.length){var l=a.length;if(b){for(b=0;b<l;b++)h+=a[b].x,g+=a[b].y;return{x:h/l,y:g/l}}for(b=0;b<l;b++)k[b]={},k[b].x=a[b].x,k[b].y=a[b].y;k[l]={};k[l].x=k[0].x;k[l].y=k[0].y;for(b=0;b<l;b++)a=k[b].x*k[b+1].y-k[b+1].x*k[b].y,c+=a,e+=(k[b].x+k[b+1].x)*a,f+=(k[b].y+k[b+1].y)*a;l=c/2;return{x:e/(6*l),y:f/(6*l)}}};a.lookupImage=function(c,b){var d,e,f=a.images.length;if(!c)return null;window.isElectron&&window.currentDir&&(e=window.currentDir+"/"+c);for(d=
0;d<f;d++){var h=a.images[d];if((c===h||c===h.id||c===h.file||c===h.file.replace(/\[.*\]$/,"")||e===h.file||e===h.file.replace(/\[.*\]$/,"")||c===h.file0||c===a.TOROOT+h.file||h.fitsFile&&c===h.fitsFile)&&0<$("#"+h.display.id).length){var g=h.display.id;if(!b||"string"===typeof b&&b===g||"object"===typeof b&&b.id===g)return h}}return null};a.lookupDisplay=function(c,b){var d,e=new RegExp("[-_]?("+a.PLUGINS+")$");void 0===b&&(b=!0);if(c&&0>c.toString().search(a.SUPERMENU)){for(d=0;d<a.displays.length;d++)if(c===
...
function(){var a=0;var g=document.createElement("canvas");var h=g.getContext("2d");var q=l.height,r=l.width;g.width=r;g.height=q;h.drawImage(l,0,0);e=h.getImageData(0,0,r,q).data;f=new Float32Array(q*r);for(h=0;h<q;h++)for(g=0;g<r;g++){var v=.299*e[a]+.587*e[a+1]+.114*e[a+2];f[(q-h)*r+g]=v;a+=4}k={head:{SIMPLE:!0,BITPIX:-32,NAXIS:2,NAXIS1:r,NAXIS2:q},filename:c.name,filedata:f,naxis:2,axis:[0,r,q],bitpix:-32,bin:1,data:f};k.dmin=Number.MAX_VALUE;k.dmax=Number.MIN_VALUE;for(a=0;a<q*r;a++)Number.isNaN(k.data[a])||
...
window.hasOwnProperty("JS9Prefs")&&"object"===typeof JS9Prefs&&JS9Prefs.globalOpts&&JS9Prefs.globalOpts.installDir&&(a.INSTALLDIR=JS9Prefs.globalOpts.installDir);if(!a.INSTALLDIR){try{$('link[href$="js9.css"]').each(function(b,c){(b=$(c).attr("href"))&&"js9.css"===b.split("/").reverse()[0]&&(a.INSTALLDIR=b.replace(/js9\.css$/,""))})}catch(b){a.INSTALLDIR=""}a.INSTALLDIR&&(a.INSTALLDIR=a.cleanPath(a.INSTALLDIR))}a.INSTALLDIR&&"/"!==a.INSTALLDIR.slice(-1)&&(a.INSTALLDIR+="/");a.TOROOT=a.INSTALLDIR.replace(/([^/.])+/g,
...
a.globalOpts,a.userOpts.displays)}try{c=localStorage.getItem("images")}catch(b){c=null}if(c){try{a.userOpts.images=JSON.parse(c)}catch(b){}a.userOpts.images&&$.extend(!0,a.imageOpts,a.userOpts.images)}try{c=localStorage.getItem("fits")}catch(b){c=null}if(c)try{a.userOpts.fits=JSON.parse(c)}catch(b){}try{c=localStorage.getItem("regions")}catch(b){c=null}if(c){try{a.userOpts.regions=JSON.parse(c)}catch(b){}a.userOpts.regions&&$.extend(!0,a.Regions.opts,a.userOpts.regions)}try{c=localStorage.getItem("grid")}catch(b){c=
null}if(c){try{a.userOpts.images=JSON.parse(c)}catch(b){}a.userOpts.images&&$.extend(!0,a.Grid.opts,a.userOpts.images)}try{c=localStorage.getItem("catalog")}catch(b){c=null}if(c){try{a.userOpts.images=JSON.parse(c)}catch(b){}a.userOpts.images&&$.extend(!0,a.Catalogs.Opts,a.userOpts.images)}}a.DEBUG=a.DEBUG||a.globalOpts.debug||0;$("div.JS9").each(function(b,c){a.checkNew(new a.Display($(c)))});if(window.Worker&&!a.allinone)try{a.worker=new a.WebWorker(a.InstallDir(a.WORKERFILE))}catch(b){}a.allinone?
a.initFITS():a.initEmscripten();window.isElectron&&window.electronHelper&&(a.globalOpts.helperType="nodejs");a.helper=new a.Helper;window.addEventListener("message",function(b){var c=b.origin||b.originalEvent.origin;b=b.data;"null"===c&&(c="unknown");if(a.globalOpts.postMessage){if("string"===typeof b)try{var e=JSON.parse(b)}catch(f){a.error("can't parse msg: "+b,f)}else"object"===typeof b?e=b:a.error("invalid msg from postMessage");a.msgHandler(e,function(a,b,c,d){d=d||{};parent.postMessage({cmd:e.cmd,
res:{name:d.name,rtype:d.rtype,rdata:a,stdout:a,stderr:b,errcode:c}},"*")})}else a.DEBUG&&(c="JS9 ignoring postMessage, origin: "+c,c="string"===typeof b?c+(" data: "+b):"object"===typeof b?c+(" obj: "+JSON.stringify(Object.keys(b))):c+(" typeof: "+typeof b),a.log(c))},!1);window.hasOwnProperty("ImageFilters")&&(a.ImageFilters=ImageFilters);a.initColormaps();a.initCommands();a.initAnalysis();a.RegisterPlugin(a.MouseTouch.CLASS,a.MouseTouch.NAME,a.MouseTouch.init,{menuItem:"Mouse/Touch",onplugindisplay:a.MouseTouch.init,
help:"help/mousetouch.html",winTitle:"Mouse/Touch Actions",winResize:!0,winDims:[a.MouseTouch.WIDTH,a.MouseTouch.HEIGHT]});a.RegisterPlugin(a.Regions.CLASS,a.Regions.NAME,a.Regions.init,{divArgs:["regions"],winDims:[0,0]});a.RegisterPlugin(a.Crosshair.CLASS,a.Crosshair.NAME,a.Crosshair.init,{onmousemove:a.Crosshair.display,onkeyboardaction:a.Crosshair.keyaction,onkeyup:a.Crosshair.keyup,onimageload:a.Crosshair.create,winDims:[0,0]});a.RegisterPlugin(a.Grid.CLASS,a.Grid.NAME,a.Grid.init,{onsetpan:a.Grid.regrid,
onsetzoom:a.Grid.regrid,onsetwcssys:a.Grid.regrid,onsetwcsunits:a.Grid.regrid,onimageload:a.Grid.regrid,onupdateprefs:a.Grid.regrid,winDims:[0,0]});a.RegisterPlugin(a.Dysel.CLASS,a.Dysel.NAME,a.Dysel.init,{onimageload:a.Dysel.imageload,onimageclose:a.Dysel.imageclose,winDims:[0,0]});a.RegisterPlugin(a.Titlebar.CLASS,a.Titlebar.NAME,a.Titlebar.init,{onimageload:a.Titlebar.imageload,onimagedisplay:a.Titlebar.imagedisplay,onimageclose:a.Titlebar.imageclose,winDims:[0,0]});a.instantiatePlugins();a.plugins.sort(function(a,
c){a=a.opts.menuItem;c=c.opts.menuItem;return a?!c||a<c?-1:a>c?1:0:1});$(document).scrollTop(0);a.inited=!0;$(document).trigger("JS9:init")};return a}();
