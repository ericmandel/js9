...
JSON.parse(d)}catch(c){a.log("can't get analysis",c)}});return this};a.Image.prototype.expandMacro=function(c,b){var d,e,f=this;if(c)return d=c.replace(/\$([a-zA-Z0-9_()]+)/g,function(d,c){var j,k;j=function(a,d){var c=a.params.wcssys;if(d)switch(d){case "wcs":if("physical"===c||"image"===c)a.params.wcssys=a.params.wcssys0;break;case "physical":case "image":a.params.wcssys=d}return c};var m=function(a,d){var c;"table"===a.imtab&&a.raw.hdu.table.filter?d+="["+a.raw.hdu.table.filter+"]":"image"===a.imtab&&
(c=a.file.match(/\[.*\]/))&&(d=d.match(/\[.*\]/)?d.replace(/\[.*\]/,c):d+c);return d},n=c.split("(");n[1]&&(n[1]=n[1].replace(/\)$/,""));switch(n[0]){case "id":k=f.display.divjq.attr("id");break;case "image":case "png":k=f.id;break;case "filename":"parent"===n[1]&&f.parentFile?k=f.parentFile:f.fitsFile?k=m(f,f.fitsFile):a.error("no FITS file for "+f.id);break;case "fits":f.fitsFile||a.error("no FITS file for "+f.id);k=m(f,f.fitsFile);break;case "parent":f.parentFile||a.error("no parent FITS file for "+
...
this.divjq.on("wheel",this,function(c){return a.wheelCB(c)});this.divjq.on("dragenter",this,function(c){return a.dragenter(this.id,c)});this.divjq.on("dragover",this,function(c){return a.dragover(this.id,c)});this.divjq.on("dragexit",this,function(c){return a.dragexit(this.id,c)});this.divjq.on("drop",this,function(c){return a.dragdrop(this.id,c,a.NewFITSImage)});this.divjq.on("contextmenu",this,function(){return!1});this.divjq.append('<div style="visibility:hidden; position:relative; top:-50;left:-50"> <input type="file" id="openLocalFile-'+
...
a.Regions.keyDownCB(g,g.ipos,c,g.layer)};a.dragenter=function(a,b){b.stopPropagation();b.preventDefault()};a.dragover=function(a,b){b.stopPropagation();b.preventDefault()};a.dragexit=function(a,b){b.stopPropagation();b.preventDefault()};a.dragdrop=function(c,b,d){var e,f;b=b.originalEvent;e=b.target.files||b.dataTransfer.files;f=$.extend(!0,{},a.fits.options);b.stopPropagation();b.preventDefault();void 0===f.display&&(f.display=c);void 0===f.extlist&&(f.extlist=a.globalOpts.extlist);a.onFileList(e,
f,d)};a.consoleKeyDownCB=function(c){var b=c.data,d=c.which||c.keyCode;if(!a.specialKey(c)){c=b.consoleConjq.find(".JS9CmdIn:last");c.focus();if(b.hist.length&&(38===d||40===d)){b.hist[b.histpos]?b.hist[b.histpos]=c.val():b.histtemp=c.val();switch(d){case 38:b.histpos--;0>b.histpos&&(b.histpos=0);break;case 40:b.histpos++;b.histpos>b.hist.length&&(b.histpos=b.hist.length);break;default:a.error("internal keycode switch mixup")}b.hist[b.histpos]?(c.val(b.hist[b.histpos]),b.histused=b.histpos!==b.hist.length?
