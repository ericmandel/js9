...
{onimageload:a.Dysel.imageload,onimageclose:a.Dysel.imageclose,winDims:[0,0]});a.RegisterPlugin(a.Titlebar.CLASS,a.Titlebar.NAME,a.Titlebar.init,{onimageload:a.Titlebar.imageload,onimagedisplay:a.Titlebar.imagedisplay,onimageclose:a.Titlebar.imageclose,winDims:[0,0]});a.instantiatePlugins();a.plugins.sort(function(a,b){a=a.opts.menuItem;b=b.opts.menuItem;return a?!b||a<b?-1:a>b?1:0:1});if(a.globalOpts.processQueryParams&&(c=new URL(window.location),c.searchParams)){b={};c=$jscomp.makeIterator(c.searchParams);
for(var d=c.next();!d.done;d=c.next()){var e=$jscomp.makeIterator(d.value);d=e.next().value;e=e.next().value;switch(d){case "url":case "file":var f=e;break;case "display":var h={display:e};break;default:b[d]=e}}f&&(h?a.Preload(f,b,h):a.Preload(f,b))}$(document).scrollTop(0);a.inited=!0;$(document).trigger("JS9:init")};return a}();
