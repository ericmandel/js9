...
"").split(","),e=a=0;a<m.radii.length;a++)""!==m.radii[a]&&(c.sizeScale&&(m.radii[a]*=c.sizeScale),m.radii[e++]=this.wcs2imlen(m.radii[a]));else{if(m.radii=c.radii,c.sizeScale)for(a=0;a<m.radii.length;a++)m.radii[a]*=c.sizeScale}else for(c.ireg&&b.SCALEIREG&&(b.notNull(c.iradius)&&(c.iradius/=h),b.notNull(c.oradius)&&(c.oradius/=h)),c.sizeScale&&(b.notNull(c.iradius)&&(c.iradius*=c.sizeScale),b.notNull(c.oradius)&&(c.oradius*=c.sizeScale)),h=(c.oradius-c.iradius)/c.nannuli,g=c.nannuli+1,a=0;a<g;a++)e=
c.iradius+h*a,c.sizeScale&&(e*=c.sizeScale),m.radii.push(e);break;case "box":c.ireg&&b.SCALEIREG&&(b.notNull(c.width)&&(c.width/=h),b.notNull(c.height)&&(c.height/=h));c.sizeScale&&(b.notNull(c.width)&&(c.width*=c.sizeScale),b.notNull(c.height)&&(c.height*=c.sizeScale));break;case "circle":c.ireg&&b.SCALEIREG&&b.notNull(c.radius)&&(c.radius/=h);c.sizeScale&&b.notNull(c.radius)&&(c.radius*=c.sizeScale);break;case "ellipse":c.ireg&&b.SCALEIREG&&(b.notNull(c.r1)&&(c.r1/=h),b.notNull(c.r2)&&(c.r2/=h));
c.sizeScale&&(b.notNull(c.r1)&&(c.r1*=c.sizeScale),b.notNull(c.r2)&&(c.r2*=c.sizeScale));break;case "point":switch(c.ptshape){case "box":c.width=2*c.ptsize;c.height=2*c.ptsize;break;case "circle":c.radius=c.ptsize;break;case "ellipse":c.rx=c.ptsize,c.ry=c.ptsize/2}c.lockRotation=!0;c.lockScalingX=!0;c.lockScalingY=!0;c.lockUniScaling=!0;c.hasControls=!1;c.hasRotatingPoint=!1;c.hasBorders=!0;break;case "line":case "polygon":if(void 0!==c.wcspts&&0<this.raw.wcs){c.pts=[];c.wcssys&&(g=this.getWCSSys(),
e=b.globalOpts.xeqPlugins,b.globalOpts.xeqPlugins=!1,this.setWCSSys(c.wcssys));for(a=0;a<c.wcspts.length;a++)f=b.wcs2pix(this.raw.wcs,c.wcspts[a].ra,c.wcspts[a].dec).trim().split(/ +/),c.pts.push({x:parseFloat(f[0]),y:parseFloat(f[1])});g&&(this.setWCSSys(g),b.globalOpts.xeqPlugins=e)}if(c.pts&&c.pts.length){if("string"===typeof c.pts){f=c.pts.replace(/ /g,"").split(",");g=f.length;if("string"===typeof f[0])for(a=0;a<g;a++)f[a]=parseFloat(f[a]);c.pts=[];for(e=a=0;a<g;a+=2,e++)c.pts[e]={x:f[a],y:f[a+
1]}}g=c.pts.length;for(a=0;a<g;a++)c.pts[a]=this.imageToDisplayPos(c.pts[a]);c.left&&c.top?e={x:c.left,y:c.top}:(e=b.centerPolygon(c.pts),n.left=e.x,n.top=e.y);c.points=[];for(a=0;a<g;a++)f={x:(c.pts[a].x-e.x)/h,y:(c.pts[a].y-e.y)/h},c.points.push(f)}else d&&d.points&&d.points.length||("polygon"===c.shape&&c.polypoints?c.points=c.polypoints:"line"===c.shape&&c.linepoints&&(c.points=c.linepoints));if(c.ireg&&b.SCALEIREG)for(g=c.points.length,a=0;a<g;a++)c.points[a].x/=h,c.points[a].y/=h}for(k in c)if(c.hasOwnProperty(k))switch(k){case "tags":case "x":case "y":case "px":case "py":case "dx":case "dy":case "ra":case "dec":case "pts":case "left":case "top":case "angle":case "radii":case "ireg":break;
...
""===d||d.match(/NaN/)))continue;if("data"!==e||"object"!==typeof g.data||!1!==g.data.doexport)"strokeWidth"===e&&g.sw1?f[e]=g.sw1:void 0!==a[e]?f[e]=a[e]:void 0!==g[e]?f[e]=g[e]:b&&void 0!==b[e]&&(f[e]=b[e])}if(0<h.length&&h[0].obj.text){c=h[0].obj;f.text=c.text;f.textOpts=r(c);if(a.angle!==c.angle){if(f.textOpts.angle=-c.angle,"circle"===a.params.shape||"annulus"===a.params.shape)c.params.parent.moved=!0}else 0===c.angle||"circle"!==a.params.shape&&"annulus"!==a.params.shape||(f.textOpts.angle=
-c.angle,c.params.parent.moved=!0);c.params.parent.moved&&(c.pub.ra&&c.pub.dec?(f.textOpts.ra=c.pub.ra,f.textOpts.dec=c.pub.dec):c.pub.lcs?(f.textOpts.px=c.pub.lcs.x,f.textOpts.py=c.pub.lcs.y):(f.textOpts.x=c.pub.x,f.textOpts.y=c.pub.y));f.textOpts.color===a.stroke&&delete f.textOpts.color;f.textOpts.text&&delete f.textOpts.text;Object.keys(f.textOpts).length||delete f.textOpts}return f};if("string"===typeof c)try{c=JSON.parse(c)}catch(u){b.error("can't parse listRegions opts: "+c,u)}c=c||{};c=c.mode;
void 0===c&&(c=3);void 0===d&&(d="regions");t=this.getShapes(d,a,{includeObj:!0});e=t.length;if(c)for(a=0;a<e;a++)if(d=t[a],(h=d.tags.join(","))&&"source,include"!==h&&"include,source"!==h){m=!0;break}for(f in b.Regions.opts.tagcolors)b.Regions.opts.tagcolors.hasOwnProperty(f)&&q.push(b.Regions.opts.tagcolors[f]);for(a=0;a<e;a++)d=t[a],g=d.obj,h=d.tags.join(","),f=0<=h.indexOf("exclude")?"-":"",g=r(g,d),d.color&&-1===q.indexOf(d.color)&&(g.color=d.color),m&&(k=" # "+h),d.wcsstr&&"image"!==this.params.wcssys&&
...
"")),4<=p&&(k.angle=H.call(this,l.args[3]))}l.comment&&(k.tags=l.comment);d.push(k)}else l.cmd.match(w)?(f=b.globalOpts.xeqPlugins,b.globalOpts.xeqPlugins=!1,this.setWCSSys(l.cmd),b.globalOpts.xeqPlugins=f,q=this.getWCSSys(),t="image"!==q&&"physical"!==q):"remove"!==l.cmd&&"delete"!==l.cmd||d.push({remove:!0});f=b.globalOpts.xeqPlugins;b.globalOpts.xeqPlugins=!1;this.setWCSSys(n);this.setWCSUnits(m);b.globalOpts.xeqPlugins=f;return d};b.Regions.saveRegions=function(a,c,d){var e=sprintf("# Region file format: JS9 version 1.0");
c=this.listRegions(c,{mode:1},d);e=sprintf("%s\n%s\n",e,c.replace(/; */g,"\n"));e=new Blob([e],{type:"text/plain;charset=utf-8"});a||(a=d?d+".reg":"js9.reg");window.hasOwnProperty("saveAs")?saveAs(e,a):b.error("no saveAs function available to save region file");return a};b.Regions.editRegionTags=function(a,b,d){var c,f,g,h,k=[];g=this.getShapes("regions",a);if(g.length){for(c=0;c<g.length;c++)for(h=g[c].tags,k.push(b),f=0;f<h.length;f++)h[f]!==d&&k.push(h[f]);this.changeShapes("regions",a,{tags:k})}};
b.Regions.toggleRegionTags=function(a,b,d){var c,f,g,h,k;g=this.getShapes("regions",a);if(g.length){for(c=0;c<g.length;c++)for(h=g[c].tags,k="",f=0;f<h.length;f++)if(h[f]===b){k=h[f]=d;break}else if(h[f]===d){k=h[f]=b;break}k&&this.changeShapes("regions",a,{tags:h})}};b.Catalogs={};b.Catalogs.CLASS="JS9";b.Catalogs.NAME="Catalogs";b.Catalogs.opts={hasControls:!1,hasRotatingPoint:!1,hasBorders:!1,lockMovementX:!0,lockMovementY:!0,lockRotation:!0,lockScalingX:!0,lockScalingY:!0,lockUniScaling:!0,selectable:!1,
canvas:{selection:!1},updateWCS:!1,panzoom:!0,shape:"circle",strokeWidth:2,width:10,height:10,radius:5,eradius:{x:5,y:3},angle:0,tagcolors:{defcolor:"#00FF00"},sortOverlapping:!1};b.Crosshair={};b.Crosshair.CLASS="JS9";b.Crosshair.NAME="Crosshair";b.Crosshair.LAYERNAME="crosshair";b.Crosshair.opts={hasControls:!1,hasRotatingPoint:!1,hasBorders:!1,lockMovementX:!0,lockMovementY:!0,lockRotation:!0,lockScalingX:!0,lockScalingY:!0,lockUniScaling:!0,selectable:!1,canvas:{selection:!1},updateWCS:!1,panzoom:!1,
strokeWidth:1,color:"#00FF00",sortOverlapping:!1,hiddenPts:{pts:[{x:-9999,y:-9999},{x:-9999,y:-9900}]}};b.Crosshair.display=function(a,c,d){var e,f,g,h,k,l,n,m=b.Crosshair.LAYERNAME;if((/iPad|iPhone|iPod/.test(navigator.platform)||d.shiftKey)&&a&&!a.tmp.shiftKey&&a.crosshair&&a.params.crosshair&&(k=a.raw.width,l=a.raw.height,n=a.ipos.x,f=a.ipos.y,k={pts:[{x:0,y:f},{x:k,y:f}],redraw:!1},a.changeShapes(m,a.crosshair.h,k),l={pts:[{x:n,y:0},{x:n,y:l}],redraw:!0},a.changeShapes(m,a.crosshair.v,l),a.crosshair.visible=
