...
b,d){var e,f,g=/normal|multiply|screen|overlay|darken|lighten|color-dodge|color-burn|hard-light|soft-light|difference|exclusion|hue|saturation|color|luminosity|clear|copy|source-over|destination-over|source-in|destination-in|source-out|destination-out|source-atop|destination-atop|xor|lighter/i;if(!0===c)return this.blend=!0,this;if(!1===c)return this.blend=!1,this;if(f=a.lookupImage(c)){if(1===arguments.length){for(e=0;e<this.blends.length;e++)if(f===this.blends[e].im)return this.blends[e];a.error("can't find blend params for "+
f.id)}for(e=0;e<this.blends.length;e++)if(f===this.blends[e].im){if(void 0!==b&&null!==b){if("remove"===b)return this.blends.splice(e,1),this;if(!0===b||!1===b)return this.blends[e].active=b,this;g.test(b)||a.error("invalid composite/blend operation: "+b);this.blends[e].blend=b}void 0!==d&&null!==d&&(this.blends[e].opacity=d);return this}this.blends.push({im:f,active:!0,blend:b,opacity:d})}else a.error("can't find image to blend: "+c);return this};a.Image.prototype.putImage=function(c){var b,d,e=
...
void 0!==c.opacity&&(e.globalAlpha=g.globalAlpha,g.globalAlpha=c.opacity);void 0!==c.blend&&(e.globalCompositeOperation=g.globalCompositeOperation,g.globalCompositeOperation=c.blend);g.drawImage(b,this.ix,this.iy);for(d in e)e.hasOwnProperty(d)&&(g[d]=e[d])}else g.putImageData(b.img,this.ix,this.iy)};a.Image.prototype.displayImage=function(c,b){var d,e,f,g={};if(!1===c)return this.displayMode=!1,this;!0===c&&(this.displayMode=!0,c="all");if(!this.displayMode)return this;"object"===typeof c&&(b=c,
c=null);c?"all"===c?(c="colors,scaled,rgb,display,plugins",g.notify=!0):"rgbonly"===c?(c="rgb,nodisplay",g.notify=!0):"display"===c&&(g.notify=!0):c="rgb";c.split(",").forEach(function(a){a=a.trim();g[a]=!0;switch(a){case "colors":g.scaled=!0;g.rgb=!0;break;case "scaled":g.rgb=!0}});g.display=!0;g.plugins=!0;this.rgbFile&&(c.colors=!1,c.scaled=!1);b=b||{};g.colors&&(this.mkColorData(),this.offscreenRGB=null);g.scaled&&(this.mkColorCells(),this.mkScaledCells(),this.offscreenRGB=null);g.rgb&&(this.mkRGBImage(),
this.offscreenRGB=null);if(g.nodisplay)return this;if(g.display){void 0===b.opacity&&void 0===b.blend&&this.display.context.clear();this.putImage(b);if(this.blend&&this.blends.length)for(d=0;d<this.blends.length;d++)e=this.blends[d],e.active&&a.Image.prototype.putImage.call(e.im,{opacity:e.opacity,blend:e.blend});this.displayShapeLayers();g.notify&&this.notifyHelper();void 0===b.opacity&&void 0===b.blend&&(this.display.image=this)}if(g.plugins)for(f in this.display.pluginInstances)if(this.display.pluginInstances.hasOwnProperty(f)&&
