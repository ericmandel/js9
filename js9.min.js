...
c.x&&void 0!==c.y&&(f=this.imageToDisplayPos(c),n.left=f.x,n.top=f.y);void 0!==c.px&&void 0!==c.py&&(f=this.logicalToDisplayPos({x:c.px,y:c.py}),n.left=f.x,n.top=f.y);void 0!==c.ra&&void 0!==c.dec&&0<this.raw.wcs&&("string"===typeof c.ra&&(c.ra=b.saostrtod(c.ra),":"===String.fromCharCode(b.saodtype())&&"galactic"!==this.params.wcssys&&"ecliptic"!==this.params.wcssys&&(c.ra*=15)),"string"===typeof c.dec&&(c.dec=b.saostrtod(c.dec)),c.wcssys?(g=this.getWCSSys(),e=b.globalOpts.xeqPlugins,b.globalOpts.xeqPlugins=
!1,this.setWCSSys(c.wcssys)):c._wcssys&&(g=this.getWCSSys(),e=b.globalOpts.xeqPlugins,b.globalOpts.xeqPlugins=!1,this.setWCSSys(c._wcssys),delete c._wcssys),f=b.wcs2pix(this.raw.wcs,c.ra,c.dec).trim().split(/ +/),g&&(this.setWCSSys(g),b.globalOpts.xeqPlugins=e),f=this.imageToDisplayPos({x:parseFloat(f[0]),y:parseFloat(f[1])}),n.left=f.x,n.top=f.y);void 0!==c.left&&(n.left=c.left);void 0!==c.top&&(n.top=c.top);void 0===n.left&&(n.left=d&&void 0!==d.left?d.left:this.display.canvasjq.attr("width")/2-
1);void 0===n.top&&(n.top=d&&void 0!==d.top?d.top:this.display.canvasjq.attr("height")/2-1+1);c.dx&&(n.left+=c.dx);c.dy&&(n.top-=c.dy);switch(c.shape){case "annulus":m.radii=[];if(void 0!==c.radii)if("string"===typeof c.radii)for(m.radii=c.radii.replace(/ /g,"").split(","),e=a=0;a<m.radii.length;a++)""!==m.radii[a]&&(m.radii[e++]=this.wcs2imlen(m.radii[a]));else m.radii=c.radii;else for(c.ireg&&b.SCALEIREG&&(c.iradius&&(c.iradius/=h),c.oradius&&(c.oradius/=h)),h=(c.oradius-c.iradius)/c.nannuli,g=
c.nannuli+1,a=0;a<g;a++)e=c.iradius+h*a,m.radii.push(e);break;case "box":c.ireg&&b.SCALEIREG&&(c.width&&(c.width/=h),c.height&&(c.height/=h));break;case "circle":c.ireg&&b.SCALEIREG&&c.radius&&(c.radius/=h);break;case "ellipse":c.ireg&&b.SCALEIREG&&(c.r1&&(c.r1/=h),c.r2&&(c.r2/=h));break;case "point":switch(c.ptshape){case "box":c.width=2*c.ptsize;c.height=2*c.ptsize;break;case "circle":c.radius=c.ptsize;break;case "ellipse":c.rx=c.ptsize,c.ry=c.ptsize/2}c.lockRotation=!0;c.lockScalingX=!0;c.lockScalingY=
!0;c.lockUniScaling=!0;c.hasControls=!1;c.hasRotatingPoint=!1;c.hasBorders=!0;break;case "line":case "polygon":if(c.pts&&c.pts.length){if("string"===typeof c.pts){f=c.pts.replace(/ /g,"").split(",");g=f.length;if("string"===typeof f[0])for(a=0;a<g;a++)f[a]=parseFloat(f[a]);c.pts=[];for(e=a=0;a<g;a+=2,e++)c.pts[e]={x:f[a],y:f[a+1]}}g=c.pts.length;for(a=0;a<g;a++)c.pts[a]=this.imageToDisplayPos(c.pts[a]);c.left&&c.top?e={x:c.left,y:c.top}:(e=b.centerPolygon(c.pts),n.left=e.x,n.top=e.y);c.points=[];
for(a=0;a<g;a++)f={x:(c.pts[a].x-e.x)/h,y:(c.pts[a].y-e.y)/h},c.points.push(f)}else d&&d.points&&d.points.length||("polygon"===c.shape&&c.polypoints?c.points=c.polypoints:"line"===c.shape&&c.linepoints&&(c.points=c.linepoints));if(c.ireg&&b.SCALEIREG)for(g=c.points.length,a=0;a<g;a++)c.points[a].x/=h,c.points[a].y/=h}for(k in c)if(c.hasOwnProperty(k))switch(k){case "tags":case "x":case "y":case "px":case "py":case "dx":case "dy":case "ra":case "dec":case "pts":case "left":case "top":case "angle":case "radii":case "ireg":break;
