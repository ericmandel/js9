...
a.lookupDisplay(this.id);this.display.menubar=this;d=a.menubarHTML.replace(/@@ID@@/g,this.id);this.menuConjq=$("<div>").addClass("JS9MenubarContainer").attr("width",this.width).attr("height",this.height).html(d).appendTo(this.divjq);$(function(){function c(){var d=g.display;a.bugs.hide_menu&&d.image&&d.image.displayImage("rgb")}function d(){var c,b,e,f=[];if(0<=g.id.search(a.SUPERMENU))if(b=g.divjq.data("displays").split(","),"*"===b[0])for(c=0;c<a.displays.length;c++)f.push(a.displays[c]);else for(c=
0;c<b.length;c++)(e=a.lookupDisplay(b[c]))&&f.push(e);f.length||f.push(g.display);return f}$("#fileMenu"+g.id).on("mousedown",function(a){a.preventDefault();$("#fileMenu"+g.id).contextMenu()});$.contextMenu({selector:"#fileMenu"+g.id,zIndex:a.MENUZINDEX,events:{hide:c},build:function(){var c,b,e,f,g=0,h={},q=d()[0],s=q.image;f=a.images.length;for(c=0;c<f;c++)b=a.images[c],b.display===q&&(e=b.id,a.globalOpts.rgb.active&&(b===a.globalOpts.rgb.rim&&(e+=" (red)"),b===a.globalOpts.rgb.gim&&(e+=" (green)"),
b===a.globalOpts.rgb.bim&&(e+=" (blue)")),h[e]={name:e},q.image&&q.image.id===b.id&&(h[e].icon="sun"),g++);g||(h.noimg={name:"[no images]",events:{keyup:function(){}}});h["sep"+g++]="------";h.open={name:"open local file ..."};h.archives={name:" accessing data archives ..."};h.archives.disabled=a.allinone?!0:!1;h.loadproxy={name:"open link via proxy ..."};h.loadproxy.disabled=!a.allinone&&"none"!==a.globalOpts.helperType&&a.globalOpts.workDir&&a.globalOpts.loadProxy?!1:!0;h.loadcors={name:"open link via CORS ..."};
...
d.id);break;case "archives":a.DisplayHelp(a.InstallDir(a.globalOpts.archivesURL));break;case "loadproxy":e=a.Image.prototype.displayAnalysis.call(null,"textline",a.InstallDir(a.globalOpts.proxyURL),"Open a link via server proxy");$(e).data("dispid",d.id).data("aname","loadproxy");break;case "imsection":f=a.Regions.opts.onchange;$("#dhtmlwindowholder").arrive("#imageSectionForm",{onceOnly:!0},function(){a.Regions.opts.onchange=function(a,c){var d,b;f&&f(a,c);a.parentFile&&("region"===$("#imageSectionForm input:radio[name=imode]:checked").val()&&
"box"===c.shape)&&(d=a.raw.header.LTM1_1||1,d=c.width/d,b=a.raw.header.LTM2_2||1,b=c.height/b,$("#imageSectionForm #xcen").val(Math.floor(c.lcs.x)),$("#imageSectionForm #ycen").val(Math.floor(c.lcs.y)),$("#imageSectionForm #xdim").val(Math.floor(d)),$("#imageSectionForm #ydim").val(Math.floor(b)))}});$("#dhtmlwindowholder").leave("#imageSectionForm",{onceOnly:!0},function(){a.Regions.opts.onchange=f});e=a.Image.prototype.displayAnalysis.call(null,"params",a.InstallDir(a.globalOpts.imsectionURL),"Extract Image Section From a 'Parent' File",
...
"").replace(/\[.*\]/,""),e.saveJPEG(d));break;case "print":e&&e.print();break;default:for(b=0;b<a.images.length;b++)if(e=a.images[b],g=c.replace(/ *\((red|green|blue)\)/,""),d.id===e.display.id&&e.id===g){e.displayImage("display");e.refreshLayers();e.clearMessage();break}}})},items:h}}});$("#viewMenu"+g.id).on("mousedown",function(a){a.preventDefault();$("#viewMenu"+g.id).contextMenu()});$.contextMenu({selector:"#viewMenu"+g.id,zIndex:a.MENUZINDEX,events:{hide:c},build:function(){var c,b,e,f,h,l=
"",q=0,s=0,t={},v=d()[0],u=v.image,w=function(c,d){var b,e;if(d.resize)switch(e=d.resize.split(/[\s,\/]+/),e.length){case 0:break;case 1:a.isNumber(e[0])&&(b=parseInt(e[0],10),c.resize(b,b));break;default:a.isNumber(e[0])&&a.isNumber(e[1])&&(b=parseInt(e[0],10),e=parseInt(e[1],10),c.resize(b,e))}},y=function(a){var c=$.contextMenu.getInputValues(a.data),d=g.display;switch(a.which||a.keyCode){case 9:case 13:w(d,c);a.data.edited=!1;break;default:a.data.edited=!0}};for(c=0;c<a.plugins.length;c++)if(b=
a.plugins[c],e=b.name,b.opts.menuItem&&"view"===b.opts.menu&&(f=v.pluginInstances[e],!f||f.winHandle))b.xclass!==l&&(q+=1),l=b.xclass,t[e]={name:b.opts.menuItem},f&&"active"===f.status&&(t[e].icon="sun");t["sep"+q++]="------";if(u){for(h in u.layers)u.layers.hasOwnProperty(h)&&"main"===u.layers[h].dlayer.dtype&&(s++,t[h]={name:h},u.layers[h].show&&(t[h].icon="sun"));1<s&&(t.hide={name:"HideAll"},t.show={name:"ShowAll"},t["sep"+q++]="------")}t.valpos={name:"display value/position"};v.image&&v.image.params.valpos&&
(t.valpos.icon="sun");if(u&&1<u.raws.length){t["sep"+q++]="------";t.rawlayer={name:"raw data layers",items:{}};for(c=0;c<u.raws.length;c++)h="rawlayer_"+u.raws[c].id,t.rawlayer.items[h]={name:u.raws[c].id},u.raw===u.raws[c]&&(t.rawlayer.items[h].icon="sun")}a.globalOpts.resize&&(t["sep"+q++]="------",t.resize={events:{keyup:y},name:"change width/height:",type:"text"});return{callback:function(c){d().forEach(function(d){var b,e,f,g=d.image;switch(c){case "valpos":g&&(g.params.valpos=!g.params.valpos,
g.params.valpos||g.clearMessage());break;case "show":case "hide":if(g)for(e in g.layers)g.layers.hasOwnProperty(e)&&"main"===g.layers[e].dlayer.dtype&&(g.showShapeLayer(e,c),"show"===c&&g.refreshLayers());break;default:for(b=0;b<a.plugins.length;b++)if(f=a.plugins[b],f.name===c){d.displayPlugin(f);return}if(g)for(e in g.layers)if(g.layers.hasOwnProperty(e)&&c===e){d=g.layers[e].show?"hide":"show";g.showShapeLayer(e,d);"show"===d&&g.refreshLayers();return}u&&c.match(/^rawlayer_/)&&u.rawDataLayer(c.replace(/^rawlayer_/,
""))}})},events:{show:function(c){var d=g.display,b={};d&&(b.resize=sprintf("%d %d",d.width,d.height),$.contextMenu.setInputValues(c,b),a.jupyterFocus(".context-menu-item"))},hide:function(a){var c=g.display;c&&a.edited&&(delete a.edited,a=$.contextMenu.getInputValues(a),w(c,a))}},items:t}}});$("#zoomMenu"+g.id).on("mousedown",function(a){a.preventDefault();$("#zoomMenu"+g.id).contextMenu()});$.contextMenu({selector:"#zoomMenu"+g.id,zIndex:a.MENUZINDEX,events:{hide:c},build:function(){var c,b,e,f,
h=0,l=d()[0].image,q={zoomtitle:{name:"Zoom Factors:",disabled:!0}};for(c=a.imageOpts.zooms;1<=c;c--)b=Math.pow(2,-c),e=Math.pow(2,c),f=sprintf("zoom%s",b),e=sprintf("zoom 1/%s",e),q[f]={name:e},l&&l.rgb.sect.zoom===b&&(q[f].icon="sun");for(c=0;c<=a.imageOpts.zooms;c++)b=Math.pow(2,c),f=sprintf("zoom%s",b),e=sprintf("zoom %s",b),q[f]={name:e},l&&l.rgb.sect.zoom===b&&(q[f].icon="sun");q["sep"+h++]="------";q.zoomiotitle={name:"Zoom In/Out:",disabled:!0};q.zoomIn={name:"zoom in"};q.zoomOut={name:"zoom out"};
q.zoomToFit={name:"zoom to fit"};q["sep"+h++]="------";q.zoom={events:{keyup:function(a){var c=$.contextMenu.getInputValues(a.data),d=g.display.image;switch(a.which||a.keyCode){case 9:case 13:d&&(isNaN(c.zoom)||d.setZoom(c.zoom),a.data.edited=!1);break;default:a.data.edited=!0}}},name:"numeric zoom value:",type:"text"};q["sep"+h++]="------";q.center={name:"pan to center"};q.reset={name:"reset zoom/pan"};return{callback:function(a){d().forEach(function(c){if(c=c.image)switch(a){case "zoomIn":c.setZoom("x2");
break;case "zoomOut":c.setZoom("/2");break;case "zoomToFit":c.setZoom("tofit");break;case "center":c.setPan();break;case "reset":c.setZoom("1");c.setPan();break;default:a.match(/^zoom/)&&c.setZoom(a.slice(4))}})},events:{show:function(c){var d=g.display.image,b={};d&&(b.zoom=String(d.rgb.sect.zoom));$.contextMenu.setInputValues(c,b);a.jupyterFocus(".context-menu-item")},hide:function(a){var c=g.display.image;c&&a.edited&&(delete a.edited,a=$.contextMenu.getInputValues(a),isNaN(a.zoom)||c.setZoom(a.zoom))}},
items:q}}});$("#scaleMenu"+g.id).on("mousedown",function(a){a.preventDefault();$("#scaleMenu"+g.id).contextMenu()});$.contextMenu({selector:"#scaleMenu"+g.id,zIndex:a.MENUZINDEX,events:{hide:c},build:function(){var c,b,e,f=0,h={},l=d()[0],q=function(c,d){a.isNumber(d.scalemin)&&(c.params.scalemin=d.scalemin);a.isNumber(d.scalemax)&&(c.params.scalemax=d.scalemax);c.displayImage("colors")},s=function(a){var c=$.contextMenu.getInputValues(a.data),d=g.display.image;switch(a.which||a.keyCode){case 9:case 13:q(d,
...
return{callback:function(a,c){d().forEach(function(d){if(d=d.image)switch(a){case "dminmax":return d.params.scaleclipping="dataminmax",d.params.scalemin=d.raw.dmin,d.params.scalemax=d.raw.dmax,$.contextMenu.setInputValues(c,{scalemin:String(d.params.scalemin),scalemax:String(d.params.scalemax)}),d.displayImage("colors"),!1;case "zscale":return(!d.params.z1||d.params.z2)&&d.zscale(!1),d.params.scaleclipping="zscale",d.params.scalemin=d.params.z1,d.params.scalemax=d.params.z2,$.contextMenu.setInputValues(c,
{scalemin:String(d.params.scalemin),scalemax:String(d.params.scalemax)}),d.displayImage("colors"),!1;default:d.setScale(a)}})},events:{show:function(c){var d=g.display.image,b={};d&&(b.scalemin=String(d.params.scalemin),b.scalemax=String(d.params.scalemax));$.contextMenu.setInputValues(c,b);a.jupyterFocus(".context-menu-item")},hide:function(a){var c=g.display.image;c&&a.edited&&(delete a.edited,a=$.contextMenu.getInputValues(a),q(c,a))}},items:h}}});$("#colorMenu"+g.id).on("mousedown",function(a){a.preventDefault();
$("#colorMenu"+g.id).contextMenu()});$.contextMenu({selector:"#colorMenu"+g.id,zIndex:a.MENUZINDEX,events:{hide:c},build:function(){var c,b,e,f=0,h={},l=d()[0],q=function(a,c){c.contrast&&!isNaN(c.contrast)&&(a.params.contrast=parseFloat(c.contrast));c.bias&&!isNaN(c.bias)&&(a.params.bias=parseFloat(c.bias));isNaN(c.opacity)||(a.params.opacity=""!==c.opacity?parseFloat(c.opacity):1);a.displayImage("colors")},s=function(a){var c=$.contextMenu.getInputValues(a.data),d=g.display.image;switch(a.which||
a.keyCode){case 9:case 13:q(d,c);a.data.edited=!1;break;default:a.data.edited=!0}};h.cmaptitle={name:"Colormaps:",disabled:!0};for(c=0;c<a.colormaps.length;c++)e=b=a.colormaps[c].name,h[b]={name:e},l.image&&l.image.cmapObj.name===b&&(h[b].icon="sun");h["sep"+f++]="------";h.contrast={events:{keyup:s},name:"contrast value:",type:"text"};h.bias={events:{keyup:s},name:"bias value:",type:"text"};h.opacity={events:{keyup:s},name:"opacity value:",type:"text"};h["sep"+f++]="------";h.reset={name:"reset contrast/bias"};
h["sep"+f++]="------";h.invert={name:"invert colormap"};l.image&&l.image.params.invert&&(h.invert.icon="sun");h["sep"+f++]="------";h.rgb={name:"RGB mode"};a.globalOpts.rgb.active&&(h.rgb.icon="sun");return{callback:function(a){d().forEach(function(c){(c=c.image)&&c.setColormap(a)})},events:{show:function(c){var d=g.display.image,b={};d&&(b.contrast=String(d.params.contrast),b.bias=String(d.params.bias),b.opacity=String(d.params.opacity),b.sigma=String(d.params.sigma));$.contextMenu.setInputValues(c,
b);a.jupyterFocus(".context-menu-item")},hide:function(a){var c=g.display.image;c&&a.edited&&(delete a.edited,a=$.contextMenu.getInputValues(a),q(c,a))}},items:h}}});$("#regionMenu"+g.id).on("mousedown",function(a){a.preventDefault();$("#regionMenu"+g.id).contextMenu()});$.contextMenu({selector:"#regionMenu"+g.id,zIndex:a.MENUZINDEX,events:{hide:c},build:function(){var c=d()[0].image,b={regiontitle:{name:"Regions:",disabled:!0},annulus:{name:"annulus"},box:{name:"box"},circle:{name:"circle"},ellipse:{name:"ellipse"},
line:{name:"line"},point:{name:"point"},polygon:{name:"polygon"},text:{name:"text"},sep2:"------",loadRegions:{name:"load regions"},saveRegions:{name:"save regions"},listRegions:{name:"list regions"},deleteRegions:{name:"delete regions"},listonchange:{name:"list on change"},xeqonchange:{name:"xeq on change"}};c&&c.params.listonchange&&(b.listonchange.icon="sun");c&&c.params.xeqonchange&&(b.xeqonchange.icon="sun");return{callback:function(c){d().forEach(function(d){var b=d.image;if(b)switch(c){case "deleteRegions":b.removeShapes("regions",
"all");b.clearMessage("regions");break;case "loadRegions":a.OpenRegionsMenu({display:d});break;case "saveRegions":b.saveRegions("all",!0);break;case "listRegions":b.listRegions("all",2);break;case "xeqonchange":b.params.xeqonchange=!b.params.xeqonchange;break;case "listonchange":b.params.listonchange=!b.params.listonchange;break;default:b.addShapes("regions",c,{ireg:!0})}})},items:b}}});$("#wcsMenu"+g.id).on("mousedown",function(a){a.preventDefault();$("#wcsMenu"+g.id).contextMenu()});$.contextMenu({selector:"#wcsMenu"+
g.id,zIndex:a.MENUZINDEX,events:{hide:c},build:function(){var c,b,e,f=0,g=0,h={},q=d()[0],s=q.image;h.wcssystitle={name:"WCS Systems:",disabled:!0};for(c=0;c<a.wcssyss.length;c++)e=b=a.wcssyss[c],h[b]={name:e},q.image&&q.image.params.wcssys===b&&(h[b].icon="sun");h["sep"+f++]="------";h.wcsutitle={name:"WCS Units:",disabled:!0};for(c=0;c<a.wcsunitss.length;c++)e=b=a.wcsunitss[c],h[b]={name:e},q.image&&q.image.params.wcsunits===b&&(h[b].icon="sun");h["sep"+f++]="------";h.reproject={name:"reproject",
items:{reprojtitle:{name:"wcs from:",disabled:!0}}};for(c=0;c<a.images.length;c++)s!==a.images[c]&&a.images[c].wcs&&(b="reproject_"+a.images[c].id,h.reproject.items[b]={name:a.images[c].id},g++);g||(h.reproject.items.notasks={name:"[none]",disabled:!0,events:{keyup:function(){}}});return{callback:function(c){d().forEach(function(d){var b;b=RegExp(c);if(d=d.image)c.match(/^reproject_/)?(b=c.replace(/^reproject_/,""),d.reprojectData(b)):0<=a.wcssyss.join("@").search(b)?d.setWCSSys(c):0<=a.wcsunitss.join("@").search(b)?
d.setWCSUnits(c):a.error("unknown wcs sys/units: "+c)})},items:h}}});$("#analysisMenu"+g.id).on("mousedown",function(a){a.preventDefault();$("#analysisMenu"+g.id).contextMenu()});$.contextMenu({selector:"#analysisMenu"+g.id,zIndex:a.MENUZINDEX,events:{hide:c},build:function(){var c,b,e,f,h,l=0,q=0,s={};h=d()[0];var t=h.image,v="",u=function(a,c){c.sigma||(c.sigma="none");"none"===c.sigma?(a.params.sigma=c.sigma,a.rawDataLayer("gaussBlur","remove")):(a.params.sigma=parseFloat(c.sigma),a.gaussBlurData(a.params.sigma))},
w=function(a){var c=$.contextMenu.getInputValues(a.data),b=g.display.image;switch(a.which||a.keyCode){case 9:case 13:u(b,c);a.data.edited=!1;break;default:a.data.edited=!0}};for(c=0;c<a.plugins.length;c++)if(b=a.plugins[c],f=b.name,b.opts.menuItem&&"analysis"===b.opts.menu&&(e=h.pluginInstances[f],!e||e.winHandle))b.xclass!==v&&(s["sep"+q++]="------",s["sep"+q++]={name:b.xclass+" Plugins:"},s["sep"+(q-1)].disabled=!0),v=b.xclass,s[f]={name:b.opts.menuItem},e&&"active"===e.status&&(s[f].icon="sun"),
...
[];for(e=d=0;d<l;d+=2,e++)p=y.call(this,h.args[d],h.args[d+1]),g.pts[e]={x:p[0],y:p[1]};delete g.x;delete g.y;break;case "text":3<=l&&(d=g,e=h.args[2].replace(/^['"]/,"").replace(/['"]$/,""),d.text=e)}h.comment&&(g.tags=h.comment);b.push(g)}else h.cmd.match(s)?(this.setWCSSys(h.cmd),k=this.getWCSSys(),m="image"!==k&&"physical"!==k):("remove"===h.cmd||"delete"===h.cmd)&&b.push({remove:!0})}this.setWCSSys(j);return b};a.Regions.saveRegions=function(c){var b=sprintf("# Region file format: JS9 version 1.0");
...
e,a.NewFitsImage)}catch(h){a.error("can't process FITS file",h)}}else a.error("no FITS module available to process this memory FITS")}else(e=a.lookupImage(c,e))?(e.displayImage("display",b),e.clearMessage()):(c=c.trim(),e=c.split(".").pop().toLowerCase(),"png"===e?a.globalOpts.pngisfits?a.checkNew(new a.Image(c,b,f)):a.fetchURL(null,c,b,a.NewFitsImage):b.fits2png||void 0===b.fits2png&&a.globalOpts.fits2png?a.helper.connected?a.helper.send("fits2png",{fits:c},function(c){var d;c="object"===typeof c?
