...
0],[.125,.5],[.25,.75],[.5,.81],[1,1]],[[0,0],[.015,.125],[.03,.375],[.065,.625],[.25,.25],[1,1]]));a.checkNew(new a.Colormap("hsv",function(){var a,c,e,f,g,h,k,l=[],p=0;for(a=0;200>a;a++,p++){c=1-a/199;e=360*c+270;f=Math.abs(Math.sin(3.1416*c));for(c=Math.pow(1-c,1/3);360<=e;)e-=360;e/=60;k=Math.floor(e);g=e-k;e=c*(1-f);h=c*(1-f*g);f=c*(1-f*(1-g));l[p]=[];switch(k){case 0:l[p].push(c);l[p].push(f);l[p].push(e);break;case 1:l[p].push(h);l[p].push(c);l[p].push(e);break;case 2:l[p].push(e);l[p].push(c);
l[p].push(f);break;case 3:l[p].push(e);l[p].push(h);l[p].push(c);break;case 4:l[p].push(f);l[p].push(e);l[p].push(c);break;case 5:l[p].push(c),l[p].push(e),l[p].push(h)}}return l}()));a.checkNew(new a.Colormap("rainbow",[[0,1],[.2,0],[.6,0],[.8,1],[1,1]],[[0,0],[.2,0],[.4,1],[.8,1],[1,0]],[[0,1],[.4,1],[.6,0],[1,0]]));a.checkNew(new a.Colormap("standard",[[0,0],[.333,.3],[.333,0],[.666,.3],[.666,.3],[1,1]],[[0,0],[.333,.3],[.333,.3],[.666,1],[.666,0],[1,.3]],[[0,0],[.333,1],[.333,0],[.666,.3],[.666,
