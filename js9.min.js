...
dataType:"script",timeout:a.globalOpts.htimeout,cache:!0,success:function(){var c={reconnection:!0,reconnectionDelay:1E3,reconnectionDelayMax:1E4,reconnectionAttempts:100,timeout:a.globalOpts.htimeout};3===a.globalOpts.socketioVersion&&(c.path="/socket.io-3/");"undefined"===typeof io?f(null,"socket io object is undefined",null):(b.socket=io.connect(b.url,c),b.socket.on("connect",function(){var c;b.connected=!0;b.helper=!0;var d=[];for(c=0;c<a.displays.length;c++)d.push(a.displays[c].id);b.socket.emit("initialize",
...
a.error("port missing for helper");this.url=this.url.replace(/:[0-9][0-9]*$/,"")+":"+a.globalOpts.helperPort;if(2===a.globalOpts.socketioVersion){c="socket.io";var k=window.electron&&window.electron.multiElectron?"socket.io.slim.js":"socket.io.js"}else c="socket.io-"+a.globalOpts.socketioVersion,k=2>=a.DEBUG?"socket.io.min.js":"socket.io.js";this.sockurl=this.url+"/"+c+"/"+k;window.electron?(this.aliveurl=this.url+"/alive",g(this.aliveurl,this.sockurl,d)):h(this.sockurl);break;default:a.error("unknown helper type: "+
