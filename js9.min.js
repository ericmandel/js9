...
if(f.nocb)return g;if(!b.params.parent&&!e.match(l)){if(this.params.xeqonchange&&k.show&&k.opts.onchange)try{this.params.xeqonchange=!1,a.xeqByName(k.opts.onchange,window,this,g)}catch(z){a.log("error in onchange: %s [%s]\n%s",this.id,z.message,a.strace(z))}finally{this.params.xeqonchange=!0}this.xeqPlugins("shape","on"+c+"change",g)}if("regions"===c&&a.globalOpts.regionsToClipboard){switch(e){case "update":d=g.parent||g.id;break;default:d=null}if(a.notNull(d)){try{var B=this.listRegions(d,{mode:1,
includedcoords:!0})}catch(z){B=null}B&&(a.clipboard=B)}}return g};a.Fabric.removeShapes=function(c,b,d){var e=this,f,h={mode:1,includedcoords:!0},g=[];if(f=this.getShapeLayer(c)){var k=f.canvas;d=d||{};"regions"===c&&a.globalOpts.unremoveReg&&(this.regstack.push(this.listRegions(b,h,c)),this.regstack.length>a.globalOpts.unremoveReg&&(this.regstack=this.regstack.slice(0,a.globalOpts.unremoveReg)));this.selectShapes(c,b,function(b,f){if(!(!1===b.params.removable&&!d.overrideRemovable||b.params.sticky&&
!1===d.sticky)){a.Fabric._updateShape.call(e,c,b,f,"remove");b.params.winid&&(b.params.winid.close(),b.params.winid=null);if(b.params.parent){var h=b.params.parent.obj;for(f=h.params.children.length-1;0<=f;f--)if(b===h.params.children[f].obj){h.params.children.splice(f,1);break}}for(f=0;f<b.params.children.length;f++)h=b.params.children[f].obj,g.push(h);g.push(b)}});for(b=0;b<g.length;b++)k.remove(g[b]);1===fabric.major_version?k.getActiveGroup()&&k.discardActiveGroup():k.discardActiveObject();k.renderAll();
!k.getObjects().length&&a.globalOpts.resetEmptyShapeId&&(f.nshape=0);return this}};a.Fabric.getShapes=function(c,b,d){var e={},f=[];d=d||{};if("string"===typeof d)try{d=JSON.parse(d)}catch(k){a.error("can't parse getShapes opts: "+d,k)}if("regions"===c&&("text"===d.format||"csv"===d.format)){d.mode=d.mode||1;b=this.listRegions(b,d);if("csv"===d.format){var h=b.split(";");c=0;for(b="";c<h.length;c++)if(h[c])if(h[c].toLowerCase().match(a.WCSEXP))d.includewcs&&(b+=h[c].trim()+"\n");else{var g=h[c].replace(/\(/,
",").replace(/\).*/,"").trim();b+=g+"\n"}}return b}this.selectShapes(c,b,function(a){e=a.pub||{};d.includeObj&&(e.obj=a);f.push(e)});return f};a.Fabric.changeShapes=function(c,b,d){var e=this,f,h,g,k,l,m,n,p,q,r,v,u=[],t=[];if((l=this.getShapeLayer(c))&&d){if("string"===typeof d)try{d=JSON.parse(d)}catch(x){a.error("can't parse shape opts: "+d,x)}if(this.display.image!==this)this.delayedShapes=this.delayedShapes||[],this.delayedShapes.push({layer:c,shape:b,mode:"change",opts:d});else{var w=l.canvas;
var y=w.getActiveObject();this.selectShapes(c,b,function(b,B){p="main"!==e.display.layers[c].dtype||b.params.preservedcoords?1:e.rgb.sect.zoom;d.radii&&(b.params.radii=[]);d.tags&&(b.params.tags=[]);k=$.extend(!0,{},b.params,d);g=a.Fabric._parseShapeOptions.call(e,c,k,b);if(g.remove){if(!0===g.remove||"true"===g.remove)g.remove="all";if(!1!==g.remove&&"false"!==g.remove){e.removeShapes(c,g.remove||"all");return}}if(g.opts.send)switch(g.opts.send){case "front":w.sendToFront(y);w.discardActiveObject();
break;case "back":w.sendToBack(y),w.discardActiveObject()}q=a.Fabric._exportShapeOptions.call(e,d).filter(function(a){return!b.params.exports.hasOwnProperty(a)});g.params.exports=b.params.exports.concat(q);g.opts.stroke&&(g.opts.color=g.opts.stroke,g.opts.stroke=a.colorToHex(g.opts.stroke));switch(b.params.shape){case "text":g.opts.stroke&&(g.opts.fill=g.opts.stroke);g.opts.strokeWidth=0;break;case "line":case "polygon":g.opts.points&&g.opts.points.length&&(b.angle=0)}b.set(g.opts);b.params=$.extend(!1,
{},b.params,g.params);d.strokeWidth&&(b.params.sw1=d.strokeWidth);switch(b.params.shape){case "annulus":if(d.radii&&d.radii.length){b.forEachObject(function(b){u.push(b)});m=u.length;for(f=0;f<m;f++)b.remove(u[f]),w.remove(u[f]);m=b.params.radii.length;n=0;r=$.extend(!0,{},d);r.stroke=r.stroke||b.get("stroke");for(f=0;f<m;f++)r.radius=b.params.radii[f],h=new fabric.Circle(r),n=Math.max(n,b.params.radii[f]),b.add(h);b.scaleX=p;b.scaleY=p;b.width=2*n;b.height=2*n;y===b&&w.setActiveObject(b)}break;case "box":d.width&&
(b.scaleX=p);d.height&&(b.scaleY=p);break;case "circle":d.radius&&(b.scaleX=p,b.scaleY=p);break;case "cross":r=$.extend(!0,{},d);r.stroke=r.stroke||b.get("stroke");r.width&&(b.scaleX=p,t[0]=[{x:-r.width/2,y:0},{x:r.width/2,y:0}],delete r.width);r.height&&(b.scaleY=p,t[1]=[{x:0,y:-r.height/2},{x:0,y:r.height/2}],delete r.height);r.angle&&delete r.angle;b.forEachObject(function(b,a){v=$.extend(!0,{},r);t[a]&&(v.points=t[a]);b.set(v)});break;case "ellipse":d.r1&&(b.rx=b.params.r1,b.scaleX=p,b.width=
2*b.rx);d.r2&&(b.ry=b.params.r2,b.scaleY=p,b.height=2*b.ry);break;case "line":case "polygon":if(d.points&&d.points.length||d.pts&&d.pts.length)b.scaleX=p,b.scaleY=p;y===b&&(a.Fabric.removePolygonAnchors(l.dlayer,b),a.Fabric.addPolygonAnchors(l.dlayer,b));a.resetPolygonCenter(b);break;case "text":d.text&&(b.params.text=d.text)}b.rescaleBorder();a.Fabric.updateChildren(l.dlayer,b,"moving");a.Fabric.updateChildren(l.dlayer,b,"scaling");a.Fabric.updateChildren(l.dlayer,b,"rotating");a.Fabric.updateChildren(l.dlayer,
b,"deltas");b.setCoords();a.Fabric._handleChildText.call(e,c,b,d);a.Fabric._updateShape.call(e,c,b,B,"update");if(d.onchangeshapes&&b.pub)try{a.xeqByName(d.onchangeshapes,e,e,b.pub)}catch(z){a.error("in onchangeshapes callback",z,!1)}});(void 0===d.redraw||d.redraw)&&w.renderAll();return this}}};a.Fabric.refreshShapes=function(c){var b;if(c){var d=this.getWCSSys();if("image"===d){var e=a.globalOpts.xeqPlugins;a.globalOpts.xeqPlugins=!1;this.raw.wcs&&0<this.raw.wcs?this.setWCSSys("native",!1):this.setWCSSys("physical",
...
(e=this.listRegions("selected",{mode:1,includedcoords:a.globalOpts.regCopyDCoords},c));e||(e=this.listRegions(d,{mode:1,includedcoords:a.globalOpts.regCopyDCoords},c));for(b=0;b<f.length;b++)d=this.display.layers[c]?this.display.layers[c].opts:a.Regions.opts,f[b].display.newShapeLayer(c,d),f[b].addShapes(c,e);return this}};a.Fabric.addPolygonPoint=function(c,b,d){var e=Number.MAX_VALUE;if(b&&b.points){d=a.eventToDisplayPos(d);var f=b.getCenterPoint().x;var h=b.getCenterPoint().y;f=(d.x-f)/b.get("scaleX");
var g=(d.y-h)/b.get("scaleY");for(h=-b.get("angle")*Math.PI/180;h>2*Math.PI;)h-=2*Math.PI;d=Math.cos(h)*f-Math.sin(h)*g;g=Math.sin(h)*f+Math.cos(h)*g;f=b.points;for(h=0;h<f.length;h++){var k=f[h];var l=f[(h+1)%f.length];var m=k.x<l.x?k.x:l.x;var n=k.y<l.y?k.y:l.y;var p=k.x>l.x?k.x:l.x;var q=k.y>l.y?k.y:l.y;var r=k.x-l.x;k=k.y-l.y;var v=Math.sqrt(r*r+k*k);0!==v&&(r/=v,k/=v);v=d-l.x;var u=g-l.y;v=v*r+u*k;r=l.x+r*v;l=l.y+k*v;r<m?r=m:r>p&&(r=p);l<n?l=n:l>q&&(l=q);m=(r-d)*(r-d)+(l-g)*(l-g);if(m<e){e=m;
var t=r;var w=l;var y=h===f.length?0:h}}c=this.getShapeLayer(c);a.Fabric.removePolygonAnchors(c.dlayer,b);f.splice(y+1,0,{x:t,y:w});if(1===fabric.major_version)c.canvas.setActiveObject(b);else{switch(b.type){case "polyline":case "polygon":a.Fabric.addPolygonAnchors(c.dlayer,b),c.dlayer.canvas.renderAll()}b.polyparams?c.dlayer.params.sel=b.polyparams.polygon:b.params&&(c.dlayer.params.sel=b)}}};a.Fabric.removePolygonPoint=function(c,b){if(b&&b.polyparams){var d=b.polyparams.polygon;var e=d.points;
...
y:b.top},-d.angle,{x:d.left,y:d.top}):(e.x=b.left,e.y=b.top),h[g].x=(e.x-d.left)/d.scaleX,h[g].y=(e.y-d.top)/d.scaleY,a.resetPolygonCenter(d),a.Fabric._updateShape.call(k,d.params.layerName,d,null,"update"),k&&(k.params.listonchange||d.params.listonchange)&&k.listRegions(d,{mode:2}),f.renderAll())},g=function(b){var c,d={};for(c=0;c<b.params.anchors.length;c++)d.x=b.left+b.points[c].x*b.scaleX,d.y=b.top+b.points[c].y*b.scaleY,b.angle&&(d=a.rotatePoint(d,b.angle,{x:b.left,y:b.top})),b.params.anchors[c].set({left:d.x,
...
c.layerName)if("objects"===d){var h={};c.canvas.getObjects().forEach(function(b){b.params&&(b.params.parent||b.params.children.length)&&(h[b.params.id]=b)});c.canvas.getObjects().forEach(function(b){if(b.params)for(b.params.parent&&(b.params.parent.obj=h[b.params.parent.id]),e=0;e<b.params.children.length;e++)b.params.children[e].obj=h[b.params.children[e].id]})}else if(b&&b.params)if("deltas"===d){if(b.params.parent){var g=b.params.parent;g.dleft=g.obj.left-b.left;g.dtop=g.obj.top-b.top;g.moved=
...
g.show&&(k+=""+l+g.dlayer.canvas.toSVG()+"</div>"));(void 0===c.colorbar||c.colorbar)&&(c=this.display.pluginInstances.JS9Colorbar)&&c.isActive()&&(f+=2,g=c.colorbarjq[0].toDataURL("image/png"),f+=this.display.height,l=sprintf("<div style='position:absolute; left:%spx; top:%spx'>",0,f),k+=l+"<img src='"+g+"'></div>",c.textjq&&c.textjq[0]&&(g=c.textjq[0].toDataURL("image/png"),f+=c.colorbarjq.height()+1,l=sprintf("<div style='position:absolute; left:%spx; top:%spx'>",0,f),k+=l+"<img style='width:"+
this.display.width+"px;'src='"+g+"'></div>"));k+="</body></html>";window.isElectron&&(e="data:text/html,<html><body><script>window.addEventListener('message', (ev) => {document.documentElement.innerHTML=ev.data; window.setTimeout(() => {window.print()}, 250);},false)\x3c/script><p>waiting for image ...</body></html>");(d=window.open(e,this.id,h))?d.document?(d.document.open(),d.document.write(k),d.document.close()):d.postMessage?window.setTimeout(function(){d.postMessage(k,"*")},a.TIMEOUT):a.error("no method available for drawing image into print window"):
