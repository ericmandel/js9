...
var t=this.display.context;var v=this.rgb;var w=v.sect;if(this.MakeRGBImage&&"function"===typeof this.MakeRGBImage&&this.MakeRGBImage()||this.MakePrimaryImage&&"function"===typeof this.MakePrimaryImage&&this.MakePrimaryImage())return this;if(this.rgbFile){var u=w.width/w.zoom;var r=w.height/w.zoom;var x=w.x0;var y=this.offscreen.canvas.height-1-(w.y0+r);y=this.offscreen.context.getImageData(x,y,u,r);if(1===w.zoom)v.img=y;else for(v.img=t.createImageData(w.width,w.height),v=v.img,d=c=0;c<y.height;c++,
d++){var B=c*y.width;var z=d*w.zoom;for(b=t=0;t<y.width;t++,b++){x=4*(B+t);var A=b*w.zoom;for(e=0;e<w.zoom;e++){var C=Math.floor(z+e);var E=C*w.width;for(C=0;C<w.zoom;C++){var D=Math.floor(A+C);D=4*(E+D);v.data[D]=y.data[x];v.data[D+1]=y.data[x+1];v.data[D+2]=y.data[x+2];v.data[D+3]=y.data[x+3]}}}}return this}v.img&&v.img.width===w.width&&v.img.height===w.height||(v.img=t.createImageData(w.width,w.height));v=v.img;var F=v.data.length-4;if(!this.psColors&&!this.staticObj)return this;var G=void 0!==
...
!l){var R=255*this.params.flooropacity;var M=this.params.floorvalue;f=!0}var N=Math.max(1,Math.floor(1/w.zoom));var P=w.zoom*N;c=Math.floor(w.y1-1);for(d=0;c>=w.y0;c-=N,d++)for(B=c*this.raw.width,z=d*P,t=Math.floor(w.x0),b=0;t<w.x1;t+=N,b++){m?G=J.raw.data[B+t]>this.mask.value?K:I:n&&(G=255*J.raw.data[B+t]);if(l){if(y=h?h.colorData[B+t]:0,u=g?g.colorData[B+t]:0,r=k?k.colorData[B+t]:0,a.isNull(y)||a.isNull(u)||a.isNull(r))return this.display.rgb.active=!1,a.error("RGB images are incompatible. Turning off RGB mode.",
"",!1),this.mkRGBImage(),this}else this.staticObj||(x=this.colorData[B+t]);var Q=G;f&&this.raw.data[B+t]<=M&&(Q=R);A=b*P;for(e=0;e<w.zoom;e++)for(C=Math.ceil(z+e),E=C*w.width,C=0;C<w.zoom;C++)if(D=Math.ceil(A+C),D=4*(E+D),D<=F)if(l)v.data[D]=h?h.psColors[y][0]:0,v.data[D+1]=g?g.psColors[u][1]:0,v.data[D+2]=k?k.psColors[r][2]:0,v.data[D+3]=G;else if(this.staticObj){var H=this.raw.data[B+t];H=a.lookupStaticColor(this,H,q);v.data[D]=H.red;v.data[D+1]=H.green;v.data[D+2]=H.blue;v.data[D+3]=H.alpha}else if(void 0!==
...
y:p}))q=c.x,p=c.y}else q=a.x,p=a.y;switch(n){case "annulus":var t=2*a.radii[a.radii.length-1];var v=2*a.radii[a.radii.length-1];break;case "box":t=a.width;v=a.height;break;case "circle":t=2*a.radius;v=2*a.radius;break;case "cross":t=a.width;v=a.height;break;case "ellipse":t=2*a.r1;v=2*a.r2;break;case "polygon":case "line":for(t=0;t<a.pts.length;t++)e+=a.pts[t].x,f+=a.pts[t].y,a.pts[t].x>h&&(h=a.pts[t].x),a.pts[t].x<g&&(g=a.pts[t].x),a.pts[t].y>m&&(m=a.pts[t].y),a.pts[t].y<k&&(k=a.pts[t].y);a.x=e/
...
[b],g)}catch(v){a.error("can't plot data (plotly)",v)}break;default:g=$.extend(!0,{},a.Plot.opts,p.opts);a.Plot.opts.annotate&&p.annotations&&(g.zoomStack.func=function(b,c){a.Plot.annotate(q,b,p)});p.color=p.color||g.color;"log"===p.xscale&&(g.xaxis=g.xaxis||{},g.xaxis.transform=a.Plot.logfunc,g.xaxis.inverseTransform=a.Plot.expfunc,p.curscale.x="log");"log"===p.yscale&&(g.yaxis=g.yaxis||{},g.yaxis.transform=a.Plot.logfunc,g.yaxis.inverseTransform=a.Plot.expfunc,p.curscale.y="log");try{var t=$.plot(q,
[p],g)}catch(v){a.error("can't plot data (flot)",v)}a.Plot.opts.annotate&&p.annotations&&a.Plot.annotate(q,t,p)}q.css("outline","none");q.attr("tabindex",0);q.on("keydown",function(b){b=a.eventToCharStr(b);switch(b){case "c":k();break;case "x":case "y":h="linear"!==p.curscale[b]?"linear":"log",a.Plot.rescale(q,t,p,b,h)}});l=$("<img src='"+a.InstallDir("images/gears.png")+"'>");l.on("click",k);b=$("<div class='JS9PlotGear'>");b.append(l);q.append(b)}break;case "params":case "regions":case "textline":f?
...
c;try{if(!l.test(n.wcsinfo.ptype)){var t=m(n.header,n.wcsinfo);var v="owcs_"+a.uniqueID()+".txt";a.vfile(v,a.raw2FITS(t,{addcr:!0}));var w="awcs_"+a.uniqueID()+".txt";var u=a.tanhdr(v,w,"");1<a.DEBUG&&a.log("tanhdr (input): %s %s -> %s",v,w,u);a.vunlink(v);0<=u.search(/\[struct stat="OK"/)&&(b.cmdswitches=b.cmdswitches||"",b.cmdswitches+=" -i "+w)}if(c.raw&&!l.test(c.raw.wcsinfo.ptype)||c.ptype&&!l.test(c.ptype)){t=m(d,c.raw.wcsinfo);v="owcs_"+a.uniqueID()+".txt";a.vfile(v,a.raw2FITS(t,{addcr:!0}));
var r="awcs_"+a.uniqueID()+".txt";u=a.tanhdr(v,r,"");1<a.DEBUG&&a.log("tanhdr (reproj): %s %s -> %s",v,r,u);a.vunlink(v);0<=u.search(/\[struct stat="OK"/)&&(a.vunlink(p),p=r)}}catch(z){}if(n.hdu&&n.hdu.fits.vfile)c=n.hdu.fits.vfile,n.hdu.fits.extname?c+="["+n.hdu.fits.extname+"]":n.hdu.fits.extnum&&0<n.hdu.fits.extnum&&(c+="["+n.hdu.fits.extnum+"]");else{var x=this.toArray();c=this.id.replace(/\.png$/,"_png.fits");a.vfile(c,x)}r=this.id.replace(/\[.*\]/,"").replace(/\.png$/i,".fits").replace(/\.fz$/i,
"").replace(/\.gz$/i,"");r="reproj_"+a.uniqueID()+"_"+r;d=b.rawid||"reproject";for(v=0;v<this.raws.length&&(t=this.raws[v],t.id!==d||!a.cleanupFITSFile(t,!0));v++);n.hdu&&"table"===n.hdu.imtab&&n.hdu.table&&!c.match(/\[bin /)&&(c.match(/\[EVENTS\]/)||(c+="[EVENTS]"),t=n.hdu.table,n=Math.floor(t.xcen-t.xdim/2+1),v=Math.floor(t.xcen+t.xdim/2),d=Math.floor(t.ycen-t.ydim/2+1),t=Math.floor(t.ycen+t.ydim/2),c+="[bin X="+n+":"+v+",Y="+d+":"+t+"]");try{var y=r.lastIndexOf(".");0<=y&&(e=r.substring(0,y)+"_area"+
r.substring(y));var B=b.cmdswitches||"";B+=" -a 0 "+a.globalOpts.reprojSwitches;u=a.reproject(c,r,p,B);1<a.DEBUG&&a.log("reproject: %s %s %s [%s] -> %s",c,r,p,B,u);a.vunlink(e);a.vunlink(p);w&&a.vunlink(w);x&&a.vunlink(c);0>u.search(/\[struct stat="OK"/)&&(h=!0,(f=u.match(/msg="(.*)"/))&&f[1]?a.error(f[1]+" (from mProjectPP)"):a.error(u))}catch(z){if(h)return;a.vunlink(e);a.vunlink(p);u?a.error(u):a.error("WCS reproject failed",z)}return r}};a.Image.prototype.reprojectData=function(c){for(var b=[],
...
c,h)}var d=c.images||a.images;for(c=0;c<d.length;c++)if((b="number"===typeof d[c]?a.images[d[c]]:d[c])&&b.display!==this){var e=b.display;var f=e.divjq.closest(".JS9GridItem");b.moveToDisplay(this);0<f.length&&(b=$.inArray(e,a.displays),0<=b&&a.displays.splice(b,1),f.remove())}a.globalOpts.extendedPlugins&&this.image&&this.image.xeqPlugins("image","ongatherdisplay")};a.Display.prototype.separate=function(c){var b=this,d,e,f,h=0,g=0,k=0,l=1,m,n,p,q,t,v,w,u,r,x,y,B,z,A,C,E={},D=/_sep[0-9][0-9]*/,F=
a.globalOpts.separate,G=function(b,c,d){c||a.error("can't init separation ops: no 'from' id");m=d.layout||a.globalOpts.separate.layout||"auto";n=d.leftMargin||F.leftMargin||0;p=d.topMargin||F.topMargin||0;"auto"===m&&0<b.divjq.closest(".JS9GridContainer").length&&(m="grid");"grid"===m&&(CSS.supports("display","grid")?(f=b.divjq.closest(".JS9GridContainer"),0<f.length&&(q=f)):m="auto");switch(m){case "auto":k=1;g=0;break;case "horizontal":k=1;g=0;break;case "vertical":k=0;g=1;break;default:k=1,g=0}t=
43;v=0;w=$("#"+c);u=$("#"+c+"Menubar");0<u.length&&(u.isactive="visible"===u.closest(".JS9PluginContainer").css("visibility"));r=$("#"+c+"Toolbar");0<r.length&&(r.isactive="visible"===r.closest(".JS9PluginContainer").css("visibility"));x=$("#"+c+"Statusbar");0<x.length&&(x.isactive="visible"===x.closest(".JS9PluginContainer").css("visibility"));y=$("#"+c+"Colorbar");0<y.length&&!x.length&&(y.isactive="visible"===y.closest(".JS9PluginContainer").css("visibility"));0<w.length&&(B=w.width(),z=w.height(),
A=w.offset().top-$(window).scrollTop()-5,C=w.offset().left-$(document).scrollLeft(),u.isactive&&(z+=u.height(),A-=u.height()),r.isactive&&(z+=r.height(),A-=r.height()),x.isactive?(z+=x.height(),A-=x.height()):y.isactive&&(z+=y.height(),A-=y.height(),A+=7))},J=function(a,b){if(a){if(0<w.length){var c="";u.isactive&&(c+=sprintf("<div class='JS9Menubar' id='%sMenubar' data-width=%s></div>",b,w.width()));r.isactive&&(c+=sprintf("<div class='JS9Toolbar' id='%sToolbar' data-width=%s></div>",b,w.width()));
...
"0@0,0@0,"+h;p("bin %s [%s]",C,h);a.imsection(C,u,k,"");A+=u+"\n"}a.vfile(r,A);k=a.imgtbl(r,".",x,"-C");m("mImgtbl",k);a.vsize(x)||a.error("no image data found to construct a mosaic");k=a.makehdr(x,z,"");m("mMakeHdr",k);w=a.vread(x)}else k=a.shrinkhdr(b.dim,u,z),m("mShrinkHdr",k),w=a.vread(w);w=w.trim().split("\n");w.splice(0,3);A="|                                                    fname|\n|                                                     char|\n";for(e=0;e<w.length;e++)k=w[e].trim().split(/\s+/),
u=k[k.length-2],k=k[k.length-1],u&&k&&(r="-a 1","shrink"===b.reduce&&(r+=" -h "+u),r+=" "+a.globalOpts.reprojSwitches,E=k.split("/").reverse()[0].replace(/\.(g|f)z$/,""),x="reproj_"+u+"_"+E,A+=x+"\n",g.push(x),g.push(x.replace(/\.fits$/i,"_area.fits")),p("reproject: %s [%s] -> %s",k,u,x),k=a.reproject(k,x,z,r),m("mProjectPP",k));a.vfile(y,A);k=a.imgtbl(y,".",B,"");m("mImgtbl",k);a.vsize(B)||a.error("no FITS files were added to output table for mosaic");p("create mosaic: %s",f);k=a.madd(B,z,f,"");
...
dataType:"script",timeout:a.globalOpts.htimeout,cache:!0,success:function(){var c={reconnection:!0,reconnectionDelay:1E3,reconnectionDelayMax:1E4,reconnectionAttempts:100,timeout:a.globalOpts.htimeout};2!==b.sockver&&(c.path="/socket.io-"+b.sockver+"/");"undefined"===typeof io?f(null,"socket io object is undefined",null):(b.socket=io.connect(b.url,c),b.socket.on("connect",function(){var c;b.connected=!0;b.helper=!0;var d=[];for(c=0;c<a.displays.length;c++)d.push(a.displays[c].id);b.socket.emit("initialize",
{displays:d,pageid:b.pageid},function(c){b.pageid=c.pageid;b.js9helper=c.js9helper;a.globalOpts.dataPathModify=c.dataPathModify;b.ready=!0;$(document).trigger("JS9:helperReady",{type:"socket.io",status:"OK"});a.DEBUG&&a.log("JS9 helper: connect: "+b.type)});$(document).trigger("JS9:connected",{type:"socket.io",status:"OK"})}),b.socket.on("connect_error",function(){b.connected=!1;b.helper=!1;1<a.DEBUG&&a.log("JS9 helper: connect error")}),b.socket.on("connect_timeout",function(){b.connected=!1;b.helper=
!1;1<a.DEBUG&&a.log("JS9 helper: connect timeout")}),b.socket.on("disconnect",function(c){b.connected=!1;b.helper=!1;1<a.DEBUG&&a.log("JS9 helper: disconnect: "+c);"io server disconnect"===c&&(1<a.DEBUG&&a.log("JS9 helper: manual reconnect"),b.socket.connect())}),b.socket.on("reconnect",function(){b.connected=!0;b.helper=!0;1<a.DEBUG&&a.log("JS9 helper: reconnect")}),b.socket.on("msg",a.msgHandler))},error:function(a,b,c){f(a,b,c)}})},g=function(a,b,c){$.ajax({url:a,dataType:"jsonp",success:function(){h(b)},
...
(this.worker=new Worker(c),d())};a.WebWorker.prototype.msgHandler=function(c){var b=a.helper,d=c.data;switch(d.cmd){case "progress":a.progress(d.result.value,d.result.max);break;case "initsocketio":this.sockinit=!0;for(c=0;c<this.handlers.length;c++){var e=this.handlers[c];if(e.id===d.id){e.func(d.result);this.handlers.splice(c,1);break}}break;case "uploadFITS":for(c=0;c<this.handlers.length;c++)if(e=this.handlers[c],e.id===d.id){e.func(d.result);this.handlers.splice(c,1);break}break;case "connect_error":case "connect_timeout":delete a.worker.uploadActive;
a.progress(!1);1<a.DEBUG&&a.log("JS9 worker socketio: "+d.cmd);break;case "disconnect":delete a.worker.uploadActive;a.progress(!1);d.result?window.setTimeout(function(){a.worker.send("initsocketio",[b.url,b.sockver,b.pageid],function(){d.alert?alert(d.result):1<a.DEBUG&&a.log(d.result)})},a.TIMEOUT):1<a.DEBUG&&a.log("JS9 worker socket was disconnected");break;case "error":delete a.worker.uploadActive,a.progress(!1),a.error(d.result||"in web worker")}};a.WebWorker.prototype.send=function(c,b,d,e){var f=
c+a.uniqueID(),h={id:f,cmd:c,args:b};d&&(b=b||[],this.handlers.push({id:f,cmd:c,args:b,func:d}));e?this.worker.postMessage(h,e):this.worker.postMessage(h)};a.WebWorker.prototype.socketio=function(c){var b=a.helper;a.worker.send("initsocketio",[b.url,b.sockver,b.pageid],function(b){"OK"===b?c&&c():a.error("can't init socket.io for JS9 worker: "+b)})};a.WebWorker.prototype.terminate=function(){this.worker.terminate()};fabric.major_version=parseFloat(fabric.version.split(".")[0]);fabric.minor_version=
parseFloat(fabric.version.split(".")[1]);fabric.patch_version=parseFloat(fabric.version.split(".")[2]);a.Fabric={};a.Fabric.elements="cornerSize cornerColor cornerStyle borderColor transparentCorners selectionLineWidth centeredScaling hasControls hasRotatingPoint lockMovementX lockMovementY lockRotation lockScalingX lockScalingY lockUniScaling selectable hasBorders params pub".split(" ");a.Fabric.opts={originX:"center",originY:"center",strokeWidth:2,selectionLineWidth:2,borderColor:"#00EEFF",cornerColor:"#00EEFF",
cornerSize:fabric.isTouchSupported?10:6,cornerStyle:"circle",hasControls:!0,hasRotatingPoint:!0,hasBorders:!0,transparentCorners:!1,centeredScaling:!0,strokeUniform:!0,selectable:!0,padding:0,canvas:{selection:!0},fill:"transparent",objectCaching:!1};a.Fabric.rescaleStrokeWidth=function(a,b){var c=(this.scaleX+this.scaleY)/2;4<=fabric.major_version||3===fabric.major_version&&6===fabric.minor_version&&3<=fabric.patch_version||2<=fabric.major_version&&this.params&&"annulus"!==this.params.shape&&"cross"!==
this.params.shape||(a=a||1,a*=c,!b&&this.params&&(b=this.params.sw1),b&&("group"===this.type?this.forEachObject(function(c){c.rescaleBorder(a,b)}):this.set("strokeWidth",b/a)))};a.Fabric.rescaleEvenly=function(){if(this.params&&this.scaleX!==this.scaleY)switch(this.params.shape){case "annulus":case "circle":var a=this.params.lastscale||1;this.scaleX!==a?this.scaleY=this.scaleX:this.scaleY!==a&&(this.scaleX=this.scaleY);this.params.lastscale=this.scaleX}};fabric.Object.prototype.rescaleBorder=a.Fabric.rescaleStrokeWidth;
fabric.Object.prototype.rescaleEvenly=a.Fabric.rescaleEvenly;a.Fabric.newShapeLayer=function(c,b,d){var e=this,f=function(a){e.image&&e.image._updateMultiDialogs(a)},h=function(b,d){b.params.sel=null;b.display.image&&(b.display.image.layer=null);if(d){switch(d.type){case "polyline":case "polygon":a.Fabric.removePolygonAnchors(b,d)}b.display.image&&"activeSelection"!==d.type&&b.display.image.updateShapes(c,d,"unselect")}},g=function(b,d){b.params.sel&&d.params&&b.params.sel!==d&&h(b,b.params.sel);
b.display.image&&(b.display.image.layer=c);if(d){switch(d.type){case "polyline":case "polygon":a.Fabric.addPolygonAnchors(b,d),b.canvas.renderAll()}d.polyparams?b.params.sel=d.polyparams.polygon:d.params&&(b.params.sel=d);b.display.image&&"activeSelection"!==d.type&&b.display.image.updateShapes(c,d,"select");f(1)}};if(this&&c){if(this.layers[c])return this.layers[c];this.layers[c]={};var k=this.layers[c];k.layerName=c;k.params=[];k.params.sel=null;k.params.sellayer=null;d?k.dtype="other":(k.dtype=
"main",d=this.divjq);var l=d.attr("id")+"-"+c.replace(/\s+/,"_")+"-shapeLayer";k.display=this;k.opts=$.extend(!0,{},b);k.opts.canvas=k.opts.canvas||{};void 0===k.opts.canvas.selection&&(k.opts.canvas.selection=!0);k.el=a.Fabric.elements;k.divjq=$("<div>").addClass("JS9Container").css("z-index",0).appendTo(d);k.canvasjq=$("<canvas>").addClass("JS9Layer").attr("id",l).attr("width",d.css("width")).attr("height",d.css("height")).appendTo(k.divjq);a.bugs.webkit_resize&&"main"===k.dtype&&k.canvasjq.attr("width",
this.width).attr("height",this.height);k.canvas=new fabric.Canvas(k.canvasjq[0]);k.canvas.renderOnAddRemove=!1;k.canvas.preserveObjectStacking=!0;k.opts.movable?(k.opts.lockMovementX=!1,k.opts.lockMovementY=!1,k.opts.selectable=!0,k.opts.evented=!0):!1===k.opts.movable&&(k.opts.lockMovementX=!0,k.opts.lockMovementY=!0,k.opts.selectable=!1,k.opts.evented=!1);void 0===k.opts.changeable&&void 0!==k.opts.fixinplace&&(k.opts.changeable=!k.opts.fixinplace);k.opts.changeable?(k.opts.hasControls=!0,k.opts.hasRotatingPoint=
!0,k.opts.hasBorders=!0,k.opts.lockMovementX=!1,k.opts.lockMovementY=!1,k.opts.lockRotation=!1,k.opts.lockScalingX=!1,k.opts.lockScalingY=!1,k.opts.lockUniScaling=!1,k.opts.selectable=!0,k.opts.evented=!0,k.opts.usekeyboard=!0):!1===k.opts.changeable&&(k.opts.hasControls=!1,k.opts.hasRotatingPoint=!1,k.opts.hasBorders=!1,k.opts.lockMovementX=!0,k.opts.lockMovementY=!0,k.opts.lockRotation=!0,k.opts.lockScalingX=!0,k.opts.lockScalingY=!0,k.opts.lockUniScaling=!0,k.opts.selectable=!1,k.opts.evented=
!1,k.opts.usekeyboard=!1);k.opts.selectable&&(k.opts.canvas.selection=!0);if(k.opts.onmousedown||k.opts.onmouseup||k.opts.onmousemove||k.opts.tooltip||k.opts.onmouseover||k.opts.onmouseout){k.opts.evented=!0;if(k.opts.onmousedown)k.canvas.on("mouse:down",function(b){if(k.display.image&&b.target)"main"===k.dtype&&(k.display.image.clickInRegion=!0,k.display.image.clickInLayer=c),k.opts.onmousedown.call(k.canvas,k.display.image,b.target.pub,b.e,b.target);else if(k.canvas._selection=k.canvas.selection)k.canvas.selection=
a.specialKey(b.e)});else k.canvas.on("mouse:down",function(b){if(k.canvas._selection=k.canvas.selection)k.canvas.selection=a.specialKey(b.e)});if(k.opts.onmouseup)k.canvas.on("mouse:up",function(a){k.display.image&&a.target&&k.opts.onmouseup.call(k.canvas,k.display.image,a.target.pub,a.e,a.target);k.canvas.selection=k.canvas._selection||k.canvas.selection});else k.canvas.on("mouse:up",function(){k.canvas.selection=k.canvas._selection||k.canvas.selection});if(k.opts.onmousemove)k.canvas.on("mouse:move",
...
d.points.length||("polygon"===b.shape&&b.polypoints?b.points=b.points||b.polypoints:"line"===b.shape&&b.linepoints&&(b.points=b.points||b.linepoints));if(b.ireg&&a.SCALEIREG)for(m=b.points.length,e=0;e<m;e++)b.points[e].x/=c,b.points[e].y/=c}for(t in b)if(b.hasOwnProperty(t))switch(t){case "tags":case "x":case "y":case "px":case "py":case "deltax":case "deltay":case "ra":case "dec":case "pts":case "left":case "top":case "angle":case "radii":case "ireg":break;case "type":case "originX":case "originY":case "width":case "height":case "scaleX":case "scaleY":case "flipX":case "flipY":case "opacity":case "cornerSize":case "transparentCorners":case "hoverCursor":case "padding":case "borderColor":case "cornerColor":case "centeredScaling":case "centeredRotation":case "fill":case "fillRule":case "backgroundColor":case "stroke":case "strokeWidth":case "strokeDashArray":case "strokeLineCap":case "strokeLineJoin":case "strokeMiterLimit":case "shadow":case "borderOpacityWhenMoving":case "borderScaleFactor":case "borderDashArray":case "transformMatrix":case "minScaleLimit":case "selectable":case "evented":case "visible":case "hasControls":case "hasBorders":case "hasRotatingPoint":case "rotatingPointOffset":case "perPixelTargetFind":case "includeDefaultValues":case "clipTo":case "lockMovementX":case "lockMovementY":case "lockRotation":case "lockScalingX":case "lockScalingY":case "lockUniScaling":case "send":case "radius":case "rx":case "ry":case "points":case "selectionLineWidth":case "fontFamily":case "fontSize":case "fontStyle":case "fontWeight":case "text":case "textDecoration":case "textAlign":case "lineHeight":case "textBackgroundColor":case "textOpts":f[t]=
b[t];break;case "shape":var p=b[t];break;default:h[t]=b[t]}if(!(b=h.color||f.stroke)){b=h.tags;e=h.tagcolors;var q;e=e||{};for(q in e)if(e.hasOwnProperty(q)){var t=q.split("_");if(0===$(b).not(t).length&&0===$(t).not(b).length){var v=e[q];break}}if(!v)for(q in e)if(e.hasOwnProperty(q)&&(t=q.split("_"),0===$(b).not(t).length)){v=e[q];break}if(!v)for(q in e)if(e.hasOwnProperty(q)&&(t=q.split("_"),0===$(t).not(b).length)){v=e[q];break}b=v=v||d&&d.get("stroke")||e.defcolor||a.globalOpts.defcolor||"#000000"}f.stroke=
...
g.child=b.params.children&&b.params.children.length?b.params.children[0].id:null;var q=b.getCenterPoint();var t={x:0,y:0};d.group&&(t=d.group.getCenterPoint(),q={x:q.x+t.x,y:q.y+t.y},d.group.angle&&(q=a.rotatePoint(q,d.group.angle,t)));g.dx=q.x;g.dy=q.y;q=this.displayToImagePos(q);g.x=q.x;g.y=q.y;g.lcs=this.imageToLogicalPos(q);"export"!==e&&b.params.wcsconfig&&("image"===b.params.wcsconfig.wcssys?h="image":"physical"===b.params.wcsconfig.wcssys&&(h="physical"));if("image"===h||"image"===this.params.wcssys&&
"physical"!==h){g.imsys="image";var v=g.x;var w=g.y;var u=1}else g.imsys=g.lcs.sys,v=g.lcs.x,w=g.lcs.y,u=Math.sqrt(Math.pow(this.lcs.physical.reverse[0][0],2)+Math.pow(this.lcs.physical.reverse[0][1],2));g.angle=-b.angle;d.group&&(g.angle-=d.group.angle);h=g.angle;if(!g.parent)switch(g.shape){case "box":case "cross":case "ellipse":case "text":if(a.notNull(this.params.transformScale)&&(g.angle/=this.params.transformScale),a.notNull(this.params.transformAngle)&&(g.angle-=this.params.transformAngle),
this.raw.wcsinfo)this.raw.wcsinfo.crot&&(g.angle-=this.raw.wcsinfo.crot);else if(a.notNull(this.raw.header.LTM1_1)||a.notNull(this.raw.header.LTM1_2)){try{var r=Math.atan((this.raw.header.LTM1_2||0)/(this.raw.header.LTM1_1||0))}catch(A){r=0}r&&(r=180*-r/Math.PI,g.angle-=r)}}for(;0>g.angle;)g.angle+=360;for(;360<=g.angle;)g.angle-=360;q=b.scaleX/p;r=b.scaleY/p;d.group&&(q*=d.group.scaleX,r*=d.group.scaleY);switch(g.shape){case "annulus":g.shape="annulus";g.radii=[];"image"!==g.imsys&&(g.lcs.radii=
[]);g.imstr="annulus("+m(v)+","+m(w)+",";var x="annulus "+g.x+" "+g.y+" ";t=b.getObjects();var y=t.length;for(d=0;d<y;d++)h=t[d].radius*q,r=h*u,g.imstr+=m(r),x+=g.x+" "+g.y+" "+(g.x+h)+" "+g.y+" ",g.imstr=d===y-1?g.imstr+")":g.imstr+",",g.radii.push(h),"image"!==g.imsys&&g.lcs.radii.push(r);break;case "box":case "cross":g.width=b.width*q;g.height=b.height*r;r=g.width*u;x=g.height*u;"image"!==g.imsys&&(g.lcs.width=r,g.lcs.height=x);g.imstr=g.shape+"("+m(v)+","+m(w)+","+m(r)+","+m(x)+","+g.angle.toFixed(4)+
")";x=g.shape+" "+g.x+" "+g.y+" "+g.x+" "+g.y+" "+(g.x+g.width)+" "+g.y+" "+g.x+" "+g.y+" "+g.x+" "+(g.y+g.height)+" "+g.angle*Math.PI/180;break;case "circle":g.radius=b.radius*q;r=g.radius*u;"image"!==g.imsys&&(g.lcs.radius=r);g.imstr="circle("+m(v)+","+m(w)+","+m(r)+")";x="circle "+g.x+" "+g.y+" "+g.x+" "+g.y+" "+(g.x+g.radius)+" "+g.y;break;case "ellipse":g.r1=b.width*q/2;g.r2=b.height*r/2;r=g.r1*u;x=g.r2*u;"image"!==g.imsys&&(g.lcs.r1=r,g.lcs.r2=x);g.imstr="ellipse("+m(v)+","+m(w)+","+m(r)+","+
m(x)+","+g.angle.toFixed(4)+")";x="ellipse "+g.x+" "+g.y+" "+g.x+" "+g.y+" "+(g.x+g.r1)+" "+g.y+" "+g.x+" "+g.y+" "+g.x+" "+(g.y+g.r2)+" "+g.angle*Math.PI/180;break;case "point":g.width=b.width*q;g.height=b.height*r;r=g.width*u;x=g.height*u;"image"!==g.imsys&&(g.lcs.width=r,g.lcs.height=x);g.imstr="point("+m(v)+","+m(w)+")";x="point "+g.x+" "+g.y;break;case "line":case "polygon":g.imstr=g.shape+"(";x=g.shape+" ";g.pts=[];"image"!==g.imsys&&(g.lcs.pts=[]);for(d=0;d<b.points.length;d++)0<d&&(g.imstr+=
",",x+=" "),r=this.displayToImagePos({x:t.x+b.left+b.points[d].x*b.scaleX,y:t.y+b.top+b.points[d].y*b.scaleY}),r=a.rotatePoint(r,h,{x:g.x,y:g.y}),"image"===g.imsys?g.imstr+=m(r.x)+","+m(r.y):(u=this.imageToLogicalPos(r),q=u.x,u=u.y,g.imstr+=m(q)+","+m(u),g.lcs.pts.push({x:q,y:u})),x+=r.x+" "+r.y,g.pts.push(r),"line"===g.shape&&(0===d?y=0:(q=g.pts[d-1],y+=Math.sqrt((r.x-q.x)*(r.x-q.x)+(r.y-q.y)*(r.y-q.y))));if("line"===g.shape&&a.notNull(y)){g.imstr+=') {"size":'+m(y)+',"units":"pixels"';if(2===g.pts.length){for(r=
180*Math.atan2(g.pts[1].y-g.pts[0].y,g.pts[1].x-g.pts[0].x)/Math.PI;0>r;)r+=360;var B=',"posang":'+r.toFixed(4)+',"posunits":"degrees"';g.imstr+=B}g.imstr+="}"}else g.imstr+=")";g.angle=0;break;case "text":g.imstr="text("+m(v)+","+m(w)+',"'+b.text+'",'+g.angle.toFixed(4)+")",x="text "+g.x+" "+g.y+' "'+b.text+'" '+g.angle*Math.PI/180,g.text=b.text}this.raw.wcs&&0<this.raw.wcs&&(n(this.raw.wcs,k,g,x,B,f,g),b.params.wcsconfig&&b.params.wcsconfig.wcssys&&(m=a.globalOpts.xeqPlugins,a.globalOpts.xeqPlugins=
!1,t=this.getWCSSys(),a.notWCS(b.params.wcsconfig.wcssys)||(this.setWCSSys(b.params.wcsconfig.wcssys,!1),n(this.raw.wcs,k,g,x,B,f,b.params.wcsconfig)),g.wcsconfig=$.extend(!0,{},b.params.wcsconfig),this.setWCSSys(t,!1),a.globalOpts.xeqPlugins=m));g.data=b.params.data;b.set("pub",g);b.params.winid&&($(b.params.winid).is(":visible")?this.initRegionsForm(b):b.params.winid=null);if(f.nocb)return g;if(!b.params.parent&&!e.match(l)){if(this.params.xeqonchange&&k.show&&k.opts.onchange)try{this.params.xeqonchange=
!1,a.xeqByName(k.opts.onchange,window,this,g)}catch(A){a.log("error in onchange: %s [%s]\n%s",this.id,A.message,a.strace(A))}finally{this.params.xeqonchange=!0}this.xeqPlugins("shape","on"+c+"change",g)}if("regions"===c&&a.globalOpts.regToClipboard){switch(e){case "update":d=g.parent||g.id;break;default:d=null}if(a.notNull(d)){try{var z=this.listRegions(d,{mode:1,includedcoords:!0})}catch(A){z=null}z&&(a.clipboard=z)}}"regions"===c&&"wcs"===e&&this._updateMultiDialogs(!0);return g};a.Fabric.removeShapes=
function(c,b,d){var e=this,f,h={mode:1,includedcoords:!0},g=[];if(f=this.getShapeLayer(c)){var k=f.canvas;d=d||{};"regions"===c&&a.globalOpts.unremoveReg&&(this.regstack.push(this.listRegions(b,h,c)),this.regstack.length>a.globalOpts.unremoveReg&&(this.regstack=this.regstack.slice(0,a.globalOpts.unremoveReg)));this._selectShapes(c,b,function(a,b){if(!(!1===a.params.removable&&!d.overrideRemovable||a.params.sticky&&!1===d.sticky)){e._updateShape(c,a,b,"remove");a.params.winid&&(a.params.winid.close(),
a.params.winid=null);if(a.params.parent){var f=a.params.parent.obj;for(b=f.params.children.length-1;0<=b;b--)if(a===f.params.children[b].obj){f.params.children.splice(b,1);break}}for(b=0;b<a.params.children.length;b++)f=a.params.children[b].obj,g.push(f);g.push(a)}});for(b=0;b<g.length;b++)k.remove(g[b]);1===fabric.major_version?k.getActiveGroup()&&k.discardActiveGroup():k.discardActiveObject();k.renderAll();!k.getObjects().length&&a.globalOpts.resetEmptyShapeId&&(f.nshape=0);return this}};a.Fabric.getShapes=
function(c,b,d){var e={},f=[];d=d||{};if("string"===typeof d)try{d=JSON.parse(d)}catch(k){a.error("can't parse getShapes opts: "+d,k)}if("regions"===c&&("text"===d.format||"csv"===d.format||"regions"===d.format)){d.mode=d.mode||1;b=this.listRegions(b,d);if("csv"===d.format){var h=b.split(";");c=0;for(b="";c<h.length;c++)if(h[c])if(h[c].toLowerCase().match(a.WCSEXP))d.includewcs&&(b+=h[c].trim()+"\n");else{var g=h[c].replace(/\(/,",").replace(/\).*/,"").trim();b+=g+"\n"}}else"regions"===d.format&&
(b=b.replace(/ *; */g,"\n"));return b}this._selectShapes(c,b,function(a){e=a.pub||{};d.includeObj&&(e.obj=a);f.push(e)});return f};a.Fabric.changeShapes=function(c,b,d){var e=this,f,h,g,k,l,m,n,p,q,t,v,w=[],u=[];if((l=this.getShapeLayer(c))&&d){if("string"===typeof d)try{d=JSON.parse(d)}catch(y){a.error("can't parse shape opts: "+d,y)}if(this.display.image!==this)this.delayedShapes=this.delayedShapes||[],this.delayedShapes.push({layer:c,shape:b,mode:"change",opts:d});else{var r=l.canvas;var x=r.getActiveObject();
this._selectShapes(c,b,function(b,B){p="main"!==e.display.layers[c].dtype||b.params.preservedcoords?1:e.rgb.sect.zoom;d.radii&&(b.params.radii=[]);d.tags&&(b.params.tags=[]);k=$.extend(!0,{},b.params,d);g=e._parseShapeOptions(c,k,b);if(g.remove){if(!0===g.remove||"true"===g.remove)g.remove="all";if(!1!==g.remove&&"false"!==g.remove){e.removeShapes(c,g.remove||"all");return}}if(g.opts.send)switch(g.opts.send){case "front":r.sendToFront(x);r.discardActiveObject();break;case "back":r.sendToBack(x),r.discardActiveObject()}q=
e._exportShapeOptions(d).filter(function(a){return!b.params.exports.hasOwnProperty(a)});g.params.exports=b.params.exports.concat(q);g.opts.stroke&&(g.opts.color=g.opts.stroke,g.opts.stroke=a.colorToHex(g.opts.stroke));switch(b.params.shape){case "text":g.opts.stroke&&(g.opts.fill=g.opts.stroke);g.opts.strokeWidth=0;break;case "line":case "polygon":g.opts.points&&g.opts.points.length&&(b.angle=0)}b.set(g.opts);b.params=$.extend(!1,{},b.params,g.params);d.strokeWidth&&(b.params.sw1=d.strokeWidth);switch(b.params.shape){case "annulus":if(d.radii&&
d.radii.length){b.forEachObject(function(a){w.push(a)});m=w.length;for(f=0;f<m;f++)b.remove(w[f]),r.remove(w[f]);m=b.params.radii.length;n=0;t=$.extend(!0,{},d);t.stroke=t.stroke||b.get("stroke");for(f=0;f<m;f++)t.radius=b.params.radii[f],h=new fabric.Circle(t),n=Math.max(n,b.params.radii[f]),b.add(h);b.scaleX=p;b.scaleY=p;b.width=2*n;b.height=2*n;x===b&&r.setActiveObject(b)}break;case "box":d.width&&(b.scaleX=p);d.height&&(b.scaleY=p);break;case "circle":d.radius&&(b.scaleX=p,b.scaleY=p);break;case "cross":t=
$.extend(!0,{},d);t.stroke=t.stroke||b.get("stroke");t.width&&(b.scaleX=p,u[0]=[{x:-t.width/2,y:0},{x:t.width/2,y:0}],delete t.width);t.height&&(b.scaleY=p,u[1]=[{x:0,y:-t.height/2},{x:0,y:t.height/2}],delete t.height);t.angle&&delete t.angle;b.forEachObject(function(a,b){v=$.extend(!0,{},t);u[b]&&(v.points=u[b]);a.set(v)});break;case "ellipse":d.r1&&(b.rx=b.params.r1,b.scaleX=p,b.width=2*b.rx);d.r2&&(b.ry=b.params.r2,b.scaleY=p,b.height=2*b.ry);break;case "line":case "polygon":if(d.points&&d.points.length||
d.pts&&d.pts.length)b.scaleX=p,b.scaleY=p;x===b&&(a.Fabric.removePolygonAnchors(l.dlayer,b),a.Fabric.addPolygonAnchors(l.dlayer,b));a.resetPolygonCenter(b);break;case "text":d.text&&(b.params.text=d.text)}b.rescaleBorder();a.Fabric.updateChildren(l.dlayer,b,"moving");a.Fabric.updateChildren(l.dlayer,b,"scaling");a.Fabric.updateChildren(l.dlayer,b,"rotating");a.Fabric.updateChildren(l.dlayer,b,"deltas");b.setCoords();e._handleChildText(c,b,d);e._updateShape(c,b,B,"update");if(d.onchangeshapes&&b.pub)try{a.xeqByName(d.onchangeshapes,
e,e,b.pub)}catch(z){a.error("in onchangeshapes callback",z,!1)}});(void 0===d.redraw||d.redraw)&&r.renderAll();return this}}};a.Fabric.refreshShapes=function(c){var b;if(c){var d=this.getWCSSys();if("image"===d){var e=a.globalOpts.xeqPlugins;a.globalOpts.xeqPlugins=!1;this.raw.wcs&&0<this.raw.wcs?this.setWCSSys("native",!1):this.setWCSSys("physical",!1)}if(b=this.listRegions("all",{mode:1,sticky:!1,savewcsconfig:!0,saveid:!0},c))this.removeShapes(c,"all",{overrideRemovable:!0,sticky:!1}),this.addShapes(c,
...
this.display.layers[c].opts:a.Regions.opts;e[b].display.newShapeLayer(c,f);e[b].addShapes(c,d)}return this}}};a.Fabric._addPolygonPoint=function(c,b,d){var e=Number.MAX_VALUE;if(b&&b.points){d=a.eventToDisplayPos(d);var f=b.getCenterPoint().x;var h=b.getCenterPoint().y;f=(d.x-f)/b.get("scaleX");var g=(d.y-h)/b.get("scaleY");for(h=-b.get("angle")*Math.PI/180;h>2*Math.PI;)h-=2*Math.PI;d=Math.cos(h)*f-Math.sin(h)*g;g=Math.sin(h)*f+Math.cos(h)*g;f=b.points;for(h=0;h<f.length;h++){var k=f[h];var l=f[(h+
1)%f.length];var m=k.x<l.x?k.x:l.x;var n=k.y<l.y?k.y:l.y;var p=k.x>l.x?k.x:l.x;var q=k.y>l.y?k.y:l.y;var t=k.x-l.x;k=k.y-l.y;var v=Math.sqrt(t*t+k*k);0!==v&&(t/=v,k/=v);v=d-l.x;var w=g-l.y;v=v*t+w*k;t=l.x+t*v;l=l.y+k*v;t<m?t=m:t>p&&(t=p);l<n?l=n:l>q&&(l=q);m=(t-d)*(t-d)+(l-g)*(l-g);if(m<e){e=m;var u=t;var r=l;var x=h===f.length?0:h}}c=this.getShapeLayer(c);a.Fabric.removePolygonAnchors(c.dlayer,b);f.splice(x+1,0,{x:u,y:r});if(1===fabric.major_version)c.canvas.setActiveObject(b);else{switch(b.type){case "polyline":case "polygon":a.Fabric.addPolygonAnchors(c.dlayer,
...
function(c,b){var d,e={},f=c.canvas,h=function(b){b=b.target;var d=b.polyparams.polygon,g=b.polyparams.point,h=d.get("points"),k=c.display.image;void 0!==g&&!1!==d.params.changeable&&(d.angle?e=a.rotatePoint({x:b.left,y:b.top},-d.angle,{x:d.left,y:d.top}):(e.x=b.left,e.y=b.top),h[g].x=(e.x-d.left)/d.scaleX,h[g].y=(e.y-d.top)/d.scaleY,a.resetPolygonCenter(d),k._updateShape(d.params.layerName,d,null,"update"),k&&(k.params.listonchange||d.params.listonchange)&&k.listRegions(d,{mode:2}),f.renderAll())},
...
b.angle,b.getCenterPoint()));var k=new fabric.Rect({left:e.x,top:e.y,hasControls:!1,hasRotatingPoint:!1,hasBorders:!1,selectable:!0,fill:b.get("stroke"),hoverCursor:"pointer",width:a.Fabric.opts.cornerSize+2,height:a.Fabric.opts.cornerSize+2,padding:2});k.on("moving",h);k.polyparams={};k.polyparams.polygon=b;k.polyparams.point=d;b.params.anchors[d]=k;f.add(k)}b.on("moving",function(){g(b)});b.on("rotating",function(){g(b)});b.on("scaling",function(){g(b)});b.setCoords()}};a.Fabric.removePolygonAnchors=
function(a,b){var c=a.canvas;if(b&&b.params&&b.params.anchors&&!1!==b.params.changeable){for(a=0;a<b.params.anchors.length;a++)c.remove(b.params.anchors[a]);delete b.params.anchors}};a.Fabric.updateChildren=function(c,b,d){var e,f;if("regions"===c.layerName)if("objects"===d){var h={};c.canvas.getObjects().forEach(function(a){a.params&&(a.params.parent||a.params.children.length)&&(h[a.params.id]=a)});c.canvas.getObjects().forEach(function(a){if(a.params)for(a.params.parent&&(a.params.parent.obj=h[a.params.parent.id]),
e=0;e<a.params.children.length;e++)a.params.children[e].obj=h[a.params.children[e].id]})}else if(b&&b.params)if("deltas"===d){if(b.params.parent){var g=b.params.parent;g.dleft=g.obj.left-b.left;g.dtop=g.obj.top-b.top;g.moved=!0}}else for(e=0;e<b.params.children.length;e++){var k=b.params.children[e].obj;g=k.params.parent;switch(d){case "moving":k.left=b.left-g.dleft;k.top=b.top-g.dtop;break;case "rotating":for(f=b.angle;0>f;)f+=360;for(;360<=f;)f-=360;var l=f-g.lastangle;var m=a.rotatePoint({x:k.left,
...
(b=c._calcDimensions(),c.width=b.width,c.height=b.height,c.pathOffset={x:b.left+c.width/2,y:b.top+c.height/2});c.setCoords()};a.Fabric.print=function(c){var b,d="",e=0,f=sprintf("width=%s,height=%s,menubar=1,toolbar=1,status=0,scrollbars=1,resizable=1",this.display.canvasjq.attr("width"),this.display.canvasjq.attr("height"));c=c||{};if("string"===typeof c)try{c=JSON.parse(c)}catch(l){a.error("can't parse print opts: "+c,l)}var h=this.display.canvas.toDataURL("image/png");var g="<html><body style='padding: 0px; margin: 0px' onload='window.print(); return false'>";
...
{onceOnly:!0},function(){b.firsttime=!0;d.updateShapes("regions",c,"wcsconfig");d.initRegionsForm(c,b)});b.winid=this.displayAnalysis("regions",h,{title:f,winformat:g});c&&(c.params.winid=b.winid)}};a.Regions.initConfigForm=function(c,b){var d=this,e,f,h,g,k,l,m,n=!1,p=this.raw.wcsinfo||{cdelt1:1,cdelt2:1};var q={type:"multi",pub:{shape:"multi",wcsconfig:{}},params:{}};var t=function(a){if(void 0!==a)return"number"===typeof a&&0!==a%1&&(a=Math.round(1E4*(a+1E-5))/1E4),String(a)},v=function(a){return(a||
"").replace(/\n/g,"\\n")};if(c&&c.pub)var w=c.pub.wcsconfig&&c.pub.wcsconfig.wcssys?c.pub.wcsconfig.wcssys:this.params.wcssys;else w=this.params.wcssys,c=q;b=b||{};if(c.params.winid)var u=c.params.winid;else b.winid&&(u=b.winid);if(u){var r="#"+$(u).attr("id")+" .regionsConfigForm ";if($(r).length){n=$(r).data("multi")?!0:b.multi;$(r+"."+c.pub.shape).each(function(a,b){$(b).removeClass("nodisplay")});$(r+".val").each(function(b,m){h="";f=$(m).attr("name");switch(f){case "x":case "y":c.pub.lcs&&void 0!==
c.pub.lcs[f]?h=t(c.pub.lcs[f]):void 0!==c.pub[f]&&(h=t(c.pub[f]));break;case "radii":c.pub.radii&&(h=a.notWCS(w)||!c.pub.wcsconfig.wcsstr?c.pub.imstr.replace(/^annulus\(/,"").replace(/\)$/,"").split(",").slice(2).join(","):c.pub.wcsconfig.wcsstr.replace(/^annulus\(/,"").replace(/\)$/,"").split(",").slice(2).join(","));break;case "pts":c.pub.pts?c.pub.pts.forEach(function(a){h&&(h+=", ");h+=a.x.toFixed(2)+", "+a.y.toFixed(2)}):c.pub.imstr&&(h=c.pub.imstr.replace(/^.*\(/,"").replace(/\)$/,""));break;
case "linelength":if(c.pub.pts&&2===c.pub.pts.length){k=c.pub.pts[0];l=c.pub.pts[1];h=t(Math.sqrt((l.x-k.x)*(l.x-k.x)+(l.y-k.y)*(l.y-k.y)));switch(w){case "image":case "physical":break;default:h*=Math.abs(p.cdelt1),h*=Math.abs(p.cdelt2)}h=t(h);d.tmp.linelength=h}break;case "lineangle":if(c.pub.pts&&2===c.pub.pts.length){k=c.pub.pts[0];l=c.pub.pts[1];for(h=180*Math.atan2(l.y-k.y,l.x-k.x)/Math.PI;0>h;)h+=360;h=t(h);d.tmp.lineangle=h}break;case "fontFamily":c.getFontFamily&&(h=c.getFontFamily());break;
case "fontSize":c.getFontSize&&(h=c.getFontSize());break;case "fontStyle":c.getFontStyle&&(h=c.getFontStyle());break;case "fontWeight":c.getFontWeight&&(h=c.getFontWeight());break;case "colorPicker":h=void 0!==c.pub.color?a.colorToHex(c.pub.color):$(r).data("colorpicker")||a.globalOpts.defcolor;break;case "color":void 0!==c.pub.color?h=t(c.pub.color):$(r).data("colorpicker")&&(h=$(r).data("colorpicker"));break;case "strokeWidth":h=c.params.sw1?c.params.sw1:$(r).data("strokewidth")||"";break;case "strokeDashes":c.strokeDashArray?
(h=c.strokeDashArray.join(" "),h.match(/NaN/)&&(h="")):h=$(r).data("strokedashes")||"";break;case "regstr":h=a.notWCS(w)||!c.pub.wcsconfig.wcsstr?c.pub.imsys+";"+c.pub.imstr:c.pub.wcsconfig.wcssys+";"+c.pub.wcsconfig.wcsstr;break;case "xpos":switch(w){case "image":c.pub.preservedcoords&&void 0!==c.pub.dx?h=sprintf("d%.1f",c.pub.dx):void 0!==c.pub.x&&(h=sprintf("%.1f",c.pub.x));break;case "physical":c.pub.lcs?h=sprintf("%.1f",c.pub.lcs.x):void 0!==c.pub.x&&(h=sprintf("%.1f",c.pub.x));break;default:void 0!==
...
c.pub[f]&&(h=t(c.pub[f]));break;case "physical":c.pub.lcs&&void 0!==c.pub.lcs[f]&&(h=t(c.pub.lcs[f]));break;default:void 0!==c.pub.wcsconfig.wcssizestr?h=t(c.pub.wcsconfig.wcssizestr[0]):void 0!==c.pub[f]&&(h=t(c.pub[f]))}break;case "height":case "r2":switch(w){case "image":void 0!==c.pub[f]&&(h=t(c.pub[f]));break;case "physical":c.pub.lcs&&void 0!==c.pub.lcs[f]&&(h=t(c.pub.lcs[f]));break;default:void 0!==c.pub.wcsconfig.wcssizestr?h=t(c.pub.wcsconfig.wcssizestr[1]):void 0!==c.pub[f]&&(h=t(c.pub[f]))}break;
case "wcssys":case "savewcs":x=$(r).find("[name='"+f+"']");if(!x.find("option").length)for(e=0;e<a.wcssyss.length;e++)x.append("<option>"+a.wcssyss[e]+"</option>");g="savewcs"===f?a.globalOpts.regSaveWCS||w:w;x.find("option").each(function(a,b){g===b.value&&(h=b.value)});break;case "wcsunits":c.pub.wcsunits&&(h=c.pub.wcsunits);break;case "childtext":c.params.children&&0<c.params.children.length&&(h=v(c.params.children[0].obj.text));break;case "text":void 0!==c.pub[f]&&(h=v(t(c.pub[f])));break;case "id":n?
h="selected":void 0!==c.pub.id&&(h=String(c.pub.id),$(m).css("width",h.length+"ch"));break;case "tags":void 0!==c.pub[f]&&(h=t(c.pub[f]));break;case "savefile":h=$(r).data("savefile")||d.tmp.saveregionsFile||"js9.reg";window.electron&&!h.match(/.*\//)&&(h=window.electron.currentDir+"/"+h);break;case "selectfilter":h=$(r).data("selectfilter");break;default:void 0!==c.pub[f]&&(h=t(c.pub[f]))}$(m).val(h)});(n||!this.raw.wcs||0>this.raw.wcs)&&$(r).find("[name='wcssys']").hide();"text"!==c.type&&c.params.children&&
($(r+".childtext").removeClass("nodisplay"),$(r+"[name='childtext']").prop("readonly",0<c.params.children.length));if(b.firsttime){window.electron&&$(r).find(".rsavebrowse, .rconfigbrowse").removeClass("nodisplay");n?($(r).find("label[for='savecur']").text("sel"),$(r).find("input[id='savecur']").data("tooltip","save selected regions")):$(r).find(".checkboxes").removeClass("nodisplay");if(a.favorites.wcs&&a.favorites.wcs.length){var x=$(r).find(".rwcsbuttons").removeClass("nodisplay");q=x.find(".rwcsbuttoncontainer");
...
a.globalOpts.regIncludeJSON);$(r+"[id='includecomments']").prop("checked",a.globalOpts.regIncludeComments);$(r+"[id='savedcoords']").prop("checked",a.globalOpts.regSaveDCoords);$(r+"[id='includewcs']").prop("checked",a.globalOpts.csvIncludeWCS);$(r).find("input[name='saveformat']").prop("checked",!1);$(r).find("input[value='"+a.globalOpts.regSaveFormat+"']").prop("checked",!0);$(r).find("input[name='rwcsbutton']").prop("checked",!1);$(r).find("input[value='"+(a.globalOpts.regSaveWCS||w)+"']").prop("checked",
!0);y="save"===b.type?"save"+a.globalOpts.regSaveWhich1:"save"+a.globalOpts.regSaveWhich2;$(r+"[id='"+y+"']").prop("checked",!0);"save"===b.type&&$(r).find("input[name='savefile']").trigger("change");$(r).find("input[name='strokeMenu']").prop("selectedIndex",0);$(r).find("input[name='dashesMenu']").prop("selectedIndex",0);if(n)$(r).find(".regid").hide(),$(r).find(".edit").hide(),$(r).find(".childtext").hide(),$(r).find(".multi").removeClass("nodisplay"),0>=b.setmode?($(r).find("[name='multitext']").val(""),
0>b.setmode&&($(r).data("selectfilter",""),$(r).find("[name='selectfilter']").val(""))):(y=this.listRegions("selected",{mode:1,includejson:!1,includecomments:!1}).replace(/ *; */g,"\n"),$(r).find("[name='multitext']").val(y));else switch($(r).find("input:text[readonly]").css("border-color","A5A5A5").css("background","#E9E9E9"),c.pub.shape){case "box":case "cross":case "ellipse":$(r+".angle").removeClass("nodisplay");break;case "text":$(r+".textangle").removeClass("nodisplay");break;case "line":c.pub.pts&&
2===c.pub.pts.length?($(r+".linelength").removeClass("nodisplay"),$(r+".lineangle").removeClass("nodisplay")):($(r+".linelength").addClass("nodisplay"),$(r+".lineangle").addClass("nodisplay"))}$(r+".xtrareg").addClass("nodisplay");$(r+".xtracsv").addClass("nodisplay");$(r+".xtrasvg").addClass("nodisplay");$(r+".xtra"+a.globalOpts.regSaveFormat).removeClass("nodisplay");$(r).data("im",this);$(r).data("shape",c);$(r).data("winid",u);$(r).data("multi",n);a.BROWSER[3]?(u="touchstart",q="touchend"):(u=
"mouseover",q="mouseout");if("save"===b.type)$(r).on(u,function(){$(r).find("input[name='savefile']").focus()});$(r).data("tooltipInit")||($(r).data("tooltipInit",!0),$(".rconfigcol_R, .rsavecol_R").on(u,function(b){var c=b.currentTarget;b=$(c).find("input, textarea, span").data("tooltip");c=$(c).closest(a.lightOpts[a.LIGHTWIN].top).find(a.lightOpts[a.LIGHTWIN].dragBar);b&&c.length&&(m=$(c)[0].childNodes[0].nodeValue.replace(/:.*/,""),$(c)[0].childNodes[0].nodeValue=m+": "+b)}),$(".rconfigcol_R, .rsavecol_R").on(q,
...
b},q=function(a){var b=String.fromCharCode(13,10);return(a||"").replace(/\\n/g,b)};this.lcs&&this.lcs.physical&&(e=Math.sqrt(Math.pow(this.lcs.physical.forward[0][0],2)+Math.pow(this.lcs.physical.forward[0][1],2)));if(b&&b.pub)var t=b.pub.wcsconfig&&b.pub.wcsconfig.wcssys?b.pub.wcsconfig.wcssys:this.params.wcssys;else t=this.params.wcssys,b=f;var v=$(c).data("multi");var w=b.pub.layer||"regions";for(f=0;f<h;f++){var u=d[f].name;var r=d[f].value;if("xpos"===u||"ypos"===u)switch(t){case "image":u="i"+
u.charAt(0);break;case "physical":u="p"+u.charAt(0);break;default:u=this.raw.wcs&&0<this.raw.wcs?"xpos"===u?"ra":"dec":"xpos"===u?"ix":"iy"}switch(u){case "multitext":case "colorPicker":case "savefile":case "rwcsbutton":case "savewcs":case "saveformat":case "includejson":case "includecomments":case "savewhich":case "savedcoords":break;case "text":"text"===b.type&&n(b,u,r)&&(g[u]=q(p(r)));break;case "selectfilter":r&&($(c).data("selectfilter",r),this.selectShapes(w,r));break;case "strokeDashes":var x=
r.trim().split(/\s+/);if(v&&r||n(b,u,x))g.strokeDashArray=0===x.length?[]:x.map(function(a){return parseInt(a,10)});break;case "strokeWidth":if(v&&r||!v&&n(b,u,x))g[u]=p(r);break;case "tags":v?r&&(g[u]='""'===r||"''"===r?"":p(r)):n(b,u,r)&&(g[u]=p(r));break;case "childtext":"text"!==b.type&&n(b,u,r)&&(g.text=q(p(r)));break;case "ix":n(b,u,r)&&(b.pub.preservedcoords&&"d"===r.charAt(0).toLowerCase()?(g.dx=p(r.substring(1)),void 0===g.dy&&void 0!==b.pub.dy&&(g.dy=b.pub.dy)):(g.x=p(r),void 0===g.y&&void 0!==
b.pub.y&&(g.y=b.pub.y)));break;case "iy":n(b,u,r)&&(b.pub.preservedcoords&&"d"===r.charAt(0).toLowerCase()?(g.dy=p(r.substring(1)),void 0===g.dx&&void 0!==b.pub.dx&&(g.dx=b.pub.dx)):(g.y=p(r),void 0===g.x&&void 0!==b.pub.x&&(g.x=b.pub.x)));break;case "px":n(b,u,r)&&(g.px=p(r),void 0===g.py&&b.pub.lcs&&(g.py=b.pub.lcs.y));break;case "py":n(b,u,r)&&(g.py=p(r),void 0===g.px&&b.pub.lcs&&(g.px=b.pub.lcs.x));break;case "ra":n(b,u,r)&&(g.ra=r,void 0===g.dec&&(b.pub.wcsconfig.wcsposstr?g.dec=b.pub.wcsconfig.wcsposstr[1]:
b.pub.wcsposstr&&(g.dec=b.pub.wcsposstr[1])));break;case "dec":n(b,u,r)&&(g.dec=r,void 0===g.ra&&(b.pub.wcsconfig.wcsposstr?g.ra=b.pub.wcsconfig.wcsposstr[0]:b.pub.wcsposstr&&(g.ra=b.pub.wcsposstr[0])),void 0===g.wcssys&&(g.wcssys=t));break;case "wcssys":break;case "radius":case "length":case "width":case "r1":switch(t){case "image":n(b,u,r)&&(g[u]=p(r));break;case "physical":n(b,u,r)&&(g[u]=p(r)*e);break;default:x=a.strtoscaled(r),r="."===x.dtype&&"galactic"!==t&&"ecliptic"!==t?x.dval:Math.abs(x.dval/
k.cdelt1),u=u.replace("wcs",""),n(b,u,r)&&(g[u]=p(r))}break;case "height":case "r2":switch(t){case "image":n(b,u,r)&&(g[u]=p(r));break;case "physical":n(b,u,r)&&(g[u]=p(r)*e);break;default:x=a.strtoscaled(r),r="."===x.dtype&&"galactic"!==t&&"ecliptic"!==t?x.dval:Math.abs(x.dval/k.cdelt2),u=u.replace("wcs",""),n(b,u,r)&&(g[u]=p(r))}break;case "radii":n(b,u,r)&&(g[u]=r);break;case "linelength":if(b.pub.pts&&2===b.pub.pts.length&&a.isNumber(r)&&r!==this.tmp.linelength){r=parseFloat(r);switch(t){case "image":case "physical":break;
default:void 0!==k.cdelt1?r/=Math.abs(k.cdelt1):void 0!==k.cdelt2&&(r/=Math.abs(k.cdelt2))}if(g.pts){u=g.pts[0];var y=g.pts[1]}else u=b.pub.pts[0],y=b.pub.pts[1];if(0<=$.inArray("line",a.Regions.opts.noCenteredScaling)){var B=Math.sqrt((u.x-y.x)*(u.x-y.x)+(u.y-y.y)*(u.y-y.y));var z=u.x-r*(u.x-y.x)/B;r=u.y-r*(u.y-y.y)/B;g.pts=[u,{x:z,y:r}]}else z={x:(u.x+y.x)/2,y:(u.y+y.y)/2},B=parseFloat(this.tmp.lineangle)||0,u.x=z.x-r/2,u.y=z.y,y.x=z.x+r/2,y.y=z.y,g.pts=[a.rotatePoint(u,B,z),a.rotatePoint(y,B,z)]}break;
case "lineangle":b.pub.pts&&2===b.pub.pts.length&&a.isNumber(r)&&r!==this.tmp.lineangle&&(B=parseFloat(r)-parseFloat(this.tmp.lineangle)||0,g.pts?(u=g.pts[0],y=g.pts[1]):(u=b.pub.pts[0],y=b.pub.pts[1]),0<=$.inArray("line",a.Regions.opts.noCenteredScaling)?g.pts=[u,a.rotatePoint(y,B,u)]:(z={x:(u.x+y.x)/2,y:(u.y+y.y)/2},g.pts=[a.rotatePoint(u,B,z),a.rotatePoint(y,B,z)]));break;case "remove":n(b,u,r)&&(v?g[u]="selected":void 0!==b.pub.id&&(g[u]=b.pub.id));break;case "misc":if(r.trim())try{var A=JSON.parse(r);
$.extend(g,A)}catch(C){a.error("invalid json: "+r)}break;default:n(b,u,r)&&(g[u]=p(r))}}0<Object.keys(g).length&&(v?this.changeShapes(w,"selected",g):this.changeShapes(w,b,g),this.initRegionsForm(b,{multi:v}))};a.Regions.pasteFromClipboard=function(c){var b,d=0,e=0;if(this){(b=a.CopyFromClipboard().trim())||a.error(a.CLIPBOARDERROR);if(b.match(/(annulus|box|circle|cross|ellipse|line|polygon|point|text) *\(/)){var f=a.globalOpts.regToClipboard;a.globalOpts.regToClipboard=!1;var h=this.addShapes("regions",
b,{rtn:"objs"});if(c){var g=h.length;for(c=0;c<g;c++)d+=h[c].pub.x,e+=h[c].pub.y;d/=g;e/=g;for(c=0;c<g;c++){var k=h[c].pub.x-d+this.ipos.x;var l=h[c].pub.y-e+this.ipos.y;this.changeShapes("regions",h[c].pub.id,{x:k,y:l})}}a.globalOpts.regToClipboard=f}else a.error(a.CLIPBOARDERROR2);return b}};a.Regions.listRegions=function(c,b,d){var e=this,f,h,g,k,l="";var m="none";var n=!1,p=[];var q={};var t=[],v=[],w=function(c,d){var f,g={},h=c.params,k=h.children,l=h.exports;for(f=0;f<l.length;f++){var m=l[f];
...
for(f=0;f<z;f++)if(A=p[f],q=A.obj,t=[],!A.sticky||!1!==b.sticky)if(!A.preservedcoords||b.includedcoords)if($.isArray(q.params.preservedcoords)){for(h=0;h<q.params.preservedcoords.length;h++){var C=q.params.preservedcoords[h];switch(C){case "pts":0>$.inArray("dx",t)&&t.push("dx");0>$.inArray("dy",t)&&t.push("dy");0>$.inArray("points",t)&&t.push("points");break;default:t.push(C)}}"none"!==m&&(l+="; ");"image"!==m&&(l+="image",l+="; ");l+=A.shape+"({";for(k=h=0;h<t.length;h++)if(C=t[h],"shape"!==C&&
...
C+A.imstr),!1!==b.includejson&&1===u%2&&0<Object.keys(q).length&&("line"===A.shape&&(l=l.replace(/ *{[^{}]*}$/,"")),l+=" "+JSON.stringify(q)),g&&(l+=g);!1===b.includecomments&&(l=l.replace(/ *#[^;]*/g,""));if(x||B)x&&this.setWCSSys(x,!1),B&&this.setWCSUnits(B,!1),this.updateShapes(d,c,"export"),a.globalOpts.xeqPlugins=r;1<u&&this.display.displayMessage("regions",l);return l}};a.Regions.copyRegions=function(a,b){return this.copyShapes("regions",a,b)};a.Regions.parseRegions=function(c,b){var d=this,
e,f,h=[],g=/^-?(annulus|box|circle|cross|ellipse|line|polygon|point|text)$/,k=/^(fk4|fk5|icrs|galactic|ecliptic|image|physical|linear)$/,l=/^(image|physical)$/,m=/[dr:]/,n=/\(\s*([^)]+?)\s*\)/,p=/(\{.*\})/,q=/\s*,\s*/,t=/#(?![a-zA-Z0-9]{6}['"])/,v=function(a){return"0"===a||"false"===a.toLowerCase()?!1:!0},w=function(a){for(var b,c,d,e={},f=/([a-zA-Z][a-zA-Z0-9_]*)\s*=\s*(\d+(\s*\d+)*|[^ '"{]+|['"{][^'"}]*['"}])/g,g={color:function(a){return{color:a}},dash:function(a){if(a)return{strokeDashArray:[3,
...
("tags"===d&&e.hasOwnProperty(d)?e[d]+=","+c[d]:e[d]=c[d]);else e[c]=b;if(a=a.replace(f,""))e._comment=a.trim();return e},u=function(b){var c,d={opts:{},args:[],isregion:0};b.includes("(")?d.cmd=b.split("(")[0].trim().toLowerCase():b.includes("{")?d.cmd=b.split("{")[0].trim().toLowerCase():b.includes("#")?d.cmd=b.split("#")[0].trim().toLowerCase():d.cmd=b.trim().toLowerCase();d.cmd&&(d.isregion=0<=d.cmd.search(g));var e=b.trim().split(t);if((c=p.exec(e[0]))&&c[0])try{d.opts=JSON.parse(c[0].trim())}catch(M){a.error("can't parse opts: "+
...
1));4<=D&&(F.height=x(E.args[3],2));5<=D&&(F.angle=a.strtoscaled(E.args[4]).dval);break;case "circle":3<=D&&(F.radius=x(E.args[2],1));break;case "ellipse":3<=D&&(F.r1=x(E.args[2],1));4<=D&&(F.r2=x(E.args[3],2));5<=D&&(F.angle=a.strtoscaled(E.args[4]).dval);break;case "line":case "polygon":if(0<D)for(F.pts=[],f=e=0;e<D;e+=2,f++){var G=r(E.args[e],E.args[e+1]);a.notNull(G.dx)&&a.notNull(G.dy)?F.pts[f]={dx:G.dx,dy:G.dy}:F.pts[f]={x:G.x,y:G.y}}break;case "text":3<=D&&(F.text=E.args[2].replace(/^['"]/,
...
l[3].ra=a.saostrtod(q[0]);l[3].dec=a.saostrtod(q[1]);g=l[0].ra;p=l[0].dec;b=l[0].ra;var t=l[0].dec;for(q=1;4>q;q++)g=Math.min(g,l[q].ra),p=Math.min(p,l[q].dec),b=Math.max(b,l[q].ra),t=Math.max(t,l[q].dec);q=a.Grid.limits.call(this,c,g,b,c.raLines*m[0]);g=q.lo;b=q.hi;l=q.inc;q=a.Grid.limits.call(this,c,p,t,c.decLines*m[1]);p=q.lo;t=q.hi;var v=q.inc;a.wcsunits(this.raw.wcs,c.wcsunits);var w=Math.abs(this.raw.wcsinfo.cdelt1);var u=w*a.Grid.opts.stride;var r=b-u;var x=Math.abs(this.raw.wcsinfo.cdelt2);
var y=x*a.Grid.opts.stride;var B=t-y;q="image;";for(f=g;f<=b;f+=l){var z="line(";var A=x;n=e=0;for(h=p;h<=t;h+=A)(d=a.wcs2pix(k.wcs,f,h).trim().split(/ +/))&&d.length&&(m=parseFloat(d[0]),d=parseFloat(d[1]),m>=-c.margin&&m<=k.width+c.margin&&d>=-c.margin&&d<=k.height+c.margin?(z+=String(m+1+","+d+1+", "),n++,0===e?(e=1,h<B&&(A=y)):1===e&&h>B&&(e=2,A=x)):1===e&&(e=2,h-=A,A=x));1<n&&(q+=z.replace(/,\s+$/,") "),q+=' {"color": "'+c.lineColor+'"};')}for(h=p;h<=t;h+=v){z="line(";A=w;n=e=0;for(f=g;f<=b;f+=
A)(d=a.wcs2pix(k.wcs,f,h).trim().split(/ +/))&&d.length&&(m=parseFloat(d[0]),d=parseFloat(d[1]),m>=-c.margin&&m<=k.width+c.margin&&d>=-c.margin&&d<=k.height+c.margin?(z+=String(m+1+","+d+1+", "),n++,0===e?(e=1,f<r&&(A=u)):1===e&&f>r&&(e=2,A=w)):1===e&&(e=2,f-=A,A=w));1<n&&(q+=z.replace(/,\s+$/,") "),q+=' {"color": "'+c.lineColor+'"};')}e=c.labelDecOffx/this.rgb.sect.zoom;A=c.labelDecOffy/this.rgb.sect.zoom;w=0;f=u=g;for(z=0;f<=b;f+=l){for(h=p;h<=t;h+=v)(d=a.wcs2pix(k.wcs,f,h).trim().split(/ +/))&&
...
b);d=d||a.Load;e.onload=function(a){var e,f,k,l=new Image;l.onload=function(){var a=0;var g=document.createElement("canvas");var h=g.getContext("2d");var q=l.height,t=l.width;g.width=t;g.height=q;h.drawImage(l,0,0);e=h.getImageData(0,0,t,q).data;f=new Float32Array(q*t);for(h=0;h<q;h++)for(g=0;g<t;g++){var v=.299*e[a]+.587*e[a+1]+.114*e[a+2];f[(q-h)*t+g]=v;a+=4}k={head:{SIMPLE:!0,BITPIX:-32,NAXIS:2,NAXIS1:t,NAXIS2:q},filename:c.name,filedata:f,naxis:2,axis:[0,t,q],bitpix:-32,bin:1,data:f};k.dmin=Number.MAX_VALUE;
k.dmax=Number.MIN_VALUE;for(a=0;a<q*t;a++)Number.isNaN(k.data[a])||(k.dmin=Math.min(k.dmin,k.data[a]),k.dmax=Math.max(k.dmax,k.data[a]));d(k,b)};l.src=a.target.result};e.readAsDataURL(c)};a.getFITSImage=function(c,b,d,e){a.fits.getFITSImage?a.fits.getFITSImage(c,b,d,e):a.error("no FITS module available to process FITS image")};a.fits2RepFile=function(c,b,d,e,f){var h,g={},k="fits2"+e;var l=d[k]||void 0===d[k]&&a.globalOpts[k];!0===l?l="always":!1===l&&(l="never");if(l.match(/never/i))return!1;if(!a.helper.connected||
...
"matchdiacritics").html("Match Diacritics").appendTo(k);p.on("click",function(){k.opts.matchdiacritics=!k.opts.matchdiacritics;e(p);d(l.val())});e(p);var q=$("<button>").addClass("JS9SearchButton JS9SearchButton-"+k.opts.matchwords).prop("data-btn","matchwords").html("Whole Words").appendTo(k);q.on("click",function(){k.opts.matchwords=!k.opts.matchwords;e(q);d(l.val())});e(q);var t=$("<button>").addClass("JS9SearchButton JS9SearchButton-"+k.opts.matchwildcards).prop("data-btn","matchwildcards").html("Wildcards").appendTo(k);
...
k,a.NewFitsImage)}catch(l){a.error("can't process FITS file",l)}},0)):a.fetchURL(h,e,b))}}else a.error("JS9.Load: no file specified for image load")});a.mkPublic("LoadWindow",function(c){for(var b=[],d=0;d<arguments.length;++d)b[d-0]=arguments[d];var e,f,h,g,k,l,m,n=a.lightOpts[a.LIGHTWIN];var p=a.parsePublicArgs(b);var q=function(b){b=$.inArray(b,a.displays);0<=b&&a.displays.splice(b,1)};var t=function(b,c,d){var f;c=c||{};c.clone&&(f=a.lookupDisplay(c.clone,!1));d&&(k=d.match(/(.*width=)([0-9]+)(px,height=)([0-9]+)(px.*)/,
...
1:0}switch(q){case 0:for(q=0;q<g;q++)if(l=q+1,l<g&&"object"===typeof b[l])f=$.extend(!0,{},b[l]),a.preloads.push([b[q],f,h]),q++;else if(l<g&&b[l].startsWith("{")){try{f=JSON.parse(b[l])}catch(v){f=null}a.preloads.push([b[q],f,h]);q++}else a.preloads.push([b[q],null,h]);break;case 1:a.globalOpts.alerts=!1;for(q=0;q<g;q++){var t=e&&b[q].match(m)&&!b[q].match(e)?a.LoadProxy:b[q].match(n)?a.LoadSession:b[q].match(p)?a.LoadColormap:a.Load;l=q+1;if(l<g&&"object"===typeof b[l]){t!==a.Load&&t!==a.LoadProxy||
a.preloadwaiting.push({id:a.cleanPath(b[q]),loaded:!1});try{h?t(b[q],b[l],h):t(b[q],b[l])}catch(v){d=d+" "+b[q]}q++}else if(l<g&&b[l].startsWith("{")){try{f=JSON.parse(b[l])}catch(v){f=null}t!==a.Load&&t!==a.LoadProxy||a.preloadwaiting.push({id:a.cleanPath(b[q]),loaded:!1});try{h?t(b[q],f,h):t(b[q],f)}catch(v){d=d+" "+b[q]}q++}else{t!==a.Load&&t!==a.LoadProxy||a.preloadwaiting.push({id:a.cleanPath(b[q]),loaded:!1});try{h?t(b[q],null,h):t(b[q],null)}catch(v){d=d+" "+b[q]}}}a.globalOpts.alerts=k;d&&
a.error("could not preload image(s): "+d);break;case 2:a.globalOpts.alerts=!1;for(q=0;q<a.preloads.length;q++){t=e&&a.preloads[q][0].match(m)&&!a.preloads[q][0].match(e)?a.LoadProxy:a.preloads[q][0].match(n)?a.LoadSession:a.preloads[q][0].match(p)?a.LoadColormap:a.Load;t!==a.Load&&t!==a.LoadProxy||a.preloadwaiting.push({id:a.cleanPath(a.cleanPath(a.preloads[q][0])),loaded:!1});try{a.preloads[q][2]?t(a.preloads[q][0],a.preloads[q][1],a.preloads[q][2]):t(a.preloads[q][0],a.preloads[q][1])}catch(v){d=
