...
m:"pan to mouse position","M-m":"toggle mouse/touch plugin","M-o":"open local file",P:"paste regions from local clipboard",p:"paste regions to current position","M-,":"toggle preferences plugin","M-p":"toggle preferences plugin",r:"copy region(s) to clipboard",s:"select region",S:"select all regions","M-s":"toggle shape layers plugin",u:"undo remove of region(s)",x:"flip image around x axis",y:"flip image around y axis",9:"rotate image by 90 degrees","/":"copy wcs position to clipboard","?":"copy value and position to clipboard",
0:"reset zoom","=":"zoom in","+":"zoom in","-":"zoom out","^":"raise region layer to top",">":"display next image","<":"display previous image","delete":"remove selected region",leftArrow:"move region/position left",upArrow:"move region/position up",rightArrow:"move region/position right",downArrow:"move region/position down"},mousetouchZoom:!1,metaClickPan:!0,statusBar:"$colorbar; $colormap; $mag; $scale ($scalemin,$scalemax); $wcssys; $image0",toolbarTooltips:!1,updateTitlebar:!0,centerDivs:["JS9Menubar"],
resizeDivs:["JS9Menubar","JS9Colorbar","JS9Toolbar","JS9Statusbar"],pinchWait:8,pinchThresh:6,xeqPlugins:!0,extendedPlugins:!0,intensivePlugins:!1,dynamicSelect:"click",dynamicHighlight:!0,corsProxy:"https://js9.si.edu/cgi-bin/CORS-proxy.cgi",simbadProxy:"https://js9.si.edu/cgi-bin/simbad-proxy.cgi",catalogs:{ras:["RA","_RAJ2000","RAJ2000"],decs:["Dec","_DEJ2000","DEJ2000"],shape:"circle",color:"yellow",width:7,height:7,radius:3.5,r1:5,r2:3.5,wcssys:"ICRS",skip:"#\n",save:!0,tooltip:"$data.ra $data.dec"},
topColormaps:"grey heat cool turbo viridis magma sls red green blue".split(" "),infoBox:"file object wcsfov wcscen wcspos impos physpos value regions progress".split(" "),infoBoxResize:!0,menuBar:"file edit view zoom scale color region wcs analysis help".split(" "),menubarStyle:"classic",menuPosition:"right-5 bottom-5",menuClickEvent:"mouseup",menuSelected:"check",menuImages:!0,userMenus:!1,userMenuDivider:"&nbsp;&nbsp;&nbsp;",imagesFileSubmenu:5,toolBar:"annulus box circle ellipse line polygon text zoom+ zoom- zoom1 zoomtofit".split(" "),
...
2048,a.globalOpts.image.xdim=2048,a.globalOpts.image.ydim=2048,a.imageOpts.crosshair=!1,a.globalOpts.reproj={xdim:2048,ydim:2048},a.lightOpts.dhtml.regWin0="width=660px,height=130px,resize=1,scrolling=1",a.lightOpts.dhtml.regWin1="width=660px,height=200px,resize=1,scrolling=1",a.lightOpts.dhtml.regWin="width=660px,height=470px,resize=1,scrolling=1");window.hasOwnProperty("Jupyter")&&(a.globalOpts.useWasm=!1);if(window.electron&&("Chrome"===a.BROWSER[0]&&66<=parseFloat(a.BROWSER[1])&&(a.globalOpts.allowFileWasm=
!0),window.electron.hostFS&&(a.hostFS=window.electron.hostFS),window.electron.multiElectron&&(a.globalOpts.localStorage=!1),window&&"function"===typeof window.eval&&(window.eval=function(){throw Error("For security reasons, Desktop JS9 does not support window.eval()");}),window.electron.cmdlineOpts))try{a.cmdlineOpts=JSON.parse(window.electron.cmdlineOpts)}catch(c){delete a.cmdlineOpts}a.Image=function(c,b,d){var e=this,f=null,h=0,g=0,k=function(b){b=b||{};a.isNull(b.scaleclipping)?"zscale"===e.params.scaleclipping?
...
for(c=0;c<b;c++){switch(e){case 0:var p=l[h];h+=1;e=1;break;case 1:p=l[h];h+=1;e=2;break;case 2:p=l[h];h+=2;e=0;break;case 3:p=l[h+1],h+=2,e=1}this.raw.data[c]=p}break;case 16:case -16:16===this.raw.bitpix?(this.raw.data=new Int16Array(b),n=DataView.prototype.getInt16):(this.raw.data=new Uint16Array(b),n=DataView.prototype.getUint16);for(c=0;c<b;c++){switch(e){case 0:g[0]=l[h];g[1]=l[h+1];p=n.call(k,0,d);h+=2;e=2;break;case 1:g[0]=l[h];g[1]=l[h+1];p=n.call(k,0,d);h+=3;e=0;break;case 2:g[0]=l[h];g[1]=
l[h+2];p=n.call(k,0,d);h+=3;e=1;break;case 3:g[0]=l[h+1],g[1]=l[h+2],p=n.call(k,0,d),h+=3,e=2}this.raw.data[c]=p}break;case 32:case -32:32===this.raw.bitpix?(this.raw.data=new Int32Array(b),n=DataView.prototype.getInt32):(this.raw.data=new Float32Array(b),n=DataView.prototype.getFloat32);for(c=0;c<b;c++){switch(e){case 0:g[0]=l[h];g[1]=l[h+1];g[2]=l[h+2];g[3]=l[h+4];p=n.call(k,0,d);h+=5;e=1;break;case 1:g[0]=l[h];g[1]=l[h+1];g[2]=l[h+3];g[3]=l[h+4];p=n.call(k,0,d);h+=5;e=2;break;case 2:g[0]=l[h];
g[1]=l[h+2];g[2]=l[h+3];g[3]=l[h+4];p=n.call(k,0,d);h+=6;e=0;break;case 3:g[0]=l[h+1],g[1]=l[h+2],g[2]=l[h+3],g[3]=l[h+5],p=n.call(k,0,d),h+=6,e=1}this.raw.data[c]=p}break;case -64:this.raw.data=new Float64Array(b);for(c=0;c<b;c++){switch(e){case 0:case 4:g[0]=l[h];g[1]=l[h+1];g[2]=l[h+2];g[3]=l[h+4];g[4]=l[h+5];g[5]=l[h+6];g[6]=l[h+8];g[7]=l[h+9];p=k.getFloat64(0,d);h+=10;e=2;break;case 1:case 5:g[0]=l[h];g[1]=l[h+1];g[2]=l[h+3];g[3]=l[h+4];g[4]=l[h+5];g[5]=l[h+7];g[6]=l[h+8];g[7]=l[h+9];p=k.getFloat64(0,
d);h+=11;e=0;break;case 2:case 6:g[0]=l[h];g[1]=l[h+2];g[2]=l[h+3];g[3]=l[h+4];g[4]=l[h+6];g[5]=l[h+7];g[6]=l[h+8];g[7]=l[h+10];p=k.getFloat64(0,d);h+=11;e=1;break;case 3:case 7:g[0]=l[h+1],g[1]=l[h+2],g[2]=l[h+3],g[3]=l[h+5],g[4]=l[h+6],g[5]=l[h+7],g[6]=l[h+9],g[7]=l[h+10],p=k.getFloat64(0,d),h+=11,e=2}this.raw.data[c]=p}break;default:a.error("unsupported bitpix in PNG file: "+this.raw.bitpix)}this.dataminmax();this.offscreen.img=null;this.initWCS();this.initLCS();this.xeqPlugins("image","onrawdata");
return this}};a.Image.prototype.mkRawDataFromHDU=function(c,b){var d=this,e,f,h,g;var k=g=0;b=b||{};if($.isArray(c)||a.isTypedArray(c)||c instanceof ArrayBuffer){$.isArray(c[0])&&(c=c.reduce(function(a,b){return a.concat(b)}));var l={image:c}}else"object"===typeof c?l=c:a.error("unknown or missing input for HDU creation");l.data&&!l.image&&(l.image=l.data);l.image||a.error("data missing from JS9 FITS object: "+JSON.stringify(l));2>l.naxis&&a.error("can't image a FITS file with less than 2 dimensions");
...
k=a.defNull(l.y1,1),f=l.bin||1,0>f&&(f=1/Math.abs(f)),a.notNull(e.NAXIS1)&&(e.NAXIS1/=f),a.notNull(e.NAXIS2)&&(e.NAXIS2/=f),a.notNull(e.CRPIX1)&&(e.CRPIX1=(e.CRPIX1+1-g-.5)/f+.5),a.notNull(e.CRPIX2)&&(e.CRPIX2=(e.CRPIX2+1-k-.5)/f+.5),a.notNull(e.CDELT1)&&(e.CDELT1*=f),a.notNull(e.CDELT2)&&(e.CDELT2*=f),a.notNull(e.CD1_1)&&(e.CD1_1*=f),a.notNull(e.CD1_2)&&(e.CD1_2*=f),a.notNull(e.CD2_1)&&(e.CD2_1*=f),a.notNull(e.CD2_2)&&(e.CD2_2*=f),e.LTM1_1=a.defNull(e.LTM1_1,1),e.LTM1_1/=f,e.LTM2_1=e.LTM2_1||0,e.LTM2_1/=
f,e.LTM1_2=e.LTM1_2||0,e.LTM1_2/=f,e.LTM2_2=a.defNull(e.LTM2_2,1),e.LTM2_2/=f,e.LTV1=e.LTV1||0,e.LTV1=(e.LTV1-g)/f+.5,e.LTV2=e.LTV2||0,e.LTV2=(e.LTV2-k)/f+.5;b.lcsUseRota2&&(e.LCSROTA2=!0);b.file&&b.file!==this.file?(this.file=b.file,this.id=null):b.filename&&b.filename!==this.file?(this.file=b.filename,this.id=null):l.filename&&l.filename!==this.file&&(this.file=l.filename,this.id=null);this.file0=this.file=a.cleanPath(this.file)||a.ANON+a.uniqueID();b.id&&(this.id0=b.id,this.id=a.getImageID(b.id,
this.display.id,this));this.id||!this.file||this.file.match(/\[.*[^a-zA-Z0-9_].*\]/)||(b.extname||b.extnum?(b.extname?(this.file=this.file.replace(/\[.*\]/,""),this.file+="["+b.extname+"]"):b.extnum&&0<b.extnum&&(this.file=this.file.replace(/\[.*\]/,""),this.file+="["+b.extnum+"]"),l&&l.fits&&(b.extname&&(l.fits.extname=b.extname),b.extnum&&0<b.extnum&&(l.fits.extnum=b.extnum))):l.fits?l.fits.extname?(this.file=this.file.replace(/\[.*\]/,""),this.file+="["+l.fits.extname+"]"):l.fits.extnum&&0<l.fits.extnum&&
...
l.dmax?this.dataminmax(l.dmin,l.dmax):this.dataminmax();this.object=this.raw.header.OBJECT;this.telescope=this.raw.header.TELESCOP;this.instrument=this.raw.header.INSTRUME;if(b.binstr)try{(w=b.binstr.split(/\s+/))&&2===w.length&&("table"===this.imtab&&l.table?(l.table.bin=parseFloat(w[0]),l.table.binMode=w[1]):(l.bin=parseFloat(w[0]),l.binMode=w[1]))}catch(t){}this.binning.bin="table"===this.imtab&&l.table?l.table.bin||1:l.bin?0<l.bin?l.bin:1/Math.abs(l.bin):1;m||(this.binning.obin=this.binning.bin);
this.initWCS();r&&this.setWCSSys(r);v&&this.setWCSUnits(v);this.initLCS();try{if(b.hdus)this.hdus=b.hdus;else if(this.parentFile&&a.helper.connected&&a.helper.js9helper)c={id:this.expandMacro("$id"),cmd:this.expandMacro("js9Xeq listhdus $filename"),image:this.file,fits:this.parentFile,rtype:"text"},a.helper.send("listhdus",c,function(a){if(!a.stderr&&!a.errcode&&a.stdout)try{d.hdus=JSON.parse(a.stdout)}catch(u){d.hdus=null}});else if(this.raw&&this.raw.hdu&&this.raw.hdu.fits&&(w=a.listhdu(this.raw.hdu.fits.vfile)))try{this.hdus=
JSON.parse(w)}catch(t){this.hdus=null}}catch(t){}if(this.raw.hdu.fits&&this.raw.hdu.fits.vfile){w=a.globalOpts.clearImageMemory;w=!1===w?["never"]:!0===w?["always"]:w.toLowerCase().split(/[,>]/);m=c=!1;e=0;for(b=!1;e<w.length&&!b;e++)switch(w[e]){case "never":c=!1;b=!0;break;case "always":b=c=!0;break;case "heap":m=!0;break;case "auto":2>=this.raw.header.NAXIS&&(!this.hdus||1===this.hdus.length)?c=!0:(c=!1,b=!0);break;case "nocube":2>=this.raw.header.NAXIS?c=!0:(c=!1,b=!0);break;case "noext":this.hdus&&
1!==this.hdus.length?(c=!1,b=!0):c=!0;break;case "size":w[e+1]?a.vsize(l.fits.vfile)>1E6*w[e+1]?c=!0:(c=!1,b=!0):(c=!1,b=!0)}c?(2<a.DEBUG&&a.log("removing underlying FITS vfile for %s: %s",this.id,this.raw.hdu.fits.vfile),a.cleanupFITSFile(this.raw,!0)):m&&(2<a.DEBUG&&a.log("freeing heap space for %s: %s",this.id,this.raw.hdu.fits.vfile),a.cleanupFITSFile(this.raw,!1))}this.xeqPlugins("image","onrawdata");return this};a.Image.prototype.mkSection=function(c){for(var b=[],d=0;d<arguments.length;++d)b[d-
...
if(1E-4>b-.5&&1E-4>e-1)return c;this.params.invert&&(b=1-b);c=Math.floor(((c/d-b)*e+.5)*d);return 0>c?0:c>=d?d-1:c};a.Image.prototype.mkColorCells=function(){var c,b=a.COLORSIZE;if("static"===this.cmapObj.type)return this;this.colorCells||(this.colorCells=[]);for(c=0;c<b;c++){var d=this.params.invert?b-c-1:c;d=this.calcContrastBias(d);this.colorCells[c]=this.cmapObj.mkColorCell(d)}return this};a.Image.prototype.mkScaledCells=function(){var c,b;var d=a.COLORSIZE;var e=a.SCALESIZE,f=a.INVSIZE;var h=
a.HISTSIZE;if(!this.colorCells||"static"===this.cmapObj.type)return this;if(!this.psColors){var g=this.psColors=[];var k=this.params.nancolor;var l=[];"#"===k.charAt(0)&&(k=k.slice(1));k=k.toUpperCase();for(c=b=0;6>b;b+=2,c++){var m="0123456789ABCDEF".indexOf(k.charAt(b));var n="0123456789ABCDEF".indexOf(k.charAt(b+1));l[c]=16*m+n}g[NaN]=l}this.psInverse||(this.psInverse=[],this.psInverse[NaN]=0);k=this.params.scalemax-this.params.scalemin;b=this.params.scalemin;switch(this.params.scale){case "linear":for(g=
0;g<e;g++)c=g/e,c=Math.floor(c*d),this.psColors[g]=this.colorCells[c];for(g=0;g<f;g++)c=g/f,this.psInverse[g]=c*k+b;break;case "log":h=this.params.exp;for(g=0;g<e;g++)c=Math.log(h*g/e+1)/Math.log(h),c=Math.floor(c*d),c>=d&&(c=d-1),this.psColors[g]=this.colorCells[c];for(g=0;g<f;g++)c=(Math.pow(h,g/f)-1)/h,this.psInverse[g]=c*k+b;break;case "power":h=this.params.exp;for(g=0;g<e;g++)c=(Math.pow(h,g/e)-1)/h,c=Math.floor(c*d),c>=d&&(c=d-1),this.psColors[g]=this.colorCells[c];for(g=0;g<f;g++)c=Math.log(h*
g/f+1)/Math.log(h),this.psInverse[g]=c*k+b;break;case "sqrt":for(g=0;g<e;g++)c=g/e,c=Math.floor(Math.sqrt(c)*d),c>=d&&(c=d-1),this.psColors[g]=this.colorCells[c];for(g=0;g<f;g++)c=g/f,this.psInverse[g]=c*c*k+b;break;case "squared":for(g=0;g<e;g++)c=g/e,c=Math.floor(c*c*d),c>=d&&(c=d-1),this.psColors[g]=this.colorCells[c];for(g=0;g<f;g++)c=Math.sqrt(g/f),this.psInverse[g]=c*k+b;break;case "asinh":for(g=0;g<e;g++)c=g/e,c=Math.floor(Math.asinh(10*c)/3*d),c>=d&&(c=d-1),this.psColors[g]=this.colorCells[c];
for(g=0;g<f;g++)c=g/f,c=Math.sinh(3*c)/10,this.psInverse[g]=c*k+b;break;case "sinh":for(g=0;g<e;g++)c=g/e,c=Math.floor(Math.sinh(3*c)/10*d),c>=d&&(c=d-1),this.psColors[g]=this.colorCells[c];for(g=0;g<f;g++)c=g/f,c=Math.asinh(10*c)/3,this.psInverse[g]=c*k+b;break;case "histeq":l=this.raw.data;var p=this.raw.width*this.raw.height;k=this.raw.dmax-this.raw.dmin;var q=this.raw.dmax;b=this.raw.dmin;var r=c=0;m=[];if(!this.hist||!this.hist.length){this.hist=[];for(g=0;g<h;g++)m[g]=0;for(g=0;g<p;g++)l[g]>=
b&&l[g]<=q&&(n=Math.floor((l[g]-b)/k*h+.5),n<h&&(m[n]+=1));for(g=0;g<h;g++)r+=m[g];n=r/h;for(g=l=0;g<h&&l<h;g++)for(this.hist[g]=l/h,c+=m[g];c>=n&&l<h;)c-=n,l++;for(c=(h-1)/h;g<h;)this.hist[g++]=c}for(g=0;g<e;g++)c=this.hist[g*h/e],c=Math.floor(c*d),this.psColors[g]=this.colorCells[c];for(g=0;g<f;g++){d=g/f;for(n=0;n<h-1&&!(this.hist[n]>d);n++);c=n/h;this.psInverse[g]=c*k+b}break;default:a.error("unknown scale '"+this.params.scale+"'")}return this};a.Image.prototype.mkRGBImage=function(){var c,b,
d,e,f=!1,h=null,g=null,k=null,l=!1,m=!1,n=!1,p=!1,q=[];if(!this.rgb)return this;!this.display.rgb.active||this!==this.display.rgb.rim&&this!==this.display.rgb.gim&&this!==this.display.rgb.bim||(l=!0,this.display.rgb.rim&&(h=this.display.rgb.rim),this.display.rgb.gim&&(g=this.display.rgb.gim),this.display.rgb.bim&&(k=this.display.rgb.bim));var r=this.display.context;var v=this.rgb;var w=v.sect;if(this.MakeRGBImage&&"function"===typeof this.MakeRGBImage&&this.MakeRGBImage()||this.MakePrimaryImage&&
"function"===typeof this.MakePrimaryImage&&this.MakePrimaryImage())return this;if(this.rgbFile){var t=w.width/w.zoom;var u=w.height/w.zoom;var y=w.x0;var x=this.offscreen.canvas.height-1-(w.y0+u);x=this.offscreen.context.getImageData(y,x,t,u);if(1===w.zoom)v.img=x;else for(v.img=r.createImageData(w.width,w.height),v=v.img,d=c=0;c<x.height;c++,d++){var B=c*x.width;var z=d*w.zoom;for(b=r=0;r<x.width;r++,b++){y=4*(B+r);var A=b*w.zoom;for(e=0;e<w.zoom;e++){var C=Math.floor(z+e);var E=C*w.width;for(C=
0;C<w.zoom;C++){var D=Math.floor(A+C);D=4*(E+D);v.data[D]=x.data[y];v.data[D+1]=x.data[y+1];v.data[D+2]=x.data[y+2];v.data[D+3]=x.data[y+3]}}}}return this}v.img&&v.img.width===w.width&&v.img.height===w.height||(v.img=r.createImageData(w.width,w.height));v=v.img;var F=v.data.length-4;if(!this.psColors&&!this.staticObj)return this;var G=void 0!==this.params.opacity?Math.floor(255*this.params.opacity):void 0!==this.params.alpha?this.params.alpha:255;if(this.mask.active&&this.mask.im){var J=this.mask.im;
if("mask"===this.mask.mode){m=!0;var I=a.notNull(this.mask.vopacity)?255*this.mask.vopacity:0;var K=a.notNull(this.params.opacity)?255*this.params.opacity:255;this.mask.invert&&(G=I,I=K,K=G)}else if("opacity"===this.mask.mode)n=!0;else if("overlay"===this.mask.mode){p=!0;var L=J.rgb.img;a.isNull(this.mask.opacity)&&(this.mask.opacity=1)}}else if(a.notNull(this.params.flooropacity)&&!l){var R=255*this.params.flooropacity;var M=this.params.floorvalue;f=!0}var N=Math.max(1,Math.floor(1/w.zoom));var P=
w.zoom*N;c=Math.floor(w.y1-1);for(d=0;c>=w.y0;c-=N,d++)for(B=c*this.raw.width,z=d*P,r=Math.floor(w.x0),b=0;r<w.x1;r+=N,b++){m?G=J.raw.data[B+r]>this.mask.value?K:I:n&&(G=255*J.raw.data[B+r]);if(l){if(x=h?h.colorData[B+r]:0,t=g?g.colorData[B+r]:0,u=k?k.colorData[B+r]:0,a.isNull(x)||a.isNull(t)||a.isNull(u))return this.display.rgb.active=!1,a.error("RGB images are incompatible. Turning off RGB mode.","",!1),this.mkRGBImage(),this}else this.staticObj||(y=this.colorData[B+r]);var Q=G;f&&this.raw.data[B+
r]<=M&&(Q=R);A=b*P;for(e=0;e<w.zoom;e++)for(C=Math.ceil(z+e),E=C*w.width,C=0;C<w.zoom;C++)if(D=Math.ceil(A+C),D=4*(E+D),D<=F)if(l)v.data[D]=h?h.psColors[x][0]:0,v.data[D+1]=g?g.psColors[t][1]:0,v.data[D+2]=k?k.psColors[u][2]:0,v.data[D+3]=G;else if(this.staticObj){var H=this.raw.data[B+r];H=a.lookupStaticColor(this,H,q);v.data[D]=H.red;v.data[D+1]=H.green;v.data[D+2]=H.blue;v.data[D+3]=H.alpha}else if(void 0!==this.psColors[y])if(p&&L.data[D+3]){H=L.data[D+3]/255*this.mask.opacity;var O=1-H;v.data[D]=
L.data[D]*H+this.psColors[y][0]*O;v.data[D+1]=L.data[D+1]*H+this.psColors[y][1]*O;v.data[D+2]=L.data[D+2]*H+this.psColors[y][2]*O;v.data[D+3]=255}else v.data[D]=this.psColors[y][0],v.data[D+1]=this.psColors[y][1],v.data[D+2]=this.psColors[y][2],v.data[D+3]=Q}return this};a.Image.prototype.blendImage=function(c){for(var b=[],d=0;d<arguments.length;++d)b[d-0]=arguments[d];var e=$jscomp.makeIterator(b);d=e.next().value;var f=e.next().value;e=e.next().value;var h=/normal|multiply|screen|overlay|darken|lighten|color-dodge|color-burn|hard-light|soft-light|difference|exclusion|hue|saturation|color|luminosity|clear|copy|source-over|destination-over|source-in|destination-in|source-out|destination-out|source-atop|destination-atop|xor|lighter/i;
...
a.notNull(e)&&("true"===e?e=!0:"false"===e&&(e=!1),this.blend.active=e),this.xeqPlugins("image","onimageblend"),this.display.blendMode&&this.blend.active&&this.displayImage();return this};a.Image.prototype.maskImage=function(c){for(var b=[],d=0;d<arguments.length;++d)b[d-0]=arguments[d];var e=$jscomp.makeIterator(b);d=e.next().value;e=e.next().value;var f,h;if(!b.length)return this.mask;if(!0===d||!1===d||"true"===d||"false"===d)return"true"===d?d=!0:"false"===d&&(d=!1),this.mask.active=d,this.xeqPlugins("image",
...
43;v=0;w=$("#"+c);t=$("#"+c+"Menubar");0<t.length&&(t.isactive="visible"===t.closest(".JS9PluginContainer").css("visibility"));u=$("#"+c+"Toolbar");0<u.length&&(u.isactive="visible"===u.closest(".JS9PluginContainer").css("visibility"));y=$("#"+c+"Statusbar");0<y.length&&(y.isactive="visible"===y.closest(".JS9PluginContainer").css("visibility"));x=$("#"+c+"Colorbar");0<x.length&&!y.length&&(x.isactive="visible"===x.closest(".JS9PluginContainer").css("visibility"));0<w.length&&(B=w.width(),z=w.height(),
A=w.offset().top-$(window).scrollTop()-5,C=w.offset().left-$(document).scrollLeft(),t.isactive&&(z+=t.height(),A-=t.height()),u.isactive&&(z+=u.height(),A-=u.height()),y.isactive?(z+=y.height(),A-=y.height()):x.isactive&&(z+=x.height(),A-=x.height(),A+=7))},J=function(a,b){if(a){if(0<w.length){var c="";t.isactive&&(c+=sprintf("<div class='JS9Menubar' id='%sMenubar' data-width=%s></div>",b,w.width()));u.isactive&&(c+=sprintf("<div class='JS9Toolbar' id='%sToolbar' data-width=%s></div>",b,w.width()));
...
f.raw.hdu.fits.vfile||a.error("no virtual file available for mosaic: "+f.id);a.waiting(!0,this);k.setStatus("createMosaic","processing");window.setTimeout(function(){var d=a.uniqueID();var f=function(a){return"mosaic_"+d+"_"+a};var k=f("in.lst");var w=f("in.tbl");var t=f("in.hdr");var u=f("bin.lst");var y=f("bin.tbl");var x=f("out.lst");var B=f("out.tbl");var z=f("out.hdr");f=c[0].id.replace(/\[.*\]/,"").replace(/\.fz$/i,"").replace(/\.gz$/i,"").replace(/\.fits$/i,"_mosaic.fits");var A=f.replace(/\.fits$/,
"_area.fits");g=[k,w,t,u,y,x,B,z,A];A="|                                                    fname|\n|                                                     char|\n";for(e=0;e<c.length;e++)A+=c[e].raw.hdu.fits.vfile+"\n";a.vfile(k,A);k=a.imgtbl(k,".",w,"-C");m("mImgtbl",k);a.vsize(w)||a.error("no image data found with which to construct a mosaic");k=a.makehdr(w,t,"");m("mMakeHdr",k);if("js9"===b.reduce){A=a.vread(t).split("\n");for(e=t=0;e<A.length;e++)switch(k=A[e].split("="),k[0].trim()){case "NAXIS1":t=
Math.max(t,parseFloat(k[1].trim()));break;case "NAXIS2":t=Math.max(t,parseFloat(k[1].trim()))}h=Math.max(1,Math.floor(t/b.dim+.5));A="|                                                    fname|\n|                                                     char|\n";w=a.vread(w);w=w.trim().split("\n");w.splice(0,3);for(e=0;e<w.length;e++)if(k=w[e].trim().split(/\s+/),t=k[k.length-2],k=k[k.length-1],t&&k){var C=k+"["+t+"]";var E=k.split("/").reverse()[0].replace(/\.(g|f)z$/,"");t="bin_"+t+"_"+E;g.push(t);k=
"0@0,0@0,"+h;p("bin %s [%s]",C,h);a.imsection(C,t,k,"");A+=t+"\n"}a.vfile(u,A);k=a.imgtbl(u,".",y,"-C");m("mImgtbl",k);a.vsize(y)||a.error("no image data found to construct a mosaic");k=a.makehdr(y,z,"");m("mMakeHdr",k);w=a.vread(y)}else k=a.shrinkhdr(b.dim,t,z),m("mShrinkHdr",k),w=a.vread(w);w=w.trim().split("\n");w.splice(0,3);A="|                                                    fname|\n|                                                     char|\n";for(e=0;e<w.length;e++)k=w[e].trim().split(/\s+/),
t=k[k.length-2],k=k[k.length-1],t&&k&&(u="-a 1","shrink"===b.reduce&&(u+=" -h "+t),u+=" "+a.globalOpts.reprojSwitches,E=k.split("/").reverse()[0].replace(/\.(g|f)z$/,""),y="reproj_"+t+"_"+E,A+=y+"\n",g.push(y),g.push(y.replace(/\.fits$/i,"_area.fits")),p("reproject: %s [%s] -> %s",k,t,y),k=a.reproject(k,y,z,u),m("mProjectPP",k));a.vfile(x,A);k=a.imgtbl(x,".",B,"");m("mImgtbl",k);a.vsize(B)||a.error("no FITS files were added to output table for mosaic");p("create mosaic: %s",f);k=a.madd(B,z,f,"");
m("mAdd",k);l();x=$.extend(!0,{},a.fits.options,b);x.image={xdim:0,ydim:0};x.file=f;a.fits.handleFITSFile(f,x,n)},a.SPINOUT);return this};a.Display.prototype.moveImageInStack=function(c,b){var d,e,f,h;for(e=d=0;d<a.images.length;d++)if(a.images[d].display.id===this.id&&(c===e&&(f=d),b===e&&(h=d),e++),a.notNull(f)&&a.notNull(h)){a.images.splice(h,0,a.images.splice(f,1)[0]);break}};a.Command=function(c){for(var b in c)c.hasOwnProperty(b)&&(this[b]=c[b]);c.name||a.error("command has no name");c.get||
