...
d/r,a=Math.sinh(3*a)/10,this.psInverse[d]=a*c+g;break;case "sinh":for(d=0;d<t;d++)a=d/t,a=Math.floor(Math.sinh(3*a)/10*h),a>=h&&(a=h-1),this.psColors[d]=this.colorCells[a];for(d=0;d<r;d++)a=d/r,a=Math.asinh(10*a)/3,this.psInverse[d]=a*c+g;break;case "histeq":k=this.raw.data;l=this.raw.width*this.raw.height;c=this.raw.dmax-this.raw.dmin;m=this.raw.dmax;g=this.raw.dmin;n=a=0;q=[];if(!this.hist||!this.hist.length){this.hist=[];for(d=0;d<f;d++)q[d]=0;for(d=0;d<l;d++)k[d]>=g&&k[d]<=m&&(e=Math.floor((k[d]-
g)/c*f+.5),e<f&&(q[e]+=1));for(d=0;d<f;d++)n+=q[d];e=n/f;for(d=k=0;d<f&&k<f;d++)for(this.hist[d]=k/f,a+=q[d];a>=e&&k<f;)a-=e,k++;for(a=(f-1)/f;d<f;)this.hist[d++]=a}for(d=0;d<t;d++)a=this.hist[d*f/t],a=Math.floor(a*h),this.psColors[d]=this.colorCells[a];for(d=0;d<r;d++){h=d/r;for(e=0;e<f-1&&!(this.hist[e]>h);e++);a=e/f;this.psInverse[d]=a*c+g}break;default:b.log("unknown scale '"+this.params.scale+"'")}return this};b.Image.prototype.mkRGBImage=function(){var a,c,d,e,f,g,h,k,l,n,m,q,t,r,u,p,x,w,y,
v,A,B,C=null,D=null,z=null,E=!1;if(!this.rgb)return this;!b.globalOpts.rgb.active||this!==b.globalOpts.rgb.rim&&this!==b.globalOpts.rgb.gim&&this!==b.globalOpts.rgb.bim||(E=!0,b.globalOpts.rgb.rim&&(C=b.globalOpts.rgb.rim),b.globalOpts.rgb.gim&&(D=b.globalOpts.rgb.gim),b.globalOpts.rgb.bim&&(z=b.globalOpts.rgb.bim));h=this.display.context;a=this.rgb;c=a.sect;if(this.MakeRGBImage&&"function"===typeof this.MakeRGBImage&&this.MakeRGBImage()||this.MakePrimaryImage&&"function"===typeof this.MakePrimaryImage&&
this.MakePrimaryImage())return this;if(this.rgbFile){f=c.width/c.zoom;g=c.height/c.zoom;d=c.x0;e=this.offscreen.canvas.height-1-(c.y0+g);e=this.offscreen.context.getImageData(d,e,f,g);if(1===c.zoom)a.img=e;else for(a.img=h.createImageData(c.width,c.height),a=a.img,q=n=0;n<e.height;n++,q++)for(w=n*e.width,r=q*c.zoom,m=h=0;h<e.width;h++,m++)for(d=4*(w+h),t=m*c.zoom,u=0;u<c.zoom;u++)for(p=Math.floor(r+u),y=p*c.width,p=0;p<c.zoom;p++)x=Math.floor(t+p),x=4*(y+x),a.data[x]=e.data[d],a.data[x+1]=e.data[d+
1],a.data[x+2]=e.data[d+2],a.data[x+3]=e.data[d+3];return this}a.img&&a.img.width===c.width&&a.img.height===c.height||(a.img=h.createImageData(c.width,c.height));a=a.img;if(!this.psColors)return this;v=void 0!==this.params.opacity?255*this.params.opacity:void 0!==this.params.alpha?this.params.alpha:255;this.maskData&&(this.params.maskInvert?void 0!==this.params.opacity&&void 0!==this.params.maskOpacity?(e=255*this.params.opacity,f=255*this.params.maskOpacity):void 0!==this.params.alpha1&&void 0!==
this.params.alpha2?(e=this.params.alpha2,f=this.params.alpha1):(e=0,f=255):void 0!==this.params.opacity&&void 0!==this.params.maskOpacity?(e=255*this.params.maskOpacity,f=255*this.params.opacity):void 0!==this.params.alpha1&&void 0!==this.params.alpha2?(e=this.params.alpha1,f=this.params.alpha2):(e=255,f=0));k=Math.max(1,Math.floor(1/c.zoom));l=c.zoom*k;n=c.y1-1;for(q=0;n>=c.y0;n-=k,q++)for(w=n*this.raw.width,r=q*l,h=c.x0,m=0;h<c.x1;h+=k,m++){if(E){if(g=C?C.colorData[w+h]:0,A=D?D.colorData[w+h]:0,
B=z?z.colorData[w+h]:0,void 0===g||void 0===A||void 0===B)return b.globalOpts.rgb.active=!1,b.error("RGB images are incompatible. Turning off RGB mode.","",!1),b.Image.prototype.mkRGBImage.call(this),this}else d=this.colorData[w+h];this.maskData&&(v=0<this.maskData[w+h]?e:f);t=m*l;for(u=0;u<c.zoom;u++)for(p=Math.floor(r+u),y=p*c.width,p=0;p<c.zoom;p++)x=Math.floor(t+p),x=4*(y+x),E?(a.data[x]=C?C.psColors[g][0]:0,a.data[x+1]=D?D.psColors[A][1]:0,a.data[x+2]=z?z.psColors[B][2]:0):(a.data[x]=this.psColors[d][0],
a.data[x+1]=this.psColors[d][1],a.data[x+2]=this.psColors[d][2]),a.data[x+3]=v}return this};b.Image.prototype.blendImage=function(a,c,d){var e=/normal|multiply|screen|overlay|darken|lighten|color-dodge|color-burn|hard-light|soft-light|difference|exclusion|hue|saturation|color|luminosity|clear|copy|source-over|destination-over|source-in|destination-in|source-out|destination-out|source-atop|destination-atop|xor|lighter/i;if(0===arguments.length)return this.blend;if(!0===a||!1===a)return this.blend.active=
...
return this};b.Image.prototype.calcDisplayOffsets=function(b){var a,d,e;this.ix=Math.floor((this.display.canvas.width-this.rgb.img.width)/2);this.iy=Math.floor((this.display.canvas.height-this.rgb.img.height)/2);b&&this.wcsim&&this.display===this.wcsim.display&&this.params.wcsalign&&(a=this.rgb.sect,d=this.wcsim,e=d.rgb.sect,b=0-(e.x0-a.x0)*e.zoom,a=(d.raw.height-this.raw.height-(e.y0-a.y0))*e.zoom,this.ix=d.ix+b,this.iy=d.iy+a);return this};b.Image.prototype.putImage=function(a){var c=this.rgb,d=
...
h.notify=!0):"display"===a&&(h.notify=!0):a="rgb";a.split(",").forEach(function(b,a,c){b=b.trim();h[b]=!0;switch(b){case "colors":h.scaled=!0;h.rgb=!0;break;case "scaled":h.rgb=!0}});h.display=!0;h.plugins=!0;this.rgbFile&&(h.colors=!1,h.scaled=!1);if("string"===typeof c)try{c=JSON.parse(c)}catch(k){b.error("can't parse displayImage opts: "+c,k)}c=c||{};if(this.display.blendMode&&!1!==c.blendMode)for(d=0;d<b.images.length;d++)e=b.images[d],e.display===this.display&&e.blend.active&&(g.push(e),f++);
...
c={x:Math.floor(a.x+.5),y:Math.floor(a.y+.5)});return c};b.Image.prototype.displaySection=function(a,c){var d=this,e,f,g,h,k,l,n,m,q,t,r,u,p=function(a,c,d){var e;b.isNull(a)?b.isNull(c)||(e=c):e=a;return e||d},x=function(a,e){var f;f="";e=e||{};n=$.extend(!0,{},e);!1!==e.waiting&&b.waiting(!0,d.display);a.fits.extname?f=sprintf("[%s]",a.fits.extname):a.fits.extnum&&0<a.fits.extnum?f=sprintf("[%s]",a.fits.extnum):d.parent&&(d.parent.extname?f=sprintf("[%s]",d.parent.extname):d.parent.extnum&&0<d.parent.extnum&&
(f=sprintf("[%s]",d.parent.extnum)));f=d.id.replace(/\[.*\]/,"")+f;e.separate?(delete n.xcen,delete n.ycen,n.id=f,n.display=d.display,"parentFile"===g&&d.fitsFile&&(f=b.lookupImage(d.fitsFile),n.parentFile=f&&f.parentFile?f.parentFile:d.fitsFile),k=d.listRegions("all",{mode:1}),c=n.ondisplaysection||n.onrefresh||c,l=new b.Image(a,n,c),l.binning.obin=l.binning.bin,k&&l.addShapes("regions",k)):(n.file=f,n.id=f,n.refreshRegions=!0,n.resetSection=!0,n.rawid=d.raw.id,n.onrefresh=n.ondisplaysection||n.onrefresh||
...
a=0;a<f.length;a++)m.tags[a]=f[a].trim();else if($.isArray(c.tags))for(a=0;a<c.tags.length;a++)m.tags[a]=c.tags[a].trim();void 0!==c.angle&&(n.angle=-c.angle,this.raw.wcsinfo&&this.raw.wcsinfo.crot&&(n.angle-=this.raw.wcsinfo.crot));void 0!==c.x&&void 0!==c.y&&(f=this.imageToDisplayPos(c),n.left=f.x,n.top=f.y);void 0!==c.px&&void 0!==c.py&&(f=this.logicalToDisplayPos({x:c.px,y:c.py}),n.left=f.x,n.top=f.y);"string"===typeof c.wcs&&(f=c.wcs.trim().split(/ +/),c.ra=f[0],c.dec=f[1],3<=f.length&&(c.wcssys=
f[2]));void 0!==c.ra&&void 0!==c.dec&&0<this.raw.wcs&&(c.wcssys?(g=this.getWCSSys(),e=b.globalOpts.xeqPlugins,b.globalOpts.xeqPlugins=!1,this.setWCSSys(c.wcssys)):c._wcssys&&(g=this.getWCSSys(),e=b.globalOpts.xeqPlugins,b.globalOpts.xeqPlugins=!1,this.setWCSSys(c._wcssys),delete c._wcssys),"string"===typeof c.ra&&(c.ra=b.saostrtod(c.ra),":"===String.fromCharCode(b.saodtype())&&"galactic"!==this.params.wcssys&&"ecliptic"!==this.params.wcssys&&(c.ra*=15)),"string"===typeof c.dec&&(c.dec=b.saostrtod(c.dec)),
f=b.wcs2pix(this.raw.wcs,c.ra,c.dec).trim().split(/ +/),g&&(this.setWCSSys(g),b.globalOpts.xeqPlugins=e),f=this.imageToDisplayPos({x:parseFloat(f[0]),y:parseFloat(f[1])}),n.left=f.x,n.top=f.y);void 0!==c.left&&(n.left=c.left);void 0!==c.top&&(n.top=c.top);void 0===n.left&&(n.left=d&&void 0!==d.left?d.left:this.display.canvasjq.attr("width")/2-1);void 0===n.top&&(n.top=d&&void 0!==d.top?d.top:this.display.canvasjq.attr("height")/2-1+1);c.dx&&(n.left+=c.dx);c.dy&&(n.top-=c.dy);switch(c.shape){case "annulus":m.radii=
[];if(void 0!==c.radii)if("string"===typeof c.radii)for(m.radii=c.radii.replace(/ /g,"").split(","),e=a=0;a<m.radii.length;a++)""!==m.radii[a]&&(c.sizeScale&&(m.radii[a]*=c.sizeScale),m.radii[e++]=this.wcs2imlen(m.radii[a]));else{if(m.radii=c.radii,c.sizeScale)for(a=0;a<m.radii.length;a++)m.radii[a]*=c.sizeScale}else for(c.ireg&&b.SCALEIREG&&(b.notNull(c.iradius)&&(c.iradius/=h),b.notNull(c.oradius)&&(c.oradius/=h)),c.sizeScale&&(b.notNull(c.iradius)&&(c.iradius*=c.sizeScale),b.notNull(c.oradius)&&
(c.oradius*=c.sizeScale)),h=(c.oradius-c.iradius)/c.nannuli,g=c.nannuli+1,a=0;a<g;a++)e=c.iradius+h*a,c.sizeScale&&(e*=c.sizeScale),m.radii.push(e);break;case "box":c.ireg&&b.SCALEIREG&&(b.notNull(c.width)&&(c.width/=h),b.notNull(c.height)&&(c.height/=h));c.sizeScale&&(b.notNull(c.width)&&(c.width*=c.sizeScale),b.notNull(c.height)&&(c.height*=c.sizeScale));break;case "circle":c.ireg&&b.SCALEIREG&&b.notNull(c.radius)&&(c.radius/=h);c.sizeScale&&b.notNull(c.radius)&&(c.radius*=c.sizeScale);break;case "ellipse":c.ireg&&
b.SCALEIREG&&(b.notNull(c.r1)&&(c.r1/=h),b.notNull(c.r2)&&(c.r2/=h));c.sizeScale&&(b.notNull(c.r1)&&(c.r1*=c.sizeScale),b.notNull(c.r2)&&(c.r2*=c.sizeScale));break;case "point":switch(c.ptshape){case "box":c.width=2*c.ptsize;c.height=2*c.ptsize;break;case "circle":c.radius=c.ptsize;break;case "ellipse":c.rx=c.ptsize,c.ry=c.ptsize/2}c.lockRotation=!0;c.lockScalingX=!0;c.lockScalingY=!0;c.lockUniScaling=!0;c.hasControls=!1;c.hasRotatingPoint=!1;c.hasBorders=!0;break;case "line":case "polygon":if(void 0!==
c.wcspts&&0<this.raw.wcs){c.pts=[];c.wcssys&&(g=this.getWCSSys(),e=b.globalOpts.xeqPlugins,b.globalOpts.xeqPlugins=!1,this.setWCSSys(c.wcssys));for(a=0;a<c.wcspts.length;a++)f=b.wcs2pix(this.raw.wcs,c.wcspts[a].ra,c.wcspts[a].dec).trim().split(/ +/),c.pts.push({x:parseFloat(f[0]),y:parseFloat(f[1])});g&&(this.setWCSSys(g),b.globalOpts.xeqPlugins=e)}if(c.pts&&c.pts.length){if("string"===typeof c.pts){f=c.pts.replace(/ /g,"").split(",");g=f.length;if("string"===typeof f[0])for(a=0;a<g;a++)f[a]=parseFloat(f[a]);
c.pts=[];for(e=a=0;a<g;a+=2,e++)c.pts[e]={x:f[a],y:f[a+1]}}g=c.pts.length;for(a=0;a<g;a++)c.pts[a]=this.imageToDisplayPos(c.pts[a]);c.left&&c.top?e={x:c.left,y:c.top}:(e=b.centerPolygon(c.pts),n.left=e.x,n.top=e.y);c.points=[];for(a=0;a<g;a++)f={x:(c.pts[a].x-e.x)/h,y:(c.pts[a].y-e.y)/h},c.points.push(f)}else d&&d.points&&d.points.length||("polygon"===c.shape&&c.polypoints?c.points=c.polypoints:"line"===c.shape&&c.linepoints&&(c.points=c.linepoints));if(c.ireg&&b.SCALEIREG)for(g=c.points.length,a=
0;a<g;a++)c.points[a].x/=h,c.points[a].y/=h}for(k in c)if(c.hasOwnProperty(k))switch(k){case "tags":case "x":case "y":case "px":case "py":case "dx":case "dy":case "ra":case "dec":case "pts":case "left":case "top":case "angle":case "radii":case "ireg":break;case "type":case "originX":case "originY":case "width":case "height":case "scaleX":case "scaleY":case "flipX":case "flipY":case "opacity":case "cornerSize":case "transparentCorners":case "hoverCursor":case "padding":case "borderColor":case "cornerColor":case "centeredScaling":case "centeredRotation":case "fill":case "fillRule":case "backgroundColor":case "stroke":case "strokeWidth":case "strokeDashArray":case "strokeLineCap":case "strokeLineJoin":case "strokeMiterLimit":case "shadow":case "borderOpacityWhenMoving":case "borderScaleFactor":case "borderDashArray":case "transformMatrix":case "minScaleLimit":case "selectable":case "evented":case "visible":case "hasControls":case "hasBorders":case "hasRotatingPoint":case "rotatingPointOffset":case "perPixelTargetFind":case "includeDefaultValues":case "clipTo":case "lockMovementX":case "lockMovementY":case "lockRotation":case "lockScalingX":case "lockScalingY":case "lockUniScaling":case "radius":case "rx":case "ry":case "points":case "selectionLineWidth":case "fontFamily":case "fontSize":case "fontStyle":case "fontWeight":case "text":case "textDecoration":case "textAlign":case "lineHeight":case "textBackgroundColor":case "textOpts":n[k]=
...
this.params.wcssys&&"ecliptic"!==this.params.wcssys&&(a.pub.ra*=15)),"string"===typeof a.pub.dec&&(a.pub.dec=b.saostrtod(a.pub.dec)),e=b.wcs2pix(q,a.pub.ra,a.pub.dec).trim().split(/ +/),e=this.imageToDisplayPos({x:parseFloat(e[0]),y:parseFloat(e[1])})):e=m.logicalToDisplayPos(a.pub.lcs);a.set("left",e.x);a.set("top",e.y);"circle"!==a.params.shape&&"line"!==a.params.shape&&"point"!==a.params.shape&&"polygon"!==a.params.shape&&"text"!==a.params.shape&&(m.raw.wcsinfo&&m.raw.wcsinfo.crot?a.set("angle",
-(a.pub.angle+m.raw.wcsinfo.crot)):a.set("angle",-a.pub.angle));if(!1!==a.params.zoomable)switch(a.params.shape){case "point":case "text":break;default:if(h=f,k=g,n&&(h*=a.scaleX,k*=a.scaleY),a.scaleX=h,a.scaleY=k,a.rescaleBorder(),a.points)if(p=a.getCenterPoint(),0<q&&a.pub.wcspts)for(t=a.pub.wcspts,d=0;d<t.length;d++)e=b.wcs2pix(q,t[d].ra,t[d].dec).trim().split(/ +/),e=this.imageToDisplayPos({x:parseFloat(e[0]),y:parseFloat(e[1])}),a.points[d]={x:(e.x-p.x)/a.scaleX,y:(e.y-p.y)/a.scaleY};else if(a.pub.lcs.pts)for(t=
a.pub.lcs.pts,d=0;d<t.length;d++)e=m.logicalToDisplayPos(a.pub.lcs.pts[d]),a.points[d]={x:(e.x-p.x)/a.scaleX,y:(e.y-p.y)/a.scaleY}}a.setCoords();switch(a.type){case "polyline":case "polygon":c===a&&(b.Fabric.removePolygonAnchors(l.dlayer,a),b.Fabric.addPolygonAnchors(l.dlayer,a))}b.Fabric.updateChildren(l.dlayer,a,"moving");b.Fabric.updateChildren(l.dlayer,a,"scaling");b.Fabric.updateChildren(l.dlayer,a,"rotating")}),d&&d.renderAll(),this};b.Fabric.addPolygonPoint=function(a,c,d){var e,f,g,h,k,l,
n,m,q,t,r,u,p,x,w,y=Number.MAX_VALUE;if(c&&c.points){d=b.eventToDisplayPos(d);n=c.getCenterPoint().x;l=c.getCenterPoint().y;n=(d.x-n)/c.get("scaleX");u=(d.y-l)/c.get("scaleY");for(l=-c.get("angle")*Math.PI/180;l>2*Math.PI;)l-=2*Math.PI;d=Math.cos(l)*n-Math.sin(l)*u;u=Math.sin(l)*n+Math.cos(l)*u;n=c.points;for(l=0;l<n.length;l++)k=n[l],f=n[(l+1)%n.length],m=k.x<f.x?k.x:f.x,q=k.y<f.y?k.y:f.y,t=k.x>f.x?k.x:f.x,r=k.y>f.y?k.y:f.y,e=k.x-f.x,k=k.y-f.y,g=Math.sqrt(e*e+k*k),0!==g&&(e/=g,k/=g),g=d-f.x,h=u-
f.y,g=g*e+h*k,e=f.x+e*g,f=f.y+k*g,e<m?e=m:e>t&&(e=t),f<q?f=q:f>r&&(f=r),m=(e-d)*(e-d)+(f-u)*(f-u),m<y&&(y=m,p=e,x=f,w=l===n.length?0:l);a=this.getShapeLayer(a);b.Fabric.removePolygonAnchors(a.dlayer,c);n.splice(w+1,0,{x:p,y:x});a.canvas.setActiveObject(c)}};b.Fabric.removePolygonPoint=function(a,c){var d,e,f,g;c&&c.polyparams&&(e=c.polyparams.polygon,f=e.points,"polygon"===e.type&&3>=f.length||"polyline"===e.type&&2>=f.length||(g=c.polyparams.point,delete c.polyparams.point,d=this.getShapeLayer(a),
b.Fabric.removePolygonAnchors(d.dlayer,e),f.splice(g,1),b.resetPolygonCenter(e),d.canvas.setActiveObject(e)))};b.Fabric.addPolygonAnchors=function(a,c){var d,e,f={},g=a.canvas,h=function(){var c=this.polyparams.polygon,d=this.polyparams.point,e=c.get("points"),h=a.display.image;void 0!==d&&!1!==c.params.changeable&&(c.angle?f=b.rotatePoint({x:this.left,y:this.top},-c.angle,{x:c.left,y:c.top}):(f.x=this.left,f.y=this.top),e[d].x=(f.x-c.left)/c.scaleX,e[d].y=(f.y-c.top)/c.scaleY,b.resetPolygonCenter(c),
b.Fabric._updateShape.call(h,c.params.layerName,c,null,"update"),h&&(h.params.listonchange||c.params.listonchange)&&h.listRegions(c,{mode:2}),g.renderAll())},k=function(a){var c,d={};for(c=0;c<a.params.anchors.length;c++)d.x=a.left+a.points[c].x*a.scaleX,d.y=a.top+a.points[c].y*a.scaleY,a.angle&&(d=b.rotatePoint(d,a.angle,{x:a.left,y:a.top})),a.params.anchors[c].set({left:d.x,top:d.y,angle:a.angle}),a.params.anchors[c].setCoords();a._calcDimensions(!0);g.renderAll()};if(!c.params.anchors&&!1!==c.params.changeable){c.params.anchors=
[];for(d=0;d<c.points.length;d++)f.x=c.left+c.points[d].x*c.scaleX,f.y=c.top+c.points[d].y*c.scaleY,c.angle&&(f=b.rotatePoint(f,c.angle,c.getCenterPoint())),e=new fabric.Rect({left:f.x,top:f.y,hasControls:!1,hasRotatingPoint:!1,hasBorders:!1,selectable:!0,fill:c.get("stroke"),hoverCursor:"pointer",width:b.Fabric.opts.cornerSize+2,height:b.Fabric.opts.cornerSize+2,padding:2}),e.on("moving",h),e.polyparams={},e.polyparams.polygon=c,e.polyparams.point=d,c.params.anchors[d]=e,g.add(e);c.on("moving",function(){k(c)});
c.on("rotating",function(){k(c)});c.on("scaling",function(){k(c)});c.setCoords()}};b.Fabric.removePolygonAnchors=function(a,b){var c,e=a.canvas;if(b&&b.params&&b.params.anchors&&!1!==b.params.changeable){for(c=0;c<b.params.anchors.length;c++)e.remove(b.params.anchors[c]);delete b.params.anchors}};b.Fabric.updateChildren=function(a,c,d){var e,f,g,h,k,l;if("regions"===a.layerName)if("objects"===d)g={},a.canvas.getObjects().forEach(function(a){a.params&&(a.params.parent||a.params.children.length)&&(g[a.params.id]=
a)}),a.canvas.getObjects().forEach(function(a){if(a.params)for(a.params.parent&&(a.params.parent.obj=g[a.params.parent.id]),e=0;e<a.params.children.length;e++)a.params.children[e].obj=g[a.params.children[e].id]});else if(c&&c.params)if("deltas"===d)c.params.parent&&(f=c.params.parent,f.dleft=f.obj.left-c.left,f.dtop=f.obj.top-c.top,f.moved=!0);else for(e=0;e<c.params.children.length;e++){h=c.params.children[e].obj;f=h.params.parent;switch(d){case "moving":h.left=c.left-f.dleft;h.top=c.top-f.dtop;
break;case "rotating":for(;0>c.angle;)c.angle+=360;for(;360<c.angle;)c.angle-=360;k=c.angle-f.lastangle;l=b.rotatePoint({x:h.left,y:h.top},k,{x:c.left,y:c.top});h.left=l.x;h.top=l.y;f.dleft=c.left-h.left;f.dtop=c.top-h.top;for(h.angle+=k;0>h.angle;)h.angle+=360;for(;360<h.angle;)h.angle-=360;f.lastangle=c.angle;break;case "scaling":f.dleft*=c.scaleX/f.lastscalex,f.dtop=c.scaleY/f.lastscaley*(f.dtop-f.textheight)+f.textheight,f.lastscalex=c.scaleX,f.lastscaley=c.scaleY,f.moved=!0,h.left=c.left-f.dleft,
h.top=c.top-f.dtop}h.setCoords();a.display.image&&a.display.image.updateShapes(a.layerName,h,"child")}};b.resetPolygonCenter=function(a){var c,d,e,f={};a._calcDimensions();d=(a.minX+a.width/2)*a.scaleX;c=(a.minY+a.height/2)*a.scaleY;a.angle?f=b.rotatePoint({x:a.left+d,y:a.top+c},a.angle,{x:a.left,y:a.top}):(f.x=a.left+d,f.y=a.top+c);if(5<=fabric.version.split(".")[1])for(d/=a.scaleX,e=c/a.scaleY,c=0;c<a.points.length;c++)a.points[c].x-=d,a.points[c].y-=e;a.left=f.x;a.top=f.y;a.setCoords()};b.Fabric.print=
function(a){var c,d,e,f,g,h,k=0,l=sprintf("width=%s,height=%s,menubar=1,toolbar=1,status=0,scrollbars=1,resizable=1",this.display.canvasjq.attr("width"),this.display.canvasjq.attr("height"));if("string"===typeof a)try{a=JSON.parse(a)}catch(n){b.error("can't parse print opts: "+a,n)}a=a||{};f=this.display.canvas.toDataURL("image/png");c="<html><body style='padding: 0px; margin: 0px' onload='window.print(); return false'>";g=sprintf("<div style='position:absolute; left:%spx; top:%spx'>",0,k);c+=sprintf("%s<img src='%s'></div>",
g,f);for(d in this.layers)this.layers.hasOwnProperty(d)&&(f=this.layers[d],"main"===f.dlayer.dtype&&f.show&&(c+=sprintf("%s%s</div>",g,f.dlayer.canvas.toSVG())));(void 0===a.colorbar||a.colorbar)&&(a=this.display.pluginInstances.JS9Colorbar)&&a.isActive()&&(k+=2,f=a.colorbarjq[0].toDataURL("image/png"),k+=this.display.height,g=sprintf("<div style='position:absolute; left:%spx; top:%spx'>",0,k),c+=sprintf("%s<img src='%s'></div>",g,f),a.textjq&&a.textjq[0]&&(f=a.textjq[0].toDataURL("image/png"),k+=
a.colorbarjq.height()+1,g=sprintf("<div style='position:absolute; left:%spx; top:%spx'>",0,k),c+=sprintf("%s<img style='width:%spx;'src='%s'></div>",g,this.display.width,f)));c+="</body></html>";window.isElectron&&(h="data:text/html,<html><body><script>window.addEventListener('message', function(ev){document.documentElement.innerHTML=ev.data; window.setTimeout(function(){window.print()}, 250);},false)\x3c/script><p>waiting for image ...</body></html>");(e=window.open(h,this.id,l))?e.document?(e.document.open(),
e.document.write(c),e.document.close()):e.postMessage?window.setTimeout(function(){e.postMessage(c,"*")},250):b.error("no method available for drawing image into print window"):b.error("could not create print window (check your pop-up blockers)")};b.Fabric.initGraphics=function(){var a;b.Display.prototype.newShapeLayer=b.Fabric.newShapeLayer;b.Image.prototype.addShapes=b.Fabric.addShapes;b.Image.prototype.selectShapes=b.Fabric.selectShapes;b.Image.prototype.updateShapes=b.Fabric.updateShapes;b.Image.prototype.updateShape=
b.Fabric._updateShape;b.Image.prototype.getShapes=b.Fabric.getShapes;b.Image.prototype.changeShapes=b.Fabric.changeShapes;b.Image.prototype.removeShapes=b.Fabric.removeShapes;b.Image.prototype.refreshShapes=b.Fabric.refreshShapes;b.Image.prototype.getShapeLayer=b.Fabric.getShapeLayer;b.Image.prototype.showShapeLayer=b.Fabric.showShapeLayer;b.Image.prototype.activeShapeLayer=b.Fabric.activeShapeLayer;b.Image.prototype.displayShapeLayers=b.Fabric.displayShapeLayers;b.Image.prototype.toggleShapeLayers=
b.Fabric.toggleShapeLayers;b.Image.prototype.print=b.Fabric.print;for(a in b.Fabric.opts)b.Fabric.opts.hasOwnProperty(a)&&(fabric.Object.prototype[a]=b.Fabric.opts[a])};b.Fabric.initGraphics();b.MouseTouch={};b.MouseTouch.CLASS="JS9";b.MouseTouch.NAME="MouseTouch";b.MouseTouch.WIDTH=512;b.MouseTouch.HEIGHT=220;b.MouseTouch.BASE=b.MouseTouch.CLASS+b.MouseTouch.NAME;b.MouseTouch.mouseText=[];b.MouseTouch.mouseText[0]="move mouse, no buttons pressed:";b.MouseTouch.mouseText[1]="move mouse, primary button pressed:";
...
this.lcs.physical&&(d.dval*=this.lcs.physical.forward[0][0]);return d.dval};a=a.trim();if(!a.match(/(\(|\{|#|;|\n)/))return a;n=this.getWCSSys();m=this.getWCSUnits();q="physical";t="image"!==q&&"physical"!==q;h=a.split(/\n|;/);for(e=0;e<h.length;e++)if("#"!==h[e].trim().substr(0,1))if(r=!1,l=G(h[e]),p=l.args.length,l.isregion){k=$.extend(!0,{},l.opts);k.shape=l.cmd;2<=p&&(u=H.call(this,l.args[0],l.args[1]),k.x=u[0],k.y=u[1]);k.textOpts&&void 0!==k.textOpts.ra&&void 0!==k.textOpts.dec&&(k.textOpts._wcssys=
q);switch(l.cmd){case "annulus":k.radii=[];for(f=2;f<p;f++)k.radii.push(F.call(this,l.args[f],1));break;case "box":3<=p&&(k.width=F.call(this,l.args[2],1));4<=p&&(k.height=F.call(this,l.args[3],2));5<=p&&(k.angle=b.strtoscaled(l.args[4]).dval);break;case "circle":3<=p&&(k.radius=F.call(this,l.args[2],1));break;case "ellipse":3<=p&&(k.r1=F.call(this,l.args[2],1));4<=p&&(k.r2=F.call(this,l.args[3],2));5<=p&&(k.angle=b.strtoscaled(l.args[4]).dval);break;case "line":case "polygon":k.pts=[];for(g=f=0;f<
p;f+=2,g++)u=H.call(this,l.args[f],l.args[f+1]),k.pts[g]={x:u[0],y:u[1]};delete k.x;delete k.y;break;case "text":3<=p&&(k.text=l.args[2].replace(/^['"]/,"").replace(/["']$/,"")),4<=p&&(k.angle=b.strtoscaled(l.args[3]).dval)}l.comment&&(k.tags=l.comment);d.push(k)}else l.cmd.match(w)?(f=b.globalOpts.xeqPlugins,b.globalOpts.xeqPlugins=!1,this.setWCSSys(l.cmd),b.globalOpts.xeqPlugins=f,q=this.getWCSSys(),t="image"!==q&&"physical"!==q):"remove"!==l.cmd&&"delete"!==l.cmd||d.push({remove:!0});f=b.globalOpts.xeqPlugins;
b.globalOpts.xeqPlugins=!1;this.setWCSSys(n);this.setWCSUnits(m);b.globalOpts.xeqPlugins=f;return d};b.Regions.saveRegions=function(a,c,d){var e=sprintf("# Region file format: JS9 version 1.0");c=this.listRegions(c,{mode:1},d);e=sprintf("%s\n%s\n",e,c.replace(/; */g,"\n"));e=new Blob([e],{type:"text/plain;charset=utf-8"});a||(a=d?d+".reg":"js9.reg");window.hasOwnProperty("saveAs")?saveAs(e,a):b.error("no saveAs function available to save region file");return a};b.Regions.editRegionTags=function(a,
b,d){var c,f,g,h,k=[];g=this.getShapes("regions",a);if(g.length){for(c=0;c<g.length;c++)for(h=g[c].tags,k.push(b),f=0;f<h.length;f++)h[f]!==d&&k.push(h[f]);this.changeShapes("regions",a,{tags:k})}};b.Regions.toggleRegionTags=function(a,b,d){var c,f,g,h,k;g=this.getShapes("regions",a);if(g.length){for(c=0;c<g.length;c++)for(h=g[c].tags,k="",f=0;f<h.length;f++)if(h[f]===b){k=h[f]=d;break}else if(h[f]===d){k=h[f]=b;break}k&&this.changeShapes("regions",a,{tags:h})}};b.Catalogs={};b.Catalogs.CLASS="JS9";
...
(b.lightOpts.nclick=0):2<=b.lightOpts.nclick?(alert("trouble closing this window? double-tap the window handle"),b.lightOpts.nclick=-1):0<=b.lightOpts.nclick&&b.lightOpts.nclick++})}return g};b.checkNew=function(a){a||b.error("internal failure in a JS9 constructor")};b.specialKey=function(a){return a.metaKey||a.ctrlKey};b.strace=function(a){var c="";1<b.DEBUG&&(c=a.stack||a.stacktrace||"");return c};b.floatToString=function(a){return sprintf("%g",parseFloat(a.toFixed(b.globalOpts.floatPrecision)))};
b.floatPrecision=function(a,b){var c,e;c=Math.floor(Math.log10(Math.abs(a)));e=Math.floor(Math.log10(Math.abs(b)));return c!==e?c>e?c:e:1};b.floatFormattedString=function(a,b,d){var c="";if(void 0===a)return c;-2>b?(b="%."+String(2+d)+"e",c=sprintf(b,a)):0>b?c=a.toFixed(Math.abs(b)+3+d):2>b?(b="%."+String(b+d)+"f",c=sprintf(b,a)):5>b?c=a.toFixed(0+d):(b="%."+String(2+d)+"e",c=sprintf(b,a));return c};b.centerPolygon=function(a){var b,d,e,f,g,h;if(a&&a.length){d=a.length;for(b=0;b<d;b++){if(void 0===
e||a[b].x<e)e=a[b].x;if(void 0===f||a[b].x>f)f=a[b].x;if(void 0===g||a[b].y<g)g=a[b].y;if(void 0===h||a[b].y>h)h=a[b].y}return{x:(e+f)/2,y:(g+h)/2}}};b.centroidPolygon=function(a){var b,d,e=0,f=0;if(a&&a.length){d=a.length;for(b=0;b<d;b++)e+=a[b].x,f+=a[b].y;return{x:e/d,y:f/d}}};b.lookupImage=function(a,c){var d,e,f,g=b.images.length;if(!a)return null;for(d=0;d<g;d++)if(e=b.images[d],(a===e||a===e.id||a===e.id0||a===e.id0.replace(/\[.*\]$/,"")||a===e.file||a===e.file.replace(/\[.*\]$/,"")||a===e.file0||
a===b.TOROOT+e.file||e.fitsFile&&a===e.fitsFile)&&0<$("#"+e.display.id).length&&(f=e.display.id,!c||"string"===typeof c&&c===f||"object"===typeof c&&c.id===f))return e;return null};b.lookupDisplay=function(a,c){var d,e=new RegExp(sprintf("[-_]?(%s)$",b.PLUGINS));void 0===c&&(c=!0);if(a&&"*"!==a&&0>a.toString().search(b.SUPERMENU)){for(d=0;d<b.displays.length;d++)if(a===b.displays[d]||a===b.displays[d].id)return b.displays[d];if("string"===typeof a)for(a=a.replace(e,""),d=0;d<b.displays.length;d++)if(a===
b.displays[d]||a===b.displays[d].id)return b.displays[d];if(c)b.error("can't find JS9 display with id: "+a);else return null}return b.displays[0]};b.getImage=function(a){var c;c=b.lookupImage(a);!c&&(a=b.lookupDisplay(a))&&(c=a.image);return c};b.lookupVfile=function(a){var c,d,e,f,g=[];if(!a)return g;for(c=0;c<b.images.length;c++)for(e=b.images[c],d=0;d<e.raws.length;d++)f=e.raws[d],f.hdu&&f.hdu.fits&&a===f.hdu.fits.vfile&&g.push({im:e,raw:f,idx:d});return g};b.loadScript=function(a,b,d){var c=document.getElementsByTagName("head")[0],
f=document.createElement("script");f.type="text/javascript";b&&(f.onload=b);d&&(f.onerror=d);f.src=a;c.appendChild(f)};b.fetchURL=function(a,c,d,e){var f,g=new XMLHttpRequest;d=d||{};a||c||b.error("invalid url specification for fetchURL");c||(c=a,a=/([^\\\/]+)$/.exec(c)[1]);a||(a=/([^\\\/]+)$/.exec(c)[1]);f=d.allowCache||c.match(/\?/)?c:c+"?r="+Math.random();g.open("GET",f,!0);g.responseType=d.responseType?d.responseType:"blob";b.globalOpts.xtimeout&&(g.timeout=b.globalOpts.xtimeout);g.onload=function(){var f;
4===this.readyState&&(200===this.status||0===this.status?"blob"===g.responseType?(f=new Blob([this.response]),a.match("://")?f.name=a.split("/").reverse()[0].replace(/\?.*$/,""):f.name=a,"uc"===f.name&&(f.name="google_"+b.uniqueID()+".fits"),e?e(f,d):b.Load(f,d)):d.display?e(this.response,d,{display:d.display}):e(this.response,d):404===this.status?b.error("could not find "+c):b.error(sprintf("can't load: %s %s (%s)  ",c,g.statusText,g.status)))};g.onerror=function(){b.error(sprintf("cannot load: %s %s .. please check the url/pathname",
...
d.ipos),!c.resizing)&&(a.preventDefault(),d.valpos=null,d.clickInRegion&&"regions"===d.clickInLayer&&(c=d.display.layers.regions.params.sel)&&((d.params.listonchange||c.params.listonchange||b.globalOpts.intensivePlugins)&&d.updateShape("regions",c,null,"move"),(d.params.listonchange||c.params.listonchange)&&d.listRegions("selected",{mode:2}),b.globalOpts.intensivePlugins&&d.xeqPlugins("region","onregionsmove",c.pub)),b.hasOwnProperty("MouseTouch")&&b.MouseTouch.action(d,a),b.specialKey(a)||(d.valpos||
(d.valpos=d.updateValpos(d.ipos,!1)),b.specialKey(a)||d.xeqPlugins("mouse","onmousemove",a)))};b.mouseOverCB=function(a){var c=a.data.image,d=$(document).scrollLeft(),e=$(document).scrollTop();a.preventDefault();c&&(c.display.displayConjq.focus(),window.scrollTo(d,e),b.specialKey(a)||(c.pos=b.eventToDisplayPos(a),c.ipos=c.displayToImagePos(c.pos),b.specialKey(a)||c.xeqPlugins("mouse","onmouseover",a)))};b.mouseOutCB=function(a){var c=a.data.image;a.preventDefault();c&&(c.display.displayConjq.blur(),
c.clickInRegion&&c.clickInLayer&&c.updateShapes(c.clickInLayer,"selected","mouseout"),b.specialKey(a)||(c.pos=b.eventToDisplayPos(a),c.ipos=c.displayToImagePos(c.pos),b.specialKey(a)||c.xeqPlugins("mouse","onmouseout",a)))};b.wheelCB=function(a){var c=a.data,d=c.image;c.mousetouchZoom&&d&&b.hasOwnProperty("MouseTouch")&&b.MouseTouch.Actions["wheel zoom"]&&(b.MouseTouch.Actions["wheel zoom"](d,a),a.preventDefault())};b.keyPressCB=function(a){var b=a.data.image;a.preventDefault();b&&b.xeqPlugins("keypress",
"onkeypress",a)};b.keyDownCB=function(a){var c,d=a.data.image;b.hasOwnProperty("Keyboard")&&(c=d?d.ipos:{x:null,y:null},b.Keyboard.action(d,c,a));d&&d.xeqPlugins("keypress","onkeydown",a)};b.keyUpCB=function(a){var b=a.data.image;b&&b.xeqPlugins("keypress","onkeyup",a)};b.dragenterCB=function(a,b){b.stopPropagation();b.preventDefault()};b.dragoverCB=function(a,b){b.stopPropagation();b.preventDefault()};b.dragexitCB=function(a,b){b.stopPropagation();b.preventDefault()};b.dragdropCB=function(a,c){var d,
e,f,g,h,k=/^(https?|ftp):\/\//;c.originalEvent&&(c=c.originalEvent);c.stopPropagation();c.preventDefault();f=$.extend(!0,{},b.fits.options);f.display=f.display||a;f.extlist=f.extlist||b.globalOpts.extlist;g=c.target.files||c.dataTransfer.files;h=b.lookupDisplay(f.display);g.length?window.setTimeout(function(){var a,c;for(d=0;d<g.length;d++)a=g[d],c=a.path||a.name||"",c.match(/\.reg$/)?b.LoadRegions(a,{display:f.display}):c.match(/\.cat$/)?b.LoadCatalog(null,a,{display:f.display}):c.match(/\.ses$/)?
