...
(c=a.lookupDisplay(c.display))&&$("#openLocalFile-"+c.id).click()});a.mkPublic("OpenRegionsMenu",function(){var c=a.parsePublicArgs(arguments);(c=a.lookupDisplay(c.display))&&$("#openLocalRegions-"+c.id).click()});a.mkPublic("OpenColormapMenu",function(){var c=a.parsePublicArgs(arguments);(c=a.lookupDisplay(c.display))&&$("#openLocalColormap-"+c.id).click()});a.mkPublic("SaveColormap",function(c){var b,d=a.parsePublicArgs(arguments);if(window.hasOwnProperty("saveAs")){if(b=a.getImage(d.display))c=
