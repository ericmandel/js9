...
l=n:l>q&&(l=q);m=(r-d)*(r-d)+(l-g)*(l-g);if(m<e){e=m;var u=r;var t=l;var x=h===f.length?0:h}}c=this.getShapeLayer(c);a.Fabric.removePolygonAnchors(c.dlayer,b);f.splice(x+1,0,{x:u,y:t});if(1===fabric.major_version)c.canvas.setActiveObject(b);else{switch(b.type){case "polyline":case "polygon":a.Fabric.addPolygonAnchors(c.dlayer,b),c.dlayer.canvas.renderAll()}b.polyparams?c.dlayer.params.sel=b.polyparams.polygon:b.params&&(c.dlayer.params.sel=b)}}};a.Fabric._removePolygonPoint=function(c,b){if(b&&b.polyparams){var d=
...
(d.angle?e=a.rotatePoint({x:b.left,y:b.top},-d.angle,{x:d.left,y:d.top}):(e.x=b.left,e.y=b.top),h[g].x=(e.x-d.left)/d.scaleX,h[g].y=(e.y-d.top)/d.scaleY,a.resetPolygonCenter(d),k._updateShape(d.params.layerName,d,null,"update"),k&&(k.params.listonchange||d.params.listonchange)&&k.listRegions(d,{mode:2}),f.renderAll())},g=function(b){var c,d={};for(c=0;c<b.params.anchors.length;c++)d.x=b.left+b.points[c].x*b.scaleX,d.y=b.top+b.points[c].y*b.scaleY,b.angle&&(d=a.rotatePoint(d,b.angle,{x:b.left,y:b.top})),
b.params.anchors[c].set({left:d.x,top:d.y,angle:b.angle}),b.params.anchors[c].setCoords();b._calcDimensions(!0);f.renderAll()};if(!b.params.anchors&&!1!==b.params.changeable){b.params.anchors=[];for(d=0;d<b.points.length;d++){e.x=b.left+b.points[d].x*b.scaleX;e.y=b.top+b.points[d].y*b.scaleY;b.angle&&(e=a.rotatePoint(e,b.angle,b.getCenterPoint()));var k=new fabric.Rect({left:e.x,top:e.y,hasControls:!1,hasRotatingPoint:!1,hasBorders:!1,selectable:!0,fill:b.get("stroke"),hoverCursor:"pointer",width:a.Fabric.opts.cornerSize+
2,height:a.Fabric.opts.cornerSize+2,padding:2});k.on("moving",h);k.polyparams={};k.polyparams.polygon=b;k.polyparams.point=d;b.params.anchors[d]=k;f.add(k)}b.on("moving",function(){g(b)});b.on("rotating",function(){g(b)});b.on("scaling",function(){g(b)});b.setCoords()}};a.Fabric.removePolygonAnchors=function(a,b){var c=a.canvas;if(b&&b.params&&b.params.anchors&&!1!==b.params.changeable){for(a=0;a<b.params.anchors.length;a++)c.remove(b.params.anchors[a]);delete b.params.anchors}};a.Fabric.updateChildren=
function(c,b,d){var e,f;if("regions"===c.layerName)if("objects"===d){var h={};c.canvas.getObjects().forEach(function(a){a.params&&(a.params.parent||a.params.children.length)&&(h[a.params.id]=a)});c.canvas.getObjects().forEach(function(a){if(a.params)for(a.params.parent&&(a.params.parent.obj=h[a.params.parent.id]),e=0;e<a.params.children.length;e++)a.params.children[e].obj=h[a.params.children[e].id]})}else if(b&&b.params)if("deltas"===d){if(b.params.parent){var g=b.params.parent;g.dleft=g.obj.left-
b.left;g.dtop=g.obj.top-b.top;g.moved=!0}}else for(e=0;e<b.params.children.length;e++){var k=b.params.children[e].obj;g=k.params.parent;switch(d){case "moving":k.left=b.left-g.dleft;k.top=b.top-g.dtop;break;case "rotating":for(f=b.angle;0>f;)f+=360;for(;360<=f;)f-=360;var l=f-g.lastangle;var m=a.rotatePoint({x:k.left,y:k.top},l,{x:b.left,y:b.top});k.left=m.x;k.top=m.y;g.dleft=b.left-k.left;g.dtop=b.top-k.top;for(k.angle+=l;0>k.angle;)k.angle+=360;for(;360<=k.angle;)k.angle-=360;g.lastangle=f;break;
case "scaling":g.dleft*=b.scaleX/g.lastscalex,g.dtop=b.scaleY/g.lastscaley*(g.dtop-g.textheight)+g.textheight,g.lastscalex=b.scaleX,g.lastscaley=b.scaleY,g.moved=!0,k.left=b.left-g.dleft,k.top=b.top-g.dtop}k.setCoords();c.display.image&&c.display.image.updateShapes(c.layerName,k,"updatechild")}};a.resetPolygonCenter=function(c){var b={};if(1===fabric.major_version){c._calcDimensions();var d=(c.minX+c.width/2)*c.scaleX;var e=(c.minY+c.height/2)*c.scaleY}else e=c._calcDimensions(),d=(e.left+e.width/
2)*c.scaleX,e=(e.top+e.height/2)*c.scaleY;c.angle?b=a.rotatePoint({x:c.left+d,y:c.top+e},c.angle,{x:c.left,y:c.top}):(b.x=c.left+d,b.y=c.top+e);if(1<fabric.major_version||5<=fabric.minor_version){d/=c.scaleX;var f=e/c.scaleY;for(e=0;e<c.points.length;e++)c.points[e].x-=d,c.points[e].y-=f}c.left=b.x;c.top=b.y;1<fabric.major_version&&(b=c._calcDimensions(),c.width=b.width,c.height=b.height,c.pathOffset={x:b.left+c.width/2,y:b.top+c.height/2});c.setCoords()};a.Fabric.print=function(c){var b,d="",e=0,
f=sprintf("width=%s,height=%s,menubar=1,toolbar=1,status=0,scrollbars=1,resizable=1",this.display.canvasjq.attr("width"),this.display.canvasjq.attr("height"));c=c||{};if("string"===typeof c)try{c=JSON.parse(c)}catch(l){a.error("can't parse print opts: "+c,l)}var h=this.display.canvas.toDataURL("image/png");var g="<html><body style='padding: 0px; margin: 0px' onload='window.print(); return false'>";var k=sprintf("<div style='position:absolute; left:%spx; top:%spx'>",0,e);g+=k+"<img src='"+h+"'></div>";
for(b in this.layers)this.layers.hasOwnProperty(b)&&(h=this.layers[b],"main"===h.dlayer.dtype&&h.show&&(g+=""+k+h.dlayer.canvas.toSVG()+"</div>"));(void 0===c.colorbar||c.colorbar)&&(c=this.display.pluginInstances.JS9Colorbar)&&c.isActive()&&(e+=2,h=c.colorbarjq[0].toDataURL("image/png"),e+=this.display.height,k=sprintf("<div style='position:absolute; left:%spx; top:%spx'>",0,e),g+=k+"<img src='"+h+"'></div>",c.textjq&&c.textjq[0]&&(h=c.textjq[0].toDataURL("image/png"),e+=c.colorbarjq.height()+1,
k=sprintf("<div style='position:absolute; left:%spx; top:%spx'>",0,e),g+=k+"<img style='width:"+this.display.width+"px;'src='"+h+"'></div>"));g+="</body></html>";window.electron&&(d="data:text/html,"+g);(k=window.open(d,this.id,f))?k.document?(k.document.open(),k.document.write(g),k.document.close()):a.error("no method available for drawing image into print window"):a.error("could not create print window (check your pop-up blockers)")};a.Fabric.initGraphics=function(){var c;a.Display.prototype.newShapeLayer=
a.Fabric.newShapeLayer;a.Image.prototype._selectShapes=a.Fabric._selectShapes;a.Image.prototype._updateShape=a.Fabric._updateShape;a.Image.prototype._parseShapeOptions=a.Fabric._parseShapeOptions;a.Image.prototype._exportShapeOptions=a.Fabric._exportShapeOptions;a.Image.prototype._handleChildText=a.Fabric._handleChildText;a.Image.prototype._addPolygonPoint=a.Fabric._addPolygonPoint;a.Image.prototype._removePolygonPoint=a.Fabric._removePolygonPoint;a.Image.prototype._updateMultiDialogs=a.Fabric._updateMultiDialogs;
a.Image.prototype.addShapes=a.Fabric.addShapes;a.Image.prototype.updateShapes=a.Fabric.updateShapes;a.Image.prototype.getShapes=a.Fabric.getShapes;a.Image.prototype.changeShapes=a.Fabric.changeShapes;a.Image.prototype.removeShapes=a.Fabric.removeShapes;a.Image.prototype.refreshShapes=a.Fabric.refreshShapes;a.Image.prototype.copyShapes=a.Fabric.copyShapes;a.Image.prototype.selectShapes=a.Fabric.selectShapes;a.Image.prototype.unselectShapes=a.Fabric.unselectShapes;a.Image.prototype.getShapeLayer=a.Fabric.getShapeLayer;
a.Image.prototype.showShapeLayer=a.Fabric.showShapeLayer;a.Image.prototype.activeShapeLayer=a.Fabric.activeShapeLayer;a.Image.prototype.displayShapeLayers=a.Fabric.displayShapeLayers;a.Image.prototype.toggleShapeLayers=a.Fabric.toggleShapeLayers;a.Image.prototype.print=a.Fabric.print;for(c in a.Fabric.opts)a.Fabric.opts.hasOwnProperty(c)&&(fabric.Object.prototype[c]=a.Fabric.opts[c])};a.Fabric.initGraphics();a.MouseTouch={};a.MouseTouch.CLASS="JS9";a.MouseTouch.NAME="MouseTouch";a.MouseTouch.WIDTH=
512;a.MouseTouch.HEIGHT=220;a.MouseTouch.BASE=a.MouseTouch.CLASS+a.MouseTouch.NAME;a.MouseTouch.mouseText=[];a.MouseTouch.mouseText[0]="Move mouse, no buttons pressed:";a.MouseTouch.mouseText[1]="Move mouse, primary button pressed:";a.MouseTouch.mouseText[2]="Move mouse, secondary button pressed:";a.MouseTouch.touchText=[];a.MouseTouch.touchText[0]="Touch move, with one finger:";a.MouseTouch.touchText[1]="Touch move, with two fingers:";a.MouseTouch.touchText[2]="Touch move, with three fingers:";a.MouseTouch.textHTML=
"<div style='float: left'>%s</div>";a.MouseTouch.actionHTML="<div style='float: left'><b>%s</b></div>";a.MouseTouch.actionid=function(a,b){return(a+"_"+b).replace(/[^A-Za-z0-9_]/g,"_")};a.MouseTouch.addText=function(c,b){b=sprintf(a.MouseTouch.textHTML,b);return $("<div>").addClass(a.MouseTouch.BASE+"Text").html(b).appendTo(c)};a.MouseTouch.addAction=function(c,b,d){b=a.MouseTouch.actionid(b,d);d=sprintf(a.MouseTouch.actionHTML,d);return $("<div>").addClass(a.MouseTouch.BASE+"Action").attr("id",b).html(d).appendTo(c)};
a.MouseTouch.isPinch=function(c,b){var d,e,f=a.globalOpts.pinchWait,h=a.globalOpts.pinchThresh;if(!c)return-1;b=c.display;if(!b.mousetouchZoom||2!==c.pos.touches.length)return-1;switch(b.ispinch){case -1:case 1:return b.ispinch}c=Math.sqrt((c.pos.touches[0].x-c.pos.touches[1].x)*(c.pos.touches[0].x-c.pos.touches[1].x)+(c.pos.touches[0].y-c.pos.touches[1].y)*(c.pos.touches[0].y-c.pos.touches[1].y));b.dist0||(b.dist0=c);b.deltas.push(Math.floor(c-b.dist0));if(b.deltas.length>=f){c=1;for(e=d=0;c<f;c++)b.deltas[c]>
b.deltas[c-1]?d++:b.deltas[c]<b.deltas[c-1]&&e++;b.ispinch=d>=h||e>=h?1:-1;b.lastzoom=0;return b.ispinch}return 0};a.MouseTouch.Actions={};a.MouseTouch.Actions["display value/position"]=function(c,b,d){!a.specialKey(d)&&a.globalOpts.internalValPos&&c&&b&&0<b.x&&0<b.y&&b.x<=c.raw.width&&b.y<=c.raw.height&&(c.valpos=c.updateValpos(b,!0))};a.MouseTouch.Actions["change contrast/bias"]=function(c,b,d){var e=c.display;a.globalOpts.internalContrastBias&&c&&b&&"static"!==c.cmapObj.type&&!(c.pos0&&c.pos&&
Math.abs(c.pos0.x-c.pos.x)<a.NOMOVE&&Math.abs(c.pos0.y-c.pos.y)<a.NOMOVE||c.clickInRegion||a.specialKey(d)||c.rgbFile)&&(d=a.eventToDisplayPos(d,c.posOffset),b=Math.floor(d.x+.5),d=Math.floor(d.y+.5),a.globalOpts.containContrastBias&&(0>b||0>d||b>=e.canvas.width||d>=e.canvas.height)||(c.params.bias=b/e.canvas.width,c.params.contrast=d/e.canvas.height*10,a.bugs.firefox_linux?window.setTimeout(function(){c.displayImage("scaled",{blendMode:!1})},0):c.displayImage("scaled",{blendMode:!1}),c.xeqStashDiscard("filterRGBImage"),
...
"").replace(/\n/g,"\\n")};if(c&&c.pub)var w=c.pub.wcsconfig&&c.pub.wcsconfig.wcssys?c.pub.wcsconfig.wcssys:this.params.wcssys;else w=this.params.wcssys,c=q;b=b||{};if(c.params.winid)var u=c.params.winid;else b.winid&&(u=b.winid);if(u){var t="#"+$(u).attr("id")+" .regionsConfigForm ";if($(t).length){n=$(t).data("multi")?!0:b.multi;$(t+"."+c.pub.shape).each(function(a,b){$(b).removeClass("nodisplay")});$(t+".val").each(function(b,m){h="";f=$(m).attr("name");switch(f){case "x":case "y":c.pub.lcs&&void 0!==
