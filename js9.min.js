...
a.helper.type))h.loadproxy={name:"open link via proxy ..."};h.print={name:"print ..."};h.header={name:"display FITS header"};h.pageid={name:"display pageid"};h.savefits={name:"save image as FITS"};h.savepng={name:"save image as PNG"};h.close={name:"close image"};h["sep"+f++]="------";h.lite={name:"new JS9 light window"};h.xnew={name:"new JS9 separate window"};2<a.DEBUG&&(h["sep"+f++]="------",h.refresh={name:"debug: refresh ..."});return{callback:function(b){d().forEach(function(d){var c,e;e=d.image;
