...
e,"=",f),b&&(h+="\n")}else if(a.BITPIX)for(e in d=a,d)if(d.hasOwnProperty(e)&&!("js9Protocol"===e||"js9Endian"===e))"END"===e&&(g=!0),f=d[e],!0===f&&(f="T"),h+=sprintf("%-8s%-2s%-70s",e,"=",f),b&&(h+="\n");g||(h+=sprintf("%-8s%-72s","END"," "),b&&(h+="\n"));return h};a.hdus2Str=function(a){var b,d,e,f="";if(!a)return f;for(b=0;b<a.length;b++){e=a[b];d=e.name?e.name:0===b?"Primary":"N/A";f+=sprintf("<b>hdu</b>: %d\t<b>name</b>: %s\t<b>type</b>: %s",e.hdu,d,e.type);switch(e.type){case "image":f+=sprintf("\t<b>bitpix</b>: %d\t<b>naxis</b>: %d",
