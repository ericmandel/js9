...
Math.PI),d=b.wcs2pix(this.raw.wcs,e.dval,d.dval).split(/ +/),e=parseFloat(d[0]),d=parseFloat(d[1])):"physical"===q?(d=this.logicalToImagePos({x:e.dval,y:d.dval}),e=d.x,d=d.y):(e=e.dval,d=d.dval);return[e,d]},F=function(a,c){var d=b.strtoscaled(a),e=this.raw.wcsinfo||{cdelt1:1,cdelt2:1};t||r?d.dtype&&"."!==d.dtype&&(d.dval=Math.abs(d.dval/e["cdelt"+c])):"physical"===q&&this.lcs&&this.lcs.physical&&(d.dval*=this.lcs.physical.forward[0][0]);return d.dval},H=function(a){a=b.strtoscaled(a);var c=this.raw.wcsinfo||
{crot:0};c.crot&&(a.dval+=c.crot);return a.dval};a=a.trim();if(!a.match(/(\(|\{|#|;|\n)/))return a;n=this.getWCSSys();m=this.getWCSUnits();q="physical";t="image"!==q&&"physical"!==q;h=a.split(/\n|;/);for(e=0;e<h.length;e++)if("#"!==h[e].trim().substr(0,1))if(r=!1,l=G(h[e]),p=l.args.length,l.isregion){k=$.extend(!0,{},l.opts);k.shape=l.cmd;2<=p&&(u=I.call(this,l.args[0],l.args[1]),k.x=u[0],k.y=u[1]);switch(l.cmd){case "annulus":k.radii=[];for(f=2;f<p;f++)k.radii.push(F.call(this,l.args[f],1));break;
case "box":3<=p&&(k.width=F.call(this,l.args[2],1));4<=p&&(k.height=F.call(this,l.args[3],2));5<=p&&(k.angle=H.call(this,l.args[4]));break;case "circle":3<=p&&(k.radius=F.call(this,l.args[2],1));break;case "ellipse":3<=p&&(k.r1=F.call(this,l.args[2],1));4<=p&&(k.r2=F.call(this,l.args[3],2));5<=p&&(k.angle=H.call(this,l.args[4]));break;case "line":case "polygon":k.pts=[];for(g=f=0;f<p;f+=2,g++)u=I.call(this,l.args[f],l.args[f+1]),k.pts[g]={x:u[0],y:u[1]};delete k.x;delete k.y;break;case "text":3<=
p&&(k.text=l.args[2].replace(/^['"]/,"").replace(/["']$/,"")),4<=p&&(k.angle=H.call(this,l.args[3]))}l.comment&&(k.tags=l.comment);d.push(k)}else l.cmd.match(w)?(this.setWCSSys(l.cmd),q=this.getWCSSys(),t="image"!==q&&"physical"!==q):"remove"!==l.cmd&&"delete"!==l.cmd||d.push({remove:!0});this.setWCSSys(n);this.setWCSUnits(m);return d};b.Regions.saveRegions=function(a,c,d){var e=sprintf("# Region file format: JS9 version 1.0");c=this.listRegions(c,{mode:1},d);e=sprintf("%s\n%s\n",e,c.replace(/; */g,
...
a);if(g.length){for(c=0;c<g.length;c++)for(h=g[c].tags,k="",f=0;f<h.length;f++)if(h[f]===b){k=h[f]=d;break}else if(h[f]===d){k=h[f]=b;break}k&&this.changeShapes("regions",a,{tags:h})}};b.Catalogs={};b.Catalogs.CLASS="JS9";b.Catalogs.NAME="Catalogs";b.Catalogs.opts={hasControls:!1,hasRotatingPoint:!1,hasBorders:!1,lockMovementX:!0,lockMovementY:!0,lockRotation:!0,lockScalingX:!0,lockScalingY:!0,lockUniScaling:!0,selectable:!1,canvas:{selection:!1},updateWCS:!1,panzoom:!0,shape:"circle",strokeWidth:2,
width:10,height:10,radius:5,eradius:{x:5,y:3},angle:0,tagcolors:{defcolor:"#00FF00"},sortOverlapping:!1};b.Crosshair={};b.Crosshair.CLASS="JS9";b.Crosshair.NAME="Crosshair";b.Crosshair.LAYERNAME="crosshair";b.Crosshair.opts={hasControls:!1,hasRotatingPoint:!1,hasBorders:!1,lockMovementX:!0,lockMovementY:!0,lockRotation:!0,lockScalingX:!0,lockScalingY:!0,lockUniScaling:!0,selectable:!1,canvas:{selection:!1},updateWCS:!1,panzoom:!1,strokeWidth:1,color:"#00FF00",sortOverlapping:!1,hiddenPts:{pts:[{x:-9999,
y:-9999},{x:-9999,y:-9900}]}};b.Crosshair.display=function(a,c,d){var e,f,g,h,k,l,n,m=b.Crosshair.LAYERNAME;if((/iPad|iPhone|iPod/.test(navigator.platform)||d.shiftKey)&&a&&!a.tmp.shiftKey&&a.crosshair&&a.params.crosshair&&(k=a.raw.width,l=a.raw.height,n=a.ipos.x,f=a.ipos.y,k={pts:[{x:0,y:f},{x:k,y:f}]},a.changeShapes(m,a.crosshair.h,k),l={pts:[{x:n,y:0},{x:n,y:l}]},a.changeShapes(m,a.crosshair.v,l),a.crosshair.visible=!0,b.globalOpts.wcsCrosshair&&a&&a.raw.wcs&&0<a.raw.wcs))for(f=b.pix2wcs(a.raw.wcs,
c.x,c.y).trim().split(/\s+/),g=b.saostrtod(f[0]),":"===String.fromCharCode(b.saodtype())&&"galactic"!==a.params.wcssys&&"ecliptic"!==a.params.wcssys&&(g*=15),h=b.saostrtod(f[1]),c=0;c<b.displays.length;c++)if((d=b.displays[c].image)&&d!==a&&d.crosshair&&d.params.crosshair&&0<d.raw.wcs){k=d.raw.width;l=d.raw.height;try{e=b.wcs2pix(d.raw.wcs,g,h)}catch(q){e=null}e&&(f=e.trim().split(/\s+/),n=parseFloat(f[0]),f=parseFloat(f[1]),0<n&&n<k&&0<f&&f<l&&(k={pts:[{x:0,y:f},{x:k,y:f}]},d.changeShapes(m,d.crosshair.h,
k),l={pts:[{x:n,y:0},{x:n,y:l}]},d.changeShapes(m,d.crosshair.v,l),d.crosshair.visible=!0))}};b.Crosshair.hide=function(a,c,d){c=b.Crosshair.LAYERNAME;d=b.Crosshair.opts.hiddenPts;a&&a.crosshair&&a.crosshair.visible&&(a.changeShapes(c,a.crosshair.h,d),a.changeShapes(c,a.crosshair.v,d),a.crosshair.visible=!1)};b.Crosshair.create=function(a){var c=b.Crosshair.opts.hiddenPts,d=b.Crosshair.LAYERNAME;a&&!a.crosshair&&0<a.raw.wcs&&(a.crosshair={},a.crosshair.h=a.addShapes(d,"line",c),a.crosshair.v=a.addShapes(d,
"line",c),a.crosshair.visible=!1)};b.Crosshair.keyaction=function(a,b,d){a&&d&&d.shiftKey&&(a.tmp.shiftKey=!0)};b.Crosshair.keyup=function(a,b,d){a&&a.tmp.shiftKey&&d&&!d.shiftKey&&delete a.tmp.shiftKey};b.Crosshair.init=function(){var a,c=b.Crosshair.LAYERNAME;for(a=0;a<b.displays.length;a++)b.displays[a].layers.crosshair||b.displays[a].newShapeLayer(c,b.Crosshair.opts);return this};b.Image.prototype.toggleCrosshair=function(){this.params.crosshair=!this.params.crosshair;this.params.crosshair||b.Crosshair.hide(this)};
b.Image.prototype.toggleWCSCrosshair=function(){b.globalOpts.wcsCrosshair=!b.globalOpts.wcsCrosshair};b.Grid={};b.Grid.CLASS="JS9";b.Grid.NAME="Grid";b.Grid.LAYERNAME="grid";b.Grid.opts={movable:!1,cover:"display",reduceDims:!0,strokeWidth:1,margin:0,stride:32,raLines:8,raSkip:0,raAngle:0,decLines:8,decSkip:0,decAngle:90,sexaPrec:1,degPrec:3,lineColor:"#00FFFF",labelColor:"#00FFFF",labelFontFamily:"Helvetica, sans-serif",labelFontSize:11,labelFontStyle:"normal",labelFontWeight:300,labelRAOffx:3,labelRAOffy:-1,
labelDecOffx:-14,labelDecOffy:6};b.Grid.limits=function(a,b,d,e){a=d-b;a=1<a?10:.1<a?100:.01<a?1E3:.001<a?1E4:1E-4<a?1E5:1E6;b=Math.floor(b*a)/a;d=Math.ceil(d*a)/a;return{lo:b,hi:d,inc:Math.ceil((d-b)/e*a)/a}};b.Grid.getLabel=function(a,c,d){var e,f,g=!1;switch(a.wcsunits){case "sexagesimal":"ra"===d&&"galactic"!==a.wcssys&&"ecliptic"!==a.wcssys&&(c/=15);c=b.saodtostr(c,":",a.sexaPrec);f=c.split(":");if(a.last[d])for(c="",e=0;e<f.length;e++)if(c&&(c+=":"),g||f[e]!==a.last[d][e])c+=f[e],g=!0;a.last[d]=
$.extend({},f);break;default:c=c.toFixed(a.degPrec)}c=c.replace(/0+$/,"");a=c.indexOf(".");0>a?c+=".0":a===c.length-1&&(c+="0");return c=c.replace(/:\.0/,":0.0")};b.Grid.display=function(a,c){var d,e,f,g,h,k,l,n,m,q,t,r,u,p,x,w,y,v,A,B,C,D;t=this.display;var z=this.raw;p=[{ra:0,dec:0},{ra:0,dec:0},{ra:0,dec:0},{ra:0,dec:0}];if(b.isNull(a))switch(this.tmp.gridStatus){case "inactive":case void 0:return!1;case "active":case "processing":return!0;default:return!0}this.removeShapes(b.Grid.LAYERNAME);if(!1===
...
a.display.displayPlugin("JS9MouseTouch")},b.Keyboard.Actions["toggle preferences plugin"]=function(a,b,d){a&&a.display.displayPlugin("JS9Preferences")},b.Keyboard.Actions["toggle shape layers plugin"]=function(a,b,d){a&&a.display.displayPlugin("JS9Layers")})};b.initAnalysis=function(){$(document).on("keyup keypress",".js9AnalysisForm",function(a){var b=$(this);if(13===(a.which||a.keyCode))return a.preventDefault(),(a=$(this).data("enterfunc"))&&b.find("[name='"+a+"']").click(),!1})};b.init=function(){var a;
window.HTMLCanvasElement&&JSON||b.error("your browser does not support JS9 (no HTML5 canvas and/or JSON). Please try a modern version of Firefox, Chrome, Safari, Opera, or IE.");window.hasOwnProperty("JS9Prefs")&&"object"===typeof JS9Prefs&&JS9Prefs.globalOpts&&JS9Prefs.globalOpts.installDir&&(b.INSTALLDIR=JS9Prefs.globalOpts.installDir);if(!b.INSTALLDIR){try{$('link[href$="js9.css"]').each(function(){var a=$(this).attr("href");a&&"js9.css"===a.split("/").reverse()[0]&&(b.INSTALLDIR=a.replace(/js9\.css$/,
""))})}catch(c){b.INSTALLDIR=""}b.INSTALLDIR&&(b.INSTALLDIR=b.cleanPath(b.INSTALLDIR))}b.INSTALLDIR&&"/"!==b.INSTALLDIR.slice(-1)&&(b.INSTALLDIR+="/");b.TOROOT=b.INSTALLDIR.replace(/([^\/.])+/g,"..");window.hasOwnProperty("JS9Inline")&&"object"===typeof JS9Inline&&(b.inline=$.extend(!0,{},JS9Inline));"dhtml"===b.LIGHTWIN&&($("<div>").attr("id","dhtmlwindowholder").appendTo($(document.body)).append("<span style='display:none'>.</span>"),dhtmlwindow.imagefiles=b.inline?[b.inline["images/min.gif"],b.inline["images/close.gif"],
b.inline["images/restore.gif"],b.inline["images/resize.gif"]]:b.allinone?[b.allinone.min,b.allinone.close,b.allinone.restore,b.allinone.resize]:[b.InstallDir("images/min.gif"),b.InstallDir("images/close.gif"),b.InstallDir("images/restore.gif"),b.InstallDir("images/resize.gif")],window.hasOwnProperty("Jupyter")&&$("#dhtmlwindowholder").arrive("input",function(){b.jupyterFocus($(this).parent())}));b.globalOpts.plotLibrary=b.globalOpts.plotLibrary||"flot";"plotly"!==b.globalOpts.plotLibrary||window.hasOwnProperty("Plotly")||
(b.globalOpts.plotLibrary="flot");window.hasOwnProperty("JS9Prefs")&&"object"===typeof JS9Prefs?b.mergePrefs(JS9Prefs):b.PREFSFILE&&(b.loadPrefs(b.InstallDir(b.PREFSFILE),1),b.loadPrefs(b.PREFSFILE,0));b.hasOwnProperty("Regions")&&$.extend(!0,b.Regions.opts,b.regionOpts);delete b.regionOpts;b.hasOwnProperty("Catalogs")&&$.extend(!0,b.Catalogs.opts,b.catalogOpts);delete b.catalogOpts;b.hasOwnProperty("Crosshair")&&$.extend(!0,b.Crosshair.opts,b.crosshairOpts);delete b.crosshairOpts;b.hasOwnProperty("Grid")&&
