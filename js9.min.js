...
2048,a.globalOpts.image.xdim=2048,a.globalOpts.image.ydim=2048,a.imageOpts.crosshair=!1,a.globalOpts.reproj={xdim:2048,ydim:2048},a.lightOpts.dhtml.regWin0="width=660px,height=130px,resize=1,scrolling=1",a.lightOpts.dhtml.regWin1="width=660px,height=200px,resize=1,scrolling=1",a.lightOpts.dhtml.regWin="width=660px,height=470px,resize=1,scrolling=1");({}).hasOwnProperty.call(window,"Jupyter")&&(a.globalOpts.useWasm=!1);if(window.electron&&(window.electron.hostFS&&(a.hostFS=window.electron.hostFS),
...
return{id:this.id,file:this.file,fits:this.fitsFile||"",source:this.source,imtab:this.imtab,width:this.raw.width,height:this.raw.height,bitpix:this.raw.bitpix,bin:this.binning.bin,header:this.raw.header,hdus:this.hdus,dwidth:this.display.width,dheight:this.display.height,fwidth:e,fheight:c,data:b}};a.Image.prototype.closeImage=function(c){var b,d,e=!1;var f=a.images.length;var g=a.Dysel.getDisplayOr(this.display);c=c||{};if("string"===typeof c)try{c=JSON.parse(c)}catch(h){a.error("can't parse closeImage opts: "+
c,h)}this.setStatus("close","closing");for(b=0;b<f;b++)a.images[b].wcsim===this&&(a.images[b].wcsim=null);for(b=0;b<f;b++)a.images[b].mask.im===this&&(a.images[b].mask.im=null,a.images[b].mask.active=!1);for(b=0;b<f;b++)if(this===a.images[b]){f=a.images[b];f===f.display.image&&(e=b+1);if(e)for(!1!==c.clear&&(f.display.clearMessage(),f.display.context.clear()),c=$jscomp.makeIterator(Object.keys(f.layers)),d=c.next();!d.done;d=c.next())d=d.value,"main"!==f.layers[d].dlayer.dtype&&f.display!==g||f.showShapeLayer(d,
!1,{local:!0});f.xeqPlugins("image","onimageclose");e&&(f.display.image=null);switch(f.cmapObj.name){case "red":f.display.rgb.rim=null;break;case "green":f.display.rgb.gim=null;break;case "blue":f.display.rgb.bim=null}for(g=0;g<f.raws.length;g++)c=f.raws[g],c.hdu&&c.hdu.fits&&(d=a.lookupVfile(c.hdu.fits.vfile),1>=d.length&&a.cleanupFITSFile(c,!0)),c.altwcs&&this.freeWCS(c);f.removeProxyFile();f.rgb=null;f.offscreen=null;f.raw=null;f.colorData=null;f.colorCells=null;f.psColors=null;f.psInverse=null;
a.images.splice(b,1);break}if(e){for(b=e-=2;0<=b;b--)if(f=a.images[b],this.display===f.display){f.displayImage("all");f.refreshLayers();e=a.images.length;break}for(b=a.images.length-1;b>e;b--)if(f=a.images[b],this.display===f.display){f.displayImage("all");f.refreshLayers();break}}};a.Image.prototype.mkOffScreenCanvas=function(){if(!this.png||!this.png.image)return this;this.offscreen={};this.offscreen.canvas=document.createElement("canvas");this.offscreen.canvas.setAttribute("width",this.png.image.width);
...
2===t.length&&("table"===this.imtab&&m.table?(m.table.bin=parseFloat(t[0]),m.table.binMode=t[1]):(m.bin=parseFloat(t[0]),m.binMode=t[1]))}catch(v){}this.binning.bin="table"===this.imtab&&m.table?m.table.bin||1:m.bin?0<m.bin?m.bin:1/Math.abs(m.bin):1;l||(this.binning.obin=this.binning.bin);u&&this.setWCSSys(u);x&&this.setWCSUnits(x);l&&l.header.CTYPE1&&l.header.CTYPE2&&this.raw.header.CTYPE1&&this.raw.header.CTYPE2&&(l.header.CTYPE1!==this.raw.header.CTYPE1||l.header.CTYPE2!==this.raw.header.CTYPE2)&&
...
[];for(h=0;h<g;h++)l[h]=0;for(h=0;h<r;h++)m[h]>=b&&m[h]<=n&&(p=Math.floor((m[h]-b)/k*g+.5),p<g&&(l[p]+=1));for(h=0;h<g;h++)u+=l[h];p=u/g;for(h=m=0;h<g&&m<g;h++)for(this.hist[h]=m/g,c+=l[h];c>=p&&m<g;)c-=p,m++;for(c=(g-1)/g;h<g;)this.hist[h++]=c}for(h=0;h<e;h++)c=this.hist[h*g/e],c=Math.floor(c*d),this.psColors[h]=this.colorCells[c];for(h=0;h<f;h++){d=h/f;for(p=0;p<g-1&&!(this.hist[p]>d);p++);c=p/g;this.psInverse[h]=c*k+b}break;default:a.error("unknown scale '"+this.params.scale+"'")}return this};
a.Image.prototype.mkRGBImage=function(){var c,b,d,e,f=!1,g=null,h=null,k=null,m=!1,l=!1,p=!1,r=!1,n=[];if(!this.rgb)return this;!this.display.rgb.active||this!==this.display.rgb.rim&&this!==this.display.rgb.gim&&this!==this.display.rgb.bim||(m=!0,this.display.rgb.rim&&(g=this.display.rgb.rim),this.display.rgb.gim&&(h=this.display.rgb.gim),this.display.rgb.bim&&(k=this.display.rgb.bim));var u=this.display.context;var x=this.rgb;var t=x.sect;if(this.MakeRGBImage&&"function"===typeof this.MakeRGBImage&&
this.MakeRGBImage()||this.MakePrimaryImage&&"function"===typeof this.MakePrimaryImage&&this.MakePrimaryImage())return this;if(this.useOffScreenCanvas()){var v=t.width/t.zoom;var w=t.height/t.zoom;var q=t.x0;var z=this.offscreen.canvas.height-1-(t.y0+w);z=this.offscreen.context.getImageData(q,z,v,w);if(1===t.zoom)x.img=z;else for(x.img=u.createImageData(t.width,t.height),x=x.img,d=c=0;c<z.height;c++,d++){var y=c*z.width;var A=d*t.zoom;for(b=u=0;u<z.width;u++,b++){q=4*(y+u);var C=b*t.zoom;for(e=0;e<
t.zoom;e++){var B=Math.floor(A+e);var D=B*t.width;for(B=0;B<t.zoom;B++){var E=Math.floor(C+B);E=4*(D+E);x.data[E]=z.data[q];x.data[E+1]=z.data[q+1];x.data[E+2]=z.data[q+2];x.data[E+3]=z.data[q+3]}}}}return this}x.img&&x.img.width===t.width&&x.img.height===t.height||(x.img=u.createImageData(t.width,t.height));x=x.img;var F=x.data.length-4;if(!this.psColors&&!this.staticObj)return this;var G=void 0!==this.params.opacity?Math.floor(255*this.params.opacity):void 0!==this.params.alpha?this.params.alpha:
255;if(this.mask.active&&this.mask.im){var J=this.mask.im;if("mask"===this.mask.mode){l=!0;var I=a.notNull(this.mask.vopacity)?255*this.mask.vopacity:0;var K=a.notNull(this.params.opacity)?255*this.params.opacity:255;this.mask.invert&&(G=I,I=K,K=G)}else if("opacity"===this.mask.mode)p=!0;else if("overlay"===this.mask.mode){r=!0;var L=J.rgb.img;a.isNull(this.mask.opacity)&&(this.mask.opacity=1)}}else if(a.notNull(this.params.flooropacity)&&!m){var R=255*this.params.flooropacity;var M=this.params.floorvalue;
f=!0}var N=Math.max(1,Math.floor(1/t.zoom));var P=t.zoom*N;c=Math.floor(t.y1-1);for(d=0;c>=t.y0;c-=N,d++)for(y=c*this.raw.width,A=d*P,u=Math.floor(t.x0),b=0;u<t.x1;u+=N,b++){l?G=J.raw.data[y+u]>this.mask.value?K:I:p&&(G=255*J.raw.data[y+u]);if(m){if(z=g?g.colorData[y+u]:0,v=h?h.colorData[y+u]:0,w=k?k.colorData[y+u]:0,a.isNull(z)||a.isNull(v)||a.isNull(w))return this.display.rgb.active=!1,a.error("RGB images are incompatible. Turning off RGB mode.","",!1),this.mkRGBImage(),this}else this.staticObj||
(q=this.colorData[y+u]);var Q=G;f&&this.raw.data[y+u]<=M&&(Q=R);C=b*P;for(e=0;e<t.zoom;e++)for(B=Math.ceil(A+e),D=B*t.width,B=0;B<t.zoom;B++)if(E=Math.ceil(C+B),E=4*(D+E),E<=F)if(m)x.data[E]=g?g.psColors[z][0]:0,x.data[E+1]=h?h.psColors[v][1]:0,x.data[E+2]=k?k.psColors[w][2]:0,x.data[E+3]=G;else if(this.staticObj){var H=this.raw.data[y+u];H=a.lookupStaticColor(this,H,n);x.data[E]=H.red;x.data[E+1]=H.green;x.data[E+2]=H.blue;x.data[E+3]=H.alpha}else if(void 0!==this.psColors[q])if(r&&L.data[E+3]){H=
L.data[E+3]/255*this.mask.opacity;var O=1-H;x.data[E]=L.data[E]*H+this.psColors[q][0]*O;x.data[E+1]=L.data[E+1]*H+this.psColors[q][1]*O;x.data[E+2]=L.data[E+2]*H+this.psColors[q][2]*O;x.data[E+3]=255}else x.data[E]=this.psColors[q][0],x.data[E+1]=this.psColors[q][1],x.data[E+2]=this.psColors[q][2],x.data[E+3]=Q}return this};a.Image.prototype.blendImage=function(c){for(var b=[],d=0;d<arguments.length;++d)b[d-0]=arguments[d];var e=$jscomp.makeIterator(b);d=e.next().value;var f=e.next().value;e=e.next().value;
...
e),this.raw.width===f.raw.width&&this.raw.height===f.raw.height||a.error("maskImage: mask dims ("+f.raw.width+","+f.raw.height+") don't match image dims ("+this.raw.width+","+this.raw.height+")"),this.mask.im=f,this.mask.active=!0);if(d){if("string"===typeof d)try{d=JSON.parse(d)}catch(g){a.error("can't parse JSON in maskImage: "+d,g)}b=$jscomp.makeIterator(Object.keys(d));for(e=b.next();!e.done;e=b.next())switch(e=e.value,e){case "opacity":this.mask.vopacity=d[e];break;default:this.mask[e]=d[e]}}!f||
d&&!1===d.sync||"function"!==typeof this.syncImages||this.syncImages(this.mask.syncops,[f]);(f||d)&&this.displayImage()};a.Image.prototype.calcDisplayOffsets=function(c){var b=this.rgb.sect;this.ix=(this.display.canvas.width-this.rgb.img.width)/2;this.iy=(this.display.canvas.height-this.rgb.img.height)/2;a.notNull(b.ix)&&(this.ix-=b.ix/2);a.notNull(b.iy)&&(this.iy+=b.iy/2);this.ix=Math.floor(this.ix);this.iy=Math.floor(this.iy);if(c&&this.wcsAlign()){var d=this.wcsim;c=d.rgb.sect;d=a.pix2pix(d,this,
d.getPan());var e=a.globalOpts.panWithinDisplay;a.globalOpts.panWithinDisplay=!0;this.tmp.ozoom=this.rgb.sect.ozoom;this.mkSection(d.x,d.y,c.zoom);this.rgb.sect.ozoom=this.tmp.ozoom;delete this.tmp.ozoom;a.globalOpts.panWithinDisplay=e;this.ix-=(b.xcen-(b.x0+b.x1)/2)*c.zoom;this.iy+=(b.ycen-(b.y0+b.y1)/2)*c.zoom}return this};a.Image.prototype.putImage=function(c){var b=this,d=this.rgb,e=this.display.context;c=c||{};"reproject"===this.rawDataLayer()&&c.wcsim&&(this.wcsim=c.wcsim,this.wcsim.isawcsim=
!0);this.calcDisplayOffsets(!0);e.save();void 0!==c.opacity&&(e.globalAlpha=c.opacity);void 0!==c.blend&&(e.globalCompositeOperation=c.blend);if(this.params.transform){c=this.params.transform;var f=this.display.width/2;var g=this.display.height/2;e.translate(f,g);e.transform(c[0][0],c[0][1],c[1][0],c[1][1],c[2][0],c[2][1]);e.translate(-f,-g)}e.drawImage(function(c){if(!b.offscreenRGB){var d=document.createElement("canvas");var e=d.getContext("2d");a.ANTIALIAS||(e.imageSmoothingEnabled=!1);b.offscreenRGB=
{canvas:d,context:e}}b.offscreenRGB.canvas.width=c.width;b.offscreenRGB.canvas.height=c.height;b.offscreenRGB.context.putImageData(c,0,0);return b.offscreenRGB.canvas}(d.img),this.ix,this.iy);e.restore();return this};a.Image.prototype.displayImage=function(c,b){var d=0;var e=[],f={};if(!1===c)return this.displayMode=!1,this;!0===c&&(this.displayMode=!0,c="all");if(!this.displayMode)return this;"object"===typeof c&&(b=c,c=null);c?"all"===c?(c="colors,scaled,rgb,display,plugins",f.notify=!0):"rgbonly"===
c?(c="rgb,nodisplay",f.notify=!0):"display"===c&&(f.notify=!0):c="rgb";c.split(",").forEach(function(a,b,c){a=a.trim();f[a]=!0;switch(a){case "colors":f.scaled=!0;f.rgb=!0;break;case "scaled":f.rgb=!0}});f.display=!0;f.plugins=!0;this.useOffScreenCanvas()&&(f.colors=!1,f.scaled=!1);b=b||{};if("string"===typeof b)try{b=JSON.parse(b)}catch(h){a.error("can't parse displayImage opts: "+b,h)}if(this.display.blendMode&&!1!==b.blendMode)for(c=0;c<a.images.length;c++){var g=a.images[c];g.display===this.display&&
...
d.raw.id,m.onrefresh=m.ondisplaysection||m.onrefresh||b,d.refreshImage(c,m);d.setStatus("displaySection","complete");a.waiting(!1)};this.raw&&this.raw.hdu&&this.raw.hdu.fits||a.error("invalid image for displaySection");c=c||{};if("full"===c){var n=this.fileDimensions();c={xdim:n.xdim,ydim:n.ydim,xcen:0,ycen:0}}else{if("selected"===c){this._selectShapes("regions","selected",null,function(a){a=a.pub;var c,e=0,f=0,g=1E6,h=0,l=1E6,k=0,n=a.shape;if(!d.parentFile&&a.lcs){a=a.lcs;var r=a.x;var p=a.y;if(c=
d.maybePhysicalToImage({x:r,y:p}))r=c.x,p=c.y}else r=a.x,p=a.y;switch(n){case "annulus":var u=2*a.radii[a.radii.length-1];var x=2*a.radii[a.radii.length-1];break;case "box":u=a.width;x=a.height;break;case "circle":u=2*a.radius;x=2*a.radius;break;case "cross":u=a.width;x=a.height;break;case "ellipse":u=2*a.r1;x=2*a.r2;break;case "polygon":case "line":for(u=0;u<a.pts.length;u++)e+=a.pts[u].x,f+=a.pts[u].y,a.pts[u].x>h&&(h=a.pts[u].x),a.pts[u].x<g&&(g=a.pts[u].x),a.pts[u].y>k&&(k=a.pts[u].y),a.pts[u].y<
l&&(l=a.pts[u].y);a.x=e/a.pts.length;a.y=f/a.pts.length;"line"===a.shape&&2===a.pts.length?(u=Math.sqrt((a.pts[0].x-a.pts[1].x)*(a.pts[0].x-a.pts[1].x)+(a.pts[0].y-a.pts[1].y)*(a.pts[0].y-a.pts[1].y)),x=1):(u=h-g,x=k-l);break;case "text":x=u=10}m={xcen:r,ycen:p,xdim:u,ydim:x,from:"virtualFile",separate:!0,refreshRegions:!1,resetSection:!0};d.displaySection(m,b)});return}if("string"===typeof c)try{c=JSON.parse(c)}catch(v){a.error("can't parse displaySection opts: "+c,v)}}c.cubecol=c.cubecol||"";if(c.cubecol){var u=
this.file.split("/").reverse()[0].replace(/\[.*\]/,"").replace(".fits","_cube_"+c.cubecol+".fits").replace(/\.ftz$/,"_cube_"+c.cubecol+".fits").replace(/\.gz$/,"").replace(/\.bz2$/,"").replace(/:/g,"_");c.file||(c.file=u);c.id||(c.id=u);!1!==c.separate&&(c.separate=!0)}var x=c.separate?$.extend(!0,{},this.raw.hdu):this.raw.hdu;(f=c.from)||(f=this.parentFile&&a.helper.connected&&a.helper.js9helper?"parentFile":"virtualFile");if("table"===this.imtab&&x.table)n=x.table;else{n={};n.bin=x.bin||1;"parentFile"===
f&&this.raw.header&&a.notNull(this.raw.header.LTM1_1)&&(n.bin=1/Math.abs(this.raw.header.LTM1_1));var t={x:this.raw.width/2,y:this.raw.height/2};t=this.imageToLogicalPos(t);n.xcen=Math.floor(t.x+.5*(n.bin-1));n.ycen=Math.floor(t.y+.5*(n.bin-1));if(t=this.maybePhysicalToImage({x:n.xcen,y:n.ycen}))n.xcen=t.x,n.ycen=t.y;n.xdim=Math.floor(x.naxis1*n.bin);n.ydim=Math.floor(x.naxis2*n.bin);n.filter=this.raw.filter||"";n.columns=this.raw.columns||""}if("string"===typeof c.bin)switch(c.bin.match(/[as]$/)&&
(c.binMode=c.bin.slice(-1),c.bin=c.bin.slice(0,-1)),t=n.bin||this.binning.bin,c.bin.charAt(0)){case "*":case "x":case "X":c.bin=t*parseFloat(c.bin.slice(1));break;case "/":c.bin=t/parseFloat(c.bin.slice(1));break;case "i":case "I":c.bin=2*t;break;case "o":case "O":c.bin=t/2;break;default:a.isNumber(c.bin)?c.bin=parseFloat(c.bin):a.error("invalid bin for displaySection: "+c.bin)}c.xcen=p(c.xcen,n.xcen,0);c.ycen=p(c.ycen,n.ycen,0);switch(this.imtab){case "table":c.xdim=p(c.xdim,n.xdim,a.fits.options.table.xdim);
...
!1,m.fixpath=!1,a.Load(c,m,{display:e.display}));break;case "regions":if((l=m.stdout.split(/\s+/))&&l[0]){if(1<l.length)try{g=JSON.parse(l[1])}catch(r){g=null}g=g||{};"boolean"===typeof g.remove&&(g.remove="all");"string"===g.type?(g.remove&&e.removeShapes("regions",g.remove),e.addShapes("regions",l[0],b)):(c=a.cleanPath(l[0]),"/"!==c.charAt(0)&&(c=a.InstallDir(c)),h={responseType:"text"},a.fetchURL(null,c,h,function(a,b){g.remove&&e.removeShapes("regions",g.remove);e.addShapes("regions",a,b)}))}break;
case "catalog":(l=m.stdout.split(/\s+/))&&l[0]&&(c=a.cleanPath(l[0]),h={responseType:"text"},a.fetchURL(null,c,h,function(a,b){e.loadCatalog(null,a,b)}));break;case "none":break;default:a.error("unknown analysis result type: "+f.rtype)}}e.setStatus("runAnalysis","complete");a.waiting(!1)});return this}a.error("could not find analysis task: "+c)}};a.Image.prototype.displayAnalysis=function(c,b,d){var e=this,f,g;var h=a.lightOpts[a.LIGHTWIN];var k=function(){var b=a.Plot.opts.title;if(n&&u){$(a.lightOpts[a.LIGHTWIN].topid).arrive("#plotConfigForm",
{onceOnly:!0},function(){a.Plot.initConfigForm.call(e,u,r)});var c=a.allinone?a.allinone.plotConfigHTML:a.InstallDir(a.Plot.opts.configURL);u.winid=e.displayAnalysis("params",c,{title:b,winformat:"width=368px,height=110px,resize=1,scrolling=1"})}};d=d||{};if("string"===typeof d)try{d=JSON.parse(d)}catch(x){a.error("can't parse displayAnalysis opts: "+d,x)}var m=d.winformat;d.divid&&0<$("#"+d.divid).length&&(f=$("#"+d.divid));var l=d.title||"";this&&!l&&(d=this.fitsFile||this.id||"",d=d.split("/").reverse()[0],
...
"  "),d.object+="(",this.telescope&&(d.object+=this.telescope,this.instrument&&(d.object+=", ")),this.instrument&&(d.object+=this.instrument),d.object+=")";if(this.validWCS()&&a.isWCSSys(this.params.wcssys)&&(c=a.pix2wcs(this.raw.wcs,c.x,c.y).trim().split(/\s+/),p=c[0]+" "+c[1]+" ("+(c[2]||"wcs")+")",p=e+"&nbsp;&nbsp;&nbsp;&nbsp;"+p+"&nbsp;&nbsp;&nbsp;&nbsp;"+l,d.ra=c[0],d.dec=c[1],d.wcspos=c[0]+"\t "+c[1],d.wcssys=c[2],this.raw.wcsinfo)){c=Math.abs(this.raw.wcsinfo.cdelt1);h=Math.abs(this.raw.wcsinfo.cdelt2);
...
this.id&&(c===e&&(f=d),b===e&&(g=d),e++),a.notNull(f)&&a.notNull(g)){a.images.splice(g,0,a.images.splice(f,1)[0]);break}};a.Command=function(c){var b,d=$jscomp.makeIterator(Object.keys(c));for(b=d.next();!b.done;b=d.next())b=b.value,this[b]=c[b];c.name||a.error("command has no name");c.get||c.set||a.error("command requires get and/or set routine");a.commands.push(this);1<a.DEBUG&&a.log("JS9 command:  %s",this.name)};a.Command.prototype.getDisplayInfo=function(a){a&&a.id&&(this.display=a,this.image=
a.image);return this};a.Command.prototype.getWhich=function(a){return this.get&&!this.set?"get":this.set&&!this.get?"set":this.which?this.which(a):0===a.length?"get":"set"};a.Helper=function(){"file:"===a.globalOpts.helperProtocol&&(a.globalOpts.helperProtocol="http:");document.domain&&"localhost"!==document.domain||(a.globalOpts.htimeout=a.globalOpts.lhtimeout);a.globalOpts.helperProtocol.match(/\/\/$/)||(a.globalOpts.helperProtocol+="//");this.helper=this.connected=!1;this.type=a.allinone&&!a.globalOpts.allinoneHelper?
"none":a.globalOpts.helperType||"sock.io";this.pageid=null;this.connect()};a.Helper.prototype.connectinfo=function(){if(null===a.helper.connected)return"notConfigured";if(a.helper.connected){var c="connected "+a.helper.type+" "+a.helper.url;a.helper.pageid&&(c+="<p>"+a.helper.pageid);return c}return"notConnected "+a.helper.type};a.Helper.prototype.connect=function(c){var b=this,d=a.globalOpts.ehretries,e=a.globalOpts.ehtimeout,f=function(c,d){b.connected=!1;b.helper=!1;b.ready=!0;$(document).trigger("JS9:helperReady",
...
function(){var c;b.connected=!0;b.helper=!0;var d=[];for(c=0;c<a.displays.length;c++)d.push(a.displays[c].id);b.socket.emit("initialize",{displays:d,pageid:b.pageid},function(c){b.pageid=c.pageid;b.js9helper=c.js9helper;a.globalOpts.dataPathModify=c.dataPathModify;b.ready=!0;$(document).trigger("JS9:helperReady",{type:"socket.io",status:"OK"});a.DEBUG&&a.log("JS9 helper: connect: "+b.type)});$(document).trigger("JS9:connected",{type:"socket.io",status:"OK"})}),b.socket.on("connect_error",function(){b.connected=
!1;b.helper=!1;1<a.DEBUG&&a.log("JS9 helper: connect error")}),b.socket.on("connect_timeout",function(){b.connected=!1;b.helper=!1;1<a.DEBUG&&a.log("JS9 helper: connect timeout")}),b.socket.on("disconnect",function(c){b.connected=!1;b.helper=!1;1<a.DEBUG&&a.log("JS9 helper: disconnect: "+c);"io server disconnect"===c&&(1<a.DEBUG&&a.log("JS9 helper: manual reconnect"),b.socket.connect())}),b.socket.on("reconnect",function(){b.connected=!0;b.helper=!0;1<a.DEBUG&&a.log("JS9 helper: reconnect")}),b.socket.on("msg",
...
d,l)}var h=f.canvas;var k=this.display.layers[c];if(a.isNull(b))return f.show;if(!0===b||"true"===b){if(!d.local&&(f.show=!0,this!==this.display.image))return;f.show&&(h.selection=f.opts.canvas.selection);f.json&&f.show&&h.loadFromJSON(f.json,function(){var b,d;a.Fabric.updateChildren(f.dlayer,null,"objects");e.resize&&(h.getObjects().forEach(function(a){a.left+=e.resize.left;a.top+=e.resize.top;a.setCoords()}),h.calcOffset());f.zindex=Math.abs(f.zindex);k.divjq.css("z-index",f.zindex);var g=$jscomp.makeIterator(Object.keys(e.layers));
for(b=g.next();!b.done;b=g.next())if(b=b.value,c!==b&&e.layers[b].show&&(b=e.display.layers[b],b.divjq.css("z-index")<f.zindex&&(d=b.canvas.getActiveObject())))a.Fabric.removePolygonAnchors(b,d),b.canvas.getActiveObject()&&b.canvas.discardActiveObject();e.restoreSelection(c)});d=$jscomp.makeIterator(Object.keys(this.layers));for(b=d.next();!b.done;b=d.next())b=b.value,this.layers[b].json&&g++;g||(this.resize=null);this.xeqPlugins("shape","onshapelayershow",c)}else{if(!d.local&&this!==this.display.image){f.show=
!1;return}if(f.show){g=h.getObjects();for(b=g.length;b--;){var m=g[b];m.params&&(m.params.winid&&(m.params.winid.close(),m.params.winid=null),m.params.anchors&&a.Fabric.removePolygonAnchors(f.dlayer,m))}g=h.toJSON(f.dlayer.el);f.json=JSON.stringify(g);this.saveSelection(c);h.selection=!1;k&&(f.zindex=-Math.abs(f.zindex),k.divjq.css("z-index",f.zindex));h.clear()}d.local||(f.show=!1);this.xeqPlugins("shape","onshapelayerhide",c)}return this}};a.Fabric.displayShapeLayers=function(){var a;if(this!==
this.display.image){if(this.display.image&&this.display.image.layers){var b=$jscomp.makeIterator(Object.keys(this.display.image.layers));for(a=b.next();!a.done;a=b.next())a=a.value,this.display.image.showShapeLayer(a,!1,{local:!0})}if(this.layers)for(b=$jscomp.makeIterator(Object.keys(this.layers)),a=b.next();!a.done;a=b.next())a=a.value,this.showShapeLayer(a,!0,{local:!0})}};a.Fabric.toggleShapeLayers=function(){var a,b;if(this.toggleLayers){var d=$jscomp.makeIterator(Object.keys(this.layers));for(a=
d.next();!a.done;a=d.next())a=a.value,(b=this.layers[a])&&this.toggleLayers[a]&&this.showShapeLayer(a,!0);delete this.toggleLayers}else for(this.toggleLayers={},d=$jscomp.makeIterator(Object.keys(this.layers)),a=d.next();!a.done;a=d.next())a=a.value,"crosshair"!==a&&(b=this.layers[a])&&b.show&&"main"===b.dlayer.dtype&&(this.toggleLayers[a]=!0,this.showShapeLayer(a,!1))};a.Fabric.getShapeLayer=function(a,b){if(!a)return null;var c=this.layers[a];if(!c){b=this.display.layers[a];if(!b)return null;this.layers[a]=
{};c=this.layers[a];c.show=!0;c.nshape=0;c.dlayer=b;c.opts=c.dlayer.opts;c.canvas=c.dlayer.canvas;c.canvas.calcOffset()}return c};a.Fabric.activeShapeLayer=function(a){var b,c;if(a)if($.isArray(a)){var e=0;for(b=this.zlayer-1;e<a.length;e++){var f=this.layers[a[e]];"main"===f.dlayer.dtype&&(f.zindex=b--,f.show?c||(c=a[e]):f.zindex=-f.zindex,f.dlayer.divjq.css("z-index",f.zindex))}a=c}else{if((f=this.layers[a])&&f.show){c=f.zindex;f.zindex=this.zlayer-1;f.dlayer.divjq.css("z-index",f.zindex);var g=
$jscomp.makeIterator(Object.keys(this.layers));for(e=g.next();!e.done;e=g.next())e=e.value,b=this.layers[e],b!==f&&b.zindex===f.zindex&&"main"===b.dlayer.dtype&&(b.zindex=c,b.dlayer.divjq.css("z-index",b.zindex));this.xeqPlugins("shape","onshapelayeractive",a)}a=this}else{a=$jscomp.makeIterator(Object.keys(this.layers));for(e=a.next();!e.done;e=a.next())e=e.value,b=this.layers[e],"main"===b.dlayer.dtype&&(void 0===f||b.zindex>f)&&(f=b.zindex,c=e);a=c}return a};a.Fabric._parseShapeOptions=function(c,
b,d){var e,f={},g={};if(b.remove)return{remove:b.remove};var h=b.parent||d&&d.params&&d.params.parent;delete b.parent;b.restoreid||delete b.id;delete b.restoreid;g.tags=[];if(b.tags)if("string"===typeof b.tags){var k=b.tags.toLowerCase().split(",");for(e=0;e<k.length;e++)g.tags[e]=k[e].trim()}else if($.isArray(b.tags))for(e=0;e<b.tags.length;e++)g.tags[e]=b.tags[e].trim();if(a.notNull(b.angle)){if(!h)switch(b.shape){case "box":case "cross":case "ellipse":case "text":if(this.raw.wcsinfo)this.raw.wcsinfo.crot&&
(b.angle+=this.raw.wcsinfo.crot);else if(a.notNull(this.raw.header.LTM1_1)||a.notNull(this.raw.header.LTM1_2)){try{var m=Math.atan((this.raw.header.LTM1_2||0)/(this.raw.header.LTM1_1||0))}catch(u){m=0}m&&(m=180*-m/Math.PI,b.angle+=m)}a.notNull(this.params.transformAngle)&&(b.angle+=this.params.transformAngle);a.notNull(this.params.transformScale)&&(b.angle*=this.params.transformScale)}f.angle=-b.angle}void 0!==b.dx&&void 0!==b.dy&&(f.left=b.dx,f.top=b.dy);void 0!==b.x&&void 0!==b.y&&(m=this.imageToDisplayPos(b),
f.left=m.x,f.top=m.y);void 0!==b.px&&void 0!==b.py&&(m=this.logicalToDisplayPos({x:b.px,y:b.py}),f.left=m.x,f.top=m.y);"string"===typeof b.wcs&&(m=b.wcs.trim().split(/ +/),b.ra=m[0],b.dec=m[1],3<=m.length&&(b.wcssys=m[2]));if(this.validWCS()&&a.notNull(b.ra)&&a.notNull(b.dec)){if(b.wcssys){var l=this.getWCSSys();var p=a.globalOpts.xeqPlugins;a.globalOpts.xeqPlugins=!1;this.setWCSSys(b.wcssys,!1)}else b._wcssys&&(l=this.getWCSSys(),p=a.globalOpts.xeqPlugins,a.globalOpts.xeqPlugins=!1,this.setWCSSys(b._wcssys,
...
"").split(","),p=e=0;e<g.radii.length;e++)""!==g.radii[e]&&(b.sizeScale&&(g.radii[e]*=b.sizeScale),g.radii[p++]=this.wcs2imlen(g.radii[e]));else{if(g.radii=b.radii,b.sizeScale)for(e=0;e<g.radii.length;e++)g.radii[e]*=b.sizeScale}else for(b.ireg&&a.SCALEIREG&&(a.notNull(b.iradius)&&(b.iradius/=c),a.notNull(b.oradius)&&(b.oradius/=c)),b.sizeScale&&(a.notNull(b.iradius)&&(b.iradius*=b.sizeScale),a.notNull(b.oradius)&&(b.oradius*=b.sizeScale)),c=(b.oradius-b.iradius)/b.nannuli,l=b.nannuli+1,e=0;e<l;e++)p=
...
f.text=n.text||"Double-click to add text here";n.fill=n.stroke;n.strokeWidth=0;m=new fabric.Text(f.text,n);break;default:a.error("unknown shape: "+u.shape)}k.add(m);f.layerName=c;f.sw1=Math.max(1,Math.floor(m.strokeWidth+.5));f.listonchange=!1;m.params=f;u="main"!==this.display.layers[c].dtype||m.params.preservedcoords?1:this.rgb.sect.zoom;if(e.opts.panzoom)switch(f.shape){case "point":case "text":break;default:m.scale(u)}m.rescaleBorder();!1===m.params.changeable&&k.sendToBack(m);this._handleChildText(c,
m,n);"TBD"!==d.parent&&this._updateShape(c,m,null,"add",f);if(d.onaddshapes&&m.pub)try{a.xeqByName(d.onaddshapes,this,this,m.pub)}catch(w){a.error("in onaddshapes callback",w,!1)}g.push(m);n.groupid&&(h[n.groupid]=h[n.groupid]||[],h[n.groupid].push(m))}}e=$jscomp.makeIterator(Object.keys(h));for(b=e.next();!b.done;b=e.next())b=b.value,this.groupShapes(c,h[b],{groupid:b,select:!1});(void 0===f.redraw||f.redraw)&&k.renderAll();return"object"===d.rtn?m:"objs"===d.rtn?g:f.id}}}};a.Fabric._parseShapes=
function(c,b,d){var e=this;if(!this.layers||!c||!this.layers[c])return null;var f=this.layers[c].canvas;d=d||{};a.tmp.regSelect={layer:c,im:this,all:[]};f.getObjects().forEach(function(b){b.params?b.params.parent||a.tmp.regSelect.all.push(b.params.id):"group"===b.type&&(b=e.lookupGroup(b))&&a.tmp.regSelect.all.push(b)});try{regSelect.parse(b)}catch(g){a.error("parsing selection filter: "+b,g)}if(d.saveselection&&b)switch(b.trim()){case "all":case "saved":case "selected":break;default:this.layers[c].selection=
b}b=a.tmp.regSelect.ids;delete a.tmp.regSelect;return b};a.Fabric._selectShapes=function(c,b,d,e){var f=this,g,h,k,m=[],l=function(a,b){0>$.inArray(a,m)&&(e.call(f,a,b),m.push(a))},p=function(a){var b;if(!a)return[];var c=a.length;do{for(b=0;c--;){var d=a[c];"group"!==d.type||d.params||(a.splice.apply(a,[c,1].concat($jscomp.arrayFromIterable(d.getObjects()))),b++)}c=a.length}while(b);return a},r=function(a,b){var c,d,e=[],f=[];var g=b.length;for(c=0;c<g;c++){var h=b[c];("activeSelection"===h.type||
"group"===h.type&&!h.params)&&e.push(h)}var k=e.length;(d=a.getActiveObject())&&("activeSelection"===d.type||"group"===d.type&&!d.params||(d=null));if(k||d)for(c=0;c<g;c++){var l=b[c];for(a=0;a<k;a++)h=e[a],h.contains(l)&&(f[c]=h);f[c]||d&&d.contains(l)&&(f[c]=d)}return f},n=function(a,b){var c;for(c=0;c<b.length;c++){var d=b[c];if("activeSelection"===d.type||"group"===d.type&&!d.params){if(d.contains(a))return d}else if(d.params&&d===a)return v[c]}return null};if(!this.layers||!c||!this.layers[c])return null;
"function"!==typeof e&&a.error("selectShapes requires a callback");d=d||{};var u=this.layers[c].canvas;b||(b=u.getActiveObject()&&"auto"===a.globalOpts.regWhichDefault?"selected":"all");if("string"===typeof b&&b.startsWith("["))try{b=JSON.parse(b)}catch(y){a.error("can't parse array selection")}if("string"===typeof b){if(this.layers[c].selection){if("and"===d.saved)b="(saved) && ("+b+")";else if("or"===d.saved||!0===d.saved)b="(saved) || ("+b+")";b=b.replace(/saved/gi,this.layers[c].selection)}if(b.match(/&|\||!/))b=
this._parseShapes(c,b,d);else if(d.saveselection&&b)switch(b.trim()){case "all":case "saved":case "selected":break;default:this.layers[c].selection=b}}$.isArray(b)||(b=[b]);for(h=0;h<b.length;h++){var x=u.getObjects().reverse();var t=x.length;var v=r(u,x);var w=b[h];"string"===typeof w&&/^[1-9]\d*$/.test(w)&&(w=parseInt(w,10));var q={group:null,canvas:u,layer:c};switch(typeof w){case "object":t=p(x);for(g=t.length;g--;)if((k=t[g])&&k.params&&k===w){q.group=n(k,x);l(k,q);break}break;case "number":t=
p(x);for(g=t.length;g--;)if((k=t[g])&&k.params&&k.params.id===w){q.group=n(k,x);l(k,q);break}break;case "string":if("selected"===w)for(t=p(u.getActiveObjects()),g=t.length;g--;)k=t[g],q.group=n(k,x),k.params&&!k.params.parent&&l(k,q);else for(;t--;)if(k=x[t],"group"===k.type&&!k.params)w===this.lookupGroup(k)||"all"===w.toLowerCase()?(q.group=k,!1!==d.transparentgroup?k.forEachObject(function(a){a.params&&!a.params.parent&&l(a,q)}):l(k,q)):k.forEachObject(function(a){a.params&&w===a.params.file&&
l(a,q)});else if(k.params&&(g=k.stroke.toLowerCase(),!k.params.parent||"child"===w||"All"===w)&&("child"!==w||k.params.parent))if(q.group=v[t],"all"===w.toLowerCase())l(k,q);else if(w.toLowerCase()===g||a.colorToHex(w).toLowerCase()===g)l(k,q);else if(w===k.params.shape)l(k,q);else if(w===k.params.file)l(k,q);else if("object"===typeof k.params.data&&w===k.params.data.syncid)l(k,q);else if("child"===w&&k.params.parent)l(k,q);else if("dcoords"===w&&k.params.preservedcoords)l(k,q);else if("nodcoords"===
w&&!k.params.preservedcoords)l(k,q);else if("parent"===w&&k.params.children&&k.params.children.length)l(k,q);else if(0<=$.inArray(w,a.wcssyss)&&k.params.wcsconfig&&k.params.wcsconfig.wcssys===w)l(k,q);else if(k.params.tags)for(g=0;g<k.params.tags.length;g++){var z=k.params.tags[g];w.match(/^\/.*\/$/)&&z.match(new RegExp(w.slice(1,-1)))?l(k,q):w===z&&l(k,q)}}}return this};a.Fabric.selectShapes=function(c,b,d){var e,f=[];if(e=this.getShapeLayer(c)){var g=e.canvas;d=d||{};if("string"===typeof d)try{d=
JSON.parse(d)}catch(h){a.error("can't parse selectShapes opts: "+d,h)}a.isNull(d.transparentgroup)&&(d.transparentgroup=!1);a.isNull(d.saveselection)&&(d.saveselection=!0);b=b||"all";if("reset"===b)return delete e.selection,!1!==d.activateselection&&(g.getActiveObject()&&g.discardActiveObject(),g.renderAll()),this;this._selectShapes(c,b,d,function(a){!(0>$.inArray(a,f))||a.params&&a.params.groupid||f.push(a)});f.length&&(g.getActiveObject()&&g.discardActiveObject(),c=1===f.length?f[0]:new fabric.ActiveSelection(f,
...
var m=a.strtoscaled(k[1]);h.ra=l.dval;h.dec=m.dval;if(!1!==g.updateWCS&&(g.updateWCS||c.opts.updateWCS)){h.wcsstr=a.reg2wcs(b,e,a.REGSIZE).replace(/;$/,"");"line"===d.shape&&f&&(h.wcsstr=h.wcsstr.replace(/} *$/,f+"}"));k=h.wcsstr.replace(/.*\(/,"").replace(/\).*/,"").split(",");for(b=0;b<k.length;b++)k[b]=k[b].trim();h.wcsposstr=[k[0],k[1]];switch(d.shape){case "annulus":h.wcssizestr=[k[k.length-1]];break;case "box":case "cross":h.wcssizestr=[k[2],k[3]];break;case "circle":h.wcssizestr=[k[2]];break;
case "ellipse":h.wcssizestr=[k[2],k[3]];break;case "line":case "polygon":for(h.wcspts=[],b=0;b<k.length;b+=2)l=a.strtoscaled(k[b]),a.isHMS(h.wcssys,l.dtype)&&(l.dval*=15),m=a.strtoscaled(k[b+1]),h.wcspts.push({ra:l.dval,dec:m.dval})}}};if(b&&b.params){d=d||{};f=f||{};e=e||"update";var x="main"!==this.display.layers[c].dtype||b.params.preservedcoords?1:this.rgb.sect.zoom;l.mode=e;l.id=b.params.id;l.groupid=b.params.groupid;l.shape=b.params.shape;l.layer=c;l.color=b.color||b.stroke;l.tags=b.params.tags;
l.sticky=b.params.sticky;l.preservedcoords=b.params.preservedcoords;b.params.ignore&&(l.ignore=!0);l.parent=b.params.parent?b.params.parent.obj.params.id:null;l.child=b.params.children&&b.params.children.length?b.params.children[0].id:null;var t=b.getCenterPoint();var v={x:0,y:0};if(d.group&&(v=d.group.getCenterPoint(),t={x:v.x+t.x*d.group.scaleX,y:v.y+t.y*d.group.scaleY},d.group.angle&&(t=a.rotatePoint(t,d.group.angle,v)),"activeSelection"!==d.group.type)){if((m=p.canvas.getActiveObject())&&"activeSelection"===
m.type){var w=m.getObjects();var q=w.length;for(h=0;h<q;h++)if(w[h]===d.group){var z=m.getCenterPoint();break}}z||(m=null);m&&(t={x:z.x+t.x*m.scaleX,y:z.y+t.y*m.scaleY},m.angle&&(t=a.rotatePoint(t,m.angle,z)))}l.preservedcoords&&(l.dx=t.x,l.dy=t.y);h=this.displayToImagePos(t);l.x=h.x;l.y=h.y;l.lcs=this.imageToLogicalPos(h);"export"!==e&&b.params.wcsconfig&&("image"===b.params.wcsconfig.wcssys?k="image":"physical"===b.params.wcsconfig.wcssys&&(k="physical"));"image"===k||"image"===this.params.wcssys&&
"physical"!==k?(l.imsys="image",h=l.x,w=l.y,k=1):(l.imsys=l.lcs.sys,h=l.lcs.x,w=l.lcs.y,k=Math.sqrt(Math.pow(this.lcs.physical.reverse[0][0],2)+Math.pow(this.lcs.physical.reverse[0][1],2)));l.angle=-b.angle;d.group&&(l.angle-=d.group.angle);m&&(l.angle-=m.angle);m=l.angle;if(!l.parent)switch(l.shape){case "box":case "cross":case "ellipse":case "text":if(a.notNull(this.params.transformScale)&&(l.angle/=this.params.transformScale),a.notNull(this.params.transformAngle)&&(l.angle-=this.params.transformAngle),
...
[]);l.imstr="annulus("+n(h)+","+n(w)+",";var A="annulus "+l.x+" "+l.y+" ";w=b.getObjects();q=w.length;for(h=0;h<q;h++)v=w[h].radius*t,y=v*k,l.imstr+=n(y),A=a.REGSIZE?A+(l.x+" "+l.y+" "+(l.x+v)+" "+l.y+" "):A+(v+" "),l.imstr=h===q-1?l.imstr+")":l.imstr+",",l.radii.push(v),"image"!==l.imsys&&l.lcs.radii.push(y);break;case "box":case "cross":l.width=b.width*t;l.height=b.height*y;y=l.width*k;A=l.height*k;"image"!==l.imsys&&(l.lcs.width=y,l.lcs.height=A);l.imstr=l.shape+"("+n(h)+","+n(w)+","+n(y)+","+
n(A)+","+l.angle.toFixed(4)+")";A=a.REGSIZE?l.shape+" "+l.x+" "+l.y+" "+l.x+" "+l.y+" "+(l.x+l.width)+" "+l.y+" "+l.x+" "+l.y+" "+l.x+" "+(l.y+l.height)+" "+l.angle*Math.PI/180:l.shape+" "+l.x+" "+l.y+" "+l.width+" "+l.height+" "+l.angle*Math.PI/180;break;case "circle":l.radius=b.radius*t;y=l.radius*k;"image"!==l.imsys&&(l.lcs.radius=y);l.imstr="circle("+n(h)+","+n(w)+","+n(y)+")";A=a.REGSIZE?"circle "+l.x+" "+l.y+" "+l.x+" "+l.y+" "+(l.x+l.radius)+" "+l.y:"circle "+l.x+" "+l.y+" "+l.radius;break;
case "ellipse":l.r1=b.width*t/2;l.r2=b.height*y/2;y=l.r1*k;A=l.r2*k;"image"!==l.imsys&&(l.lcs.r1=y,l.lcs.r2=A);l.imstr="ellipse("+n(h)+","+n(w)+","+n(y)+","+n(A)+","+l.angle.toFixed(4)+")";A=a.REGSIZE?"ellipse "+l.x+" "+l.y+" "+l.x+" "+l.y+" "+(l.x+l.r1)+" "+l.y+" "+l.x+" "+l.y+" "+l.x+" "+(l.y+l.r2)+" "+l.angle*Math.PI/180:"ellipse "+l.x+" "+l.y+" "+l.r1+" "+l.r2+" "+l.angle*Math.PI/180;break;case "point":l.width=b.width*t;l.height=b.height*y;y=l.width*k;A=l.height*k;"image"!==l.imsys&&(l.lcs.width=
y,l.lcs.height=A);l.imstr="point("+n(h)+","+n(w)+")";A="point "+l.x+" "+l.y;break;case "line":case "polygon":l.imstr=l.shape+"(";A=l.shape+" ";l.pts=[];"image"!==l.imsys&&(l.lcs.pts=[]);for(h=0;h<b.points.length;h++)if(0<h&&(l.imstr+=",",A+=" "),y=this.displayToImagePos({x:v.x+b.left+b.points[h].x*b.scaleX,y:v.y+b.top+b.points[h].y*b.scaleY}),y=a.rotatePoint(y,m,{x:l.x,y:l.y}),"image"===l.imsys?l.imstr+=n(y.x)+","+n(y.y):(x=this.imageToLogicalPos(y),d=x.x,x=x.y,l.imstr+=n(d)+","+n(x),l.lcs.pts.push({x:d,
y:x})),A+=y.x+" "+y.y,l.pts.push(y),"line"===l.shape)if(0===h)var C=0;else d=l.pts[h-1],C+=Math.sqrt((y.x-d.x)*(y.x-d.x)+(y.y-d.y)*(y.y-d.y));if("line"===l.shape&&a.notNull(C)){l.imstr+=') {"size":'+n(C)+',"units":"pixels"';if(2===l.pts.length){for(y=180*Math.atan2(l.pts[1].y-l.pts[0].y,l.pts[1].x-l.pts[0].x)/Math.PI;0>y;)y+=360;var B=',"posang":'+y.toFixed(4)+',"posunits":"degrees"';l.imstr+=B}l.imstr+="}"}else l.imstr+=")";l.angle=0;break;case "text":l.imstr="text("+n(h)+","+n(w)+',"'+b.text+'",'+
l.angle.toFixed(4)+")",A="text "+l.x+" "+l.y+' "'+b.text+'" '+l.angle*Math.PI/180,l.text=b.text}this.validWCS()&&(u(this.raw.wcs,p,l,A,B,f,l),"export"!==e&&b.params.wcsconfig&&b.params.wcsconfig.wcssys&&(n=a.globalOpts.xeqPlugins,a.globalOpts.xeqPlugins=!1,v=this.getWCSSys(),a.notWCS(b.params.wcsconfig.wcssys)||(this.setWCSSys(b.params.wcsconfig.wcssys,!1),u(this.raw.wcs,p,l,A,B,f,b.params.wcsconfig)),l.wcsconfig=$.extend(!0,{},b.params.wcsconfig),this.setWCSSys(v,!1),a.globalOpts.xeqPlugins=n));
l.data=b.params.data;b.set("pub",l);b.params.winid&&($(b.params.winid).is(":visible")?this.initRegionsForm(b):b.params.winid=null);if(f.nocb)return l;(function(){var d=function(b){try{g.params.xeqonchange=!1,a.xeqByName(b,window,g,l)}catch(G){a.log("error in onchange: %s [%s]\n%s",g.id,G.message,a.strace(G))}finally{g.params.xeqonchange=!0}};b.params.parent||e.match(r)||(g.params.xeqonchange&&p.show&&(p.opts.onchange?d(p.opts.onchange):"regions"===c&&a.Regions.opts.onchange&&d(a.Regions.opts.onchange)),
d="on"+c+"change",g.xeqPlugins("shape",d,l))})();if("regions"===c&&a.globalOpts.regToClipboard){switch(e){case "update":h=l.parent||l.id;break;default:h=null}if(a.notNull(h)){try{var D=this.listRegions(h,{mode:1,includedcoords:!0})}catch(E){D=null}D&&(a.clipboard=D)}}"regions"===c&&"wcs"===e&&this._updateMultiDialogs(!0);return l}};a.Fabric.lookupGroup=function(a,b){var c;b=b||"regions";if(!this.getShapeLayer(b))return null;b=this.layers[b].canvas;if("string"===typeof a){var e=b.getObjects();for(b=
0;b<e.length;b++){var f=e[b];if("group"===f.type&&!f.params){var g=f.getObjects();for(c=0;c<g.length;c++){var h=g[c];if(h.params&&h.params.groupid===a)return f}}}}else if("object"===typeof a&&"group"===a.type&&!a.params&&(e=a.getObjects())&&e.length&&e[0]&&e[0].params)return e[0].params.groupid;return null};a.Fabric.listGroups=function(c,b,d){var e="";d=d||"regions";var f=this.getShapeLayer(d);if(!f)return e;c=c||"all";if("string"===typeof b)try{b=JSON.parse(b)}catch(m){a.error("can't parse listGroups opts: "+
b,m)}b=b||{};var g=f.canvas.getObjects();for(f=0;f<g.length;f++){var h=g[f];if("group"===h.type&&!h.params){var k=h.getObjects()[0].params.groupid;if("all"===c||c===k)!1===b.includeregions?e+=k+";":(h=this.getShapes(d,k,{format:"text",includejson:!1,includecomments:!0})+";;",h=h.substring(h.indexOf(";")+1),e+=k+":;"+h)}}a.notNull(b.mode)&&0<b.mode&&this.display.displayMessage("regions",e);return e.replace(/;\s*/g,"\n").replace(/\n\n$/,"\n")};a.Fabric.groupShapes=function(c,b,d){var e=this,f,g,h,k,
m=[],l=[];var p=this.getShapeLayer(c);if(!p)return 0;var r=p.dlayer;d=d||{};if("string"===typeof d)try{d=JSON.parse(d)}catch(u){a.error("can't parse groupShapes opts: "+d,u)}p=p.canvas;var n=function(a){var b=1;for(a=a.groupid||"group_"+b;e.lookupGroup(a);)b+=1,a=a.replace(/_[0-9][0-9]*$/,"")+("_"+b);return a}(d);this._selectShapes(c,b,d,function(b){if(0>$.inArray(b,m)){h=!1;if(b.params.groupid)switch(a.globalOpts.regGroupConflict){case "skip":k=b.params.groupid;h=!0;break;default:g=sprintf("%s can only be a member of one group [%s,%s]",
"regions"===c?"regions":"shapes",b.params.id,b.params.groupid),a.error(g)}if(!h&&(b.params.groupid=n,0>$.inArray("groupid",b.params.exports)&&b.params.exports.push("groupid"),m.push(b),l.push(b.pub),b.params&&b.params.children.length))for(f=0;f<b.params.children.length;f++)b.params.children[f].obj&&m.push(b.params.children[f].obj)}});if(!m.length)return k;p.getActiveObject()&&p.discardActiveObject();b=new fabric.ActiveSelection(m,{canvas:p});a.globalOpts.skipSelectionProcessing=!0;p.setActiveObject(b);
p.getActiveObject().toGroup();!1===d.select&&p.getActiveObject()&&p.discardActiveObject();delete a.globalOpts.skipSelectionProcessing;p.renderAll();this.groups[c]=this.groups[c]||[];this.groups[c].push(n);"function"===typeof r.opts.ongroupcreate&&r.opts.ongroupcreate.call(r.canvas,n,this,l,m);return n};a.Fabric.ungroupShapes=function(c,b,d){var e,f;var g=this.getShapeLayer(c);if(!g||!this.layers[c])return this;a.isNull(b)&&a.error("ungroup requires a group id or selection");d=d||{};var h=g.canvas;
...
0<=r&&p.params.exports.splice(r,1)}}}}this.groups[c]&&(r=$.inArray(b,this.groups[c]),0<=r&&this.groups[c].splice(r,1));return this};a.Fabric.removeShapes=function(c,b,d){var e=this,f,g,h=!1,k={mode:1,includedcoords:!0,sortids:!1},m=[],l=[];if(f=this.getShapeLayer(c)){var p=f.canvas;d=d||{};p.getActiveObject()&&(g=p.getActiveObjects());"regions"===c&&a.globalOpts.unremoveReg&&(this.regstack.push(this.listRegions(b,k,c)),this.regstack.length>a.globalOpts.unremoveReg&&(this.regstack=this.regstack.slice(0,
a.globalOpts.unremoveReg)));this._selectShapes(c,b,d,function(a,b){if(!(!1===a.params.removable&&!d.overrideRemovable||a.params.sticky&&!1===d.sticky)){"main"===f.dlayer.dtype&&e._updateShape(c,a,b,"remove");a.params.winid&&(a.params.winid.close(),a.params.winid=null);if(a.params.parent){var k=a.params.parent.obj;for(b=k.params.children.length-1;0<=b;b--)if(a===k.params.children[b].obj){k.params.children.splice(b,1);break}}for(b=0;b<a.params.children.length;b++)k=a.params.children[b].obj,m.push(k);
a.params.groupid&&0>$.inArray(a.params.groupid,l)&&l.push(a.params.groupid);g&&!h&&0<=$.inArray(a,g)&&(h=!0);m.push(a)}});h&&p.discardActiveObject();for(b=0;b<l.length;b++)this.ungroupShapes(c,l[b]);for(b=0;b<m.length;b++)p.remove(m[b]);p.renderAll();!p.size()&&a.globalOpts.resetEmptyShapeId&&(f.nshape=0);return this}};a.Fabric.getShapes=function(c,b,d){var e={},f=[];d=d||{};if("string"===typeof d)try{d=JSON.parse(d)}catch(k){a.error("can't parse getShapes opts: "+d,k)}if("regions"===c&&("text"===
d.format||"csv"===d.format||"regions"===d.format)){d.mode=d.mode||1;b=this.listRegions(b,d);if("csv"===d.format){var g=b.split(";");c=0;for(b="";c<g.length;c++)if(g[c])if(g[c].toLowerCase().match(a.WCSEXP))d.includewcs&&(b+=g[c].trim()+"\n");else{var h=g[c].replace(/\(/,",").replace(/\).*/,"").trim();b+=h+"\n"}}else"regions"===d.format&&(b=b.replace(/ *; */g,"\n"));return b}this._selectShapes(c,b,d,function(a){e=a.pub||{};d.includeObj&&(e.obj=a);f.push(e)});!1!==d.sortids&&f.sort(function(a,b){return(a.id||
0)-(b.id||0)});return f};a.Fabric.changeShapes=function(c,b,d){var e=this,f,g,h,k,m,l,p,r,n,u,x,t,v=[],w=[];if((m=this.getShapeLayer(c))&&d){if("string"===typeof d)try{d=JSON.parse(d)}catch(y){a.error("can't parse shape opts: "+d,y)}if(this.display.image!==this)this.delayedShapes=this.delayedShapes||[],this.delayedShapes.push({layer:c,shape:b,mode:"change",opts:d});else{var q=m.canvas;if((l=q.getActiveObject())&&"activeSelection"===l.type){var z=q.getActiveObjects();q.discardActiveObject();q.renderAll();
l=null}a.isNull(d.saveselection)&&(d.saveselection=!0);this._selectShapes(c,b,d,function(b,z){n="main"!==e.display.layers[c].dtype||b.params.preservedcoords?1:e.rgb.sect.zoom;d.radii&&(b.params.radii=[]);d.tags&&(b.params.tags=[]);void 0!==d.locked&&delete b.params.changeable;k=$.extend(!0,{},b.params,d);h=e._parseShapeOptions(c,k,b);if(h.remove){if(!0===h.remove||"true"===h.remove)h.remove="all";if(!1!==h.remove&&"false"!==h.remove){e.removeShapes(c,h.remove||"all");return}}u=e._exportShapeOptions(d).filter(function(a){return!{}.hasOwnProperty.call(b.params.exports,
a)});h.params.exports=b.params.exports.concat(u);h.opts.stroke&&(h.opts.color=h.opts.stroke,h.opts.stroke=a.colorToHex(h.opts.stroke));switch(b.params.shape){case "text":h.opts.stroke&&(h.opts.fill=h.opts.stroke);h.opts.strokeWidth=0;break;case "line":case "polygon":h.opts.points&&h.opts.points.length&&(b.angle=0)}b.set(h.opts);b.params=$.extend(!1,{},b.params,h.params);h.opts.strokeWidth&&(b.params.sw1=h.opts.strokeWidth);switch(b.params.shape){case "annulus":if(d.radii&&d.radii.length){b.forEachObject(function(a){v.push(a)});
p=v.length;for(f=0;f<p;f++)b.remove(v[f]),q.remove(v[f]);p=b.params.radii.length;r=0;x=$.extend(!0,{},d);x.stroke=x.stroke||b.get("stroke");x.strokeWidth=x.strokeWidth||b.get("strokeWidth");x.strokeDashArray=x.strokeDashArray||b.get("strokeDashArray");for(f=0;f<p;f++)x.radius=b.params.radii[f],g=new fabric.Circle(x),r=Math.max(r,b.params.radii[f]),b.add(g);b.scaleX=n;b.scaleY=n;b.width=2*r;b.height=2*r;l===b&&q.setActiveObject(b)}break;case "box":d.width&&(b.scaleX=n);d.height&&(b.scaleY=n);break;
case "circle":d.radius&&(b.scaleX=n,b.scaleY=n);break;case "cross":x=$.extend(!0,{},d);x.stroke=x.stroke||b.get("stroke");x.width&&(b.scaleX=n,w[0]=[{x:-x.width/2,y:0},{x:x.width/2,y:0}],delete x.width);x.height&&(b.scaleY=n,w[1]=[{x:0,y:-x.height/2},{x:0,y:x.height/2}],delete x.height);x.angle&&delete x.angle;b.forEachObject(function(a,b){t=$.extend(!0,{},x);w[b]&&(t.points=w[b]);a.set(t)});break;case "ellipse":d.r1&&(b.rx=b.params.r1,b.scaleX=n,b.width=2*b.rx);d.r2&&(b.ry=b.params.r2,b.scaleY=n,
b.height=2*b.ry);break;case "line":case "polygon":if(d.points&&d.points.length||d.pts&&d.pts.length)b.scaleX=n,b.scaleY=n;l===b&&(a.Fabric.removePolygonAnchors(m.dlayer,b),a.Fabric.addPolygonAnchors(m.dlayer,b));a.resetPolygonCenter(b);break;case "text":d.text&&(b.params.text=d.text)}b.rescaleBorder();!1===b.params.changeable&&q.sendToBack(b);switch(h.opts.send){case "front":q.bringToFront(b);l===b&&q.discardActiveObject();break;case "back":q.sendToBack(b),l===b&&q.discardActiveObject()}a.Fabric.updateChildren(m.dlayer,
b,"moving");a.Fabric.updateChildren(m.dlayer,b,"scaling");a.Fabric.updateChildren(m.dlayer,b,"rotating");a.Fabric.updateChildren(m.dlayer,b,"deltas");b.setCoords();e._handleChildText(c,b,d);e._updateShape(c,b,z,"update");if(d.onchangeshapes&&b.pub)try{a.xeqByName(d.onchangeshapes,e,e,b.pub)}catch(C){a.error("in onchangeshapes callback",C,!1)}});z&&this.selectShapes(c,z);(void 0===d.redraw||d.redraw)&&q.renderAll();return this}}};a.Fabric.refreshShapes=function(c){if(c){var b={mode:1,sticky:!1,ignoreignore:!0,
...
f)/b.get("scaleX");var h=(d.y-g)/b.get("scaleY");for(g=-b.get("angle")*Math.PI/180;g>2*Math.PI;)g-=2*Math.PI;d=Math.cos(g)*f-Math.sin(g)*h;h=Math.sin(g)*f+Math.cos(g)*h;f=b.points;for(g=0;g<f.length;g++){var k=f[g];var m=f[(g+1)%f.length];var l=k.x<m.x?k.x:m.x;var p=k.y<m.y?k.y:m.y;var r=k.x>m.x?k.x:m.x;var n=k.y>m.y?k.y:m.y;var u=k.x-m.x;k=k.y-m.y;var x=Math.sqrt(u*u+k*k);0!==x&&(u/=x,k/=x);x=d-m.x;var t=h-m.y;x=x*u+t*k;u=m.x+u*x;m=m.y+k*x;u<l?u=l:u>r&&(u=r);m<p?m=p:m>n&&(m=n);l=(u-d)*(u-d)+(m-h)*
(m-h);if(l<e){e=l;var v=u;var w=m;var q=g===f.length?0:g}}c=this.getShapeLayer(c);a.Fabric.removePolygonAnchors(c.dlayer,b);f.splice(q+1,0,{x:v,y:w});switch(b.type){case "polyline":case "polygon":a.Fabric.addPolygonAnchors(c.dlayer,b),c.dlayer.canvas.renderAll()}b.polyparams?c.dlayer.params.sel=b.polyparams.polygon:b.params&&(c.dlayer.params.sel=b)}};a.Fabric._removePolygonPoint=function(c,b){if(b&&b.polyparams){var d=b.polyparams.polygon;var e=d.points;if(!("polygon"===d.type&&3>=e.length||"polyline"===
...
c,m)}var g=this.display.canvas.toDataURL("image/png");var h="<html><body style='padding: 0px; margin: 0px' onload='window.print(); return false'>";var k=sprintf("<div style='position:absolute; left:%spx; top:%spx'>",0,e);h+=k+"<img src='"+g+"'></div>";g=$jscomp.makeIterator(Object.keys(this.layers));for(b=g.next();!b.done;b=g.next())b=b.value,b=this.layers[b],"main"===b.dlayer.dtype&&b.show&&(h+=""+k+b.dlayer.canvas.toSVG()+"</div>");(void 0===c.colorbar||c.colorbar)&&(c=this.display.pluginInstances.JS9Colorbar)&&
...
c.params.contrast=e/b.canvas.height*10,a.bugs.firefox_linux?window.setTimeout(function(){c.displayImage("scaled",{blendMode:!1})},0):c.displayImage("scaled",{blendMode:!1}),c.xeqStashDiscard("filterRGBImage"),a.globalOpts.extendedPlugins&&c.xeqPlugins("image","onchangecontrastbias"))}};a.MouseTouch.Actions["change contrast/bias"].stop=function(a,b,d){a.display.blendMode&&a.displayImage("rgb")};a.MouseTouch.Actions["wheel zoom"]=function(c,b){var d=a.globalOpts.panzoomRefreshLimit,e=0;b=b.originalEvent.deltaY*
Math.sign(a.DIRZOOM);if(c&&a.globalOpts.mousetouchZoom&&(c.tmp.wheelzooms=c.tmp.wheelzooms||0,0===c.tmp.wheelzooms++%a.MODZOOM)){var f=c.getZoom();b=0>b?Math.min(a.MAXZOOM,f+a.ADDZOOM):Math.max(a.MINZOOM,f-a.ADDZOOM);if(a.globalOpts.mousetouchLimit){var g=Math.min(c.display.width/c.raw.width,c.display.height/c.raw.height);if(g>b&&f>b)return}b=Math.round(100*(b+1E-5))/100;f=$jscomp.makeIterator(Object.keys(c.layers));for(g=f.next();!g.done;g=f.next())g=g.value,c.layers[g].show&&c.layers[g].opts.panzoom&&
c.layers[g].canvas.size()>d&&(c.tmp.panzoomRefresh=c.tmp.panzoomRefresh||{},c.tmp.panzoomRefresh[g]={},e++);c.tmp.panzoomTimeout&&(clearTimeout(c.tmp.panzoomTimeout),delete c.tmp.panzoomTimeout);if(e||c.tmp.panzoomRefresh)c.tmp.panzoomTimeout=setTimeout(function(){c.refreshLayers(c.tmp.panzoomRefresh);delete c.tmp.panzoomRefresh},a.TIMEOUT);c.setZoom(b)}};a.MouseTouch.Actions["pan the image"]=function(c,b,d){var e=a.globalOpts.panMouseThreshold;b=a.globalOpts.panzoomRefreshLimit;if(c){d=c.rgb.sect;
var f=(c.pos0.x-c.pos.x)/d.zoom;var g=(c.pos0.y-c.pos.y)/d.zoom;if(Math.abs(f)>=e||Math.abs(g)>=e){"x"===c.params.flip?f=-f:"y"===c.params.flip?g=-g:"xy"===c.params.flip&&(f=-f,g=-g);90===c.params.rot90?(e=f,f=-g,g=e):180===c.params.rot90?(f=-f,g=-g):-90===c.params.rot90&&(e=f,f=g,g=-e);f={x:d.xcen+f,y:d.ycen-g};c.params.rotate&&(f=a.rotatePoint(f,-c.params.rotate,{x:d.xcen,y:d.ycen}));d=$jscomp.makeIterator(Object.keys(c.layers));for(g=d.next();!g.done;g=d.next())g=g.value,c.layers[g].show&&c.layers[g].opts.panzoom&&
c.layers[g].canvas.size()>b&&(c.tmp.panzoomRefresh=c.tmp.panzoomRefresh||{},c.tmp.panzoomRefresh[g]={});c.setPan(f);c.pos0=c.pos}}};a.MouseTouch.Actions.pinch=function(c,b,d){c&&(b=c.display,d=b.zoom0*Math.sqrt((c.pos.touches[0].x-c.pos.touches[1].x)*(c.pos.touches[0].x-c.pos.touches[1].x)+(c.pos.touches[0].y-c.pos.touches[1].y)*(c.pos.touches[0].y-c.pos.touches[1].y))/b.dist0,d=Math.max(a.MINZOOM,Math.min(a.MAXZOOM,Math.round(100*(d+1E-5))/100)),d!==b.lastzoom&&c.setZoom(d),b.lastzoom=d)};a.MouseTouch.Actions.start=
...
pub:{shape:"multi",wcsconfig:{}},params:{}};var u=function(a){if(void 0!==a)return"number"===typeof a&&0!==a%1&&(a=Math.round(1E4*(a+1E-5))/1E4),String(a)},x=function(a){var b=String.fromCharCode(13,10);return"string"===typeof a?a.replace(/\\n/g,b):a};if(c&&c.pub)var t=c.pub.wcsconfig&&c.pub.wcsconfig.wcssys?c.pub.wcsconfig.wcssys:this.params.wcssys;else t=this.params.wcssys,c=n;var v=!1===c.params.changeable;b=b||{};if(c.params.winid)var w=c.params.winid;else b.winid&&(w=b.winid);if(w){var q="#"+
$(w).attr("id")+" .regionsConfigForm ";if($(q).length){p=$(q).data("multi")?!0:b.multi;$(q+"."+c.pub.shape).each(function(a,b){$(b).removeClass("nodisplay")});$(q+".val").each(function(b,l){g="";f=$(l).attr("name");switch(f){case "x":case "y":c.pub.lcs&&void 0!==c.pub.lcs[f]?g=u(c.pub.lcs[f]):void 0!==c.pub[f]&&(g=u(c.pub[f]));break;case "radii":c.pub.radii&&(g=!a.notWCS(t)&&c.pub.wcsconfig&&c.pub.wcsconfig.wcsstr?c.pub.wcsconfig.wcsstr.replace(/^annulus\(/,"").replace(/\)$/,"").split(",").slice(2).join(","):
c.pub.imstr.replace(/^annulus\(/,"").replace(/\)$/,"").split(",").slice(2).join(","));break;case "pts":c.pub.pts?c.pub.pts.forEach(function(a){g&&(g+=", ");g+=a.x.toFixed(2)+", "+a.y.toFixed(2)}):c.pub.imstr&&(g=c.pub.imstr.replace(/^.*\(/,"").replace(/\)$/,""));break;case "linelength":if(c.pub.pts&&2===c.pub.pts.length){k=c.pub.pts[0];m=c.pub.pts[1];g=u(Math.sqrt((m.x-k.x)*(m.x-k.x)+(m.y-k.y)*(m.y-k.y)));switch(t){case "image":case "physical":break;default:g*=Math.abs(r.cdelt1),g*=Math.abs(r.cdelt2)}g=
u(g);d.tmp.linelength=g}break;case "lineangle":if(c.pub.pts&&2===c.pub.pts.length){k=c.pub.pts[0];m=c.pub.pts[1];for(g=180*Math.atan2(m.y-k.y,m.x-k.x)/Math.PI;0>g;)g+=360;g=u(g);d.tmp.lineangle=g}break;case "fontFamily":c.getFontFamily&&(g=c.getFontFamily());break;case "fontSize":c.getFontSize&&(g=c.getFontSize());break;case "fontStyle":c.getFontStyle&&(g=c.getFontStyle());break;case "fontWeight":c.getFontWeight&&(g=c.getFontWeight());break;case "colorPicker":g=void 0!==c.pub.color?a.colorToHex(c.pub.color):
$(q).data("colorpicker")||a.globalOpts.defcolor;break;case "color":p||(void 0!==c.pub.color?g=u(c.pub.color):$(q).data("colorpicker")&&(g=$(q).data("colorpicker")));break;case "strokeWidth":g=c.params.sw1?c.params.sw1:$(q).data("strokewidth")||"";break;case "strokeDashes":c.strokeDashArray?(g=c.strokeDashArray.join(" "),g.match(/NaN/)&&(g="")):g=$(q).data("strokedashes")||"";break;case "regstr":g=!a.notWCS(t)&&c.pub.wcsconfig&&c.pub.wcsconfig.wcsstr?c.pub.wcsconfig.wcssys+";"+c.pub.wcsconfig.wcsstr:
c.pub.imsys+";"+c.pub.imstr;break;case "xpos":switch(t){case "image":c.pub.preservedcoords&&void 0!==c.pub.dx?g=sprintf("d%.1f",c.pub.dx):void 0!==c.pub.x&&(g=sprintf("%.1f",c.pub.x));break;case "physical":c.pub.lcs?g=sprintf("%.1f",c.pub.lcs.x):void 0!==c.pub.x&&(g=sprintf("%.1f",c.pub.x));break;default:c.pub.wcsconfig&&a.notNull(c.pub.wcsconfig.ra)?g=sprintf("%.6f",c.pub.wcsconfig.ra):void 0!==c.pub.x&&(g=sprintf("%.1f",c.pub.x))}$(q+"[name='"+f+"']").prop("readonly",v);break;case "ypos":switch(t){case "image":c.pub.preservedcoords&&
void 0!==c.pub.dy?g=sprintf("d%.1f",c.pub.dy):void 0!==c.pub.y&&(g=sprintf("%.1f",c.pub.y));break;case "physical":c.pub.lcs?g=sprintf("%.1f",c.pub.lcs.y):void 0!==c.pub.y&&(g=sprintf("%.1f",c.pub.y));break;default:c.pub.wcsconfig&&a.notNull(c.pub.wcsconfig.dec)?g=sprintf("%.6f",c.pub.wcsconfig.dec):void 0!==c.pub.y&&(g=sprintf("%.1f",c.pub.y))}$(q+"[name='"+f+"']").prop("readonly",v);break;case "radius":case "oradius":case "length":case "width":case "r1":switch(t){case "image":void 0!==c.pub[f]&&
(g=u(c.pub[f]));break;case "physical":c.pub.lcs&&void 0!==c.pub.lcs[f]&&(g=u(c.pub.lcs[f]));break;default:c.pub.wcsconfig&&a.notNull(c.pub.wcsconfig.wcssizestr)?g=u(c.pub.wcsconfig.wcssizestr[0]):void 0!==c.pub[f]&&(g=u(c.pub[f]))}$(q+"[name='"+f+"']").prop("readonly",v);break;case "height":case "r2":switch(t){case "image":void 0!==c.pub[f]&&(g=u(c.pub[f]));break;case "physical":c.pub.lcs&&void 0!==c.pub.lcs[f]&&(g=u(c.pub.lcs[f]));break;default:c.pub.wcsconfig&&a.notNull(c.pub.wcsconfig.wcssizestr)?
g=u(c.pub.wcsconfig.wcssizestr[1]):void 0!==c.pub[f]&&(g=u(c.pub[f]))}$(q+"[name='"+f+"']").prop("readonly",v);break;case "wcssys":case "savewcs":z=$(q).find("[name='"+f+"']");if(!z.find("option").length)for(e=0;e<a.wcssyss.length;e++)z.append("<option>"+a.wcssyss[e]+"</option>");h="savewcs"===f?a.globalOpts.regSaveWCS||t:t;z.find("option").each(function(a,b){h===b.value&&(g=b.value)});break;case "wcsunits":c.pub.wcsunits&&(g=c.pub.wcsunits);break;case "childtext":c.params.children&&0<c.params.children.length&&
(g=x(c.params.children[0].obj.text));break;case "text":void 0!==c.pub[f]&&(g=x(u(c.pub[f])));break;case "id":p?g="selected":void 0!==c.pub.id&&(g=String(c.pub.id),$(l).css("width",g.length+"ch"));break;case "tags":void 0!==c.pub[f]&&(g=u(c.pub[f]));break;case "savefile":g=$(q).data("savefile")||d.tmp.saveregionsFile||"js9.reg";window.electron&&!g.match(/.*\//)&&(g=window.electron.currentDir+"/"+g);break;case "selectfilter":g=$(q).data("selectfilter");break;case "selectshape":case "selectcolor":case "selecttag":case "selectwcs":case "selectgroup":a.Regions.regionsConfigSetSelectMenu(d,
...
(k.dec=w,void 0===k.ra&&(b.pub.wcsconfig&&b.pub.wcsconfig.wcsposstr?k.ra=b.pub.wcsconfig.wcsposstr[0]:b.pub.wcsposstr&&(k.ra=b.pub.wcsposstr[0])),void 0===k.wcssys&&(k.wcssys=x));break;case "wcssys":break;case "radius":case "length":case "width":case "r1":switch(x){case "image":r(b,v,w)&&(k[v]=n(w));break;case "physical":r(b,v,w)&&(k[v]=n(w)*f);break;default:q=a.strtoscaled(w),w="."===q.dtype&&"galactic"!==x&&"ecliptic"!==x?q.dval:Math.abs(q.dval/m.cdelt1),v=v.replace("wcs",""),r(b,v,w)&&(k[v]=n(w))}break;
case "height":case "r2":switch(x){case "image":r(b,v,w)&&(k[v]=n(w));break;case "physical":r(b,v,w)&&(k[v]=n(w)*f);break;default:q=a.strtoscaled(w),w="."===q.dtype&&"galactic"!==x&&"ecliptic"!==x?q.dval:Math.abs(q.dval/m.cdelt2),v=v.replace("wcs",""),r(b,v,w)&&(k[v]=n(w))}break;case "radii":r(b,v,w)&&(k[v]=w);break;case "linelength":if(b.pub.pts&&2===b.pub.pts.length&&a.isNumber(w)&&w!==this.tmp.linelength){w=parseFloat(w);switch(x){case "image":case "physical":break;default:void 0!==m.cdelt1?w/=
Math.abs(m.cdelt1):void 0!==m.cdelt2&&(w/=Math.abs(m.cdelt2))}k.pts?(v=k.pts[0],q=k.pts[1]):(v=b.pub.pts[0],q=b.pub.pts[1]);if(0<=$.inArray("line",a.Regions.opts.noCenteredScaling)){var z=Math.sqrt((v.x-q.x)*(v.x-q.x)+(v.y-q.y)*(v.y-q.y));var y=v.x-w*(v.x-q.x)/z;w=v.y-w*(v.y-q.y)/z;k.pts=[v,{x:y,y:w}]}else y={x:(v.x+q.x)/2,y:(v.y+q.y)/2},z=parseFloat(this.tmp.lineangle)||0,v.x=y.x-w/2,v.y=y.y,q.x=y.x+w/2,q.y=y.y,k.pts=[a.rotatePoint(v,z,y),a.rotatePoint(q,z,y)]}break;case "lineangle":b.pub.pts&&2===
b.pub.pts.length&&a.isNumber(w)&&w!==this.tmp.lineangle&&(z=parseFloat(w)-parseFloat(this.tmp.lineangle)||0,k.pts?(v=k.pts[0],q=k.pts[1]):(v=b.pub.pts[0],q=b.pub.pts[1]),0<=$.inArray("line",a.Regions.opts.noCenteredScaling)?k.pts=[v,a.rotatePoint(q,z,v)]:(y={x:(v.x+q.x)/2,y:(v.y+q.y)/2},k.pts=[a.rotatePoint(v,z,y),a.rotatePoint(q,z,y)]));break;case "remove":r(b,v,w)&&(t?k[v]="selected":void 0!==b.pub.id&&(k[v]=b.pub.id));break;case "locked":r(b,v,!n(w))&&(k.changeable=!n(w));break;case "misc":if(w.trim())try{var A=
JSON.parse(w);$.extend(k,A)}catch(C){a.error("invalid json: "+w)}break;default:r(b,v,w)&&(k[v]=n(w))}}0<Object.keys(k).length&&(c=t?$(c).find("[name='selectfilter']").val()||"selected":$(c).find("[name='id']").val()||b,this.changeShapes(g,c,k),this.initRegionsForm(b,{multi:t}))};a.Regions.regionsConfigSetSelectFilter=function(c,b){var d=[];var e=[],f=[],g=c.closest("form"),h=g.find("[name='selectfilter']"),k=g.data("im");g=function(b){if(!b)return"";b=b.trim();return"("===b.charAt(0)&&")"===b.charAt(b.length-
...
g.textOpts=w(n);if(c.angle!==n.angle){if(g.textOpts.angle=-n.angle,"circle"===c.params.shape||"annulus"===c.params.shape)n.params.hasTextOpts=!0}else 0===n.angle||"circle"!==c.params.shape&&"annulus"!==c.params.shape||(g.textOpts.angle=-n.angle,n.params.hasTextOpts=!0);if(n.params.parent.moved||n.params.hasTextOpts)n.pub.ra&&n.pub.dec?(y&&A&&y!==A?(n=e.wcs2wcs(y,A,n.pub.ra,n.pub.dec),n=n.trim().split(/\s+/),d=a.saostrtod(n[0]),a.isHMS(A)&&(d*=15),n=a.saostrtod(n[1])):(d=n.pub.ra,n=n.pub.dec),g.textOpts.ra=
d,g.textOpts.dec=n):n.pub.lcs?(g.textOpts.px=n.pub.lcs.x,g.textOpts.py=n.pub.lcs.y):(g.textOpts.x=n.pub.x,g.textOpts.y=n.pub.y);g.textOpts.color===c.stroke&&delete g.textOpts.color;g.textOpts.text&&delete g.textOpts.text;Object.keys(g.textOpts).length||delete g.textOpts}return g};b=b||{};if("string"===typeof b)try{b=JSON.parse(b)}catch(D){a.error("can't parse listRegions opts: "+b,D)}a.notNull(b.sortids)&&(v.sortids=b.sortids);var q=b.mode;a.isNull(q)&&(q=3);d=d||"regions";if(this.getShapeLayer(d)){if(b.wcssys||
b.wcsunits){var z=a.globalOpts.xeqPlugins;a.globalOpts.xeqPlugins=!1;if(b.wcssys){var y=this.getWCSSys();this.setWCSSys(b.wcssys,!1);var A=this.getWCSSys()}if(b.wcsunits){var C=this.getWCSUnits();this.setWCSUnits(b.wcsunits,!1)}this.updateShapes(d,c,"export")}a.isNull(b.includedcoords)&&(b.includedcoords=a.globalOpts.regListDCoords);n=this.getShapes(d,c,v);v=n.length;if(q)for(f=0;f<v;f++){var B=n[f];if((h=B.tags.join(","))&&"source,include"!==h&&"include,source"!==h){r=!0;break}}f=$jscomp.makeIterator(Object.keys(a.Regions.opts.tagcolors));
for(B=f.next();!B.done;B=f.next())h=B.value,t.push(a.Regions.opts.tagcolors[h]);for(f=0;f<v;f++)if(B=n[f],u=B.obj,x=[],!B.sticky||!1!==b.sticky)if(!B.preservedcoords||b.includedcoords)if(!B.ignore||b.ignoreignore)if($.isArray(u.params.preservedcoords)){for(g=0;g<u.params.preservedcoords.length;g++)switch(h=u.params.preservedcoords[g],h){case "pts":0>$.inArray("dx",x)&&x.push("dx");0>$.inArray("dy",x)&&x.push("dy");0>$.inArray("points",x)&&x.push("points");break;default:x.push(h)}"none"!==p&&(l+="; ");
"image"!==p&&(l+="image",l+="; ");l+=B.shape+"({";for(m=g=0;g<x.length;g++)if(h=x[g],"shape"!==h&&"sticky"!==h&&"wcsconfig"!==h){"pts"===h&&(h="dx",u.params.preservedcoords.push("dy"),u.params.preservedcoords.push("points"));if("preservedcoords"===h)p=!0;else if(a.notNull(B[h]))p=B[h];else if(a.notNull(u[h]))p=u[h];else switch(h){case "dx":p=u.left;break;case "dy":p=u.top;break;case "color":p=u.stroke;break;default:p=null}if(p)switch(0<m++&&(l+=","),l+='"'+h+'":',typeof p){case "string":l+='"'+p+
'"';break;case "object":try{l+=JSON.stringify(p)}catch(D){a.error("can't parse: "+p,D)}break;default:l+=""+p}}l+="})";p="image"}else h=B.tags.join(","),g=h.includes("exclude")?"-":"",u=w(u,B),b.saveid?u.id=B.id:delete u.id,b.savewcsconfig&&B.wcsconfig&&0<Object.keys(B.wcsconfig).length?u.wcsconfig=$.extend(!0,{},B.wcsconfig):delete u.wcsconfig,B.color&&!t.includes(B.color)&&(u.color=B.color),r&&(k=" # "+h),b.saveediting||delete u.editing,B.wcsstr&&a.isWCSSys(this.params.wcssys)?("wcs"!==p&&("none"!==
p&&(l+="; "),l=B.wcssys?l+B.wcssys:l+this.params.wcssys,p="wcs"),l+="; "+g+B.wcsstr):B.imstr&&(p!==B.imsys&&("none"!==p&&(l+="; "),l+=B.imsys,p=B.imsys),l+="; "+g+B.imstr),!1!==b.includejson&&1===q%2&&0<Object.keys(u).length&&("line"===B.shape&&(l=l.replace(/ *{[^{}]*}$/,"")),l+=" "+JSON.stringify(u)),k&&(l+=k);!1===b.includecomments&&(l=l.replace(/ *#[^;]*/g,""));if(y||C)y&&this.setWCSSys(y,!1),C&&this.setWCSUnits(C,!1),this.updateShapes(d,c,"export"),a.globalOpts.xeqPlugins=z;1<q&&this.display.displayMessage("regions",
l);return l}};a.Regions.copyRegions=function(a,b){return this.copyShapes("regions",a,b)};a.Regions.parseRegions=function(c,b){var d=this,e,f,g=[],h=/^-?(annulus|box|circle|cross|ellipse|line|polygon|point|text)$/,k=/^(fk4|fk5|icrs|galactic|ecliptic|image|physical|linear)$/,m=/^(image|physical)$/,l=/[dr:]/,p=/\(\s*([^)]+?)\s*\)/,r=/(\{.*\})/,n=/\s*,\s*/,u=/#(?![a-zA-Z0-9]{6}['"])/,x=function(b){return"0"===b||"false"===b.toLowerCase()?!1:!0},t=function(b){for(var a,c,d,e={},f=/([a-zA-Z][a-zA-Z0-9_]*)\s*=\s*(\d+(\s*\d+)*|[^ '"{]+|['"{][^'"}]*['"}])/g,
g={color:function(b){return{color:b}},dash:function(b){if(b)return{strokeDashArray:[3,1]}},dashlist:function(b){if(b){var a=b.split(" ");for(b=0;b<a.length;b++)a[b]=parseFloat(a[b]);return{strokeDashArray:a}}},delete:function(b){return{removable:x(b)}},edit:function(b){return{selectable:x(b)}},fixed:function(b){return{zoomable:!x(b)}},font:function(b){var a={};b=b.split(" ");var c=b.length;1<=c&&(a.fontFamily=b[0]);2<=c&&(a.fontSize=parseFloat(b[1]));3<=c&&(a.fontStyle=b[2]);4<=c&&(a.fontWeight=b[3]);
return a},highlite:function(b){return{hasControls:x(b),hasBorders:x(b),hasRotatingPoint:x(b)}},move:function(b){return{movable:x(b)}},rotate:function(b){return{rotatable:x(b)}},resize:function(b){return{resizable:x(b)}},changeable:function(b){return{changeable:x(b)}},select:function(b){return{selectable:x(b)}},text:function(b){return{text:b}},tag:function(b){return{tags:b}},width:function(b){return{strokeWidth:parseFloat(b)}}};null!==(a=f.exec(b));)if(c=a[1].toLowerCase(),a=a[2].replace(/^['"{]|['"}]$/g,
""),{}.hasOwnProperty.call(g,c)&&"function"===typeof g[c])for(c=g[c](a),a=$jscomp.makeIterator(Object.keys(c)),d=a.next();!d.done;d=a.next())d=d.value,"tags"===d&&{}.hasOwnProperty.call(e,d)?e[d]+=","+c[d]:e[d]=c[d];else e[c]=a;if(b=b.replace(f,""))e._comment=b.trim();return e},v=function(b){var c,d={opts:{},args:[],isregion:0};b.includes("(")?d.cmd=b.split("(")[0].trim().toLowerCase():b.includes("{")?d.cmd=b.split("{")[0].trim().toLowerCase():b.includes("#")?d.cmd=b.split("#")[0].trim().toLowerCase():
d.cmd=b.trim().toLowerCase();d.cmd&&(d.isregion=0<=d.cmd.search(h));var e=b.trim().split(u);if((c=r.exec(e[0]))&&c[0])try{d.opts=JSON.parse(c[0].trim())}catch(M){a.error("can't parse opts: "+c[0],M)}d.comment=e[1];if(d.comment){var f=t(d.comment.trim());void 0!==f._comment&&(d.comment=f._comment,delete f._comment)}f&&(d.opts=$.extend({},f,d.opts));(c=p.exec(b))&&c[0].match(r)?d.args=[]:c&&c[1]&&(d.args=c[1].split(n));d.isregion&&d.cmd.startsWith("-")&&(d.cmd=d.cmd.slice(1),d.comment?d.comment.match(/exclude/)||
(d.comment+=",exclude"):d.comment="exclude");return d},w=function(b,c){var e={};if("d"===b.charAt(0).toLowerCase()&&"d"===c.charAt(0).toLowerCase())return e.dx=parseFloat(b.substring(1)),e.dy=parseFloat(c.substring(1)),e;b=a.strtoscaled(b);c=a.strtoscaled(c);!b.dtype.match(l)&&!c.dtype.match(l)||A||z.match(m)||(B=!0,y=z);if(A||B)return a.isHMS(y,b.dtype)&&(b.dval*=15),"r"===b.dtype&&(b.dval=180*b.dval/Math.PI),"r"===c.dtype&&(c.dval=180*c.dval/Math.PI),c=a.wcs2pix(d.raw.wcs,b.dval,c.dval).split(/ +/),
e.x=parseFloat(c[0]),e.y=parseFloat(c[1]),e;if("physical"===y)return c=d.logicalToImagePos({x:b.dval,y:c.dval}),e.x=c.x,e.y=c.y,e;e.x=b.dval;e.y=c.dval;return e},q=function(b,c){b=a.strtoscaled(b);var e=d.raw.wcsinfo||{cdelt1:1,cdelt2:1};!b.dtype.match(l)||A||z.match(m)||(B=!0,y=z);A||B?("r"===b.dtype&&(b.dval=180*b.dval/Math.PI),0!==a.REGSIZE&&a.error("region size based on ang sep is not implemented"),b.dval=Math.abs(b.dval/e["cdelt"+c])):"physical"===y&&d.lcs&&d.lcs.physical&&(c=Math.sqrt(Math.pow(d.lcs.physical.forward[0][0],
2)+Math.pow(d.lcs.physical.forward[0][1],2)),b.dval=Math.abs(b.dval*c));return b.dval};c=c.trim();if(!c.match(/(\(|\{|#|;|\n)/))return c;var z=this.getWCSSys();b=this.getWCSUnits();var y="physical";var A=a.isWCSSys(y);var C=c.split(/\n|;/);for(c=0;c<C.length;c++)if("#"!==C[c].trim().substr(0,1)){var B=!1;var D=v(C[c]);var E=D.args.length;if(D.isregion){var F=$.extend(!0,{},D.opts);F.shape=D.cmd;F.wcsconfig=F.wcsconfig||{wcssys:y};2<=E&&"line"!==F.shape&&"polygon"!==F.shape&&$.extend(F,w(D.args[0],
D.args[1]));F.textOpts&&void 0!==F.textOpts.ra&&void 0!==F.textOpts.dec&&(F.textOpts._wcssys=y);switch(D.cmd){case "annulus":if(0<E)for(F.radii=[],e=2;e<E;e++)F.radii.push(q(D.args[e],1));break;case "box":case "cross":3<=E&&(F.width=q(D.args[2],1));4<=E&&(F.height=q(D.args[3],2));5<=E&&(F.angle=a.strtoscaled(D.args[4]).dval);break;case "circle":3<=E&&(F.radius=q(D.args[2],1));break;case "ellipse":3<=E&&(F.r1=q(D.args[2],1));4<=E&&(F.r2=q(D.args[3],2));5<=E&&(F.angle=a.strtoscaled(D.args[4]).dval);
break;case "line":case "polygon":if(0<E)for(F.pts=[],f=e=0;e<E;e+=2,f++){var G=w(D.args[e],D.args[e+1]);a.notNull(G.dx)&&a.notNull(G.dy)?F.pts[f]={dx:G.dx,dy:G.dy}:F.pts[f]={x:G.x,y:G.y}}break;case "text":3<=E&&(F.text=D.args[2].replace(/^['"]/,"").replace(/["']$/,"")),4<=E&&(F.angle=a.strtoscaled(D.args[3]).dval)}D.comment&&(F.tags=D.comment);g.push(F)}else D.cmd.match(k)?(e=a.globalOpts.xeqPlugins,a.globalOpts.xeqPlugins=!1,this.setWCSSys(D.cmd,!1),a.globalOpts.xeqPlugins=e,y=this.getWCSSys(),A=
a.isWCSSys(y)):"remove"!==D.cmd&&"delete"!==D.cmd||g.push({remove:!0})}e=a.globalOpts.xeqPlugins;a.globalOpts.xeqPlugins=!1;this.setWCSSys(z,!1);this.setWCSUnits(b);a.globalOpts.xeqPlugins=e;return g};a.Regions.saveRegions=function(c,b,d){var e,f,g;c&&(f=c.match(/\.([^.]*)$/))&&f[1]&&f[1].match(/^(reg|svg|csv)$/)&&(e=f[1]);if("object"===typeof d){var h=d;d=null}else if(d&&"string"===typeof d){try{h=JSON.parse(d)}catch(r){h=null}h&&(d=null)}h&&(a.notNull(h.layer)&&(d=h.layer),a.notNull(h.type)&&(e=
...
g)}catch(r){a.error("can't convert layer to SVG: "+d)}break;case "csv":try{h.mode=1;h.file=c;a.isNull(h.includewcs)&&(h.includewcs=a.globalOpts.csvIncludeWCS);a.isNull(h.savedcoords)&&(h.includedcoords=a.globalOpts.regSaveDCoords);var m=this.listRegions(b,h,d);f=m.split(";");var l=0;for(k="";l<f.length;l++)if(f[l])if(f[l].toLowerCase().match(a.WCSEXP))h.includewcs&&(k+=f[l].trim()+"\n");else{var p=f[l].replace(/\(/,",").replace(/\).*/,"").trim();k+=p+"\n"}}catch(r){a.error("can't convert layer to region: "+
d)}break;default:try{h.mode=1,h.file=c,a.isNull(h.includejson)&&(h.includejson=a.globalOpts.regIncludeJSON),a.isNull(h.includecomments)&&(h.includecomments=a.globalOpts.regIncludeComments),a.notNull(h.savedcoords)?h.includedcoords=h.savedcoords:h.includedcoords=a.globalOpts.regSaveDCoords,m=this.listRegions(b,h,d).replace(/; */g,"\n"),k=!1!==h.includecomments?"# Region file format: JS9 version 1.0\n"+m+"\n":m+"\n"}catch(r){a.error("can't convert layer to region: "+d)}}b=new Blob([k],{type:"text/plain;charset=utf-8"});
({}).hasOwnProperty.call(window,"saveAs")?a.saveAs(b,c):a.error("no saveAs() available to save region file");return this.tmp.saveregionsFile=c};a.Regions.unremoveRegions=function(){var a=this.regstack.pop();return a?this.addShapes("regions",a):null};a.Regions.changeRegionTags=function(a,b,d){var c;a=a||"all";b=b||[];d=d||[];$.isArray(b)||(b=b.split(",").map(function(b){return b.trim()}));$.isArray(d)||(d=d.split(",").map(function(b){return b.trim()}));var f=this.getShapes("regions",a);for(a=0;a<f.length;a++){var g=
...
"SIMPLE","T","file does conform to FITS standard");g[b]=!0;return e};if(!c)return f;b=b||{};"boolean"===typeof b&&(b={addcr:b});if(c.card||c.cardstr){var m=c.header||{};var l=c.card?c.card.length:c.ncard;for(d=0;d<l;d++)if(h=c.card?c.card[d].slice(0,80):c.cardstr.slice(80*d,80*(d+1)),!b.notab||!h.match(/^TAB(TYP|MIN|MAX|DIM)[1,2]/)){if(h.match(/^XTENSION/)&&0===d&&b.simple)f+=k(h,"XTENSION");else if(h.match(/^BITPIX /)&&c.bitpix)f+=k(h,"BITPIX",c.bitpix,"bits/pixel");else if(h.match(/^NAXIS1 /)&&
...
done:function(){k.results=g.find("mark");k.currentIndex=0;f()}})}})},e=function(a){var b=a.prop("data-btn");k.opts[b]?(a.removeClass("JS9SearchButton-false"),a.addClass("JS9SearchButton-true")):(a.removeClass("JS9SearchButton-true"),a.addClass("JS9SearchButton-false"))},f=function(){if(k.results.length){var a=k.results.eq(k.currentIndex);k.results.removeClass("current");a.length&&(a.addClass("current"),a=a.position().top,0>a||a>h.height())&&(a=a+h.scrollTop()-50,h.scrollTop(a))}};b=b||".JS9AnalysisText";
...
"search term(s)");b=$("<button>").addClass("JS9SearchButton").prop("data-btn","next").html("&darr;").appendTo(k);var l=$("<button>").addClass("JS9SearchButton").prop("data-btn","prev").html("&uarr;").appendTo(k);b.add(l).on("click",function(a){k.results&&k.results.length&&(k.currentIndex+=$(a.currentTarget).is(l)?-1:1,0>k.currentIndex&&(k.currentIndex=k.results.length-1),k.currentIndex>k.results.length-1&&(k.currentIndex=0),f())});var p=$("<button>").addClass("JS9SearchButton JS9SearchButton-"+k.opts.matchcase).prop("data-btn",
...
"Plugin").addClass("JS9Plugin"),h.odivjq.attr("id")||h.odivjq.attr("id",h.id),h.outerdivjq=h.divjq.closest(".JS9PluginContainer"),!1!==k.data("toolbarseparate")&&(b.opts.toolbarSeparate||k.data("toolbarseparate"))&&(d="<div class='"+a.lightOpts[a.LIGHTWIN].dragBar.substr(1)+"'>",$(d).insertBefore(h.divjq))):(h.id=b.name,h.winType="virtual");h.plugin=b;h.el=c;h.status="active";b.instances.push(h);if("virtual"===h.winType)for(f=0;f<a.displays.length;f++)a.displays[f].pluginInstances[b.name]||(h.div=
null,h.display=a.displays[f],b.func.apply(h,e),a.displays[f].pluginInstances[b.name]=h);else{h.div=h.divjq[0];h.outerdiv=h.outerdivjq[0];!b.opts.winDims||h.divjq.width()&&h.divjq.height()||(h.divjq.css("width",b.opts.winDims[0]),h.divjq.css("height",b.opts.winDims[1]));c=h.divjq.data("js9id")||h.id;if("*"===c)if(b.opts.dynamicSelect){h.display=a.displays[0];h.isDynamic=!0;a.Dysel.addPlugins(b.name);var m="*"}else a.error(b.name+" is not dynamically selectable");else h.display=a.lookupDisplay(c),m=
h.display.id;if(k=k.data("toolbarhtml")||b.opts.toolbarHTML)k=a.Image.prototype.expandMacro.call(null,k,[{name:"title",value:b.opts.winTitle||""}]),c=h.divjq.closest(a.lightOpts[a.LIGHTWIN].drag),0===c.length&&(c=h.divjq),$("<div class='JS9PluginToolbar-"+h.winType+"'>").css("z-index",a.BTNZINDEX).html(k).data("displayid",m).insertAfter(c);h.display.pluginInstances[b.name]=h;b.func.apply(h,e);if("*"===m)for(f=0;f<a.displays.length;f++)a.displays[f].pluginInstances[b.name]?h.display=a.displays[f]:
...
window.electron?window.setTimeout(function(){try{window.electron.sendMsg(d)}catch(e){a.error("could not quit app",e)}},a.TIMEOUT):a.error("Quit is only available for the JS9 desktop app")});a.init=function(){var c;window.HTMLCanvasElement&&JSON||a.error("your browser does not support JS9 (no HTML5 canvas and/or JSON). Please try a modern version of Firefox, Chrome, Safari, Opera, or Edge.");({}).hasOwnProperty.call(window,"JS9Prefs")&&"object"===typeof JS9Prefs&&JS9Prefs.globalOpts&&JS9Prefs.globalOpts.installDir&&
(a.INSTALLDIR=JS9Prefs.globalOpts.installDir);if(!a.INSTALLDIR){try{$('link[href$="js9.css"]').each(function(b,c){(b=$(c).attr("href"))&&"js9.css"===b.split("/").reverse()[0]&&(a.INSTALLDIR=b.replace(/js9\.css$/,""))})}catch(k){a.INSTALLDIR=""}a.INSTALLDIR&&(a.INSTALLDIR=a.cleanPath(a.INSTALLDIR))}a.INSTALLDIR&&"/"!==a.INSTALLDIR.slice(-1)&&(a.INSTALLDIR+="/");a.TOROOT=a.INSTALLDIR.replace(/([^/.])+/g,"..");({}).hasOwnProperty.call(window,"JS9Inline")&&"object"===typeof JS9Inline&&(a.inline=$.extend(!0,
...
{}.hasOwnProperty.call(window,"Jupyter")&&$(a.lightOpts[a.LIGHTWIN].topid).arrive("input",function(b){a.jupyterFocus($(b).parent())}));a.globalOpts.plotLibrary=a.globalOpts.plotLibrary||"flot";"plotly"!==a.globalOpts.plotLibrary||{}.hasOwnProperty.call(window,"Plotly")||(a.globalOpts.plotLibrary="flot");({}).hasOwnProperty.call(window,"JS9Prefs")&&"object"===typeof JS9Prefs?a.mergePrefs(JS9Prefs):a.PREFSFILE&&(a.loadPrefs(a.InstallDir(a.PREFSFILE),0),a.loadPrefs(a.PREFSFILE,0));({}).hasOwnProperty.call(a,
...
"Fabric")){$.extend(!0,a.Fabric.opts,a.fabricOpts);var b=$jscomp.makeIterator(Object.keys(a.Fabric.opts));for(c=b.next();!c.done;c=b.next())c=c.value,fabric.Object.prototype[c]=a.Fabric.opts[c]}delete a.fabricOpts;a.globalOpts.resize||(a.globalOpts.resizeHandle=!1);void 0!==a.analOpts.prependJS9Dir&&(a.globalOpts.prependJS9Dir=a.analOpts.prependJS9Dir,delete a.analOpts.prependJS9Dir);void 0!==a.analOpts.dataDir&&(a.globalOpts.dataDir=a.analOpts.dataDir,delete a.analOpts.dataDir);void 0!==a.globalOpts.regionsToClipboard&&
void 0===a.globalOpts.regToClipboard&&(a.globalOpts.regToClipboard=a.globalOpts.regionsToClipboard,delete a.globalOpts.regionsToClipboard);void 0!==a.globalOpts.regionDisplay&&void 0===a.globalOpts.regDisplay&&(a.globalOpts.regDisplay=a.globalOpts.regionDisplay,delete a.globalOpts.regionDisplay);void 0!==a.globalOpts.regionConfigSize&&void 0===a.globalOpts.regConfigSize&&(a.globalOpts.regConfigSize=a.globalOpts.regionConfigSize,delete a.globalOpts.regionConfigSize);void 0!==a.globalOpts.regionTemplates&&
void 0===a.globalOpts.regTemplates&&(a.globalOpts.regTemplates=a.globalOpts.regionTemplates,delete a.globalOpts.regionTemplates);a.BROWSER[3]&&(a.globalOpts.resizeHandle=!1);if({}.hasOwnProperty.call(window,"localStorage")&&a.globalOpts.localStorage){try{var d=localStorage.getItem("globals")}catch(k){d=null}if(d){try{a.userOpts.displays=JSON.parse(d)}catch(k){}a.userOpts.displays&&$.extend(!0,a.globalOpts,a.userOpts.displays)}try{d=localStorage.getItem("images")}catch(k){d=null}if(d){try{a.userOpts.images=
JSON.parse(d)}catch(k){}a.userOpts.images&&$.extend(!0,a.imageOpts,a.userOpts.images)}try{d=localStorage.getItem("fits")}catch(k){d=null}if(d)try{a.userOpts.fits=JSON.parse(d)}catch(k){}try{d=localStorage.getItem("regions")}catch(k){d=null}if(d){try{a.userOpts.regions=JSON.parse(d)}catch(k){}a.userOpts.regions&&$.extend(!0,a.Regions.opts,a.userOpts.regions)}try{d=localStorage.getItem("grid")}catch(k){d=null}if(d){try{a.userOpts.images=JSON.parse(d)}catch(k){}a.userOpts.images&&$.extend(!0,a.Grid.opts,
a.userOpts.images)}try{d=localStorage.getItem("catalog")}catch(k){d=null}if(d){try{a.userOpts.images=JSON.parse(d)}catch(k){}a.userOpts.images&&$.extend(!0,a.Catalogs.Opts,a.userOpts.images)}}a.DEBUG=a.DEBUG||a.globalOpts.debug||0;$("div.JS9").each(function(b,c){a.checkNew(new a.Display($(c)))});if(window.Worker&&!a.allinone)try{a.worker=new a.WebWorker(a.InstallDir(a.WORKERFILE))}catch(k){}a.allinone?a.initFITS():a.initEmscripten();window.electron&&(a.globalOpts.helperType="nodejs");a.helper=new a.Helper;
window.addEventListener("message",function(b){var c=b.origin||b.originalEvent.origin;b=b.data;"null"===c&&(c="unknown");if(a.globalOpts.postMessage){if("string"===typeof b)try{var d=JSON.parse(b)}catch(p){a.error("can't parse msg: "+b,p)}else"object"===typeof b?d=b:a.error("invalid msg from postMessage");a.msgHandler(d,function(a,b,c,e){e=e||{};parent.postMessage({cmd:d.cmd,res:{name:e.name,rtype:e.rtype,rdata:a,stdout:a,stderr:b,errcode:c}},"*")})}else a.DEBUG&&(c="JS9 ignoring postMessage, origin: "+
...
onupdateprefs:a.Grid.regrid,winDims:[0,0]});a.RegisterPlugin(a.Dysel.CLASS,a.Dysel.NAME,a.Dysel.init,{onimageload:a.Dysel.imageload,onimageclose:a.Dysel.imageclose,winDims:[0,0]});a.RegisterPlugin(a.Titlebar.CLASS,a.Titlebar.NAME,a.Titlebar.init,{onimageload:a.Titlebar.imageload,onimagedisplay:a.Titlebar.imagedisplay,onimageclose:a.Titlebar.imageclose,winDims:[0,0]});a.instantiatePlugins();a.plugins.sort(function(a,b){a=a.opts.menuItem;b=b.opts.menuItem;return a?!b||a<b?-1:a>b?1:0:1});if(a.globalOpts.processQueryParams&&
(c=new URL(window.location),c.searchParams)){d={};b=null;c=$jscomp.makeIterator(c.searchParams);for(var e=c.next();!e.done;e=c.next()){var f=$jscomp.makeIterator(e.value);e=f.next().value;f=f.next().value;switch(e){case "url":case "file":var g=f;break;case "display":var h={display:f};break;case "renamedisplay":b=f.split(/[:,]/);break;default:d[e]=f}}b&&(a.prerename=[].concat($jscomp.arrayFromIterable(b)));g&&(h?a.Preload(g,d,h):a.Preload(g,d))}$(document).scrollTop(0);a.inited=!0;$(document).trigger("JS9:init")};
return a}();
