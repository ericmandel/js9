...
resize:function(a){return{resizable:z(a)}},select:function(a){return{selectable:z(a)}},text:function(a){return{text:a}},tag:function(a){return{tags:a}},width:function(a){return{strokeWidth:parseFloat(a)}}};null!==(b=f.exec(a));)if(c=b[1],b=b[2].replace(/^['"{]|['"}]$/g,""),g.hasOwnProperty(c)&&"function"===typeof g[c])for(d in c=g[c](b),c)c.hasOwnProperty(d)&&("tags"===d&&e.hasOwnProperty(d)?e[d]+=","+c[d]:e[d]=c[d]);else e[c]=b;if(a=a.replace(f,""))e._comment=a.trim();return e},G=function(a){var b,
c,d,e={opts:{},args:[],isregion:0};0<=a.indexOf("(")?e.cmd=a.split("(")[0].trim().toLowerCase():0<=a.indexOf("{")?e.cmd=a.split("{")[0].trim().toLowerCase():0<=a.indexOf("#")?e.cmd=a.split("#")[0].trim().toLowerCase():e.cmd=a.trim().toLowerCase();e.cmd&&(e.isregion=0<=e.cmd.search(x));b=a.trim().split(D);if((c=B.exec(b[0]))&&c[0])try{e.opts=JSON.parse(c[0].trim())}catch(J){e.opts={}}e.comment=b[1];e.comment&&(d=E(e.comment.trim().toLowerCase()),void 0!==d._comment&&(e.comment=d._comment,delete d._comment));
d&&(e.opts=$.extend({},d,e.opts));(c=A.exec(a))&&c[1]&&(e.args=c[1].split(C));e.isregion&&0===e.cmd.indexOf("-")&&(e.cmd=e.cmd.slice(1),e.comment=e.comment?e.comment+",exclude":"exclude");return e},I=function(a,c){var d,e;e=b.strtoscaled(a);d=b.strtoscaled(c);!e.dtype.match(v)&&!d.dtype.match(v)||n.match(y)||(r=!0,q=n);t||r?(":"===e.dtype&&"galactic"!==q&&"ecliptic"!==q&&(e.dval*=15),"r"===e.dtype&&(e.dval=180*e.dval/Math.PI),"r"===d.dtype&&(d.dval=180*d.dval/Math.PI),d=b.wcs2pix(this.raw.wcs,e.dval,
d.dval).split(/ +/),e=parseFloat(d[0]),d=parseFloat(d[1])):"physical"===q?(d=this.logicalToImagePos({x:e.dval,y:d.dval}),e=d.x,d=d.y):(e=e.dval,d=d.dval);return[e,d]},F=function(a,c){var d=b.strtoscaled(a),e=this.raw.wcsinfo||{cdelt1:1,cdelt2:1};t||r?d.dtype&&"."!==d.dtype&&(d.dval=Math.abs(d.dval/e["cdelt"+c])):"physical"===q&&this.lcs&&this.lcs.physical&&(d.dval*=this.lcs.physical.forward[0][0]);return d.dval},H=function(a){a=b.strtoscaled(a);var c=this.raw.wcsinfo||{crot:0};c.crot&&(a.dval+=c.crot);
return a.dval};a=a.trim();if(!a.match(/(\(|\{|#|;|\n)/))return a;n=this.getWCSSys();m=this.getWCSUnits();q="physical";t="image"!==q&&"physical"!==q;h=a.split(/\n|;/);for(e=0;e<h.length;e++)if("#"!==h[e].trim().substr(0,1))if(r=!1,l=G(h[e]),p=l.args.length,l.isregion){k=$.extend(!0,{},l.opts);k.shape=l.cmd;2<=p&&(u=I.call(this,l.args[0],l.args[1]),k.x=u[0],k.y=u[1]);switch(l.cmd){case "annulus":k.radii=[];for(f=2;f<p;f++)k.radii.push(F.call(this,l.args[f],1));break;case "box":3<=p&&(k.width=F.call(this,
l.args[2],1));4<=p&&(k.height=F.call(this,l.args[3],2));5<=p&&(k.angle=H.call(this,l.args[4]));break;case "circle":3<=p&&(k.radius=F.call(this,l.args[2],1));break;case "ellipse":3<=p&&(k.r1=F.call(this,l.args[2],1));4<=p&&(k.r2=F.call(this,l.args[3],2));5<=p&&(k.angle=H.call(this,l.args[4]));break;case "line":case "polygon":k.pts=[];for(g=f=0;f<p;f+=2,g++)u=I.call(this,l.args[f],l.args[f+1]),k.pts[g]={x:u[0],y:u[1]};delete k.x;delete k.y;break;case "text":3<=p&&(k.text=l.args[2].replace(/^['"]/,"").replace(/["']$/,
"")),4<=p&&(k.angle=H.call(this,l.args[3]))}l.comment&&(k.tags=l.comment);d.push(k)}else l.cmd.match(w)?(this.setWCSSys(l.cmd),q=this.getWCSSys(),t="image"!==q&&"physical"!==q):"remove"!==l.cmd&&"delete"!==l.cmd||d.push({remove:!0});this.setWCSSys(n);this.setWCSUnits(m);return d};b.Regions.saveRegions=function(a,c,d){var e=sprintf("# Region file format: JS9 version 1.0");c=this.listRegions(c,{mode:1},d);e=sprintf("%s\n%s\n",e,c.replace(/; */g,"\n"));e=new Blob([e],{type:"text/plain;charset=utf-8"});
a||(a=d?d+".reg":"js9.reg");window.hasOwnProperty("saveAs")?saveAs(e,a):b.error("no saveAs function available to save region file");return a};b.Regions.editRegionTags=function(a,b,d){var c,f,g,h,k=[];g=this.getShapes("regions",a);if(g.length){for(c=0;c<g.length;c++)for(h=g[c].tags,k.push(b),f=0;f<h.length;f++)h[f]!==d&&k.push(h[f]);this.changeShapes("regions",a,{tags:k})}};b.Regions.toggleRegionTags=function(a,b,d){var c,f,g,h,k;g=this.getShapes("regions",a);if(g.length){for(c=0;c<g.length;c++)for(h=
...
angle:0,tagcolors:{defcolor:"#00FF00"},sortOverlapping:!1};b.Crosshair={};b.Crosshair.CLASS="JS9";b.Crosshair.NAME="Crosshair";b.Crosshair.LAYERNAME="crosshair";b.Crosshair.opts={hasControls:!1,hasRotatingPoint:!1,hasBorders:!1,lockMovementX:!0,lockMovementY:!0,lockRotation:!0,lockScalingX:!0,lockScalingY:!0,lockUniScaling:!0,selectable:!1,canvas:{selection:!1},updateWCS:!1,panzoom:!1,strokeWidth:1,color:"#00FF00",sortOverlapping:!1,hiddenPts:{pts:[{x:-9999,y:-9999},{x:-9999,y:-9900}]}};b.Crosshair.display=
function(a,c,d){var e,f,g,h,k,l,n,m=b.Crosshair.LAYERNAME;if((/iPad|iPhone|iPod/.test(navigator.platform)||d.shiftKey)&&a&&!a.tmp.shiftKey&&a.crosshair&&a.params.crosshair&&(k=a.raw.width,l=a.raw.height,n=a.ipos.x,f=a.ipos.y,k={pts:[{x:0,y:f},{x:k,y:f}]},a.changeShapes(m,a.crosshair.h,k),l={pts:[{x:n,y:0},{x:n,y:l}]},a.changeShapes(m,a.crosshair.v,l),a.crosshair.visible=!0,b.globalOpts.wcsCrosshair&&a&&a.raw.wcs&&0<a.raw.wcs))for(f=b.pix2wcs(a.raw.wcs,c.x,c.y).trim().split(/\s+/),g=b.saostrtod(f[0]),
":"===String.fromCharCode(b.saodtype())&&"galactic"!==a.params.wcssys&&"ecliptic"!==a.params.wcssys&&(g*=15),h=b.saostrtod(f[1]),c=0;c<b.displays.length;c++)if((d=b.displays[c].image)&&d!==a&&d.crosshair&&d.params.crosshair&&0<d.raw.wcs){k=d.raw.width;l=d.raw.height;try{e=b.wcs2pix(d.raw.wcs,g,h)}catch(q){e=null}e&&(f=e.trim().split(/\s+/),n=parseFloat(f[0]),f=parseFloat(f[1]),0<n&&n<k&&0<f&&f<l&&(k={pts:[{x:0,y:f},{x:k,y:f}]},d.changeShapes(m,d.crosshair.h,k),l={pts:[{x:n,y:0},{x:n,y:l}]},d.changeShapes(m,
d.crosshair.v,l),d.crosshair.visible=!0))}};b.Crosshair.hide=function(a,c,d){c=b.Crosshair.LAYERNAME;d=b.Crosshair.opts.hiddenPts;a&&a.crosshair&&a.crosshair.visible&&(a.changeShapes(c,a.crosshair.h,d),a.changeShapes(c,a.crosshair.v,d),a.crosshair.visible=!1)};b.Crosshair.create=function(a){var c=b.Crosshair.opts.hiddenPts,d=b.Crosshair.LAYERNAME;a&&!a.crosshair&&0<a.raw.wcs&&(a.crosshair={},a.crosshair.h=a.addShapes(d,"line",c),a.crosshair.v=a.addShapes(d,"line",c),a.crosshair.visible=!1)};b.Crosshair.keyaction=
