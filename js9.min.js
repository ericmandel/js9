...
a?(a="rgb,nodisplay",h.notify=!0):"display"===a&&(h.notify=!0):a="rgb";a.split(",").forEach(function(b,a,c){b=b.trim();h[b]=!0;switch(b){case "colors":h.scaled=!0;h.rgb=!0;break;case "scaled":h.rgb=!0}});h.display=!0;h.plugins=!0;this.rgbFile&&(h.colors=!1,h.scaled=!1);if("string"===typeof c)try{c=JSON.parse(c)}catch(k){b.error("can't parse displayImage opts: "+c,k)}c=c||{};if(this.display.blendMode&&!1!==c.blendMode)for(d=0;d<b.images.length;d++)e=b.images[d],e.display===this.display&&e.blend.active&&
