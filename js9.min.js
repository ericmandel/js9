...
debug:0};a.imageOpts={contrast:1,bias:0.5,invert:!1,exp:1E3,colormap:"grey",scale:"linear",scaleclipping:"dataminmax",zscalecontrast:0.25,zscalesamples:600,zscaleline:120,wcssys:"native",wcsunits:"sexagesimal",lcs:"physical",valpos:!0,alpha:255,alpha1:100,alpha2:255,zoom:1,zooms:5,nancolor:"#000000",listonchange:!1};a.analOpts={epattern:/^(ERROR:[^\n]*)\n/,dpathURL:"params/datapath.html",prependJS9Dir:!0,dataDir:null};a.lightOpts={dhtml:{top:".dhtmlwindow",drag:".drag-contentarea",dragBar:"drag-handle",
format:"width=%spx,height=%spx,center=1,resize=%s,scrolling=0",textWin:"width=830px,height=400px,center=1,resize=1,scrolling=1",plotWin:"width=830px,height=420px,center=1,resize=1,scrolling=1",dpathWin:"width=830px,height=175px,center=1,resize=1,scrolling=1",paramWin:"width=830px,height=230px,center=1,resize=1,scrolling=1",imageWin:"width=512px,height=542px,center=1,resize=1,scrolling=1",lineWin:"width=400px,height=10px,center=1,resize=1,scrolling=1"}};a.textColorOpts={regions:"#00FF00",info:"#00FF00"};
a.plotOpts={zoomStack:!0,selection:{mode:"xy"},series:{clickable:!0,hoverable:!0,lines:{show:!0},points:{show:!1}}};a.helpOpts={user:{type:"help",url:"user.html",title:"JS9 User Manual"},install:{type:"help",url:"install.html",title:"Installing JS9"},webpage:{type:"help",url:"webpage.html",title:"Adding JS9 To A Web Page"},yourdata:{type:"help",url:"yourdata.html",title:"Adding Data To A Web Page"},localtasks:{type:"help",url:"localtasks.html",title:"Local Analysis with JS9"},publicapi:{type:"help",
...
$.contextMenu({selector:"#fileMenu"+g.id,zIndex:a.MENUZINDEX,events:{hide:b},build:function(){var b,c,e,g,f=0,h={},p=d()[0];g=a.images.length;for(b=0;b<g;b++)c=a.images[b],c.display===p&&(e=c.id,h[e]={name:e},p.image&&p.image.id===c.id&&(h[e].icon="sun"),f++);f||(h.noimg={name:"[no images]",events:{keyup:function(){}}});h["sep"+f++]="------";h.open={name:"open local file ..."};h.loadcors={name:"open link via CORS ..."};if(a.globalOpts.workDir&&("nodejs"===a.helper.type||"sock.io"===a.helper.type))h.loadproxy=
{name:"open link via proxy ..."};h.print={name:"print ..."};h.header={name:"display FITS header"};h.pageid={name:"display pageid"};h.savefits={name:"save image as FITS"};h.savepng={name:"save image as PNG"};h.close={name:"close image"};h["sep"+f++]="------";h.lite={name:"new JS9 light window"};h.xnew={name:"new JS9 separate window"};2<a.DEBUG&&(h["sep"+f++]="------",h.refresh={name:"debug: refresh ..."});return{callback:function(b){d().forEach(function(d){var c,e;e=d.image;switch(b){case "close":e&&
e.closeImage();break;case "header":e&&(e.raw.header?e.displayAnalysis("text",a.raw2FITS(e.raw,!0),"FITSHeader_"+e.id):a.error("no FITS header for "+e.id));break;case "lite":a.LoadWindow(null,null,"light");break;case "xnew":a.LoadWindow(null,null,"new");break;case "pageid":d="<center><p>Usage: js9 -pageid [pageid] ...<p>"+a.helper.pageid||"none</center>";a.lightWin("fileid"+a.uniqueID(),"inline",d,"page ID",a.lightOpts[a.LIGHTWIN].lineWin);break;case "open":a.OpenFileMenu(d);break;case "loadcors":a.globalOpts.dhtmlloadid=
"sharedURLForm";e=a.Image.prototype.displayAnalysis.call(null,"textline",a.InstallDir(a.globalOpts.corsURL),"Open a shared CORS link");$(e).data("dispid",d.id);break;case "loadproxy":a.globalOpts.dhtmlloadid="proxyURLForm";e=a.Image.prototype.displayAnalysis.call(null,"textline",a.InstallDir(a.globalOpts.proxyURL),"Open a link via server proxy");$(e).data("dispid",d.id).data("aname","loadproxy");break;case "refresh":$("#refreshLocalFile-"+d.id).click();break;case "savefits":e&&(d=e.id.replace(/png/,
"fits").replace(/.gz$/,"").replace(/\[.*\]/,""),e.saveFITS(d));break;case "savepng":e&&(d=e.id.replace(/fits/,"png").replace(/.gz$/,"").replace(/\[.*\]/,""),e.savePNG(d));break;case "print":e&&e.print();break;default:for(c=0;c<a.images.length;c++)if(e=a.images[c],d.id===e.display.id&&e.id===b){e.displayImage("display");e.clearMessage();break}}})},items:h}}});$("#viewMenu"+g.id).on("mousedown",function(a){a.preventDefault();$("#viewMenu"+g.id).contextMenu()});$.contextMenu({selector:"#viewMenu"+g.id,
...
g.display.image,d={};b&&(d.scalemin=String(b.params.scalemin),d.scalemax=String(b.params.scalemax));$.contextMenu.setInputValues(a,d)},hide:function(a){var b=g.display.image;b&&a.edited&&(delete a.edited,a=$.contextMenu.getInputValues(a),p(b,a))}},items:h}}});$("#colorMenu"+g.id).on("mousedown",function(a){a.preventDefault();$("#colorMenu"+g.id).contextMenu()});$.contextMenu({selector:"#colorMenu"+g.id,zIndex:a.MENUZINDEX,events:{hide:b},build:function(){var b,c,e,f=0,h={},q=d()[0],p=function(a,b){isNaN(b.contrast)||
(a.params.contrast=b.contrast);isNaN(b.bias)||(a.params.bias=b.bias);isNaN(b.alpha)||(a.params.alpha=b.alpha);a.displayImage("colors")},s=function(a){var b=$.contextMenu.getInputValues(a.data),d=g.display.image;switch(a.which||a.keyCode){case 9:case 13:p(d,b)}a.data.edited=!0};h.cmaptitle={name:"Colormaps:",disabled:!0};for(b=0;b<a.colormaps.length;b++)e=c=a.colormaps[b].name,h[c]={name:e},q.image&&q.image.cmapObj.name===c&&(h[c].icon="sun");h["sep"+f++]="------";h.contrast={events:{keyup:s},name:"contrast value:",
type:"text"};h.bias={events:{keyup:s},name:"bias value:",type:"text"};h.alpha={events:{keyup:s},name:"alpha value:",type:"text"};h["sep"+f++]="------";h.reset={name:"reset contrast/bias"};h["sep"+f++]="------";h.invert={name:"invert colormap"};q.image&&q.image.params.invert&&(h.invert.icon="sun");h["sep"+f++]="------";h.rgb={name:"RGB mode"};a.globalOpts.rgb.mode&&(h.rgb.icon="sun");return{callback:function(a){d().forEach(function(b){(b=b.image)&&b.setColormap(a)})},events:{show:function(a){var b=
g.display.image,d={};b&&(d.contrast=String(b.params.contrast),d.bias=String(b.params.bias),d.alpha=String(b.params.alpha));$.contextMenu.setInputValues(a,d)},hide:function(a){var b=g.display.image;b&&a.edited&&(delete a.edited,a=$.contextMenu.getInputValues(a),p(b,a))}},items:h}}});$("#regionMenu"+g.id).on("mousedown",function(a){a.preventDefault();$("#regionMenu"+g.id).contextMenu()});$.contextMenu({selector:"#regionMenu"+g.id,zIndex:a.MENUZINDEX,events:{hide:b},build:function(){var b=d()[0].image,
c={regiontitle:{name:"Regions:",disabled:!0},annulus:{name:"annulus"},box:{name:"box"},circle:{name:"circle"},ellipse:{name:"ellipse"},point:{name:"point"},polygon:{name:"polygon"},text:{name:"text"},sep2:"------",loadRegions:{name:"load regions"},saveRegions:{name:"save regions"},listRegions:{name:"list regions"},deleteRegions:{name:"delete regions"},listonchange:{name:"list on change"},xeqonchange:{name:"xeq on change"}};b&&b.params.listonchange&&(c.listonchange.icon="sun");b&&b.params.xeqonchange&&
...
b.helper=!0;c=[];for(d=0;d<a.displays.length;d++)c.push(a.displays[d].id);b.socket.emit("displays",{displays:c},function(a){b.pageid=a});a.Preload(!0);a.DEBUG&&a.log("JS9 helper: connect: "+b.type)});b.socket.on("disconnect",function(){b.connected=!1;b.helper=!1;1<a.DEBUG&&a.log("JS9 helper: disconnect")});b.socket.on("reconnect",function(){b.connected=!0;b.helper=!0;1<a.DEBUG&&a.log("JS9 helper: reconnect")});b.socket.on("msg",function(b,d){var c,e,f,n=[],r=b.cmd,k=b.id;a.globalOpts.alerts=!1;if(a.publics[r]){$.isArray(b.args)||
(b.args=[b.args]);n=$.extend(!0,[],b.args);k&&n.push({display:k});try{f=a.publics[r].apply(null,n)}catch(q){f=sprintf("ERROR: %s",q.message)}d&&d(f);a.globalOpts.alerts=!0}else if(!r||"#"===r)d&&d(""),a.globalOpts.alerts=!0;else{c=a.lookupCommand(r);e=a.lookupDisplay(k);if(c&&e)switch(c.getDisplayInfo(e),b.args?n=$.extend(!0,[],b.args):b.paramlist&&(n=b.paramlist.split(/ +/)),c.getWhich(n)){case "get":try{f=c.get(n)||""}catch(p){f="ERROR: "+p.message}break;case "set":try{f=c.set(n)||"OK"}catch(s){f=
"ERROR: "+s.message}break;default:f=sprintf("ERROR: unknown cmd type for '%s'",r)}else c||(f=sprintf("ERROR: unknown cmd '%s'",r)),e||(f=sprintf("ERROR: unknown display (%s)",k));a.globalOpts.alerts=!0;d&&d(f)}})},error:function(b,d,c){a.DEBUG&&a.log("JS9 helper: connect failure: "+d+" "+c)}});break;default:a.error("unknown helper type: "+this.type)}};a.Helper.prototype.send=function(d,b,c){if(!this.connected)return null;b&&"object"===typeof b?(b.cookie=document.cookie,a.globalOpts.dataPath&&!b.dataPath&&
