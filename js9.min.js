...
this,h,g=[],k=function(a,b){0>$.inArray(a,g)&&(e.call(f,a,b),g.push(a))};var l=function(b){a.tmp.regSelect={layer:c,im:f,all:[]};m.getObjects().forEach(function(b){b.params&&a.tmp.regSelect.all.push(b.params.id)});try{regSelect.parse(b)}catch(t){a.error("parsing selection filter: "+b,t)}f.regSelect=b;b=a.tmp.regSelect.ids;delete a.tmp.regSelect;return b};if(!this.layers||!c||!this.layers[c])return null;"function"!==typeof e&&a.error("selectShapes requires a callback");d=d||{};var m=this.layers[c].canvas;
b||(b=m.getActiveObject()&&"auto"===a.globalOpts.regWhichDefault?"selected":"all");if("string"===typeof b&&b.startsWith("["))try{b=JSON.parse(b)}catch(u){a.error("can't parse array selection")}if("string"===typeof b){if(this.regSelect){if("and"===d.prevselect)b="($prevselect) && "+b;else if("or"===d.prevselect||"add"===d.prevselect)b="($prevselect) || "+b;b=b.replace(/\$prevselect/g,this.regSelect)}b.match(/&|\||!/)&&(b=l(b))}$.isArray(b)||(b=[b]);for(d=0;d<b.length;d++){l=m.getObjects();var n=l.length;
var p=m.getActiveObjects();var q=p.length;var r=1===fabric.major_version?m.getActiveGroup():(h=m.getActiveObject())&&"activeSelection"===h.type?h:null;var v=b[d];"string"===typeof v&&/^[1-9]\d*$/.test(v)&&(v=parseInt(v,10));var w={group:null,canvas:m,layer:c};switch(typeof v){case "object":v.params&&(r&&r.contains(v)&&(w.group=r),k(v,w));break;case "number":for(;n--;)h=l[n],h.params&&v===h.params.id&&(r&&r.contains(h)?w.group=r:w.group=null,k(h,w));break;case "string":if("selected"===v)if(1===fabric.major_version)if(m.getActiveObject())h=
m.getActiveObject(),h.params&&(w.group=null,k(h,w));else{if(r)for(w.group=r;n--;)h=l[n],h.params&&!h.params.parent&&k(h,w)}else for(w.group=r;q--;)h=p[q],h.params&&!h.params.parent&&k(h,w);else for(;n--;)if(h=l[n],h.params&&(p=h.stroke.toLowerCase(),!h.params.parent||"child"===v||"All"===v))if("child"!==v||h.params.parent)if(r&&r.contains(h)?w.group=r:w.group=null,"all"===v.toLowerCase())k(h,w);else if(v.toLowerCase()===p||a.colorToHex(v).toLowerCase()===p)k(h,w);else if(v===h.params.shape)k(h,w);
else if(v===h.params.file)k(h,w);else if("object"===typeof h.params.data&&v===h.params.data.syncid)k(h,w);else if("child"===v&&h.params.parent)k(h,w);else if("dcoords"===v&&h.params.preservedcoords)k(h,w);else if("nodcoords"===v&&!h.params.preservedcoords)k(h,w);else if("parent"===v&&h.params.children&&h.params.children.length)k(h,w);else if(0<=$.inArray(v,a.wcssyss)&&h.params.wcsconfig&&h.params.wcsconfig.wcssys===v)k(h,w);else if(h.params.tags)for(p=0;p<h.params.tags.length;p++)q=h.params.tags[p],
v.match(/^\/.*\/$/)&&q.match(new RegExp(v.slice(1,-1)))?k(h,w):v===q&&k(h,w)}}return this};a.Fabric.selectShapes=function(a,b,d){var c,f=[];if(c=this.getShapeLayer(a))return d=d||{},c=c.canvas,c.discardActiveObject(),this._selectShapes(a,b,d,function(a){0>$.inArray(a,f)&&f.push(a)}),a=new fabric.ActiveSelection(f,{canvas:c}),c.setActiveObject(a),c.renderAll(),this};a.Fabric.updateShapes=function(a,b,d,e){var c=this;this._selectShapes(a,b,null,function(b,f){c._updateShape(a,b,f,d,e)});return this};
a.Fabric._updateMultiDialogs=function(a){var b=this;$("form[class*='regionsConfigForm']").each(function(c,e){c=$(e).data("multi");var d=$(e).data("winid");e=$(e).data("im");c&&d&&e===b&&e.initRegionsForm(null,{winid:d,multi:c,setmode:a})})};a.Fabric._updateShape=function(c,b,d,e,f){var h,g={},k=this.layers[c],l=/^(child||export|unexport|move|mouseout)$/;var m=function(a){return a.toFixed(2)};var n=function(b,c,d,e,f,g,h){var k=a.pix2wcs(b,d.x,d.y).trim().split(/\s+/);h.rastr=k[0];h.decstr=k[1];h.wcssys=
k[2];var l=a.strtoscaled(k[0]);a.isHMS(k[2],l.dtype)&&(l.dval*=15);var m=a.strtoscaled(k[1]);h.ra=l.dval;h.dec=m.dval;if(!1!==g.updateWCS&&(g.updateWCS||c.opts.updateWCS)){h.wcsstr=a.reg2wcs(b,e).replace(/;$/,"");"line"===d.shape&&f&&(h.wcsstr=h.wcsstr.replace(/} *$/,f+"}"));k=h.wcsstr.replace(/.*\(/,"").replace(/\).*/,"").split(",");for(b=0;b<k.length;b++)k[b]=k[b].trim();h.wcsposstr=[k[0],k[1]];switch(d.shape){case "annulus":h.wcssizestr=[k[k.length-1]];break;case "box":case "cross":h.wcssizestr=
...
this.delayedShapes||[],this.delayedShapes.push({layer:c,shape:b,mode:"change",opts:d});else{var t=l.canvas;var x=t.getActiveObject();this._selectShapes(c,b,d,function(b,B){p="main"!==e.display.layers[c].dtype||b.params.preservedcoords?1:e.rgb.sect.zoom;d.radii&&(b.params.radii=[]);d.tags&&(b.params.tags=[]);k=$.extend(!0,{},b.params,d);g=e._parseShapeOptions(c,k,b);if(g.remove){if(!0===g.remove||"true"===g.remove)g.remove="all";if(!1!==g.remove&&"false"!==g.remove){e.removeShapes(c,g.remove||"all");
return}}if(g.opts.send)switch(g.opts.send){case "front":t.sendToFront(x);t.discardActiveObject();break;case "back":t.sendToBack(x),t.discardActiveObject()}q=e._exportShapeOptions(d).filter(function(a){return!b.params.exports.hasOwnProperty(a)});g.params.exports=b.params.exports.concat(q);g.opts.stroke&&(g.opts.color=g.opts.stroke,g.opts.stroke=a.colorToHex(g.opts.stroke));switch(b.params.shape){case "text":g.opts.stroke&&(g.opts.fill=g.opts.stroke);g.opts.strokeWidth=0;break;case "line":case "polygon":g.opts.points&&
g.opts.points.length&&(b.angle=0)}b.set(g.opts);b.params=$.extend(!1,{},b.params,g.params);d.strokeWidth&&(b.params.sw1=d.strokeWidth);switch(b.params.shape){case "annulus":if(d.radii&&d.radii.length){b.forEachObject(function(a){w.push(a)});m=w.length;for(f=0;f<m;f++)b.remove(w[f]),t.remove(w[f]);m=b.params.radii.length;n=0;r=$.extend(!0,{},d);r.stroke=r.stroke||b.get("stroke");for(f=0;f<m;f++)r.radius=b.params.radii[f],h=new fabric.Circle(r),n=Math.max(n,b.params.radii[f]),b.add(h);b.scaleX=p;b.scaleY=
p;b.width=2*n;b.height=2*n;x===b&&t.setActiveObject(b)}break;case "box":d.width&&(b.scaleX=p);d.height&&(b.scaleY=p);break;case "circle":d.radius&&(b.scaleX=p,b.scaleY=p);break;case "cross":r=$.extend(!0,{},d);r.stroke=r.stroke||b.get("stroke");r.width&&(b.scaleX=p,u[0]=[{x:-r.width/2,y:0},{x:r.width/2,y:0}],delete r.width);r.height&&(b.scaleY=p,u[1]=[{x:0,y:-r.height/2},{x:0,y:r.height/2}],delete r.height);r.angle&&delete r.angle;b.forEachObject(function(a,b){v=$.extend(!0,{},r);u[b]&&(v.points=
u[b]);a.set(v)});break;case "ellipse":d.r1&&(b.rx=b.params.r1,b.scaleX=p,b.width=2*b.rx);d.r2&&(b.ry=b.params.r2,b.scaleY=p,b.height=2*b.ry);break;case "line":case "polygon":if(d.points&&d.points.length||d.pts&&d.pts.length)b.scaleX=p,b.scaleY=p;x===b&&(a.Fabric.removePolygonAnchors(l.dlayer,b),a.Fabric.addPolygonAnchors(l.dlayer,b));a.resetPolygonCenter(b);break;case "text":d.text&&(b.params.text=d.text)}b.rescaleBorder();a.Fabric.updateChildren(l.dlayer,b,"moving");a.Fabric.updateChildren(l.dlayer,
...
a.Image.prototype.getShapes=a.Fabric.getShapes;a.Image.prototype.changeShapes=a.Fabric.changeShapes;a.Image.prototype.removeShapes=a.Fabric.removeShapes;a.Image.prototype.refreshShapes=a.Fabric.refreshShapes;a.Image.prototype.copyShapes=a.Fabric.copyShapes;a.Image.prototype.selectShapes=a.Fabric.selectShapes;a.Image.prototype.getShapeLayer=a.Fabric.getShapeLayer;a.Image.prototype.showShapeLayer=a.Fabric.showShapeLayer;a.Image.prototype.activeShapeLayer=a.Fabric.activeShapeLayer;a.Image.prototype.displayShapeLayers=
...
source:"#00FF00",background:"#FFD700",defcolor:"#00FF00"},onmousedown:function(c,b,d,e){var f,h=e.params;!a.specialKey(d)&&h&&(b=(new Date).getTime(),h.lasttime&&b-h.lasttime<a.DBLCLICK&&(f=!0),h.lasttime=b);f?h.winid||!1===h.changeable||c.displayRegionsForm(e):a.specialKey(d)&&("polygon"===e.type||"polyline"===e.type?(c._addPolygonPoint(h.layerName,e,d),c._updateShape(h.layerName,e,null,"update")):e.polyparams&&e.polyparams.polygon&&(d=e.polyparams.polygon,c._removePolygonPoint(d.params.layerName,
e),c._updateShape(d.params.layerName,d,null,"update")))},onmouseup:function(){var a,b=[];this.getActiveObject()&&b.push(this.getActiveObject());1===fabric.major_version?this.getActiveGroup()&&(b=this.getActiveGroup().getObjects()):b.push(this.getActiveObjects());for(a=0;a<b.length;a++)b[a].polyparams&&this.setActiveObject(b[a].polyparams.polygon)},onchange:null};a.Regions.init=function(c){a.Image.prototype.parseRegions=a.Regions.parseRegions;a.Image.prototype.saveRegions=a.Regions.saveRegions;a.Image.prototype.listRegions=
...
n=!1,p=this.raw.wcsinfo||{cdelt1:1,cdelt2:1};var q={type:"multi",pub:{shape:"multi",wcsconfig:{}},params:{}};var r=function(a){if(void 0!==a)return"number"===typeof a&&0!==a%1&&(a=Math.round(1E4*(a+1E-5))/1E4),String(a)},v=function(a){return(a||"").replace(/\n/g,"\\n")};if(c&&c.pub)var w=c.pub.wcsconfig&&c.pub.wcsconfig.wcssys?c.pub.wcsconfig.wcssys:this.params.wcssys;else w=this.params.wcssys,c=q;b=b||{};if(c.params.winid)var u=c.params.winid;else b.winid&&(u=b.winid);if(u){var t="#"+$(u).attr("id")+
" .regionsConfigForm ";if($(t).length){n=$(t).data("multi")?!0:b.multi;$(t+"."+c.pub.shape).each(function(a,b){$(b).removeClass("nodisplay")});$(t+".val").each(function(b,m){h="";f=$(m).attr("name");switch(f){case "x":case "y":c.pub.lcs&&void 0!==c.pub.lcs[f]?h=r(c.pub.lcs[f]):void 0!==c.pub[f]&&(h=r(c.pub[f]));break;case "radii":c.pub.radii&&(h=a.notWCS(w)||!c.pub.wcsconfig.wcsstr?c.pub.imstr.replace(/^annulus\(/,"").replace(/\)$/,"").split(",").slice(2).join(","):c.pub.wcsconfig.wcsstr.replace(/^annulus\(/,
"").replace(/\)$/,"").split(",").slice(2).join(","));break;case "pts":c.pub.pts?c.pub.pts.forEach(function(a){h&&(h+=", ");h+=a.x.toFixed(2)+", "+a.y.toFixed(2)}):c.pub.imstr&&(h=c.pub.imstr.replace(/^.*\(/,"").replace(/\)$/,""));break;case "linelength":if(c.pub.pts&&2===c.pub.pts.length){k=c.pub.pts[0];l=c.pub.pts[1];h=r(Math.sqrt((l.x-k.x)*(l.x-k.x)+(l.y-k.y)*(l.y-k.y)));switch(w){case "image":case "physical":break;default:h*=Math.abs(p.cdelt1),h*=Math.abs(p.cdelt2)}h=r(h);d.tmp.linelength=h}break;
case "lineangle":if(c.pub.pts&&2===c.pub.pts.length){k=c.pub.pts[0];l=c.pub.pts[1];for(h=180*Math.atan2(l.y-k.y,l.x-k.x)/Math.PI;0>h;)h+=360;h=r(h);d.tmp.lineangle=h}break;case "fontFamily":c.getFontFamily&&(h=c.getFontFamily());break;case "fontSize":c.getFontSize&&(h=c.getFontSize());break;case "fontStyle":c.getFontStyle&&(h=c.getFontStyle());break;case "fontWeight":c.getFontWeight&&(h=c.getFontWeight());break;case "colorPicker":h=void 0!==c.pub.color?a.colorToHex(c.pub.color):$(t).data("colorpicker")||
a.globalOpts.defcolor;break;case "color":void 0!==c.pub.color?h=r(c.pub.color):$(t).data("colorpicker")&&(h=$(t).data("colorpicker"));break;case "strokeWidth":h=c.params.sw1?c.params.sw1:$(t).data("strokewidth")||"";break;case "strokeDashes":c.strokeDashArray?(h=c.strokeDashArray.join(" "),h.match(/NaN/)&&(h="")):h=$(t).data("strokedashes")||"";break;case "regstr":h=a.notWCS(w)||!c.pub.wcsconfig.wcsstr?c.pub.imsys+";"+c.pub.imstr:c.pub.wcsconfig.wcssys+";"+c.pub.wcsconfig.wcsstr;break;case "xpos":switch(w){case "image":c.pub.preservedcoords&&
void 0!==c.pub.dx?h=sprintf("d%.1f",c.pub.dx):void 0!==c.pub.x&&(h=sprintf("%.1f",c.pub.x));break;case "physical":c.pub.lcs?h=sprintf("%.1f",c.pub.lcs.x):void 0!==c.pub.x&&(h=sprintf("%.1f",c.pub.x));break;default:void 0!==c.pub.wcsconfig.ra?h=sprintf("%.6f",c.pub.wcsconfig.ra):void 0!==c.pub.x&&(h=sprintf("%.1f",c.pub.x))}break;case "ypos":switch(w){case "image":c.pub.preservedcoords&&void 0!==c.pub.dy?h=sprintf("d%.1f",c.pub.dy):void 0!==c.pub.y&&(h=sprintf("%.1f",c.pub.y));break;case "physical":c.pub.lcs?
h=sprintf("%.1f",c.pub.lcs.y):void 0!==c.pub.y&&(h=sprintf("%.1f",c.pub.y));break;default:void 0!==c.pub.wcsconfig.dec?h=sprintf("%.6f",c.pub.wcsconfig.dec):void 0!==c.pub.y&&(h=sprintf("%.1f",c.pub.y))}break;case "radius":case "oradius":case "length":case "width":case "r1":switch(w){case "image":void 0!==c.pub[f]&&(h=r(c.pub[f]));break;case "physical":c.pub.lcs&&void 0!==c.pub.lcs[f]&&(h=r(c.pub.lcs[f]));break;default:void 0!==c.pub.wcsconfig.wcssizestr?h=r(c.pub.wcsconfig.wcssizestr[0]):void 0!==
c.pub[f]&&(h=r(c.pub[f]))}break;case "height":case "r2":switch(w){case "image":void 0!==c.pub[f]&&(h=r(c.pub[f]));break;case "physical":c.pub.lcs&&void 0!==c.pub.lcs[f]&&(h=r(c.pub.lcs[f]));break;default:void 0!==c.pub.wcsconfig.wcssizestr?h=r(c.pub.wcsconfig.wcssizestr[1]):void 0!==c.pub[f]&&(h=r(c.pub[f]))}break;case "wcssys":case "savewcs":x=$(t).find("[name='"+f+"']");if(!x.find("option").length)for(e=0;e<a.wcssyss.length;e++)x.append("<option>"+a.wcssyss[e]+"</option>");g="savewcs"===f?a.globalOpts.regSaveWCS||
w:w;x.find("option").each(function(a,b){g===b.value&&(h=b.value)});break;case "wcsunits":c.pub.wcsunits&&(h=c.pub.wcsunits);break;case "childtext":c.params.children&&0<c.params.children.length&&(h=v(c.params.children[0].obj.text));break;case "text":void 0!==c.pub[f]&&(h=v(r(c.pub[f])));break;case "id":n?h="selected":void 0!==c.pub.id&&(h=String(c.pub.id),$(m).css("width",h.length+"ch"));break;case "tags":void 0!==c.pub[f]&&(h=r(c.pub[f]));break;case "savefile":h=$(t).data("savefile")||d.tmp.saveregionsFile||
"js9.reg";window.electron&&!h.match(/.*\//)&&(h=window.electron.currentDir+"/"+h);break;case "selectfilter":h=$(t).data("selectfilter");break;default:void 0!==c.pub[f]&&(h=r(c.pub[f]))}$(m).val(h)});(n||!this.raw.wcs||0>this.raw.wcs)&&$(t).find("[name='wcssys']").hide();"text"!==c.type&&c.params.children&&($(t+".childtext").removeClass("nodisplay"),$(t+"[name='childtext']").prop("readonly",0<c.params.children.length));if(b.firsttime){window.electron&&$(t).find(".rsavebrowse, .rconfigbrowse").removeClass("nodisplay");
n?($(t).find("label[for='savecur']").text("sel"),$(t).find("input[id='savecur']").data("tooltip","save selected regions")):$(t).find(".checkboxes").removeClass("nodisplay");if(a.favorites.wcs&&a.favorites.wcs.length){var x=$(t).find(".rwcsbuttons").removeClass("nodisplay");q=x.find(".rwcsbuttoncontainer");if(q.length&&!q.find(".rwcsbutton").length){for(e=0;e<a.favorites.wcs.length;e++){var y=a.favorites.wcs[e];var B="string"===typeof y?y.split(":"):y;y=B[0];B=B[1]||y;if("save"===b.type){var z="rsavecol_R"+
(e+2);var A="rsaveradio"}else z="rconfigcol_R"+(e+2),A="rconfigradio";q.append("<span class='rconfigcol_R rwcsbutton "+z+"'>\n                                <input type='radio'\n                                       id='rwcsbutton_"+y+"'\n                                       name='rwcsbutton'\n                                       class='rwcsradio "+A+"}'\n                                       value='"+y+"'\n                                       data-tooltip='save using "+y+' wcs\'\n                                       onclick=\'\n                                           $(this).closest("form")\n                                           .find("[name=savewcs]")\n                                           .val("'+
y+'")\n                                           .trigger("change");\'>\n                                <label for=\'rwcsbutton_'+y+"'>"+B+"</label>\n                                </span>")}$(t).find(".rwcsbuttons").find("[value='"+w+"']").prop("checked",!0)}}a.globalOpts.internalColorPicker&&$.fn.spectrum.inputTypeColorSupport()||(x=$(t).find("input[name='colorPicker']"),x.spectrum({showButtons:!1,showInput:!1,preferredFormat:"hex6"}),x.on("move.spectrum",function(a,b){a=b.toHexString();$(t).find("input[name='color']").val(a);
$(t).data("colorpicker",a)}))}void 0===c.params.listonchange&&(c.params.listonchange=!1);c.params.listonchange?$(t+"[name='listonchange']").prop("checked",!0):$(t+"[name='listonchange']").prop("checked",!1);void 0===c.params.changeable&&void 0!==c.params.fixinplace&&(c.params.changeable=!c.params.fixinplace);void 0===c.params.changeable&&(c.params.changeable=!0);c.params.changeable?$(t+"[name='changeable']").prop("checked",!0):$(t+"[name='changeable']").prop("checked",!1);c.params.sticky?$(t+"[name='sticky']").prop("checked",
!0):$(t+"[name='sticky']").prop("checked",!1);$(t+"[id='includejson']").prop("checked",a.globalOpts.regIncludeJSON);$(t+"[id='includecomments']").prop("checked",a.globalOpts.regIncludeComments);$(t+"[id='savedcoords']").prop("checked",a.globalOpts.regSaveDCoords);$(t+"[id='includewcs']").prop("checked",a.globalOpts.csvIncludeWCS);$(t).find("input[name='saveformat']").prop("checked",!1);$(t).find("input[value='"+a.globalOpts.regSaveFormat+"']").prop("checked",!0);$(t).find("input[name='rwcsbutton']").prop("checked",
!1);$(t).find("input[value='"+(a.globalOpts.regSaveWCS||w)+"']").prop("checked",!0);y="save"===b.type?"save"+a.globalOpts.regSaveWhich1:"save"+a.globalOpts.regSaveWhich2;$(t+"[id='"+y+"']").prop("checked",!0);"save"===b.type&&$(t).find("input[name='savefile']").trigger("change");$(t).find("input[name='strokeMenu']").prop("selectedIndex",0);$(t).find("input[name='dashesMenu']").prop("selectedIndex",0);if(n)$(t).find(".regid").hide(),$(t).find(".edit").hide(),$(t).find(".childtext").hide(),$(t).find(".multi").removeClass("nodisplay"),
0>=b.setmode?($(t).find("[name='multitext']").val(""),0>b.setmode&&($(t).data("selectfilter",""),$(t).find("[name='selectfilter']").val(""))):(y=this.listRegions("selected",{mode:1,includejson:!1,includecomments:!1}).replace(/ *; */g,"\n"),$(t).find("[name='multitext']").val(y));else switch($(t).find("input:text[readonly]").css("border-color","A5A5A5").css("background","#E9E9E9"),c.pub.shape){case "box":case "cross":case "ellipse":$(t+".angle").removeClass("nodisplay");break;case "text":$(t+".textangle").removeClass("nodisplay");
break;case "line":c.pub.pts&&2===c.pub.pts.length?($(t+".linelength").removeClass("nodisplay"),$(t+".lineangle").removeClass("nodisplay")):($(t+".linelength").addClass("nodisplay"),$(t+".lineangle").addClass("nodisplay"))}$(t+".xtrareg").addClass("nodisplay");$(t+".xtracsv").addClass("nodisplay");$(t+".xtrasvg").addClass("nodisplay");$(t+".xtra"+a.globalOpts.regSaveFormat).removeClass("nodisplay");$(t).data("im",this);$(t).data("shape",c);$(t).data("winid",u);$(t).data("multi",n);a.BROWSER[3]?(u=
"touchstart",q="touchend"):(u="mouseover",q="mouseout");if("save"===b.type)$(t).on(u,function(){$(t).find("input[name='savefile']").focus()});$(t).data("tooltipInit")||($(t).data("tooltipInit",!0),$(".rconfigcol_R, .rsavecol_R").on(u,function(b){var c=b.currentTarget;b=$(c).find("input, textarea, span").data("tooltip");c=$(c).closest(a.lightOpts[a.LIGHTWIN].top).find(a.lightOpts[a.LIGHTWIN].dragBar);b&&c.length&&(m=$(c)[0].childNodes[0].nodeValue.replace(/:.*/,""),$(c)[0].childNodes[0].nodeValue=
m+": "+b)}),$(".rconfigcol_R, .rsavecol_R").on(q,function(b){b=$(b.currentTarget).closest(a.lightOpts[a.LIGHTWIN].top).find(a.lightOpts[a.LIGHTWIN].dragBar);b.length&&(m=$(b)[0].childNodes[0].nodeValue.replace(/:.*/,""),$(b)[0].childNodes[0].nodeValue=m)}))}}};a.Regions.processConfigForm=function(c,b,d){var e=1;var f={type:"multi",pub:{shape:"multi"},params:{}};var h=d.length,g={},k=this.raw.wcsinfo||{cdelt1:1,cdelt2:1},l=function(a){if(void 0!==a)return"number"===typeof a&&0!==a%1&&(a=Math.round(1E4*
(a+1E-5))/1E4),String(a)},m=function(a,b){return v?!0:void 0===a?!1:l(a)!==l(b)},n=function(b,c,d){if("remove"===c)return"selected"===d;if("childtext"===c)return b.params.children&&0<b.params.children.length?!1:""!==d;if("strokeDashes"===c){if(b.strokeDashArray)return JSON.stringify(b.strokeDashArray)!==JSON.stringify(d);if($.isArray(d))switch(d.length){case 0:return!1;case 1:return""!==d[0];default:return""!==d[0]&&""!==d[1]}else return""!==d}if("tags"!==c&&""===d)return!1;if("misc"===c&&""!==d)return!0;
if("angle"===c)return b.angle!==-parseFloat(d);if("ix"===c)return b.pub.preservedcoords&&"d"===d.charAt(0).toLowerCase()?m(b.pub.dx,a.saostrtod(d.substring(1))):m(b.pub.x,a.saostrtod(d));if("iy"===c)return b.pub.preservedcoords&&"d"===d.charAt(0).toLowerCase()?m(b.pub.dy,a.saostrtod(d.substring(1))):m(b.pub.y,a.saostrtod(d));if("px"===c&&b.pub.lcs)return m(b.pub.lcs.x,a.saostrtod(d));if("py"===c&&b.pub.lcs)return m(b.pub.lcs.y,a.saostrtod(d));if("ra"===c)return b.pub.wcsconfig.wcsposstr?m(a.saostrtod(b.pub.wcsconfig.wcsposstr[0]),
a.saostrtod(d)):b.pub.wcsposstr?m(a.saostrtod(b.pub.wcsposstr[0]),a.saostrtod(d)):!1;if("dec"===c){if(b.pub.wcsconfig.wcsposstr)return m(a.saostrtod(b.pub.wcsconfig.wcsposstr[1]),a.saostrtod(d));if(b.pub.wcsposstr)return m(a.saostrtod(b.pub.wcsposstr[1]),a.saostrtod(d))}return"sticky"===c?v?!1:m(b.pub.sticky||!1,d):"listonchange"===c&&v?!1:b.pub.lcs&&void 0!==b.pub.lcs[c]?m(b.pub.lcs[c],d)?!0:!1:m(b.pub[c],d)||m(b.params[c],d)||m(b[c],d)?!0:!1},p=function(b){return"true"===b?!0:"false"===b?!1:a.isNumber(b)?
parseFloat(b):b},q=function(a){var b=String.fromCharCode(13,10);return(a||"").replace(/\\n/g,b)};this.lcs&&this.lcs.physical&&(e=Math.sqrt(Math.pow(this.lcs.physical.forward[0][0],2)+Math.pow(this.lcs.physical.forward[0][1],2)));if(b&&b.pub)var r=b.pub.wcsconfig&&b.pub.wcsconfig.wcssys?b.pub.wcsconfig.wcssys:this.params.wcssys;else r=this.params.wcssys,b=f;var v=$(c).data("multi");var w=b.pub.layer||"regions";for(f=0;f<h;f++){var u=d[f].name;var t=d[f].value;if("xpos"===u||"ypos"===u)switch(r){case "image":u=
"i"+u.charAt(0);break;case "physical":u="p"+u.charAt(0);break;default:u=this.raw.wcs&&0<this.raw.wcs?"xpos"===u?"ra":"dec":"xpos"===u?"ix":"iy"}switch(u){case "multitext":case "colorPicker":case "savefile":case "rwcsbutton":case "savewcs":case "saveformat":case "includejson":case "includecomments":case "savewhich":case "savedcoords":break;case "text":"text"===b.type&&n(b,u,t)&&(g[u]=q(p(t)));break;case "selectfilter":t&&($(c).data("selectfilter",t),this.selectShapes(w,t));break;case "strokeDashes":var x=
t.trim().split(/\s+/);if(v&&t||n(b,u,x))g.strokeDashArray=0===x.length?[]:x.map(function(a){return parseInt(a,10)});break;case "strokeWidth":if(v&&t||!v&&n(b,u,x))g[u]=p(t);break;case "tags":v?t&&(g[u]='""'===t||"''"===t?"":p(t)):n(b,u,t)&&(g[u]=p(t));break;case "childtext":"text"!==b.type&&n(b,u,t)&&(g.text=q(p(t)));break;case "ix":n(b,u,t)&&(b.pub.preservedcoords&&"d"===t.charAt(0).toLowerCase()?(g.dx=p(t.substring(1)),void 0===g.dy&&void 0!==b.pub.dy&&(g.dy=b.pub.dy)):(g.x=p(t),void 0===g.y&&void 0!==
b.pub.y&&(g.y=b.pub.y)));break;case "iy":n(b,u,t)&&(b.pub.preservedcoords&&"d"===t.charAt(0).toLowerCase()?(g.dy=p(t.substring(1)),void 0===g.dx&&void 0!==b.pub.dx&&(g.dx=b.pub.dx)):(g.y=p(t),void 0===g.x&&void 0!==b.pub.x&&(g.x=b.pub.x)));break;case "px":n(b,u,t)&&(g.px=p(t),void 0===g.py&&b.pub.lcs&&(g.py=b.pub.lcs.y));break;case "py":n(b,u,t)&&(g.py=p(t),void 0===g.px&&b.pub.lcs&&(g.px=b.pub.lcs.x));break;case "ra":n(b,u,t)&&(g.ra=t,void 0===g.dec&&(b.pub.wcsconfig.wcsposstr?g.dec=b.pub.wcsconfig.wcsposstr[1]:
b.pub.wcsposstr&&(g.dec=b.pub.wcsposstr[1])));break;case "dec":n(b,u,t)&&(g.dec=t,void 0===g.ra&&(b.pub.wcsconfig.wcsposstr?g.ra=b.pub.wcsconfig.wcsposstr[0]:b.pub.wcsposstr&&(g.ra=b.pub.wcsposstr[0])),void 0===g.wcssys&&(g.wcssys=r));break;case "wcssys":break;case "radius":case "length":case "width":case "r1":switch(r){case "image":n(b,u,t)&&(g[u]=p(t));break;case "physical":n(b,u,t)&&(g[u]=p(t)*e);break;default:x=a.strtoscaled(t),t="."===x.dtype&&"galactic"!==r&&"ecliptic"!==r?x.dval:Math.abs(x.dval/
k.cdelt1),u=u.replace("wcs",""),n(b,u,t)&&(g[u]=p(t))}break;case "height":case "r2":switch(r){case "image":n(b,u,t)&&(g[u]=p(t));break;case "physical":n(b,u,t)&&(g[u]=p(t)*e);break;default:x=a.strtoscaled(t),t="."===x.dtype&&"galactic"!==r&&"ecliptic"!==r?x.dval:Math.abs(x.dval/k.cdelt2),u=u.replace("wcs",""),n(b,u,t)&&(g[u]=p(t))}break;case "radii":n(b,u,t)&&(g[u]=t);break;case "linelength":if(b.pub.pts&&2===b.pub.pts.length&&a.isNumber(t)&&t!==this.tmp.linelength){t=parseFloat(t);switch(r){case "image":case "physical":break;
default:void 0!==k.cdelt1?t/=Math.abs(k.cdelt1):void 0!==k.cdelt2&&(t/=Math.abs(k.cdelt2))}if(g.pts){u=g.pts[0];var y=g.pts[1]}else u=b.pub.pts[0],y=b.pub.pts[1];if(0<=$.inArray("line",a.Regions.opts.noCenteredScaling)){var B=Math.sqrt((u.x-y.x)*(u.x-y.x)+(u.y-y.y)*(u.y-y.y));var z=u.x-t*(u.x-y.x)/B;t=u.y-t*(u.y-y.y)/B;g.pts=[u,{x:z,y:t}]}else z={x:(u.x+y.x)/2,y:(u.y+y.y)/2},B=parseFloat(this.tmp.lineangle)||0,u.x=z.x-t/2,u.y=z.y,y.x=z.x+t/2,y.y=z.y,g.pts=[a.rotatePoint(u,B,z),a.rotatePoint(y,B,z)]}break;
case "lineangle":b.pub.pts&&2===b.pub.pts.length&&a.isNumber(t)&&t!==this.tmp.lineangle&&(B=parseFloat(t)-parseFloat(this.tmp.lineangle)||0,g.pts?(u=g.pts[0],y=g.pts[1]):(u=b.pub.pts[0],y=b.pub.pts[1]),0<=$.inArray("line",a.Regions.opts.noCenteredScaling)?g.pts=[u,a.rotatePoint(y,B,u)]:(z={x:(u.x+y.x)/2,y:(u.y+y.y)/2},g.pts=[a.rotatePoint(u,B,z),a.rotatePoint(y,B,z)]));break;case "remove":n(b,u,t)&&(v?g[u]="selected":void 0!==b.pub.id&&(g[u]=b.pub.id));break;case "misc":if(t.trim())try{var A=JSON.parse(t);
...
C+A.imstr),!1!==b.includejson&&1===u%2&&0<Object.keys(q).length&&("line"===A.shape&&(l=l.replace(/ *{[^{}]*}$/,"")),l+=" "+JSON.stringify(q)),g&&(l+=g);!1===b.includecomments&&(l=l.replace(/ *#[^;]*/g,""));if(x||B)x&&this.setWCSSys(x,!1),B&&this.setWCSUnits(B,!1),this.updateShapes(d,c,"export"),a.globalOpts.xeqPlugins=t;1<u&&this.display.displayMessage("regions",l);return l}};a.Regions.copyRegions=function(a,b){return this.copyShapes("regions",a,b)};a.Regions.parseRegions=function(c,b){var d=this,
...
b+"Colorbar' "+e+"></div></div>",f&&f.pluginInstances.JS9Colorbar&&!f.pluginInstances.JS9Colorbar.showTicks&&(m-=15)):d&&(m-=44);!f||0<$("#"+c.clone+"Statusbar").length&&!f.pluginInstances.JS9Statusbar.isDynamic?g+="<div class='JS9Statusbar' id='"+b+"Statusbar'></div>":d&&(m-=40);return d?(a.Dysel.retrievePlugins().length&&(l+=2,m+=2),{html:g,winopts:k[1]+String(l)+k[3]+String(m)+k[5]}):g};var v=function(b,c){var d=new a.Display(y);d.winid=A;a.helper.send("addDisplay",{display:y});a.instantiatePlugins();
c.display=y;b&&a.Load(b,c);return d};var w=function(b){var c;var d=0;var e=[];for(c=0;c<a.images.length;c++)d=a.images[c],d.display.id===y&&e.push(d);if(!e.length)return q(b),!0;if("move"===a.globalOpts.lightWinClose){if(a.isNull(a.globalOpts.lightWinMoveTo)||a.globalOpts.lightWinMoveTo===y)d=0;else for(d=c=0;c<a.displays.length;c++)if(a.displays[c].id===a.globalOpts.lightWinMoveTo){d++;break}d||(a.globalOpts.lightWinClose="ask",delete a.globalOpts.lightWinMoveTo)}switch(a.globalOpts.lightWinClose){case "close":q(b);
...
y&&c.append($("<option>",{value:a.displays[b].id,text:a.displays[b].id}))}),B=a.lightWin(f,h,g,"Closing a light window",n.lcloseWin),$(B).data("dispid",y),$(B).data("winid",A),!1}};d=p.argv[0];var u=p.argv[1];var t=p.argv[2];b=p.argv[3];p=p.argv[4];if("object"===typeof u)u=$.extend(!0,{},u);else if(u&&"string"===typeof u)try{u=JSON.parse(u)}catch(E){u={}}else u={};t=t||"light";var x=(t||"")+"win";switch(t){case "light":if(u.id){var y=u.id;delete u.id}else y=x+a.uniqueID();var B="d"+y;if(b)p=p||n.imageWin;
else{var z=r(y,u,n.imageWin);b=z.html;p=p||z.winopts}z=sprintf("JS9 Display"+a.IDFMT,y);var A=a.lightWin(B,"inline",b,z,p);var C=v(d,u);A.onclose=function(){return w(C)};return y;case "new":u.id?(y=u.id,delete u.id):y=x+a.uniqueID();p=p||"width="+a.globalOpts.newWindowWidth+", height="+a.globalOpts.newWindowHeight;v=document.getElementsByTagName("head")[0].innerHTML;v=v.replace(/src=['"].*astroemw?\.js['"]/,"");v.match(/src=["'].*js9\.js/)||v.match(/src=["'].*js9\.min\.js/)||(v+='<script type="text/javascript" src="js9.min.js">\x3c/script>');
r=b||r(y,u);b="<html><head>"+v+"</head><body";d&&(b+=sprintf(" onload='JS9.Preload(\"%s\",%s);'",d,JSON.stringify(u)));b+=">"+r+"</body></html>\n";window.electron&&(z="data:text/html,<html><body><script>window.addEventListener('message', (ev) => {document.documentElement.innerHTML=ev.data\x3c/script><p></body></html>");if(z=window.open(z,y,p))return z.document?(z.document.open(),z.document.write(b),z.document.close()):z.postMessage?a.error("LoadWindow('new') is disabled on the Desktop for security reasons"):
...
new Blob([k],{type:"text/plain"});a.saveAs(k,g)}}else a.error("no saveAs() available to save colormap");return g});a.mkPublic("NewFitsImage",function(c){for(var b=[],d=0;d<arguments.length;++d)b[d-0]=arguments[d];var e=a.parsePublicArgs(b);b=e.argv[0];d=e.argv[1]||{};e=a.lookupDisplay(e.display||d.display||a.DEFID);if(d.refresh){if("object"===typeof d.refresh)var f=d.refresh;else e&&e.image&&(f=e.image);if(f)d.onload&&(d.onrefresh=d.onload,delete d.onload),f.refreshImage(b,d);else{if(d.onload)var h=
d.onload;a.checkNew(new a.Image(b,d,h))}}else d.onload&&(h=d.onload),a.checkNew(new a.Image(b,d,h))});a.mkPublic("GetImage",function(c){for(var b=[],d=0;d<arguments.length;++d)b[d-0]=arguments[d];b=a.parsePublicArgs(b);d=b.argv[0];"string"!==typeof d&&(d=b.display);return a.getImage(d)});a.mkPublic("GetImageData",function(c){for(var b=[],d=0;d<arguments.length;++d)b[d-0]=arguments[d];d=a.parsePublicArgs(b);b=a.getImage(d.display);d=d.argv[0];return b?b.getImageData(d):null});a.mkPublic("GetDisplayData",
function(c){for(var b=[],d=0;d<arguments.length;++d)b[d-0]=arguments[d];d=[];var e=a.parsePublicArgs(b);b=e.display||a.displays[0].id;var f=e.argv[0];for(e=0;e<a.images.length;e++){var h=a.images[e];h.display.id===b&&d.push(h.getImageData(f))}return d});a.mkPublic("GetFITSHeader",function(c){for(var b=[],d=0;d<arguments.length;++d)b[d-0]=arguments[d];d="";var e=a.parsePublicArgs(b);b=a.getImage(e.display);e=e.argv[0];b&&b.raw&&(d=a.raw2FITS(b.raw,{addcr:e}));return d});a.mkPublic("BlendDisplay",function(c){for(var b=
[],d=0;d<arguments.length;++d)b[d-0]=arguments[d];d=[];var e=a.parsePublicArgs(b);b=e.display||a.DEFID;var f=a.lookupDisplay(b);e=e.argv[0];f||a.error("no JS9 display found: "+b);if(void 0===e||"mode"===e)return f.blendMode;if("list"===e){for(e=0;e<a.images.length;e++){var h=a.images[e];h.display.id===b&&h.blend.active&&d.push(h.id)}return d}if("reset"===e){for(e=0;e<a.images.length;e++)h=a.images[e],h.display.id===b&&h.blend.active&&h.blendImage(!1);e=!1}"true"===e?e=!0:"false"===e&&(e=!1);f.blendMode=
!!e;f.image&&(f.image.xeqPlugins("image","ondisplayblend"),f.image.displayImage());return f.blendMode});a.mkPublic("LoadAuxFile",function(c){for(var b=[],d=0;d<arguments.length;++d)b[d-0]=arguments[d];var e=a.parsePublicArgs(b);d=a.getImage(e.display);b=e.argv[0];e=e.argv[1];d?d.loadAuxFile(b,e):a.error("could not find image for aux file: "+b)});a.mkPublic("SubmitAnalysis",function(c){for(var b=[],d=0;d<arguments.length;++d)b[d-0]=arguments[d];var e,f;var h=a.lightOpts[a.LIGHTWIN];var g=a.parsePublicArgs(b);
...
f,h);return null});a.mkPublic("SelectRegions",function(c){for(var b=[],d=0;d<arguments.length;++d)b[d-0]=arguments[d];var e=a.parsePublicArgs(b);d=a.getImage(e.display);b=e.argv[0];e=e.argv[1];return d?d.selectShapes("regions",b,e):null});a.mkPublic("ChangeRegionTags",function(c){for(var b=[],d=0;d<arguments.length;++d)b[d-0]=arguments[d];var e=a.parsePublicArgs(b);b=a.getImage(e.display);d=e.argv[0];var f=e.argv[1];e=e.argv[2];return b?b.changeRegionTags(d,f,e):null});a.mkPublic("ToggleRegionTags",
function(c){for(var b=[],d=0;d<arguments.length;++d)b[d-0]=arguments[d];var e=a.parsePublicArgs(b);b=a.getImage(e.display);d=e.argv[0];var f=e.argv[1];e=e.argv[2];return b?b.toggleRegionTags(d,f,e):null});a.mkPublic("UnremoveRegions",function(c){for(var b=[],d=0;d<arguments.length;++d)b[d-0]=arguments[d];b=a.parsePublicArgs(b);return(b=a.getImage(b.display))?b.unremoveRegions():null});a.mkPublic("LoadRegions",function(c){for(var b=[],d=0;d<arguments.length;++d)b[d-0]=arguments[d];d=a.parsePublicArgs(b);
var e=a.getImage(d.display),f=function(a,b){b&&void 0!==b.display&&delete b.display;e.addShapes("regions",a,b);e.setStatus("loadRegions","complete");if(h&&h.onload)h.onload(e)};b=d.argv[0];var h=d.argv[1];b||a.error("JS9.LoadRegions: no file specified for regions load");if(e){e.setStatus("loadRegions","processing");if("object"===typeof h)h=$.extend(!0,{},h);else if(h&&"string"===typeof h)try{h=JSON.parse(h)}catch(g){h={}}else h={};if("object"===typeof b){if(d=b.path||b.name)h.file=d.split("/").reverse()[0];
d=new FileReader;d.onload=function(a){f(a.target.result,h)};d.readAsText(b)}else"string"===typeof b?(h.responseType="text",b=a.fixPath(b,h),h.file=b.split("/").reverse()[0],a.fetchURL(null,b,h,f)):a.error("unknown file type for LoadRegions: "+typeof b)}});a.mkPublic("InstallDir",function(c){return c?a.cleanPath(a.INSTALLDIR+c):""});a.mkPublic("AddDivs",function(c){for(var b=[],d=0;d<arguments.length;++d)b[d-0]=arguments[d];var e,f=a.parsePublicArgs(b);for(b=0;b<f.argv.length;b++)if(e=f.argv[b])if(0===
$("#"+e).length)a.DEBUG&&a.log("warning: can't find div, skipping AddDivs(): %s",e);else{for(d=0;d<a.displays.length;d++){var h=a.displays[d];if(h.id===e){var g=!0;break}}g?a.DEBUG&&a.log("warning: div already added, skipping AddDivs(): %s",e):(a.checkNew(new a.Display(e)),a.helper.send("addDisplay",{display:e}))}a.instantiatePlugins()});a.mkPublic("InstantiatePlugins",function(){a.instantiatePlugins()});a.mkPublic("ResizeDisplay",function(c){for(var b=[],d=0;d<arguments.length;++d)b[d-0]=arguments[d];
d=a.parsePublicArgs(b);"string"!==typeof d.argv[0]||a.isNumber(d.argv[0])||"full"===d.argv[0]||"reset"===d.argv[0]||"image"===d.argv[0]?b=a.lookupDisplay(d.display):(b=a.lookupDisplay(d.argv[0]||d.display),d.argv.splice(0,1));b||a.error("invalid display for resize");d=b.resize.apply(b,$jscomp.arrayFromIterable(d.argv));return d===b?a.globalOpts.quietReturn?"":"OK":d});a.mkPublic("SelectDisplay",function(c){for(var b=[],d=0;d<arguments.length;++d)b[d-0]=arguments[d];b=a.parsePublicArgs(b);(b=a.lookupDisplay(b.argv[0]||
...
d=e.argv[0];e=e.argv[1];if(b)return b.saveCatalog(d,e)});a.mkPublic("LoadCatalog",function(c){for(var b=[],d=0;d<arguments.length;++d)b[d-0]=arguments[d];var e;b=a.parsePublicArgs(b);var f=b.argv[0];var h=b.argv[1];var g=b.argv[2];f instanceof Blob&&(g=h,h=f,f=null);h||a.error("JS9.LoadCatalog: no file specified for catalog load");if(e=a.getImage(b.display)){e.setStatus("loadCatalog","processing");if("object"===typeof g)g=$.extend(!0,{},g);else if(g&&"string"===typeof g)try{g=JSON.parse(g)}catch(k){g=
...
if(g&&g.onload)g.onload(e)});else a.error("unknown file type for LoadCatalog: "+typeof h)}});a.mkPublic("CreateMosaic",function(c){for(var b=[],d=0;d<arguments.length;++d)b[d-0]=arguments[d];var e=a.parsePublicArgs(b);b=a.lookupDisplay(e.display);d=e.argv[0];e=e.argv[1];if(b)return b.createMosaic(d,e)});a.mkPublic("DisplayPlugin",function(c){for(var b=[],d=0;d<arguments.length;++d)b[d-0]=arguments[d];var e=a.parsePublicArgs(b);d=a.lookupDisplay(e.display);b=e.argv[0];if(d&&e.argv[0]){var f=b.toLowerCase();
