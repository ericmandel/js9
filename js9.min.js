...
this.url=this.url.replace(/:[0-9][0-9]*$/,"")+":"+a.globalOpts.helperPort;this.sockurl=window.multiElectron?this.url+"/socket.io/socket.io.slim.js":this.url+"/socket.io/socket.io.js";window.isElectron?(this.aliveurl=this.url+"/alive",g(this.aliveurl,this.sockurl,d)):h(this.sockurl);break;default:a.error("unknown helper type: "+this.type)}};a.Helper.prototype.send=function(c,b,d){var e=this;if(!this.connected)return null;if(b&&"object"===typeof b){try{b.cookie=document.cookie}catch(f){delete b.cookie}a.globalOpts.dataPath&&
...
d.css("width")).attr("height",d.css("height")).appendTo(k.divjq);a.bugs.webkit_resize&&"main"===k.dtype&&k.canvasjq.attr("width",this.width).attr("height",this.height);k.canvas=new fabric.Canvas(k.canvasjq[0]);k.canvas.renderOnAddRemove=!1;k.canvas.preserveObjectStacking=!0;k.opts.movable?(k.opts.lockMovementX=!1,k.opts.lockMovementY=!1,k.opts.selectable=!0,k.opts.evented=!0):!1===k.opts.movable&&(k.opts.lockMovementX=!0,k.opts.lockMovementY=!0,k.opts.selectable=!1,k.opts.evented=!1);void 0===k.opts.changeable&&
void 0!==k.opts.fixinplace&&(k.opts.changeable=!k.opts.fixinplace);k.opts.changeable?(k.opts.hasControls=!0,k.opts.hasRotatingPoint=!0,k.opts.hasBorders=!0,k.opts.lockMovementX=!1,k.opts.lockMovementY=!1,k.opts.lockRotation=!1,k.opts.lockScalingX=!1,k.opts.lockScalingY=!1,k.opts.lockUniScaling=!1,k.opts.selectable=!0,k.opts.evented=!0,k.opts.usekeyboard=!0):!1===k.opts.changeable&&(k.opts.hasControls=!1,k.opts.hasRotatingPoint=!1,k.opts.hasBorders=!1,k.opts.lockMovementX=!0,k.opts.lockMovementY=!0,
k.opts.lockRotation=!0,k.opts.lockScalingX=!0,k.opts.lockScalingY=!0,k.opts.lockUniScaling=!0,k.opts.selectable=!1,k.opts.evented=!1,k.opts.usekeyboard=!1);k.opts.selectable&&(k.opts.canvas.selection=!0);if(k.opts.onmousedown||k.opts.onmouseup||k.opts.onmousemove||k.opts.tooltip||k.opts.onmouseover||k.opts.onmouseout){k.opts.evented=!0;if(k.opts.onmousedown)k.canvas.on("mouse:down",function(b){if(k.display.image&&b.target)"main"===k.dtype&&(k.display.image.clickInRegion=!0,k.display.image.clickInLayer=
c),k.opts.onmousedown.call(k.canvas,k.display.image,b.target.pub,b.e,b.target);else if(k.canvas._selection=k.canvas.selection)k.canvas.selection=a.specialKey(b.e)});else k.canvas.on("mouse:down",function(b){if(k.canvas._selection=k.canvas.selection)k.canvas.selection=a.specialKey(b.e)});if(k.opts.onmouseup)k.canvas.on("mouse:up",function(a){k.display.image&&a.target&&k.opts.onmouseup.call(k.canvas,k.display.image,a.target.pub,a.e,a.target);k.canvas.selection=k.canvas._selection||k.canvas.selection});
else k.canvas.on("mouse:up",function(){k.canvas.selection=k.canvas._selection||k.canvas.selection});if(k.opts.onmousemove)k.canvas.on("mouse:move",function(a){k.display.image&&a.target&&k.opts.onmousemove.call(k.canvas,k.display.image,a.target.pub,a.e,a.target)});if(k.opts.onmouseover)k.canvas.on("mouse:over",function(a){k.display.image&&a.target&&k.opts.onmouseover.call(k.canvas,k.display.image,a.target.pub,a.e,a.target)});if(k.opts.onmouseout)k.canvas.on("mouse:out",function(a){k.display.image&&
a.target&&k.opts.onmouseout.call(k.canvas,k.display.image,a.target.pub,a.e,a.target)});k.opts.tooltip&&(k.canvas.on("mouse:over",function(b){k.display.image&&b.target&&a.tooltip(b.target.left+b.target.width+2,b.target.top+b.target.height+2,k.opts.tooltip,k.display.image,b.target.pub,b.e,b.target)}),k.canvas.on("mouse:out",function(b){k.display.image&&b.target&&a.tooltip(b.target.left,b.target.top,null,k.display.image,b.target.pub,b.e,b.target)}))}else k.canvas.on("mouse:down",function(b){if(k.canvas._selection=
k.canvas.selection)k.canvas.selection=a.specialKey(b.e)}),k.canvas.on("mouse:up",function(){k.canvas.selection=k.canvas._selection||k.canvas.selection});"function"===typeof k.opts.ongroupcreate&&(k.opts.canvas.selection=!0,k.opts.selectable=!0,k.canvas.on("selection:created",function(a){var b=[],c=[];k.display.image&&a.target&&"group"===a.target.type&&(a.target.forEachObject(function(a){a.pub&&(c.push(a),b.push(a.pub))}),k.opts.ongroupcreate.call(k.canvas,k.display.image,b,a.e,c))}));k.canvas.on("object:modified",
function(b){var c=[];if(b.target){var d=b.target;a.Fabric.updateChildren(k,d,"deltas");if(k.opts.sortOverlapping&&(d.setCoords(),k.canvas.forEachObject(function(a){a!==d&&d.intersectsWithObject(a)&&(1===fabric.major_version?(e=a.getWidth(),f=a.getHeight()):(e=a.getScaledWidth(),f=a.getScaledHeight()),c.push({obj:a,siz:e*f}))}),c.length)){if(1===fabric.major_version){var e=d.getWidth();var f=d.getHeight()}else e=d.getScaledWidth(),f=d.getScaledHeight();c.push({obj:d,siz:e*f});c.sort(function(a,b){return a.siz<
b.siz?-1:a.siz>b.siz?1:0});var g=c.length;for(b=0;b<g;b++)try{c[b].obj.sendToBack()}catch(w){}}}});k.canvas.on("object:scaling",function(b){b.target&&(b=b.target,b.rescaleEvenly(),b.rescaleBorder(),a.Fabric.updateChildren(k,b,"scaling"))});k.canvas.on("object:moving",function(b){b.target&&a.Fabric.updateChildren(k,b.target,"moving")});k.canvas.on("object:rotating",function(b){b.target&&a.Fabric.updateChildren(k,b.target,"rotating")});1===fabric.major_version?(k.canvas.on("object:selected",function(a){a.target&&
g(k,a.target)}),k.canvas.on("before:selection:cleared",function(a){a.target&&h(k,a.target)})):(k.canvas.on("selection:created",function(a){a.target&&g(k,a.target)}),k.canvas.on("selection:updated",function(b){b=k.canvas.getActiveObject();if("activeSelection"===b.type){var d,e=k.canvas.getActiveObjects();for(d=0;d<e.length;d++){var h=e[d];if(h.params){if(h.params.parent&&h.params.parent.obj){var l=h.params.parent.obj;0>$.inArray(l,e)&&b.addWithUpdate(l)}if(h.params.children)for(l=0;l<h.params.children.length;l++){var m=
...
f.canvas;d=d||{};"regions"===c&&a.globalOpts.unremoveReg&&(this.regstack.push(this.listRegions(b,h,c)),this.regstack.length>a.globalOpts.unremoveReg&&(this.regstack=this.regstack.slice(0,a.globalOpts.unremoveReg)));b||(b=k.getActiveObject()?"selected":"all");this._selectShapes(c,b,function(a,b){if(!(!1===a.params.removable&&!d.overrideRemovable||a.params.sticky&&!1===d.sticky)){e._updateShape(c,a,b,"remove");a.params.winid&&(a.params.winid.close(),a.params.winid=null);if(a.params.parent){var f=a.params.parent.obj;
for(b=f.params.children.length-1;0<=b;b--)if(a===f.params.children[b].obj){f.params.children.splice(b,1);break}}for(b=0;b<a.params.children.length;b++)f=a.params.children[b].obj,g.push(f);g.push(a)}});for(b=0;b<g.length;b++)k.remove(g[b]);1===fabric.major_version?k.getActiveGroup()&&k.discardActiveGroup():k.discardActiveObject();k.renderAll();!k.getObjects().length&&a.globalOpts.resetEmptyShapeId&&(f.nshape=0);return this}};a.Fabric.getShapes=function(c,b,d){var e={},f=[];d=d||{};if("string"===typeof d)try{d=
JSON.parse(d)}catch(k){a.error("can't parse getShapes opts: "+d,k)}if("regions"===c&&("text"===d.format||"csv"===d.format)){d.mode=d.mode||1;b=this.listRegions(b,d);if("csv"===d.format){var h=b.split(";");c=0;for(b="";c<h.length;c++)if(h[c])if(h[c].toLowerCase().match(a.WCSEXP))d.includewcs&&(b+=h[c].trim()+"\n");else{var g=h[c].replace(/\(/,",").replace(/\).*/,"").trim();b+=g+"\n"}}return b}this._selectShapes(c,b,function(a){e=a.pub||{};d.includeObj&&(e.obj=a);f.push(e)});return f};a.Fabric.changeShapes=
function(c,b,d){var e=this,f,h,g,k,l,m,n,p,q,r,v,w=[],t=[];if((l=this.getShapeLayer(c))&&d){if("string"===typeof d)try{d=JSON.parse(d)}catch(x){a.error("can't parse shape opts: "+d,x)}if(this.display.image!==this)this.delayedShapes=this.delayedShapes||[],this.delayedShapes.push({layer:c,shape:b,mode:"change",opts:d});else{var u=l.canvas;var y=u.getActiveObject();this._selectShapes(c,b,function(b,B){p="main"!==e.display.layers[c].dtype||b.params.preservedcoords?1:e.rgb.sect.zoom;d.radii&&(b.params.radii=
[]);d.tags&&(b.params.tags=[]);k=$.extend(!0,{},b.params,d);g=e._parseShapeOptions(c,k,b);if(g.remove){if(!0===g.remove||"true"===g.remove)g.remove="all";if(!1!==g.remove&&"false"!==g.remove){e.removeShapes(c,g.remove||"all");return}}if(g.opts.send)switch(g.opts.send){case "front":u.sendToFront(y);u.discardActiveObject();break;case "back":u.sendToBack(y),u.discardActiveObject()}q=e._exportShapeOptions(d).filter(function(a){return!b.params.exports.hasOwnProperty(a)});g.params.exports=b.params.exports.concat(q);
...
z,!1)}});(void 0===d.redraw||d.redraw)&&u.renderAll();return this}}};a.Fabric.refreshShapes=function(c){var b;if(c){var d=this.getWCSSys();if("image"===d){var e=a.globalOpts.xeqPlugins;a.globalOpts.xeqPlugins=!1;this.raw.wcs&&0<this.raw.wcs?this.setWCSSys("native",!1):this.setWCSSys("physical",!1)}if(b=this.listRegions("all",{mode:1,sticky:!1,savewcsconfig:!0,saveid:!0},c))this.removeShapes(c,"all",{overrideRemovable:!0,sticky:!1}),this.addShapes(c,b,{restoreid:!0});"image"===d&&(this.setWCSSys(d,
!1),this.updateShapes(c,"all","refresh"),a.globalOpts.xeqPlugins=e);return this}};a.Fabric.copyShapes=function(c,b,d){var e,f=[];if(e=this.getShapeLayer(c)){if("object"===typeof b)f.push(b);else if("all"===b)for(b=0;b<a.images.length;b++)this!==a.images[b]&&f.push(a.images[b]);else(b=a.lookupImage(b))&&f.push(b);if(f.length){d||(d=e.canvas.getActiveObject()?"selected":"all");d=this.listRegions(d,{mode:1,includedcoords:a.globalOpts.regCopyDCoords},c);for(b=0;b<f.length;b++)e=this.display.layers[c]?
