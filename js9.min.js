...
internalContrastBias:!0,containContrastBias:!1,wcsCrosshair:!1,magnifierRegions:!0,htimeout:5E3,lhtimeout:1E3,ehtimeout:1E3,ehretries:10,xtimeout:18E4,extlist:"EVENTS STDEVT",table:{xdim:2048,ydim:2048,bin:1},image:{xdim:2048,ydim:2048,bin:1},binMode:"s",clearImageMemory:"never",helperProtocol:location.protocol,maxMemory:75E7,corsURL:"params/loadcors.html",proxyURL:"params/loadproxy.html",loadProxy:!1,archivesURL:"help/archives.html",imsectionURL:"params/imsection.html",postMessage:!1,waitType:"spinner",
spinColor:"#FF0000",spinOpacity:.35,resize:!0,resizeHandle:!0,resizeRedisplay:!0,cloneNewDisplay:!0,regionConfigSize:"medium",refreshDragDrop:!0,reduceMosaic:"js9",reduceRegcnts:!0,copyWcsPosFormat:"$ra $dec $sys",mouseActions:["display value/position","change contrast/bias","pan the image"],touchActions:["display value/position","change contrast/bias","pan the image"],keyboardActions:{b:"toggle selected region: source/background",c:"toggle crosshair",e:"toggle selected region: include/exclude",i:"refresh image",
I:"display full image",K:"toggle keyboard actions plugin",l:"toggle active shape layers",M:"toggle mouse/touch plugin",p:"paste regions from local clipboard",P:"toggle preferences plugin",r:"copy selected region to clipboard",R:"copy all regions to clipboard",S:"toggle shape layers plugin","/":"copy wcs position to clipboard","?":"copy value and position to clipboard",0:"reset zoom","=":"zoom in","+":"zoom in","-":"zoom out","^":"raise region layer to top",">":"display next image","<":"display previous image",
"delete":"remove selected region",leftArrow:"move selected region left",upArrow:"move selected region up",rightArrow:"move selected region right",downArrow:"move selected region down"},mousetouchZoom:!1,toolbarTooltips:!1,centerDivs:["JS9Menubar"],resizeDivs:["JS9Menubar","JS9Colorbar","JS9Toolbar"],pinchWait:8,pinchThresh:6,xeqPlugins:!0,extendedPlugins:!0,corsProxy:"https://js9.si.edu/cgi-bin/CORS-proxy.cgi",simbadProxy:"https://js9.si.edu/cgi-bin/simbad-proxy.cgi",catalogs:{ras:["RA","_RAJ2000",
"RAJ2000"],decs:["Dec","_DEJ2000","DEJ2000"],shape:"circle",color:"yellow",width:7,height:7,radius:3.5,r1:5,r2:3.5,wcssys:"ICRS",skip:"#\n",save:!0,tooltip:"$xreg.data.ra $xreg.data.dec"},topColormaps:"grey heat cool viridis magma sls red green blue".split(" "),infoBox:"file object wcsfov wcscen wcspos impos physpos value regions progress".split(" "),menuBar:"file edit view zoom scale color region wcs analysis help".split(" "),menubarStyle:"classic",userMenus:!1,toolBar:"linear log annulus box circle ellipse line polygon remove incexcl srcbkgd zoomin zoomout zoom1".split(" "),
...
lcs:"physical",valpos:!0,opacity:1,sigma:"none",maskOpacity:.4,alpha:255,alpha1:100,zoom:1,zooms:5,nancolor:"#000000",wcsalign:!0,rotationMode:"relative",crosshair:!0,ltvbug:!0,listonchange:!1};b.regionOpts={};b.catalogOpts={};b.crosshairOpts={};b.gridOpts={};b.emscriptenOpts={};b.analOpts={epattern:/^(ERROR:[^\n]*)\n/,dpathURL:"params/datapath.html",fpathURL:"params/filepath.html"};b.lightOpts={nclick:0,dhtml:{top:".dhtmlwindow",drag:".drag-contentarea",dragBar:"drag-handle",format:"width=%spx,height=%spx,center=1,resize=%s,scrolling=0",
...
h.dim=h.dim||Math.max(b.globalOpts.image.xdim,b.globalOpts.image.ydim);e=h.cmdswitches||"";d=this.raw.hdu.fits.vfile;(g=this.file.match(/\[.*\]/))&&(d+=g);"table"===this.imtab&&(g=this.raw.hdu.table.filter)&&!d.match(g)&&(d=d.match(/\]\[/)?d.slice(0,-1)+"&&"+g+"]":d+("["+g+"]"));h.reduce&&!this.parentFile&&(g=this.fileDimensions(),g=Math.floor(Math.max(g.xdim,g.ydim)/h.dim+.5),1<g&&("table"===this.imtab?e+=sprintf(" -b %s",g):(f=sprintf("bin%s_%s",g,d),g=sprintf("0@0,0@0,%s",g),b.imsection(d,f,g,
...
function(){this.params.crosshair=!this.params.crosshair;this.params.crosshair||b.Crosshair.hide(this)};b.Image.prototype.toggleWCSCrosshair=function(){b.globalOpts.wcsCrosshair=!b.globalOpts.wcsCrosshair};b.Grid={};b.Grid.CLASS="JS9";b.Grid.NAME="Grid";b.Grid.LAYERNAME="grid";b.Grid.opts={movable:!1,cover:"display",reduceDims:!0,strokeWidth:1,margin:0,stride:32,raLines:8,raSkip:0,raAngle:0,decLines:8,decSkip:0,decAngle:90,sexaPrec:1,degPrec:3,lineColor:"#00FFFF",labelColor:"#00FFFF",labelFontFamily:"Helvetica, sans-serif",
labelFontSize:11,labelFontStyle:"normal",labelFontWeight:300,labelRAOffx:3,labelRAOffy:-1,labelDecOffx:-14,labelDecOffy:6};b.Grid.limits=function(a,b,d,e){a=d-b;a=1<a?10:.1<a?100:.01<a?1E3:.001<a?1E4:1E-4<a?1E5:1E6;b=Math.floor(b*a)/a;d=Math.ceil(d*a)/a;return{lo:b,hi:d,inc:Math.ceil((d-b)/e*a)/a}};b.Grid.getLabel=function(a,c,d){var e,f,g=!1;switch(a.wcsunits){case "sexagesimal":"ra"===d&&"galactic"!==a.wcssys&&"ecliptic"!==a.wcssys&&(c/=15);c=b.saodtostr(c,":",a.sexaPrec);f=c.split(":");if(a.last[d])for(c=
"",e=0;e<f.length;e++)if(c&&(c+=":"),g||f[e]!==a.last[d][e])c+=f[e],g=!0;a.last[d]=$.extend({},f);break;default:c=c.toFixed(a.degPrec)}c=c.replace(/0+$/,"");a=c.indexOf(".");0>a?c+=".0":a===c.length-1&&(c+="0");return c=c.replace(/:\.0/,":0.0")};b.Grid.display=function(a,c){var d,e,f,g,h,k,l,n,m,q,t,r,u,p,x,w,y,v,A,B,C,D;t=this.display;var z=this.raw;p=[{ra:0,dec:0},{ra:0,dec:0},{ra:0,dec:0},{ra:0,dec:0}];if(b.isNull(a))switch(this.tmp.gridStatus){case "inactive":case void 0:return!1;case "active":case "processing":return!0;
...
function(a,c,d,e){b.fits.getFITSImage?b.fits.getFITSImage(a,c,d,e):b.error("no FITS module available to process FITS image")};b.fits2RepFile=function(a,c,d,e,f){var g,h,k,l,n,m={},q="fits2"+e;g=d[q]||void 0===d[q]&&b.globalOpts[q];!0===g?g="always":!1===g&&(g="never");if(g.match(/never/i)||!b.helper.connected||!b.helper.js9helper||"nodejs"!==b.helper.type&&"socket.io"!==b.helper.type)return!1;switch(q){case "fits2png":break;case "fits2fits":if(!b.globalOpts.workDir)return!1;e=d.xdim||b.fits.options.image.xdim||
b.fits.options.table.xdim;h=d.ydim||b.fits.options.image.ydim||b.fits.options.table.ydim;k=d.bin||b.fits.options.image.bin||b.fits.options.table.bin;l=d.binMode||b.globalOpts.binMode;l="a"===l?"a":"";"string"===typeof k&&(k.match(/[as]$/)&&(l=k.slice(-1)),k=parseInt(k,10));k=Math.max(1,k||1);m.sect=void 0!==d.xcen&&void 0!==d.ycen?sprintf("%s@%s,%s@%s,%s%s",e,d.xcen,h,d.ycen,k,l):sprintf("%s,%s,%s%s",e,h,k,l);e=g.toLowerCase().split(/[>,]/);for(g=0;g<e.length;g++)switch(e[g]){case "size":e[g+1]&&
