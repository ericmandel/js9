...
e[f].params.id;for(c=g.length-1;0<=c;c--){var k=g[c];if(h===k){1E-6===e[f].pub.radius&&(e[f].pub.radius=0);b.radii.push(e[f].pub.radius);g.splice(c,1);break}}if(!g.length)break}b.radii.sort(function(b,a){return b-a})}this.changeShapes(a,this.editAnnulus.annulus,b);this.removeShapes(a,this.editAnnulus.ids);delete this.editAnnulus}};a.Fabric.updateChildren=function(c,b,d){var e,f,g={};if("regions"===c.layerName)if("objects"===d){b=c.canvas.getObjects().reverse();c=b.length;do{for(d=0;c--;){var h=b[c];
"group"!==h.type||h.params||(b.splice.apply(b,[c,1].concat($jscomp.arrayFromIterable(h.getObjects()))),d++)}c=b.length}while(d);b.forEach(function(b){b.params&&(b.params.parent||b.params.children.length)&&(g[b.params.id]=b)});b.forEach(function(b){if(b.params)for(b.params.parent&&(b.params.parent.obj=g[b.params.parent.id]),e=0;e<b.params.children.length;e++)b.params.children[e].obj=g[b.params.children[e].id]})}else if(b&&b.params)if("deltas"===d)b.params.parent&&(h=b.params.parent,c=h.obj.left-b.left,
b=h.obj.top-b.top,c!==h.dleft||b!==h.dtop?(h.dleft=c,h.dtop=b,h.moved=!0):delete h.moved);else for(e=0;e<b.params.children.length;e++){var k=b.params.children[e].obj;h=k.params.parent;switch(d){case "moving":k.left=b.left-h.dleft;k.top=b.top-h.dtop;break;case "rotating":for(f=b.angle;0>f;)f+=360;for(;360<=f;)f-=360;var m=f-h.lastangle;var l=a.rotatePoint({x:k.left,y:k.top},m,{x:b.left,y:b.top});k.left=l.x;k.top=l.y;h.dleft=b.left-k.left;h.dtop=b.top-k.top;for(k.angle+=m;0>k.angle;)k.angle+=360;for(;360<=
k.angle;)k.angle-=360;h.lastangle=f;break;case "scaling":h.dleft*=b.scaleX/h.lastscalex,h.dtop=b.scaleY/h.lastscaley*(h.dtop-h.textheight)+h.textheight,h.lastscalex=b.scaleX,h.lastscaley=b.scaleY,h.moved=!0,k.left=b.left-h.dleft,k.top=b.top-h.dtop}k.setCoords();c.display.image&&c.display.image.updateShapes(c.layerName,k,"updatechild")}};a.resetPolygonCenter=function(c){var b={};var d=c._calcDimensions();var e=(d.left+d.width/2)*c.scaleX;d=(d.top+d.height/2)*c.scaleY;c.angle?b=a.rotatePoint({x:c.left+
e,y:c.top+d},c.angle,{x:c.left,y:c.top}):(b.x=c.left+e,b.y=c.top+d);e/=c.scaleX;var f=d/c.scaleY;for(d=0;d<c.points.length;d++)c.points[d].x-=e,c.points[d].y-=f;c.left=b.x;c.top=b.y;b=c._calcDimensions();c.width=b.width;c.height=b.height;c.pathOffset={x:b.left+c.width/2,y:b.top+c.height/2};c.setCoords()};a.Fabric.saveSelection=function(a){if(a=this.getShapeLayer(a)){var b=a.canvas.getActiveObjects();1===b.length&&((b=b[0],b.params)?!1!==b.params.changeable&&(a.savesel=b.params.id):"group"===b.type&&
(b=this.lookupGroup(b))&&(a.savesel=b))}};a.Fabric.restoreSelection=function(a){var b;if((b=this.getShapeLayer(a))&&b.savesel){var c=b.canvas;var e=b.savesel;var f=c.getObjects();var g=f.length;for(c=0;c<g;c++){var h=f[c];if(h.params&&h.params.id===e){var k=h.params.id;break}else if("group"===h.type&&this.lookupGroup(h)===e){k=e;break}}k&&(this.selectShapes(a,k,{saveselection:!1}),this.updateShapes(a,k,"restore"));delete b.savesel}};a.Fabric.print=function(c){var b,d="",e=0,f=sprintf("width=%s,height=%s,menubar=1,toolbar=1,status=0,scrollbars=1,resizable=1",
