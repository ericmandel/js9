...
g.id)}),this.png.image.src=this.rgbFile):(this.displayImage("all",h),k.call(this,d));break;case "string":this.source="fits2png";this.imtab="image";this.file=c;this.oid=this.file.split("/").reverse()[0];this.id=a.getImageID(this.oid,this.display.id);this.status.load="loading";$(this.png.image).on("load",function(){g.mkOffScreenCanvas();g.mkRawDataFromPNG();"zscale"===g.params.scaleclipping&&g.zscale(!0);g.mkSection();e=j(g,h);e.length&&g.mkSection.apply(g,e);g.displayImage("all",h);k.call(g,d);a.DEBUG&&
...
return this};a.Image.prototype.mkScaledCells=function(){var c,b,d,e,f,g,h=a.COLORSIZE,j=a.SCALESIZE;if(!this.colorCells)return this;if(!this.psColors){c=this.psColors=[];b=this.params.nancolor;var k=[];"#"===b.charAt(0)&&(b=b.slice(1));b=b.toUpperCase();for(e=d=0;6>d;d+=2,e++)f="0123456789ABCDEF".indexOf(b.charAt(d)),g="0123456789ABCDEF".indexOf(b.charAt(d+1)),k[e]=16*f+g;c[NaN]=k}this.psInverse||(this.psInverse=[],this.psInverse[NaN]=0);b=this.params.scalemax-this.params.scalemin;g=this.params.scalemin;
switch(this.params.scale){case "linear":for(d=0;d<j;d++)c=d/j,e=Math.floor(c*h),this.psColors[d]=this.colorCells[e],this.psInverse[d]=c*b+g;break;case "log":f=this.params.exp;for(d=0;d<j;d++)c=Math.log(f*d/j+1)/Math.log(f),e=Math.floor(c*h),e>=h&&(e=h-1),this.psColors[d]=this.colorCells[e],c=(Math.pow(f,d/j)-1)/f,this.psInverse[d]=c*b+g;break;case "pow":f=this.params.exp;for(d=0;d<j;d++)c=(Math.pow(f,d/j)-1)/f,e=Math.floor(c*h),e>=h&&(e=h-1),this.psColors[d]=this.colorCells[e],c=Math.log(f*d/j+1)/
Math.log(f),this.psInverse[d]=c*b+g;break;case "sqrt":for(d=0;d<j;d++)c=d/j,e=Math.floor(Math.sqrt(c)*h),e>=h&&(e=h-1),this.psColors[d]=this.colorCells[e],this.psInverse[d]=c*c*b+g;break;case "squared":for(d=0;d<j;d++)c=d/j,e=Math.floor(c*c*h),e>=h&&(e=h-1),this.psColors[d]=this.colorCells[e],c=Math.sqrt(d/j),this.psInverse[d]=c*b+g;break;case "asinh":for(d=0;d<j;d++)c=d/j,e=Math.floor(Math.asinh(10*c)/3*h),e>=h&&(e=h-1),this.psColors[d]=this.colorCells[e],e=Math.sinh(3*c)/10,this.psInverse[d]=e*
b+g;break;case "sinh":for(d=0;d<j;d++)c=d/j,e=Math.floor(Math.sinh(3*c)/10*h),e>=h&&(e=h-1),this.psColors[d]=this.colorCells[e],e=Math.asinh(10*c)/3,this.psInverse[d]=e*b+g;break;default:a.log("unknown scale '"+this.params.scale+"'")}return this};a.Image.prototype.mkRGBImage=function(){var c,b,d,e,f,g,h,j,k,m,n,p,r,l,q,s,t,v,u,w,y=null,x=null,B=null,F=!1;if(!this.rgb)return this;if(a.globalOpts.rgb.active&&(this===a.globalOpts.rgb.rim||this===a.globalOpts.rgb.gim||this===a.globalOpts.rgb.bim))F=!0,
a.globalOpts.rgb.rim&&(y=a.globalOpts.rgb.rim),a.globalOpts.rgb.gim&&(x=a.globalOpts.rgb.gim),a.globalOpts.rgb.bim&&(B=a.globalOpts.rgb.bim);h=this.display.context;c=this.rgb;b=c.sect;if(this.MakeRGBImage&&"function"===typeof this.MakeRGBImage&&this.MakeRGBImage()||this.MakePrimaryImage&&"function"===typeof this.MakePrimaryImage&&this.MakePrimaryImage())return this;if(this.rgbFile){f=b.width/b.zoom;g=b.height/b.zoom;d=b.x0;e=this.offscreen.canvas.height-1-(b.y0+g);e=this.offscreen.context.getImageData(d,
...
h||(g=$("<div>").attr("id",f).css("display","none").appendTo($(this.divjq)),$("<div>").addClass(c.name).addClass("JS9PluginInnerDiv").attr("id",d).attr("data-js9id",this.divjq.attr("id")).css("height","100%").css("width","100%").appendTo(g)),g=c.opts.winDims[0]||a.WIDTH,j=c.opts.winDims[1]||a.HEIGHT,k=c.opts.winResize?"1":"0",b=sprintf(b.format,g,j,k),g=c.opts.toolbarHTML&&0<=c.opts.toolbarHTML.search(/\$title/)?"":c.opts.winTitle||"",f=a.lightWin(e,"div",f,g,b),e=$("#"+e+" #"+d),h=a.instantiatePlugin(e,
...
h.loadcors.disabled=window.hasOwnProperty("Jupyter")?!0:!1;h.imsection={name:"extract image section ..."};h.imsection.disabled=!a.allinone&&"none"!==a.globalOpts.helperType&&a.globalOpts.workDir&&s&&s.parentFile?!1:!0;h["sep"+g++]="------";h.print={name:"print ..."};h.header={name:"display FITS header"};h.hdus={name:"display FITS HDUs"};if(!s||!s.hdus)h.hdus.disabled=!0;h.pageid={name:"display pageid"};h.savefits={name:"save image as FITS"};h.savepng={name:"save image as PNG"};h.savejpeg={name:"save image as JPEG"};
h.close={name:"close image"};h["sep"+g++]="------";h.lite={name:"new JS9 light window"};h.xnew={name:"new JS9 separate window"};2<a.DEBUG&&(h["sep"+g++]="------",h.refresh={name:"debug: refresh ..."});return{callback:function(c){d().forEach(function(d){var b,e,f,g;e=d.image;switch(c){case "close":e&&e.closeImage();break;case "header":e&&(e.raw.header?e.displayAnalysis("text",a.raw2FITS(e.raw,!0),"FITSHeader_"+e.id):a.error("no FITS header for "+e.id));break;case "hdus":e&&(e.hdus?e.displayAnalysis("text",
a.hdus2Str(e.hdus),"FITSHDUs_"+e.id,"width=800px,height=200px,center=1,resize=1,scrolling=1"):a.error("no FITS header for "+e.id));break;case "lite":a.LoadWindow(null,null,"light");break;case "xnew":a.LoadWindow(null,null,"new");break;case "pageid":d="<center><p>Usage: js9 -pageid [pageid] ...<p>"+a.helper.pageid||"none</center>";a.lightWin("fileid"+a.uniqueID(),"inline",d,"page ID",a.lightOpts[a.LIGHTWIN].lineWin);break;case "open":a.OpenFileMenu({display:d});break;case "loadcors":e=a.allinone?a.Image.prototype.displayAnalysis.call(null,
"textline",a.allinone.loadCorsHTML,"Open a shared CORS link"):a.Image.prototype.displayAnalysis.call(null,"textline",a.InstallDir(a.globalOpts.corsURL),"Open a shared CORS link");$(e).data("dispid",d.id);break;case "archives":a.DisplayHelp(a.InstallDir(a.globalOpts.archivesURL));break;case "loadproxy":e=a.Image.prototype.displayAnalysis.call(null,"textline",a.InstallDir(a.globalOpts.proxyURL),"Open a link via server proxy");$(e).data("dispid",d.id).data("aname","loadproxy");break;case "imsection":f=
a.Regions.opts.onchange;$("#dhtmlwindowholder").arrive("#imageSectionForm",{onceOnly:!0},function(){a.Regions.opts.onchange=function(a,c){var d,b;f&&f(a,c);a.parentFile&&("region"===$("#imageSectionForm input:radio[name=imode]:checked").val()&&"box"===c.shape)&&(d=a.raw.header.LTM1_1||1,d=c.width/d,b=a.raw.header.LTM2_2||1,b=c.height/b,$("#imageSectionForm #xcen").val(Math.floor(c.lcs.x)),$("#imageSectionForm #ycen").val(Math.floor(c.lcs.y)),$("#imageSectionForm #xdim").val(Math.floor(d)),$("#imageSectionForm #ydim").val(Math.floor(b)))}});
$("#dhtmlwindowholder").leave("#imageSectionForm",{onceOnly:!0},function(){a.Regions.opts.onchange=f});e=a.Image.prototype.displayAnalysis.call(null,"params",a.InstallDir(a.globalOpts.imsectionURL),"Extract Image Section From a 'Parent' File","width=440px,height=230px,center=1,resize=1,scrolling=1");$(e).data("dispid",d.id).data("aname","imsection");break;case "refresh":$("#refreshLocalFile-"+d.id).click();break;case "savefits":e&&(d=e.id.replace(/\.png/i,".fits").replace(/\.gz$/i,"").replace(/\[.*\]/,
""),e.saveFITS(d));break;case "savepng":e&&(d=e.id.replace(/\.fit[s]?/i,".png").replace(/\.gz$/i,"").replace(/\[.*\]/,""),e.savePNG(d));break;case "savejpeg":e&&(d=e.id.replace(/\.fit[s]?/i,".jpeg").replace(/\.png$/i,".jpeg").replace(/\.gz$/i,"").replace(/\[.*\]/,""),e.saveJPEG(d));break;case "print":e&&e.print();break;default:for(b=0;b<a.images.length;b++)if(e=a.images[b],g=c.replace(/ *\((red|green|blue)\)/,""),d.id===e.display.id&&e.id===g){e.displayImage("display");e.refreshLayers();e.clearMessage();
break}}})},items:h}}});$("#viewMenu"+g.id).on("mousedown",function(a){a.preventDefault();$("#viewMenu"+g.id).contextMenu()});$.contextMenu({selector:"#viewMenu"+g.id,zIndex:a.MENUZINDEX,events:{hide:c},build:function(){var c,b,e,f,h,l="",q=0,s=0,t={},v=d()[0],u=v.image,w=function(c,d){var b,e;if(d.resize)switch(e=d.resize.split(/[\s,\/]+/),e.length){case 0:break;case 1:a.isNumber(e[0])&&(b=parseInt(e[0],10),c.resize(b,b));break;default:a.isNumber(e[0])&&a.isNumber(e[1])&&(b=parseInt(e[0],10),e=parseInt(e[1],
...
"main"===u.layers[h].dlayer.dtype&&(s++,t[h]={name:h},u.layers[h].show&&(t[h].icon="sun"));1<s&&(t.hide={name:"HideAll"},t.show={name:"ShowAll"},t["sep"+q++]="------")}t.valpos={name:"display value/position"};v.image&&v.image.params.valpos&&(t.valpos.icon="sun");if(u&&1<u.raws.length){t["sep"+q++]="------";t.rawlayer={name:"raw data layers",items:{}};for(c=0;c<u.raws.length;c++)h="rawlayer_"+u.raws[c].id,t.rawlayer.items[h]={name:u.raws[c].id},u.raw===u.raws[c]&&(t.rawlayer.items[h].icon="sun")}a.globalOpts.resize&&
(t["sep"+q++]="------",t.resize={events:{keyup:y},name:"change width/height:",type:"text"});return{callback:function(c){d().forEach(function(d){var b,e,f,g=d.image;switch(c){case "valpos":g&&(g.params.valpos=!g.params.valpos,g.params.valpos||g.clearMessage());break;case "show":case "hide":if(g)for(e in g.layers)g.layers.hasOwnProperty(e)&&"main"===g.layers[e].dlayer.dtype&&(g.showShapeLayer(e,c),"show"===c&&g.refreshLayers());break;default:for(b=0;b<a.plugins.length;b++)if(f=a.plugins[b],f.name===
c){d.displayPlugin(f);return}if(g)for(e in g.layers)if(g.layers.hasOwnProperty(e)&&c===e){d=g.layers[e].show?"hide":"show";g.showShapeLayer(e,d);"show"===d&&g.refreshLayers();return}u&&c.match(/^rawlayer_/)&&u.rawDataLayer(c.replace(/^rawlayer_/,""))}})},events:{show:function(c){var d=g.display,b={};d&&(b.resize=sprintf("%d %d",d.width,d.height),$.contextMenu.setInputValues(c,b),a.jupyterFocus(".context-menu-item"))},hide:function(a){var c=g.display;c&&a.edited&&(delete a.edited,a=$.contextMenu.getInputValues(a),
w(c,a))}},items:t}}});$("#zoomMenu"+g.id).on("mousedown",function(a){a.preventDefault();$("#zoomMenu"+g.id).contextMenu()});$.contextMenu({selector:"#zoomMenu"+g.id,zIndex:a.MENUZINDEX,events:{hide:c},build:function(){var c,b,e,f,h=0,l=d()[0].image,q={zoomtitle:{name:"Zoom Factors:",disabled:!0}};for(c=a.imageOpts.zooms;1<=c;c--)b=Math.pow(2,-c),e=Math.pow(2,c),f=sprintf("zoom%s",b),e=sprintf("zoom 1/%s",e),q[f]={name:e},l&&l.rgb.sect.zoom===b&&(q[f].icon="sun");for(c=0;c<=a.imageOpts.zooms;c++)b=
Math.pow(2,c),f=sprintf("zoom%s",b),e=sprintf("zoom %s",b),q[f]={name:e},l&&l.rgb.sect.zoom===b&&(q[f].icon="sun");q["sep"+h++]="------";q.zoomiotitle={name:"Zoom In/Out:",disabled:!0};q.zoomIn={name:"zoom in"};q.zoomOut={name:"zoom out"};q.zoomToFit={name:"zoom to fit"};q["sep"+h++]="------";q.zoom={events:{keyup:function(a){var c=$.contextMenu.getInputValues(a.data),d=g.display.image;switch(a.which||a.keyCode){case 9:case 13:d&&(isNaN(c.zoom)||d.setZoom(c.zoom),a.data.edited=!1);break;default:a.data.edited=
!0}}},name:"numeric zoom value:",type:"text"};q["sep"+h++]="------";q.center={name:"pan to center"};q.reset={name:"reset zoom/pan"};return{callback:function(a){d().forEach(function(c){if(c=c.image)switch(a){case "zoomIn":c.setZoom("x2");break;case "zoomOut":c.setZoom("/2");break;case "zoomToFit":c.setZoom("tofit");break;case "center":c.setPan();break;case "reset":c.setZoom("1");c.setPan();break;default:a.match(/^zoom/)&&c.setZoom(a.slice(4))}})},events:{show:function(c){var d=g.display.image,b={};
d&&(b.zoom=String(d.rgb.sect.zoom));$.contextMenu.setInputValues(c,b);a.jupyterFocus(".context-menu-item")},hide:function(a){var c=g.display.image;c&&a.edited&&(delete a.edited,a=$.contextMenu.getInputValues(a),isNaN(a.zoom)||c.setZoom(a.zoom))}},items:q}}});$("#scaleMenu"+g.id).on("mousedown",function(a){a.preventDefault();$("#scaleMenu"+g.id).contextMenu()});$.contextMenu({selector:"#scaleMenu"+g.id,zIndex:a.MENUZINDEX,events:{hide:c},build:function(){var c,b,e,f=0,h={},l=d()[0],q=function(c,d){a.isNumber(d.scalemin)&&
(c.params.scalemin=parseFloat(d.scalemin));a.isNumber(d.scalemax)&&(c.params.scalemax=parseFloat(d.scalemax));c.displayImage("colors")},s=function(a){var c=$.contextMenu.getInputValues(a.data),d=g.display.image;switch(a.which||a.keyCode){case 9:case 13:q(d,c);a.data.edited=!1;break;default:a.data.edited=!0}};h.scaletitle={name:"Scaling Algorithms:",disabled:!0};for(c=0;c<a.scales.length;c++)e=b=a.scales[c],h[b]={name:e},l.image&&l.image.params.scale===b&&(h[b].icon="sun");h["sep"+f++]="------";h.scalemin=
{events:{keyup:s},name:"low limit for clipping:",type:"text"};h.scalemax={events:{keyup:s},name:"high limit for clipping:",type:"text"};h["sep"+f++]="------";h.dminmax={name:"set limits to data min/max"};h.zscale={name:"set limits to zscale z1/z2"};return{callback:function(a,c){d().forEach(function(d){if(d=d.image)switch(a){case "dminmax":return d.params.scaleclipping="dataminmax",d.params.scalemin=d.raw.dmin,d.params.scalemax=d.raw.dmax,$.contextMenu.setInputValues(c,{scalemin:String(d.params.scalemin),
scalemax:String(d.params.scalemax)}),d.displayImage("colors"),!1;case "zscale":return(!d.params.z1||d.params.z2)&&d.zscale(!1),d.params.scaleclipping="zscale",d.params.scalemin=d.params.z1,d.params.scalemax=d.params.z2,$.contextMenu.setInputValues(c,{scalemin:String(d.params.scalemin),scalemax:String(d.params.scalemax)}),d.displayImage("colors"),!1;default:d.setScale(a)}})},events:{show:function(c){var d=g.display.image,b={};d&&(b.scalemin=String(d.params.scalemin),b.scalemax=String(d.params.scalemax));
$.contextMenu.setInputValues(c,b);a.jupyterFocus(".context-menu-item")},hide:function(a){var c=g.display.image;c&&a.edited&&(delete a.edited,a=$.contextMenu.getInputValues(a),q(c,a))}},items:h}}});$("#colorMenu"+g.id).on("mousedown",function(a){a.preventDefault();$("#colorMenu"+g.id).contextMenu()});$.contextMenu({selector:"#colorMenu"+g.id,zIndex:a.MENUZINDEX,events:{hide:c},build:function(){var c,b,e,f=0,h={},l=d()[0],q=function(a,c){c.contrast&&!isNaN(c.contrast)&&(a.params.contrast=parseFloat(c.contrast));
c.bias&&!isNaN(c.bias)&&(a.params.bias=parseFloat(c.bias));isNaN(c.opacity)||(a.params.opacity=""!==c.opacity?parseFloat(c.opacity):1);a.displayImage("colors")},s=function(a){var c=$.contextMenu.getInputValues(a.data),d=g.display.image;switch(a.which||a.keyCode){case 9:case 13:q(d,c);a.data.edited=!1;break;default:a.data.edited=!0}};h.cmaptitle={name:"Colormaps:",disabled:!0};for(c=0;c<a.colormaps.length;c++)e=b=a.colormaps[c].name,h[b]={name:e},l.image&&l.image.cmapObj.name===b&&(h[b].icon="sun");
h["sep"+f++]="------";h.contrast={events:{keyup:s},name:"contrast value:",type:"text"};h.bias={events:{keyup:s},name:"bias value:",type:"text"};h.opacity={events:{keyup:s},name:"opacity value:",type:"text"};h["sep"+f++]="------";h.reset={name:"reset contrast/bias"};h["sep"+f++]="------";h.loadcmap={name:"load colormap"};h.savecmap={name:"save colormap"};h.invert={name:"invert colormap"};l.image&&l.image.params.invert&&(h.invert.icon="sun");h["sep"+f++]="------";h.rgb={name:"RGB mode"};a.globalOpts.rgb.active&&
(h.rgb.icon="sun");return{callback:function(c){d().forEach(function(d){var b=d.image;if(b)switch(c){case "loadcmap":a.OpenColormapMenu({display:d});break;case "savecmap":a.SaveColormap({display:d});break;default:b.setColormap(c)}})},events:{show:function(c){var d=g.display.image,b={};d&&(b.contrast=String(d.params.contrast),b.bias=String(d.params.bias),b.opacity=String(d.params.opacity),b.sigma=String(d.params.sigma));$.contextMenu.setInputValues(c,b);a.jupyterFocus(".context-menu-item")},hide:function(a){var c=
g.display.image;c&&a.edited&&(delete a.edited,a=$.contextMenu.getInputValues(a),q(c,a))}},items:h}}});$("#regionMenu"+g.id).on("mousedown",function(a){a.preventDefault();$("#regionMenu"+g.id).contextMenu()});$.contextMenu({selector:"#regionMenu"+g.id,zIndex:a.MENUZINDEX,events:{hide:c},build:function(){var c=d()[0].image,b={regiontitle:{name:"Regions:",disabled:!0},annulus:{name:"annulus"},box:{name:"box"},circle:{name:"circle"},ellipse:{name:"ellipse"},line:{name:"line"},point:{name:"point"},polygon:{name:"polygon"},
...
zIndex:a.MENUZINDEX,events:{hide:c},build:function(){var c,b,e,f=0,g=0,h={},q=d()[0],s=q.image;h.wcssystitle={name:"WCS Systems:",disabled:!0};for(c=0;c<a.wcssyss.length;c++)e=b=a.wcssyss[c],h[b]={name:e},q.image&&q.image.params.wcssys===b&&(h[b].icon="sun");h["sep"+f++]="------";h.wcsutitle={name:"WCS Units:",disabled:!0};for(c=0;c<a.wcsunitss.length;c++)e=b=a.wcsunitss[c],h[b]={name:e},q.image&&q.image.params.wcsunits===b&&(h[b].icon="sun");h["sep"+f++]="------";h.reproject={name:"reproject",items:{reprojtitle:{name:"wcs from:",
disabled:!0}}};for(c=0;c<a.images.length;c++)s!==a.images[c]&&a.images[c].wcs&&(b="reproject_"+a.images[c].id,h.reproject.items[b]={name:a.images[c].id},g++);0===g?h.reproject.items.notasks={name:"[none]",disabled:!0,events:{keyup:function(){}}}:(h.reproject.items["sep"+f++]="------",h.reproject.items.reproject_wcsalign={name:"display wcs-aligned"},q.image&&q.image.params.wcsalign&&(h.reproject.items.reproject_wcsalign.icon="sun"));return{callback:function(c){d().forEach(function(d){var b;b=RegExp(c);
if(d=d.image)c.match(/^reproject_/)?"reproject_wcsalign"===c?(d.params.wcsalign=!d.params.wcsalign,d.displayImage("display")):(b=c.replace(/^reproject_/,""),d.reprojectData(b)):0<=a.wcssyss.join("@").search(b)?d.setWCSSys(c):0<=a.wcsunitss.join("@").search(b)?d.setWCSUnits(c):a.error("unknown wcs sys/units: "+c)})},items:h}}});$("#analysisMenu"+g.id).on("mousedown",function(a){a.preventDefault();$("#analysisMenu"+g.id).contextMenu()});$.contextMenu({selector:"#analysisMenu"+g.id,zIndex:a.MENUZINDEX,
events:{hide:c},build:function(){var c,b,e,f,h,l=0,q=0,s={};h=d()[0];var t=h.image,v="",u=function(a,c){c.sigma||(c.sigma="none");"none"===c.sigma?(a.params.sigma=c.sigma,a.rawDataLayer("gaussBlur","remove")):(a.params.sigma=parseFloat(c.sigma),a.gaussBlurData(a.params.sigma))},w=function(a){var c=$.contextMenu.getInputValues(a.data),b=g.display.image;switch(a.which||a.keyCode){case 9:case 13:u(b,c);a.data.edited=!1;break;default:a.data.edited=!0}};for(c=0;c<a.plugins.length;c++)if(b=a.plugins[c],
f=b.name,b.opts.menuItem&&"analysis"===b.opts.menu&&(e=h.pluginInstances[f],!e||e.winHandle))b.xclass!==v&&(s["sep"+q++]="------",s["sep"+q++]={name:b.xclass+" Plugins:"},s["sep"+(q-1)].disabled=!0),v=b.xclass,s[f]={name:b.opts.menuItem},e&&"active"===e.status&&(s[f].icon="sun"),q++;if(!a.allinone){0<q&&(s["sep"+q++]="------");s.remotetitle={name:"Server-side Tasks:",disabled:!0};if(t&&t.analysisPackages){f=t.analysisPackages;for(b=0;b<f.length;b++){h=f[b];for(c=0;c<h.length;c++)if(!h[c].hidden&&
...
d.canvas=d.dlayer.canvas;d.canvas.calcOffset()}return d};a.Fabric._parseShapeOptions=function(c,b,d){var e,f,g,h,j,k,m,n={},p={};h="main"===this.display.layers[c].dtype?this.rgb.sect.zoom:1;j=h/("main"===this.display.layers[c].dtype?this.binning.bin||1:1);if(b.remove)return{remove:b.remove};p.tags=[];if(b.tags)if("string"===typeof b.tags){f=b.tags.toLowerCase().split(",");for(c=0;c<f.length;c++)p.tags[c]=f[c].trim()}else if($.isArray(b.tags))for(c=0;c<b.tags.length;c++)p.tags[c]=b.tags[c].trim();
void 0!==b.angle&&(n.angle=-b.angle);void 0!==b.x&&void 0!==b.y&&(e=this.imageToDisplayPos(b),n.left=e.x,n.top=e.y);void 0!==b.left&&(n.left=b.left);void 0!==b.top&&(n.top=b.top);void 0===n.left&&(n.left=d&&void 0!==d.left?d.left:this.display.canvasjq.attr("width")/2-1);void 0===n.top&&(n.top=d&&void 0!==d.top?d.top:this.display.canvasjq.attr("height")/2-1+1);b.dx&&(n.left+=b.dx);b.dy&&(n.top-=b.dy);switch(b.shape){case "annulus":p.radii=[];if(void 0!==b.radii)if("string"===typeof b.radii){p.radii=
b.radii.replace(/ /g,"").split(",");for(e=c=0;c<p.radii.length;c++)""!==p.radii[c]&&(p.radii[e++]=parseInt(p.radii[c],10))}else p.radii=b.radii;else{b.ireg&&a.SCALEIREG&&(b.iradius&&(b.iradius/=j),b.oradius&&(b.oradius/=j));h=(b.oradius-b.iradius)/b.nannuli;j=b.nannuli+1;for(c=0;c<j;c++)f=b.iradius+h*c,p.radii.push(f)}break;case "box":b.ireg&&a.SCALEIREG&&(b.width&&(b.width/=j),b.height&&(b.height/=j));break;case "circle":b.ireg&&a.SCALEIREG&&b.radius&&(b.radius/=j);break;case "ellipse":b.ireg&&a.SCALEIREG&&
...
{nx:a.userOpts.fits.table.nx,ny:a.userOpts.fits.table.ny}):(a.fits.options.extlist=a.globalOpts.extlist,a.fits.options.table={nx:a.globalOpts.dims[0],ny:a.globalOpts.dims[1]});a.fits.maxFITSMemory&&a.globalOpts.maxMemory&&a.fits.maxFITSMemory(a.globalOpts.maxMemory);break;default:a.error("unknown fits library: "+c)}a.fits.name=b;a.fits.options.error=a.error;a.fits.options.waiting=a.waiting;return b};a.handleImageFile=function(c,b,d){b=$.extend(!0,{},b,a.fits.options);void 0===d&&(d=a.Load);var e=
new FileReader;e.onload=function(a){var e=new Image;e.src=a.target.result;e.onload=function(){var a,f,k,m=0;a=document.createElement("canvas");f=a.getContext("2d");var n=e.height,p=e.width;a.width=p;a.height=n;f.drawImage(e,0,0);var r=f.getImageData(0,0,p,n).data,l=new Float32Array(n*p);for(f=0;f<n;f++)for(a=0;a<p;a++)k=0.299*r[m]+0.587*r[m+1]+0.114*r[m+2],l[(n-f)*p+a]=k,m+=4;a={head:{},name:c.name,filedata:l,naxis:2,axis:[0,p,n],bitpix:-32,data:l};a.dmin=Number.MAX_VALUE;a.dmax=Number.MIN_VALUE;
for(m=0;m<n*p;m++)a.dmin=Math.min(a.dmin,a.data[m]),a.dmax=Math.max(a.dmax,a.data[m]);d(a,b)}};e.readAsDataURL(c)};a.lookupColormap=function(c){var b;c||(c=a.imageOpts.colormap);if(c)for(b=0;b<a.colormaps.length;b++)if(a.colormaps[b].name===c)return a.colormaps[b];a.error("unknown colormap '"+c+"'")};a.lookupCommand=function(c){var b,d;if(c){d=c.toLowerCase();for(b=0;b<a.commands.length;b++)if(c=a.commands[b],c.name===d||c.alias===d||c.alias2===d)return c}return null};a.error=function(c,b,d){var e,
f,g="",h="",j=!0;a.waiting(!1);"string"===typeof b?(f=c.match(b))?f[1]?c=f[1]:f[0]&&(c=f[0]):j=!1:"object"===typeof b&&(e=b);3>arguments.length&&(d=!0);if(j&&(e&&e.message?c+=sprintf(" (%s)",e.message):c&&(e=Error(c)),(f=a.strace(e))&&(h="\n\nStacktrace:\n"+f),a.globalOpts.alerts&&(c&&("string"===typeof c&&0>c.search(/ERROR/))&&(g="JS9 ERROR: "),alert(g+(c+h))),d))throw e;};a.eventToDisplayPos=function(a){var b,d;a||(a=window.event);a.target?b=a.target:a.srcElement&&(b=a.srcElement);3===b.nodeType&&
...
void 0!==window.console.log)try{console.log.apply(console,arguments)}catch(a){Function.prototype.bind.call(console.log,console).apply(console,arguments)}};a.isNumber=function(a){return!isNaN(parseFloat(a))&&isFinite(a)};a.notNull=function(a){return void 0!==a&&null!==a};a.cardpars=function(c){var b;if("="===c[8])return b=c.slice(0,8).trim(),c=c.slice(10).replace(/\'/g," ").replace(/\/.*/,"").trim(),"T"===c?c=!0:"F"===c?c=!1:a.isNumber(c)&&(c=parseFloat(c)),[b,c]};a.raw2FITS=function(a,b){var d,e,
f,g=!1,h="";if(!a)return h;if(a.card)for(d=0;d<a.card.length;d++)e=a.card[d],h+=e,"END "===e.substring(0,4)&&(g=!0),b&&(h+="\n");else if(a.cardstr)for(d=0;d<a.ncard;d++)e=a.cardstr.slice(80*d,80*(d+1)),h+=e,"END "===e.substring(0,4)&&(g=!0),b&&(h+="\n");else if(a.header)for(e in d=a.header,d){if(d.hasOwnProperty(e)&&!("js9Protocol"===e||"js9Endian"===e))"END"===e&&(g=!0),f=d[e],!0===f&&(f="T"),h+=sprintf("%-8s%-2s%-70s",e,"=",f),b&&(h+="\n")}else if(a.BITPIX)for(e in d=a,d)if(d.hasOwnProperty(e)&&
!("js9Protocol"===e||"js9Endian"===e))"END"===e&&(g=!0),f=d[e],!0===f&&(f="T"),h+=sprintf("%-8s%-2s%-70s",e,"=",f),b&&(h+="\n");g||(h+=sprintf("%-8s%-72s","END"," "),b&&(h+="\n"));return h};a.hdus2Str=function(a){var b,d,e,f="";if(!a)return f;for(b=0;b<a.length;b++){e=a[b];d=e.name?e.name:0===b?"Primary":"N/A";f+=sprintf("<b>hdu</b>: %d\t<b>name</b>: %s\t<b>type</b>: %s",e.hdu,d,e.type);switch(e.type){case "image":f+=sprintf("\t<b>bitpix</b>: %d\t<b>naxis</b>: %d",e.bitpix,e.naxis);if(e.naxes.length){f+=
"\t<b>axes</b>: [";for(d=0;d<e.naxes.length;d++)f+=sprintf("%d",e.naxes[d]),d!==e.naxes.length-1&&(f+=", ");f+="]"}break;case "table":case "ascii":d="\t";9>=e.rows&&(d+="\t");f+=sprintf("\t<b>rows</b>: %d%s<b>cols</b>: [",e.rows,d);for(d=0;d<e.cols.length;d++)f+=sprintf("%s",e.cols[d].name),d!==e.cols.length-1&&(f+=", ");f+="]"}f+="\n\n"}return f};CanvasRenderingContext2D.prototype.clear=CanvasRenderingContext2D.prototype.clear||function(a){a&&(this.save(),this.setTransform(1,0,0,1,0,0));this.clearRect(0,
