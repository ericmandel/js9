...
e.context||"image";try{switch(e.context){case "image":this[b].apply(this,e.args);break;case "display":this.display[b].apply(this.display,e.args);break;default:this[b].apply(this,e.args)}}catch(f){a.error("error executing stash: "+b,f,!1)}}};a.Image.prototype.xeqPlugins=function(d,c,b){var e,f,g,h,k,l=function(a,b){var c="JS9:"+a;$(document).trigger(c,b)};if(d&&c&&a.globalOpts.xeqPlugins){h=this.display.pluginInstances;for(e in h)if(h.hasOwnProperty(e)&&(f=h[e],g=f.plugin.opts,f.isActive(c)&&"function"===
typeof g[c])){this.callingPlugin=c;switch(d){case "image":try{g[c].call(f,this),l(c,{im:this})}catch(n){f.errLog(c,n)}break;case "region":case "shape":try{g[c].call(f,this,b),l(c,{im:this,xreg:b})}catch(n){f.errLog(c,n)}break;case "keypress":k=b.originalEvent||b;try{g[c].call(f,this,this.ipos,k),l(c,{im:this,ipos:this.ipos,evt:k})}catch(n){f.errLog(c,n)}break;case "mouse":if(!this.clickInRegion||g[c+"_inRegion"]){k=b.originalEvent||b;try{g[c].call(f,this,this.ipos,k),l(c,{im:this,ipos:this.ipos,evt:k})}catch(n){f.errLog(c,
n)}}}delete this.callingPlugin}return this}};a.Image.prototype.uploadFITSFile=function(){var d,c,b=this,e=function(c){delete b.tmp.upload;window.setTimeout(function(){a.progress(!1)},1E3);c.stderr?a.error(c.stderr):c.stdout&&(b.fitsFile=c.stdout.trim(),b.proxyFile=b.fitsFile,a.globalOpts.prependJS9Dir&&!b.fitsFile.match(/^\${JS9_DIR}/)&&"/"!==b.fitsFile.charAt(0)&&(b.fitsFile="${JS9_DIR}/"+b.fitsFile),b.queryHelper("all"))};if(a.worker&&("nodejs"===a.helper.type||"socket.io"===a.helper.type)&&this.raw.hdu&&
this.raw.hdu.fits&&this.raw.hdu.fits.vfile)return this.tmp.upload&&a.error("only one upload allowed at a time"),d=this.raw.hdu.fits.vfile,a.helper.send("quotacheck",null,function(f){(f.stderr||f.errcode)&&a.error(f.stderr||"from quotacheck: "+f.errcode);c=a.vread(d,"binary");a.worker.socketio(function(){b.tmp.upload=!0;a.progress(!0,b.display);a.worker.postMessage("uploadFITS",[d,c],e,[c.buffer])})}),this};a.Image.prototype.removeProxyFile=function(d){var c,b,e=this;if("boolean"===typeof d)b=d;else if("string"===
typeof d){if(d.match(/^\//))return;c=new RegExp("^"+a.INSTALLDIR);c=d.replace(c,"");if(c.match(/\.\./))return;c=d}else{if(!this.proxyFile)return;c=this.proxyFile}c&&a.Send("removeproxy",{cmd:"js9Xeq removeproxy "+c},function(a){b&&a&&"OK"===a.stdout.trim()&&(e.proxyFile=null,e.fitsFile=null,e.analysisPackages=null,e.queryHelper("all"))})};a.Image.prototype.starbaseToShapes=function(d,c){var b,e,f,g,h,k,l,n,m,r,q,t,u,v,p,w,x;r=a.globalOpts.catalogs.ras;b=a.globalOpts.catalogs.decs;var A=[],z=a.globalOpts.catalogs,
C=function(b,c,d){return(b=a.wcs2pix(b.raw.wcs,c,d).trim().split(/ +/))&&b.length?{x:parseFloat(b[0]),y:parseFloat(b[1])}:null};e=function(a,b,c,d){var e,f;if(void 0!==d)f=d;else{f=-1;for(e=0;e<c.length;e++){for(d=0;d<b.length;d++)if(c[e].toLowerCase()===b[d].toLowerCase()){f=a[b[d]];break}if(0<=f)break}if(0>f)for(w=c[0],x=new RegExp("^"+w,"i"),d=0;d<b.length;d++)if(b[d].match(x)){f=a[b[d]];break}if(0>f)for(w=c[0],x=new RegExp(".*"+w+".*","i"),d=0;d<b.length;d++)if(b[d].match(x)){f=a[b[d]];break}}return f};
if(d&&d.data&&d.headline){k=d.data;l=d.headline;n=d.delims;c=c||{};r=e(d,l,r,c.xcol);0>r&&a.error("can't find an RA column (see Preferences:catalogs)");q=e(d,l,b,c.ycol);0>q&&a.error("can't find a Dec column (see Preferences:catalogs)");g=c.shape||z.shape||"circle";switch(g){case "box":m=function(a,b,d){return{width:c.width||z.width||7,height:c.height||z.height||7}};break;case "circle":m=function(a,b,d){return{radius:c.radius||z.radius||3.5}};break;case "ellipse":m=function(a,b,d){return{r1:c.r1||
z.r1||3.5,r2:c.r2||z.r2||3.5}};break;default:m=function(a,b,d){return{width:c.width||7,height:c.height||7}}}v=this.getWCSSys();p=c.wcssys?c.wcssys:z.wcssys?z.wcssys:"ICRS";this.setWCSSys(p);for(e=b=0;b<k.length;b++)if(t=k[b][r],u=k[b][q],"\x00"!==n[r]&&0<=":h ".indexOf(n[r])&&"galactic"!==p&&"ecliptic"!==p&&(t*=15),f=C(this,t,u)){h=m.call(this,k[b][1],k[b][1]);h={id:b.toString(),shape:g,x:f.x,y:f.y,width:h.width,height:h.height,radius:h.radius,r1:h.r1,r2:h.r2,angle:0,data:{ra:t,dec:u}};if(!1!==c.save&&
!1!==a.globalOpts.catalogs.save)for(f=0;f<=l.length;f++)l[f]&&(h.data[l[f]]=k[b][f]);c.color&&(h.color=c.color);A[e++]=h}this.setWCSSys(v);return A}};a.Image.prototype.loadCatalog=function(d){for(var c=[],b=0;b<arguments.length;++b)c[b-0]=arguments[b];var e=$jscomp.makeIterator(c),b=e.next().value,f=e.next().value,e=e.next().value,g,h=$.extend(!0,{},a.Catalogs.opts),k=a.globalOpts.catalogs;1===c.length&&"string"!==typeof b&&(f=b,b=null);2===c.length&&"string"!==typeof b&&(e=f,f=b,b=null);if(f){k.tooltip&&
(h.tooltip=k.tooltip);if("string"===typeof e)try{e=JSON.parse(e)}catch(l){a.error("can't parse catalog opts: "+e,l)}e=e||{};e.color=e.color||k.color||"#00FF00";e.wcssys=e.wcssys||k.wcssys;e.updateWCS=!0;c={convFuncs:{def:function(b){var c={};c.val=a.saostrtod(b);c.delim=String.fromCharCode(a.saodtype());if("\x00"!==c.delim&&0<=" \t-.:hdmsr'\"".indexOf(c.delim)||a.isNumber(b))return c;c.val=b;return c}},units:e.units||k.units,skip:e.skip||k.skip};try{g=new a.Starbase(f,c)}catch(l){a.error("could not parse catalog. Is it in tab-separated column format?")}g&&
g.data&&g.data.length||a.error("no objects found in catalog");c=this.starbaseToShapes(g,e);c.length?(b=b||"catalog_"+a.uniqueID(),this.display.newShapeLayer(b,h),this.removeShapes(b),this.layers[b].catalog=f,this.layers[b].starbase=g,this.addShapes(b,c,e)):a.error("no catalog objects found");return this}};a.Image.prototype.saveCatalog=function(d,c){var b,e;b=c||this.activeShapeLayer();this.layers[b]&&this.layers[b].catalog||(b&&"undefined"!==b?a.error("no catalog available: "+b):a.error("no active catalog available"));
e=new Blob([this.layers[b].catalog],{type:"text/plain;charset=utf-8"});d=d||b+".cat";d.match(/\.cat$/)||(d+=".cat");window.hasOwnProperty("saveAs")?saveAs(e,d):a.error("no saveAs function available to save catalog");return d};a.Image.prototype.wcs2wcs=function(d,c,b,e){var f,g,h;f=this.getWCSSys();g=this.getWCSUnits();d=d||f;c=c||f;"string"===typeof b&&(h=a.strtoscaled(b),":"===h.dtype&&"galactic"!==d&&"ecliptic"!==d&&(h.dval*=15),b=h.dval);"string"===typeof e&&(h=a.strtoscaled(e),e=h.dval);h=this.setWCSSys(d).getWCSSys();
"native"!==d&&h!==d&&a.error("unknown or invalid wcs: "+d);b=a.wcs2pix(this.raw.wcs,b,e).trim().split(/ +/);d=parseFloat(b[0]);b=parseFloat(b[1]);this.setWCSSys(c);this.setWCSUnits("degrees");d=a.pix2wcs(this.raw.wcs,d,b).trim();this.setWCSUnits(g);f!==c&&this.setWCSSys(f);return d};a.Image.prototype.wcs2imlen=function(d){var c,b=1;if(d){d=a.strtoscaled(d);c=this.raw.wcsinfo||{cdelt1:1,cdelt2:1};void 0!==c.cdelt1?b=c.cdelt1:void 0!==c.cdelt2&&(b=c.cdelt2);switch(this.params.wcssys){case "image":break;
case "physical":this.lcs&&this.lcs.physical&&(d.dval*=this.lcs.physical.forward[0][0]);break;default:d.dtype&&"."!==d.dtype&&"\x00"!==d.dtype&&(d.dval=Math.abs(d.dval/b))}return d.dval}};a.Colormap=function(d){for(var c=[],b=0;b<arguments.length;++b)c[b-0]=arguments[b];var e=$jscomp.makeIterator(c),b=e.next().value,f=e.next().value,g=e.next().value,e=e.next().value,h;if(b){this.name=b;switch(c.length){case 2:this.type="lut";this.colors=f;break;case 4:this.type="sao";this.vertices=[f,g,e];break;default:a.error("colormap requires a colormap name and 1 or 3 array args")}this.source=
a.inited?"user":"core";for(c=0;c<a.colormaps.length;c++)if(a.colormaps[c].name===this.name){a.colormaps[c]=this;h=!0;break}h||a.colormaps.push(this);1<a.DEBUG&&a.log("JS9 colormap:  %s",this.name)}};a.Colormap.prototype.mkColorCell=function(d){var c,b,e,f;e=a.COLORSIZE;var g=[0,0,0];switch(this.type){case "sao":b=d/e;for(d=0;3>d;d++){f=this.vertices[d];c=f.length;for(e=0;e<c&&!(f[e][0]>b);e++);e=0===e?f[0][1]:e===c?f[c-1][1]:(c=(f[e][1]-f[e-1][1])/(f[e][0]-f[e-1][0]))?c*(b-f[e-1][0])+f[e-1][1]:f[e][1];
g[d]=255*e}break;case "lut":b=this.colors.length;d=Math.floor(d*b/e);0>d?(g[0]=255*this.colors[0][0],g[1]=255*this.colors[0][1],g[2]=255*this.colors[0][2]):d<b?(g[0]=255*this.colors[d][0],g[1]=255*this.colors[d][1],g[2]=255*this.colors[d][2]):(g[0]=255*this.colors[b-1][0],g[1]=255*this.colors[b-1][1],g[2]=255*this.colors[b-1][2]);break;default:a.error("unknown colormap type")}return g};a.Display=function(d){var c=this;this.divjq=d instanceof jQuery?d:"object"===typeof d?$(d):$("#"+d);this.divjq.attr("id")||
...
"js9").attr("title","js9").appendTo(this.iconjq),a.globalOpts.logoDisplay&&this.iconjq.css("display","block"));a.globalOpts.resizeHandle&&window.hasOwnProperty("ResizeSensor")&&(this.divjq.css("resize","both").css("overflow","hidden"),a.bugs.webkit_resize&&(this.owidth=parseInt(this.divjq.css("width"),10),this.oheight=parseInt(this.divjq.css("height"),10),this.divjq.css("width",this.width+a.RESIZEFUDGE).css("height",this.height+a.RESIZEFUDGE)),this.resizeSensor=new ResizeSensor(this.divjq,function(){var b=
c.divjq.width(),d=c.divjq.height();a.bugs.webkit_resize&&(b-=a.RESIZEFUDGE,d-=a.RESIZEFUDGE);c.resize(b,d)}));this.context=this.canvas.getContext("2d");a.ANTIALIAS||(this.context.imageSmoothingEnabled=!1,this.context.webkitImageSmoothingEnabled=!1,this.context.msImageSmoothingEnabled=!1);this.tooltip=$("<div>").attr("id","tooltip_"+this.id).addClass("JS9Tooltip").appendTo(this.divjq);this.image=null;this.pluginInstances={};this.layers={};this.initMessages();this.blendMode=!1;this.mouseActions=a.globalOpts.mouseActions.slice(0);
...
a.displays.push(this);a.DEBUG&&a.log("JS9 display:  %s",this.id)};a.Display.prototype.addFileDialog=function(d,c){var b,e,f=this;d&&a.publics[d]&&(e="openLocal"+d+"-"+f.id,b=$("<div>").css("visibility","hidden").css("position","relative").css("top",-50).css("left",-50).appendTo(f.divjq),b=$("<input>").attr("type","file").attr("id",e).attr("multiple",!0).appendTo(b),c&&b.attr("accept",c),b.on("change",function(){var b,c;if(this.files.length)switch(d){case "Load":case "RefreshImage":c={localAccess:!0},
a.waiting(!0,f)}for(b=0;b<this.files.length;b++)a.publics[d](this.files[b],c,{display:f.id});this.value=null;return!1}))};a.Display.prototype.initMessages=function(){this.messageContainer=$("<div>").addClass("JS9Container").css("z-index",a.MESSZINDEX).appendTo(this.divjq);this.infoArea=$("<div>").addClass("JS9Message").appendTo(this.messageContainer);this.regionsArea=$("<div>").addClass("JS9Message").appendTo(this.messageContainer);this.progressArea=$("<div>").addClass("JS9Progress").addClass("JS9Message").appendTo(this.messageContainer);
this.progressBar=$("<progress>").addClass("JS9ProgressBar").attr("value",0).attr("max",100).attr("name","progress").appendTo(this.progressArea);try{this.messageContainer.draggable({start:function(d,c){this.oicb=a.globalOpts.internalContrastBias;a.globalOpts.internalContrastBias=!1},stop:function(d,c){a.globalOpts.internalContrastBias=this.oicb}})}catch(d){}return this};a.Display.prototype.displayPlugin=function(d){var c,b,e,f,g,h,k,l,n=this;if("string"===typeof d)for(c=0;c<a.plugins.length;c++)if(g=
a.plugins[c],g.name===d){d=g;break}"object"===typeof d&&d.name||a.error("unknown plugin type for displayPlugin");l=this.pluginInstances[d.name];switch(a.globalOpts.winType){case "light":b=a.lightOpts[a.LIGHTWIN];if(!l||!l.status){if(k=d.name.replace(/\s/g,"_"),c=this.id+"_"+k+"_lightDiv",g=this.id+"_"+k+"_outerDiv",k=this.id+"_"+k+"_innerDiv",l||(e=$("<div>").attr("id",g).css("display","none").appendTo($(this.divjq)),$("<div>").addClass(d.name).attr("id",k).attr("data-js9id",this.divjq.attr("id")).css("height",
"100%").css("width","100%").appendTo(e)),e=d.opts.winDims[0]||a.WIDTH,f=d.opts.winDims[1]||a.HEIGHT,h=d.opts.winResize?"1":"0",b=sprintf(b.format,e,f,h),e=d.opts.toolbarHTML&&0<=d.opts.toolbarHTML.search(/\$title/)?"":d.opts.winTitle||"",e+=sprintf(a.IDFMT,this.id),g=a.lightWin(c,"div",g,e,b),c=$("#"+c+" #"+k),l=a.instantiatePlugin(c,d,g),l.winHandle.onclose=function(){l.winHandle.hide();l.status="inactive";if(d.opts.onpluginclose)try{d.opts.onpluginclose.call(l,n.image)}catch(m){a.log("onplugincloseCB: %s [%s]\n%s",
d.name,m.message,a.strace(m))}return!1},l.status="active",d.opts.onplugindisplay)try{d.opts.onplugindisplay.call(l,this.image)}catch(m){a.log("onplugindisplayCB: %s [%s]\n%s",d.name,m.message,a.strace(m))}}else if("inactive"===l.status){if(l.winHandle&&(l.winHandle.show(),l.status="active",d.opts.onplugindisplay))try{d.opts.onplugindisplay.call(l,this.image)}catch(m){a.log("onplugindisplayCB: %s [%s]\n%s",d.name,m.message,a.strace(m))}}else if("active"===l.status&&l.winHandle&&(l.winHandle.hide(),
l.status="inactive",d.opts.onpluginclose))try{d.opts.onpluginclose.call(l,n.image)}catch(m){a.log("onplugincloseCB: %s [%s]\n%s",d.name,m.message,a.strace(m))}break;case "new":a.error("external window support for plugins not yet implemented")}};a.Display.prototype.resize=function(d,c,b){var e,f,g,h,k,l=function(a){a.left+=h;a.top+=k;a.setCoords()};a.globalOpts.resize||a.error("display resize not enabled");if(!d&&!c)return{width:this.width,height:this.height};if("full"===d){if(b=c,window.innerWidth&&
(d=window.innerWidth),window.innerHeight)for(c=window.innerHeight,e=0;e<a.globalOpts.centerDivs.length;e++)f=a.globalOpts.centerDivs[e],this.pluginInstances[f]&&(c-=this.pluginInstances[f].divjq.height())}else"image"===d?(this.image||a.error("can't resize display to 'image' without an image"),b=c,d=this.image.raw.width,c=this.image.raw.height):"reset"===d&&(b=c,d=this.width0||d,c=this.height0||c);d=Math.floor(d);c=c?Math.floor(c):d;(10>d||10>c)&&a.error("invalid dimension(s) passed to display resize");
if(d===this.width&&c===this.height)return this;b=b||{};e=d;d=c;h=(e-this.width)/2;k=(d-this.height)/2;this.width=e;this.height=d;this.divjq.css("width",e);this.divjq.css("height",d);this.canvasjq.attr("width",e);this.canvasjq.attr("height",d);a.bugs.webkit_resize&&!this.resizing&&(this.owidth=Math.min(this.owidth,e),this.oheight=Math.min(this.oheight,d));0<=$.inArray("JS9Menubar",a.globalOpts.resizeDivs)&&(a.isNull(b.resizeMenubar)||b.resizeMenubar)&&(c=this.pluginInstances.JS9Menubar)&&$("#"+this.id+
"Menubar").css("width",e);0<=$.inArray("JS9Toolbar",a.globalOpts.resizeDivs)&&(a.isNull(b.resizeToolbar)||b.resizeToolbar)&&(c=this.pluginInstances.JS9Toolbar)&&(c.divjq.attr("data-width",String(e)+"px"),a.Toolbar.init.call(c));0<=$.inArray("JS9Colorbar",a.globalOpts.resizeDivs)&&(a.isNull(b.resizeColorbar)||b.resizeColorbar)&&(c=this.pluginInstances.JS9Colorbar)&&(c.divjq.attr("data-width",String(e)+"px"),a.Colorbar.init.call(c));for(g in this.layers)this.layers.hasOwnProperty(g)&&(c=this.layers[g],
"main"===c.dtype&&(c.divjq.css("width",e),c.divjq.css("height",d),c.canvasjq.attr("width",e),c.canvasjq.attr("height",d),c.canvas.setWidth(e),c.canvas.setHeight(d),c.canvas.calcOffset()));for(e=0;e<a.images.length;e++)if(d=a.images[e],d.mkSection(),d.display&&this===d.display&&(d.resize?(d.resize.left+=h,d.resize.top+=k):d.resize={left:h,top:k},d===d.display.image))for(g in d.layers)d.layers.hasOwnProperty(g)&&(c=d.layers[g],"main"!==c.dlayer.type||c.json||(c.canvas.getObjects().forEach(l),c.canvas.renderAll()));
a.bugs.webkit_resize&&this.divjq.css("width",this.width+a.RESIZEFUDGE).css("height",this.height+a.RESIZEFUDGE);!this.image||!a.globalOpts.resizeRedisplay&&this.resizing||(this.image.displayImage("all",b),this.image.refreshLayers());b.center&&this.center();return this};a.Display.prototype.inResize=function(d){return a.globalOpts.resizeHandle&&d.x+a.RESIZEDIST>=this.divjq.width()&&d.y+a.RESIZEDIST>=this.divjq.height()?!0:!1};a.Display.prototype.center=function(){var d=this.divjq,c,b,e,f;e=d.offset().top;
var g=d.height(),h=$(window).height();f=d.offset().left;var d=d.width(),k=$(window).width();for(c=0;c<a.globalOpts.centerDivs.length;c++)b=a.globalOpts.centerDivs[c],this.pluginInstances[b]&&(b=this.pluginInstances[b].divjq,g+=b.height(),e=Math.min(b.offset().top,e));e=g<h?e-(h/2-g/2):e;f=d<k?f-(k/2-d/2):f;$("html, body").animate({scrollTop:e,scrollLeft:f},250);return this};a.Display.prototype.gather=function(d){var c,b;if("string"===typeof d)try{d=JSON.parse(d)}catch(e){a.error("can't parse gather opts: "+
d,e)}d=d||{};c=d.images||a.images;for(d=0;d<c.length;d++)(b="number"===typeof c[d]?a.images[c[d]]:c[d])&&b.display!==this&&b.moveToDisplay(this);a.globalOpts.extendedPlugins&&this.image&&this.image.xeqPlugins("image","ongatherdisplay")};a.Display.prototype.separate=function(d){var c,b,e=0,f=0,g=0,h=1,k,l,n,m,r,q,t,u,v,p,w,x,A,z={},C=/_sep[0-9][0-9]*/,D=a.globalOpts.separate,y=a.bugs.webkit_resize?a.RESIZEFUDGE:0,B=this,F=function(b,c){b||a.error("can't init seapration ops: no from id");k=c.layout||
a.globalOpts.separate.layout||"auto";l=c.leftMargin||D.leftMargin||0;n=c.topMargin||D.topMargin||0;switch(k){case "auto":g=1;f=0;break;case "horizontal":g=1;f=0;break;case "vertical":g=0;f=1;break;default:g=1,f=0}m=43;r=0;q=$("#"+b);t=$("#"+b+"Menubar");0<t.length&&(t.isactive="visible"===t.closest(".JS9PluginContainer").css("visibility"));u=$("#"+b+"Toolbar");0<u.length&&(u.isactive="visible"===u.closest(".JS9PluginContainer").css("visibility"));v=$("#"+b+"Colorbar");0<v.length&&(v.isactive="visible"===
v.closest(".JS9PluginContainer").css("visibility"));0<q.length&&(p=q.width(),w=q.height(),x=q.offset().top-$(window).scrollTop(),A=q.offset().left-$(document).scrollLeft(),t.isactive&&(w+=t.height(),x-=t.height()),u.isactive&&(w+=u.height(),x-=u.height()),v.isactive&&(w+=v.height(),x-=v.height(),x+=7))},H=function(a,b){var c,d;a&&(0<q.length&&(c="",t.isactive&&(c+=sprintf("<div class='JS9Menubar' id='%sMenubar' data-width=%s></div>",b,q.width())),u.isactive&&(c+=sprintf("<div class='JS9Toolbar' id='%sToolbar' data-width=%s></div>",
b,q.width())),c+=sprintf("<div class='JS9' id='%s' data-width=%s data-height=%s></div>",b,q.width()-y,q.height()-y),v.isactive&&(c+=sprintf("<div style='margin-top: 2px;'><div class='JS9Colorbar' id='%sColorbar' data-width=%s></div></div>",b,q.width()))),"auto"===k&&A+p*(g+.5)>window.innerWidth&&(f++,g=0),d=sprintf("width=%s,height=%s,top=%s,left=%s,resize=1,scolling=1",p,w,x+(w+n+m)*f,A+(p+l+r)*g),"auto"===k||"horizontal"===k?g++:"vertical"===k&&f++);return{id:b,html:c,winopts:d}},G=function(f){var g,
k;g=e++;f.length>g?(g="number"===typeof f[g]?a.images[f[g]]:f[g])&&g.display===B?(g.displayImage("all"),void 0===c?(c=g.display.id,F(c,d),G(f)):(b="string"===typeof d.idbase?k=d.idbase+h++:c.replace(C,"")+"_sep"+a.uniqueID(),z[b]=g,$("#dhtmlwindowholder").arrive("#"+b,{onceOnly:!0},function(){k=$(this).attr("id");window.setTimeout(function(){z[k].moveToDisplay(k);G(f)},0)}),g=H(c,b),k&&(g.id=k),a.LoadWindow(null,{id:g.id},"light",g.html,g.winopts))):G(f):a.globalOpts.extendedPlugins&&B.image&&B.image.xeqPlugins("image",
"onseparatedisplay")};if("string"===typeof d)try{d=JSON.parse(d)}catch(E){a.error("can't parse separate opts: "+d,E)}d=d||{};G(d.images||a.images)};a.Display.prototype.nextImage=function(d){var c,b,e;d=d||1;if(this.image){e=this.image.pos;for(c=0;c<a.images.length&&this.image!==a.images[c];c++);for(b=c+d;b!==c&&(b>=a.images.length&&(b=0),0>b&&(b=a.images.length-1),a.images[b].display!==this);b+=d);c!==b&&(d=a.images[b],d.displayImage("all"),d.refreshLayers(),d.display.clearMessage(),e&&(e=d.displayToImagePos(e),
d.valpos=null,d.valpos=d.updateValpos(e,!0)));return this}};a.Display.prototype.loadSession=function(d,c){var b,e,f={},g=this,h=function(b){var c,d,h,k,l,n=function(){var c=this.canvas.getObjects();c&&"undefined"!==typeof c.length&&(b.layers[this.layerName].nshape=c.length+1);a.Fabric.updateChildren(this,null,"objects");b.refreshLayers()};l=f[b.file]||{};l.blend&&(b.blend=$.extend(!0,{},l.blend));l.tmp&&(b.tmp=$.extend(!0,{},l.tmp));l.wcsim&&(b.wcsim=a.lookupImage(l.wcsim));if(l.layers&&l.layers.length)for(c=
0;c<l.layers.length;c++)if(h=l.layers[c],k=h.name,!(0<=$.inArray("regions",b.params.disable)&&"regions"===k)&&"crosshair"!==k&&"grid"!==k&&(d=g.newShapeLayer(k,h.dopts),b.addShapes(k,[]),d.canvas.loadFromJSON(h.json,n.bind(d)),h.catalog&&(b.layers[k].catalog=h.catalog),h.starbase))try{b.layers[k].starbase=JSON.parse(h.starbase)}catch(p){}b.tmp&&"active"===b.tmp.gridStatus&&b.displayCoordGrid(!0);a.notNull(e)&&(--e,0===e&&a.images.sort(function(a,b){var c=0,d=0;f[a.file]&&(c=f[a.file].i);f[b.file]&&
(d=f[b.file].i);return c-d}));l.xeqstash&&b.xeqStashCall(l.xeqstash);a.globalOpts.extendedPlugins&&a.images[0].xeqPlugins("image","onsessionload")},k=function(d){d.file||a.error("session does not contain a filename");b=$.extend(!0,{},d);delete b.params.display;b.params.crosshair=!1;b.params.onload=h;d=b.file;b.sect&&(b.params.xcen=b.sect.xcen,b.params.ycen=b.sect.ycen,b.params.xdim=b.sect.xdim,b.params.ydim=b.sect.ydim,b.params.zoom=b.sect.zoom,delete b.sect);window.isElectron&&a.desktopOpts.sessionPath&&
...
{display:g});break;default:g[d]=b.display[d]}};c=c||{};a.waiting(!0,this);"object"===typeof d?l(d):$.ajax({url:d,cache:!1,dataType:"json",mimeType:"application/json",async:!1,success:function(a){l(a)},error:function(b,c,e){a.error("could not load session: "+d,e)}});return this};a.Display.prototype.displayMessage=function(a,c,b){};a.Display.prototype.clearMessage=function(a){};a.Display.prototype.createMosaic=function(d,c){var b,e,f,g,h=this,k=function(){var b;for(b=0;b<g.length;b++)a.vunlink(g[b])},
l=function(b,c){var d;0>c.search(/\[struct stat="OK"/)&&(a.waiting(!1),k(),(d=c.match(/msg="(.*)"/))&&d[1]?a.error(d[1]+" (from "+b+")"):a.error(c||"unknown "+b+" failure"))},n=function(b,c){var d;c=c||{};d=$.extend(!0,{},c);!1!==c.waiting&&a.waiting(!0,h);d.display=h.id;a.checkNew(new a.Image(b,d));a.waiting(!1)},m=function(b){for(var d=[],e=0;e<arguments.length;++e)d[e-0]=arguments[e];if(c.verbose||1<a.DEBUG)d=sprintf.apply(null,d),a.log(d)};c=c||{};c.reduce=c.reduce||a.globalOpts.reduceMosaic;
c.dim=c.dim||Math.max(a.globalOpts.image.xdim,a.globalOpts.image.ydim);if(d)if("string"===typeof d)if("current"===d)d=this.image?[this.image]:[];else if("all"===d)for(d=[],b=0;b<a.images.length;b++)a.images[b].display.id===h.id&&d.push(a.images[b]);else d=[d];else $.isArray(d)||a.error("unknown input type for createMosaic()");else d=this.image?[this.image]:[];d.length||a.error("no images specified for createMosaic()");for(b=0;b<d.length;b++)"string"===typeof d[b]&&((e=a.lookupImage(d[b]))?d[b]=e:
...
e=C.replace(/\.fits$/,"_area.fits");g=[h,v,u,t,w,x,A,z,e];e=sprintf("%s\n%s\n","|                                                    fname|","|                                                     char|");for(b=0;b<d.length;b++)e+=sprintf("%s\n",d[b].raw.hdu.fits.vfile);a.vfile(h,e);h=a.imgtbl(h,".",v,"-C");l("mImgtbl",h);a.vsize(v)||a.error("no image data found with which to construct a mosaic");h=a.makehdr(v,u,"");l("mMakeHdr",h);if("js9"===c.reduce){e=a.vread(u).split("\n");for(b=u=0;b<e.length;b++)switch(h=
e[b].split("="),h[0].trim()){case "NAXIS1":u=Math.max(u,parseFloat(h[1].trim()));break;case "NAXIS2":u=Math.max(u,parseFloat(h[1].trim()))}f=Math.max(1,Math.floor(u/c.dim+.5));e=sprintf("%s\n%s\n","|                                                    fname|","|                                                     char|");v=a.vread(v);v=v.trim().split("\n");v.splice(0,3);for(b=0;b<v.length;b++)h=v[b].trim().split(/\s+/),u=h[h.length-2],h=h[h.length-1],u&&h&&(p=sprintf("%s[%s]",h,u),u=sprintf("bin_%s_%s",
u,h.split("/").reverse()[0].replace(/\.(g|f)z$/,"")),g.push(u),h=sprintf("0@0,0@0,%s",f),m("bin %s [%s]",p,f),a.imsection(p,u,h,""),e+=sprintf("%s\n",u));a.vfile(t,e);h=a.imgtbl(t,".",w,"-C");l("mImgtbl",h);a.vsize(w)||a.error("no image data found to construct a mosaic");h=a.makehdr(w,z,"");l("mMakeHdr",h);v=a.vread(w)}else h=a.shrinkhdr(c.dim,u,z),l("mShrinkHdr",h),v=a.vread(v);v=v.trim().split("\n");v.splice(0,3);e=sprintf("%s\n%s\n","|                                                    fname|",
"|                                                     char|");for(b=0;b<v.length;b++)h=v[b].trim().split(/\s+/),u=h[h.length-2],h=h[h.length-1],u&&h&&(t="-a 1","shrink"===c.reduce&&(t+=sprintf(" -h %s",u)),t+=" "+a.globalOpts.reprojSwitches,w=sprintf("reproj_%s_%s",u,h.split("/").reverse()[0].replace(/\.(g|f)z$/,"")),e+=sprintf("%s\n",w),g.push(w),g.push(w.replace(/\.fits$/i,"_area.fits")),m("reproject: %s [%s] -> %s",h,u,w),h=a.reproject(h,w,z,t),l("mProjectPP",h));a.vfile(x,e);h=a.imgtbl(x,".",
A,"");l("mImgtbl",h);a.vsize(A)||a.error("no FITS files were added to output table for mosaic");m("create mosaic: %s",C);h=a.madd(A,z,C,"");l("mAdd",h);k();x=$.extend(!0,{},a.fits.options,c);x.image={xdim:0,ydim:0};x.file=C;a.fits.handleFITSFile(C,x,n)},a.SPINOUT);return this};a.Command=function(d){for(var c in d)d.hasOwnProperty(c)&&(this[c]=d[c]);d.name||a.error("command has no name");d.get||d.set||a.error("command requires get and/or set routine");a.commands.push(this);1<a.DEBUG&&a.log("JS9 command:  %s",
this.name)};a.Command.prototype.getDisplayInfo=function(a){a&&a.id&&(this.display=a,this.image=a.image);return this};a.Command.prototype.getWhich=function(a){return this.get&&!this.set?"get":this.set&&!this.get?"set":this.which?this.which(a):0===a.length?"get":"set"};a.Helper=function(){"file:"===a.globalOpts.helperProtocol&&(a.globalOpts.helperProtocol="http:");document.domain&&"localhost"!==document.domain||(a.globalOpts.htimeout=a.globalOpts.lhtimeout);a.globalOpts.helperProtocol+="//";this.helper=
this.connected=!1;this.type=a.allinone&&!a.globalOpts.allinoneHelper?"none":a.globalOpts.helperType||"sock.io";this.pageid=null;this.connect()};a.Helper.prototype.connectinfo=function(){var d;return null===a.helper.connected?"notConfigured":a.helper.connected?(d=sprintf("connected %s %s",a.helper.type,a.helper.url),a.helper.pageid&&(d+="<p>"+a.helper.pageid),d):sprintf("notConnected %s",a.helper.type)};a.Helper.prototype.connect=function(d){var c=a.globalOpts.ehretries,b=a.globalOpts.ehtimeout,e=
this,f=function(b,c,d){e.connected=!1;e.helper=!1;e.ready=!0;$(document).trigger("JS9:helperReady",{type:"socket.io",status:"error"});c=c||"timeout";d&&"timeout"!==d||(d="or connection refused");d===c&&(c="");"error"===d&&(d="is the helper running?");a.globalOpts.requireHelper?a.error("helper connect error: "+c+" "+d):a.DEBUG&&a.log(sprintf("JS9 helper connect error: %s (%s)",c,d))},g=function(b){$.ajax({url:b,dataType:"script",timeout:a.globalOpts.htimeout,success:function(){var b={reconnection:!0,
reconnectionDelay:1E3,reconnectionDelayMax:1E4,reconnectionAttempts:100,timeout:a.globalOpts.htimeout};"undefined"===typeof io?f(null,"socket io object is undefined",null):(e.socket=io.connect(e.url,b),e.socket.on("connect",function(){var b,c;e.connected=!0;e.helper=!0;c=[];for(b=0;b<a.displays.length;b++)c.push(a.displays[b].id);e.socket.emit("initialize",{displays:c,pageid:e.pageid},function(b){e.pageid=b.pageid;e.js9helper=b.js9helper;a.globalOpts.dataPathModify=b.dataPathModify;e.ready=!0;$(document).trigger("JS9:helperReady",
...
g.length&&g.push(null),g.push(c),c=null);try{f=a.publics[h].apply(null,g)}catch(m){f=sprintf("ERROR: %s",m.message)}if(c){a.globalOpts.alerts=l;if(f instanceof a.Display||f instanceof a.Image)f=f.id;c(f)}return f}if(h&&"#"!==h){e=a.lookupCommand(h);b=a.lookupDisplay(k);if(e&&b)switch(e.getDisplayInfo(b),d.args?g=$.extend(!0,[],d.args):d.paramlist&&(g=d.paramlist.split(/ +/)),e.getWhich(g)){case "get":try{f=e.get(g)||""}catch(m){f="ERROR: "+m.message}break;case "set":try{f=e.set(g)||n}catch(m){f="ERROR: "+
m.message}break;default:f=sprintf("ERROR: unknown cmd type for '%s'",h)}else e||(f=sprintf("ERROR: unknown cmd '%s'",h)),b||(f=sprintf("ERROR: unknown display (%s)",k));if(c){a.globalOpts.alerts=l;if(f instanceof a.Display||f instanceof a.Image)f=f.id;c(f)}return f}c&&c("");c&&(a.globalOpts.alerts=l)};a.lightWin=function(d,c,b,e,f){var g;switch(a.LIGHTWIN){case "dhtml":g=dhtmlwindow.open(d,c,b,e,f),/iPad|iPhone|iPod/.test(navigator.platform)&&$("#"+d+" "+a.lightOpts.dhtml.drag).css("-webkit-overflow-scrolling",
...
g&&"SIMPLE"!==g&&"simple"!==g&&"BITPIX"!==g&&"bitpix"!==g){"END"===g&&(k=!0);if(g.match(/HISTORY__[0-9]+/))l+=sprintf("HISTORY %-72s",f[g]);else if(g.match(/COMMENT__[0-9]+/))l+=sprintf("COMMENT %-72s",f[g]);else{b=f[g];!0===b?b="T":!1===b?b="F":""===b?b="' '":a.isNumber(b)||"'"===b.charAt(0)||(b="'"+b+"'");e=sprintf("%-8s= %20s",g,b);h=80-e.length;if(0<h)for(b=0;b<h;b++)e+=" ";l+=e}c.addcr&&(l+="\n")}}k||(l+=sprintf("%-8s%-72s","END"," "),c.addcr&&(l+="\n"));return l};a.hdus2Str=function(a){var c,
...
alias:"run",help:"list/run analysis for current image",get:function(){var a,c,b,e,f,g="",h=this.image;if(h&&h.analysisPackages)for(c=0;c<h.analysisPackages.length;c++){f=h.analysisPackages[c];for(a=0;a<f.length;a++)e=f[a],g&&(g+=", "),b=e.xclass?e.xclass+":"+e.name:e.name,g+=sprintf("%s (%s)",e.title,b);c<h.analysisPackages.length-1&&(g+="\n")}return g},set:function(d){var c,b=this.image;b&&((c=b.lookupAnalysis(d[0]))?c.purl?(d=b.displayAnalysis("params",a.InstallDir(c.purl),{title:c.title+": "+b.fitsFile}),
$(d).data("dispid",b.display.id).data("aname",c.name)):b.runAnalysis(c.name):a.error("unknown analysis command '"+d[0]+"'"))}})),a.checkNew(new a.Command({name:"colormap",alias:"cmap",help:"set/get colormap for current image",get:function(){var a;if(a=this.image)return a=a.getColormap(),sprintf("%s %s %s",a.colormap,a.contrast,a.bias)},set:function(a){var c=this.image;c&&c.setColormap.apply(c,a)}})),a.checkNew(new a.Command({name:"colormaps",alias:"cmaps",help:"get list of available colormaps",get:function(){var d,
c="";for(d=0;d<a.colormaps.length;d++)c&&(c+=", "),c+=a.colormaps[d].name;return c}})),a.checkNew(new a.Command({name:"grid",help:"set/get coordinate grid for current image",get:function(){var a,c=this.image;c&&(a=c.displayCoordGrid());return a?"true":"false"},set:function(a){var c,b=this.image;b&&(c=a[0].match(/true/i)?!0:!1,b.displayCoordGrid(c,a[1]))}})),a.checkNew(new a.Command({name:"help",help:"get list of available commmands",get:function(){var d,c,b="<table>";for(d=0;d<a.commands.length;d++)c=
a.commands[d],b+="<tr><td>"+c.name+"</td><td>"+c.help,c.alias&&(b+=" ("+c.alias,c.alias2&&(b+=", "+c.alias2),b+=")"),b+="</td></tr>";return b+"</table>"}})),a.checkNew(new a.Command({name:"helper",help:"get/set helper connection",get:function(){return a.helper.connectinfo()},set:function(d){a.helper.connect(d[0].trim())}})),a.checkNew(new a.Command({name:"image",help:"get name of currently loaded image or display specified image",get:function(){var a=this.image;if(a)return a.file},set:function(d){var c,
b;for(c=0;c<a.images.length;c++)if(b=a.images[c],0<=b.file.search(d[0])&&b.display===this.display){b.displayImage("display");break}}})),a.checkNew(new a.Command({name:"images",help:"get list of currently loaded images",get:function(){var d,c,b="";for(d=0;d<a.images.length;d++)c=a.images[d],c.display===this.display&&(b&&(b+=", "),b+=c.file);return b}})),a.checkNew(new a.Command({name:"load",help:"load image(s)",set:function(d){var c,b,e,f=d.length;for(c=0;c<f;c++){e=null;b=c+1;if(b<f&&0===d[b].indexOf("{"))try{e=
JSON.parse(d[b])}catch(g){e=null}e?(a.Load(d[c],e,{display:this.display.id}),c++):a.Load(d[c],{display:this.display.id})}}})),a.checkNew(new a.Command({name:"pan",help:"set/get pan location for current image",get:function(){var a;if(a=this.image)return a=a.getPan(),sprintf("%s %s",a.x,a.y)},set:function(a){var c=this.image;c&&c.setPan.apply(c,a)}})),a.checkNew(new a.Command({name:"pix2wcs",help:"get image pixel value for specified wcs position",set:function(d){var c=this.image;if(c)return d=a.Pix2WCS(parseFloat(d[0]),
parseFloat(d[1]),{display:c}),d.str}})),a.checkNew(new a.Command({name:"print",help:"print image window",get:function(){var a=this.image;a&&a.print()}})),a.checkNew(new a.Command({name:"refresh",help:"refresh current image using specified file (def: use last file)",set:function(d){var c,b,e,f=d.length;c=this.image;if(0===f)e={refresh:c},a.Load(c.file,e,{display:this.display.id});else for(c=0;c<f;c++){e=null;b=c+1;if(b<f&&0===d[b].indexOf("{"))try{e=JSON.parse(d[b])}catch(g){e=null}e?(e.refresh=!0,
a.Load(d[c],e,{display:this.display.id}),c++):(e={refresh:!0},a.Load(d[c],e,{display:this.display.id}))}}})),a.checkNew(new a.Command({name:"regcnts",help:"counts in regions for current image",get:function(){var a=this.image;a&&a.countsInRegions("$sregions","$bregions",{lightwin:!0})},set:function(a){var c=this.image;if(c)return c.countsInRegions.apply(c,a)}})),a.checkNew(new a.Command({name:"regions",alias:"reg",alias2:"region",help:"add region to current image or list all regions",get:function(){var a=
this.image;if(a)return a.listRegions("all",{mode:0})||""},set:function(a){var c=this.image;c&&("delete"===a[0]||"remove"===a[0]?(a=a.slice(1).join(" "),c.removeShapes("regions",a)):(a=a.join(" "),c.addShapes("regions",a)))}})),a.checkNew(new a.Command({name:"resize",help:"get/set display size for current image",get:function(){var a;if(a=this.image)return a=a.display,sprintf("%s %s",a.width,a.height)},set:function(a){var c,b;(c=this.image)&&a.length&&(c=c.display,b=parseInt(a[0],10),a=1<a.length?parseInt(a[1],
10):b,c.resize(b,a))}})),a.checkNew(new a.Command({name:"scale",help:"set/get scaling for current image",get:function(){var a;if(a=this.image)return a=a.getScale(),sprintf("%s %s %s",a.scale,a.scalemin,a.scalemax)},set:function(a){var c=this.image;c&&c.setScale.apply(c,a)}})),a.checkNew(new a.Command({name:"scales",help:"get list of available scales",get:function(){return a.scales.join(", ")}})),a.checkNew(new a.Command({name:"section",help:"display section of current image",set:function(d){var c,
b=this.image;if(1===d.length&&"full"===d[0])b.displaySection("full");else{d=d.join(" ");try{c=JSON.parse(d)}catch(e){a.error("invalid JSON section")}b.displaySection(c)}}})),a.checkNew(new a.Command({name:"status",help:"get status for specified (or current) image",get:function(d){var c,b,e,f="";for(c=0;c<a.images.length;c++)if(b=a.images[c],0<=b.file.search(d[0])){e=b;break}e?c=1:(c=0,e=this.image);if(e){if(c>d.length)return e.status.load;for(;c<d.length;c++)switch(b=d[c].toLowerCase().trim(),b){case "load":f&&
(f+="\n"),f+=e.status.load}}return f}})),a.checkNew(new a.Command({name:"url",help:"display a url",set:function(d){a.DisplayHelp(d[0])}})),a.checkNew(new a.Command({name:"wcssys",help:"set/get wcs system for current image",get:function(){var a=this.image;if(a)return a.getWCSSys()},set:function(a){var c=this.image;c&&c.setWCSSys(a[0])}})),a.checkNew(new a.Command({name:"wcsu",help:"set/get wcs units used for current image",get:function(){var a=this.image;if(a)return a.getWCSUnits()},set:function(a){var c=
this.image;c&&c.setWCSUnits(a[0])}})),a.checkNew(new a.Command({name:"wcssystems",help:"get list of available wcs systems",get:function(){return a.wcssyss.join(", ")}})),a.checkNew(new a.Command({name:"wcsunits",help:"get list of available wcs units",get:function(){return a.wcsunitss.join(", ")}})),a.checkNew(new a.Command({name:"wcs2pix",help:"get wcs position for specified image pixel",set:function(d){var c=this.image;if(c)return d=a.WCS2Pix(parseFloat(d[0]),parseFloat(d[1]),{display:c}),d.str}})),
...
window.hasOwnProperty("JS9Prefs")&&"object"===typeof JS9Prefs&&JS9Prefs.globalOpts&&JS9Prefs.globalOpts.installDir&&(a.INSTALLDIR=JS9Prefs.globalOpts.installDir);if(!a.INSTALLDIR){try{$('link[href$="js9.css"]').each(function(){var c=$(this).attr("href");c&&"js9.css"===c.split("/").reverse()[0]&&(a.INSTALLDIR=c.replace(/js9\.css$/,""))})}catch(c){a.INSTALLDIR=""}a.INSTALLDIR&&(a.INSTALLDIR=a.cleanPath(a.INSTALLDIR))}a.INSTALLDIR&&"/"!==a.INSTALLDIR.slice(-1)&&(a.INSTALLDIR+="/");a.TOROOT=a.INSTALLDIR.replace(/([^/.])+/g,
...
null}if(d){try{a.userOpts.images=JSON.parse(d)}catch(c){}a.userOpts.images&&$.extend(!0,a.Grid.opts,a.userOpts.images)}try{d=localStorage.getItem("catalog")}catch(c){d=null}if(d){try{a.userOpts.images=JSON.parse(d)}catch(c){}a.userOpts.images&&$.extend(!0,a.Catalogs.Opts,a.userOpts.images)}}a.DEBUG=a.DEBUG||a.globalOpts.debug||0;$("div.JS9").each(function(){a.checkNew(new a.Display($(this)))});if(window.Worker&&!a.allinone)try{a.worker=new a.WebWorker(a.InstallDir(a.WORKERFILE))}catch(c){}a.allinone?
a.initFITS():a.initEmscripten();a.helper=new a.Helper;window.addEventListener("message",function(c){var b,d;b=c.origin||c.originalEvent.origin;c=c.data;"null"===b&&(b="unknown");if(a.globalOpts.postMessage){if("string"===typeof c)try{d=JSON.parse(c)}catch(f){a.error("can't parse msg: "+c,f)}else"object"===typeof c?d=c:a.error("invalid msg from postMessage");a.msgHandler(d,function(a,b,c,e){e=e||{};parent.postMessage({cmd:d.cmd,res:{name:e.name,rtype:e.rtype,rdata:a,stdout:a,stderr:b,errcode:c}},"*")})}else a.DEBUG&&
(b=sprintf("JS9 ignoring postMessage, origin: %s",b),b="string"===typeof c?b+sprintf(" data: %s",c):"object"===typeof c?b+sprintf(" obj: %s",JSON.stringify(Object.keys(c))):b+sprintf(" typeof: %s",typeof c),a.log(b))},!1);window.hasOwnProperty("ImageFilters")&&(a.ImageFilters=ImageFilters);a.initColormaps();a.initCommands();a.initAnalysis();a.RegisterPlugin(a.MouseTouch.CLASS,a.MouseTouch.NAME,a.MouseTouch.init,{menuItem:"Mouse/Touch",onplugindisplay:a.MouseTouch.init,help:"help/mousetouch.html",
...
n)}l(h);break;case 2:case 3:if("string"===typeof e)try{e=JSON.parse(e)}catch(n){a.error("can't parse JSON colormap",n)}a.checkNew(new a.Colormap(c,e));2===k.argv.length?a.globalOpts.topColormaps.push(c):"object"===typeof b&&!1===b.toplevel||a.globalOpts.topColormaps.push(c);break;case 4:case 5:if("string"===typeof e)try{e=JSON.parse(e)}catch(n){a.error("can't parse JSON colormap",n)}if("string"===typeof b)try{b=JSON.parse(b)}catch(n){a.error("can't parse JSON colormap",n)}if("string"===typeof f)try{f=
JSON.parse(f)}catch(n){a.error("can't parse JSON colormap",n)}a.checkNew(new a.Colormap(c,e,b,f));4===k.argv.length?a.globalOpts.topColormaps.push(c):g&&"object"===typeof g&&!1===g.toplevel||a.globalOpts.topColormaps.push(c);break;default:a.error("AddColormap() requires a colormap name and 1 or 3 args")}});a.mkPublic("LoadColormap",function(d){for(var c=[],b=0;b<arguments.length;++b)c[b-0]=arguments[b];var e,b=a.parsePublicArgs(c),c=b.argv[0];e=b.argv[1];c||a.error("JS9.LoadColormap: no file specified for colormap load");
"object"===typeof c?a.AddColormap(c,e):"string"===typeof c?(c=a.fixPath(c),a.fetchURL(null,c,null,function(b){a.AddColormap(b,e)})):a.error("unknown file type for LoadColormap: "+typeof c)});a.mkPublic("SetRGBMode",function(d){for(var c=[],b=0;b<arguments.length;++b)c[b-0]=arguments[b];var e,f,g=a.parsePublicArgs(c),h=["red","green","blue"],k=["rid","gid","bid"];e=g.argv[0];f=g.argv[1];void 0===e&&(e=!a.globalOpts.rgb.active);if(f)for(c=0;3>c;c++)b=f[k[c]],"string"===typeof b&&(b=a.LookupImage(b)),
b&&b.setColormap(h[c]);"true"===e?e=!0:"false"===e&&(e=!1);a.globalOpts.rgb.active=!!e;a.DisplayImage({display:g.display});return a.globalOpts.rgb.active});a.mkPublic("GetRGBMode",function(){return{active:a.globalOpts.rgb.active,rid:a.globalOpts.rgb.rim?a.globalOpts.rgb.rim.id:null,gid:a.globalOpts.rgb.gim?a.globalOpts.rgb.gim.id:null,bid:a.globalOpts.rgb.bim?a.globalOpts.rgb.bim.id:null}});a.mkPublic("SetValPos",function(d){for(var c=[],b=0;b<arguments.length;++b)c[b-0]=arguments[b];var e,b=null;
e=a.parsePublicArgs(c);c=a.getImage(e.display);e=e.argv[0];c&&(b=c.params.valpos,c.params.valpos=e);return b});a.mkPublic("SetImageInherit",function(d){for(var c=[],b=0;b<arguments.length;++b)c[b-0]=arguments[b];var e,b=null;e=a.parsePublicArgs(c);c=a.getImage(e.display);e=e.argv[0];c&&(b=c.params.inherit,c.params.inherit=e);return b});a.mkPublic("GetImageInherit",function(d){for(var c=[],b=0;b<arguments.length;++b)c[b-0]=arguments[b];b=null;c=a.parsePublicArgs(c);if(c=a.getImage(c.display))b=c.params.inherit;
return b});a.mkPublic("Load",function(d){for(var c=[],b=0;b<arguments.length;++b)c[b-0]=arguments[b];var e,f,g,h,k,b="fits";f=a.parsePublicArgs(c);k=f.argv[0];c=f.argv[1];if(k){f=f.display?f.display:0<a.displays.length?a.displays[0].id:a.DEFID;if("object"===typeof c)c=$.extend(!0,{},c);else if("string"===typeof c)try{c=JSON.parse(c)}catch(l){c={}}else c={};c.display=c.display||f;c.onload?g=c.onload:a.imageOpts.onload&&(g=a.imageOpts.onload,c.onload=g);if(k instanceof Blob){if(k.path||k.name)if(c.filename=
k.path||k.name,f="object"===typeof c.refresh?c.refresh:a.lookupImage(c.filename,c.display))if(a.isNull(c.refresh)&&(c.refresh=a.globalOpts.reloadRefresh),c.refresh)c.refresh=f;else{f.displayImage("display",c);f.refreshLayers();f.display.clearMessage();a.waiting(!1);return}else delete c.refresh;else delete c.refresh;c.filename||(c.filename=a.ANON+a.uniqueID());if(k.type&&-1!==k.type.indexOf("image/"))switch(k.type){case "image/fits":break;default:b="img"}else c.filename.split(".").pop().match(/(png|jpg|jpeg)/i)&&
(b="img");switch(b){case "fits":h=$.extend(!0,{},a.fits.options,c);k.path&&c.localAccess&&(g=a.localAccess(k.path))&&(k=k.path,h.file=k,h.vfile=g);try{a.handleFITSFile(k,h,a.NewFitsImage)}catch(l){a.error("can't process FITS file",l)}break;case "img":try{a.handleImageFile(k,c,a.Load)}catch(l){a.error("can't process IMG file",l)}}}else if("object"===typeof k)a.checkNew(new a.Image(k,c,g));else if("string"!==typeof k&&a.error("unknown file type for Load: "+typeof k),"U0lNUExFICA9"===k.slice(0,12)&&
(k=window.atob(k)),"SIMPLE  ="===k.slice(0,9)){g=[];for(e=0;e<k.length;e++)g[e]=k.charCodeAt(e);e=new Blob([new Uint8Array(g)]);c.filename||(c.filename=a.ANON+a.uniqueID());e.name=c.filename;h=$.extend(!0,{},a.fits.options,c);try{a.handleFITSFile(e,h,a.NewFitsImage)}catch(l){a.error("can't process FITS file",l)}}else{a.isNull(c.refresh)&&(c.refresh=a.globalOpts.reloadRefresh);if(c.refresh)if("object"===typeof c.refresh)f=c.refresh;else{if(b=k.split("/").reverse()[0],f=a.lookupImage(b,c.display))c.refresh=
f}else b=k.split("/").reverse()[0],f=a.lookupImage(b,c.display);f&&!c.refresh?(f.displayImage("all",c),f.display.clearMessage(),a.waiting(!1)):(k=a.cleanPath(k),"png"===k.split(".").pop().toLowerCase()?a.globalOpts.pngisfits?a.checkNew(new a.Image(k,c,g)):(k=a.fixPath(k,c),a.fetchURL(null,k,c,a.NewFitsImage)):a.fits2RepFile(c.display,k,c,"fits")||a.fits2RepFile(c.display,k,c,"png",g)||(c.display&&(e=a.lookupDisplay(c.display)),a.waiting(!0,e),f&&c.refresh&&a.cleanupFITSFile(f.raw,!0),k=a.fixPath(k,
c),e=k.replace(/\[.*\]/,""),(g=a.localAccess(k))?(h=$.extend(!0,{},a.fits.options,c),h.file=k,h.vfile=g,window.setTimeout(function(){try{a.handleFITSFile(k,h,a.NewFitsImage)}catch(l){a.error("can't process FITS file",l)}},0)):a.fetchURL(k,e,c)))}}else a.error("JS9.Load: no file specified for image load")});a.mkPublic("LoadWindow",function(d){for(var c=[],b=0;b<arguments.length;++b)c[b-0]=arguments[b];var e,f,g,h,k,l,n,m,r,q,t,u,v,p,w,x,A,z,C=a.lightOpts[a.LIGHTWIN];z=a.parsePublicArgs(c);var D=function(b){b=
$.inArray(b,a.displays);0<=b&&a.displays.splice(b,1)};l=function(b,c,d){var f,g;c=c||{};c.clone&&(g=a.lookupDisplay(c.clone,!1));d&&(v=d.match(/(.*width=)([0-9]+)(px,height=)([0-9]+)(px.*)/,"$1@@H@@$3"),p=parseInt(v[2],10),w=parseInt(v[4],10));f=sprintf("<hr class='hline0'>");!g||0<$("#"+c.clone+"Menubar").length&&!g.pluginInstances.JS9Menubar.isDynamic?f+=sprintf("<div class='JS9Menubar' id='%sMenubar'></div>",b):d&&(w-=40);f+=sprintf("<div class='JS9' id='%s'></div>",b);!g||0<$("#"+c.clone+"Colorbar").length&&
!g.pluginInstances.JS9Colorbar.isDynamic?(e=g&&g.pluginInstances.JS9Colorbar?sprintf("data-showTicks='%s'",g.pluginInstances.JS9Colorbar.showTicks):"",f+=sprintf("<div style='margin-top: 2px;'><div class='JS9Colorbar' id='%sColorbar' %s></div></div>",b,e),g&&g.pluginInstances.JS9Colorbar&&!g.pluginInstances.JS9Colorbar.showTicks&&(w-=15)):d&&(w-=44);return d?(a.Dysel.retrievePlugins().length&&(p+=2,w+=2),{html:f,winopts:v[1]+String(p)+v[3]+String(w)+v[5]}):f};k=function(b,c){var d;d=new a.Display(f);
d.winid=m;a.helper.send("addDisplay",{display:f});a.instantiatePlugins();c.display=f;b&&a.Load(b,c);return d};var y=function(b){var c,d;d=0;var e=[];for(c=0;c<a.images.length;c++)d=a.images[c],d.display.id===f&&e.push(d);if(!e.length)return D(b),!0;if("move"===a.globalOpts.lightWinClose){if(a.isNull(a.globalOpts.lightWinMoveTo)||a.globalOpts.lightWinMoveTo===f)d=0;else for(d=c=0;c<a.displays.length;c++)if(a.displays[c].id===a.globalOpts.lightWinMoveTo){d++;break}d||(a.globalOpts.lightWinClose="ask",
delete a.globalOpts.lightWinMoveTo)}switch(a.globalOpts.lightWinClose){case "close":D(b);for(c=0;c<e.length;c++)try{e[c].closeImage()}catch(E){}return!0;case "move":D(b);for(c=0;c<e.length;c++)try{e[c].moveToDisplay(a.globalOpts.lightWinMoveTo)}catch(E){}return!0;default:return r="lightCloseID"+a.uniqueID(),a.allinone?(q="inline",t=a.allinone.lightCloseHTML):(q="ajax",t=a.InstallDir(a.lightOpts.lcloseURL)),$("#dhtmlwindowholder").arrive("#lightWinCloseForm",{onceOnly:!0},function(){var b,c;c=$("#lightWinCloseForm").find("#lightWinCloseSel");
for(b=0;b<a.displays.length;b++)a.displays[b].id!==f&&c.append($("<option>",{value:a.displays[b].id,text:a.displays[b].id}))}),h=a.lightWin(r,q,t,"Closing a light window",C.lcloseWin),$(h).data("dispid",f),$(h).data("winid",m),!1}},b=z.argv[0];x=z.argv[1];A=z.argv[2];c=z.argv[3];z=z.argv[4];if("object"===typeof x)x=$.extend(!0,{},x);else if("string"===typeof x)try{x=JSON.parse(x)}catch(B){x={}}else x={};A=A||"light";u=(A||"")+"win";switch(A){case "light":return x.id?(f=x.id,delete x.id):f=u+a.uniqueID(),
h="d"+f,c?z=z||C.imageWin:(n=l(f,x,C.imageWin),c=n.html,z=z||n.winopts),n=sprintf("JS9 Display"+a.IDFMT,f),m=a.lightWin(h,"inline",c,n,z),g=k(b,x),m.onclose=function(){return y(g)},f;case "new":x.id?(f=x.id,delete x.id):f=u+a.uniqueID();z=z||sprintf("width=%s, height=%s",a.globalOpts.newWindowWidth,a.globalOpts.newWindowHeight);k=document.getElementsByTagName("head")[0].innerHTML;k=k.replace(/src=['"].*astroemw?\.js['"]/,"");k.match(/src=["'].*js9\.js/)||k.match(/src=["'].*js9\.min\.js/)||(k+=sprintf('<%s type="text/javascript" src="js9.min.js"></%s>',
...
return b});a.mkPublic("CopyFromClipboard",function(){return a.clipboard||""});a.mkPublic("OpenFileMenu",function(d){for(var c=[],b=0;b<arguments.length;++b)c[b-0]=arguments[b];c=a.parsePublicArgs(c);(c=a.lookupDisplay(c.display))&&$("#openLocalLoad-"+c.id).click()});a.mkPublic("OpenRegionsMenu",function(d){for(var c=[],b=0;b<arguments.length;++b)c[b-0]=arguments[b];c=a.parsePublicArgs(c);(c=a.lookupDisplay(c.display))&&$("#openLocalLoadRegions-"+c.id).click()});a.mkPublic("OpenSessionMenu",function(d){for(var c=
[],b=0;b<arguments.length;++b)c[b-0]=arguments[b];c=a.parsePublicArgs(c);(c=a.lookupDisplay(c.display))&&$("#openLocalLoadSession-"+c.id).click()});a.mkPublic("OpenCatalogsMenu",function(d){for(var c=[],b=0;b<arguments.length;++b)c[b-0]=arguments[b];c=a.parsePublicArgs(c);(c=a.lookupDisplay(c.display))&&$("#openLocalLoadCatalog-"+c.id).click()});a.mkPublic("OpenColormapMenu",function(d){for(var c=[],b=0;b<arguments.length;++b)c[b-0]=arguments[b];c=a.parsePublicArgs(c);(c=a.lookupDisplay(c.display))&&
$("#openLocalLoadColormap-"+c.id).click()});a.mkPublic("SaveColormap",function(d){for(var c=[],b=0;b<arguments.length;++b)c[b-0]=arguments[b];var e,f,g;f=a.parsePublicArgs(c);var c=f.argv[0],b=f.argv[1],h=function(a){var b=a;if("string"===typeof a)try{b=JSON.parse(a)}catch(m){}return b},k=function(b){var c,d,e=[];for(c=0;c<b.length;c++)if(d=a.lookupColormap(b[c]))d=$.extend(!0,{},d),delete d.type,e.push(d);return 1===e.length?e[0]:e};if(window.hasOwnProperty("saveAs")){if(f=a.getImage(f.display))c=
h(c),b=h(b),c?"string"===typeof c?(e=c,"string"===typeof b?g=k([b]):$.isArray(b)?g=k(b):(g=$.extend(!0,{},f.cmapObj),delete g.type)):$.isArray(c)&&(e="js9.cmap",g=k(c)):(e="js9.cmap",g=$.extend(!0,{},f.cmapObj),delete g.type),g=JSON.stringify(g),g=new Blob([g],{type:"text/plain"}),saveAs(g,e)}else a.error("no saveAs function available to save colormap");return e});a.mkPublic("NewFitsImage",function(d){for(var c=[],b=0;b<arguments.length;++b)c[b-0]=arguments[b];var e,f,g;f=a.parsePublicArgs(c);c=f.argv[0];
b=f.argv[1]||{};f=a.lookupDisplay(f.display||b.display||a.DEFID);b.refresh?("object"===typeof b.refresh?g=b.refresh:f&&f.image&&(g=f.image),g?(b.onload&&(b.onrefresh=b.onload,delete b.onload),g.refreshImage(c,b)):(b.onload&&(e=b.onload),a.checkNew(new a.Image(c,b,e)))):(b.onload&&(e=b.onload),a.checkNew(new a.Image(c,b,e)))});a.mkPublic("GetImage",function(d){for(var c=[],b=0;b<arguments.length;++b)c[b-0]=arguments[b];c=a.parsePublicArgs(c);(b=c.argv[0])&&"string"!==typeof b&&(b=c.display);return a.getImage(b)});
a.mkPublic("GetImageData",function(d){for(var c=[],b=0;b<arguments.length;++b)c[b-0]=arguments[b];b=a.parsePublicArgs(c);c=a.getImage(b.display);b=b.argv[0];return c?c.getImageData(b):null});a.mkPublic("GetDisplayData",function(d){for(var c=[],b=0;b<arguments.length;++b)c[b-0]=arguments[b];var e,f,g,b=[];e=a.parsePublicArgs(c);c=e.display||a.displays[0].id;g=e.argv[0];for(e=0;e<a.images.length;e++)f=a.images[e],f.display.id===c&&b.push(f.getImageData(g));return b});a.mkPublic("GetFITSHeader",function(d){for(var c=
[],b=0;b<arguments.length;++b)c[b-0]=arguments[b];var e,b="";e=a.parsePublicArgs(c);c=a.getImage(e.display);e=e.argv[0];c&&c.raw&&(b=a.raw2FITS(c.raw,{addcr:e}));return b});a.mkPublic("BlendDisplay",function(d){for(var c=[],b=0;b<arguments.length;++b)c[b-0]=arguments[b];var e,f,b=[];f=a.parsePublicArgs(c);c=f.display||a.DEFID;e=a.lookupDisplay(c);f=f.argv[0];e||a.error("no JS9 display found: "+c);if(void 0===f||"mode"===f)return e.blendMode;if("list"===f){for(e=0;e<a.images.length;e++)f=a.images[e],
f.display.id===c&&f.blend.active&&b.push(f.id);return b}"true"===f?f=!0:"false"===f&&(f=!1);e.blendMode=!!f;e.image&&(e.image.xeqPlugins("image","ondisplayblend"),e.image.displayImage());return e.blendMode});a.mkPublic("LoadAuxFile",function(d){for(var c=[],b=0;b<arguments.length;++b)c[b-0]=arguments[b];var e;e=a.parsePublicArgs(c);b=a.getImage(e.display);c=e.argv[0];e=e.argv[1];b?b.loadAuxFile(c,e):a.error("could not find image for aux file: "+c)});a.mkPublic("SubmitAnalysis",function(d){for(var c=
[],b=0;b<arguments.length;++b)c[b-0]=arguments[b];var e,f,g,h,c=a.parsePublicArgs(c);f=c.argv[0];var b=c.argv[1],k=c.argv[2];e=a.lightOpts[a.LIGHTWIN];b?e=a.lookupDisplay(c.display).id:(e=$(f).closest(e.top),b=e.data("aname"),e=e.data("dispid"));b?e&&(g=a.getImage(e)):h="internal error: could not find analysis task name";if(g){f=$(f).closest("form");try{c=f.serializeArray(),c=c.concat($("#"+f.attr("id")+" input[type=checkbox]:not(:checked)").map(function(){return{name:this.name,value:"false"}}).get())}catch(l){c=
null}g.runAnalysis(b,c,k)}else h="internal error: could not find image";h&&a.error(h);return!1});a.mkPublic("Send",function(d,c,b){a.helper.connected?a.helper.send(d,c,b):a.error("no JS9 helper available")});a.mkPublic("EventToDisplayPos",function(d){return a.eventToDisplayPos(d)});a.mkPublic("PixToWCS",function(d){for(var c=[],b=0;b<arguments.length;++b)c[b-0]=arguments[b];var e,f,b=1,g=a.parsePublicArgs(c);if(c=a.getImage(g.display))if(f=g.argv[0],"object"===typeof f&&a.notNull(f.x)&&a.notNull(f.y)?
(e=f.x,f=f.y):(e=g.argv[0],f=g.argv[1]),a.isNumber(e)&&a.isNumber(f)||a.error("invalid input for PixToWCS"),0<c.raw.wcs)return e=a.pix2wcs(c.raw.wcs,e,f).trim(),f=e.split(/ +/),"sexagesimal"===c.params.wcsunits&&"galactic"!==c.params.wcssys&&"ecliptic"!==c.params.wcssys&&(b=15),{ra:a.saostrtod(f[0])*b,dec:a.saostrtod(f[1]),sys:f[2],str:e}});a.Pix2WCS=a.PixToWCS;a.mkPublic("WCSToPix",function(d){for(var c=[],b=0;b<arguments.length;++b)c[b-0]=arguments[b];var e,f=a.parsePublicArgs(c);if(b=a.getImage(f.display))if(e=
f.argv[0],"object"===typeof e&&a.notNull(e.ra)&&a.notNull(e.dec)?(c=e.ra,e=e.dec):(c=f.argv[0],e=f.argv[1]),a.isNumber(c)&&a.isNumber(e)||a.error("invalid input for WCSToPix"),0<b.raw.wcs)return b=a.wcs2pix(b.raw.wcs,c,e).trim().split(/ +/),c=parseFloat(b[0]),e=parseFloat(b[1]),b=sprintf("%f %f",c,e),{x:c,y:e,str:b};return null});a.WCS2Pix=a.WCSToPix;a.mkPublic("NewShapeLayer",function(d){for(var c=[],b=0;b<arguments.length;++b)c[b-0]=arguments[b];var e;e=a.parsePublicArgs(c);b=a.getImage(e.display);
...
(c.removeShapes("regions",b),c.display.clearMessage("regions"),a.globalOpts.quietReturn?"":"OK"):null});a.mkPublic("CopyRegions",function(d){for(var c=[],b=0;b<arguments.length;++b)c[b-0]=arguments[b];var e=a.parsePublicArgs(c),c=a.getImage(e.display),b=e.argv[0],e=e.argv[1];return c?(c.copyRegions(b,e),a.globalOpts.quietReturn?"":"OK"):null});a.mkPublic("GetRegions",function(d){for(var c=[],b=0;b<arguments.length;++b)c[b-0]=arguments[b];c=a.parsePublicArgs(c);return(b=a.getImage(c.display))?(c.argv.unshift("regions"),
b.getShapes.apply(b,c.argv)):null});a.mkPublic("ChangeRegions",function(d){for(var c=[],b=0;b<arguments.length;++b)c[b-0]=arguments[b];var e=a.parsePublicArgs(c),c=a.getImage(e.display),b=e.argv[0],e=e.argv[1];c&&(b||a.error("no regions specified for ChangeRegions"),c.changeShapes("regions",b,e));return null});a.mkPublic("SaveRegions",function(d){for(var c=[],b=0;b<arguments.length;++b)c[b-0]=arguments[b];var e=a.parsePublicArgs(c),c=a.getImage(e.display),b=e.argv[0],f=e.argv[1],e=e.argv[2];return c?
c.saveRegions(b,f,e):null});a.mkPublic("EditRegionTags",function(d){for(var c=[],b=0;b<arguments.length;++b)c[b-0]=arguments[b];var e=a.parsePublicArgs(c),c=a.getImage(e.display),b=e.argv[0],f=e.argv[1],e=e.argv[2];return c?c.editRegionTags(b,f,e):null});a.mkPublic("ToggleRegionTags",function(d){for(var c=[],b=0;b<arguments.length;++b)c[b-0]=arguments[b];var e=a.parsePublicArgs(c),c=a.getImage(e.display),b=e.argv[0],f=e.argv[1],e=e.argv[2];return c?c.toggleRegionTags(b,f,e):null});a.mkPublic("UnremoveRegions",
function(d){for(var c=[],b=0;b<arguments.length;++b)c[b-0]=arguments[b];c=a.parsePublicArgs(c);return(c=a.getImage(c.display))?c.unremoveRegions():null});a.mkPublic("LoadRegions",function(d){for(var c=[],b=0;b<arguments.length;++b)c[b-0]=arguments[b];var e,b=a.parsePublicArgs(c),f=a.getImage(b.display),g=function(b,c){c&&void 0!==c.display&&delete c.display;if(a.globalOpts.reloadRefreshReg&&c.file)try{f.removeShapes("regions",c.file)}catch(l){}f.addShapes("regions",b,c);if(e&&e.onload)e.onload(f)},
c=b.argv[0];e=b.argv[1];c||a.error("JS9.LoadRegions: no file specified for regions load");if(f){if("object"===typeof e)e=$.extend(!0,{},e);else if("string"===typeof e)try{e=JSON.parse(e)}catch(h){e={}}else e={};if("object"===typeof c){if(b=c.path||c.name)e.file=b.split("/").reverse()[0];b=new FileReader;b.onload=function(a){g(a.target.result,e)};b.readAsText(c)}else"string"===typeof c?(e.responseType="text",c=a.fixPath(c),e.file=c.split("/").reverse()[0],a.fetchURL(null,c,e,g)):a.error("unknown file type for LoadRegions: "+
typeof c)}});a.mkPublic("InstallDir",function(d){return d?a.cleanPath(a.INSTALLDIR+d):""});a.mkPublic("AddDivs",function(d){for(var c=[],b=0;b<arguments.length;++b)c[b-0]=arguments[b];for(var e,f,g,h=a.parsePublicArgs(c),c=0;c<h.argv.length;c++)if(g=h.argv[c])if(0===$("#"+g).length)a.DEBUG&&a.log("warning: can't find div, skipping AddDivs(): %s",g);else{for(b=0;b<a.displays.length;b++)if(e=a.displays[b],e.id===g){f=!0;break}f?a.DEBUG&&a.log("warning: div already added, skipping AddDivs(): %s",g):
(a.checkNew(new a.Display(g)),a.helper.send("addDisplay",{display:g}))}a.instantiatePlugins()});a.mkPublic("InstantiatePlugins",function(){a.instantiatePlugins()});a.mkPublic("ResizeDisplay",function(d){for(var c=[],b=0;b<arguments.length;++b)c[b-0]=arguments[b];b=a.parsePublicArgs(c);"string"!==typeof b.argv[0]||a.isNumber(b.argv[0])||"full"===b.argv[0]||"reset"===b.argv[0]||"image"===b.argv[0]?c=a.lookupDisplay(b.display):(c=a.lookupDisplay(b.argv[0]||b.display),b.argv.splice(0,1));c||a.error("invalid display for resize");
b=a.Display.prototype.resize.apply(c,b.argv);return b===c?a.globalOpts.quietReturn?"":"OK":b});a.mkPublic("SelectDisplay",function(d){for(var c=[],b=0;b<arguments.length;++b)c[b-0]=arguments[b];c=a.parsePublicArgs(c);(c=a.lookupDisplay(c.argv[0]||c.display))||a.error("invalid display for select");a.hasOwnProperty("Menubar")||a.error("Menubar is required for display selection");a.Menubar.onclick(c)});a.mkPublic("GatherDisplay",function(d){for(var c=[],b=0;b<arguments.length;++b)c[b-0]=arguments[b];
var e,b=a.parsePublicArgs(c);switch(b.argv.length){case 0:c=b.display;e=null;break;case 1:"object"===typeof b.argv[0]||"string"===typeof b.argv[0]&&"{"===b.argv[0].charAt(0)?(c=b.display,e=b.argv[0]):c=b.argv[0]||b.display;break;default:c=b.argv[0]||b.display,e=b.argv[1]}(c=a.lookupDisplay(c))||a.error("invalid display for gather");c.gather(e)});a.mkPublic("SeparateDisplay",function(d){for(var c=[],b=0;b<arguments.length;++b)c[b-0]=arguments[b];var e,b=a.parsePublicArgs(c);switch(b.argv.length){case 0:c=
b.display;e=null;break;case 1:"object"===typeof b.argv[0]||"string"===typeof b.argv[0]&&"{"===b.argv[0].charAt(0)?(c=b.display,e=b.argv[0]):c=b.argv[0]||b.display;break;default:c=b.argv[0]||b.display,e=b.argv[1]}(c=a.lookupDisplay(c))||a.error("invalid display for separate");c.separate(c,e)});a.mkPublic("CenterDisplay",function(d){for(var c=[],b=0;b<arguments.length;++b)c[b-0]=arguments[b];c=a.parsePublicArgs(c);(c=a.lookupDisplay(c.argv[0]||c.display))||a.error("invalid display for center");c.center()});
a.mkPublic("SaveSession",function(d){for(var c=[],b=0;b<arguments.length;++b)c[b-0]=arguments[b];var e,f,b={},g=a.parsePublicArgs(c),c=g.argv[0];f=g.argv[1];if("object"===typeof c)b=$.extend(!0,{},c);else if("string"===typeof c)try{b=JSON.parse(c)}catch(h){if(e=c,f)if("object"===typeof f)b=$.extend(!0,{},f);else try{b=JSON.parse(f)}catch(k){b={}}}b.mode||(b.mode="display");c=a.lookupDisplay(g.display?g.display:b.display?b.display:0<a.displays.length?a.displays[0].id:a.DEFID);if(!c.image)return null;
e||(e="display"===b.mode?"js9-"+(new Date).toISOString().slice(0,10)+".ses":c.image.id+".ses");return c.image.saveSession(e,b)});a.mkPublic("LoadSession",function(d){for(var c=[],b=0;b<arguments.length;++b)c[b-0]=arguments[b];var e,f,g,c=a.parsePublicArgs(c);f=c.argv[0];g=c.argv[1];f||a.error("JS9.LoadSession: no file specified for load");if("object"===typeof g)g=$.extend(!0,{},g);else if("string"===typeof g)try{g=JSON.parse(g)}catch(h){g={}}else g={};e=a.lookupDisplay(c.display?c.display:g.display?
g.display:0<a.displays.length?a.displays[0].id:a.DEFID);g.display=e.id;"object"===typeof f?(c=new FileReader,c.onload=function(b){b=JSON.parse(b.target.result);g.sessionPath=a.dirname(f.path||f.name||"");e.loadSession(b,g)},c.readAsText(f)):"string"===typeof f?(g.responseType="text",g.display=e.id,f=a.fixPath(f),a.fetchURL(null,f,g,function(b,c){var d=JSON.parse(b);c.sessionPath=a.dirname(f);e.loadSession(d,c)})):a.error("unknown file type for LoadSession: "+typeof f)});a.mkPublic("SaveCatalog",function(d){for(var c=
[],b=0;b<arguments.length;++b)c[b-0]=arguments[b];var e=a.parsePublicArgs(c),c=a.getImage(e.display),b=e.argv[0],e=e.argv[1];if(c)return c.saveCatalog(b,e)});a.mkPublic("LoadCatalog",function(d){for(var c=[],b=0;b<arguments.length;++b)c[b-0]=arguments[b];var e,f,g,h,c=a.parsePublicArgs(c);f=c.argv[0];g=c.argv[1];h=c.argv[2];f instanceof Blob&&(h=g,g=f,f=null);g||a.error("JS9.LoadCatalog: no file specified for catalog load");if(e=a.getImage(c.display)){if("object"===typeof h)h=$.extend(!0,{},h);else if("string"===
...
typeof g)}});a.mkPublic("CreateMosaic",function(d){for(var c=[],b=0;b<arguments.length;++b)c[b-0]=arguments[b];var e=a.parsePublicArgs(c),c=a.lookupDisplay(e.display),b=e.argv[0],e=e.argv[1];if(c)return c.createMosaic(b,e)});a.mkPublic("DisplayPlugin",function(d){for(var c=[],b=0;b<arguments.length;++b)c[b-0]=arguments[b];var e,f,g,h;e=a.parsePublicArgs(c);b=a.lookupDisplay(e.display);c=e.argv[0];if(b&&e.argv[0]){h=c.toLowerCase();for(e=0;e<a.plugins.length;e++)if(f=a.plugins[e],g=f.name,g===c||g.toLowerCase().substr(-h.length)===
h){b.displayPlugin(f);return}a.error("can't find plugin: "+c)}});a.mkPublic("DisplayHelp",function(d){var c,b,e,f=a.lightOpts.dhtml.textWin;d&&(b=d.split("/").reverse()[0],c="help_"+a.uniqueID(),(e=a.helpOpts[d])?(d=a.InstallDir(e.type+"/"+e.url),a.lightWin(c,"iframe",d,e.title||b,f)):a.lightWin(c,"iframe",d,b,f))});a.mkPublic("LightWindow",function(d){for(var c=[],b=0;b<arguments.length;++b)c[b-0]=arguments[b];var e=a.parsePublicArgs(c),c=e.argv[0]||"lightWindow"+a.uniqueID(),b=e.argv[1]||"inline",
...
a.mkPublic("WindowToPDF",function(d){d=a.parsePublicArgs(d);var c={cmd:"pdf"};c.filename=d.argv[0]||"js9.pdf";d.argv[1]&&(c.opts=d.argv[1]);window.isElectron&&window.electronIPC?window.setTimeout(function(){try{window.electronIPC.send("msg",c)}catch(b){a.error("could not create window pdf",b)}},a.TIMEOUT):a.error("WindowToPDF is only available for the JS9 desktop app")});a.mkPublic("SaveDir",function(d){for(var c=[],b=0;b<arguments.length;++b)c[b-0]=arguments[b];var c=a.parsePublicArgs(c),e={cmd:"savedir"};
c.argv[0]?e.opts=c.argv[0]:a.error("SaveDir requires a directory name");window.isElectron&&window.electronIPC?window.setTimeout(function(){try{window.electronIPC.send("msg",e)}catch(f){a.error("could not set save directory",f)}},a.TIMEOUT):a.error("SaveDir is only available for the JS9 desktop app")});return a}();
