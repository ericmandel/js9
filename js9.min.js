...
b.oraw)f=this.raw;else if("current0"===b.oraw)f=this.raw.id===h?this.raw.current0:this.raw;else for(c=0;c<this.raws.length;c++)if(g=this.raws[c],b.oraw===g.id){f=g;break}f||(f=this.raws[0]);g=-1;for(c=0;c<this.raws.length;c++)if(h===this.raws[c].id){e=this.raws[c];g=c;break}if(0>g||b.alwaysCopy){e=$.extend(!0,{},f);e.current0=f;if(b.bitpix){switch(b.bitpix){case 8:e.data=new Uint8Array(f.height*f.width);break;case 16:e.data=new Int16Array(f.height*f.width);break;case -16:e.data=new Uint16Array(f.height*
f.width);break;case 32:e.data=new Int32Array(f.height*f.width);break;case -32:e.data=new Float32Array(f.height*f.width);break;case -64:e.data=new Float64Array(f.height*f.width)}k=e.width*e.height;for(c=0;c<k;c++)e.data[c]=f.data[c];e.bitpix=b.bitpix}else switch(f.bitpix){case 8:e.data=new Uint8Array(f.data);break;case 16:e.data=new Int16Array(f.data);break;case -16:e.data=new Uint16Array(f.data);break;case 32:e.data=new Int32Array(f.data);break;case -32:e.data=new Float32Array(f.data);break;case -64:e.data=
new Float64Array(f.data)}e.id=h;e.from=b.from||e.from||"func"}l.call(this,f,e,b)&&(0<=g?this.raws[g]=e:this.raws.push(e),this.raw=e,this.raw.header.bitpix&&(this.raw.bitpix=this.raw.header.bitpix),!1!==b.dataminmax&&this.dataminmax(),this.displayImage("all",b));return!0};a.Image.prototype.gaussBlurData=function(d){var c={};void 0===d&&a.error("missing sigma value for gaussBlurData");this.params.sigma=d;if("string"===typeof c)try{c=JSON.parse(c)}catch(b){a.error("can't parse gaussBlur opts: "+c,b)}c=
c||{};c.bitpix=-64===this.raw.bitpix?-64:-32;c.oraw="current0";c.alwaysCopy=!0;c.rawid=c.rawid||"gaussBlur";c.sigma=d;this.xeqStashSave("gaussBlurData",[d],c.rawid);this.rawDataLayer(c,function(b,c){var e;switch(c.bitpix){case -32:e=new Float32Array(c.data);break;case -64:e=new Float64Array(c.data);break;default:a.error("invalid temp bitpix for gaussBlur: "+c.bitpix)}gaussBlur(e,c.data,c.width,c.height,d);return!0});return this};a.Image.prototype.imarithData=function(d){for(var c=[],b=0;b<arguments.length;++b)c[b-
0]=arguments[b];var e=$jscomp.makeIterator(c),f=e.next().value,b=e.next().value,e=e.next().value;if(!c.length)return"add sub mul div min max reset".split(" ");if("string"===typeof e)try{e=JSON.parse(e)}catch(g){a.error("can't parse imarith opts: "+e,g)}e=e||{};e.rawid=e.rawid||"imarith";if("reset"===f||"remove"===f)this.rawDataLayer(e.rawid,"remove");else{void 0!==f&&void 0!==b||a.error("missing arg(s) for image arithmetic");this.xeqStashSave("imarithData",c,e.rawid);switch(f){case "add":case "sub":case "mul":case "div":case "min":case "max":e.op=
...
return this}};a.Image.prototype.shiftData=function(d){for(var c=[],b=0;b<arguments.length;++b)c[b-0]=arguments[b];var e=$jscomp.makeIterator(c),b=e.next().value,f=e.next().value,e=e.next().value;void 0!==b&&void 0!==f||a.error("missing translation value(s) for shiftData");if("string"===typeof e)try{e=JSON.parse(e)}catch(g){a.error("can't parse shift opts: "+e,g)}e=e||{};e.rawid=e.rawid||"shift";e.x=b;e.y=f;this.xeqStashSave("shiftData",c,e.rawid);this.rawDataLayer(e,function(a,b,c){var d,e,f,g,h=
a.data.BYTES_PER_ELEMENT;void 0===b.xoff&&(b.xoff=0);void 0===b.yoff&&(b.yoff=0);b.xoff+=c.x;b.yoff+=c.y;if(!c.fill||"clear"===c.fill)if(0<b.bitpix?(g=c.blank||b.header.BLANK||0,b.header.BLANK=g):g=NaN,"function"===typeof b.data.fill)b.data.fill(g);else for(c=0;c<b.data.length;c++)b.data[c]=g;for(c=0;c<a.height;c++)if(f=c+b.yoff,!(0>f||f>=a.height)){d=0;e=d+b.xoff;g=a.width;0>e&&(d-=e,g+=e,e=0);e+g>a.width&&(g-=e+g-a.width);if(0>=g)return!1;d=(c*a.width+d)*h;d=new Uint8Array(a.data.buffer,d,g*h);
e=(f*a.width+e)*h;g=new Uint8Array(b.data.buffer,e,g*h);g.set(d)}return!0});return this};a.Image.prototype.rotateData=function(d){for(var c=[],b=0;b<arguments.length;++b)c[b-0]=arguments[b];var e,f,g,h,k,l,n=b=0;e=$jscomp.makeIterator(c);h=e.next().value;var m=e.next().value;this.raws&&this.raws[0]||a.error("no raw data for reprojection");e=this.raws[0];e.header&&e.wcsinfo||a.error("no WCS info available for reprojection");if("string"===typeof m)try{m=JSON.parse(m)}catch(r){a.error("can't parse rotate opts: "+
m,r)}m=m||{};m.stash="rotateData";m.rawid="rotate";m.oraw=a.RAWID0;!0!==m.resetSection&&(m.resetSection=!1);f=e.header;g=$.extend(!0,{},f);e.width&&e.height&&(g.NAXIS1=e.width,g.NAXIS2=e.height);e.wcsinfo&&(b=e.wcsinfo.cdelt1||0,n=e.wcsinfo.cdelt2||0);if("string"===typeof h)switch(h.toLowerCase()){case "northisup":case "northup":h=0,0<b&&(b=-b),0>n&&(n=-n)}k=-(h*Math.PI/180);l=Math.sin(k);k=Math.cos(k);a.isNull(f.CD1_1)?(g.CROTA2=h,g.CDELT1=b,g.CDELT2=n):(g.CD1_1=b*k,g.CD1_2=-n*l,g.CD2_1=b*l,g.CD2_2=
n*k);e.wcsinfo&&(g.ptype=e.wcsinfo.ptype);this.xeqStashSave("rotateData",c,m.rawid);return this.reprojectData(g,m)};a.Image.prototype.reproject=function(d,c){var b,e,f,g,h,k,l,n,m,r,q,t,u,v,p,w,x,A,z=!1;k={};x=/SIMPLE|BITPIX|NAXIS|NAXIS[1-4]|AMDX|AMDY|CD[1-2]_[1-2]|CDELT[1-4]|CNPIX[1-4]|CO1_[1-9][0-9]|CO2_[1-9][0-9]|CROTA[1-4]|CRPIX[1-4]|CRVAL[1-4]|CTYPE[1-4]|CUNIT[1-4]|DATE|DATE_OBS|DC-FLAG|DEC|DETSEC|DETSIZE|EPOCH|EQUINOX|EQUINOX[a-z]|IMAGEH|IMAGEW|LATPOLE|LONGPOLE|MJD-OBS|PC00[1-4]00[1-4]|PC[1-4]_[1-4]|PIXSCALE|PIXSCAL[1-2]|PLTDECH|PLTDECM|PLTDECS|PLTDECSN|PLTRAH|PLTRAM|PLTRAS|PPO|PROJP[1-9]|PROJR0|PV[1-3]_[1-3]|PV[1-4]_[1-4]|RA|RADECSYS|SECPIX|SECPIX|SECPIX[1-2]|UT|UTMID|VELOCITY|VSOURCE|WCSAXES|WCSDEP|WCSDIM|WCSNAME|XPIXSIZE|YPIXSIZE|ZSOURCE|LTM|LTV/;
...
a.globalOpts.topColormaps.push(c):g&&"object"===typeof g&&!1===g.toplevel||a.globalOpts.topColormaps.push(c);break;default:a.error("AddColormap() requires a colormap name and 1 or 3 args")}});a.mkPublic("LoadColormap",function(d){for(var c=[],b=0;b<arguments.length;++b)c[b-0]=arguments[b];var e,b=a.parsePublicArgs(c),c=b.argv[0];e=b.argv[1];c||a.error("JS9.LoadColormap: no file specified for colormap load");"object"===typeof c?a.AddColormap(c,e):"string"===typeof c?(c=a.fixPath(c),a.fetchURL(null,
c,null,function(b){a.AddColormap(b,e)})):a.error("unknown file type for LoadColormap: "+typeof c)});a.mkPublic("SetRGBMode",function(d){for(var c=[],b=0;b<arguments.length;++b)c[b-0]=arguments[b];var e,f,g=a.parsePublicArgs(c),h=["red","green","blue"],k=["rid","gid","bid"];e=g.argv[0];f=g.argv[1];void 0===e&&(e=!a.globalOpts.rgb.active);if(f)for(c=0;3>c;c++)b=f[k[c]],"string"===typeof b&&(b=a.LookupImage(b)),b&&b.setColormap(h[c]);"true"===e?e=!0:"false"===e&&(e=!1);a.globalOpts.rgb.active=!!e;a.DisplayImage({display:g.display});
return a.globalOpts.rgb.active});a.mkPublic("GetRGBMode",function(){return{active:a.globalOpts.rgb.active,rid:a.globalOpts.rgb.rim?a.globalOpts.rgb.rim.id:null,gid:a.globalOpts.rgb.gim?a.globalOpts.rgb.gim.id:null,bid:a.globalOpts.rgb.bim?a.globalOpts.rgb.bim.id:null}});a.mkPublic("SetValPos",function(d){for(var c=[],b=0;b<arguments.length;++b)c[b-0]=arguments[b];var e,b=null;e=a.parsePublicArgs(c);c=a.getImage(e.display);e=e.argv[0];c&&(b=c.params.valpos,c.params.valpos=e);return b});a.mkPublic("SetImageInherit",
function(d){for(var c=[],b=0;b<arguments.length;++b)c[b-0]=arguments[b];var e,b=null;e=a.parsePublicArgs(c);c=a.getImage(e.display);e=e.argv[0];c&&(b=c.params.inherit,c.params.inherit=e);return b});a.mkPublic("GetImageInherit",function(d){for(var c=[],b=0;b<arguments.length;++b)c[b-0]=arguments[b];b=null;c=a.parsePublicArgs(c);if(c=a.getImage(c.display))b=c.params.inherit;return b});a.mkPublic("Load",function(d){for(var c=[],b=0;b<arguments.length;++b)c[b-0]=arguments[b];var e,f,g,h,k,b="fits";f=
a.parsePublicArgs(c);k=f.argv[0];c=f.argv[1];if(k){f=f.display?f.display:0<a.displays.length?a.displays[0].id:a.DEFID;if("object"===typeof c)c=$.extend(!0,{},c);else if("string"===typeof c)try{c=JSON.parse(c)}catch(l){c={}}else c={};c.display=c.display||f;c.onload?g=c.onload:a.imageOpts.onload&&(g=a.imageOpts.onload,c.onload=g);if(k instanceof Blob){if(k.path||k.name)if(c.filename=k.path||k.name,f="object"===typeof c.refresh?c.refresh:a.lookupImage(c.filename,c.display))if(a.isNull(c.refresh)&&(c.refresh=
a.globalOpts.reloadRefresh),c.refresh)c.refresh=f;else{f.displayImage("display",c);f.refreshLayers();f.display.clearMessage();a.waiting(!1);return}else delete c.refresh;else delete c.refresh;c.filename||(c.filename=a.ANON+a.uniqueID());if(k.type&&-1!==k.type.indexOf("image/"))switch(k.type){case "image/fits":break;default:b="img"}else c.filename.split(".").pop().match(/(png|jpg|jpeg)/i)&&(b="img");switch(b){case "fits":h=$.extend(!0,{},a.fits.options,c);k.path&&c.localAccess&&(g=a.localAccess(k.path))&&
...
c.filename||(c.filename=a.ANON+a.uniqueID());e.name=c.filename;h=$.extend(!0,{},a.fits.options,c);try{a.handleFITSFile(e,h,a.NewFitsImage)}catch(l){a.error("can't process FITS file",l)}}else{a.isNull(c.refresh)&&(c.refresh=a.globalOpts.reloadRefresh);if(c.refresh)if("object"===typeof c.refresh)f=c.refresh;else{if(b=k.split("/").reverse()[0],f=a.lookupImage(b,c.display))c.refresh=f}else b=k.split("/").reverse()[0],f=a.lookupImage(b,c.display);f&&!c.refresh?(f.displayImage("all",c),f.display.clearMessage(),
a.waiting(!1)):(k=a.cleanPath(k),"png"===k.split(".").pop().toLowerCase()?a.globalOpts.pngisfits?a.checkNew(new a.Image(k,c,g)):(k=a.fixPath(k,c),a.fetchURL(null,k,c,a.NewFitsImage)):a.fits2RepFile(c.display,k,c,"fits")||a.fits2RepFile(c.display,k,c,"png",g)||(c.display&&(e=a.lookupDisplay(c.display)),a.waiting(!0,e),f&&c.refresh&&a.cleanupFITSFile(f.raw,!0),k=a.fixPath(k,c),e=k.replace(/\[.*\]/,""),(g=a.localAccess(k))?(h=$.extend(!0,{},a.fits.options,c),h.file=k,h.vfile=g,window.setTimeout(function(){try{a.handleFITSFile(k,
h,a.NewFitsImage)}catch(l){a.error("can't process FITS file",l)}},0)):a.fetchURL(k,e,c)))}}else a.error("JS9.Load: no file specified for image load")});a.mkPublic("LoadWindow",function(d){for(var c=[],b=0;b<arguments.length;++b)c[b-0]=arguments[b];var e,f,g,h,k,l,n,m,r,q,t,u,v,p,w,x,A,z,C=a.lightOpts[a.LIGHTWIN];z=a.parsePublicArgs(c);var D=function(b){b=$.inArray(b,a.displays);0<=b&&a.displays.splice(b,1)};l=function(b,c,d){var f,g;c=c||{};c.clone&&(g=a.lookupDisplay(c.clone,!1));d&&(v=d.match(/(.*width=)([0-9]+)(px,height=)([0-9]+)(px.*)/,
"$1@@H@@$3"),p=parseInt(v[2],10),w=parseInt(v[4],10));f=sprintf("<hr class='hline0'>");!g||0<$("#"+c.clone+"Menubar").length&&!g.pluginInstances.JS9Menubar.isDynamic?f+=sprintf("<div class='JS9Menubar' id='%sMenubar'></div>",b):d&&(w-=40);f+=sprintf("<div class='JS9' id='%s'></div>",b);!g||0<$("#"+c.clone+"Colorbar").length&&!g.pluginInstances.JS9Colorbar.isDynamic?(e=g&&g.pluginInstances.JS9Colorbar?sprintf("data-showTicks='%s'",g.pluginInstances.JS9Colorbar.showTicks):"",f+=sprintf("<div style='margin-top: 2px;'><div class='JS9Colorbar' id='%sColorbar' %s></div></div>",
b,e),g&&g.pluginInstances.JS9Colorbar&&!g.pluginInstances.JS9Colorbar.showTicks&&(w-=15)):d&&(w-=44);return d?(a.Dysel.retrievePlugins().length&&(p+=2,w+=2),{html:f,winopts:v[1]+String(p)+v[3]+String(w)+v[5]}):f};k=function(b,c){var d;d=new a.Display(f);d.winid=m;a.helper.send("addDisplay",{display:f});a.instantiatePlugins();c.display=f;b&&a.Load(b,c);return d};var y=function(b){var c,d;d=0;var e=[];for(c=0;c<a.images.length;c++)d=a.images[c],d.display.id===f&&e.push(d);if(!e.length)return D(b),!0;
if("move"===a.globalOpts.lightWinClose){if(a.isNull(a.globalOpts.lightWinMoveTo)||a.globalOpts.lightWinMoveTo===f)d=0;else for(d=c=0;c<a.displays.length;c++)if(a.displays[c].id===a.globalOpts.lightWinMoveTo){d++;break}d||(a.globalOpts.lightWinClose="ask",delete a.globalOpts.lightWinMoveTo)}switch(a.globalOpts.lightWinClose){case "close":D(b);for(c=0;c<e.length;c++)try{e[c].closeImage()}catch(E){}return!0;case "move":D(b);for(c=0;c<e.length;c++)try{e[c].moveToDisplay(a.globalOpts.lightWinMoveTo)}catch(E){}return!0;
default:return r="lightCloseID"+a.uniqueID(),a.allinone?(q="inline",t=a.allinone.lightCloseHTML):(q="ajax",t=a.InstallDir(a.lightOpts.lcloseURL)),$("#dhtmlwindowholder").arrive("#lightWinCloseForm",{onceOnly:!0},function(){var b,c;c=$("#lightWinCloseForm").find("#lightWinCloseSel");for(b=0;b<a.displays.length;b++)a.displays[b].id!==f&&c.append($("<option>",{value:a.displays[b].id,text:a.displays[b].id}))}),h=a.lightWin(r,q,t,"Closing a light window",C.lcloseWin),$(h).data("dispid",f),$(h).data("winid",
m),!1}},b=z.argv[0];x=z.argv[1];A=z.argv[2];c=z.argv[3];z=z.argv[4];if("object"===typeof x)x=$.extend(!0,{},x);else if("string"===typeof x)try{x=JSON.parse(x)}catch(B){x={}}else x={};A=A||"light";u=(A||"")+"win";switch(A){case "light":return x.id?(f=x.id,delete x.id):f=u+a.uniqueID(),h="d"+f,c?z=z||C.imageWin:(n=l(f,x,C.imageWin),c=n.html,z=z||n.winopts),n=sprintf("JS9 Display"+a.IDFMT,f),m=a.lightWin(h,"inline",c,n,z),g=k(b,x),m.onclose=function(){return y(g)},f;case "new":x.id?(f=x.id,delete x.id):
f=u+a.uniqueID();z=z||sprintf("width=%s, height=%s",a.globalOpts.newWindowWidth,a.globalOpts.newWindowHeight);k=document.getElementsByTagName("head")[0].innerHTML;k=k.replace(/src=['"].*astroemw?\.js['"]/,"");k.match(/src=["'].*js9\.js/)||k.match(/src=["'].*js9\.min\.js/)||(k+=sprintf('<%s type="text/javascript" src="js9.min.js"></%s>',"script","script"));l=c||l(f,x);c=sprintf("<html><head>%s</head><body",k);b&&(c+=sprintf(" onload='JS9.Preload(\"%s\",%s);'",b,JSON.stringify(x)));c+=sprintf(">%s</body></html>\n",
...
(g=g.replace(/\/file\/d\/(\w+)\/\w+\?usp=sharing/,"/uc?export=download&id=$1"));k.display&&(f=a.lookupDisplay(k.display));if("object"===typeof h)h=$.extend(!0,{},h);else if("string"===typeof h)try{h=JSON.parse(h)}catch(l){h={}}else h={};a.waiting(!0,f);a.Send("loadproxy",{cmd:"js9Xeq loadproxy "+g},function(b){b="object"===typeof b?b:0<=b.search(a.analOpts.epattern)?{stderr:b}:{stdout:b};b.errcode=b.errcode||0;b.stderr?a.error(b.stderr):b.stdout?(void 0===h.fits2png&&(h.fits2png=!1),e=a.cleanPath(b.stdout),
h.proxyFile=e,"/"!==e.charAt(0)&&(e=a.InstallDir(e)),h.fixpath=!1,h.proxyURL=g,a.Load(e,h,{display:k.display})):a.error("internal error: no return from load proxy command")})});a.mkPublic("Preload",function(d){for(var c=[],b=0;b<arguments.length;++b)c[b-0]=arguments[b];var e,f,g,h,b="",k=null,l=null,n=c.length,m=a.globalOpts.alerts;f=a.parsePublicArgs(c);var r=a.URLEXP,q=/\.ses$/,t=/\.cmap$/;e=f.argv[0];a.globalOpts.loadProxy&&a.helper.baseurl&&(g=new RegExp("^"+a.helper.baseurl));f.display&&(l={display:f.display},
--n);switch(n){case 0:e=(null===a.helper.connected||a.helper.connected)&&a.fits.name&&0<a.preloads.length?2:3;break;case 1:e="boolean"===typeof e?e&&0<a.preloads.length?2:3:(null===a.helper.connected||a.helper.connected)&&a.fits.name?1:0;break;default:e=(null===a.helper.connected||a.helper.connected)&&a.fits.name?1:0}switch(e){case 0:for(e=0;e<n;e++)if(f=e+1,f<n&&"object"===typeof c[f])k=$.extend(!0,{},c[f]),a.preloads.push([c[e],k,l]),e++;else if(f<n&&0===c[f].indexOf("{")){try{k=JSON.parse(c[f])}catch(u){k=
null}a.preloads.push([c[e],k,l]);e++}else a.preloads.push([c[e],null,l]);break;case 1:a.globalOpts.alerts=!1;for(e=0;e<n;e++)if(h=g&&c[e].match(r)&&!c[e].match(g)?a.LoadProxy:c[e].match(q)?a.LoadSession:c[e].match(t)?a.LoadColormap:a.Load,f=e+1,f<n&&"object"===typeof c[f]){if(h===a.Load||h===a.LoadProxy)a.preloadwaiting[a.cleanPath(c[e])]=!0;try{l?h(c[e],c[f],l):h(c[e],c[f])}catch(u){b=b+" "+c[e]}e++}else if(f<n&&0===c[f].indexOf("{")){try{k=JSON.parse(c[f])}catch(u){k=null}if(h===a.Load||h===a.LoadProxy)a.preloadwaiting[a.cleanPath(c[e])]=
!0;try{l?h(c[e],k,l):h(c[e],k)}catch(u){b=b+" "+c[e]}e++}else{if(h===a.Load||h===a.LoadProxy)a.preloadwaiting[a.cleanPath(c[e])]=!0;try{l?h(c[e],null,l):h(c[e],null)}catch(u){b=b+" "+c[e]}}a.globalOpts.alerts=m;b&&a.error("could not preload image(s): "+b);break;case 2:a.globalOpts.alerts=!1;for(e=0;e<a.preloads.length;e++){h=g&&a.preloads[e][0].match(r)&&!a.preloads[e][0].match(g)?a.LoadProxy:a.preloads[e][0].match(q)?a.LoadSession:a.preloads[e][0].match(t)?a.LoadColormap:a.Load;if(h===a.Load||h===
a.LoadProxy)a.preloadwaiting[a.cleanPath(a.preloads[e][0])]=!0;try{a.preloads[e][2]?h(a.preloads[e][0],a.preloads[e][1],a.preloads[e][2]):h(a.preloads[e][0],a.preloads[e][1])}catch(u){b=b+" "+a.preloads[e][0]}}a.globalOpts.alerts=m;b&&a.error("could not preload image(s): "+b);a.preloads=[]}});a.mkPublic("RefreshImage",function(d){for(var c=[],b=0;b<arguments.length;++b)c[b-0]=arguments[b];var e,f=a.parsePublicArgs(c),g=a.getImage(f.display),h=function(a){g.refreshImage(a,e)},b=f.argv[0];e=f.argv[1]||
{};if(g)if(e.id=g.id,b instanceof Blob){e.rawid&&e.rawid!==g.raw.id||a.cleanupFITSFile(g.raw,!0);try{a.handleFITSFile(b,a.fits.options,h)}catch(k){a.error("can't refresh FITS file",k)}}else g.refreshImage(b,e);else b instanceof Blob&&a.Load.apply(a,[].concat($jscomp.arrayFromIterable(c)))});a.mkPublic("GetLoadStatus",function(d){for(var c=[],b=0;b<arguments.length;++b)c[b-0]=arguments[b];var e,f,b=a.parsePublicArgs(c),c=a.getImage(b.display),b=b.argv[0];return c?(b&&"object"===typeof b&&b.hasOwnProperty("id")&&
...
"none";f.style.background="transparent";f.value=d;document.body.appendChild(f);f.select();try{(e=document.execCommand("copy"))?b="OK":(b="MANUAL",a.BROWSER[2].match(/Mac/)?window.prompt("copy to clipboard: Cmd+C",d):window.prompt("copy to clipboard: Ctrl+C",d))}catch(g){b="ERROR"}document.body.removeChild(f);c&&c.display&&(c.display.divjq.trigger("mouseout"),c.display.divjq.trigger("mouseenter"));return b});a.mkPublic("CopyFromClipboard",function(){return a.clipboard||""});a.mkPublic("OpenFileMenu",
function(d){for(var c=[],b=0;b<arguments.length;++b)c[b-0]=arguments[b];c=a.parsePublicArgs(c);(c=a.lookupDisplay(c.display))&&$("#openLocalLoad-"+c.id).click()});a.mkPublic("OpenRegionsMenu",function(d){for(var c=[],b=0;b<arguments.length;++b)c[b-0]=arguments[b];c=a.parsePublicArgs(c);(c=a.lookupDisplay(c.display))&&$("#openLocalLoadRegions-"+c.id).click()});a.mkPublic("OpenSessionMenu",function(d){for(var c=[],b=0;b<arguments.length;++b)c[b-0]=arguments[b];c=a.parsePublicArgs(c);(c=a.lookupDisplay(c.display))&&
$("#openLocalLoadSession-"+c.id).click()});a.mkPublic("OpenCatalogsMenu",function(d){for(var c=[],b=0;b<arguments.length;++b)c[b-0]=arguments[b];c=a.parsePublicArgs(c);(c=a.lookupDisplay(c.display))&&$("#openLocalLoadCatalog-"+c.id).click()});a.mkPublic("OpenColormapMenu",function(d){for(var c=[],b=0;b<arguments.length;++b)c[b-0]=arguments[b];c=a.parsePublicArgs(c);(c=a.lookupDisplay(c.display))&&$("#openLocalLoadColormap-"+c.id).click()});a.mkPublic("SaveColormap",function(d){for(var c=[],b=0;b<
arguments.length;++b)c[b-0]=arguments[b];var e,f,g;f=a.parsePublicArgs(c);var c=f.argv[0],b=f.argv[1],h=function(a){var b=a;if("string"===typeof a)try{b=JSON.parse(a)}catch(m){}return b},k=function(b){var c,d,e=[];for(c=0;c<b.length;c++)if(d=a.lookupColormap(b[c]))d=$.extend(!0,{},d),delete d.type,e.push(d);return 1===e.length?e[0]:e};if(window.hasOwnProperty("saveAs")){if(f=a.getImage(f.display))c=h(c),b=h(b),c?"string"===typeof c?(e=c,"string"===typeof b?g=k([b]):$.isArray(b)?g=k(b):(g=$.extend(!0,
{},f.cmapObj),delete g.type)):$.isArray(c)&&(e="js9.cmap",g=k(c)):(e="js9.cmap",g=$.extend(!0,{},f.cmapObj),delete g.type),g=JSON.stringify(g),g=new Blob([g],{type:"text/plain"}),saveAs(g,e)}else a.error("no saveAs function available to save colormap");return e});a.mkPublic("NewFitsImage",function(d){for(var c=[],b=0;b<arguments.length;++b)c[b-0]=arguments[b];var e,f,g;f=a.parsePublicArgs(c);c=f.argv[0];b=f.argv[1]||{};f=a.lookupDisplay(f.display||b.display||a.DEFID);b.refresh?("object"===typeof b.refresh?
g=b.refresh:f&&f.image&&(g=f.image),g?(b.onload&&(b.onrefresh=b.onload,delete b.onload),g.refreshImage(c,b)):(b.onload&&(e=b.onload),a.checkNew(new a.Image(c,b,e)))):(b.onload&&(e=b.onload),a.checkNew(new a.Image(c,b,e)))});a.mkPublic("GetImage",function(d){for(var c=[],b=0;b<arguments.length;++b)c[b-0]=arguments[b];c=a.parsePublicArgs(c);(b=c.argv[0])&&"string"!==typeof b&&(b=c.display);return a.getImage(b)});a.mkPublic("GetImageData",function(d){for(var c=[],b=0;b<arguments.length;++b)c[b-0]=arguments[b];
b=a.parsePublicArgs(c);c=a.getImage(b.display);b=b.argv[0];return c?c.getImageData(b):null});a.mkPublic("GetDisplayData",function(d){for(var c=[],b=0;b<arguments.length;++b)c[b-0]=arguments[b];var e,f,g,b=[];e=a.parsePublicArgs(c);c=e.display||a.displays[0].id;g=e.argv[0];for(e=0;e<a.images.length;e++)f=a.images[e],f.display.id===c&&b.push(f.getImageData(g));return b});a.mkPublic("GetFITSHeader",function(d){for(var c=[],b=0;b<arguments.length;++b)c[b-0]=arguments[b];var e,b="";e=a.parsePublicArgs(c);
c=a.getImage(e.display);e=e.argv[0];c&&c.raw&&(b=a.raw2FITS(c.raw,{addcr:e}));return b});a.mkPublic("BlendDisplay",function(d){for(var c=[],b=0;b<arguments.length;++b)c[b-0]=arguments[b];var e,f,b=[];f=a.parsePublicArgs(c);c=f.display||a.DEFID;e=a.lookupDisplay(c);f=f.argv[0];e||a.error("no JS9 display found: "+c);if(void 0===f||"mode"===f)return e.blendMode;if("list"===f){for(e=0;e<a.images.length;e++)f=a.images[e],f.display.id===c&&f.blend.active&&b.push(f.id);return b}"true"===f?f=!0:"false"===
f&&(f=!1);e.blendMode=!!f;e.image&&(e.image.xeqPlugins("image","ondisplayblend"),e.image.displayImage());return e.blendMode});a.mkPublic("LoadAuxFile",function(d){for(var c=[],b=0;b<arguments.length;++b)c[b-0]=arguments[b];var e;e=a.parsePublicArgs(c);b=a.getImage(e.display);c=e.argv[0];e=e.argv[1];b?b.loadAuxFile(c,e):a.error("could not find image for aux file: "+c)});a.mkPublic("SubmitAnalysis",function(d){for(var c=[],b=0;b<arguments.length;++b)c[b-0]=arguments[b];var e,f,g,h,c=a.parsePublicArgs(c);
f=c.argv[0];var b=c.argv[1],k=c.argv[2];e=a.lightOpts[a.LIGHTWIN];b?e=a.lookupDisplay(c.display).id:(e=$(f).closest(e.top),b=e.data("aname"),e=e.data("dispid"));b?e&&(g=a.getImage(e)):h="internal error: could not find analysis task name";if(g){f=$(f).closest("form");try{c=f.serializeArray(),c=c.concat($("#"+f.attr("id")+" input[type=checkbox]:not(:checked)").map(function(){return{name:this.name,value:"false"}}).get())}catch(l){c=null}g.runAnalysis(b,c,k)}else h="internal error: could not find image";
h&&a.error(h);return!1});a.mkPublic("Send",function(d,c,b){a.helper.connected?a.helper.send(d,c,b):a.error("no JS9 helper available")});a.mkPublic("EventToDisplayPos",function(d){return a.eventToDisplayPos(d)});a.mkPublic("PixToWCS",function(d){for(var c=[],b=0;b<arguments.length;++b)c[b-0]=arguments[b];var e,f,b=1,g=a.parsePublicArgs(c);if(c=a.getImage(g.display))if(f=g.argv[0],"object"===typeof f&&a.notNull(f.x)&&a.notNull(f.y)?(e=f.x,f=f.y):(e=g.argv[0],f=g.argv[1]),a.isNumber(e)&&a.isNumber(f)||
a.error("invalid input for PixToWCS"),0<c.raw.wcs)return e=a.pix2wcs(c.raw.wcs,e,f).trim(),f=e.split(/ +/),"sexagesimal"===c.params.wcsunits&&"galactic"!==c.params.wcssys&&"ecliptic"!==c.params.wcssys&&(b=15),{ra:a.saostrtod(f[0])*b,dec:a.saostrtod(f[1]),sys:f[2],str:e}});a.Pix2WCS=a.PixToWCS;a.mkPublic("WCSToPix",function(d){for(var c=[],b=0;b<arguments.length;++b)c[b-0]=arguments[b];var e,f=a.parsePublicArgs(c);if(b=a.getImage(f.display))if(e=f.argv[0],"object"===typeof e&&a.notNull(e.ra)&&a.notNull(e.dec)?
...
null});a.mkPublic("AddRegions",function(d){for(var c=[],b=0;b<arguments.length;++b)c[b-0]=arguments[b];var e;e=a.parsePublicArgs(c);b=a.getImage(e.display);c=e.argv[0];e=e.argv[1];return b?(c||a.error("no region specified for AddRegions"),b.addShapes("regions",c,e)):null});a.mkPublic("RemoveRegions",function(d){for(var c=[],b=0;b<arguments.length;++b)c[b-0]=arguments[b];b=a.parsePublicArgs(c);c=a.getImage(b.display);b=b.argv[0];return c?(c.removeShapes("regions",b),c.display.clearMessage("regions"),
a.globalOpts.quietReturn?"":"OK"):null});a.mkPublic("CopyRegions",function(d){for(var c=[],b=0;b<arguments.length;++b)c[b-0]=arguments[b];var e=a.parsePublicArgs(c),c=a.getImage(e.display),b=e.argv[0],e=e.argv[1];return c?(c.copyRegions(b,e),a.globalOpts.quietReturn?"":"OK"):null});a.mkPublic("GetRegions",function(d){for(var c=[],b=0;b<arguments.length;++b)c[b-0]=arguments[b];c=a.parsePublicArgs(c);return(b=a.getImage(c.display))?(c.argv.unshift("regions"),b.getShapes.apply(b,[].concat($jscomp.arrayFromIterable(c.argv)))):
null});a.mkPublic("ChangeRegions",function(d){for(var c=[],b=0;b<arguments.length;++b)c[b-0]=arguments[b];var e=a.parsePublicArgs(c),c=a.getImage(e.display),b=e.argv[0],e=e.argv[1];c&&(b||a.error("no regions specified for ChangeRegions"),c.changeShapes("regions",b,e));return null});a.mkPublic("SaveRegions",function(d){for(var c=[],b=0;b<arguments.length;++b)c[b-0]=arguments[b];var e=a.parsePublicArgs(c),c=a.getImage(e.display),b=e.argv[0],f=e.argv[1],e=e.argv[2];return c?c.saveRegions(b,f,e):null});
a.mkPublic("EditRegionTags",function(d){for(var c=[],b=0;b<arguments.length;++b)c[b-0]=arguments[b];var e=a.parsePublicArgs(c),c=a.getImage(e.display),b=e.argv[0],f=e.argv[1],e=e.argv[2];return c?c.editRegionTags(b,f,e):null});a.mkPublic("ToggleRegionTags",function(d){for(var c=[],b=0;b<arguments.length;++b)c[b-0]=arguments[b];var e=a.parsePublicArgs(c),c=a.getImage(e.display),b=e.argv[0],f=e.argv[1],e=e.argv[2];return c?c.toggleRegionTags(b,f,e):null});a.mkPublic("UnremoveRegions",function(d){for(var c=
[],b=0;b<arguments.length;++b)c[b-0]=arguments[b];c=a.parsePublicArgs(c);return(c=a.getImage(c.display))?c.unremoveRegions():null});a.mkPublic("LoadRegions",function(d){for(var c=[],b=0;b<arguments.length;++b)c[b-0]=arguments[b];var e,b=a.parsePublicArgs(c),f=a.getImage(b.display),g=function(b,c){c&&void 0!==c.display&&delete c.display;if(a.globalOpts.reloadRefreshReg&&c.file)try{f.removeShapes("regions",c.file)}catch(l){}f.addShapes("regions",b,c);if(e&&e.onload)e.onload(f)},c=b.argv[0];e=b.argv[1];
