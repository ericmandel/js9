...
(a.params.parent||a.params.children.length)&&(g[a.params.id]=a)}),c.canvas.getObjects().forEach(function(a){if(a.params)for(a.params.parent&&(a.params.parent.obj=g[a.params.parent.id]),e=0;e<a.params.children.length;e++)a.params.children[e].obj=g[a.params.children[e].id]});else if("deltas"===d)b.params.parent&&(f=b.params.parent,f.dleft=f.obj.left-b.left,f.dtop=f.obj.top-b.top,f.moved=!0);else for(e=0;e<b.params.children.length;e++){h=b.params.children[e].obj;f=h.params.parent;switch(d){case "moving":h.left=
