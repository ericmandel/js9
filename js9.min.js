...
c.layers[b].canvas.clear();c.display.image=null}c.xeqPlugins("image","onimageclose");switch(c.cmapObj.name){case "red":a.globalOpts.rgb.rim=null;break;case "green":a.globalOpts.rgb.gim=null;break;case "blue":a.globalOpts.rgb.bim=null}if(a.fits.cleanupFITSFile)for(b=0;b<c.raws.length;b++)e=c.raws[b],e.hdu&&e.hdu.fits&&(f=a.lookupVfile(e.hdu.fits.vfile),1>=f.length&&a.fits.cleanupFITSFile(e.hdu.fits,!0));c.proxyFile&&a.Send("removeproxy",{cmd:"js9Xeq removeproxy "+c.proxyFile},j);c.rgb=null;c.offscreen=
null;c.raw=null;c.colorData=null;c.colorCells=null;c.psColors=null;c=c.psInverse=null;a.images.splice(d,1);break}if(g)for(d=0;d<a.images.length;d++)if(c=a.images[d],h===c.display){c.displayImage("all");c.refreshLayers();break}};a.Image.prototype.mkOffScreenCanvas=function(){if(!this.png||!this.png.image)return this;this.offscreen={};this.offscreen.canvas=document.createElement("canvas");this.offscreen.canvas.setAttribute("width",this.png.image.width);this.offscreen.canvas.setAttribute("height",this.png.image.height);
this.offscreen.context=this.offscreen.canvas.getContext("2d");a.ANTIALIAS||(this.offscreen.context.imageSmoothingEnabled=!1,this.offscreen.context.mozImageSmoothingEnabled=!1,this.offscreen.context.webkitImageSmoothingEnabled=!1,this.offscreen.context.msImageSmoothingEnabled=!1);this.offscreen.context.drawImage(this.png.image,0,0);try{this.offscreen.img=this.offscreen.context.getImageData(0,0,this.png.image.width,this.png.image.height)}catch(d){a.CHROMEFILEWARNING&&"Chrome"===a.BROWSER[0]&&""===document.domain?
alert("When using the file:// URI, Chrome must be run with the --allow-file-access-from-files switch to permit JS9 to access data."):alert("could not read off-screen image data [same-origin policy violation?]")}return this};a.Image.prototype.initLCS=function(a){var b=[[0,0,0],[0,0,0],[0,0,0]],c=function(a){var d,c,b=0,j=0,k=[[0,0,0],[0,0,0],[0,0,0]],m=a[0][0]*a[1][1];for(d=0;3>d;d++)for(c=0;2>c;c++)if(void 0===a[d][c]||isNaN(a[d][c]))return null;0<=m?b+=m:j+=m;m=-a[0][1]*a[1][0];0<=m?b+=m:j+=m;d=
...
j=!1:a.error("js9Endian missing from PNG-based FITS header");this.object=this.raw.header.OBJECT;b=this.raw.width*this.raw.height;f=c%4;switch(this.raw.bitpix){case 8:this.raw.data=new Uint8Array(b);for(d=0;d<b;d++){switch(f){case 0:g=e[c];c+=1;f=1;break;case 1:g=e[c];c+=1;f=2;break;case 2:g=e[c];c+=2;f=0;break;case 3:g=e[c+1],c+=2,f=1}this.raw.data[d]=g}break;case 16:case -16:16===this.raw.bitpix?(this.raw.data=new Int16Array(b),h=DataView.prototype.getInt16):(this.raw.data=new Uint16Array(b),h=DataView.prototype.getUint16);
for(d=0;d<b;d++){switch(f){case 0:k[0]=e[c];k[1]=e[c+1];g=h.call(m,0,j);c+=2;f=2;break;case 1:k[0]=e[c];k[1]=e[c+1];g=h.call(m,0,j);c+=3;f=0;break;case 2:k[0]=e[c];k[1]=e[c+2];g=h.call(m,0,j);c+=3;f=1;break;case 3:k[0]=e[c+1],k[1]=e[c+2],g=h.call(m,0,j),c+=3,f=2}this.raw.data[d]=g}break;case 32:case -32:32===this.raw.bitpix?(this.raw.data=new Int32Array(b),h=DataView.prototype.getInt32):(this.raw.data=new Float32Array(b),h=DataView.prototype.getFloat32);for(d=0;d<b;d++){switch(f){case 0:k[0]=e[c];
k[1]=e[c+1];k[2]=e[c+2];k[3]=e[c+4];g=h.call(m,0,j);c+=5;f=1;break;case 1:k[0]=e[c];k[1]=e[c+1];k[2]=e[c+3];k[3]=e[c+4];g=h.call(m,0,j);c+=5;f=2;break;case 2:k[0]=e[c];k[1]=e[c+2];k[2]=e[c+3];k[3]=e[c+4];g=h.call(m,0,j);c+=6;f=0;break;case 3:k[0]=e[c+1],k[1]=e[c+2],k[2]=e[c+3],k[3]=e[c+5],g=h.call(m,0,j),c+=6,f=1}this.raw.data[d]=g}break;case -64:this.raw.data=new Float64Array(b);for(d=0;d<b;d++){switch(f){case 0:case 4:k[0]=e[c];k[1]=e[c+1];k[2]=e[c+2];k[3]=e[c+4];k[4]=e[c+5];k[5]=e[c+6];k[6]=e[c+
8];k[7]=e[c+9];g=m.getFloat64(0,j);c+=10;f=2;break;case 1:case 5:k[0]=e[c];k[1]=e[c+1];k[2]=e[c+3];k[3]=e[c+4];k[4]=e[c+5];k[5]=e[c+7];k[6]=e[c+8];k[7]=e[c+9];g=m.getFloat64(0,j);c+=11;f=0;break;case 2:case 6:k[0]=e[c];k[1]=e[c+2];k[2]=e[c+3];k[3]=e[c+4];k[4]=e[c+6];k[5]=e[c+7];k[6]=e[c+8];k[7]=e[c+10];g=m.getFloat64(0,j);c+=11;f=1;break;case 3:case 7:k[0]=e[c+1],k[1]=e[c+2],k[2]=e[c+3],k[3]=e[c+5],k[4]=e[c+6],k[5]=e[c+7],k[6]=e[c+9],k[7]=e[c+10],g=m.getFloat64(0,j),c+=11,f=2}this.raw.data[d]=g}break;
...
0;c<f;c++)q[c]=0;for(c=0;c<k;c++)j[c]>=g&&j[c]<=n&&(e=Math.floor((j[c]-g)/b*f+0.5),e<f&&(q[e]+=1));for(c=0;c<f;c++)m+=q[c];e=m/f;for(c=j=0;c<f&&j<f;c++){this.hist[c]=j/f;for(d+=q[c];d>=e&&j<f;)d-=e,j++}for(d=(f-1)/f;c<f;)this.hist[c++]=d}for(c=0;c<l;c++)d=this.hist[c*f/l],d=Math.floor(d*h),this.psColors[c]=this.colorCells[d];for(c=0;c<p;c++){h=c/p;for(e=0;e<f-1&&!(this.hist[e]>h);e++);d=e/f;this.psInverse[c]=d*b+g}break;default:a.log("unknown scale '"+this.params.scale+"'")}return this};a.Image.prototype.mkRGBImage=
function(){var d,b,c,e,f,g,h,j,k,m,n,q,l,p,r,s,t,w,u,y,v=null,x=null,z=null,C=!1;if(!this.rgb)return this;if(a.globalOpts.rgb.active&&(this===a.globalOpts.rgb.rim||this===a.globalOpts.rgb.gim||this===a.globalOpts.rgb.bim))C=!0,a.globalOpts.rgb.rim&&(v=a.globalOpts.rgb.rim),a.globalOpts.rgb.gim&&(x=a.globalOpts.rgb.gim),a.globalOpts.rgb.bim&&(z=a.globalOpts.rgb.bim);h=this.display.context;d=this.rgb;b=d.sect;if(this.MakeRGBImage&&"function"===typeof this.MakeRGBImage&&this.MakeRGBImage()||this.MakePrimaryImage&&
"function"===typeof this.MakePrimaryImage&&this.MakePrimaryImage())return this;if(this.rgbFile){f=b.width/b.zoom;g=b.height/b.zoom;c=b.x0;e=this.offscreen.canvas.height-1-(b.y0+g);e=this.offscreen.context.getImageData(c,e,f,g);if(1===b.zoom)d.img=e;else{d.img=h.createImageData(b.width,b.height);d=d.img;for(m=j=0;j<e.height;j++,m++){s=j*e.width;q=m*b.zoom;for(k=h=0;h<e.width;h++,k++){c=4*(s+h);n=k*b.zoom;for(l=0;l<b.zoom;l++){p=Math.floor(q+l);t=p*b.width;for(p=0;p<b.zoom;p++)r=Math.floor(n+p),r=4*
(t+r),d.data[r]=e.data[c],d.data[r+1]=e.data[c+1],d.data[r+2]=e.data[c+2],d.data[r+3]=e.data[c+3]}}}}return this}if(!d.img||d.img.width!==b.width||d.img.height!==b.height)d.img=h.createImageData(b.width,b.height);d=d.img;if(!this.psColors)return this;w=void 0!==this.params.opacity?255*this.params.opacity:void 0!==this.params.alpha?this.params.alpha:255;this.maskData&&(this.params.maskInvert?void 0!==this.params.opacity&&void 0!==this.params.maskOpacity?(e=255*this.params.opacity,f=255*this.params.maskOpacity):
