...
e.style.outline="none";e.style.boxShadow="none";e.style.background="transparent";e.value=a;document.body.appendChild(e);e.select();try{(d=document.execCommand("copy"))?c="OK":(c="MANUAL",b.BROWSER[2].match(/Mac/)?window.prompt("copy to clipboard: Cmd+C",a):window.prompt("copy to clipboard: Ctrl+C",a))}catch(f){c="ERROR"}document.body.removeChild(e);b.clipboard=a;return c});b.mkPublic("CopyFromClipboard",function(){return b.clipboard||""});b.mkPublic("OpenFileMenu",function(){var a=b.parsePublicArgs(arguments);
(a=b.lookupDisplay(a.display))&&$("#openLocalLoad-"+a.id).click()});b.mkPublic("OpenRegionsMenu",function(){var a=b.parsePublicArgs(arguments);(a=b.lookupDisplay(a.display))&&$("#openLocalLoadRegions-"+a.id).click()});b.mkPublic("OpenSessionMenu",function(){var a=b.parsePublicArgs(arguments);(a=b.lookupDisplay(a.display))&&$("#openLocalLoadSession-"+a.id).click()});b.mkPublic("OpenCatalogsMenu",function(){var a=b.parsePublicArgs(arguments);(a=b.lookupDisplay(a.display))&&$("#openLocalLoadCatalog-"+
