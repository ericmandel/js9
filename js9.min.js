...
w=function(a){var c=$.contextMenu.getInputValues(a.data),d=g.display.image;switch(a.which||a.keyCode){case 9:case 13:u(d,c);a.data.edited=!1;break;default:a.data.edited=!0}};for(c=0;c<a.plugins.length;c++)if(d=a.plugins[c],f=d.name,d.opts.menuItem&&"analysis"===d.opts.menu&&(e=h.pluginInstances[f],!e||e.winHandle))d.xclass!==v&&(s["sep"+q++]="------",s["sep"+q++]={name:d.xclass+" Plugins:"},s["sep"+(q-1)].disabled=!0),v=d.xclass,s[f]={name:d.opts.menuItem},e&&"active"===e.status&&(s[f].icon="sun"),
...
type:"text"};s.dpath={name:"set data path ..."}}return{callback:function(c){b().forEach(function(d){var b,e,f;e=d.image;for(b=0;b<a.plugins.length;b++)if(f=a.plugins[b],f.name===c){d.displayPlugin(f);return}if(e)switch(c){case "dpath":$("#dhtmlwindowholder").arrive("#dataPathForm",{onceOnly:!0},function(){$("#dataPath").val(a.globalOpts.dataPath)});e=e.displayAnalysis("textline",a.InstallDir(a.analOpts.dpathURL),"Data Path for Drag and Drop");$(e).data("dispid",d.id);break;default:if(b=e.lookupAnalysis(c))b.purl?
(e=e.displayAnalysis("params",a.InstallDir(b.purl),b.title+": "+e.fitsFile),$(e).data("dispid",d.id).data("aname",b.name)):e.runAnalysis(b.name)}})},events:{show:function(c){var d=g.display.image,b={};d&&(b.sigma=String(d.params.sigma));$.contextMenu.setInputValues(c,b);a.jupyterFocus(".context-menu-item")},hide:function(a){var c=g.display.image;c&&a.edited&&(delete a.edited,a=$.contextMenu.getInputValues(a),u(c,a))}},items:s}}});$("#helpMenu"+g.id).on("mousedown",function(a){a.preventDefault();$("#helpMenu"+
