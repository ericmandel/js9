...
{},e);g.current0||(g.current0=e);if(d.bitpix){switch(d.bitpix){case 8:g.data=new Uint8Array(e.height*e.width);break;case 16:g.data=new Int16Array(e.height*e.width);break;case -16:g.data=new Uint16Array(e.height*e.width);break;case 32:g.data=new Int32Array(e.height*e.width);break;case -32:g.data=new Float32Array(e.height*e.width);break;case -64:g.data=new Float64Array(e.height*e.width)}j=g.width*g.height;for(c=0;c<j;c++)g.data[c]=e.data[c];g.bitpix=d.bitpix}else switch(e.bitpix){case 8:g.data=new Uint8Array(e.data);
break;case 16:g.data=new Int16Array(e.data);break;case -16:g.data=new Uint16Array(e.data);break;case 32:g.data=new Int32Array(e.data);break;case -32:g.data=new Float32Array(e.data);break;case -64:g.data=new Float64Array(e.data)}g.id=h;g.from=d.from||g.from||"func"}b.call(this,e,g,d)&&(0<=f?this.raws[f]=g:this.raws.push(g),this.raw=g,this.raw.header.bitpix&&(this.raw.bitpix=this.raw.header.bitpix),this.dataminmax(),this.displayImage("all",d));return!0};a.Image.prototype.gaussBlurData=function(d){var b=
{};void 0===d&&a.error("missing sigma value for gaussBlurData");b=b||{};b.bitpix=-64===this.raw.bitpix?-64:-32;b.oraw="current0";b.alwaysCopy=!0;b.rawid=b.rawid||"gaussBlur";b.sigma=d;this.rawDataLayer(b,function(c,b){var f;switch(b.bitpix){case -32:f=new Float32Array(b.data);break;case -64:f=new Float64Array(b.data);break;default:a.error("invalid temp bitpix for gaussBlur: "+b.bitpix)}gaussBlur(f,b.data,b.width,b.height,d);return!0});return this};a.Image.prototype.imarithData=function(d,b,c){var e;
...
function(d){var b=[],c,e,f,g,h,j,k,m,n,q,l,p=/(annulus)|(box)|(circle)|(ellipse)|(line)|(polygon)|(point)|(text)/,r=/(fk4)|(fk5)|(icrs)|(galactic)|(ecliptic)|(image)|(physical)/,s=/\(\s*([^)]+?)\s*\)/,t=/(\{[^}]*\})/,w=/\s*,\s*/,u=function(b){b=a.saostrtod(b);var d=String.fromCharCode(a.saodtype());switch(d){case '"':b/=3600;break;case "'":b/=60;break;case "r":b*=180/Math.PI}return{dval:b,dtype:d}},y=function(b,d){var c,e;e=u(b);c=u(d);if(":"===e.dtype||":"===c.dtype)n=!0;m||n?(":"===e.dtype&&("galactic"!==
