...
(this.raw.dmin=Math.min(this.raw.dmin,g),this.raw.dmax=Math.max(this.raw.dmax,g))}break;case 32:case -32:32===this.raw.bitpix?(this.raw.data=new Int32Array(b),h=DataView.prototype.getInt32):(this.raw.data=new Float32Array(b),h=DataView.prototype.getFloat32);for(d=0;d<b;d++){switch(f){case 0:j[0]=e[c];j[1]=e[c+1];j[2]=e[c+2];j[3]=e[c+4];g=h.call(m,0,l);c+=5;f=1;break;case 1:j[0]=e[c];j[1]=e[c+1];j[2]=e[c+3];j[3]=e[c+4];g=h.call(m,0,l);c+=5;f=2;break;case 2:j[0]=e[c];j[1]=e[c+2];j[2]=e[c+3];j[3]=e[c+
4];g=h.call(m,0,l);c+=6;f=0;break;case 3:j[0]=e[c+1],j[1]=e[c+2],j[2]=e[c+3],j[3]=e[c+5],g=h.call(m,0,l),c+=6,f=1}this.raw.data[d]=g;isNaN(g)||(this.raw.dmin=Math.min(this.raw.dmin,g),this.raw.dmax=Math.max(this.raw.dmax,g))}break;case -64:this.raw.data=new Float64Array(b);for(d=0;d<b;d++){switch(f){case 0:case 4:j[0]=e[c];j[1]=e[c+1];j[2]=e[c+2];j[3]=e[c+4];j[4]=e[c+5];j[5]=e[c+6];j[6]=e[c+8];j[7]=e[c+9];g=m.getFloat64(0,l);c+=10;f=2;break;case 1:case 5:j[0]=e[c];j[1]=e[c+1];j[2]=e[c+3];j[3]=e[c+
4];j[4]=e[c+5];j[5]=e[c+7];j[6]=e[c+8];j[7]=e[c+9];g=m.getFloat64(0,l);c+=11;f=0;break;case 2:case 6:j[0]=e[c];j[1]=e[c+2];j[2]=e[c+3];j[3]=e[c+4];j[4]=e[c+6];j[5]=e[c+7];j[6]=e[c+8];j[7]=e[c+10];g=m.getFloat64(0,l);c+=11;f=1;break;case 3:case 7:j[0]=e[c+1],j[1]=e[c+2],j[2]=e[c+3],j[3]=e[c+5],j[4]=e[c+6],j[5]=e[c+7],j[6]=e[c+9],j[7]=e[c+10],g=m.getFloat64(0,l),c+=11,f=2}this.raw.data[d]=g;isNaN(g)||(this.raw.dmin=Math.min(this.raw.dmin,g),this.raw.dmax=Math.max(this.raw.dmax,g))}break;default:a.error("unsupported bitpix in PNG file: "+
