...
get:function(){var c,b="";for(c=0;c<a.colormaps.length;c++)b&&(b+=", "),b+=a.colormaps[c].name;return b}})),a.checkNew(new a.Command({name:"grid",help:"set/get coordinate grid for current image",get:function(){var a,b=this.image;b&&(a=b.displayCoordGrid());return a?"true":"false"},set:function(a){var b=this.image;if(b){var c=a[0].match(/true/i)?!0:!1;b.displayCoordGrid(c,a[1])}}})),a.checkNew(new a.Command({name:"help",help:"get list of available commmands",get:function(){var c,b="<table class='JS9CmdHelp'>";
for(c=0;c<a.commands.length;c++){var d=a.commands[c];b+="<tr><td>"+d.name+"</td><td>"+d.help;d.alias&&(b+=" ("+d.alias,d.alias2&&(b+=", "+d.alias2),b+=")");b+="</td></tr>"}return b+'<tr><td colspan="2">&nbsp;</td></tr><tr><td colspan="2">Or execute JS9 public access routines (spaceless args, please):</td></tr><tr><td colspan="2">&nbsp;</td></tr><tr><td colspan="2">SetColormap heat</td></tr><tr><td colspan="2">GetColormap</td></tr><tr><td colspan="2">{"colormap":"heat","contrast":3.75,"bias":0.736328125}</td></tr><tr><td colspan="2">AddRegions circle(23:23:27.9,+58:48:42.8,3") {"color":"cyan"}</td></tr></table>'}})),
a.checkNew(new a.Command({name:"helper",help:"get/set helper connection",get:function(){return a.helper.connectinfo()},set:function(c){a.helper.connect(c[0].trim())}})),a.checkNew(new a.Command({name:"image",help:"get name of current image or display specified image",get:function(){var a=this.image;if(a)return a.file},set:function(c){var b;for(b=0;b<a.images.length;b++){var d=a.images[b];if(0<=d.file.search(c[0])&&d.display===this.display){d.displayImage("display");break}}}})),a.checkNew(new a.Command({name:"images",
...
b.removeShapes("regions",a)):(a=a.join(" "),b.addShapes("regions",a)))}})),a.checkNew(new a.Command({name:"resize",help:"get/set display size for current image",get:function(){var a;if(a=this.image)return a=a.display,a.width+" "+a.height},set:function(a){var b;if((b=this.image)&&a.length){b=b.display;var c=parseInt(a[0],10);a=1<a.length?parseInt(a[1],10):c;b.resize(c,a)}}})),a.checkNew(new a.Command({name:"scale",help:"set/get scaling for current image",get:function(){var a;if(a=this.image)return a=
...
"toggleShapeLayers");a.mkPublic("AddShapes","addShapes");a.mkPublic("RemoveShapes","removeShapes");a.mkPublic("GetShapes","getShapes");a.mkPublic("ChangeShapes","changeShapes");a.mkPublic("CopyShapes","copyShapes");a.mkPublic("DisplayCoordGrid","displayCoordGrid");a.mkPublic("Print","print");a.mkPublic("SavePNG","savePNG");a.mkPublic("SaveJPEG","saveJPEG");a.mkPublic("SaveFITS","saveFITS");a.mkPublic("UploadFITSFile","uploadFITSFile");a.mkPublic("CountsInRegions","countsInRegions");a.mkPublic("RadialProfile",
...
[],d=0;d<arguments.length;++d)b[d-0]=arguments[d];b=a.parsePublicArgs(b);return a.lookupImage(b.argv[0],b.display)});a.mkPublic("LookupDisplay",function(c){for(var b=[],d=0;d<arguments.length;++d)b[d-0]=arguments[d];b=a.parsePublicArgs(b);return a.lookupDisplay(b.argv[0]||b.display,b.argv[1])});a.mkPublic("DisplayNextImage",function(c){for(var b=[],d=0;d<arguments.length;++d)b[d-0]=arguments[d];d=a.parsePublicArgs(b);if(b=a.lookupDisplay(d.display))return d=parseFloat(d.argv[0])||1,b.nextImage(d)});
a.mkPublic("RenameDisplay",function(c){for(var b=[],d=0;d<arguments.length;++d)b[d-0]=arguments[d];var e;d=a.parsePublicArgs(b);switch(d.argv.length){case 0:return;case 1:b=d.display;d=d.argv[0];break;default:b=d.argv[0],d=d.argv[1]}(e=a.lookupDisplay(b))&&e.id&&(b=e.id,e.oid||(e.oid=b),e.id=d,a.helper.send("renameDisplay",{odisplay:b,ndisplay:e.id}))});a.mkPublic("CloseDisplay",function(c){for(var b=[],d=0;d<arguments.length;++d)b[d-0]=arguments[d];d=a.parsePublicArgs(b);b=a.lookupDisplay(d.argv[0],
!1);if(!b){b=a.lookupDisplay(d.display);var e=d.argv[0]}if(e=d.argv[1]||e)try{var f=new RegExp(e)}catch(h){a.error("invalid regexp for CloseDisplay: "+e)}for(e=a.images.length-1;0<=e;e--)d=a.images[e],d.display===b&&(f?(d.id.match(f)||d.file.match(f)||d.fitsFile.match(f))&&d.closeImage():d.closeImage())});a.mkPublic("AddColormap",function(c){for(var b=[],d=0;d<arguments.length;++d)b[d-0]=arguments[d];var e=a.parsePublicArgs(b),f=function(b,c){var d;"object"!==typeof b&&a.error("invalid colormap object for JS9.AddColormap()");
...
$("div.JS9").each(function(b,c){a.checkNew(new a.Display($(c)))});if(window.Worker&&!a.allinone)try{a.worker=new a.WebWorker(a.InstallDir(a.WORKERFILE))}catch(g){}a.allinone?a.initFITS():a.initEmscripten();window.isElectron&&window.electronHelper&&(a.globalOpts.helperType="nodejs");a.helper=new a.Helper;window.addEventListener("message",function(b){var c=b.origin||b.originalEvent.origin;b=b.data;"null"===c&&(c="unknown");if(a.globalOpts.postMessage){if("string"===typeof b)try{var d=JSON.parse(b)}catch(m){a.error("can't parse msg: "+
