...
0;b<a.images.length;b++)c=a.images[b],c.display.id===g&&d.push(c);for(b=0;b<d.length;b++)try{d[b].closeImage()}catch(p){}return!0},a.checkNew(new a.Display(g)),a.helper.send("addDisplay",{display:g}),a.instantiatePlugins(),b.display=g,c&&a.Load(c,b),g;case "new":b.id?(g=b.id,delete b.id):g=h+a.uniqueID();f=f||"width=540, height=605";d=document.getElementsByTagName("head")[0].innerHTML;d.match(/src=["'].*js9\.js/)||d.match(/src=["'].*js9\.min\.js/)||(d+=sprintf('<%s type="text/javascript" src="js9.min.js"></%s>',
"script","script"));h=e||sprintf("<div class='JS9Menubar' id='%sMenubar'></div><div class='JS9' id='%s'></div><div style='margin-top: 2px;'><div class='JS9Colorbar' id='%sColorbar'></div></div>",g,g,g);e=sprintf("<html><head>%s</head><body",d);c&&(e+=sprintf(" onload='JS9.Preload(\"%s\",%s);'",c,JSON.stringify(b)));e+=sprintf(">%s</body></html>\n",h);if(c=window.open("data:text/html,<html><body><script>window.addEventListener('message', function(ev){document.documentElement.innerHTML=ev.data\x3c/script><p></body></html>",
