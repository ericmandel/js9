...
if(v&&u||n(b,t,y))g.strokeDashArray=0===y.length?[]:y.map(function(a){return parseInt(a,10)});break;case "strokeWidth":if(v&&u||!v&&n(b,t,y))g[t]=p(u);break;case "tags":v?u&&(g[t]='""'===u||"''"===u?"":p(u)):n(b,t,u)&&(g[t]=p(u));break;case "childtext":"text"!==b.type&&n(b,t,u)&&(g.text=q(p(u)));break;case "ix":n(b,t,u)&&(b.pub.preservedcoords&&"d"===u.charAt(0).toLowerCase()?(g.dx=p(u.substring(1)),void 0===g.dy&&void 0!==b.pub.dy&&(g.dy=b.pub.dy)):(g.x=p(u),void 0===g.y&&void 0!==b.pub.y&&(g.y=
b.pub.y)));break;case "iy":n(b,t,u)&&(b.pub.preservedcoords&&"d"===u.charAt(0).toLowerCase()?(g.dy=p(u.substring(1)),void 0===g.dx&&void 0!==b.pub.dx&&(g.dx=b.pub.dx)):(g.y=p(u),void 0===g.x&&void 0!==b.pub.x&&(g.x=b.pub.x)));break;case "px":n(b,t,u)&&(g.px=p(u),void 0===g.py&&b.pub.lcs&&(g.py=b.pub.lcs.y));break;case "py":n(b,t,u)&&(g.py=p(u),void 0===g.px&&b.pub.lcs&&(g.px=b.pub.lcs.x));break;case "ra":n(b,t,u)&&(g.ra=u,void 0===g.dec&&(b.pub.wcsconfig.wcsposstr?g.dec=b.pub.wcsconfig.wcsposstr[1]:
