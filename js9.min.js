...
0;d<f;d++)c=d/f,b=10*c,c=Math.floor(Math.log(b+Math.sqrt(b*b+1))/3*e),c>=e&&(c=e-1),this.psColors[d]=this.colorCells[c];break;case "sinh":for(d=0;d<f;d++)c=d/f,b=3*c,c=Math.floor((Math.exp(b)-Math.exp(-b))/2/10*e),c>=e&&(c=e-1),this.psColors[d]=this.colorCells[c];break;default:a.log("unknown scale '"+this.params.scale+"'")}return this};a.Image.prototype.mkRGBImage=function(){var c,b,d,e,f,g,h,j,k,m,n,p,r,l,q,s,t,v,u,w,y=null,x=null,A=null,B=!1;if(!this.rgb)return this;if(a.globalOpts.rgb.active&&
...
l.imstr="line"===l.shape?l.imstr+(') {"sep":'+s(r)+',"units":"pix"}'):l.imstr+")";break;case "text":l.imstr="text("+s(k)+", "+s(m)+', "'+b.text+'")',l.text=b.text,h="text "+l.x+" "+l.y+' "'+b.text+'"'}if(this.wcs&&0<this.wcs){if("regions"===c&&!1!==f.dowcsstr||"regions"!==c&&!0===f.dowcsstr)l.wcsstr=a.reg2wcs(this.wcs,h).replace(/;$/,"");h=a.pix2wcs(this.wcs,p.x,p.y).trim().split(/\s+/);l.ra=h[0];l.dec=h[1];l.wcssys=h[2]}l.data=b.params.data;b.set("pub",l);b.params.winid&&($(b.params.winid).is(":visible")?
