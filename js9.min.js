...
this.binning.obin=this.binning.bin;this.rgb.sect.ozoom=this.rgb.sect.zoom};b.Image.prototype.imageToLogicalPos=function(a,b){var c,e,f,g,h,k=a.x;f=a.y;var l="image";b=b||this.params.lcs||"image";switch(b){case "physical":this.lcs.physical&&(l=b,c=this.lcs.physical.reverse,e=this.lcs.physical.rrot,g=this.lcs.physical.cx,h=this.lcs.physical.cy);break;case "detector":this.lcs.detector&&(l=b,c=this.lcs.detector.reverse,e=this.lcs.detector.rrot,g=this.lcs.detector.cx,h=this.lcs.detector.cy);break;case "amplifier":this.lcs.amplifier&&
(l=b,c=this.lcs.amplifier.reverse,e=this.lcs.amplifier.rrot,g=this.lcs.amplifier.cx,h=this.lcs.amplifier.cy)}c&&(k=a.x*c[0][0]+a.y*c[1][0]+c[2][0],f=a.x*c[0][1]+a.y*c[1][1]+c[2][1],e&&(c=g+(k-g)*e[0][0]+(f-h)*e[1][0]+e[2][0],f=h+(k-g)*e[0][1]+(f-h)*e[1][1]+e[2][1],k=c),"table"===this.imtab&&(e=0>this.raw.bitpix?.5:1,void 0!==this.raw.header.TABMIN1&&(k=k-e+this.raw.header.TABMIN1),void 0!==this.raw.header.TABMIN2&&(f=f-e+this.raw.header.TABMIN2)));return{x:k,y:f,sys:l}};b.Image.prototype.logicalToImagePos=
...
case "amplifier":this.lcs.amplifier&&(c=this.lcs.amplifier.forward,e=this.lcs.amplifier.frot)}c&&("table"===this.imtab&&(h=0>this.raw.bitpix?.5:1,void 0!==this.raw.header.TABMIN1&&(a.x=a.x-this.raw.header.TABMIN1+h),void 0!==this.raw.header.TABMIN2&&(a.y=a.y-this.raw.header.TABMIN2+h)),k.x=a.x*c[0][0]+a.y*c[1][0]+c[2][0],k.y=a.x*c[0][1]+a.y*c[1][1]+c[2][1],e&&(c=f+(k.x-f)*e[0][0]+(k.y-g)*e[1][0]+e[2][0],e=g+(k.x-f)*e[0][1]+(k.y-g)*e[1][1]+e[2][1],k.x=c,k.y=e));return k};b.Image.prototype.displayToImagePos=
...
b.fits.options.table.xdim;h=d.ydim||b.fits.options.image.ydim||b.fits.options.table.ydim;k=d.bin||b.fits.options.image.bin||b.fits.options.table.bin;l=d.binMode||b.globalOpts.binMode;l=l.match(/^[a0]/)?"a":"";m.sect=void 0!==d.xcen&&void 0!==d.ycen?sprintf("%s@%s,%s@%s,%s%s",e,d.xcen,h,d.ycen,k,l):sprintf("%s,%s,%s",e,h,k);e=g.toLowerCase().split(/[>,]/);for(g=0;g<e.length;g++)switch(e[g]){case "size":e[g+1]&&(b.isNumber(e[g+1])&&(m.maxsize=1E6*parseFloat(e[g+1])),g++)}break;default:b.error("unknown FITS representation type: "+
e)}m.fits=b.cleanPath(c);m.parent=!0;b.waiting(!0,a);b.helper.send(q,m,function(c){var e,g;c="object"===typeof c?c:0<=c.search(b.analOpts.epattern)?{stderr:c}:{stdout:c};c.stderr&&b.error(c.stderr,b.analOpts.epattern);if(c.stdout)switch(q){case "fits2png":c=c.stdout.replace(/\n*$/,"").split("\n").pop();e=c.split(".").pop().toLowerCase();"png"===e?(d.source="fits2png",b.checkNew(new b.Image(c,d,f))):b.error("fits2png conversion failed: "+c);break;case "fits2fits":g=c.stdout.split(/\n/);c=b.cleanPath(g[0]);
if(c===m.fits)e=$.extend(!0,{},d);else{"/"!==c.charAt(0)&&(c=b.InstallDir(c));e=$.extend(!0,{},d);delete e.xdim;delete e.ydim;delete e.bin;delete e.xcen;delete e.ycen;e.source="fits2fits";e.proxyFile=c;if(g[1]){try{n=JSON.parse(g[1])}catch(p){}n&&(e.extname=n.extname,e.extnum=n.extnum,e.hdus=n.hdus,e.parent=n)}g[2]&&(g=b.cleanPath(g[2]),e.parentFile=g,e.extname?(e.parentFile=e.parentFile.replace(/\[.*\]/,""),e.parentFile+=sprintf("[%s]",e.extname)):e.extnum&&0<e.extnum&&(e.parentFile=e.parentFile.replace(/\[.*\]/,
