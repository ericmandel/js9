...
c),b.Fabric.addPolygonAnchors(k.dlayer,c));b.resetPolygonCenter(c)}c.rescaleBorder();b.Fabric.updateChildren(k.dlayer,c,"moving");b.Fabric.updateChildren(k.dlayer,c,"scaling");b.Fabric.updateChildren(k.dlayer,c,"rotating");c.setCoords();b.Fabric._handleChildText.call(x,a,c,d);b.Fabric._updateShape.call(x,a,c,y,"update")});(void 0===d.redraw||d.redraw)&&l.renderAll();return this}};b.Fabric.refreshShapes=function(a){var c,d,e,f,g,h,k,l,n=!1,m=this,q=this.raw.wcs;if(l=this.getShapeLayer(a))return"main"===
