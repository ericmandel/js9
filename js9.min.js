...
(g=this.pluginInstances.JS9Colorbar)&&(g.divjq.attr("data-width",String(e)+"px"),a.Colorbar.init.call(g));0<=$.inArray("JS9Statusbar",a.globalOpts.resizeDivs)&&(a.isNull(d.resizeStatusbar)||d.resizeStatusbar)&&(g=this.pluginInstances.JS9Statusbar)&&($("#"+this.id+"Statusbar").css("width",e),g.statusBar.match(/\$colorbar/)&&!1!==d.resizeStatusbarColorbar&&(g.colorwidth=Math.max(g.colorwidth+c-m,a.Statusbar.COLORWIDTH),a.Statusbar.display.call(g,this.image,{reinit:!0})));for(f in this.layers)this.layers.hasOwnProperty(f)&&
