...
null}a.fits.cleanupFITSFile&&(b.raw.hdu&&b.raw.hdu.fits)&&a.fits.cleanupFITSFile(b.raw.hdu.fits,!0);b.primary=null;b.offscreen=null;b.raw=null;b.colorData=null;b.colorCells=null;b.psColors=null;a.images.splice(d,1);break}for(d=0;d<a.images.length;d++)if(b=a.images[d],h===b.display){b.displayImage("display");break}};a.Image.prototype.mkOffScreenCanvas=function(){if(!this.png||!this.png.image)return this;this.offscreen={};this.offscreen.canvas=document.createElement("canvas");this.offscreen.canvas.setAttribute("width",
...
0,this.png.image.width,this.png.image.height)}catch(d){"Chrome"===a.BROWSER[0]&&""===document.domain?alert("When using the file:// URI, Chrome must be run with the --allow-file-access-from-files switch to permit JS9 to access data."):alert("could not read JS9 data")}return this};a.Image.prototype.initLCS=function(a){var b=[[0,0,0],[0,0,0],[0,0,0]],c=function(a){var d,b,c=0,l=0,j=[[0,0,0],[0,0,0],[0,0,0]],m=a[0][0]*a[1][1];for(d=0;3>d;d++)for(b=0;2>b;b++)if(void 0===a[d][b]||isNaN(a[d][b]))return null;
0<=m?c+=m:l+=m;m=-a[0][1]*a[1][0];0<=m?c+=m:l+=m;d=c+l;if(0===d||1E-15>Math.abs(d/(c-l)))return null;d=1/d;j[0][0]=a[1][1]*d;j[1][0]=-a[1][0]*d;j[0][1]=-a[0][1]*d;j[1][1]=a[0][0]*d;j[2][0]=-(a[2][0]*j[0][0]+a[2][1]*j[1][0]);j[2][1]=-(a[2][0]*j[0][1]+a[2][1]*j[1][1]);return j};a&&(b[0][0]=a.LTM1_1||1,b[1][0]=a.LTM2_1||0,b[0][1]=a.LTM1_2||0,b[1][1]=a.LTM2_2||1,b[2][0]=a.LTV1||0,b[2][1]=a.LTV2||0,this.lcs.physical={forward:$.extend(!0,[],b),reverse:c(b)},this.lcs.physical.reverse||delete this.lcs.physical,
...
case 3:g=e[c+1],c+=2,f=1}this.raw.data[d]=g;isNaN(g)||(this.raw.dmin=Math.min(this.raw.dmin,g),this.raw.dmax=Math.max(this.raw.dmax,g))}break;case 16:case -16:16===this.raw.bitpix?(this.raw.data=new Int16Array(b),h=DataView.prototype.getInt16):(this.raw.data=new Uint16Array(b),h=DataView.prototype.getUint16);for(d=0;d<b;d++){switch(f){case 0:j[0]=e[c];j[1]=e[c+1];g=h.call(m,0,l);c+=2;f=2;break;case 1:j[0]=e[c];j[1]=e[c+1];g=h.call(m,0,l);c+=3;f=0;break;case 2:j[0]=e[c];j[1]=e[c+2];g=h.call(m,0,l);
c+=3;f=1;break;case 3:j[0]=e[c+1],j[1]=e[c+2],g=h.call(m,0,l),c+=3,f=2}this.raw.data[d]=g;isNaN(g)||(this.raw.dmin=Math.min(this.raw.dmin,g),this.raw.dmax=Math.max(this.raw.dmax,g))}break;case 32:case -32:32===this.raw.bitpix?(this.raw.data=new Int32Array(b),h=DataView.prototype.getInt32):(this.raw.data=new Float32Array(b),h=DataView.prototype.getFloat32);for(d=0;d<b;d++){switch(f){case 0:j[0]=e[c];j[1]=e[c+1];j[2]=e[c+2];j[3]=e[c+4];g=h.call(m,0,l);c+=5;f=1;break;case 1:j[0]=e[c];j[1]=e[c+1];j[2]=
e[c+3];j[3]=e[c+4];g=h.call(m,0,l);c+=5;f=2;break;case 2:j[0]=e[c];j[1]=e[c+2];j[2]=e[c+3];j[3]=e[c+4];g=h.call(m,0,l);c+=6;f=0;break;case 3:j[0]=e[c+1],j[1]=e[c+2],j[2]=e[c+3],j[3]=e[c+5],g=h.call(m,0,l),c+=6,f=1}this.raw.data[d]=g;isNaN(g)||(this.raw.dmin=Math.min(this.raw.dmin,g),this.raw.dmax=Math.max(this.raw.dmax,g))}break;case -64:this.raw.data=new Float64Array(b);for(d=0;d<b;d++){switch(f){case 0:case 4:j[0]=e[c];j[1]=e[c+1];j[2]=e[c+2];j[3]=e[c+4];j[4]=e[c+5];j[5]=e[c+6];j[6]=e[c+8];j[7]=
e[c+9];g=m.getFloat64(0,l);c+=10;f=2;break;case 1:case 5:j[0]=e[c];j[1]=e[c+1];j[2]=e[c+3];j[3]=e[c+4];j[4]=e[c+5];j[5]=e[c+7];j[6]=e[c+8];j[7]=e[c+9];g=m.getFloat64(0,l);c+=11;f=0;break;case 2:case 6:j[0]=e[c];j[1]=e[c+2];j[2]=e[c+3];j[3]=e[c+4];j[4]=e[c+6];j[5]=e[c+7];j[6]=e[c+8];j[7]=e[c+10];g=m.getFloat64(0,l);c+=11;f=1;break;case 3:case 7:j[0]=e[c+1],j[1]=e[c+2],j[2]=e[c+3],j[3]=e[c+5],j[4]=e[c+6],j[5]=e[c+7],j[6]=e[c+9],j[7]=e[c+10],g=m.getFloat64(0,l),c+=11,f=2}this.raw.data[d]=g;isNaN(g)||
...
(this.oid=this.file.split("/").reverse()[0],this.id=a.getImageID(this.oid,this.display.id));this.raw&&(c=this.raw.width,e=this.raw.height,f=this.raw.bitpix);this.raw={};this.raw.hdu=g;g.axis?(this.raw.width=g.axis[1],this.raw.height=g.axis[2]):g.naxis1&&g.naxis2?(this.raw.width=g.naxis1,this.raw.height=g.naxis2):c&&e&&(this.raw.width=c,this.raw.height=e);g.bitpix?this.raw.bitpix=g.bitpix:f&&(this.raw.bitpix=f);if("base64"===g.encoding){e=window.atob(g.image);g.image=new ArrayBuffer(e.length);f=new Uint8Array(g.image);
