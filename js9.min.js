...
"width=660px,height=200px,resize=1,scrolling=1",a.lightOpts.dhtml.regWin="width=660px,height=470px,resize=1,scrolling=1");window.hasOwnProperty("Jupyter")&&(a.globalOpts.useWasm=!1);if(window.electron&&("Chrome"===a.BROWSER[0]&&66<=parseFloat(a.BROWSER[1])&&(a.globalOpts.allowFileWasm=!0),window.electron.hostFS&&(a.hostFS=window.electron.hostFS),window.electron.multiElectron&&(a.globalOpts.localStorage=!1),window&&"function"===typeof window.eval&&(window.eval=function(){throw Error("For security reasons, Desktop JS9 does not support window.eval()");
