...
/11_2_(?:[2-9])/.test(navigator.userAgent)&&(b.globalOpts.useWasm=!1);window.hasOwnProperty("Jupyter")&&(b.globalOpts.useWasm=!1);b.BROWSER[3]&&(b.globalOpts.maxMemory=Math.min(b.globalOpts.maxMemory,35E7),b.globalOpts.image.xdim=4096,b.globalOpts.image.ydim=4096,b.REPROJDIM=1024,b.imageOpts.crosshair=!1);b.Image=function(a,c,d){var e,f,g,h=this,k=null,l=0,n=0,m=function(b,a){var c;c=1;var d=[];void 0!==a.bin&&(c="string"===typeof a.bin?parseInt(a.bin,10):a.bin);a&&void 0!==a.xcen&&d.push(a.xcen/
c);a&&void 0!==a.ycen&&d.push(a.ycen/c);a&&void 0!==a.zoom&&(c=b.parseZoom(a.zoom))&&d.push(c);return d},q=function(a){this.display.clearMessage();b.images.push(this);this.notifyHelper();k&&k.regions&&this.addShapes("regions",k.regions);this.xeqPlugins("image","onimageload");this.updateshapes&&this.updateShapes("regions","all","update");this.status.load="complete";b.waiting(!1);if(a)try{b.xeqByName(a,window,this)}catch(r){b.error("in image onload callback",r,!1)}};c&&("object"===typeof c?(k=c,k.display&&
...
q=$("#"+a+"Toolbar");0<q.length&&(q.isactive="visible"===q.closest(".JS9PluginContainer").css("visibility"));t=$("#"+a+"Colorbar");0<t.length&&(t.isactive="visible"===t.closest(".JS9PluginContainer").css("visibility"));0<n.length&&(r=n.width(),u=n.height(),p=n.offset().top-$(window).scrollTop(),x=n.offset().left-$(document).scrollLeft(),m.isactive&&(u+=m.height(),p-=m.height()),q.isactive&&(u+=q.height(),p-=q.height()),t.isactive&&(u+=t.height(),p-=t.height(),p+=7))},z=function(b,a){var c,d;b&&(0<
n.length&&(c="",m.isactive&&(c+=sprintf("<div class='JS9Menubar' id='%sMenubar' data-width=%s></div>",a,n.width())),q.isactive&&(c+=sprintf("<div class='JS9Toolbar' id='%sToolbar' data-width=%s></div>",a,n.width())),c+=sprintf("<div class='JS9' id='%s' data-width=%s data-height=%s></div>",a,n.width()-C,n.height()-C),t.isactive&&(c+=sprintf("<div style='margin-top: 2px;'><div class='JS9Colorbar' id='%sColorbar' data-width=%s></div></div>",a,n.width()))),"auto"===f&&x+r*(y+.5)>window.innerWidth&&(w++,
y=0),d=sprintf("width=%s,height=%s,top=%s,left=%s,resize=1,scolling=1",r,u,p+(u+h+k)*w,x+(r+g+l)*y),"auto"===f||"horizontal"===f?y++:"vertical"===f&&w++);return{id:a,html:c,winopts:d}},E=function(f,g){var h,k,l;f.length>g?(h="number"===typeof f[g]?b.images[f[g]]:f[g])&&h.display===c?(h.displayImage("all"),void 0===d?(d=h.display.id,D(d,a),E(f,g+1)):(e="string"===typeof a.idbase?l=a.idbase+v++:d.replace(A,"")+"_sep"+b.uniqueID(),$("#dhtmlwindowholder").arrive("#"+e,{onceOnly:!0},function(){window.setTimeout(function(){h.moveToDisplay(e);
