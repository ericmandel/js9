...
this.wcsiy=c.wcsim.iy+c.wcsim.raw.wcsinfo.crpix2-this.raw.wcsinfo.crpix2);a.notNull(c.opacity)||a.notNull(c.blend)?(e.save(),void 0!==c.opacity&&(e.globalAlpha=c.opacity),void 0!==c.blend&&(e.globalCompositeOperation=c.blend),e.drawImage(f(this,b.img),this.ix,this.iy),e.restore()):(this.params.wcsalign&&void 0!==this.wcsix&&void 0!==this.wcsiy&&(this.ix=this.wcsix,this.iy=this.wcsiy),e.putImageData(b.img,this.ix,this.iy));return this};a.Image.prototype.displayImage=function(c,b){var d,e,f;f=0;var g=
[],h={};if(!1===c)return this.displayMode=!1,this;!0===c&&(this.displayMode=!0,c="all");if(!this.displayMode)return this;"object"===typeof c&&(b=c,c=null);c?"all"===c?(c="colors,scaled,rgb,display,plugins",h.notify=!0):"rgbonly"===c?(c="rgb,nodisplay",h.notify=!0):"display"===c&&(h.notify=!0):c="rgb";c.split(",").forEach(function(a,b,c){a=a.trim();h[a]=!0;switch(a){case "colors":h.scaled=!0;h.rgb=!0;break;case "scaled":h.rgb=!0}});h.display=!0;h.plugins=!0;this.rgbFile&&(h.colors=!1,h.scaled=!1);
b=b||{};if(this.display.blendMode&&!1!==b.blendMode)for(d=0;d<a.images.length;d++)e=a.images[d],e.display===this.display&&e.blend.active&&(g.push(e),f++);h.colors&&(this.mkColorData(),this.offscreenRGB=null);h.scaled&&(this.mkColorCells(),this.mkScaledCells(),this.offscreenRGB=null);if(h.rgb&&(this.mkRGBImage(),this.offscreenRGB=null,f))for(d=g.length-1;0<=d;d--)e=g[d],e.mkRGBImage(),e.offscreenRGB=null;if(h.nodisplay)return this;if(h.display){this.display.context.clear();if(f)for(d=g.length-1;0<=
