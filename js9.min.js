...
if((h=t.exec(g))&&h[1])try{c.opts=JSON.parse(h[1].trim())}catch(B){c.opts={}}if((h=s.exec(g))&&h[1])c.args=h[1].split(u);h=c;k=h.args.length;if(h.isregion){g=$.extend(!0,{},h.opts);g.shape=h.cmd;2<=k&&(n=w.call(this,h.args[0],h.args[1]),g.x=n[0],g.y=n[1]);switch(h.cmd){case "annulus":g.radii=[];for(c=2;c<k;c++)g.radii.push(x.call(this,h.args[c],1));break;case "box":3<=k&&(g.width=x.call(this,h.args[2],1));4<=k&&(g.height=x.call(this,h.args[3],2));5<=k&&(g.angle=y.call(this,h.args[4]));break;case "circle":3<=
k&&(g.radius=x.call(this,h.args[2],1));break;case "ellipse":3<=k&&(g.r1=x.call(this,h.args[2],1));4<=k&&(g.r2=x.call(this,h.args[3],2));5<=k&&(g.angle=y.call(this,h.args[4]));break;case "polygon":g.pts=[];for(e=c=0;c<k;c+=2,e++)n=w.call(this,h.args[c],h.args[c+1]),g.pts[e]={x:n[0],y:n[1]};delete g.x;delete g.y;break;case "text":3<=k&&(c=g,e=h.args[2].replace(/^['"]/,"").replace(/['"]$/,""),c.text=e)}h.comment&&(g.tags=h.comment);b.push(g)}else h.cmd.match(p)&&(this.setWCSSys(h.cmd),j=this.getWCSSys(),
m="image"!==j&&"physical"!==j)}this.setWCSSys(l);return b};a.Regions.saveRegions=function(d){var b=sprintf("# Region file format: JS9 version 1.0");d=this.listRegions(d,1);b=sprintf("%s\n%s\n",b,d.replace(/; */g,"\n"));b=new Blob([b],{type:"text/plain;charset=utf-8"});window.hasOwnProperty("saveAs")?saveAs(b,"js9.reg"):a.error("no saveAs function available to save region file");return d};a.Regions.keyDownCB=function(a,b,c,e){var f,g;b={evt:c};var h=c.which||c.keyCode;e=e||"regions";g=a.display.layers[e].canvas;
switch(h){case 8:case 46:c.preventDefault();f="removeRegion";break;case 37:c.preventDefault();f="editRegion";b.dx=-1;break;case 38:c.preventDefault();f="editRegion";b.dy=1;break;case 39:c.preventDefault();f="editRegion";b.dx=1;break;case 40:c.preventDefault();f="editRegion";b.dy=-1;break;case 68:f="downRegion";break;case 85:f="upRegion"}switch(f){case "removeRegion":a.removeShapes(e,"selected");a.clearMessage(e);g.fire("mouse:up");break;case "editRegion":a.changeShapes(e,"selected",b);g.fire("mouse:up");
break;case "downRegion":a.selectShapes(e,"selected",function(a){g.sendToBack(a)});break;case "upRegion":a.selectShapes(e,"selected",function(a){g.bringToFront(a)})}};a.Magnifier={};a.Magnifier.CLASS="JS9";a.Magnifier.NAME="Magnifier";a.Magnifier.opts={originX:"left",originY:"top",hasControls:!1,hasRotatingPoint:!1,hasBorders:!1,selectable:!1,zoom:4,canvas:{selection:!1},tagcolors:{defcolor:"#00FF00"}};a.Magnifier.HTML="<span><button type='button' class='JS9Button' onClick='JS9.bcall(this, \"zoomMagnifier\", \"x2\"); return false'>x2</button><button type='button' class='JS9Button' onClick='JS9.bcall(this, \"zoomMagnifier\", \"/2\"); return false'>/2</button><button type='button' class='JS9Button' onClick='JS9.bcall(this, \"zoomMagnifier\", \""+
...
this.divjq)};a.Magnifier.display=function(d,b){var c,e,f,g,h,l,j,m,n,q,k,r;d&&(d.display.pluginInstances.JS9Magnifier&&"active"===d.display.pluginInstances.JS9Magnifier.status)&&(d.magnifier||(d.magnifier={zoom:a.Magnifier.opts.zoom,posx:0,posy:0}),e=d.display.pluginInstances.JS9Magnifier,g=d.display.canvas,f=d.magnifier.zoom,j=Math.floor(e.width/f),m=Math.floor(e.height/f),b?(c=d.imageToDisplayPos(b),h=c.x-j/2,l=c.y-m/2,d.magnifier.posx=h,d.magnifier.posy=l):(h=d.magnifier.posx,l=d.magnifier.posy),
q=n=0,k=e.canvas.width,r=e.canvas.height,0>h&&(j+=h,n-=h*f,k+=h*f,h=0),c=h+j-g.width,0<c&&(j-=c,k=j*f),0>l&&(m+=l,q-=l*f,r+=l*f,l=0),c=l+m-g.height,0<c&&(m-=c,r=m*f),e.context.clear(),e.context.drawImage(g,h,l,j,m,n,q,k,r),d.magnifier.boxid||(d.magnifier.boxid=d.addShapes("magnifier","box"),$(e.canvas).css("background-color","black")),g=e.width/2,e=e.height/2,d.changeShapes("magnifier",d.magnifier.boxid,{left:g,top:e,width:f,height:f}))};a.Magnifier.zoom=function(d,b){var c,e;if(d&&d.magnifier){c=
