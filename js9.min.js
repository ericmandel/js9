...
b){var d=this,e=0,f,g,h,k;if(g=this.getShapeLayer(c)){k=g.canvas;h=this.display.layers[c];if("show"===b||!0===b){"show"===b&&(g.show=!0);g.json&&g.show&&k.loadFromJSON(g.json,function(){var b,e,f;a.Fabric.updateChildren(g.dlayer,null,"objects");d.resize&&(k.getObjects().forEach(function(a){a.left+=d.resize.left;a.top+=d.resize.top;a.setCoords()}),k.calcOffset());d.layers[c].opts.panzoom?(d.binning.obin=d.binning.bin,d.refreshShapes(c)):k.renderAll();k.selection=g.opts.canvas.selection;g.zindex=Math.abs(g.zindex);
...
c.display.image&&c.display.image.updateShapes(c.layerName,h,"child")}};a.resetPolygonCenter=function(c){var b,d,e,f={};c._calcDimensions();d=(c.minX+c.width/2)*c.scaleX;b=(c.minY+c.height/2)*c.scaleY;c.angle?f=a.rotatePoint({x:c.left+d,y:c.top+b},c.angle,{x:c.left,y:c.top}):(f.x=c.left+d,f.y=c.top+b);if(5<=fabric.version.split(".")[1])for(d/=c.scaleX,e=b/c.scaleY,b=0;b<c.points.length;b++)c.points[b].x-=d,c.points[b].y-=e;c.left=f.x;c.top=f.y;c.setCoords()};a.Fabric.print=function(c){var b,d,e,f,
g,h,k=0,l=sprintf("width=%s,height=%s,menubar=1,toolbar=1,status=0,scrollbars=1,resizable=1",this.display.canvasjq.attr("width"),this.display.canvasjq.attr("height"));c=c||{};f=this.display.canvas.toDataURL("image/png");b="<html><body style='padding: 0px; margin: 0px' onload='window.print(); return false'>";g=sprintf("<div style='position:absolute; left:%spx; top:%spx'>",0,k);b+=sprintf("%s<img src='%s'></div>",g,f);for(d in this.layers)this.layers.hasOwnProperty(d)&&(f=this.layers[d],"main"===f.dlayer.dtype&&
f.show&&(b+=sprintf("%s%s</div>",g,f.dlayer.canvas.toSVG())));(void 0===c.colorbar||c.colorbar)&&(c=this.display.pluginInstances.JS9Colorbar)&&c.isActive()&&(k+=2,f=c.colorbarjq[0].toDataURL("image/png"),k+=this.display.height,g=sprintf("<div style='position:absolute; left:%spx; top:%spx'>",0,k),b+=sprintf("%s<img src='%s'></div>",g,f),c.textjq&&c.textjq[0]&&(f=c.textjq[0].toDataURL("image/png"),k+=c.colorbarjq.height()+1,g=sprintf("<div style='position:absolute; left:%spx; top:%spx'>",0,k),b+=sprintf("%s<img style='width:%spx;'src='%s'></div>",
g,this.display.width,f)));b+="</body></html>";window.isElectron&&(h="data:text/html,<html><body><script>window.addEventListener('message', function(ev){document.documentElement.innerHTML=ev.data; window.setTimeout(function(){window.print()}, 250);},false)\x3c/script><p>waiting for image ...</body></html>");(e=window.open(h,this.id,l))?e.document?(e.document.open(),e.document.write(b),e.document.close()):e.postMessage?window.setTimeout(function(){e.postMessage(b,"*")},250):a.error("no method available for drawing image into print window"):
...
"touch move, with three fingers:";a.MouseTouch.textHTML="<div style='float: left'>%s</div>";a.MouseTouch.actionHTML="<div style='float: left'><b>%s</b></div>";a.MouseTouch.actionid=function(a,b){return(a+"_"+b).replace(/[^A-Za-z0-9_]/g,"_")};a.MouseTouch.addText=function(c,b){var d;d=sprintf(a.MouseTouch.textHTML,b);return $("<div>").addClass(a.MouseTouch.BASE+"Text").html(d).appendTo(c)};a.MouseTouch.addAction=function(c,b,d){b=a.MouseTouch.actionid(b,d);d=sprintf(a.MouseTouch.actionHTML,d);return $("<div>").addClass(a.MouseTouch.BASE+
...
c&&b&&!(c.pos0&&c.pos&&Math.abs(c.pos0.x-c.pos.x)<a.NOMOVE&&Math.abs(c.pos0.y-c.pos.y)<a.NOMOVE||c.clickInRegion||a.specialKey(d)||c.rgbFile)&&(d=a.eventToDisplayPos(d,c.posOffset),b=Math.floor(d.x+.5),d=Math.floor(d.y+.5),a.globalOpts.containContrastBias&&(0>b||0>d||b>=e.canvas.width||d>=e.canvas.height)||(c.params.bias=b/e.canvas.width,c.params.contrast=d/e.canvas.height*10,a.bugs.firefox_linux?window.setTimeout(function(){c.displayImage("scaled",{blendMode:!1})},0):c.displayImage("scaled",{blendMode:!1}),
a.globalOpts.extendedPlugins&&c.xeqPlugins("image","onchangecontrastbias")))};a.MouseTouch.Actions["change contrast/bias"].stop=function(a,b,d){a.display.blendMode&&a.displayImage("rgb")};a.MouseTouch.Actions["wheel zoom"]=function(c,b){var d;c&&c.display.mousetouchZoom&&(d=0<b.originalEvent.deltaY?Math.min(a.MAXZOOM,c.getZoom()+a.ADDZOOM):Math.max(a.MINZOOM,c.getZoom()-a.ADDZOOM),d=Math.round(100*(d+1E-5))/100,c.setZoom(d))};a.MouseTouch.Actions["pan the image"]=function(a,b,d){a&&(b=a.rgb.sect.xcen+
(a.pos0.x-a.pos.x)/a.rgb.sect.zoom,a.setPan(b,a.rgb.sect.ycen-(a.pos0.y-a.pos.y)/a.rgb.sect.zoom),a.pos0=a.pos)};a.MouseTouch.Actions.pinch=function(c,b,d){c&&(b=c.display,d=b.zoom0*Math.sqrt((c.pos.touches[0].x-c.pos.touches[1].x)*(c.pos.touches[0].x-c.pos.touches[1].x)+(c.pos.touches[0].y-c.pos.touches[1].y)*(c.pos.touches[0].y-c.pos.touches[1].y))/b.dist0,d=Math.max(a.MINZOOM,Math.min(a.MAXZOOM,Math.round(100*(d+1E-5))/100)),d!==b.lastzoom&&c.setZoom(d),b.lastzoom=d)};a.MouseTouch.Actions.start=
...
break;case 1:d=e.mouseActions[1];break;case 2:d=e.mouseActions[2];break;case -1:d=e.touchActions[0];break;case -2:switch(a.MouseTouch.isPinch(c,b)){case -1:d=e.touchActions[1];break;case 1:d="pinch"}break;case -3:d=e.touchActions[2]}return d};a.MouseTouch.action=function(c,b,d){if((d=d||a.MouseTouch.getAction(c,b))&&a.MouseTouch.Actions[d])a.MouseTouch.Actions[d](c,c.ipos,b)};a.MouseTouch.mousetouchzoom=function(c,b){var d=a.lookupDisplay(c),e=b.checked;d&&(d.mousetouchZoom=e)};a.MouseTouch.init=
function(){var c,b,d=this;this.divjq.html("");this.divjq.addClass("JS9PluginScrolling");this.mousetouchContainer=$("<div>").addClass(a.MouseTouch.BASE+"Container").attr("id",this.id+"MouseTouchContainer").appendTo(this.divjq);b=sprintf("<div class='%s'><span><b>Drag an action to reconfigure JS9 mouse/touch events:</b></span><p>",a.MouseTouch.BASE+"Header");this.mousetouchHeadContainer=$("<span style='float: left'>").addClass(a.MouseTouch.BASE+"Container").attr("id",this.id+"MouseTouchHeadContainer").html(b).appendTo(this.mousetouchContainer);
...
a=0;a<f.length;a++)if(f[a].params){c.params.listonchange?c.listRegions("all",{mode:2}):f[a].params.listonchange&&c.listRegions("selected",{mode:2});break}});return this};a.Regions.initConfigForm=function(a){var b,c,e=a.params,f=e.winid,g="#"+$(f).attr("id")+" #regionsConfigForm ",h=function(a){return"number"===typeof a&&0!==a%1?a.toFixed(2):String(a)};$(g+"."+a.pub.shape).each(function(){$(this).removeClass("nodisplay")});$(g+".val").each(function(){c="";b=$(this).attr("name");switch(b){case "radii":a.pub.radii&&
a.pub.radii.forEach(function(a){c&&(c+=", ");c+=a.toFixed(1)});break;case "pts":a.pub.pts?a.pub.pts.forEach(function(a){c&&(c+=", ");c+=sprintf("%s, %s",a.x.toFixed(2),a.y.toFixed(2))}):a.pub.imstr&&(c=a.pub.imstr.replace(/^.*\(/,"").replace(/\)$/,""));break;case "fontFamily":a.getFontFamily&&(c=a.getFontFamily());break;case "fontSize":a.getFontSize&&(c=a.getFontSize());break;case "fontStyle":a.getFontStyle&&(c=a.getFontStyle());break;case "fontWeight":a.getFontWeight&&(c=a.getFontWeight());break;
case "strokeWidth":c=a.strokeWidth;break;case "strokeDashes":a.strokeDashArray?(c=a.strokeDashArray.join(" "),c.match(/NaN/)&&(c="")):c="";break;case "childtext":0<a.params.children.length&&(c=a.params.children[0].obj.text);break;default:void 0!==a.pub[b]&&(c=h(a.pub[b]))}$(this).val(c)});a.pub.wcsstr&&$(g+".wcs").removeClass("nodisplay");"text"!==a.type&&($(g+".childtext").removeClass("nodisplay"),$(g+"[name='childtext']").prop("readonly",0<e.children.length));void 0===e.listonchange&&(e.listonchange=
!1);e.listonchange?$(g+"[name='listonchange']").prop("checked",!0):$(g+"[name='listonchange']").prop("checked",!1);void 0===e.changeable&&void 0!==e.fixinplace&&(e.changeable=!e.fixinplace);void 0===e.changeable&&(e.changeable=!0);e.changeable?$(g+"[name='changeable']").prop("checked",!0):$(g+"[name='changeable']").prop("checked",!1);$(g).find("input:text[readonly]").css("border-color","A5A5A5").css("background","#E9E9E9");switch(a.pub.shape){case "box":case "ellipse":case "text":$(g+".angle").removeClass("nodisplay")}$(g).data("im",
this);$(g).data("shape",a);$(g).data("winid",f)};a.Regions.processConfigForm=function(c,b,d){var e,f,g,h,k=d.length,l={},n=function(a){return"number"===typeof a&&0!==a%1?a.toFixed(2):String(a)},p=function(a,b,c){return"remove"===b?"selected"===c:"childtext"===b?0<a.params.children.length?!1:""!==c:"strokeDashes"===b?JSON.stringify(a.strokeDashArray)!==JSON.stringify(c):"tags"!==b&&""===c?!1:"misc"===b&&""!==c?!0:"angle"===b?a.angle!==-parseFloat(c):void 0!==a.pub[b]&&n(a.pub[b])!==c||void 0!==a.params[b]&&
n(a.params[b])!==c||void 0!==a[b]&&n(a[b])!==c?!0:!1},r=function(b){return"true"===b?!0:"false"===b?!1:a.isNumber(b)?parseFloat(b):b};for(e=0;e<k;e++)switch(f=d[e].name,g=d[e].value,f){case "text":"text"===c.type&&p(c,f,g)&&(l[f]=r(g));break;case "strokeDashes":g=g.trim().split(/\s+/);p(c,f,g)&&(l.strokeDashArray=0===g.length?[]:g.map(function(a){return parseInt(a,10)}));break;case "childtext":"text"!==c.type&&p(c,f,g)&&(l.text=r(g));break;case "x":p(c,f,g)&&(l[f]=r(g),void 0===l.y&&(l.y=c.pub.y));
break;case "y":p(c,f,g)&&(l[f]=r(g),void 0===l.x&&(l.x=c.pub.x));break;case "misc":if(g.trim())try{h=JSON.parse(g),$.extend(l,h)}catch(q){a.error("invalid json: "+g)}break;default:p(c,f,g)&&(l[f]=r(g))}this.changeShapes(c.pub.layer,c,l);a.Regions.initConfigForm.call(this,c,b)};a.Regions.listRegions=function(c,b,d){var e,f,g,h,k,l="",n="none",p=!1,r=[],q=[];g={};var m=function(a,b){var c,d,e,f={},g=a.params,h=g.children,k=g.exports;for(c=0;c<k.length;c++)if(e=k[c],("text"!==e||"text"===a.type)&&"textOpts"!==
e){if("strokeDashArray"===e&&(d=a.strokeDashArray.join(""),""===d||d.match(/NaN/)))continue;"strokeWidth"===e&&g.sw1?f[e]=g.sw1:void 0!==a[e]?f[e]=a[e]:void 0!==g[e]?f[e]=g[e]:b&&void 0!==b[e]&&(f[e]=b[e])}if(0<h.length&&h[0].obj.text){c=h[0].obj;f.text=c.text;f.textOpts=m(c);if(a.angle!==c.angle){if(f.textOpts.angle=-c.angle,"circle"===a.params.shape||"annulus"===a.params.shape)c.params.parent.moved=!0}else 0===c.angle||"circle"!==a.params.shape&&"annulus"!==a.params.shape||(f.textOpts.angle=-c.angle,
c.params.parent.moved=!0);c.params.parent.moved&&(c.pub.lcs?(f.textOpts.px=c.pub.lcs.x,f.textOpts.py=c.pub.lcs.y):(f.textOpts.x=c.pub.x,f.textOpts.y=c.pub.y));f.textOpts.color===a.stroke&&delete f.textOpts.color;f.textOpts.text&&delete f.textOpts.text;Object.keys(f.textOpts).length||delete f.textOpts}return f};b=b||{};b=b.mode;void 0===b&&(b=3);void 0===d&&(d="regions");q=this.getShapes(d,c,{includeObj:!0});e=q.length;if(b)for(c=0;c<e;c++)if(d=q[c],(h=d.tags.join(","))&&"source,include"!==h&&"include,source"!==
h){p=!0;break}for(f in a.Regions.opts.tagcolors)a.Regions.opts.tagcolors.hasOwnProperty(f)&&r.push(a.Regions.opts.tagcolors[f]);for(c=0;c<e;c++)d=q[c],g=d.obj,h=d.tags.join(","),f=0<=h.indexOf("exclude")?"-":"",g=m(g,d),d.color&&-1===r.indexOf(d.color)&&(g.color=d.color),p&&(k=" # "+h),d.wcsstr&&"image"!==this.params.wcssys&&"physical"!==this.params.wcssys?("wcs"!==n&&("none"!==n&&(l+="; "),l+=this.params.wcssys,n="wcs"),l+="; "+f+d.wcsstr):d.imstr&&(n!==d.imsys&&("none"!==n&&(l+="; "),l+=d.imsys,
n=d.imsys),l+="; "+f+d.imstr),1===b%2&&0<Object.keys(g).length&&(l+=" "+JSON.stringify(g)),k&&(l+=k);1<b&&this.displayMessage("regions",l);return l};a.Regions.copyRegions=function(c,b){var d,e,f=[];if("object"===typeof c)f.push(c);else if("all"===c)for(d=0;d<a.images.length;d++)this!==a.images[d]&&f.push(a.images[d]);else(d=a.lookupImage(c))&&f.push(d);if(f.length){b||(e=this.listRegions("selected",{mode:1}));e||(e=this.listRegions(b,{mode:1}));for(d=0;d<f.length;d++)f[d].addShapes("regions",e);return this}};
a.Regions.parseRegions=function(c){var b=[],d,e,f,g,h,k,l,n,p,r,q,m=/(annulus)|(box)|(circle)|(ellipse)|(line)|(polygon)|(point)|(text)/,t=/(fk4)|(fk5)|(icrs)|(galactic)|(ecliptic)|(image)|(physical)/,u=/\(\s*([^)]+?)\s*\)/,v=/(\{.*\})/,x=/\s*,\s*/,z=/#(?![a-zA-Z0-9]{6}['"])/,y=function(a){return"0"===a?!1:!0},w=function(a){for(var b,c,d,e={},f=/([a-zA-Z][a-zA-Z0-9_]*)\s*=\s*(\d+(\s*\d+)*|[^ '"{]+|['"{][^'"}]*['"}])/g,g={color:function(a){return{color:a}},dash:function(a){if(a)return{strokeDashArray:[3,
1]}},dashlist:function(a){var b;if(a){b=a.split(" ");for(a=0;a<b.length;a++)b[a]=parseFloat(b[a]);return{strokeDashArray:b}}},"delete":function(a){return{removable:y(a)}},edit:function(a){return{selectable:y(a)}},fixed:function(a){return{zoomable:!y(a)}},font:function(a){var b={};a=a.split(" ");var c=a.length;1<=c&&(b.fontFamily=a[0]);2<=c&&(b.fontSize=parseFloat(a[1]));3<=c&&(b.fontStyle=a[2]);4<=c&&(b.fontWeight=a[3]);return b},highlite:function(a){return{hasControls:y(a),hasBorders:y(a),hasRotatingPoint:y(a)}},
move:function(a){return{movable:y(a)}},rotate:function(a){return{rotatable:y(a)}},resize:function(a){return{resizable:y(a)}},select:function(a){return{selectable:y(a)}},text:function(a){return{text:a}},tag:function(a){return{tags:a}},width:function(a){return{strokeWidth:parseFloat(a)}}};null!==(b=f.exec(a));)if(c=b[1],b=b[2].replace(/^['"{]|['"}]$/g,""),g.hasOwnProperty(c)&&"function"===typeof g[c])for(d in c=g[c](b),c)c.hasOwnProperty(d)&&("tags"===d&&e.hasOwnProperty(d)?e[d]+=","+c[d]:e[d]=c[d]);
else e[c]=b;if(a=a.replace(f,""))e._comment=a.trim();return e},B=function(a){var b,c,d,e={opts:{},args:[],isregion:0};0<=a.indexOf("(")?e.cmd=a.split("(")[0].trim().toLowerCase():0<=a.indexOf("{")?e.cmd=a.split("{")[0].trim().toLowerCase():0<=a.indexOf("#")?e.cmd=a.split("#")[0].trim().toLowerCase():e.cmd=a.trim().toLowerCase();e.cmd&&(e.isregion=0<=e.cmd.search(m));b=a.trim().split(z);if((c=v.exec(b[0]))&&c[0])try{e.opts=JSON.parse(c[0].trim())}catch(F){e.opts={}}e.comment=b[1];e.comment&&(d=w(e.comment.trim().toLowerCase()),
void 0!==d._comment&&(e.comment=d._comment,delete d._comment));d&&(e.opts=$.extend({},d,e.opts));(c=u.exec(a))&&c[1]&&(e.args=c[1].split(x));e.isregion&&0===e.cmd.indexOf("-")&&(e.cmd=e.cmd.slice(1),e.comment=e.comment?e.comment+",exclude":"exclude");return e},A=function(b){b=a.saostrtod(b);var c=String.fromCharCode(a.saodtype());switch(c){case '"':b/=3600;break;case "'":b/=60;break;case "r":b*=180/Math.PI}return{dval:b,dtype:c}},C=function(b,c){var d,e;e=A(b);d=A(c);if(":"===e.dtype||":"===d.dtype)p=
!0;n||p?(":"===e.dtype&&"galactic"!==l&&"ecliptic"!==l&&(e.dval*=15),d=a.wcs2pix(this.raw.wcs,e.dval,d.dval).split(/ +/),e=parseFloat(d[0]),d=parseFloat(d[1])):"physical"===l?(d=this.logicalToImagePos({x:e.dval,y:d.dval}),e=d.x,d=d.y):(e=e.dval,d=d.dval);return[e,d]},D=function(a,b){var c=A(a),d=this.raw.wcsinfo||{cdelt1:1,cdelt2:1};(n||p)&&c.dtype&&"."!==c.dtype&&(c.dval=Math.abs(c.dval/d["cdelt"+b]));return c.dval},E=function(a){a=A(a);var b=this.raw.wcsinfo||{crot:0};(n||p)&&b.crot&&(a.dval+=b.crot);
return a.dval};c=c.trim();if(!c.match(/(\(|\{|#|;|\n)/))return c;k=this.getWCSSys();l="physical";this.setWCSSys(l);n="image"!==l&&"physical"!==l;f=c.split(/\n|;/);for(c=0;c<f.length;c++)if("#"!==f[c].trim().substr(0,1))if(p=!1,h=B(f[c]),q=h.args.length,h.isregion){g=$.extend(!0,{},h.opts);g.shape=h.cmd;2<=q&&(r=C.call(this,h.args[0],h.args[1]),g.x=r[0],g.y=r[1]);switch(h.cmd){case "annulus":g.radii=[];for(d=2;d<q;d++)g.radii.push(D.call(this,h.args[d],1));break;case "box":3<=q&&(g.width=D.call(this,
h.args[2],1));4<=q&&(g.height=D.call(this,h.args[3],2));5<=q&&(g.angle=E.call(this,h.args[4]));break;case "circle":3<=q&&(g.radius=D.call(this,h.args[2],1));break;case "ellipse":3<=q&&(g.r1=D.call(this,h.args[2],1));4<=q&&(g.r2=D.call(this,h.args[3],2));5<=q&&(g.angle=E.call(this,h.args[4]));break;case "line":case "polygon":g.pts=[];for(e=d=0;d<q;d+=2,e++)r=C.call(this,h.args[d],h.args[d+1]),g.pts[e]={x:r[0],y:r[1]};delete g.x;delete g.y;break;case "text":3<=q&&(g.text=h.args[2].replace(/^['"]/,"").replace(/["']$/,
...
saveAs(e,c):a.error("no saveAs function available to save region file");return c};a.Regions.keyDownCB=function(a,b,d){var c,f,g={evt:d},h=d.which||d.keyCode;if(a){b=a.layer||"regions";f=a.display.layers[b].canvas;switch(h){case 8:case 46:d.preventDefault();c="removeRegion";break;case 37:d.preventDefault();c="editRegion";g.dx=-1;break;case 38:d.preventDefault();c="editRegion";g.dy=1;break;case 39:d.preventDefault();c="editRegion";g.dx=1;break;case 40:d.preventDefault();c="editRegion";g.dy=-1;break;
case 68:c="downRegion"}switch(c){case "removeRegion":a.removeShapes(b,"selected");a.clearMessage(b);f.fire("mouse:up");break;case "editRegion":a.changeShapes(b,"selected",g);f.fire("mouse:up");break;case "downRegion":a.selectShapes(b,"selected",function(a){f.sendToBack(a)})}}};a.Catalogs={};a.Catalogs.CLASS="JS9";a.Catalogs.NAME="Catalogs";a.Catalogs.opts={hasControls:!1,hasRotatingPoint:!1,hasBorders:!1,lockMovementX:!0,lockMovementY:!0,lockRotation:!0,lockScalingX:!0,lockScalingY:!0,lockUniScaling:!0,
...
2};a.jupyterFocus=function(a,b){var c;window.hasOwnProperty("Jupyter")&&(c=a instanceof jQuery?a:$(a),c.find(b||"input, textarea").each(function(){Jupyter.keyboard_manager.register_events($(this))}))};a.getImageID=function(c,b,d){var e,f,g=0,h=1,k=a.images.length,l=/.*<([0-9][0-9]*)>$/;c=c.replace(/<[0-9][0-9]*>/,"");for(e=0;e<k;e++)f=a.images[e],f.display.id===b&&f!==d&&c===f.id0&&(0<=f.id.search(l)&&(f=f.id.replace(l,"$1"),h=Math.max(h,parseInt(f,10))),g++);return g?c+"<"+String(h+1)+">":c};a.uniqueID=
...
a.fits.options.waiting=a.waiting;return b};a.handleFITSFile=function(c,b,d){a.fits.handleFITSFile?a.fits.handleFITSFile(c,b,d):a.error("no FITS module available to process FITS file")};a.handleImageFile=function(c,b,d){var e=new FileReader;b=$.extend(!0,{},b,a.fits.options);void 0===d&&(d=a.Load);e.onload=function(a){var e=new Image,f,k,l;e.src=a.target.result;e.onload=function(){var a,g,h,q=0;a=document.createElement("canvas");g=a.getContext("2d");var m=e.height,t=e.width;a.width=t;a.height=m;g.drawImage(e,
0,0);f=g.getImageData(0,0,t,m).data;k=new Float32Array(m*t);for(g=0;g<m;g++)for(a=0;a<t;a++)h=.299*f[q]+.587*f[q+1]+.114*f[q+2],k[(m-g)*t+a]=h,q+=4;l={head:{},filename:c.name,filedata:k,naxis:2,axis:[0,t,m],bitpix:-32,data:k};l.dmin=Number.MAX_VALUE;l.dmax=Number.MIN_VALUE;for(q=0;q<m*t;q++)l.dmin=Math.min(l.dmin,l.data[q]),l.dmax=Math.max(l.dmax,l.data[q]);d(l,b)}};e.readAsDataURL(c)};a.lookupColormap=function(c){var b;c||(c=a.imageOpts.colormap);if(c)for(b=0;b<a.colormaps.length;b++)if(a.colormaps[b].name===
