...
keyboardActions:{b:"make selected region a background region",e:"make selected region an exclude region",f:"toggle full screen mode",i:"make selected region an include region",l:"list regions",n:"display next image",o:"open a local FITS file",p:"copy physical coords to clipboard",s:"make selected region a source region",v:"copy pixel value to clipboard",w:"copy wcs coords to clipboard","+":"zoom in","-":"zoom out",">":"zoom in","<":"zoom out"},mousetouchZoom:!1,pinchWait:8,pinchThresh:6,extendedPlugins:!0,
