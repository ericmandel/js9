...
!1;this.type=b.allinone?"none":b.globalOpts.helperType||"sock.io";this.pageid=null;this.connect()};b.Helper.prototype.connectinfo=function(){var a;return null===b.helper.connected?"notConfigured":b.helper.connected?(a=sprintf("connected %s %s",b.helper.type,b.helper.url),b.helper.pageid&&(a+="<p>"+b.helper.pageid),a):sprintf("notConnected %s",b.helper.type)};b.Helper.prototype.connect=function(a){var c=b.globalOpts.ehretries,d=b.globalOpts.ehtimeout,e=this,f=function(a,c,d){e.connected=!1;e.helper=
!1;e.ready=!0;$(document).trigger("JS9:helperReady",{type:"socket.io",status:"error"});c=c||"timeout";d&&"timeout"!==d||(d="or connection refused");d===c&&(c="");"error"===d&&(d="is the helper running?");b.globalOpts.requireHelper?b.error("helper connect error: "+c+" "+d):b.DEBUG&&b.log(sprintf("JS9 helper connect error: %s (%s)",c,d))},g=function(a){$.ajax({url:a,dataType:"script",timeout:b.globalOpts.htimeout,success:function(){var a={reconnection:!0,reconnectionDelay:1E3,reconnectionDelayMax:1E4,
reconnectionAttempts:100,timeout:b.globalOpts.htimeout};"undefined"===typeof io?f(null,"socket io object is undefined",null):(e.socket=io.connect(e.url,a),e.socket.on("connect",function(){var a,c;e.connected=!0;e.helper=!0;c=[];for(a=0;a<b.displays.length;a++)c.push(b.displays[a].id);e.socket.emit("initialize",{displays:c,pageid:e.pageid},function(a){e.pageid=a.pageid;e.js9helper=a.js9helper;b.globalOpts.dataPathModify=a.dataPathModify;e.ready=!0;$(document).trigger("JS9:helperReady",{type:"socket.io",
