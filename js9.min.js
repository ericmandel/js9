...
"ActionContainer").attr("id",this.id+"MouseContainer").html("").appendTo(this.mousetouchActionContainer);for(c=0;c<this.display.mouseActions.length;c++)b=this.display.mouseActions[c],a.MouseTouch.addAction.call(this,this.mousetouchMouseContainer,"mouse",b);this.mousetouchMouseContainer.sortable({start:function(b,a){this.oidx=a.item.index()},stop:function(b,a){var c=a.item.index(),e=d.display.mouseActions.splice(this.oidx,1)[0];d.display.mouseActions.splice(c,0,e)}})}b=sprintf("<p><div class='%s'>use mouse wheel or pinch to zoom:&nbsp;&nbsp;<input type='checkbox' value='1' onclick='javascript:JS9.MouseTouch.mousetouchzoom(\"%s\", this);'></div>",
...
function(b,c,e){var d;c=1;b&&(e.preventDefault(),a.specialKey(e)&&(c*=5),d=b.layer||"regions",e=b.display.layers[d].canvas,b.changeShapes(d,"selected",{dx:c}),e.fire("mouse:up"))},a.Keyboard.Actions["remove selected region"]=function(a,c,e){a&&(e.preventDefault(),e=a.layer||"regions",c=a.display.layers[e].canvas,a.removeShapes(e,"selected"),a.clearMessage(e),c.fire("mouse:up"))},a.Keyboard.Actions["make regions layer active"]=function(a,c,e){a&&(e.preventDefault(),a.activeShapeLayer("regions"))});
