...
archivesURL:"help/archives.html",debug:0};a.imageOpts={contrast:1,bias:0.5,invert:!1,exp:1E3,colormap:"grey",scale:"linear",scaleclipping:"dataminmax",zscalecontrast:0.25,zscalesamples:600,zscaleline:120,wcssys:"native",wcsunits:"sexagesimal",lcs:"physical",valpos:!0,alpha:255,alpha1:100,alpha2:255,zoom:1,zooms:5,nancolor:"#000000",listonchange:!1};a.analOpts={epattern:/^(ERROR:[^\n]*)\n/,dpathURL:"params/datapath.html",prependJS9Dir:!0,dataDir:null};a.lightOpts={dhtml:{top:".dhtmlwindow",drag:".drag-contentarea",
...
this.status.load="loading";a.waiting(!0);$(this.png.image).on("load",function(){var d,b,g;l.mkOffScreenCanvas();l.mkRawDataFromPNG();"zscale"===l.params.scaleclipping&&l.zscale(!0);l.mkSection();e=m(l,j);e.length&&l.mkSection.apply(l,e);l.displayImage("all");l.clearMessage();a.images.push(l);if(c)try{a.xeqByName(c,window,l)}catch(f){a.error("in image onload callback",f,!1)}for(d in l.display.pluginInstances)if(l.display.pluginInstances.hasOwnProperty(d)&&(b=l.display.pluginInstances[d],g=b.plugin.opts,
b.isActive("onimageload")))try{g.onimageload.call(b,l)}catch(n){h.errLog("onimageload",n)}l.status.load="complete";a.waiting(!1);a.DEBUG&&a.log("JS9 image: %s dims(%d,%d) min/max(%d,%d)",l.file,l.raw.width,l.raw.height,l.raw.dmin,l.raw.dmax)}).on("error",function(){a.waiting(!1);l.status.load="error";a.error("could not load image: "+l.id)});this.png.image.src=d;break;default:a.log("unknown specification type for Load: "+typeof d)}};a.Image.prototype.closeImage=function(){var d,b,c,e,f,g;b=a.images.length;
var h=this.display,l=function(d){d.stderr?a.error(d.stderr):d.stdout&&a.warning(d.stdout)};for(d=0;d<b;d++)if(this===a.images[d]){b=a.images[d];b.clearMessage();b.display.context.clear();for(e in b.display.pluginInstances)if(b.display.pluginInstances.hasOwnProperty(e)&&(f=b.display.pluginInstances[e],g=f.plugin.opts,f.isActive("onimageclose")))try{g.onimageclose.call(f,b)}catch(j){f.errLog("onimageclose",j)}for(c in b.layers)b.layers.hasOwnProperty(c)&&(b.layers[c].canvas.dispose(),b.layers[c]=null);
b.display.image=null;switch(b.cmapObj.name){case "red":a.globalOpts.rgb.rim=null;break;case "green":a.globalOpts.rgb.gim=null;break;case "blue":a.globalOpts.rgb.bim=null}a.fits.cleanupFITSFile&&(b.raw.hdu&&b.raw.hdu.fits)&&a.fits.cleanupFITSFile(b.raw.hdu.fits,!0);b.proxyFile&&a.Send("removeproxy",{cmd:"js9Xeq removeproxy "+b.proxyFile},l);b.primary=null;b.offscreen=null;b.raw=null;b.colorData=null;b.colorCells=null;b=b.psColors=null;a.images.splice(d,1);break}for(d=0;d<a.images.length;d++)if(b=a.images[d],
...
a.Image.prototype.initLCS=function(a){var b=[[0,0,0],[0,0,0],[0,0,0]],c=function(a){var d,b,c=0,l=0,j=[[0,0,0],[0,0,0],[0,0,0]],m=a[0][0]*a[1][1];for(d=0;3>d;d++)for(b=0;2>b;b++)if(void 0===a[d][b]||isNaN(a[d][b]))return null;0<=m?c+=m:l+=m;m=-a[0][1]*a[1][0];0<=m?c+=m:l+=m;d=c+l;if(0===d||1E-15>Math.abs(d/(c-l)))return null;d=1/d;j[0][0]=a[1][1]*d;j[1][0]=-a[1][0]*d;j[0][1]=-a[0][1]*d;j[1][1]=a[0][0]*d;j[2][0]=-(a[2][0]*j[0][0]+a[2][1]*j[1][0]);j[2][1]=-(a[2][0]*j[0][1]+a[2][1]*j[1][1]);return j};
...
0,l);c+=2;f=2;break;case 1:j[0]=e[c];j[1]=e[c+1];g=h.call(m,0,l);c+=3;f=0;break;case 2:j[0]=e[c];j[1]=e[c+2];g=h.call(m,0,l);c+=3;f=1;break;case 3:j[0]=e[c+1],j[1]=e[c+2],g=h.call(m,0,l),c+=3,f=2}this.raw.data[d]=g;isNaN(g)||(this.raw.dmin=Math.min(this.raw.dmin,g),this.raw.dmax=Math.max(this.raw.dmax,g))}break;case 32:case -32:32===this.raw.bitpix?(this.raw.data=new Int32Array(b),h=DataView.prototype.getInt32):(this.raw.data=new Float32Array(b),h=DataView.prototype.getFloat32);for(d=0;d<b;d++){switch(f){case 0:j[0]=
e[c];j[1]=e[c+1];j[2]=e[c+2];j[3]=e[c+4];g=h.call(m,0,l);c+=5;f=1;break;case 1:j[0]=e[c];j[1]=e[c+1];j[2]=e[c+3];j[3]=e[c+4];g=h.call(m,0,l);c+=5;f=2;break;case 2:j[0]=e[c];j[1]=e[c+2];j[2]=e[c+3];j[3]=e[c+4];g=h.call(m,0,l);c+=6;f=0;break;case 3:j[0]=e[c+1],j[1]=e[c+2],j[2]=e[c+3],j[3]=e[c+5],g=h.call(m,0,l),c+=6,f=1}this.raw.data[d]=g;isNaN(g)||(this.raw.dmin=Math.min(this.raw.dmin,g),this.raw.dmax=Math.max(this.raw.dmax,g))}break;case -64:this.raw.data=new Float64Array(b);for(d=0;d<b;d++){switch(f){case 0:case 4:j[0]=
e[c];j[1]=e[c+1];j[2]=e[c+2];j[3]=e[c+4];j[4]=e[c+5];j[5]=e[c+6];j[6]=e[c+8];j[7]=e[c+9];g=m.getFloat64(0,l);c+=10;f=2;break;case 1:case 5:j[0]=e[c];j[1]=e[c+1];j[2]=e[c+3];j[3]=e[c+4];j[4]=e[c+5];j[5]=e[c+7];j[6]=e[c+8];j[7]=e[c+9];g=m.getFloat64(0,l);c+=11;f=0;break;case 2:case 6:j[0]=e[c];j[1]=e[c+2];j[2]=e[c+3];j[3]=e[c+4];j[4]=e[c+6];j[5]=e[c+7];j[6]=e[c+8];j[7]=e[c+10];g=m.getFloat64(0,l);c+=11;f=1;break;case 3:case 7:j[0]=e[c+1],j[1]=e[c+2],j[2]=e[c+3],j[3]=e[c+5],j[4]=e[c+6],j[5]=e[c+7],j[6]=
e[c+9],j[7]=e[c+10],g=m.getFloat64(0,l),c+=11,f=2}this.raw.data[d]=g;isNaN(g)||(this.raw.dmin=Math.min(this.raw.dmin,g),this.raw.dmax=Math.max(this.raw.dmax,g))}break;default:a.error("unsupported bitpix in PNG file: "+this.raw.bitpix)}isNaN(this.params.scalemin)&&(this.params.scalemin=this.raw.dmin);isNaN(this.params.scalemax)&&(this.params.scalemax=this.raw.dmax);this.offscreen.img=null;this.wcs=a.initwcs(a.raw2FITS(this.raw));0<this.wcs&&(this.setWCSSys(this.params.wcssys),this.params.wcssys0=this.params.wcssys.trim());
...
b.x0;for(f=0;c<b.x1;c++,f++){A?(y&&(u=y.colorData[k+c]),x&&(w=x.colorData[k+c]),z&&(E=z.colorData[k+c])):n=this.colorData[k+c];this.maskData&&(p=0<this.maskData[k+c]?s:t);h=f*b.zoom;for(j=0;j<b.zoom;j++){m=Math.floor(l+j);q=m*b.width;for(m=0;m<b.zoom;m++)r=Math.floor(h+m),r=4*(q+r),A?(d.data[r]=y?y.psColors[u][0]:0,d.data[r+1]=x?x.psColors[w][1]:0,d.data[r+2]=z?z.psColors[E][2]:0):(d.data[r]=this.psColors[n][0],d.data[r+1]=this.psColors[n][1],d.data[r+2]=this.psColors[n][2]),d.data[r+3]=p}}}return this};
...
this.display.newShapeLayer(d,a.Regions.opts);g=a.InstallDir(f.url);$.ajax({url:g,cache:!1,dataType:"json",success:n,error:k});break;case "text":g=a.InstallDir(f.url),$.ajax({url:g,cache:!1,dataType:"text",success:r,error:k})}}};a.Image.prototype.saveFITS=function(d){var b,c,e,f,g,h,l,j,m,n;if(window.hasOwnProperty("saveAs")){m=this.raw.data.buffer;d=d||"js9.fits";h=a.raw2FITS(this.raw);l=2880-h.length%2880;2880===l&&(l=0);for(b=0;b<l;b++)h+=" ";l=2880-m.byteLength%2880;2880===l&&(l=0);j=new ArrayBuffer(h.length+
m.byteLength+l);j=new Uint8Array(j);for(b=0;b<h.length;b++)j[b]=h.charCodeAt(b);if(b=0<(new Int8Array((new Int16Array([1])).buffer))[0]){g=h.length;f=Math.abs(this.raw.bitpix)/8;n=new Uint8Array(m);for(b=0;b<n.byteLength;b+=f){c=b+f-1;for(e=0;e<f;c--,e++)j[g++]=n[c]}}else j.set(new Uint8Array(m),h.length);g=h.length+m.byteLength;for(b=0;b<l;b++)j[g++]=0;h=new Blob([j],{type:"application/octet-binary"});saveAs(h,d)}else a.error("no saveAs function available to save FITS file")};a.Image.prototype.savePNG=
...
function(a){a.preventDefault();$("#viewMenu"+g.id).contextMenu()});$.contextMenu({selector:"#viewMenu"+g.id,zIndex:a.MENUZINDEX,events:{hide:b},build:function(){var b,c,e,g,f,h="",p=0,s=0,t={},u=d()[0],w=u.image;for(b=0;b<a.plugins.length;b++)if(c=a.plugins[b],e=c.name,c.opts.menuItem&&"view"===c.opts.menu&&(g=u.pluginInstances[e],!g||g.winHandle))c.xclass!==h&&(p+=1),h=c.xclass,t[e]={name:c.opts.menuItem},g&&"active"===g.status&&(t[e].icon="sun");t["sep"+p++]="------";if(w){for(f in w.layers)w.layers.hasOwnProperty(f)&&
...
case "zoomOut":b.setZoom("/2");break;case "zoomToFit":b.setZoom("tofit");break;case "center":b.setPan();break;case "reset":b.setZoom("1");b.setPan();break;default:a.match(/^zoom/)&&b.setZoom(a.slice(4))}})},events:{show:function(a){var b=g.display.image,d={};b&&(d.zoom=String(b.primary.sect.zoom));$.contextMenu.setInputValues(a,d)},hide:function(a){var b=g.display.image;b&&a.edited&&(delete a.edited,a=$.contextMenu.getInputValues(a),isNaN(a.zoom)||b.setZoom(a.zoom))}},items:p}}});$("#scaleMenu"+g.id).on("mousedown",
function(a){a.preventDefault();$("#scaleMenu"+g.id).contextMenu()});$.contextMenu({selector:"#scaleMenu"+g.id,zIndex:a.MENUZINDEX,events:{hide:b},build:function(){var b,c,e,f=0,h={},q=d()[0],p=function(a,b){isNaN(b.scalemin)||(a.params.scalemin=b.scalemin);isNaN(b.scalemax)||(a.params.scalemax=b.scalemax);a.displayImage("colors")},s=function(a){var b=$.contextMenu.getInputValues(a.data),d=g.display.image;switch(a.which||a.keyCode){case 9:case 13:p(d,b)}a.data.edited=!0};h.scaletitle={name:"Scaling Algorithms:",
...
events:{show:function(a){var b=g.display.image,d={};b&&(d.scalemin=String(b.params.scalemin),d.scalemax=String(b.params.scalemax));$.contextMenu.setInputValues(a,d)},hide:function(a){var b=g.display.image;b&&a.edited&&(delete a.edited,a=$.contextMenu.getInputValues(a),p(b,a))}},items:h}}});$("#colorMenu"+g.id).on("mousedown",function(a){a.preventDefault();$("#colorMenu"+g.id).contextMenu()});$.contextMenu({selector:"#colorMenu"+g.id,zIndex:a.MENUZINDEX,events:{hide:b},build:function(){var b,c,e,f=
0,h={},q=d()[0],p=function(a,b){isNaN(b.contrast)||(a.params.contrast=b.contrast);isNaN(b.bias)||(a.params.bias=b.bias);isNaN(b.alpha)||(a.params.alpha=b.alpha);a.displayImage("colors")},s=function(a){var b=$.contextMenu.getInputValues(a.data),d=g.display.image;switch(a.which||a.keyCode){case 9:case 13:p(d,b)}a.data.edited=!0};h.cmaptitle={name:"Colormaps:",disabled:!0};for(b=0;b<a.colormaps.length;b++)e=c=a.colormaps[b].name,h[c]={name:e},q.image&&q.image.cmapObj.name===c&&(h[c].icon="sun");h["sep"+
...
b.image)&&b.setColormap(a)})},events:{show:function(a){var b=g.display.image,d={};b&&(d.contrast=String(b.params.contrast),d.bias=String(b.params.bias),d.alpha=String(b.params.alpha));$.contextMenu.setInputValues(a,d)},hide:function(a){var b=g.display.image;b&&a.edited&&(delete a.edited,a=$.contextMenu.getInputValues(a),p(b,a))}},items:h}}});$("#regionMenu"+g.id).on("mousedown",function(a){a.preventDefault();$("#regionMenu"+g.id).contextMenu()});$.contextMenu({selector:"#regionMenu"+g.id,zIndex:a.MENUZINDEX,
...
!1;b.helper=!1;1<a.DEBUG&&a.log("JS9 helper: disconnect")});b.socket.on("reconnect",function(){b.connected=!0;b.helper=!0;1<a.DEBUG&&a.log("JS9 helper: reconnect")});b.socket.on("msg",function(b,d){var c,e,f,n=[],r=b.cmd,k=b.id;a.globalOpts.alerts=!1;if(a.publics[r]){$.isArray(b.args)||(b.args=[b.args]);n=$.extend(!0,[],b.args);k&&n.push({display:k});try{f=a.publics[r].apply(null,n)}catch(q){f=sprintf("ERROR: %s",q.message)}d&&d(f);a.globalOpts.alerts=!0}else if(!r||"#"===r)d&&d(""),a.globalOpts.alerts=
!0;else{c=a.lookupCommand(r);e=a.lookupDisplay(k);if(c&&e)switch(c.getDisplayInfo(e),b.args?n=$.extend(!0,[],b.args):b.paramlist&&(n=b.paramlist.split(/ +/)),c.getWhich(n)){case "get":try{f=c.get(n)||""}catch(p){f="ERROR: "+p.message}break;case "set":try{f=c.set(n)||"OK"}catch(s){f="ERROR: "+s.message}break;default:f=sprintf("ERROR: unknown cmd type for '%s'",r)}else c||(f=sprintf("ERROR: unknown cmd '%s'",r)),e||(f=sprintf("ERROR: unknown display (%s)",k));a.globalOpts.alerts=!0;d&&d(f)}})},error:function(b,
d,c){a.DEBUG&&a.log("JS9 helper: connect failure: "+d+" "+c)}});break;default:a.error("unknown helper type: "+this.type)}};a.Helper.prototype.send=function(d,b,c){if(!this.connected)return null;b&&"object"===typeof b?(b.cookie=document.cookie,a.globalOpts.dataPath&&!b.dataPath&&(b.dataPath=a.globalOpts.dataPath+":.")):b={dataPath:"."};a.TOROOT&&(b.dataPath+=":"+a.TOROOT);switch(this.type){case "get":case "post":b.key=d;$.ajax({url:this.url,type:this.type.toUpperCase(),data:b,dataType:"text",success:function(b){"string"===
typeof b&&0<=b.search(a.analOpts.epattern)&&a.log(b);c&&c(b)},error:function(b,d,c){a.DEBUG&&a.log("JS9 helper: "+this.type+" failure: "+d+" "+c)}});break;case "sock.io":case "nodejs":a.helper.socket.emit(d,b,c)}return this};a.Fabric={};a.Fabric.elements="cornerSize cornerColor borderColor transparentCorners selectionLineWidth centeredScaling hasControls hasRotatingPoint hasBorders params pub".split(" ");a.Fabric.opts={originX:"center",originY:"center",strokeWidth:2,cornerSize:8*(fabric.isTouchSupported?
2:1),transparentCorners:!1,selectionLineWidth:2,centeredScaling:!0,selectable:!0,skipOffset:!0,padding:0,canvas:{selection:!0,zindex:a.SHAPEZINDEX},fill:"transparent"};a.Fabric.rescaleStrokeWidth=function(d,b){var c=(this.scaleX+this.scaleY)/2;d=d||1;d*=c;!b&&this.params&&(b=this.params.sw1);"group"===this.type?this.forEachObject(function(c){a.Fabric.rescaleStrokeWidth.call(c,d,b)}):this.setStrokeWidth(b/d)};a.Fabric.rescaleEvenly=function(){var a;if(this.params&&this.scaleX!==this.scaleY)switch(this.params.shape){case "annulus":case "circle":a=
...
b.angle&&(n.angle=-b.angle);void 0!==b.x&&void 0!==b.y&&(e=this.imageToDisplayPos(b),n.left=e.x,n.top=e.y);void 0!==b.left&&(n.left=b.left);void 0!==b.top&&(n.top=b.top);void 0===n.left&&(n.left=c&&void 0!==c.left?c.left:this.display.canvasjq.attr("width")/2-1);void 0===n.top&&(n.top=c&&void 0!==c.top?c.top:this.display.canvasjq.attr("height")/2-1+1);b.dx&&(n.left+=b.dx);b.dy&&(n.top-=b.dy);switch(b.shape){case "annulus":r.radii=[];if(void 0!==b.radii)if("string"===typeof b.radii){r.radii=b.radii.replace(/ /g,
"").split(",");for(e=d=0;d<r.radii.length;d++)""!==r.radii[d]&&(r.radii[e++]=parseInt(r.radii[d],10))}else r.radii=b.radii;else{b.ireg&&a.SCALEIREG&&(b.iradius&&(b.iradius/=l),b.oradius&&(b.oradius/=l));h=(b.oradius-b.iradius)/b.nannuli;l=b.nannuli+1;for(d=0;d<l;d++)f=b.iradius+h*d,r.radii.push(f)}break;case "box":b.ireg&&a.SCALEIREG&&(b.width&&(b.width/=l),b.height&&(b.height/=l));break;case "circle":b.ireg&&a.SCALEIREG&&b.radius&&(b.radius/=l);break;case "ellipse":b.ireg&&a.SCALEIREG&&(b.r1&&(b.r1/=
...
d=0;d<f;d+=2,e++)b.pts[e]={x:g[d],y:g[d+1]}}f=b.pts.length;for(d=0;d<f;d++)b.pts[d]=this.imageToDisplayPos(b.pts[d]);b.left&&b.top?g={x:b.left,y:b.top}:(g=a.centroidPolygon(b.pts),n.left=g.x,n.top=g.y);b.points=[];for(d=0;d<f;d++)e={x:(b.pts[d].x-g.x)/h,y:(b.pts[d].y-g.y)/h},b.points.push(e)}if(b.ireg&&a.SCALEIREG){f=b.points.length;for(d=0;d<f;d++)b.points[d].x/=l,b.points[d].y/=l}}for(j in b)if(b.hasOwnProperty(j))switch(j){case "tags":case "x":case "y":case "dx":case "dy":case "pts":case "left":case "top":case "angle":case "radii":case "ireg":break;
...
Astroem;a.fits.options=a.fits.options||{};a.fits.options.handler=a.NewFitsImage;a.userOpts.fits?(a.fits.options.extlist=a.userOpts.fits.extlist,a.fits.options.table={nx:a.userOpts.fits.table.nx,ny:a.userOpts.fits.table.ny}):(a.fits.options.extlist=a.globalOpts.extlist,a.fits.options.table={nx:a.globalOpts.dims[0],ny:a.globalOpts.dims[1]});a.fits.maxFITSMemory&&a.globalOpts.maxMemory&&a.fits.maxFITSMemory(a.globalOpts.maxMemory);break;default:a.error("unknown fits library: "+d)}a.fits.name=b;a.fits.options.error=
a.error;a.fits.options.waiting=a.waiting;return b};a.handleImageFile=function(d,b,c){b=$.extend(!0,{},b,a.fits.options);void 0===c&&(c=a.Load);var e=new FileReader;e.onload=function(a){var e=new Image;e.src=a.target.result;e.onload=function(){var a,f,j,m=0;a=document.createElement("canvas");f=a.getContext("2d");var n=e.height,r=e.width;a.width=r;a.height=n;f.drawImage(e,0,0);var k=f.getImageData(0,0,r,n).data,q=new Float32Array(n*r);for(f=0;f<n;f++)for(a=0;a<r;a++)j=0.299*k[m]+0.587*k[m+1]+0.114*
k[m+2],q[(n-f)*r+a]=j,m+=4;a={head:{},name:d.name,filedata:q,naxis:2,axis:[0,r,n],bitpix:-32,data:q};a.dmin=Number.MAX_VALUE;a.dmax=Number.MIN_VALUE;for(m=0;m<n*r;m++)a.dmin=Math.min(a.dmin,a.data[m]),a.dmax=Math.max(a.dmax,a.data[m]);c(a,b)}};e.readAsDataURL(d)};a.lookupColormap=function(d){var b;d||(d=a.imageOpts.colormap);if(d)for(b=0;b<a.colormaps.length;b++)if(a.colormaps[b].name===d)return a.colormaps[b];a.error("unknown colormap '"+d+"'")};a.lookupCommand=function(d){var b,c;if(d){c=d.toLowerCase();
for(b=0;b<a.commands.length;b++)if(d=a.commands[b],d.name===c||d.alias===c||d.alias2===c)return d}return null};a.error=function(d,b,c){var e,f,g="",h="",l=!0;a.waiting(!1);"string"===typeof b?(f=d.match(b))?f[1]?d=f[1]:f[0]&&(d=f[0]):l=!1:"object"===typeof b&&(e=b);3>arguments.length&&(c=!0);if(l&&(e&&e.message?d+=sprintf(" (%s)",e.message):d&&(e=Error(d)),(f=a.strace(e))&&(h="\n\nStacktrace:\n"+f),a.globalOpts.alerts&&(d&&("string"===typeof d&&0>d.search(/ERROR/))&&(g="JS9 ERROR: "),alert(g+(d+h))),
...
b/180;e=Math.cos(b);b=Math.sin(b);return{x:e*(a.x-c.x)-b*(a.y-c.y)+c.x,y:b*(a.x-c.x)+e*(a.y-c.y)+c.y}};a.log=function(){if(void 0!==window.console&&void 0!==window.console.log)try{console.log.apply(console,arguments)}catch(a){Function.prototype.bind.call(console.log,console).apply(console,arguments)}};a.isNumber=function(a){return!isNaN(parseFloat(a))&&isFinite(a)};a.cardpars=function(d){var b;if("="===d[8])return b=d.slice(0,8).trim(),d=d.slice(10).replace(/\'/g," ").replace(/\/.*/,"").trim(),"T"===
d?d=!0:"F"===d?d=!1:a.isNumber(d)&&(d=parseFloat(d)),[b,d]};a.raw2FITS=function(a,b){var c,e,f,g=!1,h="";if(a.card)for(c=0;c<a.card.length;c++)e=a.card[c],h+=e,"END "===e.substring(0,4)&&(g=!0),b&&(h+="\n");else if(a.cardstr)for(c=0;c<a.ncard;c++)e=a.cardstr.slice(80*c,80*(c+1)),h+=e,"END "===e.substring(0,4)&&(g=!0),b&&(h+="\n");else if(a.header)for(e in c=a.header,c)if(c.hasOwnProperty(e)&&!("js9Protocol"===e||"js9Endian"===e))"END"===e&&(g=!0),f=c[e],!0===f&&(f="T"),h+=sprintf("%-8s%-2s%-70s",
