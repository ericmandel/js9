...
0;d<f;d++)c=d/f,b=10*c,c=Math.floor(Math.log(b+Math.sqrt(b*b+1))/3*e),c>=e&&(c=e-1),this.psColors[d]=this.colorCells[c];break;case "sinh":for(d=0;d<f;d++)c=d/f,b=3*c,c=Math.floor((Math.exp(b)-Math.exp(-b))/2/10*e),c>=e&&(c=e-1),this.psColors[d]=this.colorCells[c];break;default:a.log("unknown scale '"+this.params.scale+"'")}return this};a.Image.prototype.mkRGBImage=function(){var c,b,d,e,f,g,h,j,k,m,p,r,l,n,q,s,t,u,v,w,y=null,x=null,A=null,B=!1;if(!this.rgb)return this;if(a.globalOpts.rgb.mode&&(this===
a.globalOpts.rgb.rim||this===a.globalOpts.rgb.gim||this===a.globalOpts.rgb.bim))B=!0,a.globalOpts.rgb.rim&&(y=a.globalOpts.rgb.rim),a.globalOpts.rgb.gim&&(x=a.globalOpts.rgb.gim),a.globalOpts.rgb.bim&&(A=a.globalOpts.rgb.bim);h=this.display.context;c=this.rgb;b=c.sect;if(this.MakeRGBImage&&"function"===typeof this.MakeRGBImage&&this.MakeRGBImage()||this.MakePrimaryImage&&"function"===typeof this.MakePrimaryImage&&this.MakePrimaryImage())return this;if(this.rgbFile){f=b.width/b.zoom;g=b.height/b.zoom;
d=b.x0;e=this.offscreen.canvas.height-1-(b.y0+g);e=this.offscreen.context.getImageData(d,e,f,g);if(1===b.zoom)c.img=e;else{c.img=h.createImageData(b.width,b.height);c=c.img;for(m=j=0;j<e.height;j++,m++){s=j*e.width;r=m*b.zoom;for(k=h=0;h<e.width;h++,k++){d=4*(s+h);p=k*b.zoom;for(l=0;l<b.zoom;l++){n=Math.floor(r+l);t=n*b.width;for(n=0;n<b.zoom;n++)q=Math.floor(p+n),q=4*(t+q),c.data[q]=e.data[d],c.data[q+1]=e.data[d+1],c.data[q+2]=e.data[d+2],c.data[q+3]=e.data[d+3]}}}}return this}if(!c.img||c.img.width!==
b.width||c.img.height!==b.height)c.img=h.createImageData(b.width,b.height);c=c.img;if(!this.psColors)return this;u=void 0!==this.params.opacity?255*this.params.opacity:void 0!==this.params.alpha?this.params.alpha:255;this.maskData&&(this.params.maskInvert?void 0!==this.params.opacity&&void 0!==this.params.maskOpacity?(e=255*this.params.opacity,f=255*this.params.maskOpacity):void 0!==this.params.alpha1&&void 0!==this.params.alpha2?(e=this.params.alpha2,f=this.params.alpha1):(e=0,f=255):void 0!==this.params.opacity&&
void 0!==this.params.maskOpacity?(e=255*this.params.maskOpacity,f=255*this.params.opacity):void 0!==this.params.alpha1&&void 0!==this.params.alpha2?(e=this.params.alpha1,f=this.params.alpha2):(e=255,f=0));j=b.y1-1;for(m=0;j>=b.y0;j--,m++){s=j*this.raw.width;r=m*b.zoom;h=b.x0;for(k=0;h<b.x1;h++,k++){if(B){if(g=y?y.colorData[s+h]:0,v=x?x.colorData[s+h]:0,w=A?A.colorData[s+h]:0,void 0===g||void 0===v||void 0===w)return a.globalOpts.rgb.mode=!1,a.error("RGB images are incompatible. Turning off RGB mode.",
"",!1),a.Image.prototype.mkRGBImage.call(this),this}else d=this.colorData[s+h];this.maskData&&(u=0<this.maskData[s+h]?e:f);p=k*b.zoom;for(l=0;l<b.zoom;l++){n=Math.floor(r+l);t=n*b.width;for(n=0;n<b.zoom;n++)q=Math.floor(p+n),q=4*(t+q),B?(c.data[q]=y?y.psColors[g][0]:0,c.data[q+1]=x?x.psColors[v][1]:0,c.data[q+2]=A?A.psColors[w][2]:0):(c.data[q]=this.psColors[d][0],c.data[q+1]=this.psColors[d][1],c.data[q+2]=this.psColors[d][2]),c.data[q+3]=u}}}return this};a.Image.prototype.blendImage=function(c,
b,d){var e,f,g=/normal|multiply|screen|overlay|darken|lighten|color-dodge|color-burn|hard-light|soft-light|difference|exclusion|hue|saturation|color|luminosity|clear|copy|source-over|destination-over|source-in|destination-in|source-out|destination-out|source-atop|destination-atop|xor|lighter/i;if(0===arguments.length)return this.blends;if(!0===c||!1===c)return this.blend=c,this.displayImage(),this;if(f=a.lookupImage(c)){if(1===arguments.length){for(e=0;e<this.blends.length;e++)if(f===this.blends[e].im)return this.blends[e];
a.error("can't find blend params for "+f.id)}for(e=0;e<this.blends.length;e++)if(f===this.blends[e].im){if(void 0!==b&&null!==b){if("remove"===b)return this.blends.splice(e,1),this;if(!0===b||!1===b)return this.blends[e].active=b,this;g.test(b)||a.error("invalid composite/blend operation: "+b);this.blends[e].blend=b}void 0!==d&&null!==d&&(this.blends[e].opacity=d);this.blend&&this.displayImage();return this}this.blends.push({im:f,active:!0,blend:b,opacity:d});this.blend&&this.displayImage()}else a.error("can't find image to blend: "+
c);return this};a.Image.prototype.putImage=function(c){var b,d,e={};b=this.rgb;var f=this.display,g=f.context;this.ix=Math.floor((f.canvas.width-b.img.width)/2);this.iy=Math.floor((f.canvas.height-b.img.height)/2);if(void 0!==c.opacity||void 0!==c.blend){b=b.img;var h;this.offscreenRGB||(h=document.createElement("canvas"),f=h.getContext("2d"),h.width=b.width,h.height=b.height,a.ANTIALIAS||(f.imageSmoothingEnabled=!1,f.mozImageSmoothingEnabled=!1,f.webkitImageSmoothingEnabled=!1),f.putImageData(b,
0,0),this.offscreenRGB={canvas:h,context:f});b=this.offscreenRGB.canvas;void 0!==c.opacity&&(e.globalAlpha=g.globalAlpha,g.globalAlpha=c.opacity);void 0!==c.blend&&(e.globalCompositeOperation=g.globalCompositeOperation,g.globalCompositeOperation=c.blend);g.drawImage(b,this.ix,this.iy);for(d in e)e.hasOwnProperty(d)&&(g[d]=e[d])}else g.putImageData(b.img,this.ix,this.iy)};a.Image.prototype.displayImage=function(c,b){var d,e,f,g={};if(!1===c)return this.displayMode=!1,this;!0===c&&(this.displayMode=
!0,c="all");if(!this.displayMode)return this;"object"===typeof c&&(b=c,c=null);c?"all"===c?(c="colors,scaled,rgb,display,plugins",g.notify=!0):"rgbonly"===c?(c="rgb,nodisplay",g.notify=!0):"display"===c&&(g.notify=!0):c="rgb";c.split(",").forEach(function(a){a=a.trim();g[a]=!0;switch(a){case "colors":g.scaled=!0;g.rgb=!0;break;case "scaled":g.rgb=!0}});g.display=!0;g.plugins=!0;this.rgbFile&&(c.colors=!1,c.scaled=!1);b=b||{};g.colors&&(this.mkColorData(),this.offscreenRGB=null);g.scaled&&(this.mkColorCells(),
this.mkScaledCells(),this.offscreenRGB=null);g.rgb&&(this.mkRGBImage(),this.offscreenRGB=null);if(g.nodisplay)return this;if(g.display){void 0===b.opacity&&void 0===b.blend&&this.display.context.clear();this.putImage(b);if(this.blend&&this.blends.length)for(d=0;d<this.blends.length;d++)e=this.blends[d],e.active&&a.Image.prototype.putImage.call(e.im,{opacity:e.opacity,blend:e.blend});this.displayShapeLayers();g.notify&&this.notifyHelper();void 0===b.opacity&&void 0===b.blend&&(this.display.image=this)}if(g.plugins)for(f in this.display.pluginInstances)if(this.display.pluginInstances.hasOwnProperty(f)&&
(d=this.display.pluginInstances[f],e=d.plugin.opts,d.isActive("onimagedisplay")&&("JS9Panner"===f||"all"===c||"display"===c)))try{e.onimagedisplay.call(d,this)}catch(h){d.errLog("onimagedisplay",h)}return this};a.Image.prototype.refreshImage=function(c,b){var d,e,f,g,h,j;b=b||{};b.rawid=b.rawid||a.RAWID0;"function"===typeof b&&(b={onrefresh:b});!b.onrefresh&&a.imageOpts.onrefresh&&(b.onrefresh=a.imageOpts.onrefresh);d=this.rgb.sect.xcen;e=this.rgb.sect.ycen;h=this.rgb.sect.zoom;f=this.raw.width;g=
this.raw.height;this.binning.obin=this.binning.bin;this.mkRawDataFromHDU(c,b);this.raw.width===f&&this.raw.height===g?this.mkSection(d,e,h):(this.mkSection(),this.mkSection(h));this.displayImage("colors");this.refreshLayers();this.updateShapes("regions","all","binning");if(b.onrefresh)try{a.xeqByName(b.onrefresh,window,this)}catch(k){a.error("in image refresh callback",k)}for(j in this.display.pluginInstances)if(this.display.pluginInstances.hasOwnProperty(j)&&(d=this.display.pluginInstances[j],e=
d.plugin.opts,d.isActive("onimagerefresh")))try{e.onimagerefresh.call(d,this)}catch(m){d.errLog("onimagerefresh",m)}};a.Image.prototype.toArray=function(){var c,b,d,e,f,g,h,j,k,m;k=this.raw.data.buffer;g=a.raw2FITS(this.raw);h=2880-g.length%2880;2880===h&&(h=0);for(c=0;c<h;c++)g+=" ";h=2880-k.byteLength%2880;2880===h&&(h=0);c=new ArrayBuffer(g.length+k.byteLength+h);j=new Uint8Array(c);for(c=0;c<g.length;c++)j[c]=g.charCodeAt(c);if(0<(new Int8Array((new Int16Array([1])).buffer))[0]){f=g.length;e=
Math.abs(this.raw.bitpix)/8;m=new Uint8Array(k);for(c=0;c<m.byteLength;c+=e){b=c+e-1;for(d=0;d<e;b--,d++)j[f++]=m[b]}}else j.set(new Uint8Array(k),g.length);f=g.length+k.byteLength;for(c=0;c<h;c++)j[f++]=0;return j};a.Image.prototype.getPan=function(){return{x:(this.rgb.sect.x0+this.rgb.sect.x1)/2+1,y:(this.rgb.sect.y0+this.rgb.sect.y1)/2+1}};a.Image.prototype.setPan=function(c,b){var d,e,f,g,h,j=this.raw.width/2,k=this.raw.height/2;0===arguments.length&&(c=j,b=k);this.mkSection(c,b);if(this.blend&&
this.blends.length)for(d=0;d<this.blends.length;d++)f=this.blends[d],f.active&&(g=f.im.raw.width/2,h=f.im.raw.height/2,0!==arguments.length&&(g-=j-c,h-=k-b),a.Image.prototype.mkSection.call(f.im,g,h),a.Image.prototype.displayImage.call(f.im,"rgbonly"));this.displayImage("rgb");for(e in this.layers)this.layers.hasOwnProperty(e)&&this.layers[e].show&&this.layers[e].opts.panzoom&&this.refreshShapes(e);return this};a.Image.prototype.getZoom=function(){return this.rgb.sect.zoom};a.Image.prototype.parseZoom=
function(a){var b;b=this.rgb.sect.zoom;switch(typeof a){case "string":switch(a.charAt(0)){case "*":case "x":case "X":a=b*parseFloat(a.slice(1));break;case "/":a=b/parseFloat(a.slice(1));break;case "I":case "i":a=2*b;break;case "O":case "o":a=b/2;break;case "T":case "t":a=Math.min(this.display.width,this.display.height)/Math.max(this.raw.width,this.raw.height);break;default:a=parseFloat(a)}break;case "number":break;default:return}return a};a.Image.prototype.setZoom=function(c){var b,d,e;if(b=this.parseZoom(c)){this.mkSection(b);
if(this.blend&&this.blends.length)for(c=0;c<this.blends.length;c++)e=this.blends[c],e.active&&(a.Image.prototype.mkSection.call(e.im,b),a.Image.prototype.displayImage.call(e.im,"rgbonly"));this.displayImage("rgb");for(d in this.layers)this.layers.hasOwnProperty(d)&&this.layers[d].show&&this.layers[d].opts.panzoom&&this.refreshShapes(d);return this}};a.Image.prototype.refreshLayers=function(){this.setZoom(this.getZoom())};a.Image.prototype.imageToLogicalPos=function(a,b){var d,e=a.x,f=a.y,g="image";
...
(d=this.lcs.physical.forward);break;case "detector":this.lcs.detector&&(d=this.lcs.detector.forward);break;case "amplifier":this.lcs.amplifier&&(d=this.lcs.amplifier.forward)}d&&(e.x=a.x*d[0][0]+a.y*d[1][0]+d[2][0],e.y=a.x*d[0][1]+a.y*d[1][1]+d[2][1]);return e};a.Image.prototype.displayToImagePos=function(a){var b=this.rgb,d=this.rgb.sect,e={};1>=d.zoom?(e.x=(a.x-this.ix)/d.zoom+d.x0+1,e.y=(b.img.height-1-(a.y-this.iy))/d.zoom+d.y0+1):(e.x=(a.x-this.ix)/d.zoom+d.x0+1-0.5,e.y=(b.img.height-1-(a.y-
this.iy))/d.zoom+d.y0+1-0.5);return e};a.Image.prototype.imageToDisplayPos=function(a){var b=this.rgb,d=this.rgb.sect,e={};1>=d.zoom?(e.x=(a.x-1-d.x0)*d.zoom+this.ix,e.y=(d.y0-(a.y-1))*d.zoom+(b.img.height-1)+this.iy):(e.x=(a.x-1+0.5-d.x0)*d.zoom+this.ix,e.y=(d.y0-(a.y-1+0.5))*d.zoom+(b.img.height-1)+this.iy);return e};a.Image.prototype.logicalToDisplayPos=function(a){return this.imageToDisplayPos(this.logicalToImagePos(a))};a.Image.prototype.displayToLogicalPos=function(a){return this.imageToLogicalPos(this.displayToImagePos(a))};
...
this.selectShapes(c,b,function(b,h){a.Fabric._updateShape.call(f,c,b,h,d,e)});return this};a.Fabric._updateShape=function(c,b,d,e,f){var g,h,j,k,m,p,r,l={},n=this.layers[c],q=function(a){return a.toFixed(1)};d=d||{};f=f||{};p=this.display;j="main"===this.display.layers[c].dtype?this.rgb.sect.zoom:1;l.mode=e||"update";l.id=b.params.id;l.shape=b.params.shape;l.layer=c;l.color=b.stroke;l.tags=b.params.tags;e=b.getCenterPoint();d.group&&(r=d.group.getCenterPoint(),e={x:e.x+r.x,y:e.y+r.y});r=this.displayToImagePos(e);
...
function(c){var b,d,e,f,g,h,j,k,m,p=!1,r=this;if(m=this.getShapeLayer(c))return"main"===this.display.layers[c].dtype&&(p=!0),p?(e=this.binning.bin,f=this.rgb.sect.zoom,g=this.binning.obin/this.rgb.sect.ozoom*f/e,h=this.binning.obin/this.rgb.sect.ozoom*f/e):(e=1,h=g=f=this.rgb.sect.zoom),e=m.canvas,e.getActiveGroup()&&e.discardActiveGroup(),d=e.getActiveObject(),this.selectShapes(c,"all",function(c){b=r.logicalToDisplayPos(c.pub.lcs);c.setLeft(b.x);c.setTop(b.y);switch(c.params.shape){case "point":case "text":break;
...
function(){var c=a.parsePublicArgs(arguments);(c=a.lookupDisplay(c.display))&&$("#openLocalFile-"+c.id).click()});a.mkPublic("OpenRegionsMenu",function(){var c=a.parsePublicArgs(arguments);(c=a.lookupDisplay(c.display))&&$("#openLocalRegions-"+c.id).click()});a.mkPublic("DisplayPlugin",function(c){var b,d,e,f;b=a.parsePublicArgs(arguments);var g=a.lookupDisplay(b.display);if(g&&b.argv[0]){c=b.argv[0];f=c.toLowerCase();for(b=0;b<a.plugins.length;b++)if(d=a.plugins[b],e=d.name,e===c||e.toLowerCase().substr(-f.length)===
f){g.displayPlugin(d);break}}});a.mkPublic("NewFitsImage",function(c,b){var d;b&&b.onload&&(d=b.onload);a.checkNew(new a.Image(c,b,d))});a.mkPublic("GetImage",function(c){var b;c&&"string"!==typeof c&&(b=a.parsePublicArgs(arguments),c=b.display);return a.getImage(c)});a.mkPublic("GetImageData",function(c){var b=a.parsePublicArgs(arguments),d=a.getImage(b.display);return d?(c=b.argv[0],d.getImageData(c)):null});a.mkPublic("GetDisplayData",function(c){var b,d,e,f=[];b=a.parsePublicArgs(arguments);d=
