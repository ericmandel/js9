...
this.params.scale+"'")}return this};a.Image.prototype.mkPrimaryImage=function(){var d,b,c,e,f,g,h,l,j,m,n,r,k,q,p,s,t,u,w,E,y=this,x=this,z=this,A=!1;if(!this.primary||!this.psColors)return this;if(a.globalOpts.rgb.mode&&(this===a.globalOpts.rgb.rim||this===a.globalOpts.rgb.gim||this===a.globalOpts.rgb.bim))A=!0;A&&(y=a.globalOpts.rgb.rim,x=a.globalOpts.rgb.gim,z=a.globalOpts.rgb.bim);d=this.primary;b=d.sect;if(!d.img||d.img.width!==b.width||d.img.height!==b.height)d.img=this.display.context.createImageData(b.width,
b.height);d=d.img;p=this.params.alpha;this.maskData&&(this.params.maskInvert?(s=this.params.alpha2,t=this.params.alpha1):(s=this.params.alpha1,t=this.params.alpha2));e=b.y1-1;for(g=0;e>=b.y0;e--,g++){k=e*this.raw.width;l=g*b.zoom;c=b.x0;for(f=0;c<b.x1;c++,f++){A?(y&&(u=y.colorData[k+c]),x&&(w=x.colorData[k+c]),z&&(E=z.colorData[k+c])):n=this.colorData[k+c];this.maskData&&(p=0<this.maskData[k+c]?s:t);h=f*b.zoom;for(j=0;j<b.zoom;j++){m=Math.floor(l+j);q=m*b.width;for(m=0;m<b.zoom;m++)r=Math.floor(h+
m),r=4*(q+r),A?(d.data[r]=y?y.psColors[u][0]:0,d.data[r+1]=x?x.psColors[w][1]:0,d.data[r+2]=z?z.psColors[E][2]:0):(d.data[r]=this.psColors[n][0],d.data[r+1]=this.psColors[n][1],d.data[r+2]=this.psColors[n][2]),d.data[r+3]=p}}}return this};a.Image.prototype.displayImage=function(a){var b,c;c=this.primary;var e=this.display,f={},g=function(a){a=a.trim();f[a]=!0;switch(a){case "colors":f.scaled=!0;f.primary=!0;break;case "scaled":f.primary=!0}};if(!1===a)this.displayMode=!1;else if(!0===a&&(this.displayMode=
!0,a="all"),this.displayMode){a?"all"===a?(a="colors,scaled,primary,display,plugins",f.notify=!0):"display"===a&&(f.notify=!0):a="primary";a.split(",").forEach(g);f.display=!0;f.plugins=!0;f.colors&&this.mkColorData();f.scaled&&(this.mkColorCells(),this.mkScaledCells());f.primary&&this.mkPrimaryImage();f.display&&(this.ix=Math.floor((e.canvas.width-c.img.width)/2),this.iy=Math.floor((e.canvas.height-c.img.height)/2),e.context.clear(),e.context.putImageData(c.img,this.ix,this.iy),this.displayShapeLayers(),
f.notify&&this.notifyHelper(),e.image=this);if(f.plugins)for(b in this.display.pluginInstances)if(this.display.pluginInstances.hasOwnProperty(b)&&(a=this.display.pluginInstances[b],c=a.plugin.opts,a.isActive("onimagedisplay")))try{c.onimagedisplay.call(a,this)}catch(h){a.errLog("onimagedisplay",h)}return this}};a.Image.prototype.refreshImage=function(d,b){var c,e,f,g,h,l,j;!b&&a.imageOpts.onrefresh&&(b=a.imageOpts.onrefresh);e=this.primary.sect.xcen;f=this.primary.sect.ycen;l=this.primary.sect.zoom;
...
d.displayImage("colors"),!1;default:d.setScale(a)}})},events:{show:function(a){var b=g.display.image,d={};b&&(d.scalemin=String(b.params.scalemin),d.scalemax=String(b.params.scalemax));$.contextMenu.setInputValues(a,d)},hide:function(a){var b=g.display.image;b&&a.edited&&(delete a.edited,a=$.contextMenu.getInputValues(a),p(b,a))}},items:h}}});$("#colorMenu"+g.id).on("mousedown",function(a){a.preventDefault();$("#colorMenu"+g.id).contextMenu()});$.contextMenu({selector:"#colorMenu"+g.id,zIndex:a.MENUZINDEX,
events:{hide:b},build:function(){var b,c,e,f=0,h={},q=d()[0],p=function(a,b){isNaN(b.contrast)||(a.params.contrast=b.contrast);isNaN(b.bias)||(a.params.bias=b.bias);isNaN(b.alpha)||(a.params.alpha=b.alpha);a.displayImage("colors")},s=function(a){var b=$.contextMenu.getInputValues(a.data),d=g.display.image;switch(a.which||a.keyCode){case 9:case 13:p(d,b)}a.data.edited=!0};h.cmaptitle={name:"Colormaps:",disabled:!0};for(b=0;b<a.colormaps.length;b++)e=c=a.colormaps[b].name,h[c]={name:e},q.image&&q.image.cmapObj.name===
c&&(h[c].icon="sun");h["sep"+f++]="------";h.contrast={events:{keyup:s},name:"contrast value:",type:"text"};h.bias={events:{keyup:s},name:"bias value:",type:"text"};h.alpha={events:{keyup:s},name:"alpha value:",type:"text"};h["sep"+f++]="------";h.reset={name:"reset contrast/bias"};h["sep"+f++]="------";h.invert={name:"invert colormap"};q.image&&q.image.params.invert&&(h.invert.icon="sun");h["sep"+f++]="------";h.rgb={name:"RGB mode"};a.globalOpts.rgb.mode&&(h.rgb.icon="sun");return{callback:function(a){d().forEach(function(b){(b=
...
c.oid===b.argv[0]?c.status.load:"other":"none"});a.mkPublic("OpenFileMenu",function(a){$("#openLocalFile-"+a.id).click()});a.mkPublic("OpenRegionsMenu",function(a){$("#openLocalRegions-"+a.id).click()});a.mkPublic("NewFitsImage",function(d,b){var c;b&&b.onload&&(c=b.onload);a.checkNew(new a.Image(d,b,c))});a.mkPublic("GetImage",function(d){var b;d&&"string"!==typeof d&&(b=a.parsePublicArgs(arguments),d=b.display);return a.getImage(d)});a.mkPublic("GetImageData",function(d){var b=a.parsePublicArgs(arguments),
