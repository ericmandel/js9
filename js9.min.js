...
v&&null!==C&&(v[2]=C[1]);v=v?[v[1],v[2],D]:[G,navigator.appVersion,"-?",D];v.push(/Android|webOS|iPhone|iPad|iPod|BlackBerry/i.test(B));F.BROWSER=v;a.globalOpts={helperType:"sock.io",helperPort:2718,winType:"light",rgb:{mode:!1,rim:null,gim:null,bim:null},defcolor:"#00FF00",pngisfits:!0,fits2png:!1,alerts:!0,internalValPos:!0,xtimeout:1E4,extlist:"EVENTS STDEVT",dims:[1024,1024],helperProtocol:location.protocol,maxMemory:45E7,sharedURL:"params/opencors.html",debug:0};a.imageOpts={contrast:1,bias:0.5,
invert:!1,exp:1E3,colormap:"grey",scale:"linear",scaleclipping:"dataminmax",zscalecontrast:0.25,zscalesamples:600,zscaleline:120,wcssys:"native",wcsunits:"sexagesimal",lcs:"physical",valpos:!0,alpha:255,alpha1:100,alpha2:255,zoom:1,zooms:5,nancolor:"#000000",listonchange:!1};a.analOpts={epattern:/^(ERROR:[^\n]*)\n/,dpathURL:"params/datapath.html",prependJS9Dir:!0,dataDir:null};a.lightOpts={dhtml:{top:".dhtmlwindow",drag:".drag-contentarea",dragBar:"drag-handle",format:"width=%spx,height=%spx,center=1,resize=%s,scrolling=0",
textWin:"width=830px,height=400px,center=1,resize=1,scrolling=1",plotWin:"width=830px,height=420px,center=1,resize=1,scrolling=1",dpathWin:"width=830px,height=175px,center=1,resize=1,scrolling=1",paramWin:"width=830px,height=230px,center=1,resize=1,scrolling=1",imageWin:"width=512px,height=542px,center=1,resize=1,scrolling=1",lineWin:"width=400px,height=10px,center=1,resize=1,scrolling=1"}};a.textColorOpts={regions:"#00FF00",info:"#00FF00"};a.plotOpts={zoomStack:!0,selection:{mode:"xy"},series:{clickable:!0,
hoverable:!0,lines:{show:!0},points:{show:!1}}};a.helpOpts={user:{type:"help",url:"user.html",title:"JS9 User Manual"},install:{type:"help",url:"install.html",title:"Installing JS9"},webpage:{type:"help",url:"webpage.html",title:"Adding JS9 To A Web Page"},yourdata:{type:"help",url:"yourdata.html",title:"Adding Data To A Web Page"},localtasks:{type:"help",url:"localtasks.html",title:"Local Analysis with JS9"},publicapi:{type:"help",url:"publicapi.html",title:"The JS9 Public API"},helper:{type:"help",
url:"helper.html",title:"Adding Server-side Analysis"},serverside:{type:"help",url:"serverside.html",title:"Server-side Analysis with JS9"},regions:{type:"help",url:"regions.html",title:"JS9 Regions Format"},extmsg:{type:"help",url:"extmsg.html",title:"JS9 External Messaging"},preferences:{type:"help",url:"preferences.html",title:"JS9 Site Preferences"},repfile:{type:"help",url:"repfile.html",title:"The PNG Represention File"},changelog:{type:"help",url:"changelog.html",title:"JS9 ChangeLog"},issues:{type:"help",
url:"knownissues.html",title:"Known Issues"}};a.menuButtonOptsArr=[{name:"file",label:"File"},{name:"view",label:"View"},{name:"zoom",label:"Zoom"},{name:"scale",label:"Scale"},{name:"color",label:"Color"},{name:"region",label:"Region"},{name:"wcs",label:"WCS"},{name:"analysis",label:"Analysis"},{name:"help",label:"Help"}];a.images=[];a.displays=[];a.colormaps=[];a.commands=[];a.plugins=[];a.preloads=[];a.auxFiles=[];a.publics={};a.helper={};a.fits={};a.userOpts={};a.scales="linear log pow sqrt squared asinh sinh".split(" ");
...
this.id+'" multiple="true" onchange="javascript:for(var i=0; i<this.files.length; i++){JS9.LoadRegions(this.files[i], {display:\''+this.id+"'}); }\"> </div>");a.displays.push(this);a.DEBUG&&a.log("JS9 display:  %s (%d,%d)",this.id,this.x,this.y)};a.Display.prototype.initMessages=function(){this.messageContainer=$("<div>").addClass("JS9Container").css("z-index",a.MESSZINDEX).appendTo(this.divjq);this.infoArea=$("<div>").addClass("JS9Message").appendTo(this.messageContainer);this.regionsArea=$("<div>").addClass("JS9Message").appendTo(this.messageContainer);
...
$.contextMenu({selector:"#fileMenu"+g.id,zIndex:a.MENUZINDEX,events:{hide:b},build:function(){var b,c,g,e,f=0,h={},p=d()[0];e=a.images.length;for(b=0;b<e;b++)c=a.images[b],c.display===p&&(g=c.id,h[g]={name:g},p.image&&p.image.id===c.id&&(h[g].icon="sun"),f++);f||(h.noimg={name:"[no images]",events:{keyup:function(){}}});h["sep"+f++]="------";h.open={name:"open local file ..."};h.openshared={name:"open shared link ..."};h.print={name:"print ..."};h.header={name:"display FITS header"};h.pageid={name:"display pageid"};
h.savefits={name:"save image as FITS"};h.savepng={name:"save image as PNG"};h.close={name:"close image"};h["sep"+f++]="------";h.lite={name:"new JS9 light window"};h.xnew={name:"new JS9 separate window"};2<a.DEBUG&&(h["sep"+f++]="------",h.refresh={name:"debug: refresh ..."});return{callback:function(b){d().forEach(function(d){var c,g;g=d.image;switch(b){case "close":g&&g.closeImage();break;case "header":g&&(g.raw.header?g.displayAnalysis("text",a.raw2FITS(g.raw,!0),"FITSHeader_"+g.id):a.error("no FITS header for "+
g.id));break;case "lite":a.LoadWindow(null,null,"light");break;case "xnew":a.LoadWindow(null,null,"new");break;case "pageid":d="<center><p>Usage: js9 -pageid [pageid] ...<p>"+a.helper.pageid||"none</center>";a.lightWin("fileid"+a.uniqueID(),"inline",d,"page ID",a.lightOpts[a.LIGHTWIN].lineWin);break;case "open":a.OpenFileMenu(d);break;case "openshared":a.globalOpts.dhtmlloadid="sharedURLForm";g=a.Image.prototype.displayAnalysis.call(null,"textline",a.InstallDir(a.globalOpts.sharedURL),"Open a shared link");
$(g).data("dispid",d.id);break;case "refresh":$("#refreshLocalFile-"+d.id).click();break;case "savefits":g&&(d=g.id.replace(/png/,"fits").replace(/.gz$/,"").replace(/\[.*\]/,""),g.saveFITS(d));break;case "savepng":g&&(d=g.id.replace(/fits/,"png").replace(/.gz$/,"").replace(/\[.*\]/,""),g.savePNG(d));break;case "print":g&&g.print();break;default:for(c=0;c<a.images.length;c++)if(g=a.images[c],d.id===g.display.id&&g.id===b){g.displayImage("display");g.clearMessage();break}}})},items:h}}});$("#viewMenu"+
g.id).on("mousedown",function(a){a.preventDefault();$("#viewMenu"+g.id).contextMenu()});$.contextMenu({selector:"#viewMenu"+g.id,zIndex:a.MENUZINDEX,events:{hide:b},build:function(){var b,c,g,e,f,h="",p=0,s=0,t={},u=d()[0],w=u.image;for(b=0;b<a.plugins.length;b++)if(c=a.plugins[b],g=c.name,c.opts.menuItem&&"view"===c.opts.menu&&(e=u.pluginInstances[g],!e||e.winHandle))c.xclass!==h&&(p+=1),h=c.xclass,t[g]={name:c.opts.menuItem},e&&"active"===e.status&&(t[g].icon="sun");t["sep"+p++]="------";if(w){for(f in w.layers)w.layers.hasOwnProperty(f)&&
...
g.id,zIndex:a.MENUZINDEX,events:{hide:b},build:function(){var b,c,g,e,f,h=0,p=0,s={};f=d()[0];var t=f.image,u="";for(b=0;b<a.plugins.length;b++)if(c=a.plugins[b],e=c.name,c.opts.menuItem&&"analysis"===c.opts.menu&&(g=f.pluginInstances[e],!g||g.winHandle))c.xclass!==u&&(s["sep"+p++]="------",s["sep"+p++]={name:c.xclass+" Plugins:"},s["sep"+(p-1)].disabled=!0),u=c.xclass,s[e]={name:c.opts.menuItem},g&&"active"===g.status&&(s[e].icon="sun"),p++;0<p&&(s["sep"+p++]="------");s.remotetitle={name:"Server-side Tasks:",
disabled:!0};if(t&&t.analysisPackages){e=t.analysisPackages;for(c=0;c<e.length;c++){f=e[c];for(b=0;b<f.length;b++)if(!f[b].hidden&&("fits"!==f[b].files||t.fitsFile)&&!("png"===f[b].files&&"fits2png"!==t.source))g=f[b].title,f[b].purl&&(g+=" ..."),s[f[b].name]={name:g},h++}}h||(s.notasks={name:"[none]",disabled:!0,events:{keyup:function(){}}});s["sep"+p++]="------";s.dpath={name:"set data path ..."};return{callback:function(b){d().forEach(function(d){var c,g,e;g=d.image;for(c=0;c<a.plugins.length;c++)if(e=
a.plugins[c],e.name===b){d.displayPlugin(e);return}if(g)switch(b){case "dpath":a.globalOpts.dhtmlonload=function(){$("#dataPath").val(a.globalOpts.dataPath)};a.globalOpts.dhtmlloadid="dataPathForm";g=g.displayAnalysis("textline",a.InstallDir(a.analOpts.dpathURL),"Data Path for Drag and Drop");$(g).data("dispid",d.id);break;default:if(c=g.lookupAnalysis(b))c.purl?(g=g.displayAnalysis("params",a.InstallDir(c.purl),c.title+": "+g.fitsFile),$(g).data("dispid",d.id).data("aname",c.name)):g.runAnalysis(c.name)}})},
items:s}}});$("#helpMenu"+g.id).on("mousedown",function(a){a.preventDefault();$("#helpMenu"+g.id).contextMenu()});$.contextMenu({selector:"#helpMenu"+g.id,zIndex:a.MENUZINDEX,events:{hide:b},build:function(){var b,c,d=1,g="",e={helptitle:{name:"JS9 Help:",disabled:!0}};for(b in a.helpOpts)a.helpOpts.hasOwnProperty(b)&&(c=a.helpOpts[b],""!==g&&c.type!==g&&(e["sep"+d++]="------",c.heading&&(e["sep"+d++]={name:c.heading+" Help:"},e["sep"+(d-1)].disabled=!0)),g=c.type,e[b]={name:c.title});e["sep"+d++]=
"------";e.about={name:"About JS9"};return{callback:function(b){switch(b){case "about":alert(sprintf("JS9: image display right in your browser\nversion: %s\nprincipals: Eric Mandel (lead), Alexey Vikhlinin (science,management)\ncontact: saord@cfa.harvard.edu\n%s",a.VERSION,a.COPYRIGHT));break;default:a.DisplayHelp(b)}},items:e}}})})};a.Helper=function(){this.helper=this.connected=!1;this.type=a.globalOpts.helperType||"sock.io";this.pageid=null;this.connect()};a.Helper.prototype.connectinfo=function(){if(null===
...
!1;b.helper=!1;1<a.DEBUG&&a.log("JS9 helper: disconnect")});b.socket.on("reconnect",function(){b.connected=!0;b.helper=!0;1<a.DEBUG&&a.log("JS9 helper: reconnect")});b.socket.on("msg",function(b,c){var d,e,f,n=[],r=b.cmd,k=b.id;a.globalOpts.alerts=!1;if(a.publics[r]){$.isArray(b.args)||(b.args=[b.args]);n=$.extend(!0,[],b.args);k&&n.push({display:k});try{f=a.publics[r].apply(null,n)}catch(q){f=sprintf("ERROR: %s",q.message)}c&&c(f);a.globalOpts.alerts=!0}else if(!r||"#"===r)c&&c(""),a.globalOpts.alerts=
!0;else{d=a.lookupCommand(r);e=a.lookupDisplay(k);if(d&&e)switch(d.getDisplayInfo(e),b.args?n=$.extend(!0,[],b.args):b.paramlist&&(n=b.paramlist.split(/ +/)),d.getWhich(n)){case "get":try{f=d.get(n)||""}catch(p){f="ERROR: "+p.message}break;case "set":try{f=d.set(n)||"OK"}catch(s){f="ERROR: "+s.message}break;default:f=sprintf("ERROR: unknown cmd type for '%s'",r)}else d||(f=sprintf("ERROR: unknown cmd '%s'",r)),e||(f=sprintf("ERROR: unknown display (%s)",k));a.globalOpts.alerts=!0;c&&c(f)}})},error:function(b,
...
{fits:d},function(c){var d;c="object"===typeof c?c:0<=c.search(a.analOpts.epattern)?{stderr:c}:{stdout:c};c.stderr&&a.error(c.stderr,a.analOpts.epattern);c.stdout&&(c=c.stdout.replace(/\n*$/,"").split("\n").pop(),d=c.split(".").pop().toLowerCase(),"png"===d?a.checkNew(new a.Image(c,b,e)):a.error("fits2png conversion failed: "+c))}):a.error("no helper available to convert this image: "+d):(a.waiting(!0),c=d.replace(/\[.*\]/,""),a.fetchURL(d,c,b,a.NewFitsImage)));else a.error("JS9.Load: no file specified for image load")});
