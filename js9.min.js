...
(d+1E-5))/100,a.setZoom(d))};b.MouseTouch.Actions["pan the image"]=function(a,b,d){var c;a&&(c=a.rgb.sect,b=(a.pos0.x-a.pos.x)/c.zoom,d=(a.pos0.y-a.pos.y)/c.zoom,1<=Math.abs(b)||1<=Math.abs(d))&&(a.setPan(c.xcen+b,c.ycen-d),a.pos0=a.pos)};b.MouseTouch.Actions.pinch=function(a,c,d){a&&(c=a.display,d=c.zoom0*Math.sqrt((a.pos.touches[0].x-a.pos.touches[1].x)*(a.pos.touches[0].x-a.pos.touches[1].x)+(a.pos.touches[0].y-a.pos.touches[1].y)*(a.pos.touches[0].y-a.pos.touches[1].y))/c.dist0,d=Math.max(b.MINZOOM,
Math.min(b.MAXZOOM,Math.round(100*(d+1E-5))/100)),d!==c.lastzoom&&a.setZoom(d),c.lastzoom=d)};b.MouseTouch.Actions.start=function(a,c,d){a&&(c=a.display,c.ispinch=0,c.dist0=0,c.zoom0=a.rgb.sect.zoom,c.deltas=[]);c=b.MouseTouch.getAction(a,d);b.MouseTouch.Actions[c]&&b.MouseTouch.Actions[c].start&&b.MouseTouch.Actions[c].start(a,a.ipos,d)};b.MouseTouch.Actions.stop=function(a,c,d){c=b.MouseTouch.getAction(a,d);b.MouseTouch.Actions[c]&&b.MouseTouch.Actions[c].stop&&b.MouseTouch.Actions[c].stop(a,a.ipos,
d)};b.MouseTouch.getAction=function(a,c){var d,e;if(!a)return d;e=a.display;switch(a.clickState){case 0:d=e.mouseActions[0];break;case 1:d=e.mouseActions[1];break;case 2:d=e.mouseActions[2];break;case -1:d=e.touchActions[0];break;case -2:switch(b.MouseTouch.isPinch(a,c)){case -1:d=e.touchActions[1];break;case 1:d="pinch"}break;case -3:d=e.touchActions[2]}return d};b.MouseTouch.action=function(a,c,d){if((d=d||b.MouseTouch.getAction(a,c))&&b.MouseTouch.Actions[d])b.MouseTouch.Actions[d](a,a.ipos,c)};
b.MouseTouch.mousetouchzoom=function(a,c){var d=b.lookupDisplay(a),e=c.checked;d&&(d.mousetouchZoom=e)};b.MouseTouch.init=function(){var a,c,d=this;this.divjq.html("");this.divjq.addClass("JS9PluginScrolling");this.mousetouchContainer=$("<div>").addClass(b.MouseTouch.BASE+"Container").attr("id",this.id+"MouseTouchContainer").appendTo(this.divjq);c=sprintf("<div class='%s'><span><b>Drag an action to reconfigure JS9 mouse/touch events:</b></span><p>",b.MouseTouch.BASE+"Header");this.mousetouchHeadContainer=
$("<span style='float: left'>").addClass(b.MouseTouch.BASE+"Container").attr("id",this.id+"MouseTouchHeadContainer").html(c).appendTo(this.mousetouchContainer);this.mousetouchTextContainer=$("<span style='float: left'>").addClass(b.MouseTouch.BASE+"Container").attr("id",this.id+"MouseTouchTextContainer").appendTo(this.mousetouchContainer);this.mousetouchActionContainer=$("<span style='float: left'>").addClass(b.MouseTouch.BASE+"Container").attr("id",this.id+"MouseTouchActionContainer").appendTo(this.mousetouchContainer);
if(b.TOUCHSUPPORTED){this.mousetouchTouchTextContainer=$("<div>").addClass(b.MouseTouch.BASE+"TextContainer").attr("id",this.id+"TouchTextContainer").html("").appendTo(this.mousetouchTextContainer);for(a=0;a<b.MouseTouch.touchText.length;a++)b.MouseTouch.addText.call(this,this.mousetouchTouchTextContainer,b.MouseTouch.touchText[a]);for(a=b.MouseTouch.touchText.length;a<this.display.touchActions.length;a++)b.MouseTouch.addText.call(this,this.mousetouchMouseTextContainer,"&nbsp;");this.mousetouchTouchContainer=
$("<div>").addClass(b.MouseTouch.BASE+"ActionContainer").attr("id",this.id+"TouchContainer").html("").appendTo(this.mousetouchActionContainer);for(a=0;a<this.display.touchActions.length;a++)c=this.display.touchActions[a],b.MouseTouch.addAction.call(this,this.mousetouchTouchContainer,"touch",c);this.mousetouchTouchContainer.sortable({start:function(a,b){this.oidx=b.item.index()},stop:function(a,b){var c=b.item.index(),e=d.display.touchActions.splice(this.oidx,1)[0];d.display.touchActions.splice(c,
0,e)}})}if(!/iPad|iPhone|iPod/.test(navigator.platform)){this.mousetouchMouseTextContainer=$("<div>").addClass(b.MouseTouch.BASE+"TextContainer").attr("id",this.id+"MouseTextContainer").appendTo(this.mousetouchTextContainer);for(a=0;3>a;a++)b.MouseTouch.addText.call(this,this.mousetouchMouseTextContainer,b.MouseTouch.mouseText[a]);for(a=3;a<this.display.mouseActions.length;a++)b.MouseTouch.addText.call(this,this.mousetouchMouseTextContainer,"&nbsp;");this.mousetouchMouseContainer=$("<div>").addClass(b.MouseTouch.BASE+
