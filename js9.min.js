...
!1,this;!0===d&&(this.displayMode=!0,d="all");if(!this.displayMode)return this;"object"===typeof d&&(b=d,d=null);d?"all"===d?(d="colors,scaled,rgb,display,plugins",h.notify=!0):"rgbonly"===d?(d="rgb,nodisplay",h.notify=!0):"display"===d&&(h.notify=!0):d="rgb";d.split(",").forEach(function(a){a=a.trim();h[a]=!0;switch(a){case "colors":h.scaled=!0;h.rgb=!0;break;case "scaled":h.rgb=!0}});h.display=!0;h.plugins=!0;this.rgbFile&&(d.colors=!1,d.scaled=!1);b=b||{};if(this.display.blendMode&&!1!==b.blendMode)for(c=
