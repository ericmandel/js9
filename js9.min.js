...
g;"object"===typeof d?(e=d.stdout,d.stderr&&1<b.DEBUG&&b.log(d.stderr)):e=d;if(e){e=e.trim().match(/(?:[^\s\[]+|\[[^\]]*\])+/g);if(d=b.lookupImage(e[0],c.display.id||b.DEFID))e=e[1],"?"!==e&&(b.globalOpts.dataDir?(g=e.lastIndexOf("/")+1,d.fitsFile=b.globalOpts.dataDir+"/"+e.slice(g)):(d.fitsFile=e,0>d.fitsFile.indexOf("/")&&(a=d.file.match(/.*\//))&&a.length&&(e=new RegExp("^"+b.INSTALLDIR),a=a[0].replace(e,""),d.fitsFile=a+d.fitsFile),b.globalOpts.prependJS9Dir&&(d.fitsFile&&!d.fitsFile.match(/^\${JS9_DIR}/)&&
...
a)break;f=null}}return f};b.Image.prototype.runAnalysis=function(a,c,d){var e,f=this,g={},h=function(a,c){b.helper||b.error(a,c);switch(b.helper.type){case "nodejs":case "socket.io":b.helper.socket&&"polling"===b.helper.socket.io.engine.transport.name?window.setTimeout(function(){b.error(a,c)},0):b.error(a,c);break;default:b.error(a,c)}};if("string"===typeof c)try{c=JSON.parse(c)}catch(k){b.error("can't parse analysis opts: "+c,k)}d=d||b.globalOpts.analysisFunc;if(b.helper.connected&&this.analysisPackages){if(e=
...
{stderr:a}:{stdout:a};c.errcode=c.errcode||0;if(d)d(c.stdout,c.stderr,c.errcode,e);else{if(c.stderr)if(a=c.stderr,0<=a.search(/WARNING:/i)&&0>a.search(/ERROR:/i))b.log(a);else{h(a,b.analOpts.epattern);return}else if(c.errcode)if(a=sprintf("ERROR: running %s [%s]",e.name,c.errcode),c.stdout)b.log(a);else{h(a,b.analOpts.epattern);return}switch(e.rtype){case "text":case void 0:f.displayAnalysis("text",c.stdout,{divid:b.globalOpts.analysisDiv});break;case "plot":f.displayAnalysis("plot",c.stdout,{divid:b.globalOpts.analysisDiv});
break;case "alert":c.stdout&&alert(c.stdout);break;case "fits":case "png":(k=c.stdout.split(/\s+/))&&k[0]&&(a=b.cleanPath(k[0]),"/"!==a.charAt(0)&&(a=b.InstallDir(a)),c={proxyFile:a},k[1]&&(k=b.cleanPath(k[1]),c.parentFile=k),c.fits2fits=!1,b.Load(a,c,{display:f.display}));break;case "regions":(k=c.stdout.split(/\s+/))&&k[0]&&(a=b.cleanPath(k[0]),g={responseType:"text"},b.fetchURL(null,a,g,function(a,b){f.addShapes("regions",a,b)}));break;case "catalog":(k=c.stdout.split(/\s+/))&&k[0]&&(a=b.cleanPath(k[0]),
g={responseType:"text"},b.fetchURL(null,a,g,function(a,b){f.loadCatalog(null,a,b)}));break;case "none":break;default:b.error("unknown analysis result type: "+e.rtype)}}});return this}b.error("could not find analysis task: "+a)}};b.Image.prototype.displayAnalysis=function(a,c,d){var e,f,g,h,k,l,n,m,q,t={x:"linear",y:"linear"};m=b.lightOpts[b.LIGHTWIN];var r=function(a){return 0===a?a:Math.log(a)},u=function(a){return 0===a?a:Math.exp(a)},p=function(a,b){var c,d,e;if(!a.text)return null;d=a.x||0;if("%Y"===
a.y.toUpperCase())for(c=1;c<b.length-1;c++){if(b[c][0]>d){e=Math.max(b[c-1][1],b[c][1],b[c+1][1]);break}}else e=a.y;return{x:d,y:e}},x=function(a,b,c,d){switch(c){case "x":c=b.getAxes().xaxis;break;case "y":c=b.getAxes().yaxis}switch(d){case "linear":c.options.transform=null;c.options.inverseTransform=null;break;case "log":c.options.transform=r,c.options.inverseTransform=u}t[c]=d;b.setupGrid();b.draw()},w=function(a,c,d){var e,f,g,h=d.data,k=d.annotations.color||b.plotOpts.annotateColor;a.find(".plotAnnotation").remove();
...
a.annotations.color||b.plotOpts.annotateColor,h=[];for(c=0;c<a.annotations.data.length;c++)if(d=a.annotations.data[c],e=p(d,f))d={x:e.x,y:e.y,xref:"x",yref:"y",text:d.text,arrowcolor:g,font:{color:g},showarrow:!0,arrowhead:2,ax:0,ay:-30},h.push(d);return h};if("string"===typeof d)try{d=JSON.parse(d)}catch(A){b.error("can't parse display opts: "+d,A)}d=d||{};e=d.winformat;d.divid&&0<$("#"+d.divid).length&&(l=$("#"+d.divid));k=d.title||"";this&&!k&&(d=this.fitsFile||this.id||"",d=d.split("/").reverse()[0],
