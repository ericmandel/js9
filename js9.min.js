...
JS9=function(a){a.DEFID="JS9";a.ANON="[anonymous]";a.PREFSFILE="js9Prefs.json";a.ZINDEX=0;a.SHAPEZINDEX=7;a.MESSZINDEX=8;a.BTNZINDEX=10;a.MENUZINDEX=1E3;a.COLORSIZE=1024;a.SCALESIZE=16384;a.INSTALLDIR="";a.TOROOT="";a.PLUGINS="";a.LIGHTWIN="dhtml";a.ANTIALIAS=!1;a.SCALEIREG=!0;a.NOMOVE=3;a.DBLCLICK=500;a.TIMEOUT=250;a.SPINOUT=250;a.SUPERMENU=/^SUPERMENU_/;a.RESIZEDIST=20;a.RESIZEFUDGE=5;a.RAWID0="raw0";a.RAWIDX="alt";var C=a,z=navigator.platform,G=navigator.appName,D=navigator.userAgent,E,A=D.match(/(opera|chrome|safari|firefox|msie)\/?\s*(\.?\d+(\.\d+)*)/i);
E=D.match(/version\/([\.\d]+)/i);A&&null!==E&&(A[2]=E[1]);A=A?[A[1],A[2],z]:[G,navigator.appVersion,"-?",z];A.push(/Android|webOS|iPhone|iPad|iPod|BlackBerry/i.test(D));C.BROWSER=A;C=a;z=document.createElement("canvas").getContext("2d");C.PIXEL_RATIO=(window.devicePixelRatio||1)/(z.webkitBackingStorePixelRatio||z.mozBackingStorePixelRatio||z.msBackingStorePixelRatio||z.oBackingStorePixelRatio||z.backingStorePixelRatio||1);a.globalOpts={helperType:"none",helperPort:2718,winType:"light",rgb:{active:!1,
rim:null,gim:null,bim:null},defcolor:"#00FF00",pngisfits:!0,fits2png:!1,alerts:!0,internalValPos:!0,internalContrastBias:!0,htimeout:1E4,xtimeout:18E4,extlist:"EVENTS STDEVT",dims:[1024,1024],helperProtocol:location.protocol,maxMemory:75E7,corsURL:"params/loadcors.html",proxyURL:"params/loadproxy.html",loadProxy:!1,archivesURL:"help/archives.html",imsectionURL:"params/imsection.html",postMessage:!1,waitType:"spinner",spinColor:"#FF0000",spinOpacity:0.35,resize:!0,resizeHandle:!0,debug:0};a.imageOpts=
{contrast:1,bias:0.5,invert:!1,exp:1E3,colormap:"grey",scale:"linear",scaleclipping:"dataminmax",zscalecontrast:0.25,zscalesamples:600,zscaleline:120,wcssys:"native",wcsunits:"sexagesimal",lcs:"physical",valpos:!0,opacity:1,sigma:"none",maskOpacity:0.4,alpha:255,alpha1:100,zoom:1,zooms:5,nancolor:"#000000",listonchange:!1};a.regionOpts={};a.analOpts={epattern:/^(ERROR:[^\n]*)\n/,dpathURL:"params/datapath.html",prependJS9Dir:!0,dataDir:null};a.lightOpts={nclick:0,dhtml:{top:".dhtmlwindow",drag:".drag-contentarea",
...
info:"#00FF00",inimage:"#000000"};a.plotOpts={zoomStack:!0,selection:{mode:"xy"},series:{clickable:!0,hoverable:!0,lines:{show:!0},points:{show:!1}}};a.helpOpts={user:{type:"help",url:"user.html",title:"JS9 User Manual"},install:{type:"help",url:"install.html",title:"Installing JS9"},webpage:{type:"help",url:"webpage.html",title:"Adding JS9 To A Web Page"},yourdata:{type:"help",url:"yourdata.html",title:"Adding Data To A Web Page"},localtasks:{type:"help",url:"localtasks.html",title:"Local Analysis with JS9"},
publicapi:{type:"help",url:"publicapi.html",title:"The JS9 Public API"},helper:{type:"help",url:"helper.html",title:"Adding Server-side Analysis"},serverside:{type:"help",url:"serverside.html",title:"Server-side Analysis with JS9"},repfile:{type:"help",url:"repfile.html",title:"Dealing with Large Files"},regions:{type:"help",url:"regions.html",title:"JS9 Regions Format"},extmsg:{type:"help",url:"extmsg.html",title:"JS9 External Messaging"},python:{type:"help",url:"python.html",title:"JS9 with Python and Jupyter"},
...
a.Image.prototype.mkRGBImage=function(){var c,b,d,e,f,g,h,j,k,m,n,p,r,l,q,s,t,v,u,w,y=null,x=null,B=null,F=!1;if(!this.rgb)return this;if(a.globalOpts.rgb.active&&(this===a.globalOpts.rgb.rim||this===a.globalOpts.rgb.gim||this===a.globalOpts.rgb.bim))F=!0,a.globalOpts.rgb.rim&&(y=a.globalOpts.rgb.rim),a.globalOpts.rgb.gim&&(x=a.globalOpts.rgb.gim),a.globalOpts.rgb.bim&&(B=a.globalOpts.rgb.bim);h=this.display.context;c=this.rgb;b=c.sect;if(this.MakeRGBImage&&"function"===typeof this.MakeRGBImage&&
...
this.params.scalemax);e=function(a,c){return a.toFixed(c||3)};var j=function(a,c){var b="",d="";c=c||3;0>a&&(a=Math.abs(a),d="-");for(b+=a;b.length<c;)b="0"+b;return d+b};if(this.params.valpos){void 0===b&&(b=!0);if(this.valpos)return b&&this.displayMessage("info",this.valpos),this.valpos;g={x:c.x,y:c.y,sys:"image"};h="image"===this.params.wcssys?g:this.imageToLogicalPos(c);d=this.raw.data[Math.floor(c.y-0.5)*this.raw.width+Math.floor(c.x-0.5)];switch(this.raw.bitpix){case 8:case 16:case -16:case 32:f=
j(d);break;case -32:case -64:f=a.floatFormattedString(d,f);break;default:f=j(d)}e="value("+f+") "+h.sys+"("+e(h.x,3)+", "+e(h.y,3)+")";d={ix:g.x,iy:g.y,isys:"image",px:h.x,py:h.y,psys:h.sys,ra:"",dec:"",wcssys:"",val:d,val3:f,vstr:e,id:this.id,file:this.file,object:this.object};0<this.wcs&&("image"!==this.params.wcssys&&"physical"!==this.params.wcssys)&&(g=a.pix2wcs(this.wcs,c.x,c.y).trim().split(/\s+/),e=e+" "+g[2]+"("+g[0]+", "+g[1]+")",d.ra=g[0],d.dec=g[1],d.wcssys=g[2],d.vstr=e);b&&this.displayMessage("info",
...
c.oraw){for(d=0;d<this.raws.length;d++)if(g===this.raws[d].id){e=this.raws[d].current0;break}e||(e=this.raw)}else for(d=0;d<this.raws.length;d++)if(c.oraw===this.raws[d].id){e=this.raws[d];break}e||(e=this.raws[0]);h=-1;for(d=0;d<this.raws.length;d++)if(g===this.raws[d].id){f=this.raws[d];h=d;break}if(0>h||c.alwaysCopy){f=$.extend(!0,{},e);f.current0||(f.current0=e);if(c.bitpix){switch(c.bitpix){case 8:f.data=new Uint8Array(e.height*e.width);break;case 16:f.data=new Int16Array(e.height*e.width);break;
case -16:f.data=new Uint16Array(e.height*e.width);break;case 32:f.data=new Int32Array(e.height*e.width);break;case -32:f.data=new Float32Array(e.height*e.width);break;case -64:f.data=new Float64Array(e.height*e.width)}j=f.width*f.height;for(d=0;d<j;d++)f.data[d]=e.data[d];f.bitpix=c.bitpix}else switch(e.bitpix){case 8:f.data=new Uint8Array(e.data);break;case 16:f.data=new Int16Array(e.data);break;case -16:f.data=new Uint16Array(e.data);break;case 32:f.data=new Int32Array(e.data);break;case -32:f.data=
new Float32Array(e.data);break;case -64:f.data=new Float64Array(e.data)}f.id=g;f.from=c.from||f.from||"func"}b.call(this,e,f,c)&&(0<=h?this.raws[h]=f:this.raws.push(f),this.raw=f,this.displayImage("all",c));return!0};a.Image.prototype.gaussBlurData=function(c){var b={};void 0===c&&a.error("missing sigma value for gaussBlurData");b=b||{};b.bitpix=-64===this.raw.bitpix?-64:-32;b.oraw="current0";b.alwaysCopy=!0;b.rawid="gaussBlur";b.sigma=c;this.rawDataLayer(b,function(b,e){var f;switch(e.bitpix){case -32:f=
new Float32Array(e.data);break;case -64:f=new Float64Array(e.data);break;default:a.error("invalid temp bitpix for gaussBlur: "+e.bitpix)}gaussBlur(f,e.data,e.width,e.height,c);return!0})};a.Image.prototype.shiftData=function(c,b,d){(void 0===c||void 0===b)&&a.error("missing translation value(s) for shiftData");d=d||{};d.rawid="shift";d.x=c;d.y=b;this.rawDataLayer(d,function(a,c,b){var d,j,k,m,n=a.data.BYTES_PER_ELEMENT;void 0===c.xoff&&(c.xoff=0);void 0===c.yoff&&(c.yoff=0);c.xoff+=b.x;c.yoff+=b.y;
if(!b.fill||"clear"===b.fill)if("function"===typeof c.data.fill)c.data.fill(0);else for(b=0;b<c.data.length;b++)c.data[b]=0;for(b=0;b<a.height;b++)if(k=b+c.yoff,!(0>k||k>=a.height)){d=0;j=d+c.xoff;m=a.width;0>j&&(d-=j,m+=j,j=0);j+m>a.width&&(m-=j+m-a.width);if(0>=m)return!1;d=(b*a.width+d)*n;d=new Uint8Array(a.data.buffer,d,m*n);j=(k*a.width+j)*n;m=new Uint8Array(c.data.buffer,j,m*n);m.set(d)}return!0})};a.Image.prototype.reprojectData=function(c,b){var d=this,e={},f,g,h,j,k,m,n,p,r=/NAXIS|NAXIS[1-4]|AMDX|AMDY|CD[1-2]_[1-2]|CDELT[1-4]|CNPIX[1-4]|CO1_[1-9][0-9]|CO2_[1-9][0-9]|CROTA[1-4]|CRPIX[1-4]|CRVAL[1-4]|CTYPE[1-4]|CUNIT[1-4]|DATE|DATE_OBS|DC-FLAG|DEC|DETSEC|DETSIZE|EPOCH|EQUINOX|EQUINOX[a-z]|IMAGEH|IMAGEW|LATPOLE|LONGPOLE|MJD-OBS|PC00[1-4]00[1-4]|PC[1-4]_[1-4]|PIXSCALE|PIXSCAL[1-2]|PLTDECH|PLTDECM|PLTDECS|PLTDECSN|PLTRAH|PLTRAM|PLTRAS|PPO|PROJP[1-9]|PROJR0|PV[1-3]_[1-3]|PV[1-4]_[1-4]|RA|RADECSYS|SECPIX|SECPIX|SECPIX[1-2]|UT|UTMID|VELOCITY|VSOURCE|WCSAXES|WCSDEP|WCSDIM|WCSNAME|XPIXSIZE|YPIXSIZE|ZSOURCE|LTM|LTV/,
...
(d.comment=d.comment.trim().toLowerCase());if((h=v.exec(g))&&h[1])try{d.opts=JSON.parse(h[1].trim())}catch(A){d.opts={}}if((h=t.exec(g))&&h[1])d.args=h[1].split(u);d.isregion&&0===d.cmd.indexOf("-")&&(d.cmd=d.cmd.slice(1),d.comment=d.comment?d.comment+",exclude":"exclude");h=d;l=h.args.length;if(h.isregion){g=$.extend(!0,{},h.opts);g.shape=h.cmd;2<=l&&(p=y.call(this,h.args[0],h.args[1]),g.x=p[0],g.y=p[1]);switch(h.cmd){case "annulus":g.radii=[];for(d=2;d<l;d++)g.radii.push(x.call(this,h.args[d],1));
...
a.error("missing argument(s) for cmd: "+b);try{a.Panner.zoom(f,d)}catch(g){a.error("error calling zoomPanner()",g)}break;case "zoomMagnifier":3>arguments.length&&a.error("missing argument(s) for cmd: "+b);try{a.Magnifier.zoom(f,d)}catch(h){a.error("error calling zoomMagnifier()",h)}break;case "panImage":try{f.setPan()}catch(j){a.error("error calling setPan()",j)}}};a.floatPrecision=function(a,b){var d,e;d=Math.floor(Math.log10(a));e=Math.floor(Math.log10(b));return d!==e?d>e?d:e:1};a.floatFormattedString=
function(a,b){var d;-2>b?d=sprintf("%.2e",a):0>b?d=a.toFixed(Math.abs(b)+3):2>b?(d="%."+Math.abs(b)+"f",d=sprintf(d,a)):d=5>b?a.toFixed(0):sprintf("%.2e",a);return d};a.centroidPolygon=function(a){var b,d,e=0,f=0;if(a&&a.length){d=a.length;for(b=0;b<d;b++)e+=a[b].x,f+=a[b].y;return{x:e/d,y:f/d}}};a.lookupImage=function(c,b){var d,e,f=a.images.length;for(d=0;d<f;d++)if(e=a.images[d],c===e||c===e.id||c===e.file||c===a.TOROOT+e.file||e.fitsFile&&c===e.fitsFile)if(0<$("#"+e.display.id).length&&(!b||b===
