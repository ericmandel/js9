...
get:function(){var c,b="";for(c=0;c<a.colormaps.length;c++)b&&(b+=", "),b+=a.colormaps[c].name;return b}})),a.checkNew(new a.Command({name:"global",help:"set/get a JS9.globalOpts parameter",set:function(c){if(1==c.length){var b=a.globalOpts[c[0]];if(a.notNull(b))switch(typeof b){case "boolean":return b?"true":"false";case "number":return String(b);case "string":return b;case "object":return JSON.stringify(b);default:return""}}else if(2==c.length){var d=c[0];if(a.notNull(a.globalOpts[d]))switch(typeof a.globalOpts[d]){case "boolean":b=
c[1].match(/true/i)?!0:!1;a.globalOpts[d]=b;break;case "number":b=parseFloat(c[1]);a.globalOpts[d]=b;break;case "string":a.globalOpts[d]=b;break;case "object":try{b=JSON.parse(c[1])}catch(e){a.error("invalid JSON for global cmd: "+c[1])}a.globalOpts[d]=b}}}})),a.checkNew(new a.Command({name:"grid",help:"set/get coordinate grid for current image",get:function(){var a,b=this.image;b&&(a=b.displayCoordGrid());return a?"true":"false"},set:function(a){var b=this.image;if(b){var c=a[0].match(/true/i)?!0:
!1;b.displayCoordGrid(c,a[1])}}})),a.checkNew(new a.Command({name:"help",help:"get list of available commmands",get:function(){var c,b="<table class='JS9CmdHelp'>";for(c=0;c<a.commands.length;c++){var d=a.commands[c];b+="<tr><td>"+d.name+"</td><td>"+d.help;d.alias&&(b+=" ("+d.alias,d.alias2&&(b+=", "+d.alias2),b+=")");b+="</td></tr>"}return b+'<tr><td colspan="2">&nbsp;</td></tr><tr><td colspan="2">Or execute JS9 public access routines (spaceless args, please):</td></tr><tr><td colspan="2">&nbsp;</td></tr><tr><td colspan="2">SetColormap heat</td></tr><tr><td colspan="2">GetColormap</td></tr><tr><td colspan="2">{"colormap":"heat","contrast":3.75,"bias":0.736328125}</td></tr><tr><td colspan="2">AddRegions circle(23:23:27.9,+58:48:42.8,3") {"color":"cyan"}</td></tr></table>'}})),
