...
a.helper.send("getAnalysis",{fits:this.fitsFile},function(c){if(c)try{b.analysisPackages=JSON.parse(c)}catch(e){a.log("can't get analysis",e)}});return this};a.Image.prototype.expandMacro=function(c,b){var d,e=this;if(c)return c.replace(/\${?([a-zA-Z][a-zA-Z0-9_()]+)}?/g,function(c,g,h){var f;h=function(a,b){var c=a.params.wcssys;if(b)switch(b){case "wcs":if("physical"===c||"image"===c)a.params.wcssys=a.params.wcssys0;break;case "physical":case "image":a.params.wcssys=b}return c};var l=function(a,
...
this.analysisPackages){if(e=this.lookupAnalysis(c)){e.action&&(g.cmd=this.expandMacro(e.action,b));if(e.keys)for(g.keys={},c=0;c<e.keys.length;c++)g.keys[e.keys[c]]=this.expandMacro("$"+e.keys[c],b);g.id=this.expandMacro("$id");g.image=this.file;g.fits=this.fitsFile;g.rtype=e.rtype;switch(a.helper.type){case "nodejs":case "socket.io":b=e.xclass?e.xclass+":"+e.name:e.name;break;default:b="runAnalysis"}a.waiting(!0,this.display.divjq[0]);a.helper.send(b,g,function(b){var c,g;a.waiting(!1);c="object"===
...
b,a.fits.options);void 0===d&&(d=a.Load);e.onload=function(a){var e=new Image,f,k,l;e.src=a.target.result;e.onload=function(){var a,g,h,m=0;a=document.createElement("canvas");g=a.getContext("2d");var q=e.height,r=e.width;a.width=r;a.height=q;g.drawImage(e,0,0);f=g.getImageData(0,0,r,q).data;k=new Float32Array(q*r);for(g=0;g<q;g++)for(a=0;a<r;a++)h=.299*f[m]+.587*f[m+1]+.114*f[m+2],k[(q-g)*r+a]=h,m+=4;l={head:{},filename:c.name,filedata:k,naxis:2,axis:[0,r,q],bitpix:-32,data:k};l.dmin=Number.MAX_VALUE;
l.dmax=Number.MIN_VALUE;for(m=0;m<q*r;m++)l.dmin=Math.min(l.dmin,l.data[m]),l.dmax=Math.max(l.dmax,l.data[m]);d(l,b)}};e.readAsDataURL(c)};a.lookupColormap=function(c){var b;c||(c=a.imageOpts.colormap);if(c)for(b=0;b<a.colormaps.length;b++)if(a.colormaps[b].name===c)return a.colormaps[b];a.error("unknown colormap '"+c+"'")};a.lookupCommand=function(c){var b,d;if(c)for(d=c.toLowerCase(),b=0;b<a.commands.length;b++)if(c=a.commands[b],c.name===d||c.alias===d||c.alias2===d)return c;return null};a.error=
...
this.data[e][c]=h.val,this.delims[c]=h.delim||null;for(c=0;c<this.headline.length;c++)this[this.headline[c]]=c}}};a.mouseDownCB=function(c){var b=c.data,d=b.image;if(d){c.target&&(d.posOffset=$(c.target).offset());d.pos0=a.eventToDisplayPos(c,d.posOffset);d.pos=d.pos0;d.ipos0=d.displayToImagePos(d.pos);d.ipos=d.ipos0;b.resizing=b.inResize(d.pos);if(!b.resizing){c.preventDefault();a.hasOwnProperty("MouseTouch")&&a.MouseTouch.action(d,c,"start");if(d.clickInRegion){d.clearMessage("regions");return}a.specialKey(c)||
d.xeqPlugins("mouse","onmousedown",c)}d.clickState=c.which;switch(c.which){case 3:d.clickState=2}c.originalEvent&&c.originalEvent.touches&&c.originalEvent.touches.length&&(d.clickState=-c.originalEvent.touches.length);$(document).on("mousemove."+b.id,b,function(b){return a.mouseMoveCB(b)});$(document).on("mouseup."+b.id,b,function(b){return a.mouseUpCB(b)})}};a.mouseUpCB=function(c){var b,d,e=c.data;if(b=e.image)for(b.pos=a.eventToDisplayPos(c,b.posOffset),b.ipos=b.displayToImagePos(b.pos),e.inResize(b.pos)||
c.preventDefault(),a.hasOwnProperty("MouseTouch")&&a.MouseTouch.action(b,c,"stop"),b.clickInRegion&&(Math.abs(b.pos0.x-b.pos.x)<a.NOMOVE&&Math.abs(b.pos0.y-b.pos.y)<a.NOMOVE?b.updateShapes("regions","selected","select"):b.updateShapes("regions","selected","update")),a.specialKey(c)||b.xeqPlugins("mouse","onmouseup",c),b.clickInRegion=!1,b.clickState=0,b.posOffset=null,e.resizing&&(e.resizing=!1,a.bugs.webkit_resize&&(c=parseInt(e.divjq.css("width"),10),d=parseInt(e.divjq.css("height"),10),c<e.owidth&&
...
d.pos),d.ipos0||(d.ipos0=d.ipos),b.resizing||(c.preventDefault(),d.valpos=null,d.clickInRegion&&(b=d.display.layers.regions.params.sel)&&(d.params.listonchange||b.params.listonchange)&&(d.updateShape("regions",b,null,"update",!0),d.listRegions("selected",2)),a.hasOwnProperty("MouseTouch")&&a.MouseTouch.action(d,c),a.specialKey(c)||(d.valpos||(d.valpos=d.updateValpos(d.ipos,!1)),a.specialKey(c)||d.xeqPlugins("mouse","onmousemove",c))))};a.mouseOverCB=function(c){var b=c.data.image,d=$(document).scrollLeft(),
...
c.data,d=b.image;b.mousetouchZoom&&d&&a.hasOwnProperty("MouseTouch")&&a.MouseTouch.Actions["wheel zoom"]&&(a.MouseTouch.Actions["wheel zoom"](d,c),c.preventDefault())};a.keyPressCB=function(a){var b=a.data.image;a.preventDefault();b&&b.xeqPlugins("keypress","onkeypress",a)};a.keyDownCB=function(c){var b,d=c.data.image;a.hasOwnProperty("Keyboard")&&(b=d?d.ipos:{x:null,y:null},a.Keyboard.action(d,b,c));d&&d.xeqPlugins("keypress","onkeydown",c)};a.dragenterCB=function(a,b){b.stopPropagation();b.preventDefault()};
a.dragoverCB=function(a,b){b.stopPropagation();b.preventDefault()};a.dragexitCB=function(a,b){b.stopPropagation();b.preventDefault()};a.dragdropCB=function(c,b,d){var e,f,g;b.originalEvent&&(b=b.originalEvent);b.stopPropagation();b.preventDefault();f=$.extend(!0,{},a.fits.options);f.display=f.display||c;f.extlist=f.extlist||a.globalOpts.extlist;g=b.target.files||b.dataTransfer.files;(c=a.lookupDisplay(f.display))&&c.divjq&&a.waiting(!0,c.divjq[0]);window.setTimeout(function(){for(e=0;e<g.length;e++)a.Load(g[e],
f,d)},a.SPINOUT)};a.RegisterPlugin=function(c,b,d,e){var f,g;c&&b&&d&&(f=c+b,e?(e.viewMenuItem&&(e.menuItem=e.viewMenuItem),e.menuItem&&!e.menu&&(e.menu="view"),e.menu&&(e.menu=e.menu.toLowerCase())):e=[],a.PLUGINS&&(a.PLUGINS+="|"),a.PLUGINS+=f.replace(/JS9/,""),a.plugins.push({xclass:c,xname:b,name:f,opts:e,func:d,instances:[]}),e.help&&(d=e.help.match(/^.*[\\\/]/),d[0]&&(g="plugins/"+d[0].replace(/[\\\/]+$/,"")),d=e.help.replace(/^.*[\\\/]/,""),e=e.menuItem?e.menuItem:f,a.helpOpts[b]={type:g,url:d,
heading:c,title:e}))};a.instantiatePlugin=function(c,b,d,e){var f,g,h;if("string"===typeof b){for(f=0;f<a.plugins.length;f++)if(g=a.plugins[f],g.name===b){b=g;break}"string"===typeof b&&a.error("unknown plugin: "+b)}g=Object.create(b.func.prototype);g.name=b.name;g.isActive=function(a){if("active"!==this.status||a&&!this.plugin.opts.hasOwnProperty(a))return!1;switch(this.winType){case "virtual":return!0;default:return this.divjq.is(":visible")}};g.errLog=function(b,c){a.log("error in %s: %s [%s]\n%s",
...
a.RegisterPlugin(a.MouseTouch.CLASS,a.MouseTouch.NAME,a.MouseTouch.init,{menuItem:"Mouse/Touch",onplugindisplay:a.MouseTouch.init,help:"help/mousetouch.html",winTitle:"Mouse/Touch Actions",winResize:!0,winDims:[a.MouseTouch.WIDTH,a.MouseTouch.HEIGHT]});a.RegisterPlugin(a.Regions.CLASS,a.Regions.NAME,a.Regions.init,{onregionschange:a.Regions.onchange,divArgs:["regions"],winDims:[0,0]});a.instantiatePlugins();a.plugins.sort(function(a,c){var b=a.opts.menuItem,d=c.opts.menuItem;return b?!d||b<d?-1:b>
...
f*(1-g));l[n]=[];switch(k){case 0:l[n].push(c);l[n].push(f);l[n].push(e);break;case 1:l[n].push(h);l[n].push(c);l[n].push(e);break;case 2:l[n].push(e);l[n].push(c);l[n].push(f);break;case 3:l[n].push(e);l[n].push(h);l[n].push(c);break;case 4:l[n].push(f);l[n].push(e);l[n].push(c);break;case 5:l[n].push(c),l[n].push(e),l[n].push(h)}}return l}()));a.checkNew(new a.Colormap("rainbow",[[0,1],[.2,0],[.6,0],[.8,1],[1,1]],[[0,0],[.2,0],[.4,1],[.8,1],[1,0]],[[0,1],[.4,1],[.6,0],[1,0]]));a.checkNew(new a.Colormap("standard",
[[0,0],[.333,.3],[.333,0],[.666,.3],[.666,.3],[1,1]],[[0,0],[.333,.3],[.333,.3],[.666,1],[.666,0],[1,.3]],[[0,0],[.333,1],[.333,0],[.666,.3],[.666,0],[1,.3]]));a.checkNew(new a.Colormap("staircase",function(){var a,c,e=[],f=0;for(a=1;5>=a;a++,f++)c=a/5,e[f]=[],e[f].push(.3*c),e[f].push(.3*c),e[f].push(c);for(a=1;5>=a;a++,f++)c=a/5,e[f]=[],e[f].push(.3*c),e[f].push(c),e[f].push(.3*c);for(a=1;5>=a;a++,f++)c=a/5,e[f]=[],e[f].push(c),e[f].push(.3*c),e[f].push(.3*c);return e}()));a.checkNew(new a.Colormap("color",
...
d=e||sprintf("<div class='JS9Menubar' id='%sMenubar'></div><div class='JS9' id='%s'></div><div style='margin-top: 2px;'><div class='JS9Colorbar' id='%sColorbar'></div></div>",g,g,g),e=sprintf("<html><head>%s</head><body",f),c&&(e+=sprintf(" onload='JS9.Preload(\"%s\",%s);'",c,JSON.stringify(b))),e+=sprintf(">%s</body></html>\n",d),c=window.open(null,g,"width=540, height=605"),c=c.document,c.open(),c.write(e),c.close(),g}});a.mkPublic("LoadProxy",function(c,b){var d,e,f=a.parsePublicArgs(arguments);
...
g]),b++;else if(d<h&&0===arguments[d].indexOf("{")){try{f=JSON.parse(arguments[d])}catch(k){f=null}a.preloads.push([arguments[b],f,g]);b++}else a.preloads.push([arguments[b],null,g]);break;case 1:a.globalOpts.alerts=!1;for(b=0;b<h;b++)if(d=b+1,d<h&&"object"===typeof arguments[d]){try{g?a.Load(arguments[b],arguments[d],g):a.Load(arguments[b],arguments[d])}catch(k){e=e+" "+arguments[b]}b++}else if(d<h&&0===arguments[d].indexOf("{")){try{f=JSON.parse(arguments[d])}catch(k){f=null}try{g?a.Load(arguments[b],
f,g):a.Load(arguments[b],f)}catch(k){e=e+" "+arguments[b]}b++}else try{g?a.Load(arguments[b],null,g):a.Load(arguments[b],null)}catch(k){e=e+" "+arguments[b]}a.globalOpts.alerts=!0;e&&a.error("could not preload image(s): "+e);break;case 2:a.globalOpts.alerts=!1;for(b=0;b<a.preloads.length;b++)try{a.preloads[b][2]?a.Load(a.preloads[b][0],a.preloads[b][1],a.preloads[b][2]):a.Load(a.preloads[b][0],a.preloads[b][1])}catch(k){e=e+" "+a.preloads[b][0]}a.globalOpts.alerts=!0;e&&a.error("could not preload image(s): "+
e);a.preloads=[]}});a.mkPublic("RefreshImage",function(c,b){var d=a.parsePublicArgs(arguments),e=a.getImage(d.display),f=function(c){a.Image.prototype.refreshImage.call(e,c,b)};c=d.argv[0];b=d.argv[1]||{};if(e)if(c instanceof Blob){!b.rawid&&a.fits.cleanupFITSFile&&e.raw.hdu&&e.raw.hdu.fits&&a.fits.cleanupFITSFile(e.raw.hdu.fits,!0);try{a.handleFITSFile(c,a.fits.options,f)}catch(g){a.error("can't refresh FITS file",g)}}else a.Image.prototype.refreshImage.apply(e,d.argv);else c instanceof Blob&&a.Load.apply(null,
arguments)});a.mkPublic("GetLoadStatus",function(c){var b=a.parsePublicArgs(arguments),d=a.getImage(b.display);return d?(c=b.argv[0])&&d.id0!==c?"other":d.status.load:"none"});a.mkPublic("CopyToClipboard",function(c){var b,d,e=document.createElement("textarea");e.style.position="fixed";e.style.top=0;e.style.left=0;e.style.width="2em";e.style.height="2em";e.style.padding=0;e.style.border="none";e.style.outline="none";e.style.boxShadow="none";e.style.background="transparent";e.value=c;document.body.appendChild(e);
e.select();try{(d=document.execCommand("copy"))?b="OK":(b="MANUAL",a.BROWSER[2].match(/Mac/)?window.prompt("copy to clipboard: Cmd+C",c):window.prompt("copy to clipboard: Ctrl+C",c))}catch(f){b="ERROR"}document.body.removeChild(e);return b});a.mkPublic("OpenFileMenu",function(){var c=a.parsePublicArgs(arguments);(c=a.lookupDisplay(c.display))&&$("#openLocalFile-"+c.id).click()});a.mkPublic("OpenRegionsMenu",function(){var c=a.parsePublicArgs(arguments);(c=a.lookupDisplay(c.display))&&$("#openLocalRegions-"+
c.id).click()});a.mkPublic("OpenSessionMenu",function(){var c=a.parsePublicArgs(arguments);(c=a.lookupDisplay(c.display))&&$("#openLocalSession-"+c.id).click()});a.mkPublic("OpenCatalogsMenu",function(){var c=a.parsePublicArgs(arguments);(c=a.lookupDisplay(c.display))&&$("#openLocalCatalogs-"+c.id).click()});a.mkPublic("OpenColormapMenu",function(){var c=a.parsePublicArgs(arguments);(c=a.lookupDisplay(c.display))&&$("#openLocalColormap-"+c.id).click()});a.mkPublic("SaveColormap",function(c){var b,
d=a.parsePublicArgs(arguments);if(window.hasOwnProperty("saveAs")){if(b=a.getImage(d.display))c=d.argv[0]||"js9.cmap",b=$.extend(!0,{},b.cmapObj),delete b.type,b=JSON.stringify(b),b=new Blob([b],{type:"text/plain"}),saveAs(b,c)}else a.error("no saveAs function available to save colormap");return c});a.mkPublic("DisplayPlugin",function(c){var b,d,e,f;b=a.parsePublicArgs(arguments);var g=a.lookupDisplay(b.display);if(g&&b.argv[0]){c=b.argv[0];f=c.toLowerCase();for(b=0;b<a.plugins.length;b++)if(d=a.plugins[b],
