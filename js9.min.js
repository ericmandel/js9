...
c,d,e,f){var g,h,k,l,n,m={},q="fits2"+e;g=d[q]||void 0===d[q]&&b.globalOpts[q];!0===g?g="always":!1===g&&(g="never");if(g.match(/never/i)||!b.helper.connected||"nodejs"!==b.helper.type&&"socket.io"!==b.helper.type)return!1;if(!b.helper.js9helper)if(b.globalOpts.requireHelper)b.error("js9helper executable not found for fits2fits processing");else return!1;switch(q){case "fits2png":break;case "fits2fits":if(!b.globalOpts.workDir)return!1;e=d.xdim||b.fits.options.image.xdim||b.fits.options.table.xdim;
h=d.ydim||b.fits.options.image.ydim||b.fits.options.table.ydim;k=d.bin||b.fits.options.image.bin||b.fits.options.table.bin;l=d.binMode||b.globalOpts.binMode;l="a"===l?"a":"";"string"===typeof k&&(k.match(/[as]$/)&&(l=k.slice(-1)),k=parseInt(k,10));k=Math.max(1,k||1);m.sect=void 0!==d.xcen&&void 0!==d.ycen?sprintf("%s@%s,%s@%s,%s%s",e,d.xcen,h,d.ycen,k,l):sprintf("%s,%s,%s%s",e,h,k,l);e=g.toLowerCase().split(/[>,]/);for(g=0;g<e.length;g++)switch(e[g]){case "size":e[g+1]&&(b.isNumber(e[g+1])&&(m.maxsize=
