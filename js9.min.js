...
2;0===arguments.length&&(d=j,c=k);this.mkSection(d,c);if(this.display.blendMode)for(b=0;b<a.images.length;b++)h=a.images[b],h!==this&&(h.display===this.display&&h.blend.active)&&(f=h.raw.width/2,g=h.raw.height/2,0!==arguments.length&&(f-=j-d,g-=k-c),a.Image.prototype.mkSection.call(h,f,g));this.displayImage("rgb");for(e in this.layers)this.layers.hasOwnProperty(e)&&this.layers[e].show&&this.layers[e].opts.panzoom&&this.refreshShapes(e);return this};a.Image.prototype.getZoom=function(){return this.rgb.sect.zoom};
...
a.helper.send("getAnalysis",{fits:this.fitsFile},function(d){if(d)try{c.analysisPackages=JSON.parse(d)}catch(e){a.log("can't get analysis",e)}});return this};a.Image.prototype.expandMacro=function(d,c){var b,e,f=this;if(d)return b=d.replace(/\$([a-zA-Z0-9_()]+)/g,function(d,b){var j,k;j=function(a,d){var b=a.params.wcssys;if(d)switch(d){case "wcs":if("physical"===b||"image"===b)a.params.wcssys=a.params.wcssys0;break;case "physical":case "image":a.params.wcssys=d}return b};var m=b.split("(");m[1]&&
...
c=c||{};c.bitpix=-64===this.raw.bitpix?-64:-32;c.oraw="current0";c.alwaysCopy=!0;c.rawid="gaussBlur";c.sigma=d;this.rawDataLayer(c,function(b,c){var f;switch(c.bitpix){case -32:f=new Float32Array(c.data);break;case -64:f=new Float64Array(c.data);break;default:a.error("invalid temp bitpix for gaussBlur: "+c.bitpix)}gaussBlur(f,c.data,c.width,c.height,d);return!0})};a.Image.prototype.shiftData=function(d,c,b){(void 0===d||void 0===c)&&a.error("missing translation value(s) for shiftData");b=b||{};b.rawid=
"shift";b.x=d;b.y=c;this.rawDataLayer(b,function(a,d,b){var c,j,k,m,n=a.data.BYTES_PER_ELEMENT;void 0===d.xoff&&(d.xoff=0);void 0===d.yoff&&(d.yoff=0);d.xoff+=b.x;d.yoff+=b.y;if(!b.fill||"clear"===b.fill)if("function"===typeof d.data.fill)d.data.fill(0);else for(b=0;b<d.data.length;b++)d.data[b]=0;for(b=0;b<a.height;b++)if(k=b+d.yoff,!(0>k||k>=a.height)){c=0;j=c+d.xoff;m=a.width;0>j&&(c-=j,m+=j,j=0);j+m>a.width&&(m-=j+m-a.width);if(0>=m)return!1;c=(b*a.width+c)*n;c=new Uint8Array(a.data.buffer,c,
m*n);j=(k*a.width+j)*n;m=new Uint8Array(d.data.buffer,j,m*n);m.set(c)}return!0})};a.Image.prototype.reprojectData=function(d,c){var b=this,e={},f=!1,g,h,j,k,m,n,p,r,l;l=/NAXIS|NAXIS[1-4]|AMDX|AMDY|CD[1-2]_[1-2]|CDELT[1-4]|CNPIX[1-4]|CO1_[1-9][0-9]|CO2_[1-9][0-9]|CROTA[1-4]|CRPIX[1-4]|CRVAL[1-4]|CTYPE[1-4]|CUNIT[1-4]|DATE|DATE_OBS|DC-FLAG|DEC|DETSEC|DETSIZE|EPOCH|EQUINOX|EQUINOX[a-z]|IMAGEH|IMAGEW|LATPOLE|LONGPOLE|MJD-OBS|PC00[1-4]00[1-4]|PC[1-4]_[1-4]|PIXSCALE|PIXSCAL[1-2]|PLTDECH|PLTDECM|PLTDECS|PLTDECSN|PLTRAH|PLTRAM|PLTRAS|PPO|PROJP[1-9]|PROJR0|PV[1-3]_[1-3]|PV[1-4]_[1-4]|RA|RADECSYS|SECPIX|SECPIX|SECPIX[1-2]|UT|UTMID|VELOCITY|VSOURCE|WCSAXES|WCSDEP|WCSDIM|WCSNAME|XPIXSIZE|YPIXSIZE|ZSOURCE|LTM|LTV/;
...
"------";q.zoom={events:{keyup:function(a){var d=$.contextMenu.getInputValues(a.data),c=g.display.image;switch(a.which||a.keyCode){case 9:case 13:c&&(isNaN(d.zoom)||c.setZoom(d.zoom),a.data.edited=!1);break;default:a.data.edited=!0}}},name:"numeric zoom value:",type:"text"};q["sep"+h++]="------";q.center={name:"pan to center"};q.reset={name:"reset zoom/pan"};return{callback:function(a){c().forEach(function(d){if(d=d.image)switch(a){case "zoomIn":d.setZoom("x2");break;case "zoomOut":d.setZoom("/2");
break;case "zoomToFit":d.setZoom("tofit");break;case "center":d.setPan();break;case "reset":d.setZoom("1");d.setPan();break;default:a.match(/^zoom/)&&d.setZoom(a.slice(4))}})},events:{show:function(d){var c=g.display.image,b={};c&&(b.zoom=String(c.rgb.sect.zoom));$.contextMenu.setInputValues(d,b);a.jupyterFocus(".context-menu-item")},hide:function(a){var d=g.display.image;d&&a.edited&&(delete a.edited,a=$.contextMenu.getInputValues(a),isNaN(a.zoom)||d.setZoom(a.zoom))}},items:q}}});$("#scaleMenu"+
