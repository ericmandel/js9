...
alert("When using the file:// URI, Chrome must be run with the --allow-file-access-from-files switch to permit JS9 to access data."):alert("could not read off-screen image data [same-origin policy violation?]")}return this};a.Image.prototype.initLCS=function(a){var b=[[0,0,0],[0,0,0],[0,0,0]],d=function(a){var b,d,c=0,e=0,l=[[0,0,0],[0,0,0],[0,0,0]],n=a[0][0]*a[1][1];for(b=0;3>b;b++)for(d=0;2>d;d++)if(void 0===a[b][d]||isNaN(a[b][d]))return null;0<=n?c+=n:e+=n;n=-a[0][1]*a[1][0];0<=n?c+=n:e+=n;b=
...
{xmax:a.globalOpts.image.xmax,ymax:a.globalOpts.image.ymax});a.fits.maxFITSMemory&&a.globalOpts.maxMemory&&a.fits.maxFITSMemory(a.globalOpts.maxMemory);break;default:a.error("unknown fits library: "+c)}a.fits.name=b;a.fits.options.error=a.error;a.fits.options.waiting=a.waiting;return b};a.handleImageFile=function(c,b,d){var e=new FileReader;b=$.extend(!0,{},b,a.fits.options);void 0===d&&(d=a.Load);e.onload=function(a){var e=new Image,f,k,l;e.src=a.target.result;e.onload=function(){var a,g,h,m=0;a=
document.createElement("canvas");g=a.getContext("2d");var q=e.height,r=e.width;a.width=r;a.height=q;g.drawImage(e,0,0);f=g.getImageData(0,0,r,q).data;k=new Float32Array(q*r);for(g=0;g<q;g++)for(a=0;a<r;a++)h=.299*f[m]+.587*f[m+1]+.114*f[m+2],k[(q-g)*r+a]=h,m+=4;l={head:{},filename:c.name,filedata:k,naxis:2,axis:[0,r,q],bitpix:-32,data:k};l.dmin=Number.MAX_VALUE;l.dmax=Number.MIN_VALUE;for(m=0;m<q*r;m++)l.dmin=Math.min(l.dmin,l.data[m]),l.dmax=Math.max(l.dmax,l.data[m]);d(l,b)}};e.readAsDataURL(c)};
...
(e=b);3>arguments.length&&(d=!0);if(k&&(e&&e.message?c+=sprintf(" (%s)",e.message):c&&(e=Error(c)),(f=a.strace(e))&&(h="\n\nStacktrace:\n"+f),a.globalOpts.alerts&&(c&&"string"===typeof c&&0>c.search(/ERROR/)&&(g="JS9 ERROR: "),alert(g+(c+h))),d))throw e;};a.eventToCharStr=function(a){var b,c,e={37:"leftArrow",38:"upArrow",39:"rightArrow",40:"downArrow",8:"delete",46:"delete"},f={188:"44",109:"45",190:"46",191:"47",192:"96",220:"92",222:"39",221:"93",219:"91",173:"45",187:"61",186:"59",189:"45"},g=
{96:"~",49:"!",50:"@",51:"#",52:"$",53:"%",54:"^",55:"&",56:"*",57:"(",48:")",45:"_",61:"+",91:"{",93:"}",92:"|",59:":",39:'"',44:"<",46:">",47:"?"};b="number"===typeof a?a:a.which||a.keyCode;c=String(b);f.hasOwnProperty(c)&&(b=f[c]);return b=!a.shiftKey&&65<=b&&90>=b?String.fromCharCode(b+32):!a.shiftKey&&e.hasOwnProperty(b)?e[b]:a.shiftKey&&g.hasOwnProperty(b)?g[b]:String.fromCharCode(b)};a.eventToDisplayPos=function(a,b){var c,e,f,g,h;a||(a=window.event);a.target?e=a.target:a.srcElement&&(e=a.srcElement);
3===e.nodeType&&(e=e.parentNode);b=b||$(e).offset();a.originalEvent?a.originalEvent.touches&&a.originalEvent.touches.length?(h=a.originalEvent.touches,c=h[0].pageX,f=h[0].pageY):a.originalEvent.changedTouches&&a.originalEvent.changedTouches.length?(h=a.originalEvent.changedTouches,c=h[0].pageX,f=h[0].pageY):(c=a.pageX,f=a.pageY):(c=a.pageX,f=a.pageY);e=b.left+1;g=b.top+1;f={x:Math.floor(c-e),y:Math.floor(f-g)};if(h&&h.length)for(f.touches=[{x:f.x,y:f.y}],c=1;c<h.length;c++)f.touches[c]={x:Math.floor(h[c].pageX-
e),y:Math.floor(h[c].pageY-g)};return f};a.rotatePoint=function(a,b,d){var c;d=d||{x:0,y:0};b=Math.PI*b/180;c=Math.cos(b);b=Math.sin(b);return{x:c*(a.x-d.x)-b*(a.y-d.y)+d.x,y:b*(a.x-d.x)+c*(a.y-d.y)+d.y}};a.log=function(){var a;if(void 0!==window.console&&void 0!==window.console.log)try{console.log.apply(console,arguments)}catch(b){a=Function.prototype.bind.call(console.log,console),a.apply(console,arguments)}};a.isNumber=function(a){return!isNaN(parseFloat(a))&&isFinite(a)};a.notNull=function(a){return void 0!==
a&&null!==a};a.cardpars=function(c){var b;if("="===c[8])return b=c.slice(0,8).trim(),c=c.slice(10).replace(/\'/g," ").replace(/\/.*/,"").trim(),"T"===c?c=!0:"F"===c?c=!1:a.isNumber(c)&&(c=parseFloat(c)),[b,c]};a.raw2FITS=function(a,b){var c,e,f,g=!1,h="";if(!a)return h;if(a.card)for(c=0;c<a.card.length;c++)e=a.card[c],h+=e,"END "===e.substring(0,4)&&(g=!0),b&&(h+="\n");else if(a.cardstr)for(c=0;c<a.ncard;c++)e=a.cardstr.slice(80*c,80*(c+1)),e.match(/^BITPIX/)&&a.bitpix?(f=e.replace(/BITPIX *= *(-?[0-9][0-9]*) */,
"$1"),f=parseInt(f,10),h=f!==a.bitpix?h+sprintf("BITPIX  = %20s / %-47s",a.bitpix,"bits/pixel"):h+e):h+=e,"END "===e.substring(0,4)&&(g=!0),b&&(h+="\n");else if(a.header)for(e in c=a.header,c)c.hasOwnProperty(e)&&"js9Protocol"!==e&&"js9Endian"!==e&&("END"===e&&(g=!0),f=c[e],!0===f&&(f="T"),h+=sprintf("%-8s%-2s%-70s",e,"=",f),b&&(h+="\n"));else if(a.BITPIX)for(e in c=a,c)c.hasOwnProperty(e)&&"js9Protocol"!==e&&"js9Endian"!==e&&("END"===e&&(g=!0),f=c[e],!0===f&&(f="T"),h+=sprintf("%-8s%-2s%-70s",e,
...
a.vmemcpy=Astroem.vmemcpy,a.vfile=Astroem.vfile,a.vunlink=Astroem.vunlink,a.vsize=Astroem.vsize,a.arrfile=Astroem.arrfile,a.listhdu=Astroem.listhdu,a.initwcs=Astroem.initwcs,a.wcsinfo=Astroem.wcsinfo,a.wcssys=Astroem.wcssys,a.wcsunits=Astroem.wcsunits,a.pix2wcs=Astroem.pix2wcs,a.wcs2pix=Astroem.wcs2pix,a.reg2wcs=Astroem.reg2wcs,a.saostrtod=Astroem.saostrtod,a.saodtype=Astroem.saodtype,a.zscale=Astroem.zscale,a.tanhdr=Astroem.tanhdr,a.reproject=Astroem.reproject);window.hasOwnProperty("Fitsy")?(a.fitsLibrary("fitsy"),
a.fits=Fitsy):window.hasOwnProperty("Astroem")&&(a.fitsLibrary("cfitsio"),a.fits=Astroem);$("div.JS9").each(function(){a.checkNew(new a.Display($(this)))});a.RegisterPlugin(a.MouseTouch.CLASS,a.MouseTouch.NAME,a.MouseTouch.init,{menuItem:"Mouse/Touch",onplugindisplay:a.MouseTouch.init,help:"help/mousetouch.html",winTitle:"Mouse/Touch Actions",winResize:!0,winDims:[a.MouseTouch.WIDTH,a.MouseTouch.HEIGHT]});a.RegisterPlugin(a.Regions.CLASS,a.Regions.NAME,a.Regions.init,{onregionschange:a.Regions.onchange,
