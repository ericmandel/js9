...
d.clickInRegion&&(b=d.display.layers.regions.params.sel)&&(d.params.listonchange||b.params.listonchange)&&(d.updateShape("regions",b,null,"update",!0),d.listRegions("selected",2)),a.hasOwnProperty("MouseTouch")&&a.MouseTouch.action(d,c),a.specialKey(c)||(d.valpos||(d.valpos=d.updateValpos(d.ipos,!1)),a.specialKey(c)||d.xeqPlugins("mouse","onmousemove",c))))};a.mouseOverCB=function(c){var b=c.data.image,d=$(document).scrollLeft(),e=$(document).scrollTop();c.preventDefault();b&&(b.display.displayConjq.focus(),
...
(a.MouseTouch.Actions["wheel zoom"](d,c),c.preventDefault())};a.keyPressCB=function(a){var b=a.data.image;a.preventDefault();b&&b.xeqPlugins("keypress","onkeypress",a)};a.keyDownCB=function(c){var b,d=c.data.image;a.hasOwnProperty("Keyboard")&&(b=d?d.ipos:{x:null,y:null},a.Keyboard.action(d,b,c));d&&d.xeqPlugins("keypress","onkeydown",c)};a.dragenterCB=function(a,b){b.stopPropagation();b.preventDefault()};a.dragoverCB=function(a,b){b.stopPropagation();b.preventDefault()};a.dragexitCB=function(a,b){b.stopPropagation();
b.preventDefault()};a.dragdropCB=function(c,b,d){var e;b.originalEvent&&(b=b.originalEvent);b.stopPropagation();b.preventDefault();e=$.extend(!0,{},a.fits.options);e.display=e.display||c;e.extlist=e.extlist||a.globalOpts.extlist;c=b.target.files||b.dataTransfer.files;(b=a.lookupDisplay(e.display))&&b.divjq&&a.waiting(!0,b.divjq[0]);for(b=0;b<c.length;b++)a.Load(c[b],e,d)};a.RegisterPlugin=function(c,b,d,e){var f,g;c&&b&&d&&(f=c+b,e?(e.viewMenuItem&&(e.menuItem=e.viewMenuItem),e.menuItem&&!e.menu&&
(e.menu="view"),e.menu&&(e.menu=e.menu.toLowerCase())):e=[],a.PLUGINS&&(a.PLUGINS+="|"),a.PLUGINS+=f.replace(/JS9/,""),a.plugins.push({xclass:c,xname:b,name:f,opts:e,func:d,instances:[]}),e.help&&(d=e.help.match(/^.*[\\\/]/),d[0]&&(g="plugins/"+d[0].replace(/[\\\/]+$/,"")),d=e.help.replace(/^.*[\\\/]/,""),e=e.menuItem?e.menuItem:f,a.helpOpts[b]={type:g,url:d,heading:c,title:e}))};a.instantiatePlugin=function(c,b,d,e){var f,g,h;if("string"===typeof b){for(f=0;f<a.plugins.length;f++)if(g=a.plugins[f],
g.name===b){b=g;break}"string"===typeof b&&a.error("unknown plugin: "+b)}g=Object.create(b.func.prototype);g.name=b.name;g.isActive=function(a){if("active"!==this.status||a&&!this.plugin.opts.hasOwnProperty(a))return!1;switch(this.winType){case "virtual":return!0;default:return this.divjq.is(":visible")}};g.errLog=function(b,c){a.log("error in %s: %s [%s]\n%s",b,this.name,c.message,a.strace(c))};if(c)for(h=c instanceof jQuery?c:"object"===typeof c?$(c):$("#"+c),f=0;f<b.instances.length;f++){if(h.is(b.instances[f].odivjq))return b.instances[f]}else h=
