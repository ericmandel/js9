...
fwidth:a.xdim,fheight:a.ydim,dwidth:this.display.width,dheight:this.display.height,data:b}};b.Image.prototype.closeImage=function(a){var c,d,e,f,g=!1;d=b.images.length;var h=this.display;a=a||{};if("string"===typeof a)try{a=JSON.parse(a)}catch(k){b.error("can't parse closeImage opts: "+a,k)}for(c=0;c<d;c++)if(this===b.images[c]){d=b.images[c];d===d.display.image&&(g=c+1);if(g)for(e in!1!==a.clear&&(d.display.clearMessage(),d.display.context.clear()),d.layers)d.layers.hasOwnProperty(e)&&d.showShapeLayer(e,
!1,{local:!0});d.xeqPlugins("image","onimageclose");g&&(d.display.image=null);switch(d.cmapObj.name){case "red":b.globalOpts.rgb.rim=null;break;case "green":b.globalOpts.rgb.gim=null;break;case "blue":b.globalOpts.rgb.bim=null}if(b.fits.cleanupFITSFile)for(a=0;a<d.raws.length;a++)e=d.raws[a],e.hdu&&e.hdu.fits&&(f=b.lookupVfile(e.hdu.fits.vfile),1>=f.length&&b.fits.cleanupFITSFile(e.hdu.fits,!0)),e.altwcs&&this.freeWCS(e);d.removeProxyFile();d.rgb=null;d.offscreen=null;d.raw=null;d.colorData=null;
d.colorCells=null;d.psColors=null;d.psInverse=null;b.images.splice(c,1);break}if(g){for(c=g-=2;0<=c;c--)if(d=b.images[c],h===d.display){d.displayImage("all");d.refreshLayers();g=b.images.length;break}for(c=b.images.length-1;c>g;c--)if(d=b.images[c],h===d.display){d.displayImage("all");d.refreshLayers();break}}};b.Image.prototype.mkOffScreenCanvas=function(){if(!this.png||!this.png.image)return this;this.offscreen={};this.offscreen.canvas=document.createElement("canvas");this.offscreen.canvas.setAttribute("width",
...
new Uint8Array(f);for(a=0;a<f;a++){switch(g){case 0:h=e[d];d+=1;g=1;break;case 1:h=e[d];d+=1;g=2;break;case 2:h=e[d];d+=2;g=0;break;case 3:h=e[d+1],d+=2,g=1}this.raw.data[a]=h}break;case 16:case -16:16===this.raw.bitpix?(this.raw.data=new Int16Array(f),c=DataView.prototype.getInt16):(this.raw.data=new Uint16Array(f),c=DataView.prototype.getUint16);for(a=0;a<f;a++){switch(g){case 0:m[0]=e[d];m[1]=e[d+1];h=c.call(q,0,k);d+=2;g=2;break;case 1:m[0]=e[d];m[1]=e[d+1];h=c.call(q,0,k);d+=3;g=0;break;case 2:m[0]=
e[d];m[1]=e[d+2];h=c.call(q,0,k);d+=3;g=1;break;case 3:m[0]=e[d+1],m[1]=e[d+2],h=c.call(q,0,k),d+=3,g=2}this.raw.data[a]=h}break;case 32:case -32:32===this.raw.bitpix?(this.raw.data=new Int32Array(f),c=DataView.prototype.getInt32):(this.raw.data=new Float32Array(f),c=DataView.prototype.getFloat32);for(a=0;a<f;a++){switch(g){case 0:m[0]=e[d];m[1]=e[d+1];m[2]=e[d+2];m[3]=e[d+4];h=c.call(q,0,k);d+=5;g=1;break;case 1:m[0]=e[d];m[1]=e[d+1];m[2]=e[d+3];m[3]=e[d+4];h=c.call(q,0,k);d+=5;g=2;break;case 2:m[0]=
e[d];m[1]=e[d+2];m[2]=e[d+3];m[3]=e[d+4];h=c.call(q,0,k);d+=6;g=0;break;case 3:m[0]=e[d+1],m[1]=e[d+2],m[2]=e[d+3],m[3]=e[d+5],h=c.call(q,0,k),d+=6,g=1}this.raw.data[a]=h}break;case -64:this.raw.data=new Float64Array(f);for(a=0;a<f;a++){switch(g){case 0:case 4:m[0]=e[d];m[1]=e[d+1];m[2]=e[d+2];m[3]=e[d+4];m[4]=e[d+5];m[5]=e[d+6];m[6]=e[d+8];m[7]=e[d+9];h=q.getFloat64(0,k);d+=10;g=2;break;case 1:case 5:m[0]=e[d];m[1]=e[d+1];m[2]=e[d+3];m[3]=e[d+4];m[4]=e[d+5];m[5]=e[d+7];m[6]=e[d+8];m[7]=e[d+9];h=
q.getFloat64(0,k);d+=11;g=0;break;case 2:case 6:m[0]=e[d];m[1]=e[d+2];m[2]=e[d+3];m[3]=e[d+4];m[4]=e[d+6];m[5]=e[d+7];m[6]=e[d+8];m[7]=e[d+10];h=q.getFloat64(0,k);d+=11;g=1;break;case 3:case 7:m[0]=e[d+1],m[1]=e[d+2],m[2]=e[d+3],m[3]=e[d+5],m[4]=e[d+6],m[5]=e[d+7],m[6]=e[d+9],m[7]=e[d+10],h=q.getFloat64(0,k),d+=11,g=2}this.raw.data[a]=h}break;default:b.error("unsupported bitpix in PNG file: "+this.raw.bitpix)}this.dataminmax();this.offscreen.img=null;this.initWCS();this.initLCS();this.xeqPlugins("image",
"onrawdata");return this}};b.Image.prototype.mkRawDataFromHDU=function(a,c){var d=this,e,f,g,h,k,l,n,m,q,t,r,u,p,x;q=m=0;c=c||{};$.isArray(a)||b.isTypedArray(a)||a instanceof ArrayBuffer?($.isArray(a[0])&&(a=a.reduce(function(a,b){return a.concat(b)})),h={image:a}):"object"===typeof a?h=a:b.error("unknown or missing input for HDU creation");h.data&&!h.image&&(h.image=h.data);h.image||b.error("data missing from JS9 FITS object"+JSON.stringify(h));2>h.naxis&&b.error("can't image a FITS file with less than 2 dimensions");
...
h]:0,A=D?D.colorData[w+h]:0,B=z?z.colorData[w+h]:0,void 0===g||void 0===A||void 0===B)return b.globalOpts.rgb.active=!1,b.error("RGB images are incompatible. Turning off RGB mode.","",!1),b.Image.prototype.mkRGBImage.call(this),this}else d=this.colorData[w+h];this.maskData&&(v=0<this.maskData[w+h]?e:f);t=m*l;for(u=0;u<c.zoom;u++)for(p=Math.floor(r+u),y=p*c.width,p=0;p<c.zoom;p++)x=Math.floor(t+p),x=4*(y+x),E?(a.data[x]=C?C.psColors[g][0]:0,a.data[x+1]=D?D.psColors[A][1]:0,a.data[x+2]=z?z.psColors[B][2]:
0):(a.data[x]=this.psColors[d][0],a.data[x+1]=this.psColors[d][1],a.data[x+2]=this.psColors[d][2]),a.data[x+3]=v}return this};b.Image.prototype.blendImage=function(a,c,d){var e=/normal|multiply|screen|overlay|darken|lighten|color-dodge|color-burn|hard-light|soft-light|difference|exclusion|hue|saturation|color|luminosity|clear|copy|source-over|destination-over|source-in|destination-in|source-out|destination-out|source-atop|destination-atop|xor|lighter/i;if(0===arguments.length)return this.blend;if(!0===
