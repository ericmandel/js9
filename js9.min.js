...
(g=this.display.rgb.gim),this.display.rgb.bim&&(k=this.display.rgb.bim));var r=this.display.context;var v=this.rgb;var w=v.sect;if(this.MakeRGBImage&&"function"===typeof this.MakeRGBImage&&this.MakeRGBImage()||this.MakePrimaryImage&&"function"===typeof this.MakePrimaryImage&&this.MakePrimaryImage())return this;if(this.rgbFile){var t=w.width/w.zoom;var u=w.height/w.zoom;var y=w.x0;var x=this.offscreen.canvas.height-1-(w.y0+u);x=this.offscreen.context.getImageData(y,x,t,u);if(1===w.zoom)v.img=x;else for(v.img=
r.createImageData(w.width,w.height),v=v.img,d=c=0;c<x.height;c++,d++){var B=c*x.width;var z=d*w.zoom;for(b=r=0;r<x.width;r++,b++){y=4*(B+r);var A=b*w.zoom;for(e=0;e<w.zoom;e++){var C=Math.floor(z+e);var E=C*w.width;for(C=0;C<w.zoom;C++){var D=Math.floor(A+C);D=4*(E+D);v.data[D]=x.data[y];v.data[D+1]=x.data[y+1];v.data[D+2]=x.data[y+2];v.data[D+3]=x.data[y+3]}}}}return this}v.img&&v.img.width===w.width&&v.img.height===w.height||(v.img=r.createImageData(w.width,w.height));v=v.img;var F=v.data.length-
...
a.uniqueID();var f=function(a){return"mosaic_"+d+"_"+a};var k=f("in.lst");var w=f("in.tbl");var t=f("in.hdr");var u=f("bin.lst");var y=f("bin.tbl");var x=f("out.lst");var B=f("out.tbl");var z=f("out.hdr");f=c[0].id.replace(/\[.*\]/,"").replace(/\.fz$/i,"").replace(/\.gz$/i,"").replace(/\.fits$/i,"_mosaic.fits");var A=f.replace(/\.fits$/,"_area.fits");g=[k,w,t,u,y,x,B,z,A];A="|                                                    fname|\n|                                                     char|\n";
...
a.reg2wcs(b,e).replace(/;$/,"");"line"===d.shape&&f&&(h.wcsstr=h.wcsstr.replace(/} *$/,f+"}"));k=h.wcsstr.replace(/.*\(/,"").replace(/\).*/,"").split(",");for(b=0;b<k.length;b++)k[b]=k[b].trim();h.wcsposstr=[k[0],k[1]];switch(d.shape){case "annulus":h.wcssizestr=[k[k.length-1]];break;case "box":case "cross":h.wcssizestr=[k[2],k[3]];break;case "circle":h.wcssizestr=[k[2]];break;case "ellipse":h.wcssizestr=[k[2],k[3]];break;case "line":case "polygon":for(h.wcspts=[],b=0;b<k.length;b+=2)l=a.strtoscaled(k[b]),
a.isHMS(h.wcssys,l.dtype)&&(l.dval*=15),m=a.strtoscaled(k[b+1]),h.wcspts.push({ra:l.dval,dec:m.dval})}}};d=d||{};f=f||{};e=e||"update";var p="main"!==this.display.layers[c].dtype||b.params.preservedcoords?1:this.rgb.sect.zoom;g.mode=e;g.id=b.params.id;g.shape=b.params.shape;g.layer=c;g.color=b.color||b.stroke;g.tags=b.params.tags;g.sticky=b.params.sticky;g.preservedcoords=b.params.preservedcoords;g.parent=b.params.parent?b.params.parent.obj.params.id:null;g.child=b.params.children&&b.params.children.length?
b.params.children[0].id:null;var q=b.getCenterPoint();if(d.group){var r=d.group.getCenterPoint();q={x:q.x+r.x,y:q.y+r.y};d.group.angle&&(q=a.rotatePoint(q,d.group.angle,r))}g.dx=q.x;g.dy=q.y;q=this.displayToImagePos(q);g.x=q.x;g.y=q.y;g.lcs=this.imageToLogicalPos(q);"export"!==e&&b.params.wcsconfig&&("image"===b.params.wcsconfig.wcssys?h="image":"physical"===b.params.wcsconfig.wcssys&&(h="physical"));if("image"===h||"image"===this.params.wcssys&&"physical"!==h){g.imsys="image";var v=g.x;var w=g.y;
r=1}else g.imsys=g.lcs.sys,v=g.lcs.x,w=g.lcs.y,r=Math.sqrt(Math.pow(this.lcs.physical.reverse[0][0],2)+Math.pow(this.lcs.physical.reverse[0][1],2));g.angle=-b.angle;d.group&&(g.angle-=d.group.angle);h=g.angle;if(!g.parent)switch(g.shape){case "box":case "cross":case "ellipse":case "text":if(a.notNull(this.params.transformScale)&&(g.angle/=this.params.transformScale),a.notNull(this.params.transformAngle)&&(g.angle-=this.params.transformAngle),this.raw.wcsinfo)this.raw.wcsinfo.crot&&(g.angle-=this.raw.wcsinfo.crot);
else if(a.notNull(this.raw.header.LTM1_1)||a.notNull(this.raw.header.LTM1_2)){try{var t=Math.atan((this.raw.header.LTM1_2||0)/(this.raw.header.LTM1_1||0))}catch(z){t=0}t&&(t=180*-t/Math.PI,g.angle-=t)}}for(;0>g.angle;)g.angle+=360;for(;360<=g.angle;)g.angle-=360;q=b.scaleX/p;t=b.scaleY/p;d.group&&(q*=d.group.scaleX,t*=d.group.scaleY);switch(g.shape){case "annulus":g.shape="annulus";g.radii=[];"image"!==g.imsys&&(g.lcs.radii=[]);g.imstr="annulus("+m(v)+","+m(w)+",";var u="annulus "+g.x+" "+g.y+" ";
var y=b.getObjects();h=y.length;for(d=0;d<h;d++)p=y[d].radius*q,t=p*r,g.imstr+=m(t),u+=g.x+" "+g.y+" "+(g.x+p)+" "+g.y+" ",g.imstr=d===h-1?g.imstr+")":g.imstr+",",g.radii.push(p),"image"!==g.imsys&&g.lcs.radii.push(t);break;case "box":case "cross":g.width=b.width*q;g.height=b.height*t;t=g.width*r;u=g.height*r;"image"!==g.imsys&&(g.lcs.width=t,g.lcs.height=u);g.imstr=g.shape+"("+m(v)+","+m(w)+","+m(t)+","+m(u)+","+g.angle.toFixed(4)+")";u=g.shape+" "+g.x+" "+g.y+" "+g.x+" "+g.y+" "+(g.x+g.width)+" "+
g.y+" "+g.x+" "+g.y+" "+g.x+" "+(g.y+g.height)+" "+g.angle*Math.PI/180;break;case "circle":g.radius=b.radius*q;t=g.radius*r;"image"!==g.imsys&&(g.lcs.radius=t);g.imstr="circle("+m(v)+","+m(w)+","+m(t)+")";u="circle "+g.x+" "+g.y+" "+g.x+" "+g.y+" "+(g.x+g.radius)+" "+g.y;break;case "ellipse":g.r1=b.width*q/2;g.r2=b.height*t/2;t=g.r1*r;u=g.r2*r;"image"!==g.imsys&&(g.lcs.r1=t,g.lcs.r2=u);g.imstr="ellipse("+m(v)+","+m(w)+","+m(t)+","+m(u)+","+g.angle.toFixed(4)+")";u="ellipse "+g.x+" "+g.y+" "+g.x+" "+
g.y+" "+(g.x+g.r1)+" "+g.y+" "+g.x+" "+g.y+" "+g.x+" "+(g.y+g.r2)+" "+g.angle*Math.PI/180;break;case "point":g.width=b.width*q;g.height=b.height*t;t=g.width*r;u=g.height*r;"image"!==g.imsys&&(g.lcs.width=t,g.lcs.height=u);g.imstr="point("+m(v)+","+m(w)+")";u="point "+g.x+" "+g.y;break;case "line":case "polygon":g.imstr=g.shape+"(";u=g.shape+" ";g.pts=[];"image"!==g.imsys&&(g.lcs.pts=[]);for(d=0;d<b.points.length;d++)0<d&&(g.imstr+=",",u+=" "),t=this.displayToImagePos({x:b.left+b.points[d].x*b.scaleX,
y:b.top+b.points[d].y*b.scaleY}),t=a.rotatePoint(t,h,{x:g.x,y:g.y}),"image"===g.imsys?g.imstr+=m(t.x)+","+m(t.y):(r=this.imageToLogicalPos(t),q=r.x,r=r.y,g.imstr+=m(q)+","+m(r),g.lcs.pts.push({x:q,y:r})),u+=t.x+" "+t.y,g.pts.push(t),"line"===g.shape&&(0===d?y=0:(q=g.pts[d-1],y+=Math.sqrt((t.x-q.x)*(t.x-q.x)+(t.y-q.y)*(t.y-q.y))));if("line"===g.shape&&a.notNull(y)){g.imstr+=') {"size":'+m(y)+',"units":"pixels"';if(2===g.pts.length){for(t=180*Math.atan2(g.pts[1].y-g.pts[0].y,g.pts[1].x-g.pts[0].x)/
Math.PI;0>t;)t+=360;var x=',"posang":'+t.toFixed(4)+',"posunits":"degrees"';g.imstr+=x}g.imstr+="}"}else g.imstr+=")";g.angle=0;break;case "text":g.imstr="text("+m(v)+","+m(w)+',"'+b.text+'",'+g.angle.toFixed(4)+")",u="text "+g.x+" "+g.y+' "'+b.text+'" '+g.angle*Math.PI/180,g.text=b.text}this.raw.wcs&&0<this.raw.wcs&&(n(this.raw.wcs,k,g,u,x,f,g),b.params.wcsconfig&&b.params.wcsconfig.wcssys&&(m=a.globalOpts.xeqPlugins,a.globalOpts.xeqPlugins=!1,y=this.getWCSSys(),a.notWCS(b.params.wcsconfig.wcssys)||
...
a.globalOpts.xeqPlugins=e);return this}};a.Fabric.copyShapes=function(c,b,d){var e,f=[];if("object"===typeof b)f.push(b);else if("all"===b)for(b=0;b<a.images.length;b++)this!==a.images[b]&&f.push(a.images[b]);else(b=a.lookupImage(b))&&f.push(b);if(f.length){d||(e=this.listRegions("selected",{mode:1,includedcoords:a.globalOpts.regCopyDCoords},c));e||(e=this.listRegions(d,{mode:1,includedcoords:a.globalOpts.regCopyDCoords},c));for(b=0;b<f.length;b++)d=this.display.layers[c]?this.display.layers[c].opts:
a.Regions.opts,f[b].display.newShapeLayer(c,d),f[b].addShapes(c,e);return this}};a.Fabric._addPolygonPoint=function(c,b,d){var e=Number.MAX_VALUE;if(b&&b.points){d=a.eventToDisplayPos(d);var f=b.getCenterPoint().x;var h=b.getCenterPoint().y;f=(d.x-f)/b.get("scaleX");var g=(d.y-h)/b.get("scaleY");for(h=-b.get("angle")*Math.PI/180;h>2*Math.PI;)h-=2*Math.PI;d=Math.cos(h)*f-Math.sin(h)*g;g=Math.sin(h)*f+Math.cos(h)*g;f=b.points;for(h=0;h<f.length;h++){var k=f[h];var l=f[(h+1)%f.length];var m=k.x<l.x?
k.x:l.x;var n=k.y<l.y?k.y:l.y;var p=k.x>l.x?k.x:l.x;var q=k.y>l.y?k.y:l.y;var r=k.x-l.x;k=k.y-l.y;var v=Math.sqrt(r*r+k*k);0!==v&&(r/=v,k/=v);v=d-l.x;var w=g-l.y;v=v*r+w*k;r=l.x+r*v;l=l.y+k*v;r<m?r=m:r>p&&(r=p);l<n?l=n:l>q&&(l=q);m=(r-d)*(r-d)+(l-g)*(l-g);if(m<e){e=m;var t=r;var u=l;var y=h===f.length?0:h}}c=this.getShapeLayer(c);a.Fabric.removePolygonAnchors(c.dlayer,b);f.splice(y+1,0,{x:t,y:u});if(1===fabric.major_version)c.canvas.setActiveObject(b);else{switch(b.type){case "polyline":case "polygon":a.Fabric.addPolygonAnchors(c.dlayer,
...
a.Fabric.getShapes;a.Image.prototype.changeShapes=a.Fabric.changeShapes;a.Image.prototype.removeShapes=a.Fabric.removeShapes;a.Image.prototype.refreshShapes=a.Fabric.refreshShapes;a.Image.prototype.copyShapes=a.Fabric.copyShapes;a.Image.prototype.selectShapes=a.Fabric.selectShapes;a.Image.prototype.getShapeLayer=a.Fabric.getShapeLayer;a.Image.prototype.showShapeLayer=a.Fabric.showShapeLayer;a.Image.prototype.activeShapeLayer=a.Fabric.activeShapeLayer;a.Image.prototype.displayShapeLayers=a.Fabric.displayShapeLayers;
a.Image.prototype.toggleShapeLayers=a.Fabric.toggleShapeLayers;a.Image.prototype.print=a.Fabric.print;for(c in a.Fabric.opts)a.Fabric.opts.hasOwnProperty(c)&&(fabric.Object.prototype[c]=a.Fabric.opts[c])};a.Fabric.initGraphics();a.MouseTouch={};a.MouseTouch.CLASS="JS9";a.MouseTouch.NAME="MouseTouch";a.MouseTouch.WIDTH=512;a.MouseTouch.HEIGHT=220;a.MouseTouch.BASE=a.MouseTouch.CLASS+a.MouseTouch.NAME;a.MouseTouch.mouseText=[];a.MouseTouch.mouseText[0]="Move mouse, no buttons pressed:";a.MouseTouch.mouseText[1]=
...
"_")};a.MouseTouch.addText=function(c,b){b=sprintf(a.MouseTouch.textHTML,b);return $("<div>").addClass(a.MouseTouch.BASE+"Text").html(b).appendTo(c)};a.MouseTouch.addAction=function(c,b,d){b=a.MouseTouch.actionid(b,d);d=sprintf(a.MouseTouch.actionHTML,d);return $("<div>").addClass(a.MouseTouch.BASE+"Action").attr("id",b).html(d).appendTo(c)};a.MouseTouch.isPinch=function(c,b){var d,e,f=a.globalOpts.pinchWait,h=a.globalOpts.pinchThresh;if(!c)return-1;b=c.display;if(!b.mousetouchZoom||2!==c.pos.touches.length)return-1;
switch(b.ispinch){case -1:case 1:return b.ispinch}c=Math.sqrt((c.pos.touches[0].x-c.pos.touches[1].x)*(c.pos.touches[0].x-c.pos.touches[1].x)+(c.pos.touches[0].y-c.pos.touches[1].y)*(c.pos.touches[0].y-c.pos.touches[1].y));b.dist0||(b.dist0=c);b.deltas.push(Math.floor(c-b.dist0));if(b.deltas.length>=f){c=1;for(e=d=0;c<f;c++)b.deltas[c]>b.deltas[c-1]?d++:b.deltas[c]<b.deltas[c-1]&&e++;b.ispinch=d>=h||e>=h?1:-1;b.lastzoom=0;return b.ispinch}return 0};a.MouseTouch.Actions={};a.MouseTouch.Actions["display value/position"]=
function(c,b,d){!a.specialKey(d)&&a.globalOpts.internalValPos&&c&&b&&0<b.x&&0<b.y&&b.x<=c.raw.width&&b.y<=c.raw.height&&(c.valpos=c.updateValpos(b,!0))};a.MouseTouch.Actions["change contrast/bias"]=function(c,b,d){var e=c.display;a.globalOpts.internalContrastBias&&c&&b&&"static"!==c.cmapObj.type&&!(c.pos0&&c.pos&&Math.abs(c.pos0.x-c.pos.x)<a.NOMOVE&&Math.abs(c.pos0.y-c.pos.y)<a.NOMOVE||c.clickInRegion||a.specialKey(d)||c.rgbFile)&&(d=a.eventToDisplayPos(d,c.posOffset),b=Math.floor(d.x+.5),d=Math.floor(d.y+
.5),a.globalOpts.containContrastBias&&(0>b||0>d||b>=e.canvas.width||d>=e.canvas.height)||(c.params.bias=b/e.canvas.width,c.params.contrast=d/e.canvas.height*10,a.bugs.firefox_linux?window.setTimeout(function(){c.displayImage("scaled",{blendMode:!1})},0):c.displayImage("scaled",{blendMode:!1}),c.xeqStashDiscard("filterRGBImage"),a.globalOpts.extendedPlugins&&c.xeqPlugins("image","onchangecontrastbias")))};a.MouseTouch.Actions["change contrast/bias"].stop=function(a,b,d){a.display.blendMode&&a.displayImage("rgb")};
a.MouseTouch.Actions["wheel zoom"]=function(c,b){c&&c.display.mousetouchZoom&&(b=0<b.originalEvent.deltaY?Math.min(a.MAXZOOM,c.getZoom()+a.ADDZOOM):Math.max(a.MINZOOM,c.getZoom()-a.ADDZOOM),b=Math.round(100*(b+1E-5))/100,c.setZoom(b))};a.MouseTouch.Actions["pan the image"]=function(c,b,d){if(c){b=c.rgb.sect;d=(c.pos0.x-c.pos.x)/b.zoom;var e=(c.pos0.y-c.pos.y)/b.zoom;if(1<=Math.abs(d)||1<=Math.abs(e)){"x"===c.params.flip?d=-d:"y"===c.params.flip?e=-e:"xy"===c.params.flip&&(d=-d,e=-e);if(90===c.params.rot90){var f=
d;d=-e;e=f}else 180===c.params.rot90?(d=-d,e=-e):-90===c.params.rot90&&(f=d,d=e,e=-f);d={x:b.xcen+d,y:b.ycen-e};c.params.rotate&&(d=a.rotatePoint(d,-c.params.rotate,{x:b.xcen,y:b.ycen}));c.setPan(d);c.pos0=c.pos}}};a.MouseTouch.Actions.pinch=function(c,b,d){c&&(b=c.display,d=b.zoom0*Math.sqrt((c.pos.touches[0].x-c.pos.touches[1].x)*(c.pos.touches[0].x-c.pos.touches[1].x)+(c.pos.touches[0].y-c.pos.touches[1].y)*(c.pos.touches[0].y-c.pos.touches[1].y))/b.dist0,d=Math.max(a.MINZOOM,Math.min(a.MAXZOOM,
Math.round(100*(d+1E-5))/100)),d!==b.lastzoom&&c.setZoom(d),b.lastzoom=d)};a.MouseTouch.Actions.start=function(c,b,d){c&&(b=c.display,b.ispinch=0,b.dist0=0,b.zoom0=c.rgb.sect.zoom,b.deltas=[]);b=a.MouseTouch.getAction(c,d);a.MouseTouch.Actions[b]&&a.MouseTouch.Actions[b].start&&a.MouseTouch.Actions[b].start(c,c.ipos,d)};a.MouseTouch.Actions.stop=function(c,b,d){b=a.MouseTouch.getAction(c,d);a.MouseTouch.Actions[b]&&a.MouseTouch.Actions[b].stop&&a.MouseTouch.Actions[b].stop(c,c.ipos,d)};a.MouseTouch.getAction=
function(c,b){if(!c)return e;var d=c.display;switch(c.clickState){case 0:var e=d.mouseActions[0];break;case 1:e=d.mouseActions[1];break;case 2:e=d.mouseActions[2];break;case -1:e=d.touchActions[0];break;case -2:switch(a.MouseTouch.isPinch(c,b)){case -1:e=d.touchActions[1];break;case 1:e="pinch"}break;case -3:e=d.touchActions[2]}return e};a.MouseTouch.action=function(c,b,d){if((d=d||a.MouseTouch.getAction(c,b))&&a.MouseTouch.Actions[d])a.MouseTouch.Actions[d](c,c.ipos,b)};a.MouseTouch.mousetouchzoom=
function(c,b){c=a.lookupDisplay(c);b=b.checked;c&&(c.mousetouchZoom=b)};a.MouseTouch.init=function(){var c=this,b;this.divjq.html("");this.divjq.addClass("JS9PluginScrolling");this.mousetouchContainer=$("<div>").addClass(a.MouseTouch.BASE+"Container").attr("id",this.id+"MouseTouchContainer").appendTo(this.divjq);var d=sprintf("<div class='%s'><span><b>Drag an action to reconfigure JS9 mouse/touch events:</b></span><p>",a.MouseTouch.BASE+"Header");this.mousetouchHeadContainer=$("<span style='float: left'>").addClass(a.MouseTouch.BASE+
...
c.pub[f]&&(h=r(c.pub[f]))}break;case "height":case "r2":switch(w){case "image":void 0!==c.pub[f]&&(h=r(c.pub[f]));break;case "physical":c.pub.lcs&&void 0!==c.pub.lcs[f]&&(h=r(c.pub.lcs[f]));break;default:void 0!==c.pub.wcsconfig.wcssizestr?h=r(c.pub.wcsconfig.wcssizestr[1]):void 0!==c.pub[f]&&(h=r(c.pub[f]))}break;case "wcssys":case "savewcs":y=$(u).find("[name='"+f+"']");if(!y.find("option").length)for(e=0;e<a.wcssyss.length;e++)y.append("<option>"+a.wcssyss[e]+"</option>");g="savewcs"===f?a.globalOpts.regSaveWCS||
w:w;y.find("option").each(function(a,b){g===b.value&&(h=b.value)});break;case "wcsunits":c.pub.wcsunits&&(h=c.pub.wcsunits);break;case "childtext":c.params.children&&0<c.params.children.length&&(h=v(c.params.children[0].obj.text));break;case "text":void 0!==c.pub[f]&&(h=v(r(c.pub[f])));break;case "id":n?h="selected":void 0!==c.pub.id&&(h=String(c.pub.id),$(m).css("width",h.length+"ch"));break;case "tags":void 0!==c.pub[f]&&(h=r(c.pub[f]));break;case "savefile":h=$(u).data("savefile")||d.tmp.saveregionsFile||
"js9.reg";window.isElectron&&window.currentDir&&!h.match(/.*\//)&&(h=window.currentDir+"/"+h);break;case "selectfilter":h=$(u).data("selectfilter");break;default:void 0!==c.pub[f]&&(h=r(c.pub[f]))}$(m).val(h)});(n||!this.raw.wcs||0>this.raw.wcs)&&$(u).find("[name='wcssys']").hide();"text"!==c.type&&c.params.children&&($(u+".childtext").removeClass("nodisplay"),$(u+"[name='childtext']").prop("readonly",0<c.params.children.length));if(b.firsttime){window.isElectron&&$(u).find(".rsavebrowse, .rconfigbrowse").removeClass("nodisplay");
n?($(u).find("label[for='savecur']").text("sel"),$(u).find("input[id='savecur']").data("tooltip","save selected regions")):$(u).find(".checkboxes").removeClass("nodisplay");if(a.favorites.wcs&&a.favorites.wcs.length){var y=$(u).find(".rwcsbuttons").removeClass("nodisplay");q=y.find(".rwcsbuttoncontainer");if(q.length&&!q.find(".rwcsbutton").length){for(e=0;e<a.favorites.wcs.length;e++){var x=a.favorites.wcs[e];var B="string"===typeof x?x.split(":"):x;x=B[0];B=B[1]||x;if("save"===b.type){var z="rsavecol_R"+
...
x+'")\n                                           .trigger("change");\'>\n                                <label for=\'rwcsbutton_'+x+"'>"+B+"</label>\n                                </span>")}$(u).find(".rwcsbuttons").find("[value='"+w+"']").prop("checked",!0)}}a.globalOpts.internalColorPicker&&$.fn.spectrum.inputTypeColorSupport()||(y=$(u).find("input[name='colorPicker']"),y.spectrum({showButtons:!1,showInput:!1,preferredFormat:"hex6"}),y.on("move.spectrum",function(a,b){a=b.toHexString();$(u).find("input[name='color']").val(a);
$(u).data("colorpicker",a)}))}void 0===c.params.listonchange&&(c.params.listonchange=!1);c.params.listonchange?$(u+"[name='listonchange']").prop("checked",!0):$(u+"[name='listonchange']").prop("checked",!1);void 0===c.params.changeable&&void 0!==c.params.fixinplace&&(c.params.changeable=!c.params.fixinplace);void 0===c.params.changeable&&(c.params.changeable=!0);c.params.changeable?$(u+"[name='changeable']").prop("checked",!0):$(u+"[name='changeable']").prop("checked",!1);c.params.sticky?$(u+"[name='sticky']").prop("checked",
!0):$(u+"[name='sticky']").prop("checked",!1);$(u+"[id='includejson']").prop("checked",a.globalOpts.regIncludeJSON);$(u+"[id='includecomments']").prop("checked",a.globalOpts.regIncludeComments);$(u+"[id='savedcoords']").prop("checked",a.globalOpts.regSaveDCoords);$(u+"[id='includewcs']").prop("checked",a.globalOpts.csvIncludeWCS);$(u).find("input[name='saveformat']").prop("checked",!1);$(u).find("input[value='"+a.globalOpts.regSaveFormat+"']").prop("checked",!0);$(u).find("input[name='rwcsbutton']").prop("checked",
!1);$(u).find("input[value='"+(a.globalOpts.regSaveWCS||w)+"']").prop("checked",!0);x="save"===b.type?"save"+a.globalOpts.regSaveWhich1:"save"+a.globalOpts.regSaveWhich2;$(u+"[id='"+x+"']").prop("checked",!0);"save"===b.type&&$(u).find("input[name='savefile']").trigger("change");$(u).find("input[name='strokeMenu']").prop("selectedIndex",0);$(u).find("input[name='dashesMenu']").prop("selectedIndex",0);if(n)$(u).find(".regid").hide(),$(u).find(".edit").hide(),$(u).find(".childtext").hide(),$(u).find(".multi").removeClass("nodisplay"),
0>=b.setmode?($(u).find("[name='multitext']").val(""),0>b.setmode&&($(u).data("selectfilter",""),$(u).find("[name='selectfilter']").val(""))):(x=this.listRegions("selected",{mode:1,includejson:!1,includecomments:!1}).replace(/ *; */g,"\n"),$(u).find("[name='multitext']").val(x));else switch($(u).find("input:text[readonly]").css("border-color","A5A5A5").css("background","#E9E9E9"),c.pub.shape){case "box":case "cross":case "ellipse":$(u+".angle").removeClass("nodisplay");break;case "text":$(u+".textangle").removeClass("nodisplay");
break;case "line":c.pub.pts&&2===c.pub.pts.length?($(u+".linelength").removeClass("nodisplay"),$(u+".lineangle").removeClass("nodisplay")):($(u+".linelength").addClass("nodisplay"),$(u+".lineangle").addClass("nodisplay"))}$(u+".xtrareg").addClass("nodisplay");$(u+".xtracsv").addClass("nodisplay");$(u+".xtrasvg").addClass("nodisplay");$(u+".xtra"+a.globalOpts.regSaveFormat).removeClass("nodisplay");$(u).data("im",this);$(u).data("shape",c);$(u).data("winid",t);$(u).data("multi",n);a.BROWSER[3]?(t=
"touchstart",q="touchend"):(t="mouseover",q="mouseout");if("save"===b.type)$(u).on(t,function(){$(u).find("input[name='savefile']").focus()});$(u).data("tooltipInit")||($(u).data("tooltipInit",!0),$(".rconfigcol_R, .rsavecol_R").on(t,function(b){var c=b.currentTarget;b=$(c).find("input, textarea, span").data("tooltip");c=$(c).closest(a.lightOpts[a.LIGHTWIN].top).find(a.lightOpts[a.LIGHTWIN].dragBar);b&&c.length&&(m=$(c)[0].childNodes[0].nodeValue.replace(/:.*/,""),$(c)[0].childNodes[0].nodeValue=
...
parseFloat(b):b},q=function(a){var b=String.fromCharCode(13,10);return(a||"").replace(/\\n/g,b)};this.lcs&&this.lcs.physical&&(e=Math.sqrt(Math.pow(this.lcs.physical.forward[0][0],2)+Math.pow(this.lcs.physical.forward[0][1],2)));if(b&&b.pub&&b.pub.wcsconfig&&b.pub.wcsconfig.wcssys)var r=b.pub.wcsconfig.wcssys;else r=this.params.wcssys,b=f;var v=$(c).data("multi");var w=b.pub.layer||"regions";for(f=0;f<h;f++){var t=d[f].name;var u=d[f].value;if("xpos"===t||"ypos"===t)switch(r){case "image":t="i"+t.charAt(0);
break;case "physical":t="p"+t.charAt(0);break;default:t=this.raw.wcs&&0<this.raw.wcs?"xpos"===t?"ra":"dec":"xpos"===t?"ix":"iy"}switch(t){case "multitext":case "colorPicker":case "savefile":case "rwcsbutton":case "savewcs":case "saveformat":case "includejson":case "includecomments":case "savewhich":case "savedcoords":break;case "text":"text"===b.type&&n(b,t,u)&&(g[t]=q(p(u)));break;case "selectfilter":u&&($(c).data("selectfilter",u),this.selectShapes(w,u));break;case "strokeDashes":var y=u.trim().split(/\s+/);
if(v&&u||n(b,t,y))g.strokeDashArray=0===y.length?[]:y.map(function(a){return parseInt(a,10)});break;case "strokeWidth":if(v&&u||!v&&n(b,t,y))g[t]=p(u);break;case "tags":v?u&&(g[t]=p(u)):n(b,t,u)&&(g[t]=p(u));break;case "childtext":"text"!==b.type&&n(b,t,u)&&(g.text=q(p(u)));break;case "ix":n(b,t,u)&&(b.pub.preservedcoords&&"d"===u.charAt(0).toLowerCase()?(g.dx=p(u.substring(1)),void 0===g.dy&&void 0!==b.pub.dy&&(g.dy=b.pub.dy)):(g.x=p(u),void 0===g.y&&void 0!==b.pub.y&&(g.y=b.pub.y)));break;case "iy":n(b,
t,u)&&(b.pub.preservedcoords&&"d"===u.charAt(0).toLowerCase()?(g.dy=p(u.substring(1)),void 0===g.dx&&void 0!==b.pub.dx&&(g.dx=b.pub.dx)):(g.y=p(u),void 0===g.x&&void 0!==b.pub.x&&(g.x=b.pub.x)));break;case "px":n(b,t,u)&&(g.px=p(u),void 0===g.py&&b.pub.lcs&&(g.py=b.pub.lcs.y));break;case "py":n(b,t,u)&&(g.py=p(u),void 0===g.px&&b.pub.lcs&&(g.px=b.pub.lcs.x));break;case "ra":n(b,t,u)&&(g.ra=u,void 0===g.dec&&(b.pub.wcsconfig.wcsposstr?g.dec=b.pub.wcsconfig.wcsposstr[1]:b.pub.wcsposstr&&(g.dec=b.pub.wcsposstr[1])));
break;case "dec":n(b,t,u)&&(g.dec=u,void 0===g.ra&&(b.pub.wcsconfig.wcsposstr?g.ra=b.pub.wcsconfig.wcsposstr[0]:b.pub.wcsposstr&&(g.ra=b.pub.wcsposstr[0])),void 0===g.wcssys&&(g.wcssys=r));break;case "wcssys":break;case "radius":case "length":case "width":case "r1":switch(r){case "image":n(b,t,u)&&(g[t]=p(u));break;case "physical":n(b,t,u)&&(g[t]=p(u)*e);break;default:y=a.strtoscaled(u),u="."===y.dtype&&"galactic"!==r&&"ecliptic"!==r?y.dval:Math.abs(y.dval/k.cdelt1),t=t.replace("wcs",""),n(b,t,u)&&
(g[t]=p(u))}break;case "height":case "r2":switch(r){case "image":n(b,t,u)&&(g[t]=p(u));break;case "physical":n(b,t,u)&&(g[t]=p(u)*e);break;default:y=a.strtoscaled(u),u="."===y.dtype&&"galactic"!==r&&"ecliptic"!==r?y.dval:Math.abs(y.dval/k.cdelt2),t=t.replace("wcs",""),n(b,t,u)&&(g[t]=p(u))}break;case "radii":n(b,t,u)&&(g[t]=u);break;case "linelength":if(b.pub.pts&&2===b.pub.pts.length&&a.isNumber(u)&&u!==this.tmp.linelength){u=parseFloat(u);switch(r){case "image":case "physical":break;default:void 0!==
k.cdelt1?u/=Math.abs(k.cdelt1):void 0!==k.cdelt2&&(u/=Math.abs(k.cdelt2))}if(g.pts){t=g.pts[0];var x=g.pts[1]}else t=b.pub.pts[0],x=b.pub.pts[1];if(0<=$.inArray("line",a.Regions.opts.noCenteredScaling)){var B=Math.sqrt((t.x-x.x)*(t.x-x.x)+(t.y-x.y)*(t.y-x.y));var z=t.x-u*(t.x-x.x)/B;u=t.y-u*(t.y-x.y)/B;g.pts=[t,{x:z,y:u}]}else z={x:(t.x+x.x)/2,y:(t.y+x.y)/2},B=parseFloat(this.tmp.lineangle)||0,t.x=z.x-u/2,t.y=z.y,x.x=z.x+u/2,x.y=z.y,g.pts=[a.rotatePoint(t,B,z),a.rotatePoint(x,B,z)]}break;case "lineangle":b.pub.pts&&
2===b.pub.pts.length&&a.isNumber(u)&&u!==this.tmp.lineangle&&(B=parseFloat(u)-parseFloat(this.tmp.lineangle)||0,g.pts?(t=g.pts[0],x=g.pts[1]):(t=b.pub.pts[0],x=b.pub.pts[1]),0<=$.inArray("line",a.Regions.opts.noCenteredScaling)?g.pts=[t,a.rotatePoint(x,B,t)]:(z={x:(t.x+x.x)/2,y:(t.y+x.y)/2},g.pts=[a.rotatePoint(t,B,z),a.rotatePoint(x,B,z)]));break;case "remove":n(b,t,u)&&(v?g[t]="selected":void 0!==b.pub.id&&(g[t]=b.pub.id));break;case "misc":if(u.trim())try{var A=JSON.parse(u);$.extend(g,A)}catch(C){a.error("invalid json: "+
u)}break;default:n(b,t,u)&&(g[t]=p(u))}}0<Object.keys(g).length&&(v?this.changeShapes(w,"selected",g):this.changeShapes(w,b,g),this.initRegionsForm(b,{multi:v}))};a.Regions.pasteFromClipboard=function(c){var b,d=0,e=0;if(this){(b=a.CopyFromClipboard().trim())||a.error(a.CLIPBOARDERROR);if(b.match(/(annulus|box|circle|cross|ellipse|line|polygon|point|text) *\(/)){var f=a.globalOpts.regToClipboard;a.globalOpts.regToClipboard=!1;var h=this.addShapes("regions",b,{rtn:"objs"});if(c){var g=h.length;for(c=
...
m){if("strokeDashArray"===m&&c.strokeDashArray){var n=c.strokeDashArray.join("");if(""===n||n.match(/NaN/))continue}"id"===m&&b.file||"wcsconfig"===m&&b.file||"data"===m&&"object"===typeof h.data&&!1===h.data.doexport&&b.file||("strokeWidth"===m&&h.sw1?g[m]=h.sw1:void 0!==c[m]?g[m]=c[m]:void 0!==h[m]?g[m]=h[m]:d&&void 0!==d[m]&&(g[m]=d[m]))}}if(0<k.length&&k[0].obj.text){n=k[0].obj;g.text=n.text;g.textOpts=w(n);if(c.angle!==n.angle){if(g.textOpts.angle=-n.angle,"circle"===c.params.shape||"annulus"===
c.params.shape)n.params.hasTextOpts=!0}else 0===n.angle||"circle"!==c.params.shape&&"annulus"!==c.params.shape||(g.textOpts.angle=-n.angle,n.params.hasTextOpts=!0);if(n.params.parent.moved||n.params.hasTextOpts)n.pub.ra&&n.pub.dec?(y&&x&&y!==x?(n=e.wcs2wcs(y,x,n.pub.ra,n.pub.dec),n=n.trim().split(/\s+/),d=a.saostrtod(n[0]),a.isHMS(x)&&(d*=15),n=a.saostrtod(n[1])):(d=n.pub.ra,n=n.pub.dec),g.textOpts.ra=d,g.textOpts.dec=n):n.pub.lcs?(g.textOpts.px=n.pub.lcs.x,g.textOpts.py=n.pub.lcs.y):(g.textOpts.x=
n.pub.x,g.textOpts.y=n.pub.y);g.textOpts.color===c.stroke&&delete g.textOpts.color;g.textOpts.text&&delete g.textOpts.text;Object.keys(g.textOpts).length||delete g.textOpts}return g};b=b||{};if("string"===typeof b)try{b=JSON.parse(b)}catch(E){a.error("can't parse listRegions opts: "+b,E)}var t=b.mode;a.isNull(t)&&(t=3);a.isNull(d)&&(d="regions");if(b.wcssys||b.wcsunits){var u=a.globalOpts.xeqPlugins;a.globalOpts.xeqPlugins=!1;if(b.wcssys){var y=this.getWCSSys();this.setWCSSys(b.wcssys,!1);var x=this.getWCSSys()}if(b.wcsunits){var B=
this.getWCSUnits();this.setWCSUnits(b.wcsunits,!1)}this.updateShapes(d,c,"export")}a.isNull(b.includedcoords)&&(b.includedcoords=a.globalOpts.regListDCoords);p=this.getShapes(d,c,{includeObj:!0});var z=p.length;if(t)for(f=0;f<z;f++){var A=p[f];if((h=A.tags.join(","))&&"source,include"!==h&&"include,source"!==h){n=!0;break}}for(C in a.Regions.opts.tagcolors)a.Regions.opts.tagcolors.hasOwnProperty(C)&&v.push(a.Regions.opts.tagcolors[C]);for(f=0;f<z;f++)if(A=p[f],q=A.obj,r=[],!A.sticky||!1!==b.sticky)if(!A.preservedcoords||
b.includedcoords)if($.isArray(q.params.preservedcoords)){for(h=0;h<q.params.preservedcoords.length;h++){var C=q.params.preservedcoords[h];switch(C){case "pts":0>$.inArray("dx",r)&&r.push("dx");0>$.inArray("dy",r)&&r.push("dy");0>$.inArray("points",r)&&r.push("points");break;default:r.push(C)}}"none"!==m&&(l+="; ");"image"!==m&&(l+="image",l+="; ");l+=A.shape+"({";for(k=h=0;h<r.length;h++)if(C=r[h],"shape"!==C&&"sticky"!==C&&"wcsconfig"!==C){"pts"===C&&(C="dx",q.params.preservedcoords.push("dy"),q.params.preservedcoords.push("points"));
if("preservedcoords"===C)m=!0;else if(a.notNull(A[C]))m=A[C];else if(a.notNull(q[C]))m=q[C];else switch(C){case "dx":m=q.left;break;case "dy":m=q.top;break;case "color":m=q.stroke;break;default:m=null}if(m)switch(0<k++&&(l+=","),l+='"'+C+'":',typeof m){case "string":l+='"'+m+'"';break;case "object":try{l+=JSON.stringify(m)}catch(E){a.error("can't parse: "+m,E)}break;default:l+=""+m}}l+="})";m="image"}else h=A.tags.join(","),C=h.includes("exclude")?"-":"",q=w(q,A),b.saveid&&(q.id=A.id),b.savewcsconfig&&
A.wcsconfig&&0<Object.keys(A.wcsconfig).length&&(q.wcsconfig=$.extend(!0,{},A.wcsconfig)),A.color&&!v.includes(A.color)&&(q.color=A.color),n&&(g=" # "+h),A.wcsstr&&a.isWCS(this.params.wcssys)?("wcs"!==m&&("none"!==m&&(l+="; "),l=A.wcssys?l+A.wcssys:l+this.params.wcssys,m="wcs"),l+="; "+C+A.wcsstr):A.imstr&&(m!==A.imsys&&("none"!==m&&(l+="; "),l+=A.imsys,m=A.imsys),l+="; "+C+A.imstr),!1!==b.includejson&&1===t%2&&0<Object.keys(q).length&&("line"===A.shape&&(l=l.replace(/ *{[^{}]*}$/,"")),l+=" "+JSON.stringify(q)),
g&&(l+=g);!1===b.includecomments&&(l=l.replace(/ *#[^;]*/g,""));if(y||B)y&&this.setWCSSys(y,!1),B&&this.setWCSUnits(B,!1),this.updateShapes(d,c,"export"),a.globalOpts.xeqPlugins=u;1<t&&this.display.displayMessage("regions",l);return l};a.Regions.copyRegions=function(a,b){return this.copyShapes("regions",a,b)};a.Regions.parseRegions=function(c,b){var d=this,e,f,h=[],g=/^-?(annulus|box|circle|cross|ellipse|line|polygon|point|text)$/,k=/^(fk4|fk5|icrs|galactic|ecliptic|image|physical|linear)$/,l=/^(image|physical)$/,
m=/[dr:]/,n=/\(\s*([^)]+?)\s*\)/,p=/(\{.*\})/,q=/\s*,\s*/,r=/#(?![a-zA-Z0-9]{6}['"])/,v=function(a){return"0"===a||"false"===a.toLowerCase()?!1:!0},w=function(a){for(var b,c,d,e={},f=/([a-zA-Z][a-zA-Z0-9_]*)\s*=\s*(\d+(\s*\d+)*|[^ '"{]+|['"{][^'"}]*['"}])/g,g={color:function(a){return{color:a}},dash:function(a){if(a)return{strokeDashArray:[3,1]}},dashlist:function(a){if(a){var b=a.split(" ");for(a=0;a<b.length;a++)b[a]=parseFloat(b[a]);return{strokeDashArray:b}}},delete:function(a){return{removable:v(a)}},
...
b.includes("(")?d.cmd=b.split("(")[0].trim().toLowerCase():b.includes("{")?d.cmd=b.split("{")[0].trim().toLowerCase():b.includes("#")?d.cmd=b.split("#")[0].trim().toLowerCase():d.cmd=b.trim().toLowerCase();d.cmd&&(d.isregion=0<=d.cmd.search(g));var e=b.trim().split(r);if((c=p.exec(e[0]))&&c[0])try{d.opts=JSON.parse(c[0].trim())}catch(M){a.error("can't parse opts: "+c[0],M)}d.comment=e[1];if(d.comment){var f=w(d.comment.trim());void 0!==f._comment&&(d.comment=f._comment,delete f._comment)}f&&(d.opts=
$.extend({},f,d.opts));(c=n.exec(b))&&c[0].match(p)?d.args=[]:c&&c[1]&&(d.args=c[1].split(q));d.isregion&&d.cmd.startsWith("-")&&(d.cmd=d.cmd.slice(1),d.comment?d.comment.match(/exclude/)||(d.comment+=",exclude"):d.comment="exclude");return d},u=function(b,c){var e={};if("d"===b.charAt(0).toLowerCase()&&"d"===c.charAt(0).toLowerCase())return e.dx=parseFloat(b.substring(1)),e.dy=parseFloat(c.substring(1)),e;b=a.strtoscaled(b);c=a.strtoscaled(c);!b.dtype.match(m)&&!c.dtype.match(m)||z||x.match(l)||
(C=!0,B=x);if(z||C)return a.isHMS(B,b.dtype)&&(b.dval*=15),"r"===b.dtype&&(b.dval=180*b.dval/Math.PI),"r"===c.dtype&&(c.dval=180*c.dval/Math.PI),c=a.wcs2pix(d.raw.wcs,b.dval,c.dval).split(/ +/),e.x=parseFloat(c[0]),e.y=parseFloat(c[1]),e;if("physical"===B)return c=d.logicalToImagePos({x:b.dval,y:c.dval}),e.x=c.x,e.y=c.y,e;e.x=b.dval;e.y=c.dval;return e},y=function(b,c){b=a.strtoscaled(b);var e=d.raw.wcsinfo||{cdelt1:1,cdelt2:1};!b.dtype.match(m)||z||x.match(l)||(C=!0,B=x);z||C?("r"===b.dtype&&(b.dval=
180*b.dval/Math.PI),b.dval=Math.abs(b.dval/e["cdelt"+c])):"physical"===B&&d.lcs&&d.lcs.physical&&(c=Math.sqrt(Math.pow(d.lcs.physical.forward[0][0],2)+Math.pow(d.lcs.physical.forward[0][1],2)),b.dval=Math.abs(b.dval*c));return b.dval};c=c.trim();if(!c.match(/(\(|\{|#|;|\n)/))return c;var x=this.getWCSSys();b=this.getWCSUnits();var B="physical";var z=a.isWCS(B);var A=c.split(/\n|;/);for(c=0;c<A.length;c++)if("#"!==A[c].trim().substr(0,1)){var C=!1;var E=t(A[c]);var D=E.args.length;if(E.isregion){var F=
$.extend(!0,{},E.opts);F.shape=E.cmd;F.wcsconfig=F.wcsconfig||{wcssys:B};2<=D&&"line"!==F.shape&&"polygon"!==F.shape&&$.extend(F,u(E.args[0],E.args[1]));F.textOpts&&void 0!==F.textOpts.ra&&void 0!==F.textOpts.dec&&(F.textOpts._wcssys=B);switch(E.cmd){case "annulus":if(0<D)for(F.radii=[],e=2;e<D;e++)F.radii.push(y(E.args[e],1));break;case "box":case "cross":3<=D&&(F.width=y(E.args[2],1));4<=D&&(F.height=y(E.args[3],2));5<=D&&(F.angle=a.strtoscaled(E.args[4]).dval);break;case "circle":3<=D&&(F.radius=
y(E.args[2],1));break;case "ellipse":3<=D&&(F.r1=y(E.args[2],1));4<=D&&(F.r2=y(E.args[3],2));5<=D&&(F.angle=a.strtoscaled(E.args[4]).dval);break;case "line":case "polygon":if(0<D)for(F.pts=[],f=e=0;e<D;e+=2,f++){var G=u(E.args[e],E.args[e+1]);a.notNull(G.dx)&&a.notNull(G.dy)?F.pts[f]={dx:G.dx,dy:G.dy}:F.pts[f]={x:G.x,y:G.y}}break;case "text":3<=D&&(F.text=E.args[2].replace(/^['"]/,"").replace(/["']$/,"")),4<=D&&(F.angle=a.strtoscaled(E.args[3]).dval)}E.comment&&(F.tags=E.comment);h.push(F)}else E.cmd.match(k)?
(e=a.globalOpts.xeqPlugins,a.globalOpts.xeqPlugins=!1,this.setWCSSys(E.cmd,!1),a.globalOpts.xeqPlugins=e,B=this.getWCSSys(),z=a.isWCS(B)):"remove"!==E.cmd&&"delete"!==E.cmd||h.push({remove:!0})}e=a.globalOpts.xeqPlugins;a.globalOpts.xeqPlugins=!1;this.setWCSSys(x,!1);this.setWCSUnits(b);a.globalOpts.xeqPlugins=e;return h};a.Regions.saveRegions=function(c,b,d){var e,f,h;c&&(f=c.match(/\.([^.]*)$/))&&f[1]&&f[1].match(/^(reg|svg|csv)$/)&&(e=f[1]);if("object"===typeof d){var g=d;d=null}else if(d&&"string"===
typeof d){try{g=JSON.parse(d)}catch(p){g=null}g&&(d=null)}g&&(a.notNull(g.layer)&&(d=g.layer),a.notNull(g.type)&&(e=g.type),a.notNull(g.format)&&(e=g.format));g=g||{};d=d||"regions";e=e||"reg";this.layers[d]||a.error("can't find layer for saveRegions: "+d);c||(c=d&&"regions"!==d?"js9_"+d+"."+e:"js9."+e);switch(e){case "svg":try{a.globalOpts.svgBorder&&(h=this.addShapes(d,"box",{left:this.rgb.img.width/2,top:this.rgb.img.height/2,width:this.rgb.img.width,height:this.rgb.img.height,color:"black",strokeWidth:1,
tags:"SVGBorder"}));var k=this.layers[d].dlayer.canvas.toSVG();a.globalOpts.svgBorder&&this.removeShapes(d,h)}catch(p){a.error("can't convert layer to SVG: "+d)}break;case "csv":try{g.mode=1;g.file=c;a.isNull(g.includewcs)&&(g.includewcs=a.globalOpts.csvIncludeWCS);a.isNull(g.savedcoords)&&(g.includedcoords=a.globalOpts.regSaveDCoords);var l=this.listRegions(b,g,d);f=l.split(";");var m=0;for(k="";m<f.length;m++)if(f[m])if(f[m].toLowerCase().match(a.WCSEXP))g.includewcs&&(k+=f[m].trim()+"\n");else{var n=
f[m].replace(/\(/,",").replace(/\).*/,"").trim();k+=n+"\n"}}catch(p){a.error("can't convert layer to region: "+d)}break;default:try{g.mode=1,g.file=c,a.isNull(g.includejson)&&(g.includejson=a.globalOpts.regIncludeJSON),a.isNull(g.includecomments)&&(g.includecomments=a.globalOpts.regIncludeComments),a.isNull(g.savedcoords)&&(g.includedcoords=a.globalOpts.regSaveDCoords),l=this.listRegions(b,g,d).replace(/; */g,"\n"),k=!1!==g.includecomments?"# Region file format: JS9 version 1.0\n"+l+"\n":l+"\n"}catch(p){a.error("can't convert layer to region: "+
...
this.getShapes("regions",a);for(a=0;a<f.length;a++){var h=f[a].tags;var g=[];for(c=0;c<b.length;c++)0>$.inArray(b[c],h)&&g.push(b[c]);for(c=0;c<h.length;c++)0>$.inArray(h[c],d)&&g.push(h[c]);this.changeShapes("regions",f[a].id,{tags:g})}};a.Regions.toggleRegionTags=function(a,b,d){var c;var f=this.getShapes("regions",a||"all");for(a=0;a<f.length;a++){var h=f[a].tags;var g="";for(c=0;c<h.length;c++)if(h[c]===b){g=h[c]=d;break}else if(h[c]===d){g=h[c]=b;break}g&&this.changeShapes("regions",f[a].id,
{tags:h})}};a.Plot={};a.Plot.CLASS="JS9";a.Plot.NAME="Plot";a.Plot.opts={annotate:!1,annotateColor:"#FF0000",color:"blue",zoomStack:{enabled:!0},selection:{mode:"xy"},series:{clickable:!0,hoverable:!0,lines:{show:!0},points:{show:!1}},legend:{backgroundColor:null,backgroundOpacity:0},xaxis:{autorange:!0},yaxis:{autorange:!0},title:"Plot Configuration",configURL:"./params/plotconfig.html"};a.Plot.logfunc=function(a){return 0===a?0:Math.log(a)};a.Plot.expfunc=function(a){return 0===a?0:Math.exp(a)};
a.Plot.rescale=function(c,b,d,e,f,h,g){switch(a.globalOpts.plotLibrary){case "flot":switch(e){case "x":var k=b.getAxes().xaxis;break;case "y":k=b.getAxes().yaxis}switch(f){case "linear":k.options.transform=null;k.options.inverseTransform=null;d.curscale[e]=f;break;case "log":k.options.transform=a.Plot.logfunc,k.options.inverseTransform=a.Plot.expfunc,d.curscale[e]=f}a.isNumber(h)?k.options.min=Number.parseFloat(h):""==h&&(k.options.min=null);a.isNumber(g)?k.options.max=Number.parseFloat(g):""==g&&
(k.options.max=null);b.setupGrid();b.draw();break;case "plotly":switch(e){case "x":var l={xaxis:{type:f,autorange:!0}};d.curscale[e]=f;break;case "y":l={yaxis:{type:f,autorange:!0}},d.curscale[e]=f}Plotly.restyle(c.attr("id"),l)}};a.Plot.annotate=function(c,b,d){var e;var f=[];var h=d.data,g=d.annotations.color||a.Plot.opts.annotateColor,k=function(a,b){if(!a.text)return null;var c=a.x||0;if("%Y"===a.y.toUpperCase())for(a=1;a<b.length-1;a++){if(b[a][0]>c){var d=Math.max(b[a-1][1],b[a][1],b[a+1][1]);
break}}else d=a.y;return{x:c,y:d}};switch(a.globalOpts.plotLibrary){case "flot":var l=-25;c.find(".plotAnnotation").remove();for(e=0;e<d.annotations.data.length;e++){var m=d.annotations.data[e];var n=k(m,h);f=b.pointOffset({x:n.x,y:n.y});0>f.left||f.left>c.width()||(m=sprintf("<div class='plotAnnotation' style='position: absolute; left: %spx; top:%spx; color: %s; font-size: small'>%s</div>",f.left,f.top+l,g,"&darr;"+m.text),c.append(m))}break;case "plotly":l=-30;for(e=0;e<d.annotations.data.length;e++)if(m=
d.annotations.data[e],n=k(m,h))c={x:n.x,y:n.y,xref:"x",yref:"y",text:m.text,arrowcolor:g,font:{color:g},showarrow:!0,arrowhead:2,ax:0,ay:l},f.push(c);return f}};a.Plot.initConfigForm=function(c,b){var d,e;var f=c.winid;var h="#"+$(f).attr("id")+" #plotConfigForm ";var g=function(a){if(void 0!==a)return"number"===typeof a&&0!==a%1&&(a=Math.round(100*(a+.001))/100),String(a)};c&&b&&"flot"===a.globalOpts.plotLibrary&&($(h+".val").each(function(f,h){d="";e=$(h).attr("name");switch(e){case "xscale":a.notNull(b.curscale.x)&&
(d=g(b.curscale.x));break;case "xmin":a.notNull(c.getAxes().xaxis.options.min)&&(d=g(c.getAxes().xaxis.options.min));break;case "xmax":a.notNull(c.getAxes().xaxis.options.max)&&(d=g(c.getAxes().xaxis.options.max));break;case "yscale":a.notNull(b.curscale.y)&&(d=g(b.curscale.y));break;case "ymin":a.notNull(c.getAxes().yaxis.options.min)&&(d=g(c.getAxes().yaxis.options.min));break;case "ymax":a.notNull(c.getAxes().yaxis.options.max)&&(d=g(c.getAxes().yaxis.options.max))}$(h).val(d)}),$(h).data("im",
this),$(h).data("plot",c),$(h).data("pobj",b),$(h).data("winid",f),$(h).data("tooltipInit")||($(h).data("tooltipInit",!0),a.BROWSER[3]?(f="touchstart",h="touchend"):(f="mouseover",h="mouseout"),$(".plotcol_P").on(f,function(b){var c=b.currentTarget;b=$(c).find("input").data("tooltip");c=$(c).closest(a.lightOpts[a.LIGHTWIN].top).find(a.lightOpts[a.LIGHTWIN].dragBar);b&&c.length&&(b=a.Plot.opts.title+": "+b,$(c)[0].childNodes[0].nodeValue=b)}),$(".plotcol_P").on(h,function(b){b=$(b.currentTarget).closest(a.lightOpts[a.LIGHTWIN].top).find(a.lightOpts[a.LIGHTWIN].dragBar);
b.length&&($(b)[0].childNodes[0].nodeValue=a.Plot.opts.title)})))};a.Plot.processConfigForm=function(c,b,d,e){var f=e.length;switch(a.globalOpts.plotLibrary){case "plotly":return}for(c=0;c<f;c++){var h=e[c].name;var g=e[c].value;switch(h){case "xscale":""===g&&(g="linear");a.Plot.rescale(null,b,d,"x",g);break;case "xmin":a.Plot.rescale(null,b,d,"x",null,g,null);break;case "xmax":a.Plot.rescale(null,b,d,"x",null,null,g);break;case "yscale":""===g&&(g="linear");a.Plot.rescale(null,b,d,"y",g);break;
case "ymin":a.Plot.rescale(null,b,d,"y",null,g,null);break;case "ymax":a.Plot.rescale(null,b,d,"y",null,null,g)}}a.Plot.initConfigForm.call(this,b,d)};a.plotOpts=a.Plot.opts;a.Catalogs={};a.Catalogs.CLASS="JS9";a.Catalogs.NAME="Catalogs";a.Catalogs.opts={hasControls:!1,hasRotatingPoint:!1,hasBorders:!1,lockMovementX:!0,lockMovementY:!0,lockRotation:!0,lockScalingX:!0,lockScalingY:!0,lockUniScaling:!0,selectable:!1,canvas:{selection:!1},updateWCS:!1,panzoom:!0,shape:"circle",strokeWidth:2,width:10,
...
y:-9999},{x:-9999,y:-9900}]}};a.Crosshair.display=function(c,b,d){var e=a.Crosshair.LAYERNAME;d=/iPad|iPhone|iPod/.test(navigator.platform)?!0:d.shiftKey;if(c.tmp.arrowCrosshair||d&&c&&!c.tmp.shiftKey&&c.crosshair&&c.params.crosshair){if(c.tmp.arrowCrosshair&&!c.params.crosshair){var f=a.Crosshair.opts.arrowSize/c.rgb.sect.zoom;d=b.x-f;var h=b.x+f;var g=b.y-f;var k=b.y+f}else d=0,h=c.raw.width,g=0,k=c.raw.height;h={pts:[{x:d,y:b.y},{x:h,y:b.y}],redraw:!1};c.changeShapes(e,c.crosshair.h,h);d={pts:[{x:b.x,
y:g},{x:b.x,y:k}],redraw:!0};c.changeShapes(e,c.crosshair.v,d);c.crosshair.visible=!0;if(a.globalOpts.wcsCrosshair&&c&&c.raw.wcs&&0<c.raw.wcs){g=a.pix2wcs(c.raw.wcs,b.x,b.y).trim().split(/\s+/);var l=a.saostrtod(g[0]);a.isHMS(c.params.wcssys)&&(l*=15);var m=a.saostrtod(g[1]);for(b=0;b<a.displays.length;b++)if((f=a.displays[b].image)&&f!==c&&f.crosshair&&f.params.crosshair&&0<f.raw.wcs){h=f.raw.width;k=f.raw.height;try{var n=a.wcs2pix(f.raw.wcs,l,m)}catch(p){n=null}n&&(g=n.trim().split(/\s+/),d=parseFloat(g[0]),
g=parseFloat(g[1]),0<d&&d<h&&0<g&&g<k&&(h={pts:[{x:0,y:g},{x:h,y:g}],redraw:!1},f.changeShapes(e,f.crosshair.h,h),d={pts:[{x:d,y:0},{x:d,y:k}],redraw:!0},f.changeShapes(e,f.crosshair.v,d),f.crosshair.visible=!0))}}}};a.Crosshair.hide=function(c,b,d){b=a.Crosshair.LAYERNAME;d=a.Crosshair.opts.hiddenPts;if(c&&c.crosshair&&c.crosshair.visible||c.tmp.arrowCrosshairVisible)c.changeShapes(b,c.crosshair.h,d),c.changeShapes(b,c.crosshair.v,d),c.crosshair.visible=!1,delete c.tmp.arrowCrosshairVisible};a.Crosshair.create=
...
c.wcssys&&"ecliptic"!==c.wcssys&&(b/=15);b=a.saodtostr(b,":",c.sexaPrec);var h=b.split(":");if(c.last[d])for(b="",e=0;e<h.length;e++)if(b&&(b+=":"),f||h[e]!==c.last[d][e])b+=h[e],f=!0;c.last[d]=$.extend({},h);break;default:b=b.toFixed(c.degPrec)}b=b.replace(/0+$/,"");c=b.indexOf(".");0>c?b+=".0":c===b.length-1&&(b+="0");return b=b.replace(/:\.0/,":0.0")};a.Grid.display=function(c,b){var d,e,f,h;var g=this.display;var k=this.raw;var l=[{ra:0,dec:0},{ra:0,dec:0},{ra:0,dec:0},{ra:0,dec:0}];if(a.isNull(c))switch(this.tmp.gridStatus){case "inactive":case void 0:return!1;
