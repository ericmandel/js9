...
"width=660px,height=200px,resize=1,scrolling=1",a.lightOpts.dhtml.regWin="width=660px,height=470px,resize=1,scrolling=1");window.hasOwnProperty("Jupyter")&&(a.globalOpts.useWasm=!1);window.electron&&("Chrome"===a.BROWSER[0]&&66<=parseFloat(a.BROWSER[1])&&(a.globalOpts.allowFileWasm=!0),a.hasNode="object"===typeof process&&"function"===typeof require,a.hasNode&&(a.localMount=require("os").hostname()||"localAccess"),window.electron&&window.electron.multiElectron&&(a.globalOpts.localStorage=!1),window&&
"function"===typeof window.eval&&(window.eval=function(){throw Error("For security reasons, Desktop JS9 does not support window.eval()");}));a.Image=function(c,b,d){var e=this,f=null,h=0,g=0,k=function(b){b=b||{};a.isNull(b.scaleclipping)?"zscale"===e.params.scaleclipping?e.zscale(!0):"zmax"===e.params.scaleclipping&&e.zscale("zmax"):"zscale"===b.scaleclipping?e.zscale(!0):"zmax"===b.scaleclipping&&e.zscale("zmax");a.notNull(b.scalemin)&&(e.params.scalemin=b.scalemin);a.notNull(b.scalemax)&&(e.params.scalemax=
b.scalemax)},l=function(b){var c=a.globalOpts.imopts,d=a.globalOpts.imcmap,g=a.globalOpts.alerts;var h=/(annulus|box|circle|ellipse|line|polygon|point|text) *\(/;a.images.push(e);e.display.clearMessage();e.displayImage("all",f);e.notifyHelper();e.showShapeLayer("regions",!0,{local:!0});f&&((a.notNull(f.x)&&a.notNull(f.y)||a.notNull(f.px)&&a.notNull(f.py)||a.notNull(f.ra)&&a.notNull(f.dec)||a.notNull(f.wcs))&&e.setPan(f),f.regions&&(f.regions.match(h)?e.addShapes("regions",f.regions):a.LoadRegions(f.regions,
{display:e.display})));a.globalOpts.alerts=!1;if(e.raw&&e.raw.header&&e.raw.header[d]){try{var k=JSON.parse(e.raw.header[d])}catch(z){k=null}if(k)try{a.AddColormap(k)}catch(z){}}if(e.raw&&e.raw.header&&e.raw.header[d+"1"]){var l=1;for(h="";100>l;l++){var m=d+String(l);if(e.raw.header[m])h+=e.raw.header[m];else break}if(h){try{k=JSON.parse(h)}catch(z){k=null}if(k)try{a.AddColormap(k)}catch(z){}}}if(e.raw&&e.raw.header&&e.raw.header[c]){try{k=JSON.parse(e.raw.header[c])}catch(z){k=null}if(k)try{e.setParam("all",
k)}catch(z){}}if(e.raw&&e.raw.header&&e.raw.header[c+"1"]){l=1;for(h="";100>l;l++)if(m=c+String(l),e.raw.header[m])h+=e.raw.header[m];else break;if(h){try{k=JSON.parse(h)}catch(z){k=null}if(k)try{e.setParam("all",k)}catch(z){}}}a.globalOpts.alerts=g;e.xeqPlugins("image","onimageload");e.setStatus("load","complete");a.waiting(!1);if(b)try{a.xeqByName(b,window,e)}catch(z){a.error("in image onload callback",z,!1)}if(a.preloadwaiting&&a.preloadwaiting.length){var n=a.preloadwaiting.length;b=e.proxyURL||
e.file;for(k=l=0;l<n;l++){var p=a.preloadwaiting[l];b.match(p.id)||p.id.match(b)?(p.loaded=!0,p.im=e):!1===p.loaded&&k++}if(!k){a.globalOpts.sortPreloads?(a.images.sort(function(b,c){var d=0,e=0;for(l=0;l<n;l++)p=a.preloadwaiting[l],b.id===p.im.id&&(d=l),c.id===p.im.id&&(e=l);return d-e}),b=a.preloadwaiting[n-1].im||e,b.displayImage()):b=e;if(a.notNull(a.globalOpts.onpreload))try{a.xeqByName(a.globalOpts.onpreload,window,b)}catch(z){a.error("in onpreload callback",z,!1)}finally{delete a.globalOpts.onpreload}a.preloadwaiting=
...
g+"'></div>",c.textjq&&c.textjq[0]&&(g=c.textjq[0].toDataURL("image/png"),f+=c.colorbarjq.height()+1,l=sprintf("<div style='position:absolute; left:%spx; top:%spx'>",0,f),k+=l+"<img style='width:"+this.display.width+"px;'src='"+g+"'></div>"));k+="</body></html>";window.electron&&(e="data:text/html,<html><body><script>window.addEventListener('message', (ev) => {document.documentElement.innerHTML=ev.data; window.setTimeout(() => {window.print()}, 250);},false)\x3c/script><p>waiting for image ...</body></html>");
...
"js9.reg";window.electron&&!h.match(/.*\//)&&(h=window.electron.currentDir+"/"+h);break;case "selectfilter":h=$(u).data("selectfilter");break;default:void 0!==c.pub[f]&&(h=r(c.pub[f]))}$(m).val(h)});(n||!this.raw.wcs||0>this.raw.wcs)&&$(u).find("[name='wcssys']").hide();"text"!==c.type&&c.params.children&&($(u+".childtext").removeClass("nodisplay"),$(u+"[name='childtext']").prop("readonly",0<c.params.children.length));if(b.firsttime){window.electron&&$(u).find(".rsavebrowse, .rconfigbrowse").removeClass("nodisplay");
...
b=a.parsePublicArgs(b);var e={cmd:"print"};b.argv[0]&&(e.opts=b.argv[0]);window.electron?window.setTimeout(function(){try{window.electron.sendMsg(e)}catch(f){a.error("could not print window",f)}},a.TIMEOUT):a.error("WindowPrint is only available for the JS9 desktop app")});a.mkPublic("WindowToPDF",function(c){for(var b=[],d=0;d<arguments.length;++d)b[d-0]=arguments[d];b=a.parsePublicArgs(b);var e={cmd:"pdf"};e.filename=b.argv[0]||"js9.pdf";b.argv[1]&&(e.opts=b.argv[1]);window.electron?window.setTimeout(function(){try{window.electron.sendMsg(e)}catch(f){a.error("could not create window pdf",
f)}},a.TIMEOUT):a.error("WindowToPDF is only available for the JS9 desktop app")});a.mkPublic("SaveDir",function(c){for(var b=[],d=0;d<arguments.length;++d)b[d-0]=arguments[d];b=a.parsePublicArgs(b);var e={cmd:"savedir"};b.argv[0]?e.opts=b.argv[0]:a.error("SaveDir requires a directory name");window.electron?window.setTimeout(function(){try{window.electron.sendMsg(e)}catch(f){a.error("could not set save directory",f)}},a.TIMEOUT):a.error("SaveDir is only available for the JS9 desktop app")});a.init=
function(){var c;window.HTMLCanvasElement&&JSON||a.error("your browser does not support JS9 (no HTML5 canvas and/or JSON). Please try a modern version of Firefox, Chrome, Safari, Opera, or Edge.");window.hasOwnProperty("JS9Prefs")&&"object"===typeof JS9Prefs&&JS9Prefs.globalOpts&&JS9Prefs.globalOpts.installDir&&(a.INSTALLDIR=JS9Prefs.globalOpts.installDir);if(!a.INSTALLDIR){try{$('link[href$="js9.css"]').each(function(b,c){(b=$(c).attr("href"))&&"js9.css"===b.split("/").reverse()[0]&&(a.INSTALLDIR=
b.replace(/js9\.css$/,""))})}catch(g){a.INSTALLDIR=""}a.INSTALLDIR&&(a.INSTALLDIR=a.cleanPath(a.INSTALLDIR))}a.INSTALLDIR&&"/"!==a.INSTALLDIR.slice(-1)&&(a.INSTALLDIR+="/");a.TOROOT=a.INSTALLDIR.replace(/([^/.])+/g,"..");window.hasOwnProperty("JS9Inline")&&"object"===typeof JS9Inline&&(a.inline=$.extend(!0,{},JS9Inline));"dhtml"===a.LIGHTWIN&&($("<div>").attr("id","dhtmlwindowholder").appendTo($(document.body)).append("<span style='display:none'>.</span>"),dhtmlwindow.imagefiles=a.inline?[a.inline["images/min.gif"],
a.inline["images/close.gif"],a.inline["images/restore.gif"],a.inline["images/resize.gif"]]:a.allinone?[a.allinone.min,a.allinone.close,a.allinone.restore,a.allinone.resize]:[a.InstallDir("images/min.gif"),a.InstallDir("images/close.gif"),a.InstallDir("images/restore.gif"),a.InstallDir("images/resize.gif")],window.hasOwnProperty("Jupyter")&&$(a.lightOpts[a.LIGHTWIN].topid).arrive("input",function(b){a.jupyterFocus($(b).parent())}));a.globalOpts.plotLibrary=a.globalOpts.plotLibrary||"flot";"plotly"!==
a.globalOpts.plotLibrary||window.hasOwnProperty("Plotly")||(a.globalOpts.plotLibrary="flot");window.hasOwnProperty("JS9Prefs")&&"object"===typeof JS9Prefs?a.mergePrefs(JS9Prefs):a.PREFSFILE&&(a.loadPrefs(a.InstallDir(a.PREFSFILE),0),a.loadPrefs(a.PREFSFILE,0));a.hasOwnProperty("Regions")&&$.extend(!0,a.Regions.opts,a.regionOpts);delete a.regionOpts;a.hasOwnProperty("Catalogs")&&$.extend(!0,a.Catalogs.opts,a.catalogOpts);delete a.catalogOpts;a.hasOwnProperty("Crosshair")&&$.extend(!0,a.Crosshair.opts,
a.crosshairOpts);delete a.crosshairOpts;a.hasOwnProperty("Grid")&&$.extend(!0,a.Grid.opts,a.gridOpts);delete a.gridOpts;a.hasOwnProperty("Module")&&$.extend(!0,Module,a.emscriptenOpts);delete a.emscriptenOpts;a.globalOpts.resize||(a.globalOpts.resizeHandle=!1);void 0!==a.analOpts.prependJS9Dir&&(a.globalOpts.prependJS9Dir=a.analOpts.prependJS9Dir,delete a.analOpts.prependJS9Dir);void 0!==a.analOpts.dataDir&&(a.globalOpts.dataDir=a.analOpts.dataDir,delete a.analOpts.dataDir);void 0!==a.globalOpts.regionsToClipboard&&
...
winDims:[0,0]});a.RegisterPlugin(a.Dysel.CLASS,a.Dysel.NAME,a.Dysel.init,{onimageload:a.Dysel.imageload,onimageclose:a.Dysel.imageclose,winDims:[0,0]});a.RegisterPlugin(a.Titlebar.CLASS,a.Titlebar.NAME,a.Titlebar.init,{onimageload:a.Titlebar.imageload,onimagedisplay:a.Titlebar.imagedisplay,onimageclose:a.Titlebar.imageclose,winDims:[0,0]});a.instantiatePlugins();a.plugins.sort(function(a,b){a=a.opts.menuItem;b=b.opts.menuItem;return a?!b||a<b?-1:a>b?1:0:1});if(a.globalOpts.processQueryParams&&(c=
new URL(window.location),c.searchParams)){b={};c=$jscomp.makeIterator(c.searchParams);for(var d=c.next();!d.done;d=c.next()){var e=$jscomp.makeIterator(d.value);d=e.next().value;e=e.next().value;switch(d){case "url":case "file":var f=e;break;case "display":var h={display:e};break;default:b[d]=e}}f&&(h?a.Preload(f,b,h):a.Preload(f,b))}$(document).scrollTop(0);a.inited=!0;$(document).trigger("JS9:init")};return a}();
$(document).ready(function(){$(document).on("JS9:ready",function(){JS9.readied||(JS9.readied=!0,JS9.Preload(!0))});$(document).on("JS9:init",function(){JS9.helper.ready&&JS9.fits.ready&&$(document).trigger("JS9:ready",{status:"OK"})});$(document).on("astroem:ready",function(){JS9.initFITS();if(window.electron&&JS9.hasNode)try{JS9.vmount("/",JS9.localMount)||delete JS9.localMount}catch(a){delete JS9.localMount}JS9.helper.ready&&JS9.inited&&$(document).trigger("JS9:ready",{status:"OK"})});$(document).on("JS9:helperReady",
