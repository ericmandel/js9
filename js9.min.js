...
this.params.invert&&(b=1-b);c=Math.floor(((c/d-b)*e+.5)*d);return 0>c?0:c>=d?d-1:c};a.Image.prototype.mkColorCells=function(){var c,b=a.COLORSIZE;if("static"===this.cmapObj.type)return this;this.colorCells||(this.colorCells=[]);for(c=0;c<b;c++){var d=this.params.invert?b-c-1:c;d=this.calcContrastBias(d);this.colorCells[c]=this.cmapObj.mkColorCell(d)}return this};a.Image.prototype.mkScaledCells=function(){var c,b;var d=a.COLORSIZE;var e=a.SCALESIZE,f=a.INVSIZE;var h=a.HISTSIZE;if(!this.colorCells||
"static"===this.cmapObj.type)return this;if(!this.psColors){var g=this.psColors=[];var k=this.params.nancolor;var l=[];"#"===k.charAt(0)&&(k=k.slice(1));k=k.toUpperCase();for(c=b=0;6>b;b+=2,c++){var m="0123456789ABCDEF".indexOf(k.charAt(b));var n="0123456789ABCDEF".indexOf(k.charAt(b+1));l[c]=16*m+n}g[NaN]=l}this.psInverse||(this.psInverse=[],this.psInverse[NaN]=0);k=this.params.scalemax-this.params.scalemin;b=this.params.scalemin;switch(this.params.scale){case "linear":for(g=0;g<e;g++)c=g/e,c=Math.floor(c*
d),this.psColors[g]=this.colorCells[c];for(g=0;g<f;g++)c=g/f,this.psInverse[g]=c*k+b;break;case "log":h=this.params.exp;for(g=0;g<e;g++)c=Math.log(h*g/e+1)/Math.log(h),c=Math.floor(c*d),c>=d&&(c=d-1),this.psColors[g]=this.colorCells[c];for(g=0;g<f;g++)c=(Math.pow(h,g/f)-1)/h,this.psInverse[g]=c*k+b;break;case "power":h=this.params.exp;for(g=0;g<e;g++)c=(Math.pow(h,g/e)-1)/h,c=Math.floor(c*d),c>=d&&(c=d-1),this.psColors[g]=this.colorCells[c];for(g=0;g<f;g++)c=Math.log(h*g/f+1)/Math.log(h),this.psInverse[g]=
...
c)/10,this.psInverse[g]=c*k+b;break;case "sinh":for(g=0;g<e;g++)c=g/e,c=Math.floor(Math.sinh(3*c)/10*d),c>=d&&(c=d-1),this.psColors[g]=this.colorCells[c];for(g=0;g<f;g++)c=g/f,c=Math.asinh(10*c)/3,this.psInverse[g]=c*k+b;break;case "histeq":l=this.raw.data;var p=this.raw.width*this.raw.height;k=this.raw.dmax-this.raw.dmin;var q=this.raw.dmax;b=this.raw.dmin;var r=c=0;m=[];if(!this.hist||!this.hist.length){this.hist=[];for(g=0;g<h;g++)m[g]=0;for(g=0;g<p;g++)l[g]>=b&&l[g]<=q&&(n=Math.floor((l[g]-b)/
k*h+.5),n<h&&(m[n]+=1));for(g=0;g<h;g++)r+=m[g];n=r/h;for(g=l=0;g<h&&l<h;g++)for(this.hist[g]=l/h,c+=m[g];c>=n&&l<h;)c-=n,l++;for(c=(h-1)/h;g<h;)this.hist[g++]=c}for(g=0;g<e;g++)c=this.hist[g*h/e],c=Math.floor(c*d),this.psColors[g]=this.colorCells[c];for(g=0;g<f;g++){d=g/f;for(n=0;n<h-1&&!(this.hist[n]>d);n++);c=n/h;this.psInverse[g]=c*k+b}break;default:a.error("unknown scale '"+this.params.scale+"'")}return this};a.Image.prototype.mkRGBImage=function(){var c,b,d,e,f=!1,h=null,g=null,k=null,l=!1,
m=!1,n=!1,p=!1,q=[];if(!this.rgb)return this;!this.display.rgb.active||this!==this.display.rgb.rim&&this!==this.display.rgb.gim&&this!==this.display.rgb.bim||(l=!0,this.display.rgb.rim&&(h=this.display.rgb.rim),this.display.rgb.gim&&(g=this.display.rgb.gim),this.display.rgb.bim&&(k=this.display.rgb.bim));var r=this.display.context;var v=this.rgb;var w=v.sect;if(this.MakeRGBImage&&"function"===typeof this.MakeRGBImage&&this.MakeRGBImage()||this.MakePrimaryImage&&"function"===typeof this.MakePrimaryImage&&
this.MakePrimaryImage())return this;if(this.rgbFile){var t=w.width/w.zoom;var u=w.height/w.zoom;var y=w.x0;var x=this.offscreen.canvas.height-1-(w.y0+u);x=this.offscreen.context.getImageData(y,x,t,u);if(1===w.zoom)v.img=x;else for(v.img=r.createImageData(w.width,w.height),v=v.img,d=c=0;c<x.height;c++,d++){var B=c*x.width;var z=d*w.zoom;for(b=r=0;r<x.width;r++,b++){y=4*(B+r);var A=b*w.zoom;for(e=0;e<w.zoom;e++){var C=Math.floor(z+e);var E=C*w.width;for(C=0;C<w.zoom;C++){var D=Math.floor(A+C);D=4*(E+
D);v.data[D]=x.data[y];v.data[D+1]=x.data[y+1];v.data[D+2]=x.data[y+2];v.data[D+3]=x.data[y+3]}}}}return this}v.img&&v.img.width===w.width&&v.img.height===w.height||(v.img=r.createImageData(w.width,w.height));v=v.img;var F=v.data.length-4;if(!this.psColors&&!this.staticObj)return this;var G=void 0!==this.params.opacity?Math.floor(255*this.params.opacity):void 0!==this.params.alpha?this.params.alpha:255;if(this.mask.active&&this.mask.im){var J=this.mask.im;if("mask"===this.mask.mode){m=!0;var I=a.notNull(this.mask.vopacity)?
255*this.mask.vopacity:0;var K=a.notNull(this.params.opacity)?255*this.params.opacity:255;this.mask.invert&&(G=I,I=K,K=G)}else if("opacity"===this.mask.mode)n=!0;else if("overlay"===this.mask.mode){p=!0;var L=J.rgb.img;a.isNull(this.mask.opacity)&&(this.mask.opacity=1)}}else if(a.notNull(this.params.flooropacity)&&!l){var R=255*this.params.flooropacity;var M=this.params.floorvalue;f=!0}var N=Math.max(1,Math.floor(1/w.zoom));var P=w.zoom*N;c=Math.floor(w.y1-1);for(d=0;c>=w.y0;c-=N,d++)for(B=c*this.raw.width,
z=d*P,r=Math.floor(w.x0),b=0;r<w.x1;r+=N,b++){m?G=J.raw.data[B+r]>this.mask.value?K:I:n&&(G=255*J.raw.data[B+r]);if(l){if(x=h?h.colorData[B+r]:0,t=g?g.colorData[B+r]:0,u=k?k.colorData[B+r]:0,a.isNull(x)||a.isNull(t)||a.isNull(u))return this.display.rgb.active=!1,a.error("RGB images are incompatible. Turning off RGB mode.","",!1),this.mkRGBImage(),this}else this.staticObj||(y=this.colorData[B+r]);var Q=G;f&&this.raw.data[B+r]<=M&&(Q=R);A=b*P;for(e=0;e<w.zoom;e++)for(C=Math.ceil(z+e),E=C*w.width,C=
0;C<w.zoom;C++)if(D=Math.ceil(A+C),D=4*(E+D),D<=F)if(l)v.data[D]=h?h.psColors[x][0]:0,v.data[D+1]=g?g.psColors[t][1]:0,v.data[D+2]=k?k.psColors[u][2]:0,v.data[D+3]=G;else if(this.staticObj){var H=this.raw.data[B+r];H=a.lookupStaticColor(this,H,q);v.data[D]=H.red;v.data[D+1]=H.green;v.data[D+2]=H.blue;v.data[D+3]=H.alpha}else if(void 0!==this.psColors[y])if(p&&L.data[D+3]){H=L.data[D+3]/255*this.mask.opacity;var O=1-H;v.data[D]=L.data[D]*H+this.psColors[y][0]*O;v.data[D+1]=L.data[D+1]*H+this.psColors[y][1]*
O;v.data[D+2]=L.data[D+2]*H+this.psColors[y][2]*O;v.data[D+3]=255}else v.data[D]=this.psColors[y][0],v.data[D+1]=this.psColors[y][1],v.data[D+2]=this.psColors[y][2],v.data[D+3]=Q}return this};a.Image.prototype.blendImage=function(c){for(var b=[],d=0;d<arguments.length;++d)b[d-0]=arguments[d];var e=$jscomp.makeIterator(b);d=e.next().value;var f=e.next().value;e=e.next().value;var h=/normal|multiply|screen|overlay|darken|lighten|color-dodge|color-burn|hard-light|soft-light|difference|exclusion|hue|saturation|color|luminosity|clear|copy|source-over|destination-over|source-in|destination-in|source-out|destination-out|source-atop|destination-atop|xor|lighter/i;
...
f)}},a.TIMEOUT)):a.error("WindowToPDF is only available for the JS9 desktop app")});a.mkPublic("SaveScript",function(c){for(var b=[],d=0;d<arguments.length;++d)b[d-0]=arguments[d];b=a.parsePublicArgs(b);var e={cmd:"script"};window.electron&&window.electron.app?(e.filename=b.argv[0]||"js9msg",window.setTimeout(function(){try{window.electron.sendMsg(e)}catch(f){a.error("could not create messaging script",f)}},a.TIMEOUT)):a.error("SaveScript is only available for the JS9 desktop app")});a.mkPublic("SaveDir",
