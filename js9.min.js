...
K:"toggle keyboard actions plugin",l:"toggle active shape layers",M:"toggle mouse/touch plugin",p:"paste regions from local clipboard",P:"toggle preferences plugin",r:"copy selected region to clipboard",R:"copy all regions to clipboard",S:"toggle shape layers plugin","/":"copy wcs position to clipboard","?":"copy value and position to clipboard",0:"reset zoom","=":"zoom in","+":"zoom in","-":"zoom out","^":"raise region layer to top",">":"display next image","<":"display previous image","delete":"remove selected region",
leftArrow:"move selected region left",upArrow:"move selected region up",rightArrow:"move selected region right",downArrow:"move selected region down"},mousetouchZoom:!1,toolbarTooltips:!1,centerDivs:["JS9Menubar"],resizeDivs:["JS9Menubar","JS9Colorbar","JS9Toolbar"],pinchWait:8,pinchThresh:6,xeqPlugins:!0,extendedPlugins:!0,corsProxy:"https://js9.si.edu/cgi-bin/CORS-proxy.cgi",simbadProxy:"https://js9.si.edu/cgi-bin/simbad-proxy.cgi",catalogs:{ras:["RA","_RAJ2000","RAJ2000"],decs:["Dec","_DEJ2000",
...
k.id);this.iy=this.ix=0;this.png={};this.png.image=new Image;this.status={};this.rgb={};this.rgb.sect={zoom:1,ozoom:1};this.layers={};this.zlayer=b.SHAPEZINDEX;this.lcs={};this.aux={};this.binning={bin:1,obin:1};this.raws=[];this.blend={active:void 0,mode:"normal",opacity:1};this.updateshapes=!1;if(a)switch(b.waiting(!0,this.display),typeof a){case "object":this.source=k.source||"fits";this.mkRawDataFromHDU(a,$.extend({},{file:a.filename},k));"zscale"===this.params.scaleclipping?this.zscale(!0):"zmax"===
this.params.scaleclipping&&this.zscale("zmax");this.params.zoom&&(g=this.parseZoom(this.params.zoom),this.rgb.sect.zoom=g,this.rgb.sect.ozoom=g);this.mkSection();f=m(this,k);f.length&&this.mkSection.apply(this,f);k&&k.rgbFile?(this.rgbFile=k.rgbFile,$(this.png.image).on("load",function(){var a;if(h.png.image.width!==h.raw.width||h.png.image.height!==h.raw.height)a=sprintf("rgb dims [%s,%s] don't match image [%s,%s]",h.png.image.width,h.png.image.height,h.raw.width,h.raw.height),b.error(a);h.mkOffScreenCanvas();
h.displayImage("all",k);q.call(h,d)}).on("error",function(){b.waiting(!1);h.status.load="error";b.error("could not load image: "+h.id)}),this.png.image.src=this.rgbFile):(this.displayImage("all",k),q.call(this,d));break;case "string":this.source=k.source||"fits2png";this.imtab="image";this.file=b.cleanPath(a);this.id0=this.file.split("/").reverse()[0];this.id=b.getImageID(this.id0,this.display.id);this.status.load="loading";$(this.png.image).on("load",function(){h.mkOffScreenCanvas();h.mkRawDataFromPNG();
"zscale"===h.params.scaleclipping?h.zscale(!0):"zmax"===h.params.scaleclipping&&h.zscale("zmax");h.params.zoom&&(g=h.parseZoom(h.params.zoom),h.rgb.sect.zoom=g,h.rgb.sect.ozoom=g);h.mkSection();f=m(h,k);f.length&&h.mkSection.apply(h,f);h.displayImage("all",k);q.call(h,d);b.DEBUG&&b.log("JS9 image: %s dims(%d,%d) min/max(%d,%d)",h.file,h.raw.width,h.raw.height,h.raw.dmin,h.raw.dmax)}).on("error",function(){b.waiting(!1);h.status.load="error";b.error("could not load image: "+h.id)});this.png.image.src=
a;break;default:b.log("unknown specification type for Load: "+typeof a)}};b.Image.prototype.getImageData=function(a){var b=null;if(a)if("array"===a)b=Array.prototype.slice.call(this.raw.data);else if("base64"===a){a="";for(var d=new Uint8Array(this.raw.data.buffer),e=d.byteLength,b=0;b<e;b++)a+=String.fromCharCode(d[b]);b=window.btoa(a)}else a&&"false"!==a&&(b=this.raw.data);a=this.fileDimensions();return{id:this.id,file:this.file,fits:this.fitsFile||"",source:this.source,imtab:this.imtab,width:this.raw.width,
height:this.raw.height,bitpix:this.raw.bitpix,bin:this.binning.bin,header:this.raw.header,hdus:this.hdus,fwidth:a.xdim,fheight:a.ydim,dwidth:this.display.width,dheight:this.display.height,data:b}};b.Image.prototype.closeImage=function(a){var c,d,e,f,g=!1;d=b.images.length;var h=this.display;a=a||{};if("string"===typeof a)try{a=JSON.parse(a)}catch(k){b.error("can't parse closeImage opts: "+a,k)}for(c=0;c<d;c++)if(this===b.images[c]){d=b.images[c];d===d.display.image&&(g=c+1);if(g)for(e in!1!==a.clear&&
