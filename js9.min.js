...
k?f-(k/2-d/2):f;$("html, body").animate({scrollTop:e,scrollLeft:f},250);return this};b.Display.prototype.gather=function(a){var c,d;a=a||{};c=a.images||b.images;for(a=0;a<c.length;a++)(d="number"===typeof c[a]?b.images[c[a]]:c[a])&&d.display!==this&&d.moveToDisplay(this)};b.Display.prototype.separate=function(a){var c=this,d,e,f,g,h,k,l,n,m,q,t,r,u,p,x,w=0,y=0,v=1,A=/_sep[0-9][0-9]*/,B=b.globalOpts.separate,C=b.bugs.webkit_resize?b.RESIZEFUDGE:0,D=function(a,c){a||b.error("can't init seapration ops: no from id");
f=c.layout||b.globalOpts.separate.layout||"auto";g=c.leftMargin||B.leftMargin||0;h=c.topMargin||B.topMargin||0;switch(f){case "auto":y=1;w=0;break;case "horizontal":y=1;w=0;break;case "vertical":y=0;w=1;break;default:y=1,w=0}k=43;l=0;n=$("#"+a);m=$("#"+a+"Menubar");0<m.length&&(m.isactive="visible"===m.closest(".JS9PluginContainer").css("visibility"));q=$("#"+a+"Toolbar");0<q.length&&(q.isactive="visible"===q.closest(".JS9PluginContainer").css("visibility"));t=$("#"+a+"Colorbar");0<t.length&&(t.isactive=
"visible"===t.closest(".JS9PluginContainer").css("visibility"));0<n.length&&(r=n.width(),u=n.height(),p=n.offset().top-$(window).scrollTop(),x=n.offset().left-$(document).scrollLeft(),m.isactive&&(u+=m.height(),p-=m.height()),q.isactive&&(u+=q.height(),p-=q.height()),t.isactive&&(u+=t.height(),p-=t.height(),p+=7))},z=function(a,b){var c,d;a&&(0<n.length&&(c="",m.isactive&&(c+=sprintf("<div class='JS9Menubar' id='%sMenubar' data-width=%s></div>",b,n.width())),q.isactive&&(c+=sprintf("<div class='JS9Toolbar' id='%sToolbar' data-width=%s></div>",
b,n.width())),c+=sprintf("<div class='JS9' id='%s' data-width=%s data-height=%s></div>",b,n.width()-C,n.height()-C),t.isactive&&(c+=sprintf("<div style='margin-top: 2px;'><div class='JS9Colorbar' id='%sColorbar' data-width=%s></div></div>",b,n.width()))),"auto"===f&&x+r*(y+.5)>window.innerWidth&&(w++,y=0),d=sprintf("width=%s,height=%s,top=%s,left=%s,resize=1,scolling=1",r,u,p+(u+h+k)*w,x+(r+g+l)*y),"auto"===f||"horizontal"===f?y++:"vertical"===f&&w++);return{id:b,html:c,winopts:d}},E=function(f,g){var h,
k,l;f.length>g&&((h="number"===typeof f[g]?b.images[f[g]]:f[g])&&h.display===c?(h.displayImage("all"),void 0===d?(d=h.display.id,D(d,a),E(f,g+1)):(e="string"===typeof a.idbase?l=a.idbase+v++:d.replace(A,"")+"_sep"+b.uniqueID(),$("#dhtmlwindowholder").arrive("#"+e,{onceOnly:!0},function(){window.setTimeout(function(){h.moveToDisplay(e);E(f,g+1)},0)}),k=z(d,e),l&&(k.id=l),b.LoadWindow(null,k))):E(f,g+1))};if("string"===typeof a)try{a=JSON.parse(a)}catch(G){b.error("can't parse displaySeparate opts: "+
a,G)}a=a||{};E(a.images||b.images,0)};b.Display.prototype.nextImage=function(a){var c,d,e;a=a||1;if(this.image){e=this.image.pos;for(c=0;c<b.images.length&&this.image!==b.images[c];c++);for(d=c+a;d!==c&&(d>=b.images.length&&(d=0),0>d&&(d=b.images.length-1),b.images[d].display!==this);d+=a);c!==d&&(a=b.images[d],a.displayImage("all"),a.refreshLayers(),a.display.clearMessage(),e&&(e=a.displayToImagePos(e),a.valpos=null,a.valpos=a.updateValpos(e,!0)));return this}};b.Display.prototype.loadSession=function(a){var c=
this,d={},e,f=function(a){var e,f,g,h,k,r=function(){b.Fabric.updateChildren(this,null,"objects");a.refreshLayers()};k=d[a.file]||{};k.blend&&(a.blend=$.extend(!0,{},k.blend));k.wcsim&&(a.wcsim=b.lookupImage(k.wcsim));if(k.layers&&k.layers.length)for(e=0;e<k.layers.length;e++)if(g=k.layers[e],h=g.name,f=c.newShapeLayer(h,g.dopts),a.addShapes(h,[]),f.canvas.loadFromJSON(g.json,r.bind(f)),g.catalog&&(a.layers[h].catalog=g.catalog),g.starbase)try{a.layers[h].starbase=JSON.parse(g.starbase)}catch(u){}if(k.xeqstash)for(e=
0;e<k.xeqstash.length;e++){f=k.xeqstash[e];f.context=f.context||"image";try{switch(f.context){case "image":a[f.func].apply(a,f.args);break;case "display":a.display[f.func].apply(a.display,f.args);break;default:a[f.func].apply(a,f.args)}}catch(u){b.error("error executing stash: "+f.func,u,!1)}}},g=function(a){a.file||b.error("session does not contain a filename");e=$.extend(!0,{},a);e.params.onload=f;e.params.display&&delete e.params.display;d[e.file]=e;b.Load(e.file,e.params,{display:c.id})},h=function(a){var d,
...
b.globalOpts.helperProtocol+="//";this.helper=this.connected=!1;this.type=b.globalOpts.helperType||"sock.io";this.pageid=null;this.connect()};b.Helper.prototype.connectinfo=function(){var a;return null===b.helper.connected?"notConfigured":b.helper.connected?(a=sprintf("connected %s %s",b.helper.type,b.helper.url),b.helper.pageid&&(a+="<p>"+b.helper.pageid),a):sprintf("notConnected %s",b.helper.type)};b.Helper.prototype.connect=function(a){var c=b.globalOpts.ehretries,d=b.globalOpts.ehtimeout,e=this,
f=function(a,c,d){e.connected=!1;e.helper=!1;e.ready=!0;$(document).trigger("JS9:helperReady",{type:"socket.io",status:"error"});b.DEBUG&&(d&&"timeout"!==d||(d="or connection refused"),b.log(sprintf("JS9 helper connect error: %s (%s)",c||"timeout",d)))},g=function(a){$.ajax({url:a,dataType:"script",timeout:b.globalOpts.htimeout,success:function(){var a,c,d={reconnection:!0,reconnectionDelay:1E3,reconnectionDelayMax:1E4,reconnectionAttempts:100,timeout:b.globalOpts.htimeout};"undefined"===typeof io?
f(null,"socket io object is undefined",null):(e.socket=io.connect(e.url,d),e.socket.on("connect",function(){e.connected=!0;e.helper=!0;c=[];for(a=0;a<b.displays.length;a++)c.push(b.displays[a].id);e.socket.emit("initialize",{displays:c},function(a){e.pageid=a.pageid;e.js9helper=a.js9helper;b.globalOpts.dataPathModify=a.dataPathModify;e.ready=!0;$(document).trigger("JS9:helperReady",{type:"socket.io",status:"OK"});b.DEBUG&&b.log("JS9 helper: connect: "+e.type)});$(document).trigger("JS9:connected",
{type:"socket.io",status:"OK"})}),e.socket.on("connect_error",function(){e.connected=!1;e.helper=!1;1<b.DEBUG&&b.log("JS9 helper: connect error")}),e.socket.on("connect_timeout",function(){e.connected=!1;e.helper=!1;1<b.DEBUG&&b.log("JS9 helper: connect timeout")}),e.socket.on("disconnect",function(a){e.connected=!1;e.helper=!1;1<b.DEBUG&&b.log("JS9 helper: disconnect");"io server disconnect"===a&&(1<b.DEBUG&&b.log("JS9 helper: manual reconnect"),e.socket.connect())}),e.socket.on("reconnect",function(){e.connected=
...
d){if(!this.connected)return null;if(c&&"object"===typeof c){try{c.cookie=document.cookie}catch(e){delete c.cookie}b.globalOpts.dataPath&&!c.dataPath&&(c.dataPath=b.globalOpts.dataPath+":.")}else c={dataPath:"."};b.TOROOT&&(c.dataPath+=":"+b.TOROOT);switch(this.type){case "get":case "post":c.key=a;b.helper.pageid&&(c.pageid=b.helper.pageid);b.DEBUG&&b.log("JS9 cgi helper [%s, %s]: %s",this.type,JSON.stringify(c),this.url);$.ajax({url:this.url,type:this.type.toUpperCase(),data:c,dataType:"text",success:function(a){"string"===
...
d){var e,f,g,h,k,l,n={},m={};h="main"===this.display.layers[a].dtype?this.rgb.sect.zoom:1;if(c.remove)return{remove:c.remove};m.tags=[];if(c.tags)if("string"===typeof c.tags)for(f=c.tags.toLowerCase().split(","),a=0;a<f.length;a++)m.tags[a]=f[a].trim();else if($.isArray(c.tags))for(a=0;a<c.tags.length;a++)m.tags[a]=c.tags[a].trim();void 0!==c.angle&&(n.angle=-c.angle);void 0!==c.x&&void 0!==c.y&&(f=this.imageToDisplayPos(c),n.left=f.x,n.top=f.y);void 0!==c.px&&void 0!==c.py&&(f=this.logicalToDisplayPos({x:c.px,
y:c.py}),n.left=f.x,n.top=f.y);void 0!==c.ra&&void 0!==c.dec&&0<this.raw.wcs&&("string"===typeof c.ra&&(c.ra=b.saostrtod(c.ra),":"===String.fromCharCode(b.saodtype())&&"galactic"!==this.params.wcssys&&"ecliptic"!==this.params.wcssys&&(c.ra*=15)),"string"===typeof c.dec&&(c.dec=b.saostrtod(c.dec)),c.wcssys?(g=this.getWCSSys(),e=b.globalOpts.xeqPlugins,b.globalOpts.xeqPlugins=!1,this.setWCSSys(c.wcssys)):c._wcssys&&(g=this.getWCSSys(),e=b.globalOpts.xeqPlugins,b.globalOpts.xeqPlugins=!1,this.setWCSSys(c._wcssys),
delete c._wcssys),f=b.wcs2pix(this.raw.wcs,c.ra,c.dec).trim().split(/ +/),g&&(this.setWCSSys(g),b.globalOpts.xeqPlugins=e),f=this.imageToDisplayPos({x:parseFloat(f[0]),y:parseFloat(f[1])}),n.left=f.x,n.top=f.y);void 0!==c.left&&(n.left=c.left);void 0!==c.top&&(n.top=c.top);void 0===n.left&&(n.left=d&&void 0!==d.left?d.left:this.display.canvasjq.attr("width")/2-1);void 0===n.top&&(n.top=d&&void 0!==d.top?d.top:this.display.canvasjq.attr("height")/2-1+1);c.dx&&(n.left+=c.dx);c.dy&&(n.top-=c.dy);switch(c.shape){case "annulus":m.radii=
[];if(void 0!==c.radii)if("string"===typeof c.radii)for(m.radii=c.radii.replace(/ /g,"").split(","),e=a=0;a<m.radii.length;a++)""!==m.radii[a]&&(m.radii[e++]=this.wcs2imlen(m.radii[a]));else m.radii=c.radii;else for(c.ireg&&b.SCALEIREG&&(c.iradius&&(c.iradius/=h),c.oradius&&(c.oradius/=h)),h=(c.oradius-c.iradius)/c.nannuli,g=c.nannuli+1,a=0;a<g;a++)e=c.iradius+h*a,m.radii.push(e);break;case "box":c.ireg&&b.SCALEIREG&&(c.width&&(c.width/=h),c.height&&(c.height/=h));break;case "circle":c.ireg&&b.SCALEIREG&&
...
"").split(",");g=f.length;if("string"===typeof f[0])for(a=0;a<g;a++)f[a]=parseFloat(f[a]);c.pts=[];for(e=a=0;a<g;a+=2,e++)c.pts[e]={x:f[a],y:f[a+1]}}g=c.pts.length;for(a=0;a<g;a++)c.pts[a]=this.imageToDisplayPos(c.pts[a]);c.left&&c.top?e={x:c.left,y:c.top}:(e=b.centerPolygon(c.pts),n.left=e.x,n.top=e.y);c.points=[];for(a=0;a<g;a++)f={x:(c.pts[a].x-e.x)/h,y:(c.pts[a].y-e.y)/h},c.points.push(f)}else d&&d.points&&d.points.length||("polygon"===c.shape&&c.polypoints?c.points=c.polypoints:"line"===c.shape&&
c.linepoints&&(c.points=c.linepoints));if(c.ireg&&b.SCALEIREG)for(g=c.points.length,a=0;a<g;a++)c.points[a].x/=h,c.points[a].y/=h}for(k in c)if(c.hasOwnProperty(k))switch(k){case "tags":case "x":case "y":case "px":case "py":case "dx":case "dy":case "ra":case "dec":case "pts":case "left":case "top":case "angle":case "radii":case "ireg":break;case "type":case "originX":case "originY":case "width":case "height":case "scaleX":case "scaleY":case "flipX":case "flipY":case "opacity":case "cornerSize":case "transparentCorners":case "hoverCursor":case "padding":case "borderColor":case "cornerColor":case "centeredScaling":case "centeredRotation":case "fill":case "fillRule":case "backgroundColor":case "stroke":case "strokeWidth":case "strokeDashArray":case "strokeLineCap":case "strokeLineJoin":case "strokeMiterLimit":case "shadow":case "borderOpacityWhenMoving":case "borderScaleFactor":case "borderDashArray":case "transformMatrix":case "minScaleLimit":case "selectable":case "evented":case "visible":case "hasControls":case "hasBorders":case "hasRotatingPoint":case "rotatingPointOffset":case "perPixelTargetFind":case "includeDefaultValues":case "clipTo":case "lockMovementX":case "lockMovementY":case "lockRotation":case "lockScalingX":case "lockScalingY":case "lockUniScaling":case "radius":case "rx":case "ry":case "points":case "selectionLineWidth":case "fontFamily":case "fontSize":case "fontStyle":case "fontWeight":case "text":case "textDecoration":case "textAlign":case "lineHeight":case "textBackgroundColor":case "textOpts":n[k]=
...
return d.dval},H=function(a){a=b.strtoscaled(a);var c=this.raw.wcsinfo||{crot:0};c.crot&&(a.dval+=c.crot);return a.dval};a=a.trim();if(!a.match(/(\(|\{|#|;|\n)/))return a;n=this.getWCSSys();m=this.getWCSUnits();q="physical";t="image"!==q&&"physical"!==q;h=a.split(/\n|;/);for(e=0;e<h.length;e++)if("#"!==h[e].trim().substr(0,1))if(r=!1,l=G(h[e]),p=l.args.length,l.isregion){k=$.extend(!0,{},l.opts);k.shape=l.cmd;2<=p&&(u=I.call(this,l.args[0],l.args[1]),k.x=u[0],k.y=u[1]);k.textOpts&&void 0!==k.textOpts.ra&&
void 0!==k.textOpts.dec&&(k.textOpts._wcssys=q);switch(l.cmd){case "annulus":k.radii=[];for(f=2;f<p;f++)k.radii.push(F.call(this,l.args[f],1));break;case "box":3<=p&&(k.width=F.call(this,l.args[2],1));4<=p&&(k.height=F.call(this,l.args[3],2));5<=p&&(k.angle=H.call(this,l.args[4]));break;case "circle":3<=p&&(k.radius=F.call(this,l.args[2],1));break;case "ellipse":3<=p&&(k.r1=F.call(this,l.args[2],1));4<=p&&(k.r2=F.call(this,l.args[3],2));5<=p&&(k.angle=H.call(this,l.args[4]));break;case "line":case "polygon":k.pts=
[];for(g=f=0;f<p;f+=2,g++)u=I.call(this,l.args[f],l.args[f+1]),k.pts[g]={x:u[0],y:u[1]};delete k.x;delete k.y;break;case "text":3<=p&&(k.text=l.args[2].replace(/^['"]/,"").replace(/["']$/,"")),4<=p&&(k.angle=H.call(this,l.args[3]))}l.comment&&(k.tags=l.comment);d.push(k)}else l.cmd.match(w)?(f=b.globalOpts.xeqPlugins,b.globalOpts.xeqPlugins=!1,this.setWCSSys(l.cmd),b.globalOpts.xeqPlugins=f,q=this.getWCSSys(),t="image"!==q&&"physical"!==q):"remove"!==l.cmd&&"delete"!==l.cmd||d.push({remove:!0});f=
...
(k=a.raw.width,l=a.raw.height,n=a.ipos.x,f=a.ipos.y,k={pts:[{x:0,y:f},{x:k,y:f}],redraw:!1},a.changeShapes(m,a.crosshair.h,k),l={pts:[{x:n,y:0},{x:n,y:l}],redraw:!0},a.changeShapes(m,a.crosshair.v,l),a.crosshair.visible=!0,b.globalOpts.wcsCrosshair&&a&&a.raw.wcs&&0<a.raw.wcs))for(f=b.pix2wcs(a.raw.wcs,c.x,c.y).trim().split(/\s+/),g=b.saostrtod(f[0]),":"===String.fromCharCode(b.saodtype())&&"galactic"!==a.params.wcssys&&"ecliptic"!==a.params.wcssys&&(g*=15),h=b.saostrtod(f[1]),c=0;c<b.displays.length;c++)if((d=
b.displays[c].image)&&d!==a&&d.crosshair&&d.params.crosshair&&0<d.raw.wcs){k=d.raw.width;l=d.raw.height;try{e=b.wcs2pix(d.raw.wcs,g,h)}catch(q){e=null}e&&(f=e.trim().split(/\s+/),n=parseFloat(f[0]),f=parseFloat(f[1]),0<n&&n<k&&0<f&&f<l&&(k={pts:[{x:0,y:f},{x:k,y:f}],redraw:!1},d.changeShapes(m,d.crosshair.h,k),l={pts:[{x:n,y:0},{x:n,y:l}],redraw:!0},d.changeShapes(m,d.crosshair.v,l),d.crosshair.visible=!0))}};b.Crosshair.hide=function(a,c,d){c=b.Crosshair.LAYERNAME;d=b.Crosshair.opts.hiddenPts;a&&
a.crosshair&&a.crosshair.visible&&(a.changeShapes(c,a.crosshair.h,d),a.changeShapes(c,a.crosshair.v,d),a.crosshair.visible=!1)};b.Crosshair.create=function(a){var c=b.Crosshair.opts.hiddenPts,d=b.Crosshair.LAYERNAME;a&&!a.crosshair&&0<a.raw.wcs&&(a.crosshair={},a.crosshair.h=a.addShapes(d,"line",c),a.crosshair.v=a.addShapes(d,"line",c),a.crosshair.visible=!1)};b.Crosshair.keyaction=function(a,b,d){a&&d&&d.shiftKey&&(a.tmp.shiftKey=!0)};b.Crosshair.keyup=function(a,b,d){a&&a.tmp.shiftKey&&d&&!d.shiftKey&&
delete a.tmp.shiftKey};b.Crosshair.init=function(){var a,c=b.Crosshair.LAYERNAME;for(a=0;a<b.displays.length;a++)b.displays[a].layers.crosshair||b.displays[a].newShapeLayer(c,b.Crosshair.opts);return this};b.Image.prototype.toggleCrosshair=function(){this.params.crosshair=!this.params.crosshair;this.params.crosshair||b.Crosshair.hide(this)};b.Image.prototype.toggleWCSCrosshair=function(){b.globalOpts.wcsCrosshair=!b.globalOpts.wcsCrosshair};b.Grid={};b.Grid.CLASS="JS9";b.Grid.NAME="Grid";b.Grid.LAYERNAME=
"grid";b.Grid.opts={movable:!1,cover:"display",reduceDims:!0,strokeWidth:1,margin:0,labelMargin:10,stride:32,raLines:8,raSkip:0,raAngle:0,decLines:8,decSkip:0,decAngle:90,sexaPrec:1,degPrec:3,lineColor:"#00FFFF",labelColor:"#00FFFF",labelFontFamily:"Helvetica, sans-serif",labelFontSize:11,labelFontStyle:"normal",labelFontWeight:300,labelRAOffx:3,labelRAOffy:-1,labelDecOffx:-14,labelDecOffy:6};b.Grid.limits=function(a,b,d,e){a=d-b;a=1<a?10:.1<a?100:.01<a?1E3:.001<a?1E4:1E-4<a?1E5:1E6;b=Math.floor(b*
...
l=d.binMode||b.globalOpts.binMode;l="a"===l?"a":"";"string"===typeof k&&(k.match(/[as]$/)&&(l=k.slice(-1)),k=parseInt(k,10));k=Math.max(1,k||1);m.sect=void 0!==d.xcen&&void 0!==d.ycen?sprintf("%s@%s,%s@%s,%s%s",e,d.xcen,h,d.ycen,k,l):sprintf("%s,%s,%s%s",e,h,k,l);e=g.toLowerCase().split(/[>,]/);for(g=0;g<e.length;g++)switch(e[g]){case "size":e[g+1]&&(b.isNumber(e[g+1])&&(m.maxsize=1E6*parseFloat(e[g+1])),g++)}break;default:b.error("unknown FITS representation type: "+e)}m.fits=b.cleanPath(c);m.parent=
!0;b.waiting(!0,a);b.helper.send(q,m,function(c){var e,g;c="object"===typeof c?c:0<=c.search(b.analOpts.epattern)?{stderr:c}:{stdout:c};c.stderr&&b.error(c.stderr,b.analOpts.epattern);if(c.stdout)switch(q){case "fits2png":c=c.stdout.replace(/\n*$/,"").split("\n").pop();e=c.split(".").pop().toLowerCase();"png"===e?(d.source="fits2png",b.checkNew(new b.Image(c,d,f))):b.error("fits2png conversion failed: "+c);break;case "fits2fits":g=c.stdout.split(/\n/);c=b.cleanPath(g[0]);if(c===m.fits)e=$.extend(!0,
