...
f=f||{};e=e||"update";var p="main"!==this.display.layers[c].dtype||b.params.preservedcoords?1:this.rgb.sect.zoom;g.mode=e;g.id=b.params.id;g.shape=b.params.shape;g.layer=c;g.color=b.color||b.stroke;g.tags=b.params.tags;g.sticky=b.params.sticky;g.preservedcoords=b.params.preservedcoords;g.parent=b.params.parent?b.params.parent.obj.params.id:null;g.child=b.params.children&&b.params.children.length?b.params.children[0].id:null;var q=b.getCenterPoint();var r={x:0,y:0};d.group&&(r=d.group.getCenterPoint(),
q={x:q.x+r.x,y:q.y+r.y},d.group.angle&&(q=a.rotatePoint(q,d.group.angle,r)));g.dx=q.x;g.dy=q.y;q=this.displayToImagePos(q);g.x=q.x;g.y=q.y;g.lcs=this.imageToLogicalPos(q);"export"!==e&&b.params.wcsconfig&&("image"===b.params.wcsconfig.wcssys?h="image":"physical"===b.params.wcsconfig.wcssys&&(h="physical"));if("image"===h||"image"===this.params.wcssys&&"physical"!==h){g.imsys="image";var v=g.x;var w=g.y;var u=1}else g.imsys=g.lcs.sys,v=g.lcs.x,w=g.lcs.y,u=Math.sqrt(Math.pow(this.lcs.physical.reverse[0][0],
2)+Math.pow(this.lcs.physical.reverse[0][1],2));g.angle=-b.angle;d.group&&(g.angle-=d.group.angle);h=g.angle;if(!g.parent)switch(g.shape){case "box":case "cross":case "ellipse":case "text":if(a.notNull(this.params.transformScale)&&(g.angle/=this.params.transformScale),a.notNull(this.params.transformAngle)&&(g.angle-=this.params.transformAngle),this.raw.wcsinfo)this.raw.wcsinfo.crot&&(g.angle-=this.raw.wcsinfo.crot);else if(a.notNull(this.raw.header.LTM1_1)||a.notNull(this.raw.header.LTM1_2)){try{var t=
Math.atan((this.raw.header.LTM1_2||0)/(this.raw.header.LTM1_1||0))}catch(A){t=0}t&&(t=180*-t/Math.PI,g.angle-=t)}}for(;0>g.angle;)g.angle+=360;for(;360<=g.angle;)g.angle-=360;q=b.scaleX/p;t=b.scaleY/p;d.group&&(q*=d.group.scaleX,t*=d.group.scaleY);switch(g.shape){case "annulus":g.shape="annulus";g.radii=[];"image"!==g.imsys&&(g.lcs.radii=[]);g.imstr="annulus("+m(v)+","+m(w)+",";var x="annulus "+g.x+" "+g.y+" ";r=b.getObjects();var y=r.length;for(d=0;d<y;d++)h=r[d].radius*q,t=h*u,g.imstr+=m(t),x+=
g.x+" "+g.y+" "+(g.x+h)+" "+g.y+" ",g.imstr=d===y-1?g.imstr+")":g.imstr+",",g.radii.push(h),"image"!==g.imsys&&g.lcs.radii.push(t);break;case "box":case "cross":g.width=b.width*q;g.height=b.height*t;t=g.width*u;x=g.height*u;"image"!==g.imsys&&(g.lcs.width=t,g.lcs.height=x);g.imstr=g.shape+"("+m(v)+","+m(w)+","+m(t)+","+m(x)+","+g.angle.toFixed(4)+")";x=g.shape+" "+g.x+" "+g.y+" "+g.x+" "+g.y+" "+(g.x+g.width)+" "+g.y+" "+g.x+" "+g.y+" "+g.x+" "+(g.y+g.height)+" "+g.angle*Math.PI/180;break;case "circle":g.radius=
b.radius*q;t=g.radius*u;"image"!==g.imsys&&(g.lcs.radius=t);g.imstr="circle("+m(v)+","+m(w)+","+m(t)+")";x="circle "+g.x+" "+g.y+" "+g.x+" "+g.y+" "+(g.x+g.radius)+" "+g.y;break;case "ellipse":g.r1=b.width*q/2;g.r2=b.height*t/2;t=g.r1*u;x=g.r2*u;"image"!==g.imsys&&(g.lcs.r1=t,g.lcs.r2=x);g.imstr="ellipse("+m(v)+","+m(w)+","+m(t)+","+m(x)+","+g.angle.toFixed(4)+")";x="ellipse "+g.x+" "+g.y+" "+g.x+" "+g.y+" "+(g.x+g.r1)+" "+g.y+" "+g.x+" "+g.y+" "+g.x+" "+(g.y+g.r2)+" "+g.angle*Math.PI/180;break;case "point":g.width=
b.width*q;g.height=b.height*t;t=g.width*u;x=g.height*u;"image"!==g.imsys&&(g.lcs.width=t,g.lcs.height=x);g.imstr="point("+m(v)+","+m(w)+")";x="point "+g.x+" "+g.y;break;case "line":case "polygon":g.imstr=g.shape+"(";x=g.shape+" ";g.pts=[];"image"!==g.imsys&&(g.lcs.pts=[]);for(d=0;d<b.points.length;d++)0<d&&(g.imstr+=",",x+=" "),t=this.displayToImagePos({x:r.x+b.left+b.points[d].x*b.scaleX,y:r.y+b.top+b.points[d].y*b.scaleY}),t=a.rotatePoint(t,h,{x:g.x,y:g.y}),"image"===g.imsys?g.imstr+=m(t.x)+","+
m(t.y):(u=this.imageToLogicalPos(t),q=u.x,u=u.y,g.imstr+=m(q)+","+m(u),g.lcs.pts.push({x:q,y:u})),x+=t.x+" "+t.y,g.pts.push(t),"line"===g.shape&&(0===d?y=0:(q=g.pts[d-1],y+=Math.sqrt((t.x-q.x)*(t.x-q.x)+(t.y-q.y)*(t.y-q.y))));if("line"===g.shape&&a.notNull(y)){g.imstr+=') {"size":'+m(y)+',"units":"pixels"';if(2===g.pts.length){for(t=180*Math.atan2(g.pts[1].y-g.pts[0].y,g.pts[1].x-g.pts[0].x)/Math.PI;0>t;)t+=360;var B=',"posang":'+t.toFixed(4)+',"posunits":"degrees"';g.imstr+=B}g.imstr+="}"}else g.imstr+=
")";g.angle=0;break;case "text":g.imstr="text("+m(v)+","+m(w)+',"'+b.text+'",'+g.angle.toFixed(4)+")",x="text "+g.x+" "+g.y+' "'+b.text+'" '+g.angle*Math.PI/180,g.text=b.text}this.raw.wcs&&0<this.raw.wcs&&(n(this.raw.wcs,k,g,x,B,f,g),b.params.wcsconfig&&b.params.wcsconfig.wcssys&&(m=a.globalOpts.xeqPlugins,a.globalOpts.xeqPlugins=!1,r=this.getWCSSys(),a.notWCS(b.params.wcsconfig.wcssys)||(this.setWCSSys(b.params.wcsconfig.wcssys,!1),n(this.raw.wcs,k,g,x,B,f,b.params.wcsconfig)),g.wcsconfig=$.extend(!0,
{},b.params.wcsconfig),this.setWCSSys(r,!1),a.globalOpts.xeqPlugins=m));g.data=b.params.data;b.set("pub",g);b.params.winid&&($(b.params.winid).is(":visible")?this.initRegionsForm(b):b.params.winid=null);if(f.nocb)return g;if(!b.params.parent&&!e.match(l)){if(this.params.xeqonchange&&k.show&&k.opts.onchange)try{this.params.xeqonchange=!1,a.xeqByName(k.opts.onchange,window,this,g)}catch(A){a.log("error in onchange: %s [%s]\n%s",this.id,A.message,a.strace(A))}finally{this.params.xeqonchange=!0}this.xeqPlugins("shape",
"on"+c+"change",g)}if("regions"===c&&a.globalOpts.regToClipboard){switch(e){case "update":d=g.parent||g.id;break;default:d=null}if(a.notNull(d)){try{var z=this.listRegions(d,{mode:1,includedcoords:!0})}catch(A){z=null}z&&(a.clipboard=z)}}"regions"===c&&"wcs"===e&&this._updateMultiDialogs(!0);return g};a.Fabric.removeShapes=function(c,b,d){var e=this,f,h={mode:1,includedcoords:!0},g=[];if(f=this.getShapeLayer(c)){var k=f.canvas;d=d||{};"regions"===c&&a.globalOpts.unremoveReg&&(this.regstack.push(this.listRegions(b,
h,c)),this.regstack.length>a.globalOpts.unremoveReg&&(this.regstack=this.regstack.slice(0,a.globalOpts.unremoveReg)));this._selectShapes(c,b,d,function(a,b){if(!(!1===a.params.removable&&!d.overrideRemovable||a.params.sticky&&!1===d.sticky)){e._updateShape(c,a,b,"remove");a.params.winid&&(a.params.winid.close(),a.params.winid=null);if(a.params.parent){var f=a.params.parent.obj;for(b=f.params.children.length-1;0<=b;b--)if(a===f.params.children[b].obj){f.params.children.splice(b,1);break}}for(b=0;b<
a.params.children.length;b++)f=a.params.children[b].obj,g.push(f);g.push(a)}});for(b=0;b<g.length;b++)k.remove(g[b]);1===fabric.major_version?k.getActiveGroup()&&k.discardActiveGroup():k.discardActiveObject();k.renderAll();!k.getObjects().length&&a.globalOpts.resetEmptyShapeId&&(f.nshape=0);return this}};a.Fabric.getShapes=function(c,b,d){var e={},f=[];d=d||{};if("string"===typeof d)try{d=JSON.parse(d)}catch(k){a.error("can't parse getShapes opts: "+d,k)}if("regions"===c&&("text"===d.format||"csv"===
d.format||"regions"===d.format)){d.mode=d.mode||1;b=this.listRegions(b,d);if("csv"===d.format){var h=b.split(";");c=0;for(b="";c<h.length;c++)if(h[c])if(h[c].toLowerCase().match(a.WCSEXP))d.includewcs&&(b+=h[c].trim()+"\n");else{var g=h[c].replace(/\(/,",").replace(/\).*/,"").trim();b+=g+"\n"}}else"regions"===d.format&&(b=b.replace(/ *; */g,"\n"));return b}this._selectShapes(c,b,d,function(a){e=a.pub||{};d.includeObj&&(e.obj=a);f.push(e)});return f};a.Fabric.changeShapes=function(c,b,d){var e=this,
f,h,g,k,l,m,n,p,q,r,v,w=[],u=[];if((l=this.getShapeLayer(c))&&d){if("string"===typeof d)try{d=JSON.parse(d)}catch(y){a.error("can't parse shape opts: "+d,y)}if(this.display.image!==this)this.delayedShapes=this.delayedShapes||[],this.delayedShapes.push({layer:c,shape:b,mode:"change",opts:d});else{var t=l.canvas;var x=t.getActiveObject();a.isNull(d.setSelection)&&(d.setSelection=!0);this._selectShapes(c,b,d,function(b,B){p="main"!==e.display.layers[c].dtype||b.params.preservedcoords?1:e.rgb.sect.zoom;
d.radii&&(b.params.radii=[]);d.tags&&(b.params.tags=[]);k=$.extend(!0,{},b.params,d);g=e._parseShapeOptions(c,k,b);if(g.remove){if(!0===g.remove||"true"===g.remove)g.remove="all";if(!1!==g.remove&&"false"!==g.remove){e.removeShapes(c,g.remove||"all");return}}if(g.opts.send)switch(g.opts.send){case "front":t.sendToFront(x);t.discardActiveObject();break;case "back":t.sendToBack(x),t.discardActiveObject()}q=e._exportShapeOptions(d).filter(function(a){return!b.params.exports.hasOwnProperty(a)});g.params.exports=
b.params.exports.concat(q);g.opts.stroke&&(g.opts.color=g.opts.stroke,g.opts.stroke=a.colorToHex(g.opts.stroke));switch(b.params.shape){case "text":g.opts.stroke&&(g.opts.fill=g.opts.stroke);g.opts.strokeWidth=0;break;case "line":case "polygon":g.opts.points&&g.opts.points.length&&(b.angle=0)}b.set(g.opts);b.params=$.extend(!1,{},b.params,g.params);d.strokeWidth&&(b.params.sw1=d.strokeWidth);switch(b.params.shape){case "annulus":if(d.radii&&d.radii.length){b.forEachObject(function(a){w.push(a)});
