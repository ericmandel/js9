...
this.refreshLayers();b.globalOpts.extendedPlugins&&this.xeqPlugins("image","onrawdatalayer");return!0}return!1}if("function"!==typeof c)return!1;if("string"===typeof a)try{a=JSON.parse(a)}catch(l){b.error("can't parse rawData opts: "+a,l)}a=a||{};h=a.rawid||b.RAWIDX;void 0===a.oraw&&(a.oraw="current0");if("current"===a.oraw)e=this.raw;else if("current0"===a.oraw){for(d=0;d<this.raws.length;d++)if(f=this.raws[d],h===f.id){e=f.current0;break}e||(e=this.raw)}else for(d=0;d<this.raws.length;d++)if(f=
this.raws[d],a.oraw===f.id){e=f;break}e||(e=this.raws[0]);f=-1;for(d=0;d<this.raws.length;d++)if(h===this.raws[d].id){g=this.raws[d];f=d;break}if(0>f||a.alwaysCopy){g=$.extend(!0,{},e);g.current0=e;if(a.bitpix){switch(a.bitpix){case 8:g.data=new Uint8Array(e.height*e.width);break;case 16:g.data=new Int16Array(e.height*e.width);break;case -16:g.data=new Uint16Array(e.height*e.width);break;case 32:g.data=new Int32Array(e.height*e.width);break;case -32:g.data=new Float32Array(e.height*e.width);break;
case -64:g.data=new Float64Array(e.height*e.width)}k=g.width*g.height;for(d=0;d<k;d++)g.data[d]=e.data[d];g.bitpix=a.bitpix}else switch(e.bitpix){case 8:g.data=new Uint8Array(e.data);break;case 16:g.data=new Int16Array(e.data);break;case -16:g.data=new Uint16Array(e.data);break;case 32:g.data=new Int32Array(e.data);break;case -32:g.data=new Float32Array(e.data);break;case -64:g.data=new Float64Array(e.data)}g.id=h;g.from=a.from||g.from||"func"}c.call(this,e,g,a)&&(0<=f?this.raws[f]=g:this.raws.push(g),
this.raw=g,this.raw.header.bitpix&&(this.raw.bitpix=this.raw.header.bitpix),!1!==a.dataminmax&&this.dataminmax(),this.displayImage("all",a));return!0};b.Image.prototype.gaussBlurData=function(a){var c={};void 0===a&&b.error("missing sigma value for gaussBlurData");this.xeqStash("gaussBlurData",Array.prototype.slice.call(arguments));if("string"===typeof c)try{c=JSON.parse(c)}catch(d){b.error("can't parse gaussBlur opts: "+c,d)}c=c||{};c.bitpix=-64===this.raw.bitpix?-64:-32;c.oraw=b.RAWID0;c.alwaysCopy=
!0;c.rawid=c.rawid||"gaussBlur";c.sigma=a;this.rawDataLayer(c,function(c,e){var d;switch(e.bitpix){case -32:d=new Float32Array(e.data);break;case -64:d=new Float64Array(e.data);break;default:b.error("invalid temp bitpix for gaussBlur: "+e.bitpix)}gaussBlur(d,e.data,e.width,e.height,a);return!0});return this};b.Image.prototype.imarithData=function(a,c,d){var e;if(!arguments.length)return"add sub mul div min max reset".split(" ");if("string"===typeof d)try{d=JSON.parse(d)}catch(f){b.error("can't parse imarith opts: "+
