...
null}if(k)try{e.setParam("all",k)}catch(y){}}}a.globalOpts.alerts=g;e.xeqPlugins("image","onimageload");e.setStatus("load","complete");a.waiting(!1);if(b)try{a.xeqByName(b,window,e)}catch(y){a.error("in image onload callback",y,!1)}if(a.preloadwaiting&&a.preloadwaiting.length){var p=a.preloadwaiting.length;b=e.proxyURL||e.file;for(k=l=0;l<p;l++){var z=a.preloadwaiting[l];b.match(z.id)||z.id.match(b)?(z.loaded=!0,z.im=e):!1===z.loaded&&k++}if(!k){a.globalOpts.sortPreloads?(a.images.sort(function(b,
c){var d=0,e=0;for(l=0;l<p;l++)z=a.preloadwaiting[l],b.id===z.im.id&&(d=l),c.id===z.im.id&&(e=l);return d-e}),b=a.preloadwaiting[p-1].im||e,b.displayImage()):b=e;if(a.notNull(a.globalOpts.onpreload))try{a.xeqByName(a.globalOpts.onpreload,window,b)}catch(y){a.error("in onpreload callback",y,!1)}finally{delete a.globalOpts.onpreload}a.preloadwaiting=[]}}f&&f.allext&&e.hdus&&0<e.hdus.length&&e.displayExtension("all")};if(b)if("object"===typeof b){if(f=b,f.display)var l=f.display}else l=b;l||(l=0<a.displays.length?
