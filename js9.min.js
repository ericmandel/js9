...
n&&($(u).find("label[for='savecur']").text("sel"),$(u).find("input[id='savecur']").data("tooltip","save selected regions"));if(a.favorites.wcs&&a.favorites.wcs.length){var y=$(u).find(".rwcsbuttons").removeClass("nodisplay");q=y.find(".rwcsbuttoncontainer");if(q.length&&!q.find(".rwcsbutton").length){for(e=0;e<a.favorites.wcs.length;e++){var x=a.favorites.wcs[e];var B="string"===typeof x?x.split(":"):x;x=B[0];B=B[1]||x;if("save"===b.type){var z="rsavecol_R"+(e+2);var A="rsaveradio"}else z="rconfigcol_R"+
(e+2),A="rconfigradio";q.append("<span class='rconfigcol_R rwcsbutton "+z+"'>\n                                <input type='radio'\n                                       id='rwcsbutton_"+x+"'\n                                       name='rwcsbutton'\n                                       class='rwcsradio "+A+"}'\n                                       value='"+x+"'\n                                       data-tooltip='save using "+x+' wcs\'\n                                       onclick=\'\n                                           $(this).closest("form")\n                                           .find("[name=savewcs]")\n                                           .val("'+
...
(a+1E-5))/1E4),String(a)},m=function(a,b){return v?!0:void 0===a?!1:l(a)!==l(b)},n=function(b,c,d){if("remove"===c)return"selected"===d;if("childtext"===c)return b.params.children&&0<b.params.children.length?!1:""!==d;if("strokeDashes"===c)return b.strokeDashArray?JSON.stringify(b.strokeDashArray)!==JSON.stringify(d):""!==d;if("tags"!==c&&""===d)return!1;if("misc"===c&&""!==d)return!0;if("angle"===c)return b.angle!==-parseFloat(d);if("ix"===c)return b.pub.preservedcoords&&"d"===d.charAt(0).toLowerCase()?
m(b.pub.dx,a.saostrtod(d.substring(1))):m(b.pub.x,a.saostrtod(d));if("iy"===c)return b.pub.preservedcoords&&"d"===d.charAt(0).toLowerCase()?m(b.pub.dy,a.saostrtod(d.substring(1))):m(b.pub.y,a.saostrtod(d));if("px"===c&&b.pub.lcs)return m(b.pub.lcs.x,a.saostrtod(d));if("py"===c&&b.pub.lcs)return m(b.pub.lcs.y,a.saostrtod(d));if("ra"===c)return b.pub.wcsconfig.wcsposstr?m(a.saostrtod(b.pub.wcsconfig.wcsposstr[0]),a.saostrtod(d)):b.pub.wcsposstr?m(a.saostrtod(b.pub.wcsposstr[0]),a.saostrtod(d)):!1;if("dec"===
c){if(b.pub.wcsconfig.wcsposstr)return m(a.saostrtod(b.pub.wcsconfig.wcsposstr[1]),a.saostrtod(d));if(b.pub.wcsposstr)return m(a.saostrtod(b.pub.wcsposstr[1]),a.saostrtod(d))}return"sticky"===c?m(b.pub.sticky||!1,d):b.pub.lcs&&void 0!==b.pub.lcs[c]?m(b.pub.lcs[c],d)?!0:!1:m(b.pub[c],d)||m(b.params[c],d)||m(b[c],d)?!0:!1},p=function(b){return"true"===b?!0:"false"===b?!1:a.isNumber(b)?parseFloat(b):b},q=function(a){var b=String.fromCharCode(13,10);return(a||"").replace(/\\n/g,b)};this.lcs&&this.lcs.physical&&
(e=Math.sqrt(Math.pow(this.lcs.physical.forward[0][0],2)+Math.pow(this.lcs.physical.forward[0][1],2)));if(b&&b.pub&&b.pub.wcsconfig&&b.pub.wcsconfig.wcssys)var r=b.pub.wcsconfig.wcssys;else r=this.params.wcssys,b=f;var v=$(c).data("multi");var w=b.pub.layer||"regions";for(f=0;f<h;f++){var t=d[f].name;var u=d[f].value;if("xpos"===t||"ypos"===t)switch(r){case "image":t="i"+t.charAt(0);break;case "physical":t="p"+t.charAt(0);break;default:t=this.raw.wcs&&0<this.raw.wcs?"xpos"===t?"ra":"dec":"xpos"===
t?"ix":"iy"}switch(t){case "text":"text"===b.type&&n(b,t,u)&&(g[t]=q(p(u)));break;case "selectfilter":u&&($(c).data("selectfilter",u),this.selectShapes(w,u));break;case "strokeDashes":var y=u.trim().split(/\s+/);if(v&&u||n(b,t,y))g.strokeDashArray=0===y.length?[]:y.map(function(a){return parseInt(a,10)});break;case "strokeWidth":if(v&&u||n(b,t,y))g[t]=p(u);break;case "childtext":"text"!==b.type&&n(b,t,u)&&(g.text=q(p(u)));break;case "ix":n(b,t,u)&&(b.pub.preservedcoords&&"d"===u.charAt(0).toLowerCase()?
(g.dx=p(u.substring(1)),void 0===g.dy&&void 0!==b.pub.dy&&(g.dy=b.pub.dy)):(g.x=p(u),void 0===g.y&&void 0!==b.pub.y&&(g.y=b.pub.y)));break;case "iy":n(b,t,u)&&(b.pub.preservedcoords&&"d"===u.charAt(0).toLowerCase()?(g.dy=p(u.substring(1)),void 0===g.dx&&void 0!==b.pub.dx&&(g.dx=b.pub.dx)):(g.y=p(u),void 0===g.x&&void 0!==b.pub.x&&(g.x=b.pub.x)));break;case "px":n(b,t,u)&&(g.px=p(u),void 0===g.py&&b.pub.lcs&&(g.py=b.pub.lcs.y));break;case "py":n(b,t,u)&&(g.py=p(u),void 0===g.px&&b.pub.lcs&&(g.px=b.pub.lcs.x));
break;case "ra":n(b,t,u)&&(g.ra=u,void 0===g.dec&&(b.pub.wcsconfig.wcsposstr?g.dec=b.pub.wcsconfig.wcsposstr[1]:b.pub.wcsposstr&&(g.dec=b.pub.wcsposstr[1])));break;case "dec":n(b,t,u)&&(g.dec=u,void 0===g.ra&&(b.pub.wcsconfig.wcsposstr?g.ra=b.pub.wcsconfig.wcsposstr[0]:b.pub.wcsposstr&&(g.ra=b.pub.wcsposstr[0])),void 0===g.wcssys&&(g.wcssys=r));break;case "wcssys":break;case "radius":case "length":case "width":case "r1":switch(r){case "image":n(b,t,u)&&(g[t]=p(u));break;case "physical":n(b,t,u)&&
(g[t]=p(u)*e);break;default:y=a.strtoscaled(u),u="."===y.dtype&&"galactic"!==r&&"ecliptic"!==r?y.dval:Math.abs(y.dval/k.cdelt1),t=t.replace("wcs",""),n(b,t,u)&&(g[t]=p(u))}break;case "height":case "r2":switch(r){case "image":n(b,t,u)&&(g[t]=p(u));break;case "physical":n(b,t,u)&&(g[t]=p(u)*e);break;default:y=a.strtoscaled(u),u="."===y.dtype&&"galactic"!==r&&"ecliptic"!==r?y.dval:Math.abs(y.dval/k.cdelt2),t=t.replace("wcs",""),n(b,t,u)&&(g[t]=p(u))}break;case "radii":n(b,t,u)&&(g[t]=u);break;case "linelength":if(b.pub.pts&&
2===b.pub.pts.length&&a.isNumber(u)&&u!==this.tmp.linelength){u=parseFloat(u);switch(r){case "image":case "physical":break;default:void 0!==k.cdelt1?u/=Math.abs(k.cdelt1):void 0!==k.cdelt2&&(u/=Math.abs(k.cdelt2))}if(g.pts){t=g.pts[0];var x=g.pts[1]}else t=b.pub.pts[0],x=b.pub.pts[1];if(0<=$.inArray("line",a.Regions.opts.noCenteredScaling)){var B=Math.sqrt((t.x-x.x)*(t.x-x.x)+(t.y-x.y)*(t.y-x.y));var z=t.x-u*(t.x-x.x)/B;u=t.y-u*(t.y-x.y)/B;g.pts=[t,{x:z,y:u}]}else z={x:(t.x+x.x)/2,y:(t.y+x.y)/2},
B=parseFloat(this.tmp.lineangle)||0,t.x=z.x-u/2,t.y=z.y,x.x=z.x+u/2,x.y=z.y,g.pts=[a.rotatePoint(t,B,z),a.rotatePoint(x,B,z)]}break;case "lineangle":b.pub.pts&&2===b.pub.pts.length&&a.isNumber(u)&&u!==this.tmp.lineangle&&(B=parseFloat(u)-parseFloat(this.tmp.lineangle)||0,g.pts?(t=g.pts[0],x=g.pts[1]):(t=b.pub.pts[0],x=b.pub.pts[1]),0<=$.inArray("line",a.Regions.opts.noCenteredScaling)?g.pts=[t,a.rotatePoint(x,B,t)]:(z={x:(t.x+x.x)/2,y:(t.y+x.y)/2},g.pts=[a.rotatePoint(t,B,z),a.rotatePoint(x,B,z)]));
break;case "remove":n(b,t,u)&&(v?g[t]="selected":void 0!==b.pub.id&&(g[t]=b.pub.id));break;case "misc":if(u.trim())try{var A=JSON.parse(u);$.extend(g,A)}catch(C){a.error("invalid json: "+u)}break;default:n(b,t,u)&&(g[t]=p(u))}}v?this.changeShapes(w,"selected",g):this.changeShapes(w,b,g);this.initRegionsForm(b,{multi:v})};a.Regions.pasteFromClipboard=function(c){var b,d=0,e=0;if(this){(b=a.CopyFromClipboard().trim())||a.error(a.CLIPBOARDERROR);if(b.match(/(annulus|box|circle|cross|ellipse|line|polygon|point|text) *\(/)){var f=
...
k[0].obj;g.text=n.text;g.textOpts=w(n);if(c.angle!==n.angle){if(g.textOpts.angle=-n.angle,"circle"===c.params.shape||"annulus"===c.params.shape)n.params.hasTextOpts=!0}else 0===n.angle||"circle"!==c.params.shape&&"annulus"!==c.params.shape||(g.textOpts.angle=-n.angle,n.params.hasTextOpts=!0);if(n.params.parent.moved||n.params.hasTextOpts)n.pub.ra&&n.pub.dec?(y&&x&&y!==x?(n=e.wcs2wcs(y,x,n.pub.ra,n.pub.dec),n=n.trim().split(/\s+/),d=a.saostrtod(n[0]),a.isHMS(x)&&(d*=15),n=a.saostrtod(n[1])):(d=n.pub.ra,
n=n.pub.dec),g.textOpts.ra=d,g.textOpts.dec=n):n.pub.lcs?(g.textOpts.px=n.pub.lcs.x,g.textOpts.py=n.pub.lcs.y):(g.textOpts.x=n.pub.x,g.textOpts.y=n.pub.y);g.textOpts.color===c.stroke&&delete g.textOpts.color;g.textOpts.text&&delete g.textOpts.text;Object.keys(g.textOpts).length||delete g.textOpts}return g};b=b||{};if("string"===typeof b)try{b=JSON.parse(b)}catch(E){a.error("can't parse listRegions opts: "+b,E)}var t=b.mode;a.isNull(t)&&(t=3);a.isNull(d)&&(d="regions");if(b.wcssys||b.wcsunits){var u=
...
m=A.imsys),l+="; "+C+A.imstr),!1!==b.includejson&&1===t%2&&0<Object.keys(q).length&&("line"===A.shape&&(l=l.replace(/ *{[^{}]*}$/,"")),l+=" "+JSON.stringify(q)),g&&(l+=g);!1===b.includecomments&&(l=l.replace(/ *#[^;]*/g,""));if(y||B)y&&this.setWCSSys(y,!1),B&&this.setWCSUnits(B,!1),this.updateShapes(d,c,"export"),a.globalOpts.xeqPlugins=u;1<t&&this.display.displayMessage("regions",l);return l};a.Regions.copyRegions=function(a,b){return this.copyShapes("regions",a,b)};a.Regions.parseRegions=function(c,
...
e.onload=function(a){var e,f,k,l=new Image;l.onload=function(){var a=0;var g=document.createElement("canvas");var h=g.getContext("2d");var q=l.height,r=l.width;g.width=r;g.height=q;h.drawImage(l,0,0);e=h.getImageData(0,0,r,q).data;f=new Float32Array(q*r);for(h=0;h<q;h++)for(g=0;g<r;g++){var v=.299*e[a]+.587*e[a+1]+.114*e[a+2];f[(q-h)*r+g]=v;a+=4}k={head:{SIMPLE:!0,BITPIX:-32,NAXIS:2,NAXIS1:r,NAXIS2:q},filename:c.name,filedata:f,naxis:2,axis:[0,r,q],bitpix:-32,bin:1,data:f};k.dmin=Number.MAX_VALUE;
