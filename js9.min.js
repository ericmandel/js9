...
if(!s||!s.hdus)h.hdus.disabled=!0;h.pageid={name:"display pageid"};h.savefits={name:"save image as FITS"};h.savepng={name:"save image as PNG"};h.savejpeg={name:"save image as JPEG"};h.close={name:"close image"};h["sep"+g++]="------";h.lite={name:"new JS9 light window"};h.xnew={name:"new JS9 separate window"};2<a.DEBUG&&(h["sep"+g++]="------",h.refresh={name:"debug: refresh ..."});return{callback:function(c){d().forEach(function(d){var b,e,f,g;e=d.image;switch(c){case "close":e&&e.closeImage();break;
case "header":e&&(e.raw.header?e.displayAnalysis("text",a.raw2FITS(e.raw,!0),"FITSHeader_"+e.id):a.error("no FITS header for "+e.id));break;case "hdus":e&&(e.hdus?e.displayAnalysis("text",a.hdus2Str(e.hdus),"FITSHDUs_"+e.id,"width=800px,height=200px,center=1,resize=1,scrolling=1"):a.error("no FITS header for "+e.id));break;case "lite":a.LoadWindow(null,null,"light");break;case "xnew":a.LoadWindow(null,null,"new");break;case "pageid":d="<center><p>Usage: js9 -pageid [pageid] ...<p>"+a.helper.pageid||
"none</center>";a.lightWin("fileid"+a.uniqueID(),"inline",d,"page ID",a.lightOpts[a.LIGHTWIN].lineWin);break;case "open":a.OpenFileMenu({display:d});break;case "loadcors":e=a.allinone?a.Image.prototype.displayAnalysis.call(null,"textline",a.allinone.loadCorsHTML,"Open a shared CORS link"):a.Image.prototype.displayAnalysis.call(null,"textline",a.InstallDir(a.globalOpts.corsURL),"Open a shared CORS link");$(e).data("dispid",d.id);break;case "archives":a.DisplayHelp(a.InstallDir(a.globalOpts.archivesURL));
break;case "loadproxy":e=a.Image.prototype.displayAnalysis.call(null,"textline",a.InstallDir(a.globalOpts.proxyURL),"Open a link via server proxy");$(e).data("dispid",d.id).data("aname","loadproxy");break;case "imsection":f=a.Regions.opts.onchange;$("#dhtmlwindowholder").arrive("#imageSectionForm",{onceOnly:!0},function(){a.Regions.opts.onchange=function(a,c){var d,b;f&&f(a,c);a.parentFile&&("region"===$("#imageSectionForm input:radio[name=imode]:checked").val()&&"box"===c.shape)&&(d=a.raw.header.LTM1_1||
1,d=c.width/d,b=a.raw.header.LTM2_2||1,b=c.height/b,$("#imageSectionForm #xcen").val(Math.floor(c.lcs.x)),$("#imageSectionForm #ycen").val(Math.floor(c.lcs.y)),$("#imageSectionForm #xdim").val(Math.floor(d)),$("#imageSectionForm #ydim").val(Math.floor(b)))}});$("#dhtmlwindowholder").leave("#imageSectionForm",{onceOnly:!0},function(){a.Regions.opts.onchange=f});e=a.Image.prototype.displayAnalysis.call(null,"params",a.InstallDir(a.globalOpts.imsectionURL),"Extract Image Section From a 'Parent' File",
...
h["sep"+f++]="------";h.loadcmap={name:"load colormap"};h.savecmap={name:"save colormap"};h.invert={name:"invert colormap"};l.image&&l.image.params.invert&&(h.invert.icon="sun");h["sep"+f++]="------";h.rgb={name:"RGB mode"};a.globalOpts.rgb.active&&(h.rgb.icon="sun");return{callback:function(c){d().forEach(function(d){var b=d.image;if(b)switch(c){case "loadcmap":a.OpenColormapMenu({display:d});break;case "savecmap":a.SaveColormap({display:d});break;default:b.setColormap(c)}})},events:{show:function(c){var d=
g.display.image,b={};d&&(b.contrast=String(d.params.contrast),b.bias=String(d.params.bias),b.opacity=String(d.params.opacity),b.sigma=String(d.params.sigma));$.contextMenu.setInputValues(c,b);a.jupyterFocus(".context-menu-item")},hide:function(a){var c=g.display.image;c&&a.edited&&(delete a.edited,a=$.contextMenu.getInputValues(a),q(c,a))}},items:h}}});$("#regionMenu"+g.id).on("mousedown",function(a){a.preventDefault();$("#regionMenu"+g.id).contextMenu()});$.contextMenu({selector:"#regionMenu"+g.id,
zIndex:a.MENUZINDEX,events:{hide:c},build:function(){var c=d()[0].image,b={regiontitle:{name:"Regions:",disabled:!0},annulus:{name:"annulus"},box:{name:"box"},circle:{name:"circle"},ellipse:{name:"ellipse"},line:{name:"line"},point:{name:"point"},polygon:{name:"polygon"},text:{name:"text"},sep2:"------",loadRegions:{name:"load regions"},saveRegions:{name:"save regions"},listRegions:{name:"list regions"},deleteRegions:{name:"delete regions"},listonchange:{name:"list on change"},xeqonchange:{name:"xeq on change"}};
...
!b.params.listonchange;break;default:b.addShapes("regions",c,{ireg:!0})}})},items:b}}});$("#wcsMenu"+g.id).on("mousedown",function(a){a.preventDefault();$("#wcsMenu"+g.id).contextMenu()});$.contextMenu({selector:"#wcsMenu"+g.id,zIndex:a.MENUZINDEX,events:{hide:c},build:function(){var c,b,e,f=0,g=0,h={},q=d()[0],s=q.image;h.wcssystitle={name:"WCS Systems:",disabled:!0};for(c=0;c<a.wcssyss.length;c++)e=b=a.wcssyss[c],h[b]={name:e},q.image&&q.image.params.wcssys===b&&(h[b].icon="sun");h["sep"+f++]="------";
...
(h.reproject.items["sep"+f++]="------",h.reproject.items.reproject_wcsalign={name:"display wcs-aligned"},q.image&&q.image.params.wcsalign&&(h.reproject.items.reproject_wcsalign.icon="sun"));return{callback:function(c){d().forEach(function(d){var b;b=RegExp(c);if(d=d.image)c.match(/^reproject_/)?"reproject_wcsalign"===c?(d.params.wcsalign=!d.params.wcsalign,d.displayImage("display")):(b=c.replace(/^reproject_/,""),d.reprojectData(b)):0<=a.wcssyss.join("@").search(b)?d.setWCSSys(c):0<=a.wcsunitss.join("@").search(b)?
...
function(c,b,d){b=$.extend(!0,{},b,a.fits.options);void 0===d&&(d=a.Load);var e=new FileReader;e.onload=function(a){var e=new Image;e.src=a.target.result;e.onload=function(){var a,f,k,m=0;a=document.createElement("canvas");f=a.getContext("2d");var n=e.height,p=e.width;a.width=p;a.height=n;f.drawImage(e,0,0);var r=f.getImageData(0,0,p,n).data,l=new Float32Array(n*p);for(f=0;f<n;f++)for(a=0;a<p;a++)k=0.299*r[m]+0.587*r[m+1]+0.114*r[m+2],l[(n-f)*p+a]=k,m+=4;a={head:{},name:c.name,filedata:l,naxis:2,
axis:[0,p,n],bitpix:-32,data:l};a.dmin=Number.MAX_VALUE;a.dmax=Number.MIN_VALUE;for(m=0;m<n*p;m++)a.dmin=Math.min(a.dmin,a.data[m]),a.dmax=Math.max(a.dmax,a.data[m]);d(a,b)}};e.readAsDataURL(c)};a.lookupColormap=function(c){var b;c||(c=a.imageOpts.colormap);if(c)for(b=0;b<a.colormaps.length;b++)if(a.colormaps[b].name===c)return a.colormaps[b];a.error("unknown colormap '"+c+"'")};a.lookupCommand=function(c){var b,d;if(c){d=c.toLowerCase();for(b=0;b<a.commands.length;b++)if(c=a.commands[b],c.name===
d||c.alias===d||c.alias2===d)return c}return null};a.error=function(c,b,d){var e,f,g="",h="",j=!0;a.waiting(!1);"string"===typeof b?(f=c.match(b))?f[1]?c=f[1]:f[0]&&(c=f[0]):j=!1:"object"===typeof b&&(e=b);3>arguments.length&&(d=!0);if(j&&(e&&e.message?c+=sprintf(" (%s)",e.message):c&&(e=Error(c)),(f=a.strace(e))&&(h="\n\nStacktrace:\n"+f),a.globalOpts.alerts&&(c&&("string"===typeof c&&0>c.search(/ERROR/))&&(g="JS9 ERROR: "),alert(g+(c+h))),d))throw e;};a.eventToDisplayPos=function(a){var b,d;a||
(a=window.event);a.target?b=a.target:a.srcElement&&(b=a.srcElement);3===b.nodeType&&(b=b.parentNode);a.originalEvent&&a.originalEvent.changedTouches&&a.originalEvent.changedTouches.length?(d=a.originalEvent.changedTouches[0].pageX,a=a.originalEvent.changedTouches[0].pageY):(d=a.pageX,a=a.pageY);d-=$(b).offset().left;b=a-$(b).offset().top;return{x:Math.floor(d-1),y:Math.floor(b-1)}};a.rotatePoint=function(a,b,d){var e;d=d||{x:0,y:0};b=Math.PI*b/180;e=Math.cos(b);b=Math.sin(b);return{x:e*(a.x-d.x)-
b*(a.y-d.y)+d.x,y:b*(a.x-d.x)+e*(a.y-d.y)+d.y}};a.log=function(){if(void 0!==window.console&&void 0!==window.console.log)try{console.log.apply(console,arguments)}catch(a){Function.prototype.bind.call(console.log,console).apply(console,arguments)}};a.isNumber=function(a){return!isNaN(parseFloat(a))&&isFinite(a)};a.notNull=function(a){return void 0!==a&&null!==a};a.cardpars=function(c){var b;if("="===c[8])return b=c.slice(0,8).trim(),c=c.slice(10).replace(/\'/g," ").replace(/\/.*/,"").trim(),"T"===
c?c=!0:"F"===c?c=!1:a.isNumber(c)&&(c=parseFloat(c)),[b,c]};a.raw2FITS=function(a,b){var d,e,f,g=!1,h="";if(!a)return h;if(a.card)for(d=0;d<a.card.length;d++)e=a.card[d],h+=e,"END "===e.substring(0,4)&&(g=!0),b&&(h+="\n");else if(a.cardstr)for(d=0;d<a.ncard;d++)e=a.cardstr.slice(80*d,80*(d+1)),h+=e,"END "===e.substring(0,4)&&(g=!0),b&&(h+="\n");else if(a.header)for(e in d=a.header,d){if(d.hasOwnProperty(e)&&!("js9Protocol"===e||"js9Endian"===e))"END"===e&&(g=!0),f=d[e],!0===f&&(f="T"),h+=sprintf("%-8s%-2s%-70s",
