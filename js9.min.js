...
a.waiting;return b};a.handleFITSFile=function(c,b,d){a.fits.handleFITSFile?a.fits.handleFITSFile(c,b,d):a.error("no FITS module available to process FITS file")};a.cleanupFITSFile=function(c,b){var d;a.hostFS&&(d=new RegExp("^"+a.hostFS));return a.fits.cleanupFITSFile&&c&&c.hdu&&c.hdu.fits?(d&&c.hdu.fits.vfile&&c.hdu.fits.vfile.match(d)&&(b=!1),a.fits.cleanupFITSFile(c.hdu.fits,b),!0):!1};a.handleImageFile=function(c,b,d){var e=new FileReader;b=$.extend(!0,{},a.fits.options,b);d=d||a.Load;e.onload=
function(a){var e,f,k,l=new Image;l.onload=function(){var a=0;var g=document.createElement("canvas");var h=g.getContext("2d");var q=l.height,r=l.width;g.width=r;g.height=q;h.drawImage(l,0,0);e=h.getImageData(0,0,r,q).data;f=new Float32Array(q*r);for(h=0;h<q;h++)for(g=0;g<r;g++){var v=.299*e[a]+.587*e[a+1]+.114*e[a+2];f[(q-h)*r+g]=v;a+=4}k={head:{SIMPLE:!0,BITPIX:-32,NAXIS:2,NAXIS1:r,NAXIS2:q},filename:c.name,filedata:f,naxis:2,axis:[0,r,q],bitpix:-32,bin:1,data:f};k.dmin=Number.MAX_VALUE;k.dmax=Number.MIN_VALUE;
for(a=0;a<q*r;a++)Number.isNaN(k.data[a])||(k.dmin=Math.min(k.dmin,k.data[a]),k.dmax=Math.max(k.dmax,k.data[a]));d(k,b)};l.src=a.target.result};e.readAsDataURL(c)};a.getFITSImage=function(c,b,d,e){a.fits.getFITSImage?a.fits.getFITSImage(c,b,d,e):a.error("no FITS module available to process FITS image")};a.fits2RepFile=function(c,b,d,e,f){var h,g={},k="fits2"+e;var l=d[k]||void 0===d[k]&&a.globalOpts[k];!0===l?l="always":!1===l&&(l="never");if(l.match(/never/i))return!1;if(!a.helper.connected||"nodejs"!==
a.helper.type&&"socket.io"!==a.helper.type)return"always"===l&&a.globalOpts.requireFits2Fits&&a.error("can't run fits2fits without connected JS9 helper"),!1;if(!a.helper.js9helper)if(a.globalOpts.requireFits2Fits)a.error("js9helper not found for fits2fits processing");else return!1;switch(k){case "fits2png":break;case "fits2fits":if(!a.globalOpts.workDir)return a.globalOpts.requireFits2Fits&&a.error("can't run fits2fits without a workdir"),!1;e=d.xdim||a.fits.options.image.xdim||a.fits.options.table.xdim;
