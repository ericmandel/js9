...
c;this.oid=this.file.split("/").reverse()[0];this.id=a.getImageID(this.oid,this.display.id);this.status.load="loading";$(this.png.image).on("load",function(){g.mkOffScreenCanvas();g.mkRawDataFromPNG();"zscale"===g.params.scaleclipping&&g.zscale(!0);g.mkSection();e=j(g,h);e.length&&g.mkSection.apply(g,e);g.displayImage("all",h);k.call(g,d);a.DEBUG&&a.log("JS9 image: %s dims(%d,%d) min/max(%d,%d)",g.file,g.raw.width,g.raw.height,g.raw.dmin,g.raw.dmax)}).on("error",function(){a.waiting(!1);g.status.load=
...
this.raw.header.BITPIX?this.raw.bitpix=this.raw.header.BITPIX:a.error("BITPIX missing from PNG-based FITS header");"little"===this.raw.endian?j=!0:"big"===this.raw.endian?j=!1:a.error("js9Endian missing from PNG-based FITS header");this.object=this.raw.header.OBJECT;this.raw.dmin=Number.MAX_VALUE;this.raw.dmax=Number.MIN_VALUE;b=this.raw.width*this.raw.height;f=d%4;switch(this.raw.bitpix){case 8:this.raw.data=new Uint8Array(b);for(c=0;c<b;c++){switch(f){case 0:g=e[d];d+=1;f=1;break;case 1:g=e[d];
d+=1;f=2;break;case 2:g=e[d];d+=2;f=0;break;case 3:g=e[d+1],d+=2,f=1}this.raw.data[c]=g;isNaN(g)||(this.raw.dmin=Math.min(this.raw.dmin,g),this.raw.dmax=Math.max(this.raw.dmax,g))}break;case 16:case -16:16===this.raw.bitpix?(this.raw.data=new Int16Array(b),h=DataView.prototype.getInt16):(this.raw.data=new Uint16Array(b),h=DataView.prototype.getUint16);for(c=0;c<b;c++){switch(f){case 0:k[0]=e[d];k[1]=e[d+1];g=h.call(m,0,j);d+=2;f=2;break;case 1:k[0]=e[d];k[1]=e[d+1];g=h.call(m,0,j);d+=3;f=0;break;
case 2:k[0]=e[d];k[1]=e[d+2];g=h.call(m,0,j);d+=3;f=1;break;case 3:k[0]=e[d+1],k[1]=e[d+2],g=h.call(m,0,j),d+=3,f=2}this.raw.data[c]=g;isNaN(g)||(this.raw.dmin=Math.min(this.raw.dmin,g),this.raw.dmax=Math.max(this.raw.dmax,g))}break;case 32:case -32:32===this.raw.bitpix?(this.raw.data=new Int32Array(b),h=DataView.prototype.getInt32):(this.raw.data=new Float32Array(b),h=DataView.prototype.getFloat32);for(c=0;c<b;c++){switch(f){case 0:k[0]=e[d];k[1]=e[d+1];k[2]=e[d+2];k[3]=e[d+4];g=h.call(m,0,j);d+=
5;f=1;break;case 1:k[0]=e[d];k[1]=e[d+1];k[2]=e[d+3];k[3]=e[d+4];g=h.call(m,0,j);d+=5;f=2;break;case 2:k[0]=e[d];k[1]=e[d+2];k[2]=e[d+3];k[3]=e[d+4];g=h.call(m,0,j);d+=6;f=0;break;case 3:k[0]=e[d+1],k[1]=e[d+2],k[2]=e[d+3],k[3]=e[d+5],g=h.call(m,0,j),d+=6,f=1}this.raw.data[c]=g;isNaN(g)||(this.raw.dmin=Math.min(this.raw.dmin,g),this.raw.dmax=Math.max(this.raw.dmax,g))}break;case -64:this.raw.data=new Float64Array(b);for(c=0;c<b;c++){switch(f){case 0:case 4:k[0]=e[d];k[1]=e[d+1];k[2]=e[d+2];k[3]=e[d+
4];k[4]=e[d+5];k[5]=e[d+6];k[6]=e[d+8];k[7]=e[d+9];g=m.getFloat64(0,j);d+=10;f=2;break;case 1:case 5:k[0]=e[d];k[1]=e[d+1];k[2]=e[d+3];k[3]=e[d+4];k[4]=e[d+5];k[5]=e[d+7];k[6]=e[d+8];k[7]=e[d+9];g=m.getFloat64(0,j);d+=11;f=0;break;case 2:case 6:k[0]=e[d];k[1]=e[d+2];k[2]=e[d+3];k[3]=e[d+4];k[4]=e[d+6];k[5]=e[d+7];k[6]=e[d+8];k[7]=e[d+10];g=m.getFloat64(0,j);d+=11;f=1;break;case 3:case 7:k[0]=e[d+1],k[1]=e[d+2],k[2]=e[d+3],k[3]=e[d+5],k[4]=e[d+6],k[5]=e[d+7],k[6]=e[d+9],k[7]=e[d+10],g=m.getFloat64(0,
...
function(){var c,b,d=a.COLORSIZE;this.colorCells||(this.colorCells=[]);for(c=0;c<d;c++)b=this.params.invert?d-c-1:c,b=this.calcContrastBias(b),this.colorCells[c]=this.cmapObj.mkColorCell(b);return this};a.Image.prototype.mkScaledCells=function(){var c,b,d,e,f,g,h=a.COLORSIZE,j=a.SCALESIZE;c=function(a){var c,d,b,e,f=[];"#"===a.charAt(0)&&(a=a.slice(1));a=a.toUpperCase();for(d=c=0;6>c;c+=2,d++)b="0123456789ABCDEF".indexOf(a.charAt(c)),e="0123456789ABCDEF".indexOf(a.charAt(c+1)),f[d]=16*b+e;return f};
if(!this.colorCells)return this;this.psColors||(this.psColors=[],this.psColors[NaN]=c(this.params.nancolor));this.psInverse||(this.psInverse=[],this.psInverse[NaN]=c(this.params.nancolor));b=this.params.scalemax-this.params.scalemin;g=this.params.scalemin;switch(this.params.scale){case "linear":for(d=0;d<j;d++)c=d/j,e=Math.floor(c*h),this.psColors[d]=this.colorCells[e],this.psInverse[d]=c*b+g;break;case "log":f=this.params.exp;for(d=0;d<j;d++)c=Math.log(f*d/j+1)/Math.log(f),e=Math.floor(c*h),e>=h&&
(e=h-1),this.psColors[d]=this.colorCells[e],c=(Math.pow(f,d/j)-1)/f,this.psInverse[d]=c*b+g;break;case "pow":f=this.params.exp;for(d=0;d<j;d++)c=(Math.pow(f,d/j)-1)/f,e=Math.floor(c*h),e>=h&&(e=h-1),this.psColors[d]=this.colorCells[e],c=Math.log(f*d/j+1)/Math.log(f),this.psInverse[d]=c*b+g;break;case "sqrt":for(d=0;d<j;d++)c=d/j,e=Math.floor(Math.sqrt(c)*h),e>=h&&(e=h-1),this.psColors[d]=this.colorCells[e],this.psInverse[d]=c*c*b+g;break;case "squared":for(d=0;d<j;d++)c=d/j,e=Math.floor(c*c*h),e>=
h&&(e=h-1),this.psColors[d]=this.colorCells[e],c=Math.sqrt(d/j),this.psInverse[d]=c*b+g;break;case "asinh":for(d=0;d<j;d++)c=d/j,e=Math.floor(Math.asinh(10*c)/3*h),e>=h&&(e=h-1),this.psColors[d]=this.colorCells[e],e=Math.sinh(3*c)/10,this.psInverse[d]=e*b+g;break;case "sinh":for(d=0;d<j;d++)c=d/j,e=Math.floor(Math.sinh(3*c)/10*h),e>=h&&(e=h-1),this.psColors[d]=this.colorCells[e],e=Math.asinh(10*c)/3,this.psInverse[d]=e*b+g;break;default:a.log("unknown scale '"+this.params.scale+"'")}return this};
a.Image.prototype.mkRGBImage=function(){var c,b,d,e,f,g,h,j,k,m,n,p,r,l,q,s,t,v,u,w,y=null,x=null,A=null,B=!1;if(!this.rgb)return this;if(a.globalOpts.rgb.active&&(this===a.globalOpts.rgb.rim||this===a.globalOpts.rgb.gim||this===a.globalOpts.rgb.bim))B=!0,a.globalOpts.rgb.rim&&(y=a.globalOpts.rgb.rim),a.globalOpts.rgb.gim&&(x=a.globalOpts.rgb.gim),a.globalOpts.rgb.bim&&(A=a.globalOpts.rgb.bim);h=this.display.context;c=this.rgb;b=c.sect;if(this.MakeRGBImage&&"function"===typeof this.MakeRGBImage&&
this.MakeRGBImage()||this.MakePrimaryImage&&"function"===typeof this.MakePrimaryImage&&this.MakePrimaryImage())return this;if(this.rgbFile){f=b.width/b.zoom;g=b.height/b.zoom;d=b.x0;e=this.offscreen.canvas.height-1-(b.y0+g);e=this.offscreen.context.getImageData(d,e,f,g);if(1===b.zoom)c.img=e;else{c.img=h.createImageData(b.width,b.height);c=c.img;for(m=j=0;j<e.height;j++,m++){s=j*e.width;p=m*b.zoom;for(k=h=0;h<e.width;h++,k++){d=4*(s+h);n=k*b.zoom;for(r=0;r<b.zoom;r++){l=Math.floor(p+r);t=l*b.width;
for(l=0;l<b.zoom;l++)q=Math.floor(n+l),q=4*(t+q),c.data[q]=e.data[d],c.data[q+1]=e.data[d+1],c.data[q+2]=e.data[d+2],c.data[q+3]=e.data[d+3]}}}}return this}if(!c.img||c.img.width!==b.width||c.img.height!==b.height)c.img=h.createImageData(b.width,b.height);c=c.img;if(!this.psColors)return this;v=void 0!==this.params.opacity?255*this.params.opacity:void 0!==this.params.alpha?this.params.alpha:255;this.maskData&&(this.params.maskInvert?void 0!==this.params.opacity&&void 0!==this.params.maskOpacity?(e=
255*this.params.opacity,f=255*this.params.maskOpacity):void 0!==this.params.alpha1&&void 0!==this.params.alpha2?(e=this.params.alpha2,f=this.params.alpha1):(e=0,f=255):void 0!==this.params.opacity&&void 0!==this.params.maskOpacity?(e=255*this.params.maskOpacity,f=255*this.params.opacity):void 0!==this.params.alpha1&&void 0!==this.params.alpha2?(e=this.params.alpha1,f=this.params.alpha2):(e=255,f=0));j=b.y1-1;for(m=0;j>=b.y0;j--,m++){s=j*this.raw.width;p=m*b.zoom;h=b.x0;for(k=0;h<b.x1;h++,k++){if(B){if(g=
y?y.colorData[s+h]:0,u=x?x.colorData[s+h]:0,w=A?A.colorData[s+h]:0,void 0===g||void 0===u||void 0===w)return a.globalOpts.rgb.active=!1,a.error("RGB images are incompatible. Turning off RGB mode.","",!1),a.Image.prototype.mkRGBImage.call(this),this}else d=this.colorData[s+h];this.maskData&&(v=0<this.maskData[s+h]?e:f);n=k*b.zoom;for(r=0;r<b.zoom;r++){l=Math.floor(p+r);t=l*b.width;for(l=0;l<b.zoom;l++)q=Math.floor(n+l),q=4*(t+q),B?(c.data[q]=y?y.psColors[g][0]:0,c.data[q+1]=x?x.psColors[u][1]:0,c.data[q+
2]=A?A.psColors[w][2]:0):(c.data[q]=this.psColors[d][0],c.data[q+1]=this.psColors[d][1],c.data[q+2]=this.psColors[d][2]),c.data[q+3]=v}}}return this};a.Image.prototype.blendImage=function(c,b,d){var e=/normal|multiply|screen|overlay|darken|lighten|color-dodge|color-burn|hard-light|soft-light|difference|exclusion|hue|saturation|color|luminosity|clear|copy|source-over|destination-over|source-in|destination-in|source-out|destination-out|source-atop|destination-atop|xor|lighter/i;if(0===arguments.length)return this.blend;
if(!0===c||!1===c)return this.blend.active=c,this.display.blendMode&&this.displayImage(),this;if(a.notNull(c)||a.notNull(b))a.notNull(c)&&(e.test(c)||a.error("invalid composite/blend operation: "+c),this.blend.mode=c),a.notNull(b)&&(this.blend.opacity=b),a.notNull(d)&&(this.blend.active=d),this.display.blendMode&&this.blend.active&&this.displayImage();return this};a.noff=0;a.Image.prototype.putImage=function(c){var b,d,e=this.rgb;b=this.display;var f=b.context,g=function(c,d){var b,e;c.offscreenRGB||
(e=document.createElement("canvas"),b=e.getContext("2d"),e.width=d.width,e.height=d.height,a.ANTIALIAS||(b.imageSmoothingEnabled=!1,b.mozImageSmoothingEnabled=!1,b.webkitImageSmoothingEnabled=!1),b.putImageData(d,0,0),c.offscreenRGB={canvas:e,context:b});return c.offscreenRGB.canvas};c=c||{};this.ix=Math.floor((b.canvas.width-e.img.width)/2);this.iy=Math.floor((b.canvas.height-e.img.height)/2);"reproject"===this.rawDataLayer()&&(c.wcsim&&(b=c.wcsim.logicalToDisplayPos({x:c.wcsim.raw.header.CRPIX1,
y:c.wcsim.raw.header.CRPIX2}),d=this.logicalToDisplayPos({x:this.raw.header.CRPIX1,y:this.raw.header.CRPIX2}),this.wcsix=b.x-d.x,this.wcsiy=b.y-d.y),this.wcsix&&(this.ix+=this.wcsix*this.rgb.sect.zoom),this.wcsiy&&(this.iy+=this.wcsiy*this.rgb.sect.zoom));a.notNull(c.opacity)||a.notNull(c.blend)?(f.save(),void 0!==c.opacity&&(f.globalAlpha=c.opacity),void 0!==c.blend&&(f.globalCompositeOperation=c.blend),f.drawImage(g(this,e.img),this.ix,this.iy),f.restore()):f.putImageData(e.img,this.ix,this.iy)};
a.Image.prototype.displayImage=function(c,b){var d,e,f,g;g=0;var h=[],j={};if(!1===c)return this.displayMode=!1,this;!0===c&&(this.displayMode=!0,c="all");if(!this.displayMode)return this;"object"===typeof c&&(b=c,c=null);c?"all"===c?(c="colors,scaled,rgb,display,plugins",j.notify=!0):"rgbonly"===c?(c="rgb,nodisplay",j.notify=!0):"display"===c&&(j.notify=!0):c="rgb";c.split(",").forEach(function(a){a=a.trim();j[a]=!0;switch(a){case "colors":j.scaled=!0;j.rgb=!0;break;case "scaled":j.rgb=!0}});j.display=
!0;j.plugins=!0;this.rgbFile&&(c.colors=!1,c.scaled=!1);b=b||{};if(this.display.blendMode)for(d=0;d<a.images.length;d++)e=a.images[d],e.display===this.display&&e.blend.active&&(h.push(e),g++);j.colors&&(this.mkColorData(),this.offscreenRGB=null);j.scaled&&(this.mkColorCells(),this.mkScaledCells(),this.offscreenRGB=null);if(j.rgb&&(this.mkRGBImage(),this.offscreenRGB=null,g))for(d=h.length-1;0<=d;d--)e=h[d],e.mkRGBImage(),e.offscreenRGB=null;if(j.nodisplay)return this;if(j.display){this.display.context.clear();
if(g)for(d=h.length-1;0<=d;d--)e=h[d],g={blend:e.blend.mode,opacity:e.blend.opacity},e.putImage(g),e===this&&(e.displayShapeLayers(),j.notify&&e.notifyHelper());else this.putImage(b),this.displayShapeLayers(),j.notify&&this.notifyHelper();this.display.image=this}if(j.plugins)for(f in this.display.pluginInstances)if(this.display.pluginInstances.hasOwnProperty(f)&&(d=this.display.pluginInstances[f],e=d.plugin.opts,d.isActive("onimagedisplay")&&("JS9Panner"===f||j.display)))try{e.onimagedisplay.call(d,
this)}catch(k){d.errLog("onimagedisplay",k)}return this};a.Image.prototype.refreshImage=function(c,b){var d,e,f,g,h,j;b=b||{};b.rawid=b.rawid||a.RAWID0;"function"===typeof b&&(b={onrefresh:b});!b.onrefresh&&a.imageOpts.onrefresh&&(b.onrefresh=a.imageOpts.onrefresh);d=this.rgb.sect.xcen;e=this.rgb.sect.ycen;h=this.rgb.sect.zoom;f=this.raw.width;g=this.raw.height;this.binning.obin=this.binning.bin;this.mkRawDataFromHDU(c,b);this.raw.width===f&&this.raw.height===g?this.mkSection(d,e,h):(this.mkSection(),
this.mkSection(h));this.displayImage("colors",b);this.refreshLayers();this.updateShapes("regions","all","binning");if(b.onrefresh)try{a.xeqByName(b.onrefresh,window,this)}catch(k){a.error("in image refresh callback",k)}for(j in this.display.pluginInstances)if(this.display.pluginInstances.hasOwnProperty(j)&&(d=this.display.pluginInstances[j],e=d.plugin.opts,d.isActive("onimagerefresh")))try{e.onimagerefresh.call(d,this)}catch(m){d.errLog("onimagerefresh",m)}};a.Image.prototype.toArray=function(){var c,
b,d,e,f,g,h,j,k,m;k=this.raw.data.buffer;g=a.raw2FITS(this.raw);h=2880-g.length%2880;2880===h&&(h=0);for(c=0;c<h;c++)g+=" ";h=2880-k.byteLength%2880;2880===h&&(h=0);c=new ArrayBuffer(g.length+k.byteLength+h);j=new Uint8Array(c);for(c=0;c<g.length;c++)j[c]=g.charCodeAt(c);if(0<(new Int8Array((new Int16Array([1])).buffer))[0]){f=g.length;e=Math.abs(this.raw.bitpix)/8;m=new Uint8Array(k);for(c=0;c<m.byteLength;c+=e){b=c+e-1;for(d=0;d<e;b--,d++)j[f++]=m[b]}}else j.set(new Uint8Array(k),g.length);f=g.length+
k.byteLength;for(c=0;c<h;c++)j[f++]=0;return j};a.Image.prototype.getPan=function(){return{x:(this.rgb.sect.x0+this.rgb.sect.x1)/2+1,y:(this.rgb.sect.y0+this.rgb.sect.y1)/2+1}};a.Image.prototype.setPan=function(c,b){var d,e,f,g,h,j=this.raw.width/2,k=this.raw.height/2;0===arguments.length&&(c=j,b=k);this.mkSection(c,b);if(this.display.blendMode)for(d=0;d<a.images.length;d++)h=a.images[d],h!==this&&(h.display===this.display&&h.blend.active)&&(f=h.raw.width/2,g=h.raw.height/2,0!==arguments.length&&
(f-=j-c,g-=k-b),a.Image.prototype.mkSection.call(h,f,g));this.displayImage("rgb");for(e in this.layers)this.layers.hasOwnProperty(e)&&this.layers[e].show&&this.layers[e].opts.panzoom&&this.refreshShapes(e);return this};a.Image.prototype.getZoom=function(){return this.rgb.sect.zoom};a.Image.prototype.parseZoom=function(a){var b;b=this.rgb.sect.zoom;switch(typeof a){case "string":switch(a.charAt(0)){case "*":case "x":case "X":a=b*parseFloat(a.slice(1));break;case "/":a=b/parseFloat(a.slice(1));break;
...
this.displayImage("rgb");for(d in this.layers)this.layers.hasOwnProperty(d)&&this.layers[d].show&&this.layers[d].opts.panzoom&&this.refreshShapes(d);return this}};a.Image.prototype.refreshLayers=function(){this.setZoom(this.getZoom())};a.Image.prototype.imageToLogicalPos=function(a,b){var d,e=a.x,f=a.y,g="image";b=b||this.params.lcs||"image";switch(b){case "physical":this.lcs.physical&&(g=b,d=this.lcs.physical.reverse);break;case "detector":this.lcs.detector&&(g=b,d=this.lcs.detector.reverse);break;
case "amplifier":this.lcs.amplifier&&(g=b,d=this.lcs.amplifier.reverse)}d&&(e=a.x*d[0][0]+a.y*d[1][0]+d[2][0],f=a.x*d[0][1]+a.y*d[1][1]+d[2][1]);return{x:e,y:f,sys:g}};a.Image.prototype.logicalToImagePos=function(a,b){var d,e={x:a.x,y:a.y};b=b||this.params.lcs||"image";switch(b){case "physical":this.lcs.physical&&(d=this.lcs.physical.forward);break;case "detector":this.lcs.detector&&(d=this.lcs.detector.forward);break;case "amplifier":this.lcs.amplifier&&(d=this.lcs.amplifier.forward)}d&&(e.x=a.x*
d[0][0]+a.y*d[1][0]+d[2][0],e.y=a.x*d[0][1]+a.y*d[1][1]+d[2][1]);return e};a.Image.prototype.displayToImagePos=function(a){var b=this.rgb,d=this.rgb.sect,e={};1>=d.zoom?(e.x=(a.x-this.ix)/d.zoom+d.x0+1,e.y=(b.img.height-1-(a.y-this.iy))/d.zoom+d.y0+1):(e.x=(a.x-this.ix)/d.zoom+d.x0+1-0.5,e.y=(b.img.height-1-(a.y-this.iy))/d.zoom+d.y0+1-0.5);return e};a.Image.prototype.imageToDisplayPos=function(a){var b=this.rgb,d=this.rgb.sect,e={};1>=d.zoom?(e.x=(a.x-1-d.x0)*d.zoom+this.ix,e.y=(d.y0-(a.y-1))*d.zoom+
(b.img.height-1)+this.iy):(e.x=(a.x-1+0.5-d.x0)*d.zoom+this.ix,e.y=(d.y0-(a.y-1+0.5))*d.zoom+(b.img.height-1)+this.iy);return e};a.Image.prototype.logicalToDisplayPos=function(a){return this.imageToDisplayPos(this.logicalToImagePos(a))};a.Image.prototype.displayToLogicalPos=function(a){return this.imageToLogicalPos(this.displayToImagePos(a))};a.Image.prototype.getWCSSys=function(){if(this.params.wcssys)return this.params.wcssys};a.Image.prototype.setWCSSys=function(c){if("image"===c)this.params.wcssys=
"image",this.params.wcsunits="pixels";else if("physical"===c)this.params.wcssys="physical",this.params.wcsunits="pixels";else if(this.wcs&&0<this.wcs){"native"===c&&(c=this.params.wcssys0);if(c=a.wcssys(this.wcs,c))this.params.wcssys=c.trim(),c="pixels"===this.params.wcsunits?a.imageOpts.wcsunits:this.params.wcsunits,this.setWCSUnits(c),this.updateShapes("regions","all","update");return this}};a.Image.prototype.getWCSUnits=function(){return this.params.wcsunits?this.params.wcsunits:"pixels"};a.Image.prototype.setWCSUnits=
...
h.params={};h.params.scalemin=Number.Nan;h.params.scalemax=Number.Nan;h.png={};h.png.image=new Image;$(h.png.image).on("load",m).on("error",r);h.png.image.src=a.InstallDir(f.url);break;case "regions":f.layer=this.display.newShapeLayer(c,a.Regions.opts);g=a.InstallDir(f.url);$.ajax({url:g,cache:!1,dataType:"json",success:n,error:r});break;case "text":g=a.InstallDir(f.url),$.ajax({url:g,cache:!1,dataType:"text",success:p,error:r})}}};a.Image.prototype.saveFITS=function(c){var b;window.hasOwnProperty("saveAs")?
...
a.Image.prototype.getScale=function(){if(this.params.scale)return{scale:this.params.scale,scalemin:this.params.scalemin,scalemax:this.params.scalemax}};a.Image.prototype.setScale=function(c,b,d){var e=this,f=function(c){0<=a.scales.indexOf(c)?e.params.scale=c:a.error("unknown scale: "+c)};if(arguments.length){switch(arguments.length){case 1:f(c);break;case 2:this.params.scalemin=parseInt(c,10);this.params.scalemax=parseInt(b,10);this.mkColorData();break;default:f(c),this.params.scalemin=parseInt(b,
...
0;d<this.raws.length;d++)if(c.oraw===this.raws[d].id){e=this.raws[d];break}e||(e=this.raws[0]);h=-1;for(d=0;d<this.raws.length;d++)if(g===this.raws[d].id){f=this.raws[d];h=d;break}if(0>h||c.alwaysCopy){f=$.extend(!0,{},e);f.current0||(f.current0=e);if(c.bitpix){switch(c.bitpix){case 8:f.data=new Uint8Array(e.height*e.width);break;case 16:f.data=new Int16Array(e.height*e.width);break;case -16:f.data=new Uint16Array(e.height*e.width);break;case 32:f.data=new Int32Array(e.height*e.width);break;case -32:f.data=
new Float32Array(e.height*e.width);break;case -64:f.data=new Float64Array(e.height*e.width)}j=f.width*f.height;for(d=0;d<j;d++)f.data[d]=e.data[d];f.bitpix=c.bitpix}else switch(e.bitpix){case 8:f.data=new Uint8Array(e.data);break;case 16:f.data=new Int16Array(e.data);break;case -16:f.data=new Uint16Array(e.data);break;case 32:f.data=new Int32Array(e.data);break;case -32:f.data=new Float32Array(e.data);break;case -64:f.data=new Float64Array(e.data)}f.id=g;f.from=c.from||f.from||"func"}b.call(this,
...
e.bitpix)}gaussBlur(f,e.data,e.width,e.height,c);return!0})};a.Image.prototype.shiftData=function(c,b,d){(void 0===c||void 0===b)&&a.error("missing translation value(s) for shiftData");d=d||{};d.rawid="shift";d.x=c;d.y=b;this.rawDataLayer(d,function(a,c,b){var d,j,k,m,n=a.data.BYTES_PER_ELEMENT;void 0===c.xoff&&(c.xoff=0);void 0===c.yoff&&(c.yoff=0);c.xoff+=b.x;c.yoff+=b.y;if(!b.fill||"clear"===b.fill)if("function"===typeof c.data.fill)c.data.fill(0);else for(b=0;b<c.data.length;b++)c.data[b]=0;for(b=
0;b<a.height;b++)if(k=b+c.yoff,!(0>k||k>=a.height)){d=0;j=d+c.xoff;m=a.width;0>j&&(d-=j,m+=j,j=0);j+m>a.width&&(m-=j+m-a.width);if(0>=m)return!1;d=(b*a.width+d)*n;d=new Uint8Array(a.data.buffer,d,m*n);j=(k*a.width+j)*n;m=new Uint8Array(c.data.buffer,j,m*n);m.set(d)}return!0})};a.Image.prototype.reprojectData=function(c,b){var d=this,e={},f,g,h,j,k,m,n,p,r=/NAXIS|NAXIS[1-4]|AMDX|AMDY|CD[1-2]_[1-2]|CDELT[1-4]|CNPIX[1-4]|CO1_[1-9][0-9]|CO2_[1-9][0-9]|CROTA[1-4]|CRPIX[1-4]|CRVAL[1-4]|CTYPE[1-4]|CUNIT[1-4]|DATE|DATE_OBS|DC-FLAG|DEC|DETSEC|DETSIZE|EPOCH|EQUINOX|EQUINOX[a-z]|IMAGEH|IMAGEW|LATPOLE|LONGPOLE|MJD-OBS|PC00[1-4]00[1-4]|PC[1-4]_[1-4]|PIXSCALE|PIXSCAL[1-2]|PLTDECH|PLTDECM|PLTDECS|PLTDECSN|PLTRAH|PLTRAM|PLTRAS|PPO|PROJP[1-9]|PROJR0|PV[1-3]_[1-3]|PV[1-4]_[1-4]|RA|RADECSYS|SECPIX|SECPIX|SECPIX[1-2]|UT|UTMID|VELOCITY|VSOURCE|WCSAXES|WCSDEP|WCSDIM|WCSNAME|XPIXSIZE|YPIXSIZE|ZSOURCE|LTM|LTV/,
l=function(c){d.refreshImage(c,m);a.waiting(!1)};if(this.wcs&&c&&a.reproject&&a.fits.handleFITSFile){b=b||{};a.waiting(!0,this.display.divjq[0]);"string"===typeof c&&((g=a.getImage(c))?c=g:a.error("unknown WCS for reproject: "+c));g=$.extend(!0,{},this.raw.header);for(p in g)g.hasOwnProperty(p)&&r.test(p)&&delete g[p];c.raw&&c.raw.header?h=c.raw.header:c.BITPIX&&c.NAXIS1&&c.NAXIS2?h=c:a.error("invalid wcs object input to reproject()");for(p in h)h.hasOwnProperty(p)&&r.test(p)&&(e[p]=h[p]);e=$.extend(!0,
...
"fits")):(e=this.toArray(),j=this.id.replace(/\.png$/,"_png"+a.uniqueID()+".fits"),a.vfile(j,e),k="reprojected_"+j);window.setTimeout(function(){var d,e,g,h;try{d=k.lastIndexOf("."),0<=d&&(e=k.substring(0,d)+"_area"+k.substring(d)),h=b.cmdswitches||"",n=a.reproject(j,k,f,h),a.vunlink(e),a.vunlink(f),0>n.search(/\[struct stat="OK"/)&&((g=n.match(/msg="([^"]*)"/))&&g[1]?a.error(g[1]+" (from mProjectPP)"):a.error(n))}catch(r){a.vunlink(e),a.vunlink(f),n?a.error(n):a.error("WCS reproject failed",r)}m=
$.extend(!0,{},b||{},a.fits.options);m.rawid=m.rawid||"reproject";m.wcsim=c;try{a.fits.handleFITSFile(k,m,l)}catch(p){a.error("can't process reprojected FITS file",p)}},a.SPINOUT)}};a.Colormap=function(c,b,d,e){this.name=c;switch(arguments.length-1){case 1:this.type="lut";this.colors=b;break;case 3:this.type="sao";this.vertices=[];this.vertices[0]=b;this.vertices[1]=d;this.vertices[2]=e;break;default:a.error("colormap requires name and 1 or 3 array arg")}a.colormaps.push(this);1<a.DEBUG&&a.log("JS9 colormap:  %s",
...
c.scaleX;e=b/c.scaleY;for(b=0;b<c.points.length;b++)c.points[b].x-=d,c.points[b].y-=e}c.left=f.x;c.top=f.y;c.setCoords()};a.Fabric.print=function(){var c,b,d;b=sprintf("width=%s,height=%s,menubar=1,toolbar=1,status=0,scrollbars=1,resizable=1",this.display.canvasjq.attr("width"),this.display.canvasjq.attr("height"));d=this.display.canvas.toDataURL("image/png");if(b=window.open(null,this.id,b)){b.document.open();b.document.write("<html><body style='padding: 0px; margin: 0px' onload='window.print(); return false'>");
...
oradius:30,nannuli:10,width:60,height:60,radius:30,r1:30,r2:20,ptshape:"box",ptsize:2,linepoints:[{x:-30,y:30},{x:30,y:-30}],polypoints:[{x:-30,y:30},{x:30,y:30},{x:0,y:-30}],fontFamily:"Helvetica",fontSize:14,fontStyle:"normal",fontWeight:300,textAlign:"left",angle:0,aradius1:4,aradius2:8,configURL:"./params/regionsconfig.html",tagcolors:{include_source:"#00FF00",exclude_source:"#FF0000",include_background:"#FFD700",exclude_background:"#FF8C00",source:"#00FF00",background:"#FFD700",defcolor:"#00FF00"},
onmousedown:function(c,b,d,e){var f;!a.specialKey(d)&&e.params&&(b=(new Date).getTime(),e.params.lasttime&&b-e.params.lasttime<a.DBLCLICK&&(f=!0),e.params.lasttime=b);f?e.params.winid||($("#dhtmlwindowholder").arrive("#regionsConfigForm",{onceOnly:!0},function(){e.pub&&a.Regions.initConfigForm.call(c,e)}),e.params.winid=a.allinone?c.displayAnalysis("params",a.allinone.regionsConfigHTML,"Region Configuration"):c.displayAnalysis("params",a.InstallDir(a.Regions.opts.configURL),"Region Configuration")):
...
(f=this.getActiveGroup().getObjects());for(a=0;a<f.length;a++)if(f[a].params){c.params.listonchange?c.listRegions("all",2):f[a].params.listonchange&&c.listRegions("selected",2);break}}});return this};a.Regions.onchange=function(c,b){if(a.Regions.opts.onchange&&"function"===typeof a.Regions.opts.onchange)try{a.Regions.opts.onchange(c,b)}catch(d){}};a.Regions.initConfigForm=function(a){var b,d,e=a.params.winid,f="#"+$(e).attr("id")+" #regionsConfigForm ";$(f+"."+a.pub.shape).each(function(){$(this).removeClass("nodisplay")});
...
void 0===a.params.fixinplace&&(a.params.fixinplace=!1);a.params.fixinplace?$(f+"[name='fixinplace']").attr("checked","checked"):$(f+"[name='fixinplace']").removeAttr("checked");switch(a.pub.shape){case "box":case "ellipse":case "line":case "polygon":case "text":$(f+".angle").removeClass("nodisplay")}$(f).data("im",this);$(f).data("shape",a);$(f).data("winid",e)};a.Regions.processConfigForm=function(c,b,d){var e,f,g,h=d.length,j={},k=function(a,c,b){return"remove"===c||void 0!==a.pub[c]&&String(a.pub[c])!==
b||void 0!==a.params[c]&&String(a.params[c])!==b?!0:!1},m=function(a){return"true"===a?!0:"false"===a?!1:""===a||isNaN(a)?a:parseFloat(a)};for(e=0;e<h;e++)switch(f=d[e].name,g=d[e].value,f){case "x":k(c,f,g)&&(j[f]=m(g),void 0===j.y&&(j.y=c.pub.y));break;case "y":k(c,f,g)&&(j[f]=m(g),void 0===j.x&&(j.x=c.pub.x));break;default:k(c,f,g)&&(j[f]=m(g))}this.changeShapes(c.pub.layer,c,j);a.Regions.initConfigForm.call(this,c,b)};a.Regions.listRegions=function(a,b){var d,e,f,g,h,j,k="",m="none",n=!1,p=[];
void 0===b&&(b=2);p=this.getShapes("regions",a);f=p.length;if(b)for(d=0;d<f;d++)if(e=p[d],"source,include"!==e.tags.join(",")){n=!0;break}for(d=0;d<f;d++)e=p[d],h=e.tags.join(","),j=0<=h.indexOf("exclude")?"-":"",n&&(g=" # "+h),e.wcsstr&&"image"!==this.params.wcssys&&"physical"!==this.params.wcssys?("wcs"!==m&&("none"!==m&&(k+="; "),k+=this.params.wcssys,m="wcs"),k+="; "+j+e.wcsstr):e.imstr&&(m!==e.imsys&&("none"!==m&&(k+="; "),k+=e.imsys,m=e.imsys),k+="; "+j+e.imstr),n&&(k+=g);1<b&&this.displayMessage("regions",
k);return k};a.Regions.parseRegions=function(c){var b=[],d,e,f,g,h,j,k,m,n,p,r,l,q=/(annulus)|(box)|(circle)|(ellipse)|(line)|(polygon)|(point)|(text)/,s=/(fk4)|(fk5)|(icrs)|(galactic)|(ecliptic)|(image)|(physical)/,t=/\(\s*([^)]+?)\s*\)/,v=/(\{[^}]*\})/,u=/\s*,\s*/,w=function(c){c=a.saostrtod(c);var b=String.fromCharCode(a.saodtype());switch(b){case '"':c/=3600;break;case "'":c/=60;break;case "r":c*=180/Math.PI}return{dval:c,dtype:b}},y=function(c,b){var d,e;e=w(c);d=w(b);if(":"===e.dtype||":"===
d.dtype)n=!0;m||n?(":"===e.dtype&&("galactic"!==k&&"ecliptic"!==k)&&(e.dval*=15),d=a.wcs2pix(this.wcs,e.dval,d.dval).split(/ +/),e=parseFloat(d[0])-1,d=parseFloat(d[1])-1):"physical"===k?(d=this.logicalToImagePos({x:e.dval,y:d.dval}),e=d.x,d=d.y):(e=e.dval,d=d.dval);return[e,d]},x=function(a,c){var b=w(a);if((m||n)&&b.dtype&&"."!==b.dtype)b.dval=Math.abs(b.dval/r["cdelt"+c]);return b.dval};c=c.trim();if(!c.match(/(\(|\{|#|;|\n)/))return c;try{r=JSON.parse(a.wcsinfo(this.wcs))}catch(z){r={cdelt1:1,
cdelt2:1,crot:0,imflip:0}}j=this.getWCSSys();k="physical";this.setWCSSys(k);m="image"!==k&&"physical"!==k;f=c.split(/\n|;/);for(c=0;c<f.length;c++)if("#"!==f[c].trim().substr(0,1)){n=!1;g=f[c];h=void 0;d={opts:{},args:[],isregion:0};d.cmd=0<=g.indexOf("(")?g.split("(")[0].trim().toLowerCase():0<=g.indexOf("{")?g.split("{")[0].trim().toLowerCase():0<=g.indexOf("#")?g.split("#")[0].trim().toLowerCase():g.trim().toLowerCase();d.cmd&&(d.isregion=0<=d.cmd.search(q));d.comment=g.split("#")[1];d.comment&&
(d.comment=d.comment.trim().toLowerCase());if((h=v.exec(g))&&h[1])try{d.opts=JSON.parse(h[1].trim())}catch(B){d.opts={}}if((h=t.exec(g))&&h[1])d.args=h[1].split(u);d.isregion&&0===d.cmd.indexOf("-")&&(d.cmd=d.cmd.slice(1),d.comment=d.comment?d.comment+",exclude":"exclude");h=d;l=h.args.length;if(h.isregion){g=$.extend(!0,{},h.opts);g.shape=h.cmd;2<=l&&(p=y.call(this,h.args[0],h.args[1]),g.x=p[0],g.y=p[1]);switch(h.cmd){case "annulus":g.radii=[];for(d=2;d<l;d++)g.radii.push(x.call(this,h.args[d],1));
break;case "box":3<=l&&(g.width=x.call(this,h.args[2],1));4<=l&&(g.height=x.call(this,h.args[3],2));5<=l&&(g.angle=w(h.args[4]).dval);break;case "circle":3<=l&&(g.radius=x.call(this,h.args[2],1));break;case "ellipse":3<=l&&(g.r1=x.call(this,h.args[2],1));4<=l&&(g.r2=x.call(this,h.args[3],2));5<=l&&(g.angle=w(h.args[4]).dval);break;case "line":case "polygon":g.pts=[];for(e=d=0;d<l;d+=2,e++)p=y.call(this,h.args[d],h.args[d+1]),g.pts[e]={x:p[0],y:p[1]};delete g.x;delete g.y;break;case "text":3<=l&&(d=
g,e=h.args[2].replace(/^['"]/,"").replace(/['"]$/,""),d.text=e)}h.comment&&(g.tags=h.comment);b.push(g)}else h.cmd.match(s)?(this.setWCSSys(h.cmd),k=this.getWCSSys(),m="image"!==k&&"physical"!==k):("remove"===h.cmd||"delete"===h.cmd)&&b.push({remove:!0})}this.setWCSSys(j);return b};a.Regions.saveRegions=function(c){var b=sprintf("# Region file format: JS9 version 1.0");c=this.listRegions(c,1);b=sprintf("%s\n%s\n",b,c.replace(/; */g,"\n"));b=new Blob([b],{type:"text/plain;charset=utf-8"});window.hasOwnProperty("saveAs")?
saveAs(b,"js9.reg"):a.error("no saveAs function available to save region file");return c};a.Regions.keyDownCB=function(a,b,d,e){var f,g;b={evt:d};var h=d.which||d.keyCode;e=e||"regions";g=a.display.layers[e].canvas;switch(h){case 8:case 46:d.preventDefault();f="removeRegion";break;case 37:d.preventDefault();f="editRegion";b.dx=-1;break;case 38:d.preventDefault();f="editRegion";b.dy=1;break;case 39:d.preventDefault();f="editRegion";b.dx=1;break;case 40:d.preventDefault();f="editRegion";b.dy=-1;break;
case 68:f="downRegion";break;case 85:f="upRegion"}switch(f){case "removeRegion":a.removeShapes(e,"selected");a.clearMessage(e);g.fire("mouse:up");break;case "editRegion":a.changeShapes(e,"selected",b);g.fire("mouse:up");break;case "downRegion":a.selectShapes(e,"selected",function(a){g.sendToBack(a)});break;case "upRegion":a.selectShapes(e,"selected",function(a){g.bringToFront(a)})}};a.Magnifier={};a.Magnifier.CLASS="JS9";a.Magnifier.NAME="Magnifier";a.Magnifier.opts={originX:"left",originY:"top",
hasControls:!1,hasRotatingPoint:!1,hasBorders:!1,selectable:!1,zoom:4,canvas:{selection:!1},tagcolors:{defcolor:"#00FF00"}};a.Magnifier.HTML="<span><button type='button' class='JS9Button' onClick='JS9.bcall(this, \"zoomMagnifier\", \"x2\"); return false'>x2</button><button type='button' class='JS9Button' onClick='JS9.bcall(this, \"zoomMagnifier\", \"/2\"); return false'>/2</button><button type='button' class='JS9Button' onClick='JS9.bcall(this, \"zoomMagnifier\", \""+a.Magnifier.opts.zoom+"\"); return false'>"+
a.Magnifier.opts.zoom+"</button></span>";a.Magnifier.init=function(c,b){this.width=this.divjq.attr("data-width");this.width||(this.width=c||a.MAGWIDTH);this.divjq.css("width",this.width);this.width=parseInt(this.divjq.css("width"),10);this.height=this.divjq.attr("data-height");this.height||(this.height=b||a.MAGHEIGHT);this.divjq.css("height",this.height);this.height=parseInt(this.divjq.css("height"),10);this.canvas=document.createElement("canvas");this.canvasjq=$(this.canvas);this.canvasjq.addClass("JS9Magnifier");
this.canvasjq.css("z-index",a.ZINDEX);this.canvasjq.attr("width",this.width);this.canvasjq.attr("height",this.height);this.context=this.canvas.getContext("2d");a.ANTIALIAS||(this.context.imageSmoothingEnabled=!1,this.context.mozImageSmoothingEnabled=!1,this.context.webkitImageSmoothingEnabled=!1);this.containerjq=$("<div>").addClass("JS9Container").append(this.canvasjq).appendTo(this.divjq);this.display.newShapeLayer("magnifier",a.Magnifier.opts,this.divjq)};a.Magnifier.display=function(c,b){var d,
e,f,g,h,j,k,m,n,p,r,l;c&&(c.display.pluginInstances.JS9Magnifier&&"active"===c.display.pluginInstances.JS9Magnifier.status)&&(c.magnifier||(c.magnifier={zoom:a.Magnifier.opts.zoom,posx:0,posy:0}),e=c.display.pluginInstances.JS9Magnifier,g=c.display.canvas,f=c.magnifier.zoom,k=Math.floor(e.width/f),m=Math.floor(e.height/f),b?(d=c.imageToDisplayPos(b),h=d.x-k/2,j=d.y-m/2,c.magnifier.posx=h,c.magnifier.posy=j):(h=c.magnifier.posx,j=c.magnifier.posy),p=n=0,r=e.canvas.width,l=e.canvas.height,0>h&&(k+=
h,n-=h*f,r+=h*f,h=0),d=h+k-g.width,0<d&&(k-=d,r=k*f),0>j&&(m+=j,p-=j*f,l+=j*f,j=0),d=j+m-g.height,0<d&&(m-=d,l=m*f),e.context.clear(),e.context.drawImage(g,h,j,k,m,n,p,r,l),c.magnifier.boxid||(c.magnifier.boxid=c.addShapes("magnifier","box"),$(e.canvas).css("background-color","black")),g=e.width/2,e=e.height/2,c.changeShapes("magnifier",c.magnifier.boxid,{left:g,top:e,width:f,height:f}))};a.Magnifier.zoom=function(c,b){var d,e;if(c&&c.magnifier){d=c.magnifier;e=d.zoom;switch(b.charAt(0)){case "x":case "*":e*=
parseFloat(b.slice(1));break;case "/":e/=parseFloat(b.slice(1));break;default:e=parseFloat(b)}if(!e||1>e)e=1;d.zoom=e;a.Magnifier.display(c)}};a.Magnifier.close=function(a){var b=a.display.pluginInstances.JS9Magnifier;b&&(b.context.clear(),a.removeShapes("magnifier","all"));return a};a.Panner={};a.Panner.CLASS="JS9";a.Panner.NAME="Panner";a.Panner.opts={hasControls:!1,hasRotatingPoint:!1,hasBorders:!1,zoom:4,canvas:{selection:!0},tagcolors:{defcolor:"#00FF00"}};a.Panner.HTML="<span><button type='button' class='JS9Button' onClick='JS9.bcall(this, \"zoomPanner\", \"x2\"); return false'>x2</button><button type='button' class='JS9Button' onClick='JS9.bcall(this, \"zoomPanner\", \"/2\"); return false'>/2</button><button type='button' class='JS9Button' onClick='JS9.bcall(this, \"zoomPanner\", \"1\"); return false'>Zoom1</button><button type='button' class='JS9Button' onClick='JS9.bcall(this, \"panImage\"); return false'>Center</button></span>";
...
c.target.getCenterPoint();c=(h.x-b.panner.ix)*b.panner.xblock/b.panner.zoom+b.panner.x0;h=(d.canvas.height-(h.y+b.panner.iy))*b.panner.yblock/b.panner.zoom+b.panner.y0;try{b.display.pluginInstances.JS9Panner.status="inactive",b.setPan(c,h)}catch(j){a.log("couldn't pan image",j)}finally{b.display.pluginInstances.JS9Panner.status="active"}}});this.display.image&&a.Panner.display(this.display.image)};a.Panner.create=function(a){var b,d,e,f,g,h,j,k,m,n,p,r,l;if(a&&a.raw&&a.display.pluginInstances.JS9Panner){a.panner||
(a.panner={});a.panner.zoom||(a.panner.zoom=1);b=a.display.pluginInstances.JS9Panner;d=a.panner;e=a.rgb.sect;r=Math.min(a.raw.width,b.width);l=Math.min(a.raw.height,b.height);d.xblock=a.raw.width/r;d.yblock=a.raw.height/l;d.xblock>d.yblock?(l=Math.floor(l/d.xblock*d.yblock+0.5),d.yblock=d.xblock):d.yblock>d.xblock&&(r=Math.floor(r/d.yblock*d.xblock+0.5),d.xblock=d.yblock);b=a.display.context.createImageData(r,l);1===d.zoom?(g=d.xblock,h=d.yblock,e=f=0):(g=d.xblock/d.zoom,h=d.yblock/d.zoom,f=Math.max(0,
(e.x0+e.x1-r*g)/2),e=Math.max(0,(e.y0+e.y1-l*h)/2));d.x0=f;d.y0=e;d.img=b;d.ix=0;d.iy=0;if(a.rgbFile){for(j=0;j<l;j++){m=Math.floor(e+j*h)*a.offscreen.img.width;n=j*r;for(d=0;d<r;d++)k=Math.floor(f+d*g),k=4*(k+m),p=4*(n+d),b.data[p]=a.offscreen.img.data[k],b.data[p+1]=a.offscreen.img.data[k+1],b.data[p+2]=a.offscreen.img.data[k+2],b.data[p+3]=255}return a}for(j=0;j<l;j++){m=Math.floor(e+(l-j-1)*h)*a.raw.width;n=j*r;for(d=0;d<r;d++)k=Math.floor(f+d*g),k=a.colorData[k+m],p=4*(n+d),a.psColors[k]&&(b.data[p]=
...
c.args?g=$.extend(!0,[],c.args):c.paramlist&&(g=c.paramlist.split(/ +/)),d.getWhich(g)){case "get":try{f=d.get(g)||""}catch(m){f="ERROR: "+m.message}break;case "set":try{f=d.set(g)||"OK"}catch(n){f="ERROR: "+n.message}break;default:f=sprintf("ERROR: unknown cmd type for '%s'",h)}else d||(f=sprintf("ERROR: unknown cmd '%s'",h)),e||(f=sprintf("ERROR: unknown display (%s)",j));b&&(a.globalOpts.alerts=!0,b(f));return f}};a.lightWin=function(c,b,d,e,f){var g;switch(a.LIGHTWIN){case "dhtml":g=dhtmlwindow.open(c,
...
(a.fits.options.extlist=a.userOpts.fits.extlist,a.fits.options.table={nx:a.userOpts.fits.table.nx,ny:a.userOpts.fits.table.ny}):(a.fits.options.extlist=a.globalOpts.extlist,a.fits.options.table={nx:a.globalOpts.dims[0],ny:a.globalOpts.dims[1]});a.fits.maxFITSMemory&&a.globalOpts.maxMemory&&a.fits.maxFITSMemory(a.globalOpts.maxMemory);break;default:a.error("unknown fits library: "+c)}a.fits.name=b;a.fits.options.error=a.error;a.fits.options.waiting=a.waiting;return b};a.handleImageFile=function(c,
b,d){b=$.extend(!0,{},b,a.fits.options);void 0===d&&(d=a.Load);var e=new FileReader;e.onload=function(a){var e=new Image;e.src=a.target.result;e.onload=function(){var a,f,k,m=0;a=document.createElement("canvas");f=a.getContext("2d");var n=e.height,p=e.width;a.width=p;a.height=n;f.drawImage(e,0,0);var r=f.getImageData(0,0,p,n).data,l=new Float32Array(n*p);for(f=0;f<n;f++)for(a=0;a<p;a++)k=0.299*r[m]+0.587*r[m+1]+0.114*r[m+2],l[(n-f)*p+a]=k,m+=4;a={head:{},name:c.name,filedata:l,naxis:2,axis:[0,p,n],
bitpix:-32,data:l};a.dmin=Number.MAX_VALUE;a.dmax=Number.MIN_VALUE;for(m=0;m<n*p;m++)a.dmin=Math.min(a.dmin,a.data[m]),a.dmax=Math.max(a.dmax,a.data[m]);d(a,b)}};e.readAsDataURL(c)};a.lookupColormap=function(c){var b;c||(c=a.imageOpts.colormap);if(c)for(b=0;b<a.colormaps.length;b++)if(a.colormaps[b].name===c)return a.colormaps[b];a.error("unknown colormap '"+c+"'")};a.lookupCommand=function(c){var b,d;if(c){d=c.toLowerCase();for(b=0;b<a.commands.length;b++)if(c=a.commands[b],c.name===d||c.alias===
d||c.alias2===d)return c}return null};a.error=function(c,b,d){var e,f,g="",h="",j=!0;a.waiting(!1);"string"===typeof b?(f=c.match(b))?f[1]?c=f[1]:f[0]&&(c=f[0]):j=!1:"object"===typeof b&&(e=b);3>arguments.length&&(d=!0);if(j&&(e&&e.message?c+=sprintf(" (%s)",e.message):c&&(e=Error(c)),(f=a.strace(e))&&(h="\n\nStacktrace:\n"+f),a.globalOpts.alerts&&(c&&("string"===typeof c&&0>c.search(/ERROR/))&&(g="JS9 ERROR: "),alert(g+(c+h))),d))throw e;};a.eventToDisplayPos=function(a){var b,d;a||(a=window.event);
a.target?b=a.target:a.srcElement&&(b=a.srcElement);3===b.nodeType&&(b=b.parentNode);a.originalEvent&&a.originalEvent.changedTouches&&a.originalEvent.changedTouches.length?(d=a.originalEvent.changedTouches[0].pageX,a=a.originalEvent.changedTouches[0].pageY):(d=a.pageX,a=a.pageY);d-=$(b).offset().left;b=a-$(b).offset().top;return{x:Math.floor(d-1),y:Math.floor(b-1)}};a.rotatePoint=function(a,b,d){var e;d=d||{x:0,y:0};b=Math.PI*b/180;e=Math.cos(b);b=Math.sin(b);return{x:e*(a.x-d.x)-b*(a.y-d.y)+d.x,y:b*
(a.x-d.x)+e*(a.y-d.y)+d.y}};a.log=function(){if(void 0!==window.console&&void 0!==window.console.log)try{console.log.apply(console,arguments)}catch(a){Function.prototype.bind.call(console.log,console).apply(console,arguments)}};a.isNumber=function(a){return!isNaN(parseFloat(a))&&isFinite(a)};a.notNull=function(a){return void 0!==a&&null!==a};a.cardpars=function(c){var b;if("="===c[8])return b=c.slice(0,8).trim(),c=c.slice(10).replace(/\'/g," ").replace(/\/.*/,"").trim(),"T"===c?c=!0:"F"===c?c=!1:
a.isNumber(c)&&(c=parseFloat(c)),[b,c]};a.raw2FITS=function(a,b){var d,e,f,g=!1,h="";if(!a)return h;if(a.card)for(d=0;d<a.card.length;d++)e=a.card[d],h+=e,"END "===e.substring(0,4)&&(g=!0),b&&(h+="\n");else if(a.cardstr)for(d=0;d<a.ncard;d++)e=a.cardstr.slice(80*d,80*(d+1)),h+=e,"END "===e.substring(0,4)&&(g=!0),b&&(h+="\n");else if(a.header)for(e in d=a.header,d){if(d.hasOwnProperty(e)&&!("js9Protocol"===e||"js9Endian"===e))"END"===e&&(g=!0),f=d[e],!0===f&&(f="T"),h+=sprintf("%-8s%-2s%-70s",e,"=",
f),b&&(h+="\n")}else if(a.BITPIX)for(e in d=a,d)if(d.hasOwnProperty(e)&&!("js9Protocol"===e||"js9Endian"===e))"END"===e&&(g=!0),f=d[e],!0===f&&(f="T"),h+=sprintf("%-8s%-2s%-70s",e,"=",f),b&&(h+="\n");g||(h+=sprintf("%-8s%-72s","END"," "),b&&(h+="\n"));return h};CanvasRenderingContext2D.prototype.clear=CanvasRenderingContext2D.prototype.clear||function(a){a&&(this.save(),this.setTransform(1,0,0,1,0,0));this.clearRect(0,0,this.canvas.width,this.canvas.height);a&&this.restore()};a.tooltip=function(a,
...
c.split(".");g=f.pop();for(d=0;d<f.length;d++)b=b[f[d]];return b[g].apply(b,e);default:a.error("unknown function type: "+d)}};a.loadPrefs=function(c,b){$.ajax({url:c,dataType:"json",async:!1,success:function(b){var c,f,g;for(g in b)if(b.hasOwnProperty(g)&&a.hasOwnProperty(g)&&(f=typeof a[g],c=typeof b[g],f===c||"string"===c))switch(f){case "object":$.isArray(b[g])?a[g]=b[g]:$.extend(!0,a[g],b[g]);break;case "number":case "string":a[g]=b[g]}},error:function(){b&&("Chrome"===a.BROWSER[0]&&""===document.domain?
a.log("When using the file:// URI, Chrome must be run with the --allow-file-access-from-files switch to permit JS9 to access the preference file."):a.log("JS9 prefs file not available: %s",c))}})};a.isTypedArray=function(a){a=Object.prototype.toString.call(a);return{"[object Int8Array]":!0,"[object Uint8Array]":!0,"[object Uint8ClampedArray]":!0,"[object Int16Array]":!0,"[object Uint16Array]":!0,"[object Int32Array]":!0,"[object Uint32Array]":!0,"[object Float32Array]":!0,"[object Float64Array]":!0}.hasOwnProperty(a)};
a.mouseDownCB=function(c){var b,d,e,f,g=c.data,h=g.image;if(h)if(d=a.eventToDisplayPos(c),g.inResize(d)||c.preventDefault(),2<a.DEBUG&&a.log("m-down: %d %d %s",d.x,d.y,h.rclick),f=h.displayToImagePos(d),h.dnpos=d,h.rclick)h.clearMessage("regions");else{g.blendMode&&(g.blendMode=0);if(!a.specialKey(c))for(b in g.pluginInstances)if(g.pluginInstances.hasOwnProperty(b)&&(d=g.pluginInstances[b],e=d.plugin.opts,d.isActive("onmousedown")&&(!h.rclick||e.mousedownRegions)))try{e.onmousedown.call(d,h,f,c.originalEvent||
c)}catch(j){d.errLog("onmousedown",j)}h.evstate=c.button;c.originalEvent&&(c.originalEvent.touches&&c.originalEvent.touches.length)&&(h.evstate=c.originalEvent.touches.length-2);$("body").on("mousemove",g,function(b){return a.mouseMoveCB(b)});$("body").on("mouseup",g,function(b){return a.mouseUpCB(b)})}};a.mouseUpCB=function(c){var b,d,e,f,g=c.data,h=g.image;if(h){b=a.eventToDisplayPos(c);g.inResize(b)||c.preventDefault();2<a.DEBUG&&a.log("m-up: %d %d %s",b.x,b.y,h.rclick);d=h.displayToImagePos(b);
...
f.mouseupRegions)))try{f.onmouseup.call(b,h,d,c.originalEvent||c)}catch(j){b.errLog("onmouseup",j)}h.rclick=0;h.evstate=-1;g.resizing&&(g.resizing=0,a.bugs.webkit_resize&&(c=parseInt(g.divjq.css("width"),10),d=parseInt(g.divjq.css("height"),10),c<g.owidth&&g.divjq.css("width",g.owidth+a.RESIZEFUDGE),d<g.oheight&&g.divjq.css("height",g.oheight+a.RESIZEFUDGE)));$("body").off("mouseup");$("body").off("mousemove")}};a.mouseMoveCB=function(c){var b,d,e,f,g=c.data,h=g.image;if(h&&!g.resizing){b=a.eventToDisplayPos(c);
g.inResize(b)||c.preventDefault();3<a.DEBUG&&a.log("m-move: %d %d %s",b.x,b.y,h.rclick);d=h.displayToImagePos(b);h.valpos=null;if(h.rclick&&(h.rclick=2,(f=h.display.layers.regions.params.sel)&&(h.params.listonchange||f.params.listonchange)))h.updateShape("regions",f,null,"update",!0),h.listRegions("selected",2);switch(h.evstate){case -1:if(0<d.x&&(0<d.y&&d.x<h.raw.width&&d.y<h.raw.height)&&!a.specialKey(c))for(e in a.globalOpts.internalValPos&&(h.valpos=h.updateValpos(d)),g.pluginInstances)if(g.pluginInstances.hasOwnProperty(e)&&
(b=g.pluginInstances[e],f=b.plugin.opts,b.isActive("onmousemove")&&(!h.rclick||f.mousemoveRegions)))try{f.onmousemove.call(b,h,d,c.originalEvent||c)}catch(j){b.errLog("onmousemove",j)}break;case 0:case 1:if(!a.globalOpts.internalContrastBias)break;if(h.rclick||a.specialKey(c))break;if(h.rgbFile)break;if(h.dnpos&&Math.abs(h.dnpos.x-b.x)<a.NOMOVE&&Math.abs(h.dnpos.y-b.y)<a.NOMOVE)break;d.x=Math.floor(b.x+0.5);d.y=Math.floor(b.y+0.5);if(0>d.x||0>d.y||d.x>=g.canvas.width||d.y>=g.canvas.height)break;h.params.bias=
d.x/g.canvas.width;h.params.contrast=10*(d.y/g.canvas.height);a.bugs.firefox_linux?window.setTimeout(function(){h.displayImage("scaled")},0):h.displayImage("scaled")}}};a.mouseOverCB=function(c){var b,d,e,f,g=c.data,h=g.image;b=$(document).scrollLeft();e=$(document).scrollTop();c.preventDefault();if(h&&(h.display.displayConjq.focus(),window.scrollTo(b,e),!a.specialKey(c)))for(d in b=a.eventToDisplayPos(c),b=h.displayToImagePos(b),g.pluginInstances)if(g.pluginInstances.hasOwnProperty(d)&&(e=g.pluginInstances[d],
f=e.plugin.opts,e.isActive("onmouseover")&&(!h.rclick||f.mouseoverRegions)))try{f.onmouseover.call(e,h,b,c.originalEvent||c)}catch(j){e.errLog("onmouseover",j)}};a.mouseOutCB=function(c){var b,d,e,f,g=c.data,h=g.image;c.preventDefault();if(h&&(h.display.displayConjq.blur(),!a.specialKey(c)))for(d in b=a.eventToDisplayPos(c),b=h.displayToImagePos(b),g.pluginInstances)if(g.pluginInstances.hasOwnProperty(d)&&(e=g.pluginInstances[d],f=e.plugin.opts,e.isActive("onmouseout")&&(!h.rclick||f.mouseoutRegions)))try{f.onmouseout.call(e,
h,b,c.originalEvent||c)}catch(j){e.errLog("onmouseout",j)}};a.keyPressCB=function(c){var b,d,e,f,g=c.data,h=g.image;b=c.which||c.keyCode;c.preventDefault();3<a.DEBUG&&a.log("keypress: %d ",b);b=a.eventToDisplayPos(c);b=h.displayToImagePos(b);for(d in g.pluginInstances)if(g.pluginInstances.hasOwnProperty(d)&&(e=g.pluginInstances[d],f=e.plugin.opts,e.isActive("onkeypress")))try{f.onkeypress.call(e,h,b,c.originalEvent||c)}catch(j){e.errLog("onkeypress",j)}};a.keyDownCB=function(c){var b,d,e,f,g=c.data,
h=g.image;b=c.which||c.keyCode;3<a.DEBUG&&a.log("keydown: %d ",b);b=a.eventToDisplayPos(c);b=h.displayToImagePos(b);for(d in g.pluginInstances)if(g.pluginInstances.hasOwnProperty(d)&&(e=g.pluginInstances[d],f=e.plugin.opts,e.isActive("onkeydown")))try{f.onkeydown.call(e,h,b,c.originalEvent||c)}catch(j){e.errLog("onkeydown",j)}h.layer&&h.layers[h.layer].opts.usekeyboard&&a.Regions.keyDownCB(h,b,c,h.layer)};a.dragenter=function(a,b){b.stopPropagation();b.preventDefault()};a.dragover=function(a,b){b.stopPropagation();
...
a.userOpts.regions)}try{c=localStorage.getItem("fits")}catch(h){c=null}if(c)try{a.userOpts.fits=JSON.parse(c)}catch(j){}}a.globalOpts.postMessage&&window.addEventListener("message",function(b){var c;b=b.data;if("string"===typeof b)try{c=JSON.parse(b)}catch(d){a.error("can't parse msg: "+b,d)}else"object"===typeof b?c=b:a.error("invalid msg from postMessage");(b=a.msgHandler(c))&&parent.postMessage({cmd:c.cmd,res:b},"*")},!1);a.DEBUG=a.DEBUG||a.globalOpts.debug||0;window.hasOwnProperty("Astroem")&&
(a.vmalloc=Astroem.vmalloc,a.vfree=Astroem.vfree,a.vheap=Astroem.vheap,a.vmemcpy=Astroem.vmemcpy,a.vfile=Astroem.vfile,a.vunlink=Astroem.vunlink,a.arrfile=Astroem.arrfile,a.initwcs=Astroem.initwcs,a.wcsinfo=Astroem.wcsinfo,a.wcssys=Astroem.wcssys,a.wcsunits=Astroem.wcsunits,a.pix2wcs=Astroem.pix2wcs,a.wcs2pix=Astroem.wcs2pix,a.reg2wcs=Astroem.reg2wcs,a.saostrtod=Astroem.saostrtod,a.saodtype=Astroem.saodtype,a.zscale=Astroem.zscale,a.reproject=Astroem.reproject);window.hasOwnProperty("Fitsy")?(a.fitsLibrary("fitsy"),
a.fits=Fitsy):window.hasOwnProperty("Astroem")&&(a.fitsLibrary("cfitsio"),a.fits=Astroem);$("div.JS9").each(function(){a.checkNew(new a.Display($(this)))});a.RegisterPlugin("JS9","Menubar",a.Menubar);a.RegisterPlugin("JS9","Console",a.Console,{menuItem:"Console",winTitle:"JS9 Console",winResize:!0,winDims:[a.WIDTH,180]});a.RegisterPlugin("JS9","Info",a.Info.init,{menuItem:"InfoBox",plugindisplay:a.Info.clearMain,winTitle:"JS9 Info",winResize:!0,winDims:[a.INFOWIDTH,a.INFOHEIGHT]});a.RegisterPlugin(a.Regions.CLASS,
...
g+a.uniqueID(),g="d"+d,e=e||sprintf("<hr class='hline0'><div class='JS9Menubar' id='%sMenubar'></div><div class='JS9' id='%s'></div>",d,d),f=f||a.lightOpts[a.LIGHTWIN].imageWin,a.lightWin(g,"inline",e,c,f),a.checkNew(new a.Display(d)),a.instantiatePlugins(),b.display=d,c&&a.Load(c,b),d;case "new":return b.id?(d=b.id,delete b.id):d=g+a.uniqueID(),f=document.getElementsByTagName("head")[0].innerHTML,!f.match(/src=["'].*js9\.js/)&&!f.match(/src=["'].*js9\.min\.js/)&&(f+=sprintf('<%s type="text/javascript" src="js9.min.js"></%s>',
"script","script")),g=e||sprintf("<div class='JS9Menubar' id='%sMenubar'></div><div class='JS9' id='%s'></div>",d,d),e=sprintf("<html><head>%s</head><body",f),c&&(e+=sprintf(" onload='JS9.Preload(\"%s\",%s);'",c,JSON.stringify(b))),e+=sprintf(">%s</body></html>\n",g),c=window.open(null,d,"width=540, height=560"),c=c.document,c.open(),c.write(e),c.close(),d}});a.mkPublic("LoadProxy",function(c,b){var d,e,f=a.parsePublicArgs(arguments);c=f.argv[0];b=f.argv[1];a.globalOpts.loadProxy||a.error("proxy load not available for this server");
a.globalOpts.workDir||a.error("proxy load requires a temp workDir this server");c||a.error("no url specified for proxy load");c=c.trim();c.match(/dropbox\.com/)?(c=c.replace("www.dropbox.com","dl.dropboxusercontent.com"),c=c.replace("?dl=0","")+"?raw=1"):c.match(/drive\.google\.com/)&&(c=c.replace(/\/file\/d\/(\w+)\/\w+\?usp=sharing/,"/uc?export=download&id=$1"));f.display&&(e=a.lookupDisplay(f.display))&&(e=e.divjq[0]);a.waiting(!0,e);a.Send("loadproxy",{cmd:"js9Xeq loadproxy "+c},function(c){c=
"object"===typeof c?c:0<=c.search(a.analOpts.epattern)?{stderr:c}:{stdout:c};c.errcode=c.errcode||0;c.stderr?a.error(c.stderr):c.stdout?(b=b||{},void 0===b.fits2png&&(b.fits2png=!1),d=c.stdout.trim(),"/"!==d.charAt(0)&&(d=a.InstallDir(d)),b.proxyFile=d,a.Load(d,b,{display:f.display})):a.error("internal error: no return from load proxy command")})});a.mkPublic("Preload",function(c){var b,d,e="",f=null,g=arguments.length;b=a.parsePublicArgs(arguments);c=b.argv[0];b.display&&(f={display:b.display},g-=
1);switch(g){case 0:b=(null===a.helper.connected||a.helper.connected)&&0<a.preloads.length?2:3;break;case 1:b="boolean"===typeof c?0<a.preloads.length?2:3:null===a.helper.connected||a.helper.connected?1:0;break;default:b=null===a.helper.connected||a.helper.connected?1:0}switch(b){case 0:for(b=0;b<g;b++)d=b+1,d<g&&"object"===typeof arguments[d]?(a.preloads.push([arguments[b],arguments[d],f]),b++):a.preloads.push([arguments[b],null,f]);break;case 1:a.globalOpts.alerts=!1;for(b=0;b<g;b++)if(d=b+1,d<
...
(c=b.argv[0],d.removeShapes("regions",c),d.clearMessage("regions"),"OK"):null});a.mkPublic("GetRegions",function(c){var b=a.parsePublicArgs(arguments),d=a.getImage(b.display);return d?(b.argv.unshift("regions"),d.getShapes.apply(d,b.argv)):null});a.mkPublic("ChangeRegions",function(c,b){var d=a.parsePublicArgs(arguments),e=a.getImage(d.display);e&&((c=d.argv[0])||a.error("no region specified for GetRegions"),b=d.argv[1],e.changeShapes("regions",c,b));return null});a.mkPublic("InstallDir",function(c){return a.INSTALLDIR+
c});a.mkPublic("AddDivs",function(){var c,b=a.parsePublicArgs(arguments);for(c=0;c<b.argv.length;c++)a.checkNew(new a.Display(b.argv[c]));a.instantiatePlugins()});a.mkPublic("ResizeDisplay",function(){var c;c=a.parsePublicArgs(arguments);var b=a.lookupDisplay(c.display);b||a.error("invalid display for resize");c=a.Display.prototype.resize.apply(b,c.argv);c===b&&(c="OK");return c});return a}(JS9);$(document).ready(function(){JS9.init()});
