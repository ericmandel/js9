...
2048,b.globalOpts.image.ydim=2048,b.imageOpts.crosshair=!1,b.globalOpts.reproj={xdim:2048,ydim:2048});window.hasOwnProperty("Jupyter")&&(b.globalOpts.useWasm=!1);window.isElectron&&("Chrome"===b.BROWSER[0]&&66<=parseFloat(b.BROWSER[1])&&(b.globalOpts.allowFileWasm=!0),b.globalOpts.internalColorPicker=!1);b.Image=function(a,c,d){var e,f,g,h=this,k=null,l=0,n=0,m=function(b,a){var c;c=1;var d=[];void 0!==a.bin&&(c="string"===typeof a.bin?parseInt(a.bin,10):a.bin);a&&void 0!==a.xcen&&d.push(a.xcen/c);
a&&void 0!==a.ycen&&d.push(a.ycen/c);a&&void 0!==a.zoom&&(c=b.parseZoom(a.zoom))&&d.push(c);return d},t=function(a){this.display.clearMessage();b.images.push(this);this.notifyHelper();k&&k.regions&&this.addShapes("regions",k.regions);this.xeqPlugins("image","onimageload");this.updateshapes&&this.updateShapes("regions","all","update");this.status.load="complete";b.waiting(!1);if(a)try{b.xeqByName(a,window,this)}catch(u){b.error("in image onload callback",u,!1)}};c&&("object"===typeof c?(k=c,k.display&&
...
this.id0=this.file.split("/").reverse()[0];this.id=b.getImageID(this.id0,this.display.id);this.status.load="loading";$(this.png.image).on("load",function(){h.mkOffScreenCanvas();h.mkRawDataFromPNG();"zscale"===h.params.scaleclipping?h.zscale(!0):"zmax"===h.params.scaleclipping&&h.zscale("zmax");h.params.zoom&&(g=h.parseZoom(h.params.zoom),h.rgb.sect.zoom=g,h.rgb.sect.ozoom=g);h.mkSection();f=m(h,k);f.length&&h.mkSection.apply(h,f);h.displayImage("all",k);t.call(h,d);b.DEBUG&&b.log("JS9 image: %s dims(%d,%d) min/max(%d,%d)",
h.file,h.raw.width,h.raw.height,h.raw.dmin,h.raw.dmax)}).on("error",function(){b.waiting(!1);h.status.load="error";b.error("could not load image: "+h.id)});this.png.image.src=a;break;default:b.log("unknown specification type for Load: "+typeof a)}};b.Image.prototype.getImageData=function(b){var a=null;if(b)if("array"===b)a=Array.prototype.slice.call(this.raw.data);else if("base64"===b){b="";for(var d=new Uint8Array(this.raw.data.buffer),e=d.byteLength,a=0;a<e;a++)b+=String.fromCharCode(d[a]);a=window.btoa(b)}else b&&
...
this.blend.active&&this.displayImage();return this};b.Image.prototype.calcDisplayOffsets=function(a){var c,d,e,f,g;this.ix=Math.floor((this.display.canvas.width-this.rgb.img.width)/2);this.iy=Math.floor((this.display.canvas.height-this.rgb.img.height)/2);a&&this.wcsim&&this.display===this.wcsim.display&&this.params.wcsalign&&(d=this.rgb.sect,a=this.wcsim,e=a.rgb.sect,c=a.getPan(),f=b.pix2wcs(a.raw.wcs,c.x,c.y).trim().split(/\s+/),g=b.saostrtod(f[0]),":"===String.fromCharCode(b.saodtype())&&"galactic"!==
a.params.wcssys&&"ecliptic"!==a.params.wcssys&&(g*=15),f=b.saostrtod(f[1]),f=b.wcs2pix(this.raw.wcs,g,f).trim().split(/\s+/),g=parseFloat(f[0]),f=parseFloat(f[1]),.5>Math.abs(g-c.x)&&(g=c.x),.5>Math.abs(f-c.y)&&(f=c.y),this.mkSection(g,f,e.zoom),c=0-(e.x0-d.x0)*e.zoom,d=(a.raw.height-this.raw.height-(e.y0-d.y0))*e.zoom,this.ix=a.ix+c,this.iy=a.iy+d);return this};b.Image.prototype.putImage=function(a){var c=this.rgb,d=this.display.context,e=function(a,c){var d,e;a.offscreenRGB||(e=document.createElement("canvas"),
...
d.drawImage(e(this,c.img),this.ix,this.iy),d.restore()):d.putImageData(c.img,this.ix,this.iy);return this};b.Image.prototype.displayImage=function(a,c){var d,e,f;f=0;var g=[],h={};if(!1===a)return this.displayMode=!1,this;!0===a&&(this.displayMode=!0,a="all");if(!this.displayMode)return this;"object"===typeof a&&(c=a,a=null);a?"all"===a?(a="colors,scaled,rgb,display,plugins",h.notify=!0):"rgbonly"===a?(a="rgb,nodisplay",h.notify=!0):"display"===a&&(h.notify=!0):a="rgb";a.split(",").forEach(function(b,
...
!a.opts.winDims||a.opts.winDims[0]||a.opts.winDims[1]||b.instantiatePlugin(null,a,null,a.opts.divArgs)};for(a=0;a<b.plugins.length;a++)c(b.plugins[a])};b.initEmscripten=function(){var a;if(!window.hasOwnProperty("Astroem"))if(a={responseType:"arraybuffer",allowCache:!0},b.globalOpts.useWasm&&"object"===typeof WebAssembly&&("file:"!==location.protocol||b.globalOpts.allowFileWasm))b.globalOpts.astroemWasm=b.InstallDir(Module.wasmBinaryFile||"astroemw.wasm"),b.fetchURL(b.globalOpts.astroemWasm,null,
a,function(a){Module.wasmBinary=a;b.globalOpts.astroemURL=b.InstallDir("astroemw.js");try{b.loadScript(b.globalOpts.astroemURL)}catch(d){b.error("can't find "+b.globalOpts.astroemURL)}});else{b.globalOpts.astroemURL=b.InstallDir("astroem.js");try{b.loadScript(b.globalOpts.astroemURL)}catch(c){b.error("can't find "+b.globalOpts.astroemURL)}}};b.initFITS=function(){window.hasOwnProperty("Astroem")?(b.vmalloc=Astroem.vmalloc,b.vfree=Astroem.vfree,b.vheap=Astroem.vheap,b.vmemcpy=Astroem.vmemcpy,b.vfile=
Astroem.vfile,b.vread=Astroem.vread,b.vunlink=Astroem.vunlink,b.vsize=Astroem.vsize,b.arrfile=Astroem.arrfile,b.listhdu=Astroem.listhdu,b.initwcs=Astroem.initwcs,b.freewcs=Astroem.freewcs,b.wcsinfo=Astroem.wcsinfo,b.wcssys=Astroem.wcssys,b.wcsunits=Astroem.wcsunits,b.pix2wcs=Astroem.pix2wcs,b.wcs2pix=Astroem.wcs2pix,b.reg2wcs=Astroem.reg2wcs,b.saostrtod=Astroem.saostrtod,b.saodtostr=Astroem.saodtostr,b.saodtype=Astroem.saodtype,b.zscale=Astroem.zscale,b.tanhdr=Astroem.tanhdr,b.reproject=Astroem.reproject,
