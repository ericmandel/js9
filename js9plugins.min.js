...
function(a){c(d+" progress "+a.loaded.toString())}),f.addEventListener("error",function(a){c(d+" service error")}),f.addEventListener("abort",function(a){c(d+" service aborted")}));f.onload=function(a){4!==this.readyState||200!==this.status&&0!==this.status||(void 0!==c&&c(""),b(a,this))};f.send();return f}},{}]},{},[1]);"use strict";
...
JS9.RegisterPlugin(JS9.Cmaps.CLASS,JS9.Cmaps.NAME,JS9.Cmaps.init,{menuItem:"Colormaps",help:"help/cmaps.html",onimageload:JS9.Cmaps.imageload,onimagedisplay:JS9.Cmaps.imagedisplay,onimageclose:JS9.Cmaps.imageclose,winTitle:"Create Colormaps",winResize:!0,winDims:[JS9.Cmaps.WIDTH,JS9.Cmaps.HEIGHT]});"use strict";JS9.Colorbar={};JS9.Colorbar.CLASS="JS9";JS9.Colorbar.NAME="Colorbar";JS9.Colorbar.WIDTH=512;JS9.Colorbar.HEIGHT=40;JS9.Colorbar.BASE=JS9.Colorbar.CLASS+JS9.Colorbar.NAME;
JS9.Colorbar.SCALED=!1;JS9.Colorbar.TICKS=10;JS9.Colorbar.COLORBARHEIGHT=16;JS9.Colorbar.MAXLABELSIZE=10;JS9.Colorbar.STATICSIZE=4;JS9.Colorbar.STATICPADDING=3;JS9.Colorbar.INFINITY=10;
...
JS9.RegisterPlugin("JS9","Info",JS9.Info.init,{menuItem:"InfoBox",help:"help/info.html",dynamicSelect:!0,onplugindisplay:JS9.Info.pluginDisplay,onpluginclose:JS9.Info.pluginClose,onimagedisplay:JS9.Info.init,onimagerefresh:JS9.Info.init,onupdateprefs:JS9.Info.init,winTitle:"Info",winResize:!0,winDims:[JS9.Info.WIDTH,JS9.Info.HEIGHT]});"use strict";JS9.Keyboard={};JS9.Keyboard.CLASS="JS9";JS9.Keyboard.NAME="Keyboard";JS9.Keyboard.WIDTH=450;JS9.Keyboard.HEIGHT=420;
JS9.Keyboard.BASE=JS9.Keyboard.CLASS+JS9.Keyboard.NAME;JS9.Keyboard.actionHTML="<div class='JS9KeyboardText'><button class='JS9Button JS9KeyboardButton' type='button' value='%s'>%s</button></div><div class='JS9KeyboardAction'>%s</div>";JS9.Keyboard.actionid=function(a,b){return(a+"_"+b).replace(/[^A-Za-z0-9_]/g,"_")};
...
JS9.RegisterPlugin(JS9.Keyboard.CLASS,JS9.Keyboard.NAME,JS9.Keyboard.init,{menuItem:"Keyboard Actions",onplugindisplay:JS9.Keyboard.init,help:"help/keyboard.html",winTitle:"Keyboard Actions",winResize:!0,winDims:[JS9.Keyboard.WIDTH,JS9.Keyboard.HEIGHT]});"use strict";JS9.Layers={};JS9.Layers.CLASS="JS9";JS9.Layers.NAME="Layers";JS9.Layers.WIDTH=460;JS9.Layers.HEIGHT=250;JS9.Layers.BASE=JS9.Layers.CLASS+JS9.Layers.NAME;JS9.Layers.headerHTML="Shape layers can be hidden or made visible below. The topmost visible layer in the stack is <b>active</b>: it responds to mouse and touch events. Move a layer to the top of the stack to make it active.";
...
JS9.RegisterPlugin(JS9.Statusbar.CLASS,JS9.Statusbar.NAME,JS9.Statusbar.init,{menuItem:"Statusbar",dynamicSelect:!0,ondynamicselect:JS9.Statusbar.dynamic,onimagedisplay:JS9.Statusbar.imagedisplay,onimageclear:JS9.Statusbar.imageclear,onimageclose:JS9.Statusbar.imageclear,onsetwcssys:JS9.Statusbar.imagedisplay,onsetwcsunits:JS9.Statusbar.imagedisplay,help:"help/statusbar.html",winTitle:"Statusbar",winDims:[JS9.Statusbar.WIDTH,JS9.Statusbar.HEIGHT]});"use strict";JS9.Sync={};JS9.Sync.CLASS="JS9";
JS9.Sync.NAME="Sync";JS9.Sync.getOps=function(a){var b,c,d=[];a=a||JS9.globalOpts.syncOps;if(!$.isArray(a))try{a=JSON.parse(a)}catch(e){a=[a]}for(c=b=0;b<a.length;b++){var f=a[b];switch(f){case "wcs":d[c++]="wcssys";d[c++]="wcunits";break;default:d[c++]=f}}return d};
JS9.Sync.getIms=function(a){var b,c,d=[];a=a||JS9.images;if(!$.isArray(a))try{a=JSON.parse(a)}catch(e){a=[a]}for(c=b=0;b<a.length;b++){var f="string"===typeof a[b]?JS9.lookupImage(a[b]):a[b];!f||f.id===this.id&&f.display.id===this.display.id||(d[c++]=f)}return d};
...
0;e<c.length;e++)if(a.hasOwnProperty(c[e]))a=a[c[e]];else return"";c=f.substring(f.length-1);f=f.substring(0,f.length-1);f=f.split(".");e=f[0]|0;f=f[1]|0;switch(c){case "s":a=a.toString();break;case "f":a=a.toFixed(f);break;case "d":a=a.toFixed(0)}0!==e&&e>a.length&&(a=0<e?d(" ",e-a.length)+a:a+d(" ",e-a.length));return a})}},{}]},{},[]);"use strict";
...
"lightblue");$(this.div).find(":input").css("font-size","11")},{menu:"view",menuItem:"Pixel Table",winTitle:"Pixel Table",winResize:!0,toolbarSeparate:!0,onmousemove:b,onarrowkey:b,winDims:[625,240]})})();"use strict";
...
c);d=0;var e=.001*c.sum,h=0,l;$(f).empty();var g=[];for(l=0;l<c.data.shape[0];l++)if(d+=c.data.get(l),d>e&&d<c.sum-e){var k=c.data.get(l);g[h]=[l*c.width+c.min,k];h++}c=$.plot(f,[g],{zoomStack:!0,zoomFunc:a,selection:{mode:"x"}});a(f,c,void 0)},winDims:[250,250]})})();"use strict";
