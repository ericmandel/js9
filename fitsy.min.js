...
h.bin;a.table.filter=h.filter;a.table.nx=h.nx;a.table.ny=h.ny;a.table.cx=n.cx;a.table.cy=n.cy;a.dmin=Number.MAX_VALUE;a.dmax=Number.MIN_VALUE;for(f=0;f<p.nx*p.ny;f++)a.dmin=Math.min(a.dmin,a.data[f]),a.dmax=Math.max(a.dmax,a.data[f]);a.axis[1]=p.nx;a.axis[2]=p.ny;a.head.NAXIS1=p.nx;a.head.NAXIS2=p.ny;a.card[0]=Fitsy.cardfmt("SIMPLE",0,!0,"Standard FITS Image");a.card[Fitsy.cardfind(a.card,"BITPIX",0)]=Fitsy.cardfmt("BITPIX",0,32,"FITS Data type.");a.card[Fitsy.cardfind(a.card,"NAXIS",0)]=Fitsy.cardfmt("NAXIS",
0,2,"Number of Axes");a.card[Fitsy.cardfind(a.card,"NAXIS1",1)]=Fitsy.cardfmt("NAXIS1",0,p.nx,"Axis Dimension");a.card[Fitsy.cardfind(a.card,"NAXIS2",1)]=Fitsy.cardfmt("NAXIS2",0,p.ny,"Axis Dimension");f=m.ith;Fitsy.cardcopy(a,"TCTYP"+f,a,"CTYPE1");Fitsy.cardcopy(a,"TCRVL"+f,a,"CRVAL1");Fitsy.cardcopy(a,"TCDLT"+f,a,"CDELT1",void 0,function(a){return a*n.bin});Fitsy.cardcopy(a,"TCRPX"+f,a,"CRPIX1",void 0,function(b){return b-(a.table.cx-a.table.nx/2)-0.5});Fitsy.cardcopy(a,"TCROT"+f,a,"CROTA1");f=
q.ith;Fitsy.cardcopy(a,"TCTYP"+f,a,"CTYPE2");Fitsy.cardcopy(a,"TCRVL"+f,a,"CRVAL2");Fitsy.cardcopy(a,"TCDLT"+f,a,"CDELT2",void 0,function(a){return a*n.bin});Fitsy.cardcopy(a,"TCRPX"+f,a,"CRPIX2",void 0,function(b){return b-(a.table.cy-a.table.ny/2)-0.5});Fitsy.cardcopy(a,"TCROT"+f,a,"CROTA2");Fitsy.cardcopy(a,"LTV1",a,"LTV1",0,function(){return p.nx/2-a.table.cx/n.bin});Fitsy.cardcopy(a,"LTV2",a,"LTV2",0,function(){return p.ny/2-a.table.cy/n.bin});Fitsy.cardcopy(a,"LTM1_1",a,"LTM1_1",1,function(a){return a/
n.bin});Fitsy.cardcopy(a,"LTM1_2",a,"LTM1_2",0,function(a){return a/n.bin});Fitsy.cardcopy(a,"LTM2_1",a,"LTM2_1",0,function(a){return a/n.bin});Fitsy.cardcopy(a,"LTM2_2",a,"LTM2_2",1,function(a){return a/n.bin});c(a,e)}else d=Math.min(a.length-a.nev,Fitsy.options.maxev),g=a.dataseek+a.nev*a.width,Fitsy.getDataSlice(b,"asArray",g,g+d*a.width,Fitsy.readTableHDUDataBinner,Fitsy.readError,b,a,d,e,c)};
